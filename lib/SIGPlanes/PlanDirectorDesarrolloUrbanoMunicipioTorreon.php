...
class PlanDirectorDesarrolloUrbanoMunicipioTorreon extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->descripcion               = 'Establecer una metrópoli articulada y coherente con equipamiento e infraestructura para la regeneración urbana. </br> - PDF 4.1 MB.</br></br></br>';
