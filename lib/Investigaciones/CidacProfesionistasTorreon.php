...
class CidacProfesionistasTorreon extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->autor           = 'CIDAC';
        $this->fecha           = '2016-04-20T15:30';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes
        $this->archivo         = 'cidac-profesionistas-torreon';
        $this->imagen          = 'cidac-profesionistas-torreon/imagen.jpg';
        $this->imagen_previa   = 'cidac-profesionistas-torreon/imagen-previa.jpg';
        ...
        $this->contenido_archivo_markdown = 'lib/Blog/CidacProfesionistasTorreon.md';
        // Para el Organizador
