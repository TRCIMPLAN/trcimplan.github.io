...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdmmiiylh">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetilprkxit" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdmmiiylh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdmmiiylh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapilprkxit;
  ...
  function initmapilprkxit() {
    // Nuevo Mapa
    mapilprkxit = new L.Map('LeafLetilprkxit');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapilprkxit.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapilprkxit.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapilprkxit === 'undefined') {
    varinitmapilprkxit = initmapilprkxit();
  };
});
FINAL;
    } // constructor
