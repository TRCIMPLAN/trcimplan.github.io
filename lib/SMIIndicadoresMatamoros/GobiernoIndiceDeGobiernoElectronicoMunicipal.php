...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnyhkkbff">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzhhtvcfz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnyhkkbff a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnyhkkbff a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzhhtvcfz;
  ...
  function initmapzhhtvcfz() {
    // Nuevo Mapa
    mapzhhtvcfz = new L.Map('LeafLetzhhtvcfz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzhhtvcfz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzhhtvcfz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzhhtvcfz === 'undefined') {
    varinitmapzhhtvcfz = initmapzhhtvcfz();
  };
});
FINAL;
    } // constructor
