...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmubnnbvw">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgoojgrtq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmubnnbvw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmubnnbvw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgoojgrtq;
  ...
  function initmapgoojgrtq() {
    // Nuevo Mapa
    mapgoojgrtq = new L.Map('LeafLetgoojgrtq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgoojgrtq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgoojgrtq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgoojgrtq === 'undefined') {
    varinitmapgoojgrtq = initmapgoojgrtq();
  };
});
FINAL;
    } // constructor
