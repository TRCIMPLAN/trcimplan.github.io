...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuawqqsxq">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvebwebjb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuawqqsxq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuawqqsxq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvebwebjb;
  ...
  function initmapvebwebjb() {
    // Nuevo Mapa
    mapvebwebjb = new L.Map('LeafLetvebwebjb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvebwebjb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvebwebjb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvebwebjb === 'undefined') {
    varinitmapvebwebjb = initmapvebwebjb();
  };
});
FINAL;
    } // constructor
