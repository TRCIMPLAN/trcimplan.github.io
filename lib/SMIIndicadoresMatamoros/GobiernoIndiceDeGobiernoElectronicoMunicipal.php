...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastzowbrsy">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkqzxqyji" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastzowbrsy a:first').tab('show')
});
// LENGUETA
$('#Lenguetastzowbrsy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkqzxqyji;
  ...
  function initmapkqzxqyji() {
    // Nuevo Mapa
    mapkqzxqyji = new L.Map('LeafLetkqzxqyji');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkqzxqyji.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkqzxqyji.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkqzxqyji === 'undefined') {
    varinitmapkqzxqyji = initmapkqzxqyji();
  };
});
FINAL;
    } // constructor
