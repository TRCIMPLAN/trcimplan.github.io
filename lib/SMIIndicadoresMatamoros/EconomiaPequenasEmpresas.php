...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjdchxfrq">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuowldjxp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmyucxihx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjdchxfrq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjdchxfrq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuowldjxp === 'undefined') {
    varMorrisuowldjxp = Morris.Line({
      element: 'Morrisuowldjxp',
...
// LENGUETA
$('#Lenguetasjdchxfrq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmyucxihx;
  ...
  function initmapmyucxihx() {
    // Nuevo Mapa
    mapmyucxihx = new L.Map('LeafLetmyucxihx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmyucxihx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmyucxihx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmyucxihx === 'undefined') {
    varinitmapmyucxihx = initmapmyucxihx();
  };
});
FINAL;
    } // constructor
