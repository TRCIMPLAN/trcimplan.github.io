...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbmuidgba">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishsrvtnqb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwpfemmxf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbmuidgba a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbmuidgba a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishsrvtnqb === 'undefined') {
    varMorrishsrvtnqb = Morris.Line({
      element: 'Morrishsrvtnqb',
...
// LENGUETA
$('#Lenguetasbmuidgba a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwpfemmxf;
  ...
  function initmapwpfemmxf() {
    // Nuevo Mapa
    mapwpfemmxf = new L.Map('LeafLetwpfemmxf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwpfemmxf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwpfemmxf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwpfemmxf === 'undefined') {
    varinitmapwpfemmxf = initmapwpfemmxf();
  };
});
FINAL;
    } // constructor
