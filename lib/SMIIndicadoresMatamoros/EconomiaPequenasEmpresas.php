...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastupevfav">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisllaqvcnd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastupevfav a:first').tab('show')
});
// LENGUETA
$('#Lenguetastupevfav a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisllaqvcnd === 'undefined') {
    varMorrisllaqvcnd = Morris.Line({
      element: 'Morrisllaqvcnd',
