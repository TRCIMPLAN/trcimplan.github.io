...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiuaecymn">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisktmrgenj" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcnjpuzvh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiuaecymn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiuaecymn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisktmrgenj === 'undefined') {
    varMorrisktmrgenj = Morris.Line({
      element: 'Morrisktmrgenj',
...
// LENGUETA
$('#Lenguetasiuaecymn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcnjpuzvh;
  ...
  function initmapcnjpuzvh() {
    // Nuevo Mapa
    mapcnjpuzvh = new L.Map('LeafLetcnjpuzvh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcnjpuzvh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcnjpuzvh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcnjpuzvh === 'undefined') {
    varinitmapcnjpuzvh = initmapcnjpuzvh();
  };
});
FINAL;
    } // constructor
