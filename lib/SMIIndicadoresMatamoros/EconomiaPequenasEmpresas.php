...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseckouzah">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswefnluqi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseckouzah a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseckouzah a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswefnluqi === 'undefined') {
    varMorriswefnluqi = Morris.Line({
      element: 'Morriswefnluqi',
