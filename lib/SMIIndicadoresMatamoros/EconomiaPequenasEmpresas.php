...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascfgqbinb">
...
<div id="Morrisofwjuvfn" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcxvdxmww" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascfgqbinb a:first').tab('show')
});
// LENGUETA
$('#Lenguetascfgqbinb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisofwjuvfn === 'undefined') {
    varMorrisofwjuvfn = Morris.Line({
      element: 'Morrisofwjuvfn',
...
// LENGUETA
$('#Lenguetascfgqbinb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcxvdxmww;
  ...
  function initmapcxvdxmww() {
    // Nuevo Mapa
    mapcxvdxmww = new L.Map('LeafLetcxvdxmww');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcxvdxmww.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcxvdxmww.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcxvdxmww === 'undefined') {
    varinitmapcxvdxmww = initmapcxvdxmww();
  };
});
FINAL;
    } // constructor
