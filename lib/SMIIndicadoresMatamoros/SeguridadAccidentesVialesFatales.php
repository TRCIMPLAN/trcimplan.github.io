...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfnqlxdsz">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethtgjqahj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfnqlxdsz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfnqlxdsz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphtgjqahj;
  ...
  function initmaphtgjqahj() {
    // Nuevo Mapa
    maphtgjqahj = new L.Map('LeafLethtgjqahj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphtgjqahj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphtgjqahj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphtgjqahj === 'undefined') {
    varinitmaphtgjqahj = initmaphtgjqahj();
  };
});
FINAL;
    } // constructor
