...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspkuoipnm">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettnxwkhhj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspkuoipnm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspkuoipnm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptnxwkhhj;
  ...
  function initmaptnxwkhhj() {
    // Nuevo Mapa
    maptnxwkhhj = new L.Map('LeafLettnxwkhhj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptnxwkhhj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptnxwkhhj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptnxwkhhj === 'undefined') {
    varinitmaptnxwkhhj = initmaptnxwkhhj();
  };
});
FINAL;
    } // constructor
