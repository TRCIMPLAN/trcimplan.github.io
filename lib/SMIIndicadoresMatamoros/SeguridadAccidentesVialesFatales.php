...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastvjyyvxc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteowhbges" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastvjyyvxc a:first').tab('show')
});
// LENGUETA
$('#Lenguetastvjyyvxc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeowhbges;
  ...
  function initmapeowhbges() {
    // Nuevo Mapa
    mapeowhbges = new L.Map('LeafLeteowhbges');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeowhbges.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeowhbges.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeowhbges === 'undefined') {
    varinitmapeowhbges = initmapeowhbges();
  };
});
FINAL;
    } // constructor
