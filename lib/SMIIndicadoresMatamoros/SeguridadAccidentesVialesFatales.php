...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasegswxvon">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcdvufpzb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasegswxvon a:first').tab('show')
});
// LENGUETA
$('#Lenguetasegswxvon a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcdvufpzb;
  ...
  function initmapcdvufpzb() {
    // Nuevo Mapa
    mapcdvufpzb = new L.Map('LeafLetcdvufpzb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcdvufpzb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcdvufpzb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcdvufpzb === 'undefined') {
    varinitmapcdvufpzb = initmapcdvufpzb();
  };
});
FINAL;
    } // constructor
