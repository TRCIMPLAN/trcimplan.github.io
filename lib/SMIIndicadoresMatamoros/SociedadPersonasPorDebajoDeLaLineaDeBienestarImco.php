<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPersonasPorDebajoDeLaLineaDeBienestarImco
 *
...
class SociedadPersonasPorDebajoDeLaLineaDeBienestarImco extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas por Debajo de la Línea de Bienestar (IMCO) en Matamoros';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2016-12-31', 'valor' => '8791', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 cambió a "cantidad" de Personas que ganan menos de lo establecido por CONEVAL')); // formateado 0, valor 12, crudo 7
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2018-12-31', 'valor' => '17.8900', 'fuente_nombre' => 'IMCO'));
    } // otras_regiones
