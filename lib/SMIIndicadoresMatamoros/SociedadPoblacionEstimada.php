...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiyitxkmc">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyimutprh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrberelyl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiyitxkmc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiyitxkmc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyimutprh === 'undefined') {
    varMorrisyimutprh = Morris.Line({
      element: 'Morrisyimutprh',
...
// LENGUETA
$('#Lenguetasiyitxkmc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprberelyl;
  ...
  function initmaprberelyl() {
    // Nuevo Mapa
    maprberelyl = new L.Map('LeafLetrberelyl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprberelyl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprberelyl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprberelyl === 'undefined') {
    varinitmaprberelyl = initmaprberelyl();
  };
});
FINAL;
    } // constructor
