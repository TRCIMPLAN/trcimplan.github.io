...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasphijhswj">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjqdzeowa" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasphijhswj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasphijhswj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjqdzeowa === 'undefined') {
    varMorrisjqdzeowa = Morris.Line({
      element: 'Morrisjqdzeowa',
