...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxmwoxbjq">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismeqtqleo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxmwoxbjq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxmwoxbjq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismeqtqleo === 'undefined') {
    varMorrismeqtqleo = Morris.Line({
      element: 'Morrismeqtqleo',
