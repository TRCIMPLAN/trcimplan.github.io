...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasozohosta">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisszddptnc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbtnpipnw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasozohosta a:first').tab('show')
});
// LENGUETA
$('#Lenguetasozohosta a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisszddptnc === 'undefined') {
    varMorrisszddptnc = Morris.Line({
      element: 'Morrisszddptnc',
...
// LENGUETA
$('#Lenguetasozohosta a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbtnpipnw;
  ...
  function initmapbtnpipnw() {
    // Nuevo Mapa
    mapbtnpipnw = new L.Map('LeafLetbtnpipnw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbtnpipnw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbtnpipnw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbtnpipnw === 'undefined') {
    varinitmapbtnpipnw = initmapbtnpipnw();
  };
});
FINAL;
    } // constructor
