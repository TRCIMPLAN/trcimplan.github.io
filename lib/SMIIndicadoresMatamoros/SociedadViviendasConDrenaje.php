...
class SociedadViviendasConDrenaje extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascctdcsbi">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetelpikjun" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascctdcsbi a:first').tab('show')
});
// LENGUETA
$('#Lenguetascctdcsbi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapelpikjun;
  ...
  function initmapelpikjun() {
    // Nuevo Mapa
    mapelpikjun = new L.Map('LeafLetelpikjun');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapelpikjun.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapelpikjun.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapelpikjun === 'undefined') {
    varinitmapelpikjun = initmapelpikjun();
  };
});
FINAL;
    } // constructor
