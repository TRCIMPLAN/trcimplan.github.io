...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasurrsivmu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrxpssmqi" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetidesieix" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasurrsivmu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasurrsivmu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrxpssmqi === 'undefined') {
    varMorrisrxpssmqi = Morris.Line({
      element: 'Morrisrxpssmqi',
...
// LENGUETA
$('#Lenguetasurrsivmu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapidesieix;
  ...
  function initmapidesieix() {
    // Nuevo Mapa
    mapidesieix = new L.Map('LeafLetidesieix');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapidesieix.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapidesieix.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapidesieix === 'undefined') {
    varinitmapidesieix = initmapidesieix();
  };
});
FINAL;
    } // constructor
