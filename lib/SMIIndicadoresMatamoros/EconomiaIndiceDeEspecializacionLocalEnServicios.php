...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbjtknjkt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxtxcelep" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbjtknjkt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbjtknjkt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxtxcelep === 'undefined') {
    varMorrisxtxcelep = Morris.Line({
      element: 'Morrisxtxcelep',
