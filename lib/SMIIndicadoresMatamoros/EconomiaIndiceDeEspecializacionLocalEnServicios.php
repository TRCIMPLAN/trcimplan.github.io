...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiieqyppk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgubsitkh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjddurbun" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiieqyppk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiieqyppk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgubsitkh === 'undefined') {
    varMorrisgubsitkh = Morris.Line({
      element: 'Morrisgubsitkh',
...
// LENGUETA
$('#Lenguetasiieqyppk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjddurbun;
  ...
  function initmapjddurbun() {
    // Nuevo Mapa
    mapjddurbun = new L.Map('LeafLetjddurbun');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjddurbun.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjddurbun.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjddurbun === 'undefined') {
    varinitmapjddurbun = initmapjddurbun();
  };
});
FINAL;
    } // constructor
