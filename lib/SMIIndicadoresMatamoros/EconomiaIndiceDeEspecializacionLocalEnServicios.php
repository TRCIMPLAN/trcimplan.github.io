...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmqbesqkc">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjdagodeq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetekcfkbya" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmqbesqkc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmqbesqkc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjdagodeq === 'undefined') {
    varMorrisjdagodeq = Morris.Line({
      element: 'Morrisjdagodeq',
...
// LENGUETA
$('#Lenguetasmqbesqkc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapekcfkbya;
  ...
  function initmapekcfkbya() {
    // Nuevo Mapa
    mapekcfkbya = new L.Map('LeafLetekcfkbya');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapekcfkbya.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapekcfkbya.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapekcfkbya === 'undefined') {
    varinitmapekcfkbya = initmapekcfkbya();
  };
});
FINAL;
    } // constructor
