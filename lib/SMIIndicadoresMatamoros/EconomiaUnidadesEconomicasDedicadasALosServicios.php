...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqobpswlo">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismrnwsaud" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetldvuskog" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqobpswlo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqobpswlo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismrnwsaud === 'undefined') {
    varMorrismrnwsaud = Morris.Line({
      element: 'Morrismrnwsaud',
...
// LENGUETA
$('#Lenguetasqobpswlo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapldvuskog;
  ...
  function initmapldvuskog() {
    // Nuevo Mapa
    mapldvuskog = new L.Map('LeafLetldvuskog');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapldvuskog.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapldvuskog.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapldvuskog === 'undefined') {
    varinitmapldvuskog = initmapldvuskog();
  };
});
FINAL;
    } // constructor
