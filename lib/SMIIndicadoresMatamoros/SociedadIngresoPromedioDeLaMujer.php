<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Ingreso Promedio de la Mujer (Creado por Central:SmiLanzadera)
 *
...
<p>Unidades: 1 es la igualdad entre salario de hombre y mujer. Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Ingreso Promedio de la Mujer en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.0000 },{ fecha: '2009-12-31', dato: 0.9000 },{ fecha: '2010-12-31', dato: 0.9000 },{ fecha: '2011-12-31', dato: 0.9000 },{ fecha: '2012-12-31', dato: 1.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
