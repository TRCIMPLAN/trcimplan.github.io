...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszetsvrmh">
...
<b>Unidad:</b> Litros por segundo por cada mil habitantes.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpzwzrqah" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszetsvrmh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszetsvrmh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappzwzrqah;
  ...
  function initmappzwzrqah() {
    // Nuevo Mapa
    mappzwzrqah = new L.Map('LeafLetpzwzrqah');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappzwzrqah.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappzwzrqah.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappzwzrqah === 'undefined') {
    varinitmappzwzrqah = initmappzwzrqah();
  };
});
FINAL;
    } // constructor
