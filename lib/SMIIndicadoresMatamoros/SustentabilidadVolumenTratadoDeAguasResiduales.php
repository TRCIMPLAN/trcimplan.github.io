...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjkjfruvd">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxcekojtb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjkjfruvd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjkjfruvd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxcekojtb;
  ...
  function initmapxcekojtb() {
    // Nuevo Mapa
    mapxcekojtb = new L.Map('LeafLetxcekojtb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxcekojtb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxcekojtb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxcekojtb === 'undefined') {
    varinitmapxcekojtb = initmapxcekojtb();
  };
});
FINAL;
    } // constructor
