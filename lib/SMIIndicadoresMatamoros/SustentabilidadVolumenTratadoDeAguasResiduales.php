...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyanztkzh">
...
<b>Unidad:</b> Litros por segundo por cada mil habitantes.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlstqjpnp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyanztkzh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyanztkzh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplstqjpnp;
  ...
  function initmaplstqjpnp() {
    // Nuevo Mapa
    maplstqjpnp = new L.Map('LeafLetlstqjpnp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplstqjpnp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplstqjpnp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplstqjpnp === 'undefined') {
    varinitmaplstqjpnp = initmaplstqjpnp();
  };
});
FINAL;
    } // constructor
