...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgjxxwqqv">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzufwknbm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgjxxwqqv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgjxxwqqv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzufwknbm;
  ...
  function initmapzufwknbm() {
    // Nuevo Mapa
    mapzufwknbm = new L.Map('LeafLetzufwknbm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzufwknbm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzufwknbm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzufwknbm === 'undefined') {
    varinitmapzufwknbm = initmapzufwknbm();
  };
});
FINAL;
    } // constructor
