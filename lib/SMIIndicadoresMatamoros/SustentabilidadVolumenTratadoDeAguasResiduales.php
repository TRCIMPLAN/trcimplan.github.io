...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastvypfkyb">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbrxfxuwk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastvypfkyb a:first').tab('show')
});
// LENGUETA
$('#Lenguetastvypfkyb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbrxfxuwk;
  ...
  function initmapbrxfxuwk() {
    // Nuevo Mapa
    mapbrxfxuwk = new L.Map('LeafLetbrxfxuwk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbrxfxuwk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbrxfxuwk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbrxfxuwk === 'undefined') {
    varinitmapbrxfxuwk = initmapbrxfxuwk();
  };
});
FINAL;
    } // constructor
