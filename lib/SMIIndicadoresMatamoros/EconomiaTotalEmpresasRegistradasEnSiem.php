<?php
/**
 * EconomiaTotalEmpresasRegistradasEnSiem.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaTotalEmpresasRegistradasEnSiem
 */
class EconomiaTotalEmpresasRegistradasEnSiem extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiatotal-empresas-registradas-en-siem';
        $this->descripcion  = '';
...
Datos obtenidos de <a href="http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1">SIEM</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Total de Empresas registradas en el SIEM en Matamoros</h3>
