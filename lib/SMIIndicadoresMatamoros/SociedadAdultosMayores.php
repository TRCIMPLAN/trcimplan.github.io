...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdevfhgma">
...
<div id="Morriswspcqnyj" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuuungylo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdevfhgma a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdevfhgma a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswspcqnyj === 'undefined') {
    varMorriswspcqnyj = Morris.Line({
      element: 'Morriswspcqnyj',
...
// LENGUETA
$('#Lenguetasdevfhgma a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuuungylo;
  ...
  function initmapuuungylo() {
    // Nuevo Mapa
    mapuuungylo = new L.Map('LeafLetuuungylo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuuungylo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuuungylo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuuungylo === 'undefined') {
    varinitmapuuungylo = initmapuuungylo();
  };
});
FINAL;
    } // constructor
