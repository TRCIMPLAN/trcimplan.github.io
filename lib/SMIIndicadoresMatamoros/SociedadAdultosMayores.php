...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbaxvvmek">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisemimckoc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbaxvvmek a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbaxvvmek a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisemimckoc === 'undefined') {
    varMorrisemimckoc = Morris.Line({
      element: 'Morrisemimckoc',
