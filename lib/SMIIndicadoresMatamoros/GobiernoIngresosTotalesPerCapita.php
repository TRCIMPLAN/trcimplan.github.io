...
class GobiernoIngresosTotalesPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnhkyweav">
...
<div id="Morrisbmilabrl" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzkdxqihx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnhkyweav a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnhkyweav a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbmilabrl === 'undefined') {
    varMorrisbmilabrl = Morris.Line({
      element: 'Morrisbmilabrl',
...
// LENGUETA
$('#Lenguetasnhkyweav a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzkdxqihx;
  ...
  function initmapzkdxqihx() {
    // Nuevo Mapa
    mapzkdxqihx = new L.Map('LeafLetzkdxqihx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzkdxqihx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzkdxqihx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzkdxqihx === 'undefined') {
    varinitmapzkdxqihx = initmapzkdxqihx();
  };
});
FINAL;
    } // constructor
