...
class GobiernoIngresosTotalesPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbxogegup">
...
<div id="Morrisxmbrpnnj" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetygfhqhze" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbxogegup a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbxogegup a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxmbrpnnj === 'undefined') {
    varMorrisxmbrpnnj = Morris.Line({
      element: 'Morrisxmbrpnnj',
...
// LENGUETA
$('#Lenguetasbxogegup a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapygfhqhze;
  ...
  function initmapygfhqhze() {
    // Nuevo Mapa
    mapygfhqhze = new L.Map('LeafLetygfhqhze');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapygfhqhze.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapygfhqhze.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapygfhqhze === 'undefined') {
    varinitmapygfhqhze = initmapygfhqhze();
  };
});
FINAL;
    } // constructor
