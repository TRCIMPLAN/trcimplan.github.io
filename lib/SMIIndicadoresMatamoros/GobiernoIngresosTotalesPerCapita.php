...
class GobiernoIngresosTotalesPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqhzccsgt">
...
<div id="Morrisscxqviyz" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlticsgzo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqhzccsgt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqhzccsgt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisscxqviyz === 'undefined') {
    varMorrisscxqviyz = Morris.Line({
      element: 'Morrisscxqviyz',
...
// LENGUETA
$('#Lenguetasqhzccsgt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplticsgzo;
  ...
  function initmaplticsgzo() {
    // Nuevo Mapa
    maplticsgzo = new L.Map('LeafLetlticsgzo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplticsgzo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplticsgzo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplticsgzo === 'undefined') {
    varinitmaplticsgzo = initmaplticsgzo();
  };
});
FINAL;
    } // constructor
