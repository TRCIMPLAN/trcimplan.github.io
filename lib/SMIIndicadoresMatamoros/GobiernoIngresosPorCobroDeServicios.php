...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastgxkowpq">
...
<div id="Morrisldotkqbi" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcczsqnbp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastgxkowpq a:first').tab('show')
});
// LENGUETA
$('#Lenguetastgxkowpq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisldotkqbi === 'undefined') {
    varMorrisldotkqbi = Morris.Line({
      element: 'Morrisldotkqbi',
...
// LENGUETA
$('#Lenguetastgxkowpq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcczsqnbp;
  ...
  function initmapcczsqnbp() {
    // Nuevo Mapa
    mapcczsqnbp = new L.Map('LeafLetcczsqnbp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcczsqnbp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcczsqnbp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcczsqnbp === 'undefined') {
    varinitmapcczsqnbp = initmapcczsqnbp();
  };
});
FINAL;
    } // constructor
