...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashkqukntg">
...
<div id="Morrislcbpfeph" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrknddzks" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashkqukntg a:first').tab('show')
});
// LENGUETA
$('#Lenguetashkqukntg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislcbpfeph === 'undefined') {
    varMorrislcbpfeph = Morris.Line({
      element: 'Morrislcbpfeph',
...
// LENGUETA
$('#Lenguetashkqukntg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprknddzks;
  ...
  function initmaprknddzks() {
    // Nuevo Mapa
    maprknddzks = new L.Map('LeafLetrknddzks');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprknddzks.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprknddzks.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprknddzks === 'undefined') {
    varinitmaprknddzks = initmaprknddzks();
  };
});
FINAL;
    } // constructor
