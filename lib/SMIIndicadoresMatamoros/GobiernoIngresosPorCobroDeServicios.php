...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseqwgzywk">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisemiqaoti" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseqwgzywk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseqwgzywk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisemiqaoti === 'undefined') {
    varMorrisemiqaoti = Morris.Line({
      element: 'Morrisemiqaoti',
