...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashklbyssa">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdraowbfp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashklbyssa a:first').tab('show')
});
// LENGUETA
$('#Lenguetashklbyssa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdraowbfp === 'undefined') {
    varMorrisdraowbfp = Morris.Line({
      element: 'Morrisdraowbfp',
