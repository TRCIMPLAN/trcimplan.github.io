...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdfiolkcb">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcsdgpeyo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdfiolkcb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdfiolkcb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcsdgpeyo;
  ...
  function initmapcsdgpeyo() {
    // Nuevo Mapa
    mapcsdgpeyo = new L.Map('LeafLetcsdgpeyo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcsdgpeyo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcsdgpeyo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcsdgpeyo === 'undefined') {
    varinitmapcsdgpeyo = initmapcsdgpeyo();
  };
});
FINAL;
    } // constructor
