...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassvnwsqjh">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbkscyaln" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassvnwsqjh a:first').tab('show')
});
// LENGUETA
$('#Lenguetassvnwsqjh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbkscyaln;
  ...
  function initmapbkscyaln() {
    // Nuevo Mapa
    mapbkscyaln = new L.Map('LeafLetbkscyaln');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbkscyaln.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbkscyaln.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbkscyaln === 'undefined') {
    varinitmapbkscyaln = initmapbkscyaln();
  };
});
FINAL;
    } // constructor
