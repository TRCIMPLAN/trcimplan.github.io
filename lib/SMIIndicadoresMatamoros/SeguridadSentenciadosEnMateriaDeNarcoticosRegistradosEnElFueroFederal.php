...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmehtkric">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfcgobmqd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmehtkric a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmehtkric a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfcgobmqd;
  ...
  function initmapfcgobmqd() {
    // Nuevo Mapa
    mapfcgobmqd = new L.Map('LeafLetfcgobmqd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfcgobmqd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfcgobmqd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfcgobmqd === 'undefined') {
    varinitmapfcgobmqd = initmapfcgobmqd();
  };
});
FINAL;
    } // constructor
