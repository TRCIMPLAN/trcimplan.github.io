...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasayrbqbbz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxbuwipmu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasayrbqbbz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasayrbqbbz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxbuwipmu;
  ...
  function initmapxbuwipmu() {
    // Nuevo Mapa
    mapxbuwipmu = new L.Map('LeafLetxbuwipmu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxbuwipmu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxbuwipmu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxbuwipmu === 'undefined') {
    varinitmapxbuwipmu = initmapxbuwipmu();
  };
});
FINAL;
    } // constructor
