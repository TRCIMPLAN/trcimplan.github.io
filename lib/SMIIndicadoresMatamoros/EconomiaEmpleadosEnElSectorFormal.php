<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Empleados en el Sector Formal (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpleadosEnElSectorFormal extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empleados en el Sector Formal en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 74.6192 },{ fecha: '2009-12-31', dato: 63.8691 },{ fecha: '2010-12-31', dato: 52.6047 },{ fecha: '2011-12-31', dato: 47.5995 },{ fecha: '2012-12-31', dato: 46.0290 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
