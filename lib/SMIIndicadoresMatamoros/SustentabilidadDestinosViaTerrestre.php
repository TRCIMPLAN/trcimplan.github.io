...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrxyjrxti">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpwgezzpl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrxyjrxti a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrxyjrxti a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappwgezzpl;
  ...
  function initmappwgezzpl() {
    // Nuevo Mapa
    mappwgezzpl = new L.Map('LeafLetpwgezzpl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappwgezzpl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappwgezzpl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappwgezzpl === 'undefined') {
    varinitmappwgezzpl = initmappwgezzpl();
  };
});
FINAL;
    } // constructor
