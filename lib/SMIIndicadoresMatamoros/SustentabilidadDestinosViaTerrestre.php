...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgbzqsvyx">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethlvgupxc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgbzqsvyx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgbzqsvyx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphlvgupxc;
  ...
  function initmaphlvgupxc() {
    // Nuevo Mapa
    maphlvgupxc = new L.Map('LeafLethlvgupxc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphlvgupxc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphlvgupxc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphlvgupxc === 'undefined') {
    varinitmaphlvgupxc = initmaphlvgupxc();
  };
});
FINAL;
    } // constructor
