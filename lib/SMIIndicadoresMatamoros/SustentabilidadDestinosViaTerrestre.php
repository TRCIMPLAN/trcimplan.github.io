...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoidyxnfh">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfxtwhnhy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoidyxnfh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoidyxnfh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfxtwhnhy;
  ...
  function initmapfxtwhnhy() {
    // Nuevo Mapa
    mapfxtwhnhy = new L.Map('LeafLetfxtwhnhy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfxtwhnhy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfxtwhnhy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfxtwhnhy === 'undefined') {
    varinitmapfxtwhnhy = initmapfxtwhnhy();
  };
});
FINAL;
    } // constructor
