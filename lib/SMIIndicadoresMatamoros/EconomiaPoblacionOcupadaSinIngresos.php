<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Población Ocupada Sin Ingresos (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje de la población ocupada</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Población Ocupada Sin Ingresos en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 11.8900 },{ fecha: '2009-12-31', dato: 2.3500 },{ fecha: '2010-12-31', dato: 3.0400 },{ fecha: '2011-12-31', dato: 7.2300 },{ fecha: '2012-12-31', dato: 7.9300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
