<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadNuevasViviendasVerticales
 *
...
class SociedadNuevasViviendasVerticales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nuevas viviendas verticales en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '4.4100', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
