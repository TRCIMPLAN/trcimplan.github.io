<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Crecimiento en Acceso a Servicios de Salud (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Acceso a Servicios de Salud en Matamoros</h3>
