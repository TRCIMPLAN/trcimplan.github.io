...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 5.1100 },{ region: 'Gómez Palacio', dato: 7.0100 },{ region: 'Lerdo', dato: 6.0100 },{ region: 'Matamoros', dato: 3.6100 },{ region: 'La Laguna', dato: 5.8700 },{ region: 'Coahuila', dato: 5.3025 },{ region: 'Durango', dato: 4.7994 },{ region: 'Nacional', dato: 4.3472 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
