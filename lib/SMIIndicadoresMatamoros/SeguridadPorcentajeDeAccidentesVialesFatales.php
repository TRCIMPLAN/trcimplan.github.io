...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdwgxmaly">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdyicjvfj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdwgxmaly a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdwgxmaly a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdyicjvfj;
  ...
  function initmapdyicjvfj() {
    // Nuevo Mapa
    mapdyicjvfj = new L.Map('LeafLetdyicjvfj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdyicjvfj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdyicjvfj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdyicjvfj === 'undefined') {
    varinitmapdyicjvfj = initmapdyicjvfj();
  };
});
FINAL;
    } // constructor
