...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasslitqmaj">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetubxalroo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasslitqmaj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasslitqmaj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapubxalroo;
  ...
  function initmapubxalroo() {
    // Nuevo Mapa
    mapubxalroo = new L.Map('LeafLetubxalroo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapubxalroo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapubxalroo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapubxalroo === 'undefined') {
    varinitmapubxalroo = initmapubxalroo();
  };
});
FINAL;
    } // constructor
