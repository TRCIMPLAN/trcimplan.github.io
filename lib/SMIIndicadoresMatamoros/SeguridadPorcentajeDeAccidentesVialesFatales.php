...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnubhtevf">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetefclwiyv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnubhtevf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnubhtevf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapefclwiyv;
  ...
  function initmapefclwiyv() {
    // Nuevo Mapa
    mapefclwiyv = new L.Map('LeafLetefclwiyv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapefclwiyv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapefclwiyv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapefclwiyv === 'undefined') {
    varinitmapefclwiyv = initmapefclwiyv();
  };
});
FINAL;
    } // constructor
