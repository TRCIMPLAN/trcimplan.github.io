...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyxfifwuc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaenasrht" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyxfifwuc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyxfifwuc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaenasrht;
  ...
  function initmapaenasrht() {
    // Nuevo Mapa
    mapaenasrht = new L.Map('LeafLetaenasrht');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaenasrht.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaenasrht.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaenasrht === 'undefined') {
    varinitmapaenasrht = initmapaenasrht();
  };
});
FINAL;
    } // constructor
