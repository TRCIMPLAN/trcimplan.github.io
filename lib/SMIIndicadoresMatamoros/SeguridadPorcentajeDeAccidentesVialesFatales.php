...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseokmzbej">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzmebxvpt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseokmzbej a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseokmzbej a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzmebxvpt;
  ...
  function initmapzmebxvpt() {
    // Nuevo Mapa
    mapzmebxvpt = new L.Map('LeafLetzmebxvpt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzmebxvpt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzmebxvpt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzmebxvpt === 'undefined') {
    varinitmapzmebxvpt = initmapzmebxvpt();
  };
});
FINAL;
    } // constructor
