...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tamaño del Mercado Hipotecario en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.7990 },{ fecha: '2009-12-31', dato: 1.7849 },{ fecha: '2010-12-31', dato: 1.7709 },{ fecha: '2011-12-31', dato: 2.9561 },{ fecha: '2012-12-31', dato: 3.5920 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
