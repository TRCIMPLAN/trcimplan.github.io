...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassxwefscf">
...
<div id="Morrisviwvohtc" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnohhljsz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassxwefscf a:first').tab('show')
});
// LENGUETA
$('#Lenguetassxwefscf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisviwvohtc === 'undefined') {
    varMorrisviwvohtc = Morris.Line({
      element: 'Morrisviwvohtc',
...
// LENGUETA
$('#Lenguetassxwefscf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnohhljsz;
  ...
  function initmapnohhljsz() {
    // Nuevo Mapa
    mapnohhljsz = new L.Map('LeafLetnohhljsz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnohhljsz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnohhljsz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnohhljsz === 'undefined') {
    varinitmapnohhljsz = initmapnohhljsz();
  };
});
FINAL;
    } // constructor
