...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdhybpalk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgxxyglrz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdhybpalk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdhybpalk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgxxyglrz === 'undefined') {
    varMorrisgxxyglrz = Morris.Line({
      element: 'Morrisgxxyglrz',
