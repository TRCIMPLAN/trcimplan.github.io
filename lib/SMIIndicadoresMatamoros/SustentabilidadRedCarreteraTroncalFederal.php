...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascgurlagc">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnsgqigti" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascgurlagc a:first').tab('show')
});
// LENGUETA
$('#Lenguetascgurlagc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnsgqigti;
  ...
  function initmapnsgqigti() {
    // Nuevo Mapa
    mapnsgqigti = new L.Map('LeafLetnsgqigti');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnsgqigti.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnsgqigti.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnsgqigti === 'undefined') {
    varinitmapnsgqigti = initmapnsgqigti();
  };
});
FINAL;
    } // constructor
