<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPoblacionConEducacionSuperior
 *
...
class SociedadPoblacionConEducacionSuperior extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con educación superior en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '11.1100', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
