...
class GobiernoCapacidadFinanciera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrdbntdnk">
...
<div id="Morriscsloiohg" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetesgrsmrn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrdbntdnk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrdbntdnk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscsloiohg === 'undefined') {
    varMorriscsloiohg = Morris.Line({
      element: 'Morriscsloiohg',
...
// LENGUETA
$('#Lenguetasrdbntdnk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapesgrsmrn;
  ...
  function initmapesgrsmrn() {
    // Nuevo Mapa
    mapesgrsmrn = new L.Map('LeafLetesgrsmrn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapesgrsmrn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapesgrsmrn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapesgrsmrn === 'undefined') {
    varinitmapesgrsmrn = initmapesgrsmrn();
  };
});
FINAL;
    } // constructor
