...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmimexwdz">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlgrpaggy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmimexwdz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmimexwdz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplgrpaggy;
  ...
  function initmaplgrpaggy() {
    // Nuevo Mapa
    maplgrpaggy = new L.Map('LeafLetlgrpaggy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplgrpaggy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplgrpaggy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplgrpaggy === 'undefined') {
    varinitmaplgrpaggy = initmaplgrpaggy();
  };
});
FINAL;
    } // constructor
