<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Seguridad Tasa de Robo de VehÍculos (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública (SESNSP) e INEGI, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tasa de Robo de VehÍculos en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.4444 },{ fecha: '2009-12-31', dato: 0.4444 },{ fecha: '2010-12-31', dato: 0.4444 },{ fecha: '2011-12-31', dato: 9.6467 },{ fecha: '2012-12-31', dato: 8.3992 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>En el Índice de Competitividad Urbana pertenece al subíndice de "Sistema de Derecho Confiable y Objetivo". Mide el número relativo de robo de vehículos en cada ciudad. Sólo se cuenta con observaciones para 2011 y 2012. Unidades: Robo de autos por cada mil vehículos registrados.</p>
