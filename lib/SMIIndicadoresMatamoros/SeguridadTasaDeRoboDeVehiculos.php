...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjgcjiqgu">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjlmetssv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjgcjiqgu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjgcjiqgu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjlmetssv;
  ...
  function initmapjlmetssv() {
    // Nuevo Mapa
    mapjlmetssv = new L.Map('LeafLetjlmetssv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjlmetssv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjlmetssv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjlmetssv === 'undefined') {
    varinitmapjlmetssv = initmapjlmetssv();
  };
});
FINAL;
    } // constructor
