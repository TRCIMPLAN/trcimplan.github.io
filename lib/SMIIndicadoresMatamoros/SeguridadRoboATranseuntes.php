...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasznkqmhtg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdasxigwe" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasznkqmhtg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasznkqmhtg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdasxigwe === 'undefined') {
    varMorrisdasxigwe = Morris.Line({
      element: 'Morrisdasxigwe',
