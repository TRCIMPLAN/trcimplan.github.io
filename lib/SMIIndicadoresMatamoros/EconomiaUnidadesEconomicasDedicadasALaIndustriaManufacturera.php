...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskhyobjse">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishihbftfz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskhyobjse a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskhyobjse a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishihbftfz === 'undefined') {
    varMorrishihbftfz = Morris.Line({
      element: 'Morrishihbftfz',
