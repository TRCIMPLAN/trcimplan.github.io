...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasepqrybcf">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszxcnchln" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetonwizdom" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasepqrybcf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasepqrybcf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszxcnchln === 'undefined') {
    varMorriszxcnchln = Morris.Line({
      element: 'Morriszxcnchln',
...
// LENGUETA
$('#Lenguetasepqrybcf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maponwizdom;
  ...
  function initmaponwizdom() {
    // Nuevo Mapa
    maponwizdom = new L.Map('LeafLetonwizdom');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maponwizdom.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maponwizdom.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaponwizdom === 'undefined') {
    varinitmaponwizdom = initmaponwizdom();
  };
});
FINAL;
    } // constructor
