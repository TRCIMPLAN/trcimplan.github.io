...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascofbmolk">
...
<div id="Morrisgbpnesqh" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvvvjjgnh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascofbmolk a:first').tab('show')
});
// LENGUETA
$('#Lenguetascofbmolk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgbpnesqh === 'undefined') {
    varMorrisgbpnesqh = Morris.Line({
      element: 'Morrisgbpnesqh',
...
// LENGUETA
$('#Lenguetascofbmolk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvvvjjgnh;
  ...
  function initmapvvvjjgnh() {
    // Nuevo Mapa
    mapvvvjjgnh = new L.Map('LeafLetvvvjjgnh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvvvjjgnh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvvvjjgnh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvvvjjgnh === 'undefined') {
    varinitmapvvvjjgnh = initmapvvvjjgnh();
  };
});
FINAL;
    } // constructor
