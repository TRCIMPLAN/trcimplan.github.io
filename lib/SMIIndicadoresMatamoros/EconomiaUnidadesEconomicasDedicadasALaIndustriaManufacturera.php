...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasacbqicjq">
...
<div id="Morrisalhemldy" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnfirdvzs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasacbqicjq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasacbqicjq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisalhemldy === 'undefined') {
    varMorrisalhemldy = Morris.Line({
      element: 'Morrisalhemldy',
...
// LENGUETA
$('#Lenguetasacbqicjq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnfirdvzs;
  ...
  function initmapnfirdvzs() {
    // Nuevo Mapa
    mapnfirdvzs = new L.Map('LeafLetnfirdvzs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnfirdvzs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnfirdvzs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnfirdvzs === 'undefined') {
    varinitmapnfirdvzs = initmapnfirdvzs();
  };
});
FINAL;
    } // constructor
