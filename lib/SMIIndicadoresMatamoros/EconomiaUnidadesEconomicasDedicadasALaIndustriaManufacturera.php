...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswexrevpu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispctaeene" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswexrevpu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswexrevpu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispctaeene === 'undefined') {
    varMorrispctaeene = Morris.Line({
      element: 'Morrispctaeene',
