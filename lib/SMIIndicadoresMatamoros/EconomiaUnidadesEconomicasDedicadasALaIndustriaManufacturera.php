...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslxrpaqzy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisldfvrevd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslxrpaqzy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslxrpaqzy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisldfvrevd === 'undefined') {
    varMorrisldfvrevd = Morris.Line({
      element: 'Morrisldfvrevd',
