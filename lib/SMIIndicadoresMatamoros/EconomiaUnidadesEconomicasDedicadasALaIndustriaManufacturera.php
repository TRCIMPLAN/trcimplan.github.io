...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnmmombzu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuoupynss" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnmmombzu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnmmombzu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuoupynss === 'undefined') {
    varMorrisuoupynss = Morris.Line({
      element: 'Morrisuoupynss',
