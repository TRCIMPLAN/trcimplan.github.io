...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjmqjnlok">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristsjlazoj" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlgzlzqbe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjmqjnlok a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjmqjnlok a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristsjlazoj === 'undefined') {
    varMorristsjlazoj = Morris.Line({
      element: 'Morristsjlazoj',
...
// LENGUETA
$('#Lenguetasjmqjnlok a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplgzlzqbe;
  ...
  function initmaplgzlzqbe() {
    // Nuevo Mapa
    maplgzlzqbe = new L.Map('LeafLetlgzlzqbe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplgzlzqbe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplgzlzqbe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplgzlzqbe === 'undefined') {
    varinitmaplgzlzqbe = initmaplgzlzqbe();
  };
});
FINAL;
    } // constructor
