<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SustentabilidadIntensidadEnergeticaEnLaEconomia
 *
...
class SustentabilidadIntensidadEnergeticaEnLaEconomia extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Intensidad Energética en la Economía en Matamoros';
        ...
        $this->claves      = 'IMPLAN, Matamoros, Índice de Competitividad Urbana, Recursos Naturales, Medio Ambiente';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '95571000.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '95571000.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '95571000.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2013-12-31', 'valor' => '96012400.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2014-12-31', 'valor' => '103925000.0000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 10, crudo 5
    } // datos
