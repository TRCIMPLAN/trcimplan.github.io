...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasewwpujcw">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxbbuirej" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasewwpujcw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasewwpujcw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxbbuirej;
  ...
  function initmapxbbuirej() {
    // Nuevo Mapa
    mapxbbuirej = new L.Map('LeafLetxbbuirej');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxbbuirej.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxbbuirej.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxbbuirej === 'undefined') {
    varinitmapxbbuirej = initmapxbbuirej();
  };
});
FINAL;
    } // constructor
