...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvkkqqefy">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmplodptt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvkkqqefy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvkkqqefy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmplodptt;
  ...
  function initmapmplodptt() {
    // Nuevo Mapa
    mapmplodptt = new L.Map('LeafLetmplodptt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmplodptt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmplodptt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmplodptt === 'undefined') {
    varinitmapmplodptt = initmapmplodptt();
  };
});
FINAL;
    } // constructor
