...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasasoeflhg">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyrlmsfye" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasasoeflhg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasasoeflhg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyrlmsfye;
  ...
  function initmapyrlmsfye() {
    // Nuevo Mapa
    mapyrlmsfye = new L.Map('LeafLetyrlmsfye');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyrlmsfye.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyrlmsfye.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyrlmsfye === 'undefined') {
    varinitmapyrlmsfye = initmapyrlmsfye();
  };
});
FINAL;
    } // constructor
