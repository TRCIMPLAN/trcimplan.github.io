...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqywxcbsn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwerhpzuw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqywxcbsn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqywxcbsn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwerhpzuw;
  ...
  function initmapwerhpzuw() {
    // Nuevo Mapa
    mapwerhpzuw = new L.Map('LeafLetwerhpzuw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwerhpzuw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwerhpzuw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwerhpzuw === 'undefined') {
    varinitmapwerhpzuw = initmapwerhpzuw();
  };
});
FINAL;
    } // constructor
