...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswztgbor">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjgdlrxro" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvbtztfgj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswztgbor a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswztgbor a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjgdlrxro === 'undefined') {
    varMorrisjgdlrxro = Morris.Line({
      element: 'Morrisjgdlrxro',
...
// LENGUETA
$('#Lenguetasswztgbor a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvbtztfgj;
  ...
  function initmapvbtztfgj() {
    // Nuevo Mapa
    mapvbtztfgj = new L.Map('LeafLetvbtztfgj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvbtztfgj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvbtztfgj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvbtztfgj === 'undefined') {
    varinitmapvbtztfgj = initmapvbtztfgj();
  };
});
FINAL;
    } // constructor
