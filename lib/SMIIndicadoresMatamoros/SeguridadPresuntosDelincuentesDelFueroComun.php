...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxokxgeax">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethkdlwyhv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxokxgeax a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxokxgeax a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphkdlwyhv;
  ...
  function initmaphkdlwyhv() {
    // Nuevo Mapa
    maphkdlwyhv = new L.Map('LeafLethkdlwyhv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphkdlwyhv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphkdlwyhv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphkdlwyhv === 'undefined') {
    varinitmaphkdlwyhv = initmaphkdlwyhv();
  };
});
FINAL;
    } // constructor
