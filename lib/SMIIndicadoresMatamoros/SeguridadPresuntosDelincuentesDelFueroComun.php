...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasavkkkxnn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcnyfwhpk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasavkkkxnn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasavkkkxnn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcnyfwhpk;
  ...
  function initmapcnyfwhpk() {
    // Nuevo Mapa
    mapcnyfwhpk = new L.Map('LeafLetcnyfwhpk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcnyfwhpk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcnyfwhpk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcnyfwhpk === 'undefined') {
    varinitmapcnyfwhpk = initmapcnyfwhpk();
  };
});
FINAL;
    } // constructor
