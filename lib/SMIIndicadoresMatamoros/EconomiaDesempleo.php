...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasocwcsfmq">
...
<div id="Morrislzcxrhnq" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvziyljkt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasocwcsfmq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasocwcsfmq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislzcxrhnq === 'undefined') {
    varMorrislzcxrhnq = Morris.Line({
      element: 'Morrislzcxrhnq',
...
// LENGUETA
$('#Lenguetasocwcsfmq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvziyljkt;
  ...
  function initmapvziyljkt() {
    // Nuevo Mapa
    mapvziyljkt = new L.Map('LeafLetvziyljkt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvziyljkt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvziyljkt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvziyljkt === 'undefined') {
    varinitmapvziyljkt = initmapvziyljkt();
  };
});
FINAL;
    } // constructor
