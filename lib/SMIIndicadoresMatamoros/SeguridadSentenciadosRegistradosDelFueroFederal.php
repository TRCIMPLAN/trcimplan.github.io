...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbfxfxfft">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfnfepoqx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbfxfxfft a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbfxfxfft a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfnfepoqx;
  ...
  function initmapfnfepoqx() {
    // Nuevo Mapa
    mapfnfepoqx = new L.Map('LeafLetfnfepoqx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfnfepoqx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfnfepoqx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfnfepoqx === 'undefined') {
    varinitmapfnfepoqx = initmapfnfepoqx();
  };
});
FINAL;
    } // constructor
