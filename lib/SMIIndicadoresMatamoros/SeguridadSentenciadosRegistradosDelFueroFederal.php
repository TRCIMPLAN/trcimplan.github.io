...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdsgrhwcs">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpytootip" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdsgrhwcs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdsgrhwcs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappytootip;
  ...
  function initmappytootip() {
    // Nuevo Mapa
    mappytootip = new L.Map('LeafLetpytootip');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappytootip.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappytootip.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappytootip === 'undefined') {
    varinitmappytootip = initmappytootip();
  };
});
FINAL;
    } // constructor
