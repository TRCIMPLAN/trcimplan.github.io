...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspixbprmo">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwjghfbcp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspixbprmo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspixbprmo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwjghfbcp;
  ...
  function initmapwjghfbcp() {
    // Nuevo Mapa
    mapwjghfbcp = new L.Map('LeafLetwjghfbcp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwjghfbcp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwjghfbcp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwjghfbcp === 'undefined') {
    varinitmapwjghfbcp = initmapwjghfbcp();
  };
});
FINAL;
    } // constructor
