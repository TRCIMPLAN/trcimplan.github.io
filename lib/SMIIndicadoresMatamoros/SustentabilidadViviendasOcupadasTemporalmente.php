...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnxdpsnev">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeturrziojq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnxdpsnev a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnxdpsnev a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapurrziojq;
  ...
  function initmapurrziojq() {
    // Nuevo Mapa
    mapurrziojq = new L.Map('LeafLeturrziojq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapurrziojq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapurrziojq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapurrziojq === 'undefined') {
    varinitmapurrziojq = initmapurrziojq();
  };
});
FINAL;
    } // constructor
