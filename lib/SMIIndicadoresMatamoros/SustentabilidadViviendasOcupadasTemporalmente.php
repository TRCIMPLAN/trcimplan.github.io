...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyaolcmhj">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcqvljxvv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyaolcmhj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyaolcmhj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcqvljxvv;
  ...
  function initmapcqvljxvv() {
    // Nuevo Mapa
    mapcqvljxvv = new L.Map('LeafLetcqvljxvv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcqvljxvv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcqvljxvv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcqvljxvv === 'undefined') {
    varinitmapcqvljxvv = initmapcqvljxvv();
  };
});
FINAL;
    } // constructor
