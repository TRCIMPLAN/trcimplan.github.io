<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SeguridadSecuestrosMensual
 *
...
class SeguridadSecuestrosMensual extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Secuestros (mensual) en Matamoros';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2018-12-31', 'valor' => '0', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 114, crudo 58
    } // datos
