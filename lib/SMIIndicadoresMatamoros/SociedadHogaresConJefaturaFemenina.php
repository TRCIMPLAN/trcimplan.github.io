...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasftdiahfr">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpofavdmm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasftdiahfr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasftdiahfr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappofavdmm;
  ...
  function initmappofavdmm() {
    // Nuevo Mapa
    mappofavdmm = new L.Map('LeafLetpofavdmm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappofavdmm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappofavdmm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappofavdmm === 'undefined') {
    varinitmappofavdmm = initmappofavdmm();
  };
});
FINAL;
    } // constructor
