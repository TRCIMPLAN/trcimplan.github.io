...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashwrimeda">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiacougjt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashwrimeda a:first').tab('show')
});
// LENGUETA
$('#Lenguetashwrimeda a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiacougjt;
  ...
  function initmapiacougjt() {
    // Nuevo Mapa
    mapiacougjt = new L.Map('LeafLetiacougjt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiacougjt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiacougjt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiacougjt === 'undefined') {
    varinitmapiacougjt = initmapiacougjt();
  };
});
FINAL;
    } // constructor
