...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasidnsssyk">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwmezvyly" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasidnsssyk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasidnsssyk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwmezvyly;
  ...
  function initmapwmezvyly() {
    // Nuevo Mapa
    mapwmezvyly = new L.Map('LeafLetwmezvyly');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwmezvyly.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwmezvyly.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwmezvyly === 'undefined') {
    varinitmapwmezvyly = initmapwmezvyly();
  };
});
FINAL;
    } // constructor
