...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgqvosdeg">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvlbfzyzl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgqvosdeg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgqvosdeg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvlbfzyzl;
  ...
  function initmapvlbfzyzl() {
    // Nuevo Mapa
    mapvlbfzyzl = new L.Map('LeafLetvlbfzyzl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvlbfzyzl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvlbfzyzl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvlbfzyzl === 'undefined') {
    varinitmapvlbfzyzl = initmapvlbfzyzl();
  };
});
FINAL;
    } // constructor
