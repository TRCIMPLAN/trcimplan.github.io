...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdqgrjqme">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethubmtcif" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdqgrjqme a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdqgrjqme a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphubmtcif;
  ...
  function initmaphubmtcif() {
    // Nuevo Mapa
    maphubmtcif = new L.Map('LeafLethubmtcif');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphubmtcif.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphubmtcif.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphubmtcif === 'undefined') {
    varinitmaphubmtcif = initmaphubmtcif();
  };
});
FINAL;
    } // constructor
