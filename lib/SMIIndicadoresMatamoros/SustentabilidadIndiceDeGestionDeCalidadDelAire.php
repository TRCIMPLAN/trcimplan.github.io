<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sustentabilidad Índice de Gestión de Calidad del Aire (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadIndiceDeGestionDeCalidadDelAire extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->descripcion       = 'Incluido en el subíndice "Manejo Sustentable del Medio Ambiente" Mide los esfuerzos que dedica la administración de la ciudad a la gestión de la calidad
del aire.
...
Fuente: IMCO, con información al 2013.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Manejo Sustentable del Medio Ambiente" Mide los esfuerzos que dedica la administración de la ciudad a la gestión de la calidad
del aire.
Unidades: Variable discreta que asigna valores de 0 a 3, según la medición de la calidad del
aire (se da el valor de: 1 si mide calidad, 2 si la reporta, 3 si cuenta con PROAIRE, 0 en otro
caso). No se penaliza a las ciudades que no tienen la obligación de medir su calidad del aire
de acuerdo con la NOM-156-SEMARNAT-2012, por lo que a ésas se les asigna el valor 3.
Fuente: IMCO, con información al 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Índice de Gestión de Calidad del Aire en Matamoros</h3>
