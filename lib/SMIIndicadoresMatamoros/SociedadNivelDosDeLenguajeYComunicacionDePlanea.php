<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadNivelDosDeLenguajeYComunicacionDePlanea
 *
...
class SociedadNivelDosDeLenguajeYComunicacionDePlanea extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nivel dos de Lenguaje y Comunicación de PLANEA en Matamoros';
...
discriminan y relacionan información oportuna y confiable, y la organizan a partir de un propósito.';
    ...
    public function datos() {
        return array(
            array('fecha' => '2017-12-31', 'valor' => '30.6800', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
