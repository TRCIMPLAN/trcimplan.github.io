...
class SociedadViviendasConInternet extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuhgjaofb">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdailsqwn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuhgjaofb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuhgjaofb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdailsqwn;
  ...
  function initmapdailsqwn() {
    // Nuevo Mapa
    mapdailsqwn = new L.Map('LeafLetdailsqwn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdailsqwn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdailsqwn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdailsqwn === 'undefined') {
    varinitmapdailsqwn = initmapdailsqwn();
  };
});
FINAL;
    } // constructor
