...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbxfuqaaa">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkuhpwnst" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbxfuqaaa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbxfuqaaa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkuhpwnst;
  ...
  function initmapkuhpwnst() {
    // Nuevo Mapa
    mapkuhpwnst = new L.Map('LeafLetkuhpwnst');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkuhpwnst.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkuhpwnst.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkuhpwnst === 'undefined') {
    varinitmapkuhpwnst = initmapkuhpwnst();
  };
});
FINAL;
    } // constructor
