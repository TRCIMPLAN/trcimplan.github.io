...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslthduhba">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwvzzcnzb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslthduhba a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslthduhba a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwvzzcnzb;
  ...
  function initmapwvzzcnzb() {
    // Nuevo Mapa
    mapwvzzcnzb = new L.Map('LeafLetwvzzcnzb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwvzzcnzb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwvzzcnzb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwvzzcnzb === 'undefined') {
    varinitmapwvzzcnzb = initmapwvzzcnzb();
  };
});
FINAL;
    } // constructor
