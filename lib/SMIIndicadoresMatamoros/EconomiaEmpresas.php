<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Empresas (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpresas extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empresas en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.1333 },{ fecha: '2009-12-31', dato: 9.9402 },{ fecha: '2010-12-31', dato: 8.8747 },{ fecha: '2011-12-31', dato: 6.9652 },{ fecha: '2012-12-31', dato: 6.4458 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
