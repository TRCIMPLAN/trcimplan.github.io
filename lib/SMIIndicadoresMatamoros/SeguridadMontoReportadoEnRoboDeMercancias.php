<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Seguridad Monto Reportado en Robo de Mercancías (Creado por Central:SmiLanzadera)
 *
...
<p>Unidades: Pesos (de 2012) por cada millón de pesos del PIB de la ciudad. Fuente: Asociación Mexicana de Instituciones de Seguros (AMIS), 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Monto Reportado en Robo de Mercancías en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.07 },{ fecha: '2009-12-31', dato: 0.10 },{ fecha: '2010-12-31', dato: 0.31 },{ fecha: '2011-12-31', dato: 0.00 },{ fecha: '2012-12-31', dato: 0.01 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
