...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasomiafmzj">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbncdooeo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasomiafmzj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasomiafmzj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbncdooeo;
  ...
  function initmapbncdooeo() {
    // Nuevo Mapa
    mapbncdooeo = new L.Map('LeafLetbncdooeo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbncdooeo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbncdooeo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbncdooeo === 'undefined') {
    varinitmapbncdooeo = initmapbncdooeo();
  };
});
FINAL;
    } // constructor
