...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyyhulgcn">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkgqkdxbr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyyhulgcn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyyhulgcn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkgqkdxbr;
  ...
  function initmapkgqkdxbr() {
    // Nuevo Mapa
    mapkgqkdxbr = new L.Map('LeafLetkgqkdxbr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkgqkdxbr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkgqkdxbr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkgqkdxbr === 'undefined') {
    varinitmapkgqkdxbr = initmapkgqkdxbr();
  };
});
FINAL;
    } // constructor
