...
class SociedadPobrezaModerada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxcztdghf">
...
Consulta la [Base de Datos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdqedpwec" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxcztdghf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxcztdghf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdqedpwec;
  ...
  function initmapdqedpwec() {
    // Nuevo Mapa
    mapdqedpwec = new L.Map('LeafLetdqedpwec');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdqedpwec.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdqedpwec.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdqedpwec === 'undefined') {
    varinitmapdqedpwec = initmapdqedpwec();
  };
});
FINAL;
    } // constructor
