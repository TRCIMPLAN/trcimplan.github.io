...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszcuthgzt">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisivpcqzcw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszcuthgzt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszcuthgzt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisivpcqzcw === 'undefined') {
    varMorrisivpcqzcw = Morris.Line({
      element: 'Morrisivpcqzcw',
