...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyneprnof">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseilegtlr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyneprnof a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyneprnof a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseilegtlr === 'undefined') {
    varMorriseilegtlr = Morris.Line({
      element: 'Morriseilegtlr',
