...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjtzqalxx">
...
<div id="Morrisovaodert" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfrqaxwib" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjtzqalxx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjtzqalxx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisovaodert === 'undefined') {
    varMorrisovaodert = Morris.Line({
      element: 'Morrisovaodert',
...
// LENGUETA
$('#Lenguetasjtzqalxx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfrqaxwib;
  ...
  function initmapfrqaxwib() {
    // Nuevo Mapa
    mapfrqaxwib = new L.Map('LeafLetfrqaxwib');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfrqaxwib.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfrqaxwib.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfrqaxwib === 'undefined') {
    varinitmapfrqaxwib = initmapfrqaxwib();
  };
});
FINAL;
    } // constructor
