...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2011-12-31', dato: 55.7400 },{ fecha: '2012-03-31', dato: 53.4500 },{ fecha: '2012-06-30', dato: 57.2900 },{ fecha: '2012-09-30', dato: 56.4200 },{ fecha: '2012-12-31', dato: 51.9200 },{ fecha: '2013-03-31', dato: 50.0000 },{ fecha: '2013-06-30', dato: 49.3300 },{ fecha: '2013-09-30', dato: 51.3500 },{ fecha: '2013-12-31', dato: 56.4500 },{ fecha: '2014-03-31', dato: 48.1500 },{ fecha: '2014-06-30', dato: 60.4000 },{ fecha: '2014-09-30', dato: 55.0600 },{ fecha: '2014-12-31', dato: 56.9200 },{ fecha: '2015-03-31', dato: 56.4500 },{ fecha: '2015-06-30', dato: 52.3077 },{ fecha: '2015-09-30', dato: 59.4203 },{ fecha: '2015-12-31', dato: 44.6602 },{ fecha: '2016-03-31', dato: 43.6893 },{ fecha: '2016-06-30', dato: 51.2200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 41.4100 },{ region: 'Gómez Palacio', dato: 41.9300 },{ region: 'Lerdo', dato: 50.0000 },{ region: 'Matamoros', dato: 51.2200 },{ region: 'La Laguna', dato: 41.9600 },{ region: 'Coahuila', dato: 36.8100 },{ region: 'Durango', dato: 53.8600 },{ region: 'Nacional', dato: 57.1800 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
