<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Escuelas de Calidad (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 3.3000 },{ fecha: '2009-12-31', dato: 3.3000 },{ fecha: '2010-12-31', dato: 3.1900 },{ fecha: '2011-12-31', dato: 1.0600 },{ fecha: '2012-12-31', dato: 3.2300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
