...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasivpokkvy">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzeeabrob" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasivpokkvy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasivpokkvy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzeeabrob;
  ...
  function initmapzeeabrob() {
    // Nuevo Mapa
    mapzeeabrob = new L.Map('LeafLetzeeabrob');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzeeabrob.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzeeabrob.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzeeabrob === 'undefined') {
    varinitmapzeeabrob = initmapzeeabrob();
  };
});
FINAL;
    } // constructor
