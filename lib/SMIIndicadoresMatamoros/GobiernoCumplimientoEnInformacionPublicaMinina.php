...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassmokcewi">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgsdpdagz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassmokcewi a:first').tab('show')
});
// LENGUETA
$('#Lenguetassmokcewi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgsdpdagz;
  ...
  function initmapgsdpdagz() {
    // Nuevo Mapa
    mapgsdpdagz = new L.Map('LeafLetgsdpdagz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgsdpdagz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgsdpdagz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgsdpdagz === 'undefined') {
    varinitmapgsdpdagz = initmapgsdpdagz();
  };
});
FINAL;
    } // constructor
