...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasduazsjay">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrkkxnhai" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasduazsjay a:first').tab('show')
});
// LENGUETA
$('#Lenguetasduazsjay a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprkkxnhai;
  ...
  function initmaprkkxnhai() {
    // Nuevo Mapa
    maprkkxnhai = new L.Map('LeafLetrkkxnhai');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprkkxnhai.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprkkxnhai.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprkkxnhai === 'undefined') {
    varinitmaprkkxnhai = initmaprkkxnhai();
  };
});
FINAL;
    } // constructor
