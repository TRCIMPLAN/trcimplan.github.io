...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasypkutcmw">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjdmvoeyc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasypkutcmw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasypkutcmw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjdmvoeyc;
  ...
  function initmapjdmvoeyc() {
    // Nuevo Mapa
    mapjdmvoeyc = new L.Map('LeafLetjdmvoeyc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjdmvoeyc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjdmvoeyc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjdmvoeyc === 'undefined') {
    varinitmapjdmvoeyc = initmapjdmvoeyc();
  };
});
FINAL;
    } // constructor
