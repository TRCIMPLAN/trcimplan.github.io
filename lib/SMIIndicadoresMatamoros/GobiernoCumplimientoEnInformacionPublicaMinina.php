...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslxzfqkwz">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuwwtifyz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslxzfqkwz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslxzfqkwz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuwwtifyz;
  ...
  function initmapuwwtifyz() {
    // Nuevo Mapa
    mapuwwtifyz = new L.Map('LeafLetuwwtifyz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuwwtifyz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuwwtifyz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuwwtifyz === 'undefined') {
    varinitmapuwwtifyz = initmapuwwtifyz();
  };
});
FINAL;
    } // constructor
