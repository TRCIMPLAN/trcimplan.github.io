...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrfekbmsq">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnlkoonos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzynpbskz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrfekbmsq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrfekbmsq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnlkoonos === 'undefined') {
    varMorrisnlkoonos = Morris.Line({
      element: 'Morrisnlkoonos',
...
// LENGUETA
$('#Lenguetasrfekbmsq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzynpbskz;
  ...
  function initmapzynpbskz() {
    // Nuevo Mapa
    mapzynpbskz = new L.Map('LeafLetzynpbskz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzynpbskz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzynpbskz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzynpbskz === 'undefined') {
    varinitmapzynpbskz = initmapzynpbskz();
  };
});
FINAL;
    } // constructor
