...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfndkmkhe">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgdjpnowb" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfndkmkhe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfndkmkhe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgdjpnowb === 'undefined') {
    varMorrisgdjpnowb = Morris.Line({
      element: 'Morrisgdjpnowb',
