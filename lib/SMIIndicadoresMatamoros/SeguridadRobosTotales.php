...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskgcxkihb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissrbagmmn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjtcypyvl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskgcxkihb a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskgcxkihb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissrbagmmn === 'undefined') {
    varMorrissrbagmmn = Morris.Line({
      element: 'Morrissrbagmmn',
...
// LENGUETA
$('#Lenguetaskgcxkihb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjtcypyvl;
  ...
  function initmapjtcypyvl() {
    // Nuevo Mapa
    mapjtcypyvl = new L.Map('LeafLetjtcypyvl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjtcypyvl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjtcypyvl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjtcypyvl === 'undefined') {
    varinitmapjtcypyvl = initmapjtcypyvl();
  };
});
FINAL;
    } // constructor
