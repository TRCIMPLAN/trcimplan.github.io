...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasghthbstg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisduyruadi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasghthbstg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasghthbstg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisduyruadi === 'undefined') {
    varMorrisduyruadi = Morris.Line({
      element: 'Morrisduyruadi',
