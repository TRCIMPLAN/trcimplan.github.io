...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseuoftjjk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdvcfbiob" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseuoftjjk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseuoftjjk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdvcfbiob === 'undefined') {
    varMorrisdvcfbiob = Morris.Line({
      element: 'Morrisdvcfbiob',
