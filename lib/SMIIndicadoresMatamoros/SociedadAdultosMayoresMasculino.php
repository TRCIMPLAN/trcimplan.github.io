...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvitrcglg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismgvtgrjh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvitrcglg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvitrcglg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismgvtgrjh === 'undefined') {
    varMorrismgvtgrjh = Morris.Line({
      element: 'Morrismgvtgrjh',
