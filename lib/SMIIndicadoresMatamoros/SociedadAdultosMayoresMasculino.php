...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasskunxyyb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislgnnqcqq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasskunxyyb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasskunxyyb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislgnnqcqq === 'undefined') {
    varMorrislgnnqcqq = Morris.Line({
      element: 'Morrislgnnqcqq',
