...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdassyifs">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskaxmlmlf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdassyifs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdassyifs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskaxmlmlf === 'undefined') {
    varMorriskaxmlmlf = Morris.Line({
      element: 'Morriskaxmlmlf',
