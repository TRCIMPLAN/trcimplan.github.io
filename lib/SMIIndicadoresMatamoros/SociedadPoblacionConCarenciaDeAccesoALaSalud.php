<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPoblacionConCarenciaDeAccesoALaSalud
 *
...
class SociedadPoblacionConCarenciaDeAccesoALaSalud extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con carencia de acceso a la salud en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '22.5000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '17.6000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
