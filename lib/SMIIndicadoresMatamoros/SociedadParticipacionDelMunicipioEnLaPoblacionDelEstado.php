<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadParticipacionDelMunicipioEnLaPoblacionDelEstado
 *
...
class SociedadParticipacionDelMunicipioEnLaPoblacionDelEstado extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Participación del municipio en la población del estado en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '4.0000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
