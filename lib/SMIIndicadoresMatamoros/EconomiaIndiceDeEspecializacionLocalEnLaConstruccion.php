...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszlacbkiy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsrrovwyh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszlacbkiy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszlacbkiy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsrrovwyh;
  ...
  function initmapsrrovwyh() {
    // Nuevo Mapa
    mapsrrovwyh = new L.Map('LeafLetsrrovwyh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsrrovwyh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsrrovwyh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsrrovwyh === 'undefined') {
    varinitmapsrrovwyh = initmapsrrovwyh();
  };
});
FINAL;
    } // constructor
