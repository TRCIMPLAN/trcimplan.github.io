...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqlbkiplz">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlqeqmoss" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqlbkiplz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqlbkiplz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplqeqmoss;
  ...
  function initmaplqeqmoss() {
    // Nuevo Mapa
    maplqeqmoss = new L.Map('LeafLetlqeqmoss');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplqeqmoss.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplqeqmoss.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplqeqmoss === 'undefined') {
    varinitmaplqeqmoss = initmaplqeqmoss();
  };
});
FINAL;
    } // constructor
