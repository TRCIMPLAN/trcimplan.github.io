...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbxifolof">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmleemwsq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbxifolof a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbxifolof a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmleemwsq;
  ...
  function initmapmleemwsq() {
    // Nuevo Mapa
    mapmleemwsq = new L.Map('LeafLetmleemwsq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmleemwsq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmleemwsq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmleemwsq === 'undefined') {
    varinitmapmleemwsq = initmapmleemwsq();
  };
});
FINAL;
    } // constructor
