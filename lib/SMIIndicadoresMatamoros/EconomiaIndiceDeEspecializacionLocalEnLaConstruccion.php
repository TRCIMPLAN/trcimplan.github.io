...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasucbcexgy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoxqwsdqk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasucbcexgy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasucbcexgy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoxqwsdqk;
  ...
  function initmapoxqwsdqk() {
    // Nuevo Mapa
    mapoxqwsdqk = new L.Map('LeafLetoxqwsdqk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoxqwsdqk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoxqwsdqk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoxqwsdqk === 'undefined') {
    varinitmapoxqwsdqk = initmapoxqwsdqk();
  };
});
FINAL;
    } // constructor
