...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashjnzfpug">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnpjgbwmn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashjnzfpug a:first').tab('show')
});
// LENGUETA
$('#Lenguetashjnzfpug a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnpjgbwmn;
  ...
  function initmapnpjgbwmn() {
    // Nuevo Mapa
    mapnpjgbwmn = new L.Map('LeafLetnpjgbwmn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnpjgbwmn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnpjgbwmn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnpjgbwmn === 'undefined') {
    varinitmapnpjgbwmn = initmapnpjgbwmn();
  };
});
FINAL;
    } // constructor
