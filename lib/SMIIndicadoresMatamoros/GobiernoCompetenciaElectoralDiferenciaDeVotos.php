<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Gobierno Competencia Electoral Diferencia de Votos (Creado por Central:SmiLanzadera)
 *
...
<p>Cantidad de votos</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia Electoral Diferencia de Votos en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-07-01', dato: 19079 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
