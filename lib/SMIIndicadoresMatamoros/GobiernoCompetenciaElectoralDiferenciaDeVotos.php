...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasotqhwesr">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlztellsd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasotqhwesr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasotqhwesr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplztellsd;
  ...
  function initmaplztellsd() {
    // Nuevo Mapa
    maplztellsd = new L.Map('LeafLetlztellsd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplztellsd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplztellsd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplztellsd === 'undefined') {
    varinitmaplztellsd = initmaplztellsd();
  };
});
FINAL;
    } // constructor
