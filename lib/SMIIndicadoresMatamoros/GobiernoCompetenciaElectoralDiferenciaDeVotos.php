...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrpaovxjb">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfijmfdxc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrpaovxjb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrpaovxjb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfijmfdxc;
  ...
  function initmapfijmfdxc() {
    // Nuevo Mapa
    mapfijmfdxc = new L.Map('LeafLetfijmfdxc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfijmfdxc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfijmfdxc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfijmfdxc === 'undefined') {
    varinitmapfijmfdxc = initmapfijmfdxc();
  };
});
FINAL;
    } // constructor
