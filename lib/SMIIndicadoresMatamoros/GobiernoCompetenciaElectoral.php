<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Gobierno Competencia Electoral (Creado por Central:SmiLanzadera)
 *
...
<p>Diferencia entre los dos candidatos con más votación entre el total de votos.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia Electoral en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2013-07-07', dato: 39.6700 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
