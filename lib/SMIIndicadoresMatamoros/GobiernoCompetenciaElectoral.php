...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbclvaepc">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyphxisew" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbclvaepc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbclvaepc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyphxisew;
  ...
  function initmapyphxisew() {
    // Nuevo Mapa
    mapyphxisew = new L.Map('LeafLetyphxisew');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyphxisew.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyphxisew.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyphxisew === 'undefined') {
    varinitmapyphxisew = initmapyphxisew();
  };
});
FINAL;
    } // constructor
