...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdkllytsc">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuyyhtlyw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdkllytsc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdkllytsc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuyyhtlyw;
  ...
  function initmapuyyhtlyw() {
    // Nuevo Mapa
    mapuyyhtlyw = new L.Map('LeafLetuyyhtlyw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuyyhtlyw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuyyhtlyw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuyyhtlyw === 'undefined') {
    varinitmapuyyhtlyw = initmapuyyhtlyw();
  };
});
FINAL;
    } // constructor
