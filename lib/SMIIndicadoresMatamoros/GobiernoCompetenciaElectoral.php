...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszabnxqpa">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetstlmrjhj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszabnxqpa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszabnxqpa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapstlmrjhj;
  ...
  function initmapstlmrjhj() {
    // Nuevo Mapa
    mapstlmrjhj = new L.Map('LeafLetstlmrjhj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapstlmrjhj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapstlmrjhj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapstlmrjhj === 'undefined') {
    varinitmapstlmrjhj = initmapstlmrjhj();
  };
});
FINAL;
    } // constructor
