...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdxcmimle">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethdivfwtl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdxcmimle a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdxcmimle a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphdivfwtl;
  ...
  function initmaphdivfwtl() {
    // Nuevo Mapa
    maphdivfwtl = new L.Map('LeafLethdivfwtl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphdivfwtl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphdivfwtl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphdivfwtl === 'undefined') {
    varinitmaphdivfwtl = initmaphdivfwtl();
  };
});
FINAL;
    } // constructor
