...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszgpavtkp">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetifsndtkr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszgpavtkp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszgpavtkp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapifsndtkr;
  ...
  function initmapifsndtkr() {
    // Nuevo Mapa
    mapifsndtkr = new L.Map('LeafLetifsndtkr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapifsndtkr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapifsndtkr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapifsndtkr === 'undefined') {
    varinitmapifsndtkr = initmapifsndtkr();
  };
});
FINAL;
    } // constructor
