...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasierzxdtj">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqnhtlopv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasierzxdtj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasierzxdtj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqnhtlopv;
  ...
  function initmapqnhtlopv() {
    // Nuevo Mapa
    mapqnhtlopv = new L.Map('LeafLetqnhtlopv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqnhtlopv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqnhtlopv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqnhtlopv === 'undefined') {
    varinitmapqnhtlopv = initmapqnhtlopv();
  };
});
FINAL;
    } // constructor
