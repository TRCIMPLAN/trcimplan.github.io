...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqbawuggh">
...
<div id="Morriszrgtjvoh" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqaguzhec" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqbawuggh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqbawuggh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszrgtjvoh === 'undefined') {
    varMorriszrgtjvoh = Morris.Line({
      element: 'Morriszrgtjvoh',
...
// LENGUETA
$('#Lenguetasqbawuggh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqaguzhec;
  ...
  function initmapqaguzhec() {
    // Nuevo Mapa
    mapqaguzhec = new L.Map('LeafLetqaguzhec');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqaguzhec.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqaguzhec.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqaguzhec === 'undefined') {
    varinitmapqaguzhec = initmapqaguzhec();
  };
});
FINAL;
    } // constructor
