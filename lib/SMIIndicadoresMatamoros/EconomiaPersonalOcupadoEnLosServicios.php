...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszwnuieff">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjtearkws" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszwnuieff a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszwnuieff a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjtearkws === 'undefined') {
    varMorrisjtearkws = Morris.Line({
      element: 'Morrisjtearkws',
