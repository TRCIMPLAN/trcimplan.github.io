...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasljtfgafa">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisylbblzcz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfpwtfzvv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasljtfgafa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasljtfgafa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisylbblzcz === 'undefined') {
    varMorrisylbblzcz = Morris.Line({
      element: 'Morrisylbblzcz',
...
// LENGUETA
$('#Lenguetasljtfgafa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfpwtfzvv;
  ...
  function initmapfpwtfzvv() {
    // Nuevo Mapa
    mapfpwtfzvv = new L.Map('LeafLetfpwtfzvv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfpwtfzvv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfpwtfzvv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfpwtfzvv === 'undefined') {
    varinitmapfpwtfzvv = initmapfpwtfzvv();
  };
});
FINAL;
    } // constructor
