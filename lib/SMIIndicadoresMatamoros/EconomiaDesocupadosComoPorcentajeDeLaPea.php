...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqcsrqyi">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgsjmfetr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrmkbxvdm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqcsrqyi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqcsrqyi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgsjmfetr === 'undefined') {
    varMorrisgsjmfetr = Morris.Line({
      element: 'Morrisgsjmfetr',
...
// LENGUETA
$('#Lenguetasbqcsrqyi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprmkbxvdm;
  ...
  function initmaprmkbxvdm() {
    // Nuevo Mapa
    maprmkbxvdm = new L.Map('LeafLetrmkbxvdm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprmkbxvdm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprmkbxvdm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprmkbxvdm === 'undefined') {
    varinitmaprmkbxvdm = initmaprmkbxvdm();
  };
});
FINAL;
    } // constructor
