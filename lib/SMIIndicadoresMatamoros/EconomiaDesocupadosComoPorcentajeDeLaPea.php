...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastrxpsiev">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscmeidpnb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrkobjgrp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastrxpsiev a:first').tab('show')
});
// LENGUETA
$('#Lenguetastrxpsiev a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscmeidpnb === 'undefined') {
    varMorriscmeidpnb = Morris.Line({
      element: 'Morriscmeidpnb',
...
// LENGUETA
$('#Lenguetastrxpsiev a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprkobjgrp;
  ...
  function initmaprkobjgrp() {
    // Nuevo Mapa
    maprkobjgrp = new L.Map('LeafLetrkobjgrp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprkobjgrp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprkobjgrp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprkobjgrp === 'undefined') {
    varinitmaprkobjgrp = initmaprkobjgrp();
  };
});
FINAL;
    } // constructor
