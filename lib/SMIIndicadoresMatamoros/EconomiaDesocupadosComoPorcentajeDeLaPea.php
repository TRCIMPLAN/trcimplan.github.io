...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgasozfgx">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisatnzwscz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetczbnehbm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgasozfgx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgasozfgx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisatnzwscz === 'undefined') {
    varMorrisatnzwscz = Morris.Line({
      element: 'Morrisatnzwscz',
...
// LENGUETA
$('#Lenguetasgasozfgx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapczbnehbm;
  ...
  function initmapczbnehbm() {
    // Nuevo Mapa
    mapczbnehbm = new L.Map('LeafLetczbnehbm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapczbnehbm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapczbnehbm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapczbnehbm === 'undefined') {
    varinitmapczbnehbm = initmapczbnehbm();
  };
});
FINAL;
    } // constructor
