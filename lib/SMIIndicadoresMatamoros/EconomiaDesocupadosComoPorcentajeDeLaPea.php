...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasliatnlia">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispzdfccmt" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasliatnlia a:first').tab('show')
});
// LENGUETA
$('#Lenguetasliatnlia a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispzdfccmt === 'undefined') {
    varMorrispzdfccmt = Morris.Line({
      element: 'Morrispzdfccmt',
