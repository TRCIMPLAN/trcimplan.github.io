...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastfggfjng">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetliwfbwty" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastfggfjng a:first').tab('show')
});
// LENGUETA
$('#Lenguetastfggfjng a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapliwfbwty;
  ...
  function initmapliwfbwty() {
    // Nuevo Mapa
    mapliwfbwty = new L.Map('LeafLetliwfbwty');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapliwfbwty.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapliwfbwty.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapliwfbwty === 'undefined') {
    varinitmapliwfbwty = initmapliwfbwty();
  };
});
FINAL;
    } // constructor
