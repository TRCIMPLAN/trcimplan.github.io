...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascbcalrob">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetanerfdmz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascbcalrob a:first').tab('show')
});
// LENGUETA
$('#Lenguetascbcalrob a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapanerfdmz;
  ...
  function initmapanerfdmz() {
    // Nuevo Mapa
    mapanerfdmz = new L.Map('LeafLetanerfdmz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapanerfdmz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapanerfdmz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapanerfdmz === 'undefined') {
    varinitmapanerfdmz = initmapanerfdmz();
  };
});
FINAL;
    } // constructor
