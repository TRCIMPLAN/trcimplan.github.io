...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassyididbi">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetigijxwla" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassyididbi a:first').tab('show')
});
// LENGUETA
$('#Lenguetassyididbi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapigijxwla;
  ...
  function initmapigijxwla() {
    // Nuevo Mapa
    mapigijxwla = new L.Map('LeafLetigijxwla');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapigijxwla.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapigijxwla.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapigijxwla === 'undefined') {
    varinitmapigijxwla = initmapigijxwla();
  };
});
FINAL;
    } // constructor
