...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswfypozng">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjxexfefs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswfypozng a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswfypozng a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjxexfefs;
  ...
  function initmapjxexfefs() {
    // Nuevo Mapa
    mapjxexfefs = new L.Map('LeafLetjxexfefs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjxexfefs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjxexfefs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjxexfefs === 'undefined') {
    varinitmapjxexfefs = initmapjxexfefs();
  };
});
FINAL;
    } // constructor
