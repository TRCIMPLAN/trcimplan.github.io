<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Empresas Certificadas con ISO-9000 y 14000 (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaEmpresasCertificadasConIso9000Y14000 extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empresas Certificadas con ISO-9000 y 14000 en Matamoros</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Empresas Certificadas con ISO-9000 y 14000</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Empresas Certificadas con ISO-9000 y 14000</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1341.4634 },{ fecha: '2009-12-31', dato: 194.4444 },{ fecha: '2010-12-31', dato: 226.5861 },{ fecha: '2011-12-31', dato: 250.7937 },{ fecha: '2012-12-31', dato: 279.3651 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 10.6011 },{ region: 'Gómez Palacio', dato: 14.9306 },{ region: 'Lerdo', dato: 61.3409 },{ region: 'Matamoros', dato: 279.3651 },{ region: 'La Laguna', dato: 21.4807 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
