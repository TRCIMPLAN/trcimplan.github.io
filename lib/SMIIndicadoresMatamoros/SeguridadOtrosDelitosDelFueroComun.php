<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SeguridadOtrosDelitosDelFueroComun
 *
...
class SeguridadOtrosDelitosDelFueroComun extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Otros delitos del Fuero Común en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-01-31', 'valor' => '8', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública'),
