...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxkfzmjyi">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjaivgyjf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxkfzmjyi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxkfzmjyi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjaivgyjf === 'undefined') {
    varMorrisjaivgyjf = Morris.Line({
      element: 'Morrisjaivgyjf',
