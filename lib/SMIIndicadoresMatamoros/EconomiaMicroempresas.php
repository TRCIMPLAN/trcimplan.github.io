...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdvtnchxt">
...
<div id="Morrismuxbemwm" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdfkzaxnw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdvtnchxt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdvtnchxt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismuxbemwm === 'undefined') {
    varMorrismuxbemwm = Morris.Line({
      element: 'Morrismuxbemwm',
...
// LENGUETA
$('#Lenguetasdvtnchxt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdfkzaxnw;
  ...
  function initmapdfkzaxnw() {
    // Nuevo Mapa
    mapdfkzaxnw = new L.Map('LeafLetdfkzaxnw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdfkzaxnw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdfkzaxnw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdfkzaxnw === 'undefined') {
    varinitmapdfkzaxnw = initmapdfkzaxnw();
  };
});
FINAL;
    } // constructor
