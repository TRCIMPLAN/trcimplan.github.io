...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrmnexqbn">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqxtfscto" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrmnexqbn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrmnexqbn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqxtfscto === 'undefined') {
    varMorrisqxtfscto = Morris.Line({
      element: 'Morrisqxtfscto',
