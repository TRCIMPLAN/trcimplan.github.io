...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslaeeqfsu">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscesxajnn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrstkovar" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslaeeqfsu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslaeeqfsu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscesxajnn === 'undefined') {
    varMorriscesxajnn = Morris.Line({
      element: 'Morriscesxajnn',
...
// LENGUETA
$('#Lenguetaslaeeqfsu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprstkovar;
  ...
  function initmaprstkovar() {
    // Nuevo Mapa
    maprstkovar = new L.Map('LeafLetrstkovar');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprstkovar.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprstkovar.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprstkovar === 'undefined') {
    varinitmaprstkovar = initmaprstkovar();
  };
});
FINAL;
    } // constructor
