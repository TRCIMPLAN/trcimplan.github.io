...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasammzuqnh">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszhprmdmg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasammzuqnh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasammzuqnh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszhprmdmg === 'undefined') {
    varMorriszhprmdmg = Morris.Line({
      element: 'Morriszhprmdmg',
