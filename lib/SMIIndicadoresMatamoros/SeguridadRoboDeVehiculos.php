...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvdfhezhx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrvvfijeh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvdfhezhx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvdfhezhx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrvvfijeh === 'undefined') {
    varMorrisrvvfijeh = Morris.Line({
      element: 'Morrisrvvfijeh',
