...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszzikrfsk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdulscwph" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlpyfsvhh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszzikrfsk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszzikrfsk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdulscwph === 'undefined') {
    varMorrisdulscwph = Morris.Line({
      element: 'Morrisdulscwph',
...
// LENGUETA
$('#Lenguetaszzikrfsk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplpyfsvhh;
  ...
  function initmaplpyfsvhh() {
    // Nuevo Mapa
    maplpyfsvhh = new L.Map('LeafLetlpyfsvhh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplpyfsvhh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplpyfsvhh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplpyfsvhh === 'undefined') {
    varinitmaplpyfsvhh = initmaplpyfsvhh();
  };
});
FINAL;
    } // constructor
