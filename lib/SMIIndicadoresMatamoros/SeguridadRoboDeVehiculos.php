...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqnpasjuy">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzkufzadg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqnpasjuy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqnpasjuy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzkufzadg;
  ...
  function initmapzkufzadg() {
    // Nuevo Mapa
    mapzkufzadg = new L.Map('LeafLetzkufzadg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzkufzadg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzkufzadg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzkufzadg === 'undefined') {
    varinitmapzkufzadg = initmapzkufzadg();
  };
});
FINAL;
    } // constructor
