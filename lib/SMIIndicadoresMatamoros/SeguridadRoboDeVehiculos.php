...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassutgfrej">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnflvjggz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassutgfrej a:first').tab('show')
});
// LENGUETA
$('#Lenguetassutgfrej a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnflvjggz;
  ...
  function initmapnflvjggz() {
    // Nuevo Mapa
    mapnflvjggz = new L.Map('LeafLetnflvjggz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnflvjggz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnflvjggz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnflvjggz === 'undefined') {
    varinitmapnflvjggz = initmapnflvjggz();
  };
});
FINAL;
    } // constructor
