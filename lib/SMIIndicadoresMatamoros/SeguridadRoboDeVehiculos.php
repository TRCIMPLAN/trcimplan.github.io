...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasspwwbuyl">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriselbrnzcm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasspwwbuyl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasspwwbuyl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriselbrnzcm === 'undefined') {
    varMorriselbrnzcm = Morris.Line({
      element: 'Morriselbrnzcm',
