...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastpegpjes">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxhfaqkpi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastpegpjes a:first').tab('show')
});
// LENGUETA
$('#Lenguetastpegpjes a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxhfaqkpi === 'undefined') {
    varMorrisxhfaqkpi = Morris.Line({
      element: 'Morrisxhfaqkpi',
