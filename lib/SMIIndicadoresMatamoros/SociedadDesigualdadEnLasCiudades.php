<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Desigualdad en las Ciudades (Creado por Central:SmiLanzadera)
 *
...
Fuente: Estimaciones de IMCO con datos de INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Desigualdad en las Ciudades en Matamoros</h3>
