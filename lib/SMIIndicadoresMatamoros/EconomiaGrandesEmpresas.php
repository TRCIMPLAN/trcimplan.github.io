...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswefszpyt">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetatmtyyjj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswefszpyt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswefszpyt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapatmtyyjj;
  ...
  function initmapatmtyyjj() {
    // Nuevo Mapa
    mapatmtyyjj = new L.Map('LeafLetatmtyyjj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapatmtyyjj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapatmtyyjj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapatmtyyjj === 'undefined') {
    varinitmapatmtyyjj = initmapatmtyyjj();
  };
});
FINAL;
    } // constructor
