...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbazvavdd">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvmccsass" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetanvxtlgu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbazvavdd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbazvavdd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvmccsass === 'undefined') {
    varMorrisvmccsass = Morris.Line({
      element: 'Morrisvmccsass',
...
// LENGUETA
$('#Lenguetasbazvavdd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapanvxtlgu;
  ...
  function initmapanvxtlgu() {
    // Nuevo Mapa
    mapanvxtlgu = new L.Map('LeafLetanvxtlgu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapanvxtlgu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapanvxtlgu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapanvxtlgu === 'undefined') {
    varinitmapanvxtlgu = initmapanvxtlgu();
  };
});
FINAL;
    } // constructor
