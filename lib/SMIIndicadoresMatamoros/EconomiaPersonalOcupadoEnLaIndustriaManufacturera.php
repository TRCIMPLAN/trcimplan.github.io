...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiqdvlfos">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisntazqeiz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiqdvlfos a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiqdvlfos a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisntazqeiz === 'undefined') {
    varMorrisntazqeiz = Morris.Line({
      element: 'Morrisntazqeiz',
