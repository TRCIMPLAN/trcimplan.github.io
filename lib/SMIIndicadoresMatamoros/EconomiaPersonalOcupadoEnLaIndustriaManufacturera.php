...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswtbfszpk">
...
<div id="Morrisptnxodaw" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwqysqgag" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswtbfszpk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswtbfszpk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisptnxodaw === 'undefined') {
    varMorrisptnxodaw = Morris.Line({
      element: 'Morrisptnxodaw',
...
// LENGUETA
$('#Lenguetaswtbfszpk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwqysqgag;
  ...
  function initmapwqysqgag() {
    // Nuevo Mapa
    mapwqysqgag = new L.Map('LeafLetwqysqgag');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwqysqgag.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwqysqgag.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwqysqgag === 'undefined') {
    varinitmapwqysqgag = initmapwqysqgag();
  };
});
FINAL;
    } // constructor
