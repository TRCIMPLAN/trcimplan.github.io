...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnxhdusvo">
...
<div id="Morrisxvlzezbj" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdiwxgtfj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnxhdusvo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnxhdusvo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxvlzezbj === 'undefined') {
    varMorrisxvlzezbj = Morris.Line({
      element: 'Morrisxvlzezbj',
...
// LENGUETA
$('#Lenguetasnxhdusvo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdiwxgtfj;
  ...
  function initmapdiwxgtfj() {
    // Nuevo Mapa
    mapdiwxgtfj = new L.Map('LeafLetdiwxgtfj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdiwxgtfj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdiwxgtfj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdiwxgtfj === 'undefined') {
    varinitmapdiwxgtfj = initmapdiwxgtfj();
  };
});
FINAL;
    } // constructor
