...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspjohexqy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristyeedjit" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspjohexqy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspjohexqy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristyeedjit === 'undefined') {
    varMorristyeedjit = Morris.Line({
      element: 'Morristyeedjit',
