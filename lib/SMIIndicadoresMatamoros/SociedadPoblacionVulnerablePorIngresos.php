<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPoblacionVulnerablePorIngresos
 *
...
class SociedadPoblacionVulnerablePorIngresos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población vulnerable por ingresos en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '9.5000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '17.1000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
