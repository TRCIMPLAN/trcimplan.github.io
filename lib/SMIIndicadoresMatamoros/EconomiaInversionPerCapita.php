...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaeivotij">
...
<div id="Morrisflrejang" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetftyejxyl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaeivotij a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaeivotij a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisflrejang === 'undefined') {
    varMorrisflrejang = Morris.Line({
      element: 'Morrisflrejang',
...
// LENGUETA
$('#Lenguetasaeivotij a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapftyejxyl;
  ...
  function initmapftyejxyl() {
    // Nuevo Mapa
    mapftyejxyl = new L.Map('LeafLetftyejxyl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapftyejxyl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapftyejxyl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapftyejxyl === 'undefined') {
    varinitmapftyejxyl = initmapftyejxyl();
  };
});
FINAL;
    } // constructor
