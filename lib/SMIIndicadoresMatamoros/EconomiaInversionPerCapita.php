...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskybuojov">
...
<div id="Morrissasubeyq" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetakkgnvxo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskybuojov a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskybuojov a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissasubeyq === 'undefined') {
    varMorrissasubeyq = Morris.Line({
      element: 'Morrissasubeyq',
...
// LENGUETA
$('#Lenguetaskybuojov a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapakkgnvxo;
  ...
  function initmapakkgnvxo() {
    // Nuevo Mapa
    mapakkgnvxo = new L.Map('LeafLetakkgnvxo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapakkgnvxo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapakkgnvxo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapakkgnvxo === 'undefined') {
    varinitmapakkgnvxo = initmapakkgnvxo();
  };
});
FINAL;
    } // constructor
