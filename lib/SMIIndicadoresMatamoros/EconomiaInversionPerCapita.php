...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxkvpasat">
...
<div id="Morristmxsecfu" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaeimnogl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxkvpasat a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxkvpasat a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristmxsecfu === 'undefined') {
    varMorristmxsecfu = Morris.Line({
      element: 'Morristmxsecfu',
...
// LENGUETA
$('#Lenguetasxkvpasat a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaeimnogl;
  ...
  function initmapaeimnogl() {
    // Nuevo Mapa
    mapaeimnogl = new L.Map('LeafLetaeimnogl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaeimnogl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaeimnogl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaeimnogl === 'undefined') {
    varinitmapaeimnogl = initmapaeimnogl();
  };
});
FINAL;
    } // constructor
