...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuqrptkqw">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxgypcyhr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmyestqbn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuqrptkqw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuqrptkqw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxgypcyhr === 'undefined') {
    varMorrisxgypcyhr = Morris.Line({
      element: 'Morrisxgypcyhr',
...
// LENGUETA
$('#Lenguetasuqrptkqw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmyestqbn;
  ...
  function initmapmyestqbn() {
    // Nuevo Mapa
    mapmyestqbn = new L.Map('LeafLetmyestqbn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmyestqbn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmyestqbn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmyestqbn === 'undefined') {
    varinitmapmyestqbn = initmapmyestqbn();
  };
});
FINAL;
    } // constructor
