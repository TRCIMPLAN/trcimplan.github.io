...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasldqtrkho">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvzcjrgym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasldqtrkho a:first').tab('show')
});
// LENGUETA
$('#Lenguetasldqtrkho a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvzcjrgym;
  ...
  function initmapvzcjrgym() {
    // Nuevo Mapa
    mapvzcjrgym = new L.Map('LeafLetvzcjrgym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvzcjrgym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvzcjrgym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvzcjrgym === 'undefined') {
    varinitmapvzcjrgym = initmapvzcjrgym();
  };
});
FINAL;
    } // constructor
