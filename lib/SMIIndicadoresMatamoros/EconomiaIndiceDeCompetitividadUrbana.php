...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascazgaxym">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcgycvnvm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascazgaxym a:first').tab('show')
});
// LENGUETA
$('#Lenguetascazgaxym a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcgycvnvm;
  ...
  function initmapcgycvnvm() {
    // Nuevo Mapa
    mapcgycvnvm = new L.Map('LeafLetcgycvnvm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcgycvnvm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcgycvnvm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcgycvnvm === 'undefined') {
    varinitmapcgycvnvm = initmapcgycvnvm();
  };
});
FINAL;
    } // constructor
