...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgqgkfumw">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteayohpet" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgqgkfumw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgqgkfumw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeayohpet;
  ...
  function initmapeayohpet() {
    // Nuevo Mapa
    mapeayohpet = new L.Map('LeafLeteayohpet');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeayohpet.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeayohpet.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeayohpet === 'undefined') {
    varinitmapeayohpet = initmapeayohpet();
  };
});
FINAL;
    } // constructor
