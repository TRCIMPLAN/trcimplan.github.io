...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasljaqntie">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgtgeokqf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasljaqntie a:first').tab('show')
});
// LENGUETA
$('#Lenguetasljaqntie a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgtgeokqf;
  ...
  function initmapgtgeokqf() {
    // Nuevo Mapa
    mapgtgeokqf = new L.Map('LeafLetgtgeokqf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgtgeokqf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgtgeokqf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgtgeokqf === 'undefined') {
    varinitmapgtgeokqf = initmapgtgeokqf();
  };
});
FINAL;
    } // constructor
