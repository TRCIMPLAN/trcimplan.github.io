...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdsxkjfdg">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetohdnnerg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdsxkjfdg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdsxkjfdg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapohdnnerg;
  ...
  function initmapohdnnerg() {
    // Nuevo Mapa
    mapohdnnerg = new L.Map('LeafLetohdnnerg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapohdnnerg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapohdnnerg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapohdnnerg === 'undefined') {
    varinitmapohdnnerg = initmapohdnnerg();
  };
});
FINAL;
    } // constructor
