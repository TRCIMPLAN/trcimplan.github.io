...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbdkdqfvr">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwvrrjeja" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbdkdqfvr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbdkdqfvr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwvrrjeja;
  ...
  function initmapwvrrjeja() {
    // Nuevo Mapa
    mapwvrrjeja = new L.Map('LeafLetwvrrjeja');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwvrrjeja.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwvrrjeja.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwvrrjeja === 'undefined') {
    varinitmapwvrrjeja = initmapwvrrjeja();
  };
});
FINAL;
    } // constructor
