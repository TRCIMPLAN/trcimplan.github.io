...
class SociedadRezagoAlimentario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjgjbrqqn">
...
Consulta la [BasedeDatos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Anexo-estad%C3%ADstico-municipal-2010.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnvyphdbg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjgjbrqqn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjgjbrqqn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnvyphdbg;
  ...
  function initmapnvyphdbg() {
    // Nuevo Mapa
    mapnvyphdbg = new L.Map('LeafLetnvyphdbg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnvyphdbg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnvyphdbg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnvyphdbg === 'undefined') {
    varinitmapnvyphdbg = initmapnvyphdbg();
  };
});
FINAL;
    } // constructor
