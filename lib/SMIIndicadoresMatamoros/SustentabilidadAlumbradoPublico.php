...
class SustentabilidadAlumbradoPublico extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Matamoros, Servicios Públicos, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2014-12-31', 'valor' => '15.4200', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 4, crudo 2
    } // datos
