...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascidrvuzu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxuofbnyj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascidrvuzu a:first').tab('show')
});
// LENGUETA
$('#Lenguetascidrvuzu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxuofbnyj === 'undefined') {
    varMorrisxuofbnyj = Morris.Line({
      element: 'Morrisxuofbnyj',
