...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspdpcrgqe">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnfzbvify" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspdpcrgqe a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspdpcrgqe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnfzbvify === 'undefined') {
    varMorrisnfzbvify = Morris.Line({
      element: 'Morrisnfzbvify',
