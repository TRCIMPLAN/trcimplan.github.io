...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmbvbnuer">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswmuirree" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmbvbnuer a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmbvbnuer a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswmuirree === 'undefined') {
    varMorriswmuirree = Morris.Line({
      element: 'Morriswmuirree',
