...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasinooxypp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskiwihlqs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkyiubkro" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasinooxypp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasinooxypp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskiwihlqs === 'undefined') {
    varMorriskiwihlqs = Morris.Line({
      element: 'Morriskiwihlqs',
...
// LENGUETA
$('#Lenguetasinooxypp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkyiubkro;
  ...
  function initmapkyiubkro() {
    // Nuevo Mapa
    mapkyiubkro = new L.Map('LeafLetkyiubkro');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkyiubkro.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkyiubkro.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkyiubkro === 'undefined') {
    varinitmapkyiubkro = initmapkyiubkro();
  };
});
FINAL;
    } // constructor
