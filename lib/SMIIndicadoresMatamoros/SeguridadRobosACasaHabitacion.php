...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdwfonkrz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfxkcbzhc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdwfonkrz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdwfonkrz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfxkcbzhc === 'undefined') {
    varMorrisfxkcbzhc = Morris.Line({
      element: 'Morrisfxkcbzhc',
