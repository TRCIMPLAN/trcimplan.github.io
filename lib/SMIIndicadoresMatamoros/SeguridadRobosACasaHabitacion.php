...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 2 },{ fecha: '2014-02-28', dato: 8 },{ fecha: '2014-03-31', dato: 6 },{ fecha: '2014-04-30', dato: 5 },{ fecha: '2014-05-31', dato: 10 },{ fecha: '2014-06-30', dato: 5 },{ fecha: '2014-07-31', dato: 7 },{ fecha: '2014-08-31', dato: 8 },{ fecha: '2014-09-30', dato: 5 },{ fecha: '2014-10-31', dato: 8 },{ fecha: '2014-11-30', dato: 12 },{ fecha: '2014-12-31', dato: 6 },{ fecha: '2015-01-31', dato: 4 },{ fecha: '2015-02-28', dato: 8 },{ fecha: '2015-03-31', dato: 8 },{ fecha: '2015-04-30', dato: 4 },{ fecha: '2015-05-31', dato: 3 },{ fecha: '2015-06-30', dato: 6 },{ fecha: '2015-07-31', dato: 7 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
