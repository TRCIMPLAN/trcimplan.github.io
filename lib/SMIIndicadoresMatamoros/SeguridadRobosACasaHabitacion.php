...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspbstadca">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdlkuqdeu" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxqmanbhy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspbstadca a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspbstadca a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdlkuqdeu === 'undefined') {
    varMorrisdlkuqdeu = Morris.Line({
      element: 'Morrisdlkuqdeu',
      data: [{ fecha: '2014-01-31', dato: 2 },{ fecha: '2014-02-28', dato: 8 },{ fecha: '2014-03-31', dato: 6 },{ fecha: '2014-04-30', dato: 5 },{ fecha: '2014-05-31', dato: 10 },{ fecha: '2014-06-30', dato: 5 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetaspbstadca a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxqmanbhy;
  ...
  function initmapxqmanbhy() {
    // Nuevo Mapa
    mapxqmanbhy = new L.Map('LeafLetxqmanbhy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxqmanbhy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxqmanbhy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxqmanbhy === 'undefined') {
    varinitmapxqmanbhy = initmapxqmanbhy();
  };
});
FINAL;
    } // constructor
