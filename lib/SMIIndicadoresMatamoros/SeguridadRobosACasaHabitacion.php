...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxykniofg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswlgmvwvv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxykniofg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxykniofg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswlgmvwvv === 'undefined') {
    varMorriswlgmvwvv = Morris.Line({
      element: 'Morriswlgmvwvv',
