...
3er. Trimestre: 5.20 %</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tasa de Desempleo Abierto en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '1990-03-12', dato: 3.3200 },{ fecha: '2000-02-14', dato: 1.1800 },{ fecha: '2010-06-25', dato: 6.0700 },{ fecha: '2014-03-31', dato: 6.9000 },{ fecha: '2014-06-30', dato: 3.8100 },{ fecha: '2014-09-30', dato: 5.3100 },{ fecha: '2014-12-31', dato: 7.1400 },{ fecha: '2015-03-31', dato: 3.1300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
