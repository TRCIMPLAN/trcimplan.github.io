...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswbwtlxpw">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdumrnmla" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswbwtlxpw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswbwtlxpw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdumrnmla;
  ...
  function initmapdumrnmla() {
    // Nuevo Mapa
    mapdumrnmla = new L.Map('LeafLetdumrnmla');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdumrnmla.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdumrnmla.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdumrnmla === 'undefined') {
    varinitmapdumrnmla = initmapdumrnmla();
  };
});
FINAL;
    } // constructor
