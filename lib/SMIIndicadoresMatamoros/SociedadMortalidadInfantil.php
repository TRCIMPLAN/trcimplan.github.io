...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashiflklvc">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbzkxtixu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashiflklvc a:first').tab('show')
});
// LENGUETA
$('#Lenguetashiflklvc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbzkxtixu;
  ...
  function initmapbzkxtixu() {
    // Nuevo Mapa
    mapbzkxtixu = new L.Map('LeafLetbzkxtixu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbzkxtixu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbzkxtixu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbzkxtixu === 'undefined') {
    varinitmapbzkxtixu = initmapbzkxtixu();
  };
});
FINAL;
    } // constructor
