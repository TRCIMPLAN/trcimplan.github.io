<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaIntensidadElectrica
 *
...
class EconomiaIntensidadElectrica extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Intensidad eléctrica en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2018-12-31', 'valor' => '185145008', 'fuente_nombre' => 'IMCO', 'notas' => 'Kilowatts-hora')); // formateado 0, valor 2, crudo 2
    } // datos
