...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszsjvifoi">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmeyrsyjh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszsjvifoi a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszsjvifoi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmeyrsyjh;
  ...
  function initmapmeyrsyjh() {
    // Nuevo Mapa
    mapmeyrsyjh = new L.Map('LeafLetmeyrsyjh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmeyrsyjh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmeyrsyjh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmeyrsyjh === 'undefined') {
    varinitmapmeyrsyjh = initmapmeyrsyjh();
  };
});
FINAL;
    } // constructor
