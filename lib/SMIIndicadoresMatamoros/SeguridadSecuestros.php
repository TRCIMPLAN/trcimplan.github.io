...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasajkroppk">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcjwgypzu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasajkroppk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasajkroppk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcjwgypzu;
  ...
  function initmapcjwgypzu() {
    // Nuevo Mapa
    mapcjwgypzu = new L.Map('LeafLetcjwgypzu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcjwgypzu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcjwgypzu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcjwgypzu === 'undefined') {
    varinitmapcjwgypzu = initmapcjwgypzu();
  };
});
FINAL;
    } // constructor
