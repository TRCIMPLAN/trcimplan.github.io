...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasibanmhuk">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyfxrkvvv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasibanmhuk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasibanmhuk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyfxrkvvv;
  ...
  function initmapyfxrkvvv() {
    // Nuevo Mapa
    mapyfxrkvvv = new L.Map('LeafLetyfxrkvvv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyfxrkvvv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyfxrkvvv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyfxrkvvv === 'undefined') {
    varinitmapyfxrkvvv = initmapyfxrkvvv();
  };
});
FINAL;
    } // constructor
