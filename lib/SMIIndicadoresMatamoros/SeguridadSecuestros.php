...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnhiieogc">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismbirstpz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnhiieogc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnhiieogc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismbirstpz === 'undefined') {
    varMorrismbirstpz = Morris.Line({
      element: 'Morrismbirstpz',
