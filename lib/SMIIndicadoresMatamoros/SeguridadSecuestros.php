...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuesxgzxs">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxohiwblu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuesxgzxs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuesxgzxs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxohiwblu === 'undefined') {
    varMorrisxohiwblu = Morris.Line({
      element: 'Morrisxohiwblu',
