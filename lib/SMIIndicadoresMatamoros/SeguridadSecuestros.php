...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaozaqkgd">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkmcxcefo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaozaqkgd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaozaqkgd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkmcxcefo;
  ...
  function initmapkmcxcefo() {
    // Nuevo Mapa
    mapkmcxcefo = new L.Map('LeafLetkmcxcefo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkmcxcefo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkmcxcefo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkmcxcefo === 'undefined') {
    varinitmapkmcxcefo = initmapkmcxcefo();
  };
});
FINAL;
    } // constructor
