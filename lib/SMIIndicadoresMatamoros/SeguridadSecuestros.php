...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskuyyeqxk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisninoiuru" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskuyyeqxk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskuyyeqxk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisninoiuru === 'undefined') {
    varMorrisninoiuru = Morris.Line({
      element: 'Morrisninoiuru',
