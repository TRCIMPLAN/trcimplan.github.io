...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqcgiqwow">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristkzumhqs" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqcgiqwow a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqcgiqwow a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristkzumhqs === 'undefined') {
    varMorristkzumhqs = Morris.Line({
      element: 'Morristkzumhqs',
