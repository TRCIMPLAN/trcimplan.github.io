...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiwzvyguq">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismzanlsez" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteontcblb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiwzvyguq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiwzvyguq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismzanlsez === 'undefined') {
    varMorrismzanlsez = Morris.Line({
      element: 'Morrismzanlsez',
...
// LENGUETA
$('#Lenguetasiwzvyguq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeontcblb;
  ...
  function initmapeontcblb() {
    // Nuevo Mapa
    mapeontcblb = new L.Map('LeafLeteontcblb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeontcblb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeontcblb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeontcblb === 'undefined') {
    varinitmapeontcblb = initmapeontcblb();
  };
});
FINAL;
    } // constructor
