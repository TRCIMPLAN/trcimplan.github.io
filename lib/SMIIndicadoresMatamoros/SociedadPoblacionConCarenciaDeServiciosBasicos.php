<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadPoblacionConCarenciaDeServiciosBasicos
 *
...
class SociedadPoblacionConCarenciaDeServiciosBasicos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con carencia de servicios básicos en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '11.6000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '9.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
