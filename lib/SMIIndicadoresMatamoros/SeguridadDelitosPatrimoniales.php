...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2015-01-31', dato: 8 },{ fecha: '2015-02-28', dato: 9 },{ fecha: '2015-03-31', dato: 7 },{ fecha: '2015-04-30', dato: 16 },{ fecha: '2015-05-31', dato: 8 },{ fecha: '2015-06-30', dato: 10 },{ fecha: '2015-07-31', dato: 17 },{ fecha: '2015-08-31', dato: 6 },{ fecha: '2015-09-30', dato: 15 },{ fecha: '2015-10-31', dato: 14 },{ fecha: '2015-11-30', dato: 2 },{ fecha: '2015-12-31', dato: 2 },{ fecha: '2016-01-31', dato: 2 },{ fecha: '2016-02-29', dato: 3 },{ fecha: '2016-03-31', dato: 2 },{ fecha: '2016-04-30', dato: 9 },{ fecha: '2016-05-31', dato: 13 },{ fecha: '2016-06-30', dato: 17 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
