...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskcmtabpd">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoxjiqmqy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskcmtabpd a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskcmtabpd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoxjiqmqy === 'undefined') {
    varMorrisoxjiqmqy = Morris.Line({
      element: 'Morrisoxjiqmqy',
