...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvorkiflo">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismdrcqdzh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvorkiflo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvorkiflo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismdrcqdzh === 'undefined') {
    varMorrismdrcqdzh = Morris.Line({
      element: 'Morrismdrcqdzh',
