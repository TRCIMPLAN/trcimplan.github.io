...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaasmfwrr">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissdletihi" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqmairanf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaasmfwrr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaasmfwrr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissdletihi === 'undefined') {
    varMorrissdletihi = Morris.Line({
      element: 'Morrissdletihi',
...
// LENGUETA
$('#Lenguetasaasmfwrr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqmairanf;
  ...
  function initmapqmairanf() {
    // Nuevo Mapa
    mapqmairanf = new L.Map('LeafLetqmairanf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqmairanf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqmairanf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqmairanf === 'undefined') {
    varinitmapqmairanf = initmapqmairanf();
  };
});
FINAL;
    } // constructor
