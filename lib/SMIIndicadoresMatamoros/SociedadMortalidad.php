...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmdcnlhea">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvjbrnoes" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmdcnlhea a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmdcnlhea a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvjbrnoes;
  ...
  function initmapvjbrnoes() {
    // Nuevo Mapa
    mapvjbrnoes = new L.Map('LeafLetvjbrnoes');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvjbrnoes.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvjbrnoes.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvjbrnoes === 'undefined') {
    varinitmapvjbrnoes = initmapvjbrnoes();
  };
});
FINAL;
    } // constructor
