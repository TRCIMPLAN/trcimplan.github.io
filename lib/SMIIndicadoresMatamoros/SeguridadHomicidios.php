...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmajwhrgn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyrwokpnc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcezlcjik" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmajwhrgn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmajwhrgn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyrwokpnc === 'undefined') {
    varMorrisyrwokpnc = Morris.Line({
      element: 'Morrisyrwokpnc',
...
// LENGUETA
$('#Lenguetasmajwhrgn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcezlcjik;
  ...
  function initmapcezlcjik() {
    // Nuevo Mapa
    mapcezlcjik = new L.Map('LeafLetcezlcjik');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcezlcjik.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcezlcjik.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcezlcjik === 'undefined') {
    varinitmapcezlcjik = initmapcezlcjik();
  };
});
FINAL;
    } // constructor
