...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiygqgwye">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskeuavcxl" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiygqgwye a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiygqgwye a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskeuavcxl === 'undefined') {
    varMorriskeuavcxl = Morris.Line({
      element: 'Morriskeuavcxl',
