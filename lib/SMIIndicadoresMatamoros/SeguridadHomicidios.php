...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiseiooxp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdipjjdkw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiseiooxp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiseiooxp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdipjjdkw === 'undefined') {
    varMorrisdipjjdkw = Morris.Line({
      element: 'Morrisdipjjdkw',
