...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxggcwgdh">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetznphearo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxggcwgdh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxggcwgdh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapznphearo;
  ...
  function initmapznphearo() {
    // Nuevo Mapa
    mapznphearo = new L.Map('LeafLetznphearo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapznphearo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapznphearo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapznphearo === 'undefined') {
    varinitmapznphearo = initmapznphearo();
  };
});
FINAL;
    } // constructor
