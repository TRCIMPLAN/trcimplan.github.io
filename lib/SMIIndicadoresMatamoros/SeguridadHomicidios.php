...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdacmbooe">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetstrpxkpa" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdacmbooe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdacmbooe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapstrpxkpa;
  ...
  function initmapstrpxkpa() {
    // Nuevo Mapa
    mapstrpxkpa = new L.Map('LeafLetstrpxkpa');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapstrpxkpa.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapstrpxkpa.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapstrpxkpa === 'undefined') {
    varinitmapstrpxkpa = initmapstrpxkpa();
  };
});
FINAL;
    } // constructor
