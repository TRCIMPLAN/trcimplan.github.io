...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgqfrzxrr">
...
<div id="Morrissbazhjgc" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrcyfkrix" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgqfrzxrr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgqfrzxrr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissbazhjgc === 'undefined') {
    varMorrissbazhjgc = Morris.Line({
      element: 'Morrissbazhjgc',
...
// LENGUETA
$('#Lenguetasgqfrzxrr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprcyfkrix;
  ...
  function initmaprcyfkrix() {
    // Nuevo Mapa
    maprcyfkrix = new L.Map('LeafLetrcyfkrix');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprcyfkrix.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprcyfkrix.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprcyfkrix === 'undefined') {
    varinitmaprcyfkrix = initmaprcyfkrix();
  };
});
FINAL;
    } // constructor
