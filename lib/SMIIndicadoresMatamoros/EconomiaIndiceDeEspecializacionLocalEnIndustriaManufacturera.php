...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyqczuner">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvxslcewp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyqczuner a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyqczuner a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvxslcewp === 'undefined') {
    varMorrisvxslcewp = Morris.Line({
      element: 'Morrisvxslcewp',
