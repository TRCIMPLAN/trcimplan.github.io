...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjstxxldx">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbbglazzt" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpokbuzqt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjstxxldx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjstxxldx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbbglazzt === 'undefined') {
    varMorrisbbglazzt = Morris.Line({
      element: 'Morrisbbglazzt',
...
// LENGUETA
$('#Lenguetasjstxxldx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappokbuzqt;
  ...
  function initmappokbuzqt() {
    // Nuevo Mapa
    mappokbuzqt = new L.Map('LeafLetpokbuzqt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappokbuzqt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappokbuzqt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappokbuzqt === 'undefined') {
    varinitmappokbuzqt = initmappokbuzqt();
  };
});
FINAL;
    } // constructor
