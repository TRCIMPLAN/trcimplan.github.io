...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqvfffvkb">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgjxaxvvc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoipzupxr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqvfffvkb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqvfffvkb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgjxaxvvc === 'undefined') {
    varMorrisgjxaxvvc = Morris.Line({
      element: 'Morrisgjxaxvvc',
...
// LENGUETA
$('#Lenguetasqvfffvkb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoipzupxr;
  ...
  function initmapoipzupxr() {
    // Nuevo Mapa
    mapoipzupxr = new L.Map('LeafLetoipzupxr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoipzupxr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoipzupxr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoipzupxr === 'undefined') {
    varinitmapoipzupxr = initmapoipzupxr();
  };
});
FINAL;
    } // constructor
