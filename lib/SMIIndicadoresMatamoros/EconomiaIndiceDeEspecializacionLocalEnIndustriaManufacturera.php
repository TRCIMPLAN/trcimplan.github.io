...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmvlvauwy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqwmwkfzp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetopueibve" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmvlvauwy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmvlvauwy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqwmwkfzp === 'undefined') {
    varMorrisqwmwkfzp = Morris.Line({
      element: 'Morrisqwmwkfzp',
...
// LENGUETA
$('#Lenguetasmvlvauwy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapopueibve;
  ...
  function initmapopueibve() {
    // Nuevo Mapa
    mapopueibve = new L.Map('LeafLetopueibve');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapopueibve.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapopueibve.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapopueibve === 'undefined') {
    varinitmapopueibve = initmapopueibve();
  };
});
FINAL;
    } // constructor
