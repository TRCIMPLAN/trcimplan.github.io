...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjfevvdpw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscwntevmd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjfevvdpw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjfevvdpw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscwntevmd === 'undefined') {
    varMorriscwntevmd = Morris.Line({
      element: 'Morriscwntevmd',
