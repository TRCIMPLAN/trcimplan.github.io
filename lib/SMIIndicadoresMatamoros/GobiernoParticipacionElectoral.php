...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspgtlmisw">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetecbawqwg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspgtlmisw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspgtlmisw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapecbawqwg;
  ...
  function initmapecbawqwg() {
    // Nuevo Mapa
    mapecbawqwg = new L.Map('LeafLetecbawqwg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapecbawqwg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapecbawqwg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapecbawqwg === 'undefined') {
    varinitmapecbawqwg = initmapecbawqwg();
  };
});
FINAL;
    } // constructor
