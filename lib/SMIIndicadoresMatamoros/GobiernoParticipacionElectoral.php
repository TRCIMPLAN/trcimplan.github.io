...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasceotytjo">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsaipbtah" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasceotytjo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasceotytjo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsaipbtah;
  ...
  function initmapsaipbtah() {
    // Nuevo Mapa
    mapsaipbtah = new L.Map('LeafLetsaipbtah');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsaipbtah.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsaipbtah.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsaipbtah === 'undefined') {
    varinitmapsaipbtah = initmapsaipbtah();
  };
});
FINAL;
    } // constructor
