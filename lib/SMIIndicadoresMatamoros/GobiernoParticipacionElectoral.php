...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskohfwutf">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmdmpwtig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskohfwutf a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskohfwutf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmdmpwtig;
  ...
  function initmapmdmpwtig() {
    // Nuevo Mapa
    mapmdmpwtig = new L.Map('LeafLetmdmpwtig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmdmpwtig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmdmpwtig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmdmpwtig === 'undefined') {
    varinitmapmdmpwtig = initmapmdmpwtig();
  };
});
FINAL;
    } // constructor
