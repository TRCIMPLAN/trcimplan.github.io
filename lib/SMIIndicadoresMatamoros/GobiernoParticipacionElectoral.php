...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqzheoszw">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethbnxvwpe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqzheoszw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqzheoszw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphbnxvwpe;
  ...
  function initmaphbnxvwpe() {
    // Nuevo Mapa
    maphbnxvwpe = new L.Map('LeafLethbnxvwpe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphbnxvwpe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphbnxvwpe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphbnxvwpe === 'undefined') {
    varinitmaphbnxvwpe = initmaphbnxvwpe();
  };
});
FINAL;
    } // constructor
