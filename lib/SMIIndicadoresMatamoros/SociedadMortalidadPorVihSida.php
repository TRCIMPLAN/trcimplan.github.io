<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Mortalidad por VIH-SIDA (Creado por Central:SmiLanzadera)
 *
...
<p>Defunciones a causa de VIH/SIDA por cada 100,000 habitantes</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Mortalidad por VIH-SIDA en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2013-12-31', dato: 1.8000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
