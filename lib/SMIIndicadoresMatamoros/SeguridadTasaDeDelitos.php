...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspecvrces">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetphvewatj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspecvrces a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspecvrces a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapphvewatj;
  ...
  function initmapphvewatj() {
    // Nuevo Mapa
    mapphvewatj = new L.Map('LeafLetphvewatj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapphvewatj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapphvewatj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapphvewatj === 'undefined') {
    varinitmapphvewatj = initmapphvewatj();
  };
});
FINAL;
    } // constructor
