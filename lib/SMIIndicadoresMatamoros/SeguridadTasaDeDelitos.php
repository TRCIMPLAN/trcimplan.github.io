...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiipyacnx">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmtervhgn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiipyacnx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiipyacnx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmtervhgn;
  ...
  function initmapmtervhgn() {
    // Nuevo Mapa
    mapmtervhgn = new L.Map('LeafLetmtervhgn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmtervhgn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmtervhgn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmtervhgn === 'undefined') {
    varinitmapmtervhgn = initmapmtervhgn();
  };
});
FINAL;
    } // constructor
