...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascqftuyah">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqkqjtrcv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascqftuyah a:first').tab('show')
});
// LENGUETA
$('#Lenguetascqftuyah a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqkqjtrcv;
  ...
  function initmapqkqjtrcv() {
    // Nuevo Mapa
    mapqkqjtrcv = new L.Map('LeafLetqkqjtrcv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqkqjtrcv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqkqjtrcv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqkqjtrcv === 'undefined') {
    varinitmapqkqjtrcv = initmapqkqjtrcv();
  };
});
FINAL;
    } // constructor
