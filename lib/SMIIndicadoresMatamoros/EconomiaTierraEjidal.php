<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Tierra Ejidal (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaTierraEjidal extends \Base\Publicacion {
...
<p>Unidades: Porcentaje de la superficie total de las unidades económicas. Fuente: INEGI, 2008.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tierra Ejidal en Matamoros</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 59.0000 },{ fecha: '2009-12-31', dato: 59.0000 },{ fecha: '2010-12-31', dato: 59.0000 },{ fecha: '2011-12-31', dato: 59.0000 },{ fecha: '2012-12-31', dato: 59.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 68.2100 },{ region: 'Gómez Palacio', dato: 58.9200 },{ region: 'Lerdo', dato: 70.2100 },{ region: 'Matamoros', dato: 59.0000 },{ region: 'La Laguna', dato: 63.3400 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
