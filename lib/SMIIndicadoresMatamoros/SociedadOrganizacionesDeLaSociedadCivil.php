...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswiwkzct">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteovjvldw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswiwkzct a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswiwkzct a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeovjvldw;
  ...
  function initmapeovjvldw() {
    // Nuevo Mapa
    mapeovjvldw = new L.Map('LeafLeteovjvldw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeovjvldw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeovjvldw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeovjvldw === 'undefined') {
    varinitmapeovjvldw = initmapeovjvldw();
  };
});
FINAL;
    } // constructor
