...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspfxcsodm">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlagdlppj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspfxcsodm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspfxcsodm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplagdlppj;
  ...
  function initmaplagdlppj() {
    // Nuevo Mapa
    maplagdlppj = new L.Map('LeafLetlagdlppj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplagdlppj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplagdlppj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplagdlppj === 'undefined') {
    varinitmaplagdlppj = initmaplagdlppj();
  };
});
FINAL;
    } // constructor
