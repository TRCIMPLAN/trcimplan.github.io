<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros EconomiaHorasLaboradas
 *
...
class EconomiaHorasLaboradas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Horas laboradas en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '53462897.5100', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 el decimal es por "Horas trabajadas al año"')); // formateado 0, valor 2, crudo 2
    } // datos
