<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda
 *
...
class SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a los servicios básicos de la vivienda en Matamoros';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '9.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
