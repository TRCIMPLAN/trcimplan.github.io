...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgsxblbtz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissroyonnz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgsxblbtz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgsxblbtz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissroyonnz === 'undefined') {
    varMorrissroyonnz = Morris.Line({
      element: 'Morrissroyonnz',
