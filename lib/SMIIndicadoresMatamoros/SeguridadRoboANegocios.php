...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswlsrdlyc">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskjnqmbyk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswlsrdlyc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswlsrdlyc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskjnqmbyk === 'undefined') {
    varMorriskjnqmbyk = Morris.Line({
      element: 'Morriskjnqmbyk',
