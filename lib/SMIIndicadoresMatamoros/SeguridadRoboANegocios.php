...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseixxmafx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscodmcifp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseixxmafx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseixxmafx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscodmcifp === 'undefined') {
    varMorriscodmcifp = Morris.Line({
      element: 'Morriscodmcifp',
