...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashwxhyhen">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismjtisfnu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashwxhyhen a:first').tab('show')
});
// LENGUETA
$('#Lenguetashwxhyhen a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismjtisfnu === 'undefined') {
    varMorrismjtisfnu = Morris.Line({
      element: 'Morrismjtisfnu',
