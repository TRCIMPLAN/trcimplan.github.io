...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasixedmecg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishmwsvjez" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfaozkrwi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasixedmecg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasixedmecg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishmwsvjez === 'undefined') {
    varMorrishmwsvjez = Morris.Line({
      element: 'Morrishmwsvjez',
...
// LENGUETA
$('#Lenguetasixedmecg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfaozkrwi;
  ...
  function initmapfaozkrwi() {
    // Nuevo Mapa
    mapfaozkrwi = new L.Map('LeafLetfaozkrwi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfaozkrwi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfaozkrwi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfaozkrwi === 'undefined') {
    varinitmapfaozkrwi = initmapfaozkrwi();
  };
});
FINAL;
    } // constructor
