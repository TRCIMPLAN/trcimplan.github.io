...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvsldmcxt">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuyazdjlm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvsldmcxt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvsldmcxt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuyazdjlm;
  ...
  function initmapuyazdjlm() {
    // Nuevo Mapa
    mapuyazdjlm = new L.Map('LeafLetuyazdjlm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuyazdjlm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuyazdjlm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuyazdjlm === 'undefined') {
    varinitmapuyazdjlm = initmapuyazdjlm();
  };
});
FINAL;
    } // constructor
