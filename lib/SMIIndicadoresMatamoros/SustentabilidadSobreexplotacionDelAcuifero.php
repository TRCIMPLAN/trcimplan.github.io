...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuadpolwa">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnycackws" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuadpolwa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuadpolwa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnycackws;
  ...
  function initmapnycackws() {
    // Nuevo Mapa
    mapnycackws = new L.Map('LeafLetnycackws');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnycackws.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnycackws.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnycackws === 'undefined') {
    varinitmapnycackws = initmapnycackws();
  };
});
FINAL;
    } // constructor
