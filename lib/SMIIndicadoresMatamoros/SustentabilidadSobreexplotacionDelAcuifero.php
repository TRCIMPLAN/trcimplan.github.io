...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmsrimcxv">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethpiljtcj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmsrimcxv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmsrimcxv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphpiljtcj;
  ...
  function initmaphpiljtcj() {
    // Nuevo Mapa
    maphpiljtcj = new L.Map('LeafLethpiljtcj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphpiljtcj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphpiljtcj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphpiljtcj === 'undefined') {
    varinitmaphpiljtcj = initmaphpiljtcj();
  };
});
FINAL;
    } // constructor
