...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqsuvoaz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettckqliml" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqsuvoaz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqsuvoaz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptckqliml;
  ...
  function initmaptckqliml() {
    // Nuevo Mapa
    maptckqliml = new L.Map('LeafLettckqliml');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptckqliml.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptckqliml.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptckqliml === 'undefined') {
    varinitmaptckqliml = initmaptckqliml();
  };
});
FINAL;
    } // constructor
