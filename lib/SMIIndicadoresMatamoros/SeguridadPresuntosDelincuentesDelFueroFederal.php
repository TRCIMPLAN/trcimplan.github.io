...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashnltoxrr">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwatgwzpb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashnltoxrr a:first').tab('show')
});
// LENGUETA
$('#Lenguetashnltoxrr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwatgwzpb;
  ...
  function initmapwatgwzpb() {
    // Nuevo Mapa
    mapwatgwzpb = new L.Map('LeafLetwatgwzpb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwatgwzpb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwatgwzpb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwatgwzpb === 'undefined') {
    varinitmapwatgwzpb = initmapwatgwzpb();
  };
});
FINAL;
    } // constructor
