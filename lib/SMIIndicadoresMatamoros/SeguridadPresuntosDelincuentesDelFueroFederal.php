...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqqugcuqi">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethrqsjehb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqqugcuqi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqqugcuqi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphrqsjehb;
  ...
  function initmaphrqsjehb() {
    // Nuevo Mapa
    maphrqsjehb = new L.Map('LeafLethrqsjehb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphrqsjehb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphrqsjehb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphrqsjehb === 'undefined') {
    varinitmaphrqsjehb = initmaphrqsjehb();
  };
});
FINAL;
    } // constructor
