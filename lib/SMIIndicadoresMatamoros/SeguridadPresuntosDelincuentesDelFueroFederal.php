...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszclyeqid">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdmfahuux" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszclyeqid a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszclyeqid a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdmfahuux;
  ...
  function initmapdmfahuux() {
    // Nuevo Mapa
    mapdmfahuux = new L.Map('LeafLetdmfahuux');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdmfahuux.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdmfahuux.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdmfahuux === 'undefined') {
    varinitmapdmfahuux = initmapdmfahuux();
  };
});
FINAL;
    } // constructor
