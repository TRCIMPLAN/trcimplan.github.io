...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswnebjyek">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdrlvjsog" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswnebjyek a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswnebjyek a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdrlvjsog;
  ...
  function initmapdrlvjsog() {
    // Nuevo Mapa
    mapdrlvjsog = new L.Map('LeafLetdrlvjsog');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdrlvjsog.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdrlvjsog.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdrlvjsog === 'undefined') {
    varinitmapdrlvjsog = initmapdrlvjsog();
  };
});
FINAL;
    } // constructor
