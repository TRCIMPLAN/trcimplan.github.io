...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashgngxgiu">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgwqawlgd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashgngxgiu a:first').tab('show')
});
// LENGUETA
$('#Lenguetashgngxgiu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgwqawlgd;
  ...
  function initmapgwqawlgd() {
    // Nuevo Mapa
    mapgwqawlgd = new L.Map('LeafLetgwqawlgd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgwqawlgd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgwqawlgd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgwqawlgd === 'undefined') {
    varinitmapgwqawlgd = initmapgwqawlgd();
  };
});
FINAL;
    } // constructor
