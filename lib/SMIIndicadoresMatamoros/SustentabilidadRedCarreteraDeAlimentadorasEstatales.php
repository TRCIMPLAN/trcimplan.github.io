...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashexwucrx">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzmucjzya" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashexwucrx a:first').tab('show')
});
// LENGUETA
$('#Lenguetashexwucrx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzmucjzya;
  ...
  function initmapzmucjzya() {
    // Nuevo Mapa
    mapzmucjzya = new L.Map('LeafLetzmucjzya');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzmucjzya.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzmucjzya.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzmucjzya === 'undefined') {
    varinitmapzmucjzya = initmapzmucjzya();
  };
});
FINAL;
    } // constructor
