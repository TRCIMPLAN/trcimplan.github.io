...
class SociedadIndiceDeDesarrolloHumanoIdh extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasioioswvc">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwgoilcww" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasioioswvc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasioioswvc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwgoilcww;
  ...
  function initmapwgoilcww() {
    // Nuevo Mapa
    mapwgoilcww = new L.Map('LeafLetwgoilcww');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwgoilcww.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwgoilcww.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwgoilcww === 'undefined') {
    varinitmapwgoilcww = initmapwgoilcww();
  };
});
FINAL;
    } // constructor
