<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Economía Salario Promedio Mensual para Trabajadores de Tiempo Completo (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica-2"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos === 'undefined') {
    vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos = Morris.Line({
      ...
      data: [{ fecha: '2015-03-31', dato: 4043.13 },{ fecha: '2015-06-30', dato: 4425.56 },{ fecha: '2015-09-30', dato: 5059.90 },{ fecha: '2015-12-31', dato: 4936.80 },{ fecha: '2016-03-31', dato: 5059.74 },{ fecha: '2016-06-30', dato: 4722.96 },{ fecha: '2016-09-30', dato: 4872.94 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 6282.40 },{ region: 'Gómez Palacio', dato: 5698.27 },{ region: 'Lerdo', dato: 5896.23 },{ region: 'Matamoros', dato: 4872.94 },{ region: 'La Laguna', dato: 5896.38 },{ region: 'Coahuila', dato: 7063.56 },{ region: 'Durango', dato: 5759.83 },{ region: 'Nacional', dato: 6365.06 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
