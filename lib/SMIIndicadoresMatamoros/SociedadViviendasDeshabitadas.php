<?php
/**
 * TrcIMPLAN - SMI Indicadores Matamoros Sociedad Viviendas Deshabitadas (Creado por Central:SmiLanzadera)
 *
...
Fuente: INEGI (Censo de Población y Vivienda).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Viviendas Deshabitadas en Matamoros</h3>
