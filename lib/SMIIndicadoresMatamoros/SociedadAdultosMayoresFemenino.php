...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasavztlsni">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvylxwlki" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasavztlsni a:first').tab('show')
});
// LENGUETA
$('#Lenguetasavztlsni a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvylxwlki === 'undefined') {
    varMorrisvylxwlki = Morris.Line({
      element: 'Morrisvylxwlki',
