...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasargclskn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishgkhpptw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasargclskn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasargclskn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishgkhpptw === 'undefined') {
    varMorrishgkhpptw = Morris.Line({
      element: 'Morrishgkhpptw',
