...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmtlmnvrt">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmfzyflmd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmtlmnvrt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmtlmnvrt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmfzyflmd;
  ...
  function initmapmfzyflmd() {
    // Nuevo Mapa
    mapmfzyflmd = new L.Map('LeafLetmfzyflmd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmfzyflmd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmfzyflmd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmfzyflmd === 'undefined') {
    varinitmapmfzyflmd = initmapmfzyflmd();
  };
});
FINAL;
    } // constructor
