...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseyftdgew">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqhinlhym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseyftdgew a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseyftdgew a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqhinlhym;
  ...
  function initmapqhinlhym() {
    // Nuevo Mapa
    mapqhinlhym = new L.Map('LeafLetqhinlhym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqhinlhym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqhinlhym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqhinlhym === 'undefined') {
    varinitmapqhinlhym = initmapqhinlhym();
  };
});
FINAL;
    } // constructor
