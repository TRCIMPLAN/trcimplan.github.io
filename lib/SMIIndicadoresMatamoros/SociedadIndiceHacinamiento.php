<?php
/**
 * SociedadIndiceHacinamiento.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadIndiceHacinamiento
 */
class SociedadIndiceHacinamiento extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sociedadindice-hacinamiento';
        ...
        $this->claves       = 'Matamoros, Bienestar, Vivienda';
