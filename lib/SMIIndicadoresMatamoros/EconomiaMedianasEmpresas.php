...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdxlyuwqp">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismhfgswcq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcafezmwl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdxlyuwqp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdxlyuwqp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismhfgswcq === 'undefined') {
    varMorrismhfgswcq = Morris.Line({
      element: 'Morrismhfgswcq',
...
// LENGUETA
$('#Lenguetasdxlyuwqp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcafezmwl;
  ...
  function initmapcafezmwl() {
    // Nuevo Mapa
    mapcafezmwl = new L.Map('LeafLetcafezmwl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcafezmwl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcafezmwl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcafezmwl === 'undefined') {
    varinitmapcafezmwl = initmapcafezmwl();
  };
});
FINAL;
    } // constructor
