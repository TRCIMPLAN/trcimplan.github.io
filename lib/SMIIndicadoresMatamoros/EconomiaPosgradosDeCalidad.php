...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassljvxglf">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetooyigrxr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassljvxglf a:first').tab('show')
});
// LENGUETA
$('#Lenguetassljvxglf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapooyigrxr;
  ...
  function initmapooyigrxr() {
    // Nuevo Mapa
    mapooyigrxr = new L.Map('LeafLetooyigrxr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapooyigrxr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapooyigrxr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapooyigrxr === 'undefined') {
    varinitmapooyigrxr = initmapooyigrxr();
  };
});
FINAL;
    } // constructor
