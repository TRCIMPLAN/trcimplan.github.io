...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgnwazdun">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjvjdnpyf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgnwazdun a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgnwazdun a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjvjdnpyf;
  ...
  function initmapjvjdnpyf() {
    // Nuevo Mapa
    mapjvjdnpyf = new L.Map('LeafLetjvjdnpyf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjvjdnpyf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjvjdnpyf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjvjdnpyf === 'undefined') {
    varinitmapjvjdnpyf = initmapjvjdnpyf();
  };
});
FINAL;
    } // constructor
