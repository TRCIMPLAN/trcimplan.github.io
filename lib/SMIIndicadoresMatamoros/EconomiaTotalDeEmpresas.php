...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszewwdhqn">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisykrearos" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszewwdhqn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszewwdhqn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisykrearos === 'undefined') {
    varMorrisykrearos = Morris.Line({
      element: 'Morrisykrearos',
