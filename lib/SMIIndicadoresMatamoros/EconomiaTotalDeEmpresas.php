...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaselddjhhg">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbycycqhf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwgyxbkcu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaselddjhhg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaselddjhhg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbycycqhf === 'undefined') {
    varMorrisbycycqhf = Morris.Line({
      element: 'Morrisbycycqhf',
...
// LENGUETA
$('#Lenguetaselddjhhg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwgyxbkcu;
  ...
  function initmapwgyxbkcu() {
    // Nuevo Mapa
    mapwgyxbkcu = new L.Map('LeafLetwgyxbkcu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwgyxbkcu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwgyxbkcu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwgyxbkcu === 'undefined') {
    varinitmapwgyxbkcu = initmapwgyxbkcu();
  };
});
FINAL;
    } // constructor
