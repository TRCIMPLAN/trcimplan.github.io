...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoivemuhb">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszdbawpgh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetebomscfp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoivemuhb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoivemuhb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszdbawpgh === 'undefined') {
    varMorriszdbawpgh = Morris.Line({
      element: 'Morriszdbawpgh',
...
// LENGUETA
$('#Lenguetasoivemuhb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapebomscfp;
  ...
  function initmapebomscfp() {
    // Nuevo Mapa
    mapebomscfp = new L.Map('LeafLetebomscfp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapebomscfp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapebomscfp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapebomscfp === 'undefined') {
    varinitmapebomscfp = initmapebomscfp();
  };
});
FINAL;
    } // constructor
