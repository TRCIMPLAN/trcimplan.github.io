...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrnqbvvet">
...
<div id="Morrishyghdbfk" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgypenepy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrnqbvvet a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrnqbvvet a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishyghdbfk === 'undefined') {
    varMorrishyghdbfk = Morris.Line({
      element: 'Morrishyghdbfk',
...
// LENGUETA
$('#Lenguetasrnqbvvet a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgypenepy;
  ...
  function initmapgypenepy() {
    // Nuevo Mapa
    mapgypenepy = new L.Map('LeafLetgypenepy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgypenepy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgypenepy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgypenepy === 'undefined') {
    varinitmapgypenepy = initmapgypenepy();
  };
});
FINAL;
    } // constructor
