...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxjcvdwer">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetntrolkqn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxjcvdwer a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxjcvdwer a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapntrolkqn;
  ...
  function initmapntrolkqn() {
    // Nuevo Mapa
    mapntrolkqn = new L.Map('LeafLetntrolkqn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapntrolkqn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapntrolkqn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapntrolkqn === 'undefined') {
    varinitmapntrolkqn = initmapntrolkqn();
  };
});
FINAL;
    } // constructor
