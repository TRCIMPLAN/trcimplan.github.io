...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyqkzmagz">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdhfumpct" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyqkzmagz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyqkzmagz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdhfumpct;
  ...
  function initmapdhfumpct() {
    // Nuevo Mapa
    mapdhfumpct = new L.Map('LeafLetdhfumpct');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdhfumpct.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdhfumpct.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdhfumpct === 'undefined') {
    varinitmapdhfumpct = initmapdhfumpct();
  };
});
FINAL;
    } // constructor
