...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasypsvloyz">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwnzqdwht" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasypsvloyz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasypsvloyz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwnzqdwht;
  ...
  function initmapwnzqdwht() {
    // Nuevo Mapa
    mapwnzqdwht = new L.Map('LeafLetwnzqdwht');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwnzqdwht.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwnzqdwht.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwnzqdwht === 'undefined') {
    varinitmapwnzqdwht = initmapwnzqdwht();
  };
});
FINAL;
    } // constructor
