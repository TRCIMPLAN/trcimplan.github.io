...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasufyzxmuu">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuxccuoul" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasufyzxmuu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasufyzxmuu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuxccuoul;
  ...
  function initmapuxccuoul() {
    // Nuevo Mapa
    mapuxccuoul = new L.Map('LeafLetuxccuoul');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuxccuoul.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuxccuoul.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuxccuoul === 'undefined') {
    varinitmapuxccuoul = initmapuxccuoul();
  };
});
FINAL;
    } // constructor
