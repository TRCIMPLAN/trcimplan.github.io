...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskfwwvfmu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispbmvntto" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskfwwvfmu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskfwwvfmu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispbmvntto === 'undefined') {
    varMorrispbmvntto = Morris.Line({
      element: 'Morrispbmvntto',
