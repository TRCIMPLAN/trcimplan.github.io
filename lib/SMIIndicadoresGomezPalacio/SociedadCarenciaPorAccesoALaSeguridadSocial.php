<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadCarenciaPorAccesoALaSeguridadSocial
 *
...
class SociedadCarenciaPorAccesoALaSeguridadSocial extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a la seguridad social en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '32.8000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
