...
class SociedadViviendasConComputadora extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasphyxxjmc">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlyyrtixd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasphyxxjmc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasphyxxjmc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplyyrtixd;
  ...
  function initmaplyyrtixd() {
    // Nuevo Mapa
    maplyyrtixd = new L.Map('LeafLetlyyrtixd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplyyrtixd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplyyrtixd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplyyrtixd === 'undefined') {
    varinitmaplyyrtixd = initmaplyyrtixd();
  };
});
FINAL;
    } // constructor
