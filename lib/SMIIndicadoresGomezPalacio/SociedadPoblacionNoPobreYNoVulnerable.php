<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPoblacionNoPobreYNoVulnerable
 *
...
class SociedadPoblacionNoPobreYNoVulnerable extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población no pobre y no vulnerable en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '23.6000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '29.3000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
