...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqbusfpgf">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkwtuaqyj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqbusfpgf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqbusfpgf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkwtuaqyj;
  ...
  function initmapkwtuaqyj() {
    // Nuevo Mapa
    mapkwtuaqyj = new L.Map('LeafLetkwtuaqyj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkwtuaqyj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkwtuaqyj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkwtuaqyj === 'undefined') {
    varinitmapkwtuaqyj = initmapkwtuaqyj();
  };
});
FINAL;
    } // constructor
