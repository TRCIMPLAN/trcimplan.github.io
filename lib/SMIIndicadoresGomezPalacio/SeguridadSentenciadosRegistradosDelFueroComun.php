...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslpbaejyo">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqhghyurn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslpbaejyo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslpbaejyo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqhghyurn;
  ...
  function initmapqhghyurn() {
    // Nuevo Mapa
    mapqhghyurn = new L.Map('LeafLetqhghyurn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqhghyurn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqhghyurn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqhghyurn === 'undefined') {
    varinitmapqhghyurn = initmapqhghyurn();
  };
});
FINAL;
    } // constructor
