...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoklxkdki">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethrjdmmpw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoklxkdki a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoklxkdki a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphrjdmmpw;
  ...
  function initmaphrjdmmpw() {
    // Nuevo Mapa
    maphrjdmmpw = new L.Map('LeafLethrjdmmpw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphrjdmmpw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphrjdmmpw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphrjdmmpw === 'undefined') {
    varinitmaphrjdmmpw = initmaphrjdmmpw();
  };
});
FINAL;
    } // constructor
