...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslcplxbgc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlbyjlsxp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslcplxbgc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslcplxbgc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplbyjlsxp;
  ...
  function initmaplbyjlsxp() {
    // Nuevo Mapa
    maplbyjlsxp = new L.Map('LeafLetlbyjlsxp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplbyjlsxp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplbyjlsxp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplbyjlsxp === 'undefined') {
    varinitmaplbyjlsxp = initmaplbyjlsxp();
  };
});
FINAL;
    } // constructor
