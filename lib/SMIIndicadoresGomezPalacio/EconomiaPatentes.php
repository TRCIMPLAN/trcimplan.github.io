<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Patentes (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaPatentes extends \Base\Publicacion {
...
<p>Unidades: Por cada 100 mil de PEA. Fuente: CONACYT, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Patentes en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Patentes</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Patentes</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.7773 },{ fecha: '2009-12-31', dato: 3.5720 },{ fecha: '2010-12-31', dato: 5.1570 },{ fecha: '2011-12-31', dato: 6.7204 },{ fecha: '2012-12-31', dato: 8.4125 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 5.6569 },{ region: 'Gómez Palacio', dato: 8.4125 },{ region: 'Lerdo', dato: 8.4125 },{ region: 'Matamoros', dato: 7.7962 },{ region: 'La Laguna', dato: 5.3714 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
