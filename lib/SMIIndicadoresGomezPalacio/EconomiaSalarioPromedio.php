<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Salario promedio (Creado por Central:SmiLanzadera)
 *
...
/**
 * Clase EconomiaSalarioPromedio
 */
class EconomiaSalarioPromedio extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Salario promedio en Gómez Palacio';
     // $this->autor             = '';
        $this->fecha             = '2015-05-21T12:56';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'economia-salario-promedio';
        $this->imagen            = '../smi/introduccion/imagen.jpg';
        $this->imagen_previa     = '../smi/introduccion/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales. Las categorías son de uso interno
        $this->descripcion       = 'Salario promedio mensual para personal ocupado con jornadas laborales de 35 a 48 horas semanales.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Salario promedio mensual para personal ocupado con jornadas laborales de 35 a 48 horas semanales.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Salario promedio en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Salario promedio</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Salario promedio</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2015-03-31', dato: 5319.43 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
