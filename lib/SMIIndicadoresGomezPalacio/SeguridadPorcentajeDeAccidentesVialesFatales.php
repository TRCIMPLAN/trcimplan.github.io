...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswusczca">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdadgcrxt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswusczca a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswusczca a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdadgcrxt;
  ...
  function initmapdadgcrxt() {
    // Nuevo Mapa
    mapdadgcrxt = new L.Map('LeafLetdadgcrxt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdadgcrxt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdadgcrxt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdadgcrxt === 'undefined') {
    varinitmapdadgcrxt = initmapdadgcrxt();
  };
});
FINAL;
    } // constructor
