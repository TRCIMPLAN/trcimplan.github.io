...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashgcbcihy">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzfrxufin" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashgcbcihy a:first').tab('show')
});
// LENGUETA
$('#Lenguetashgcbcihy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzfrxufin;
  ...
  function initmapzfrxufin() {
    // Nuevo Mapa
    mapzfrxufin = new L.Map('LeafLetzfrxufin');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzfrxufin.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzfrxufin.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzfrxufin === 'undefined') {
    varinitmapzfrxufin = initmapzfrxufin();
  };
});
FINAL;
    } // constructor
