...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasepekxmwq">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcyzxegro" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasepekxmwq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasepekxmwq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcyzxegro;
  ...
  function initmapcyzxegro() {
    // Nuevo Mapa
    mapcyzxegro = new L.Map('LeafLetcyzxegro');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcyzxegro.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcyzxegro.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcyzxegro === 'undefined') {
    varinitmapcyzxegro = initmapcyzxegro();
  };
});
FINAL;
    } // constructor
