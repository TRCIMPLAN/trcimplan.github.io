...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasumoswavd">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoidtqswx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasumoswavd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasumoswavd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoidtqswx;
  ...
  function initmapoidtqswx() {
    // Nuevo Mapa
    mapoidtqswx = new L.Map('LeafLetoidtqswx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoidtqswx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoidtqswx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoidtqswx === 'undefined') {
    varinitmapoidtqswx = initmapoidtqswx();
  };
});
FINAL;
    } // constructor
