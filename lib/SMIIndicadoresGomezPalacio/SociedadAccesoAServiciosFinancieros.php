<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Acceso a Servicios Financieros (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadAccesoAServiciosFinancieros extends \Base\Publicacion {
...
Qué mide: El número de sucursales y corresponsales de banca múltiple en la ciudad por
cada 10 mil adultos como proxy del acceso a servicios financieros.
Unidades: Sucursales/corresponsales por cada 10 mil adultos.
Fuente: (CNBV), 2010-2012.';
...
Fuente: (CNBV), 2010-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Acceso a Servicios Financieros en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 3.0400 },{ fecha: '2009-12-31', dato: 2.9799 },{ fecha: '2010-12-31', dato: 2.9209 },{ fecha: '2011-12-31', dato: 4.5736 },{ fecha: '2012-12-31', dato: 4.8501 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
