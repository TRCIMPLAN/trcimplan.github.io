<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Viviendas con Líneas Telefónicas Móviles (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadViviendasConLineasTelefonicasMoviles extends \Base\Publicacion {
...
Unidades: Porcentaje de viviendas habitadas.
Fuente: Estimaciones de IMCO a partir del Módulo de Condiciones Socioeconómicas (MCS) del Consejo Nacional para la Evaluación de la Política de Desarrollo Social (CONEVAL), 2008-2012.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Precursores". Mide el número de viviendas que cuentan con líneas telefónicas móviles como porcentaje del total de viviendas habitadas.
Unidades: Porcentaje de viviendas habitadas.
Fuente: Estimaciones de IMCO a partir del Módulo de Condiciones Socioeconómicas (MCS) del Consejo Nacional para la Evaluación de la Política de Desarrollo Social (CONEVAL), 2008-2012.</p>
