...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbkxuhzvd">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoycyokgl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbkxuhzvd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbkxuhzvd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoycyokgl;
  ...
  function initmapoycyokgl() {
    // Nuevo Mapa
    mapoycyokgl = new L.Map('LeafLetoycyokgl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoycyokgl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoycyokgl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoycyokgl === 'undefined') {
    varinitmapoycyokgl = initmapoycyokgl();
  };
});
FINAL;
    } // constructor
