...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbnprwokm">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwpraeaez" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbnprwokm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbnprwokm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwpraeaez;
  ...
  function initmapwpraeaez() {
    // Nuevo Mapa
    mapwpraeaez = new L.Map('LeafLetwpraeaez');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwpraeaez.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwpraeaez.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwpraeaez === 'undefined') {
    varinitmapwpraeaez = initmapwpraeaez();
  };
});
FINAL;
    } // constructor
