...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgdcdbbsw">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjnnutsav" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgdcdbbsw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgdcdbbsw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjnnutsav;
  ...
  function initmapjnnutsav() {
    // Nuevo Mapa
    mapjnnutsav = new L.Map('LeafLetjnnutsav');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjnnutsav.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjnnutsav.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjnnutsav === 'undefined') {
    varinitmapjnnutsav = initmapjnnutsav();
  };
});
FINAL;
    } // constructor
