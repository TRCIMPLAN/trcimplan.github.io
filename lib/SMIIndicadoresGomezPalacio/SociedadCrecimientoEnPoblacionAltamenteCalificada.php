<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Crecimiento en Población Altamente Calificada (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadCrecimientoEnPoblacionAltamenteCalificada extends \Base\Publicacion {
...
<p>Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Población Altamente Calificada en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Crecimiento en Población Altamente Calificada</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Crecimiento en Población Altamente Calificada</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 4.8200 },{ fecha: '2009-12-31', dato: 4.8200 },{ fecha: '2010-12-31', dato: 4.8200 },{ fecha: '2011-12-31', dato: 4.8200 },{ fecha: '2012-12-31', dato: 4.8200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: -2.9800 },{ region: 'Gómez Palacio', dato: 4.8200 },{ region: 'Lerdo', dato: -10.6700 },{ region: 'Matamoros', dato: -1.2200 },{ region: 'La Laguna', dato: -1.5500 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
