<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Uso de Twitter como Proxy de Uso de Tecnologías de Información (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.7678 },{ fecha: '2009-12-31', dato: 0.7678 },{ fecha: '2010-12-31', dato: 0.7678 },{ fecha: '2011-12-31', dato: 0.7678 },{ fecha: '2012-12-31', dato: 2.8366 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
