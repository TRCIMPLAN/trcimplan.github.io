...
class SociedadPoblacionDerechohabiente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashxlspsrb">
...
Fuente: INEGI
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetudnygxtg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashxlspsrb a:first').tab('show')
});
// LENGUETA
$('#Lenguetashxlspsrb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapudnygxtg;
  ...
  function initmapudnygxtg() {
    // Nuevo Mapa
    mapudnygxtg = new L.Map('LeafLetudnygxtg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapudnygxtg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapudnygxtg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapudnygxtg === 'undefined') {
    varinitmapudnygxtg = initmapudnygxtg();
  };
});
FINAL;
    } // constructor
