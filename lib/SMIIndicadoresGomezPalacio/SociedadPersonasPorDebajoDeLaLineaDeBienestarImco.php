<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPersonasPorDebajoDeLaLineaDeBienestarImco
 *
...
class SociedadPersonasPorDebajoDeLaLineaDeBienestarImco extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas por Debajo de la Línea de Bienestar (IMCO) en Gómez Palacio';
