<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Crecimiento de la Población Ocupada sin Ingresos (Creado por Central:SmiLanzadera)
 *
...
class EconomiaCrecimientoDeLaPoblacionOcupadaSinIngresos extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento de la Población Ocupada sin Ingresos en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: -9.6900 },{ fecha: '2009-12-31', dato: -9.6900 },{ fecha: '2010-12-31', dato: -9.6900 },{ fecha: '2011-12-31', dato: -9.6900 },{ fecha: '2012-12-31', dato: -9.6900 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
