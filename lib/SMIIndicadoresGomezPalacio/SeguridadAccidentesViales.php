...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbtxzboos">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvatqmlgy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxeiykfem" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbtxzboos a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbtxzboos a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvatqmlgy === 'undefined') {
    varMorrisvatqmlgy = Morris.Line({
      element: 'Morrisvatqmlgy',
...
// LENGUETA
$('#Lenguetasbtxzboos a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxeiykfem;
  ...
  function initmapxeiykfem() {
    // Nuevo Mapa
    mapxeiykfem = new L.Map('LeafLetxeiykfem');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxeiykfem.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxeiykfem.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxeiykfem === 'undefined') {
    varinitmapxeiykfem = initmapxeiykfem();
  };
});
FINAL;
    } // constructor
