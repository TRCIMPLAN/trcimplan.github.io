...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvxpekcgh">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjjgbfhho" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetepmqfmjh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvxpekcgh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvxpekcgh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjjgbfhho === 'undefined') {
    varMorrisjjgbfhho = Morris.Line({
      element: 'Morrisjjgbfhho',
...
// LENGUETA
$('#Lenguetasvxpekcgh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapepmqfmjh;
  ...
  function initmapepmqfmjh() {
    // Nuevo Mapa
    mapepmqfmjh = new L.Map('LeafLetepmqfmjh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapepmqfmjh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapepmqfmjh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapepmqfmjh === 'undefined') {
    varinitmapepmqfmjh = initmapepmqfmjh();
  };
});
FINAL;
    } // constructor
