...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnucykrid">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwvwlqobf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnucykrid a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnucykrid a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwvwlqobf;
  ...
  function initmapwvwlqobf() {
    // Nuevo Mapa
    mapwvwlqobf = new L.Map('LeafLetwvwlqobf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwvwlqobf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwvwlqobf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwvwlqobf === 'undefined') {
    varinitmapwvwlqobf = initmapwvwlqobf();
  };
});
FINAL;
    } // constructor
