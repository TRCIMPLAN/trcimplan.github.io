...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgotcjhme">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislycvnwvn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgotcjhme a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgotcjhme a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislycvnwvn === 'undefined') {
    varMorrislycvnwvn = Morris.Line({
      element: 'Morrislycvnwvn',
