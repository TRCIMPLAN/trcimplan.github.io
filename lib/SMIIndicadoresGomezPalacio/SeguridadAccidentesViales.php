...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasefmdflyr">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdbqdarzl" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbaaqhyup" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasefmdflyr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasefmdflyr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdbqdarzl === 'undefined') {
    varMorrisdbqdarzl = Morris.Line({
      element: 'Morrisdbqdarzl',
...
// LENGUETA
$('#Lenguetasefmdflyr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbaaqhyup;
  ...
  function initmapbaaqhyup() {
    // Nuevo Mapa
    mapbaaqhyup = new L.Map('LeafLetbaaqhyup');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbaaqhyup.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbaaqhyup.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbaaqhyup === 'undefined') {
    varinitmapbaaqhyup = initmapbaaqhyup();
  };
});
FINAL;
    } // constructor
