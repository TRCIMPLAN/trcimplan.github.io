...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasctauwkux">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetexuxnnby" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasctauwkux a:first').tab('show')
});
// LENGUETA
$('#Lenguetasctauwkux a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapexuxnnby;
  ...
  function initmapexuxnnby() {
    // Nuevo Mapa
    mapexuxnnby = new L.Map('LeafLetexuxnnby');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapexuxnnby.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapexuxnnby.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapexuxnnby === 'undefined') {
    varinitmapexuxnnby = initmapexuxnnby();
  };
});
FINAL;
    } // constructor
