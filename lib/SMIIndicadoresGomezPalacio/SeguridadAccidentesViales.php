...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasryrxvuci">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbermsipy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasryrxvuci a:first').tab('show')
});
// LENGUETA
$('#Lenguetasryrxvuci a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbermsipy === 'undefined') {
    varMorrisbermsipy = Morris.Line({
      element: 'Morrisbermsipy',
