...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasezfacisr">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlusgyuao" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasezfacisr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasezfacisr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplusgyuao;
  ...
  function initmaplusgyuao() {
    // Nuevo Mapa
    maplusgyuao = new L.Map('LeafLetlusgyuao');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplusgyuao.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplusgyuao.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplusgyuao === 'undefined') {
    varinitmaplusgyuao = initmaplusgyuao();
  };
});
FINAL;
    } // constructor
