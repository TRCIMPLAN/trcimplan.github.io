...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnutruoqv">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiagubqbf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnutruoqv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnutruoqv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiagubqbf;
  ...
  function initmapiagubqbf() {
    // Nuevo Mapa
    mapiagubqbf = new L.Map('LeafLetiagubqbf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiagubqbf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiagubqbf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiagubqbf === 'undefined') {
    varinitmapiagubqbf = initmapiagubqbf();
  };
});
FINAL;
    } // constructor
