...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrrdmcclc">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkrldebxs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrrdmcclc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrrdmcclc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkrldebxs;
  ...
  function initmapkrldebxs() {
    // Nuevo Mapa
    mapkrldebxs = new L.Map('LeafLetkrldebxs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkrldebxs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkrldebxs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkrldebxs === 'undefined') {
    varinitmapkrldebxs = initmapkrldebxs();
  };
});
FINAL;
    } // constructor
