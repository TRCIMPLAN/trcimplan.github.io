...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswnxfhior">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzvikadyf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswnxfhior a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswnxfhior a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzvikadyf;
  ...
  function initmapzvikadyf() {
    // Nuevo Mapa
    mapzvikadyf = new L.Map('LeafLetzvikadyf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzvikadyf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzvikadyf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzvikadyf === 'undefined') {
    varinitmapzvikadyf = initmapzvikadyf();
  };
});
FINAL;
    } // constructor
