...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyumtzfcc">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqosstzmm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyumtzfcc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyumtzfcc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqosstzmm;
  ...
  function initmapqosstzmm() {
    // Nuevo Mapa
    mapqosstzmm = new L.Map('LeafLetqosstzmm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqosstzmm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqosstzmm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqosstzmm === 'undefined') {
    varinitmapqosstzmm = initmapqosstzmm();
  };
});
FINAL;
    } // constructor
