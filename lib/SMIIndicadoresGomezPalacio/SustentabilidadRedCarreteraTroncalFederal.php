...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasefpseyoi">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpnvmckij" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasefpseyoi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasefpseyoi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappnvmckij;
  ...
  function initmappnvmckij() {
    // Nuevo Mapa
    mappnvmckij = new L.Map('LeafLetpnvmckij');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappnvmckij.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappnvmckij.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappnvmckij === 'undefined') {
    varinitmappnvmckij = initmappnvmckij();
  };
});
FINAL;
    } // constructor
