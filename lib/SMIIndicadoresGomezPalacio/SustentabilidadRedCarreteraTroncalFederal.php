...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasndtdcllt">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlvrcdvru" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasndtdcllt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasndtdcllt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplvrcdvru;
  ...
  function initmaplvrcdvru() {
    // Nuevo Mapa
    maplvrcdvru = new L.Map('LeafLetlvrcdvru');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplvrcdvru.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplvrcdvru.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplvrcdvru === 'undefined') {
    varinitmaplvrcdvru = initmaplvrcdvru();
  };
});
FINAL;
    } // constructor
