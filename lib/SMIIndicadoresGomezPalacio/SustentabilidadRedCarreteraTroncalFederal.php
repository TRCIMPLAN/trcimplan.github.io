...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasghmzhajt">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetickjhbah" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasghmzhajt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasghmzhajt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapickjhbah;
  ...
  function initmapickjhbah() {
    // Nuevo Mapa
    mapickjhbah = new L.Map('LeafLetickjhbah');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapickjhbah.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapickjhbah.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapickjhbah === 'undefined') {
    varinitmapickjhbah = initmapickjhbah();
  };
});
FINAL;
    } // constructor
