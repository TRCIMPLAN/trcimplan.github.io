...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasemsojvlk">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetacgqzxvu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasemsojvlk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasemsojvlk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapacgqzxvu;
  ...
  function initmapacgqzxvu() {
    // Nuevo Mapa
    mapacgqzxvu = new L.Map('LeafLetacgqzxvu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapacgqzxvu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapacgqzxvu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapacgqzxvu === 'undefined') {
    varinitmapacgqzxvu = initmapacgqzxvu();
  };
});
FINAL;
    } // constructor
