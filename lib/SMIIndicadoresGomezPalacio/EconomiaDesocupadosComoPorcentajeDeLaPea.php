...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxzrgdsuj">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskurblmkd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxzrgdsuj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxzrgdsuj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskurblmkd === 'undefined') {
    varMorriskurblmkd = Morris.Line({
      element: 'Morriskurblmkd',
