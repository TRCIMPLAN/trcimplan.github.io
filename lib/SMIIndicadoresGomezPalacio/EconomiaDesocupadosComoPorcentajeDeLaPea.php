...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiqmgcnrf">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisaqaarzzm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiqmgcnrf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiqmgcnrf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaqaarzzm === 'undefined') {
    varMorrisaqaarzzm = Morris.Line({
      element: 'Morrisaqaarzzm',
