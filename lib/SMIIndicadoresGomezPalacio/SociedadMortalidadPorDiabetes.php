...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaschypgvwm">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcsovlckl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaschypgvwm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaschypgvwm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcsovlckl;
  ...
  function initmapcsovlckl() {
    // Nuevo Mapa
    mapcsovlckl = new L.Map('LeafLetcsovlckl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcsovlckl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcsovlckl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcsovlckl === 'undefined') {
    varinitmapcsovlckl = initmapcsovlckl();
  };
});
FINAL;
    } // constructor
