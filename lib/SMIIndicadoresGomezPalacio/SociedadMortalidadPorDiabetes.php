...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassfvkxxqd">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetojbqfbbc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassfvkxxqd a:first').tab('show')
});
// LENGUETA
$('#Lenguetassfvkxxqd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapojbqfbbc;
  ...
  function initmapojbqfbbc() {
    // Nuevo Mapa
    mapojbqfbbc = new L.Map('LeafLetojbqfbbc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapojbqfbbc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapojbqfbbc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapojbqfbbc === 'undefined') {
    varinitmapojbqfbbc = initmapojbqfbbc();
  };
});
FINAL;
    } // constructor
