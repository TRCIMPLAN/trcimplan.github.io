...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassvbisqko">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdajnspew" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassvbisqko a:first').tab('show')
});
// LENGUETA
$('#Lenguetassvbisqko a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdajnspew;
  ...
  function initmapdajnspew() {
    // Nuevo Mapa
    mapdajnspew = new L.Map('LeafLetdajnspew');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdajnspew.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdajnspew.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdajnspew === 'undefined') {
    varinitmapdajnspew = initmapdajnspew();
  };
});
FINAL;
    } // constructor
