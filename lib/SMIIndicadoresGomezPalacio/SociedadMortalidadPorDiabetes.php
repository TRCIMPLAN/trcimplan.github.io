...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasosbxhhew">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetublulqah" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasosbxhhew a:first').tab('show')
});
// LENGUETA
$('#Lenguetasosbxhhew a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapublulqah;
  ...
  function initmapublulqah() {
    // Nuevo Mapa
    mapublulqah = new L.Map('LeafLetublulqah');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapublulqah.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapublulqah.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapublulqah === 'undefined') {
    varinitmapublulqah = initmapublulqah();
  };
});
FINAL;
    } // constructor
