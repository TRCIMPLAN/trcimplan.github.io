...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashhufjwat">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjqvhcdwy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashhufjwat a:first').tab('show')
});
// LENGUETA
$('#Lenguetashhufjwat a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjqvhcdwy;
  ...
  function initmapjqvhcdwy() {
    // Nuevo Mapa
    mapjqvhcdwy = new L.Map('LeafLetjqvhcdwy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjqvhcdwy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjqvhcdwy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjqvhcdwy === 'undefined') {
    varinitmapjqvhcdwy = initmapjqvhcdwy();
  };
});
FINAL;
    } // constructor
