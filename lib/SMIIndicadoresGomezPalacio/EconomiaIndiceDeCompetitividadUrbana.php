...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxprjhoet">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsriomqqf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxprjhoet a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxprjhoet a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsriomqqf;
  ...
  function initmapsriomqqf() {
    // Nuevo Mapa
    mapsriomqqf = new L.Map('LeafLetsriomqqf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsriomqqf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsriomqqf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsriomqqf === 'undefined') {
    varinitmapsriomqqf = initmapsriomqqf();
  };
});
FINAL;
    } // constructor
