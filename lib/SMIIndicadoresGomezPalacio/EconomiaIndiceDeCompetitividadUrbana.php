...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmbpvxhfi">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpkrqcpvz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmbpvxhfi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmbpvxhfi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappkrqcpvz;
  ...
  function initmappkrqcpvz() {
    // Nuevo Mapa
    mappkrqcpvz = new L.Map('LeafLetpkrqcpvz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappkrqcpvz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappkrqcpvz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappkrqcpvz === 'undefined') {
    varinitmappkrqcpvz = initmappkrqcpvz();
  };
});
FINAL;
    } // constructor
