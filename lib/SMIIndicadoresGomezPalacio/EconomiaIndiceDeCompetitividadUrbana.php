...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasekkducdy">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetficroyou" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasekkducdy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasekkducdy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapficroyou;
  ...
  function initmapficroyou() {
    // Nuevo Mapa
    mapficroyou = new L.Map('LeafLetficroyou');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapficroyou.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapficroyou.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapficroyou === 'undefined') {
    varinitmapficroyou = initmapficroyou();
  };
});
FINAL;
    } // constructor
