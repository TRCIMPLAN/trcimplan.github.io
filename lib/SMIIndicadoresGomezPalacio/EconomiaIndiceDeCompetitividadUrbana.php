...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjhphlxak">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxoaudgou" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjhphlxak a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjhphlxak a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxoaudgou;
  ...
  function initmapxoaudgou() {
    // Nuevo Mapa
    mapxoaudgou = new L.Map('LeafLetxoaudgou');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxoaudgou.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxoaudgou.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxoaudgou === 'undefined') {
    varinitmapxoaudgou = initmapxoaudgou();
  };
});
FINAL;
    } // constructor
