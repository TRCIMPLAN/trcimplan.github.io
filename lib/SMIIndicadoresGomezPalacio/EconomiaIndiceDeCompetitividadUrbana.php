...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjwpfrmoo">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkfhpwdra" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjwpfrmoo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjwpfrmoo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkfhpwdra;
  ...
  function initmapkfhpwdra() {
    // Nuevo Mapa
    mapkfhpwdra = new L.Map('LeafLetkfhpwdra');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkfhpwdra.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkfhpwdra.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkfhpwdra === 'undefined') {
    varinitmapkfhpwdra = initmapkfhpwdra();
  };
});
FINAL;
    } // constructor
