...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasthxxitai">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaydpjela" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasthxxitai a:first').tab('show')
});
// LENGUETA
$('#Lenguetasthxxitai a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaydpjela;
  ...
  function initmapaydpjela() {
    // Nuevo Mapa
    mapaydpjela = new L.Map('LeafLetaydpjela');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaydpjela.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaydpjela.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaydpjela === 'undefined') {
    varinitmapaydpjela = initmapaydpjela();
  };
});
FINAL;
    } // constructor
