...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswagosstj">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrihepdru" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswagosstj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswagosstj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprihepdru;
  ...
  function initmaprihepdru() {
    // Nuevo Mapa
    maprihepdru = new L.Map('LeafLetrihepdru');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprihepdru.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprihepdru.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprihepdru === 'undefined') {
    varinitmaprihepdru = initmaprihepdru();
  };
});
FINAL;
    } // constructor
