...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfuzonone">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbxbrrjlf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfuzonone a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfuzonone a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbxbrrjlf;
  ...
  function initmapbxbrrjlf() {
    // Nuevo Mapa
    mapbxbrrjlf = new L.Map('LeafLetbxbrrjlf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbxbrrjlf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbxbrrjlf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbxbrrjlf === 'undefined') {
    varinitmapbxbrrjlf = initmapbxbrrjlf();
  };
});
FINAL;
    } // constructor
