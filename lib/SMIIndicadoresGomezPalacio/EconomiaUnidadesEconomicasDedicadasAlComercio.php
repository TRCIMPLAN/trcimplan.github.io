...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasihcrpjhu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristujdxvub" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasihcrpjhu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasihcrpjhu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristujdxvub === 'undefined') {
    varMorristujdxvub = Morris.Line({
      element: 'Morristujdxvub',
