...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbmvrhxkf">
...
<div id="Morrisbrwaljvf" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetejewglhp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbmvrhxkf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbmvrhxkf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbrwaljvf === 'undefined') {
    varMorrisbrwaljvf = Morris.Line({
      element: 'Morrisbrwaljvf',
...
// LENGUETA
$('#Lenguetasbmvrhxkf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapejewglhp;
  ...
  function initmapejewglhp() {
    // Nuevo Mapa
    mapejewglhp = new L.Map('LeafLetejewglhp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapejewglhp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapejewglhp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapejewglhp === 'undefined') {
    varinitmapejewglhp = initmapejewglhp();
  };
});
FINAL;
    } // constructor
