...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdzfaoelz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrhminjsw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdzfaoelz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdzfaoelz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrhminjsw === 'undefined') {
    varMorrisrhminjsw = Morris.Line({
      element: 'Morrisrhminjsw',
