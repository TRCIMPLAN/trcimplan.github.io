...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskempztqj">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgwratkdd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskempztqj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskempztqj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgwratkdd;
  ...
  function initmapgwratkdd() {
    // Nuevo Mapa
    mapgwratkdd = new L.Map('LeafLetgwratkdd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgwratkdd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgwratkdd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgwratkdd === 'undefined') {
    varinitmapgwratkdd = initmapgwratkdd();
  };
});
FINAL;
    } // constructor
