...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmfnfocdm">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfuddhlch" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmfnfocdm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmfnfocdm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfuddhlch === 'undefined') {
    varMorrisfuddhlch = Morris.Line({
      element: 'Morrisfuddhlch',
