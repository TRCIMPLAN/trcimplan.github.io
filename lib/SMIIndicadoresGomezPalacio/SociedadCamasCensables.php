...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdwligsvl">
...
<div id="Morrisoblitqjk" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvzrnlzsb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdwligsvl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdwligsvl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoblitqjk === 'undefined') {
    varMorrisoblitqjk = Morris.Line({
      element: 'Morrisoblitqjk',
...
// LENGUETA
$('#Lenguetasdwligsvl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvzrnlzsb;
  ...
  function initmapvzrnlzsb() {
    // Nuevo Mapa
    mapvzrnlzsb = new L.Map('LeafLetvzrnlzsb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvzrnlzsb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvzrnlzsb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvzrnlzsb === 'undefined') {
    varinitmapvzrnlzsb = initmapvzrnlzsb();
  };
});
FINAL;
    } // constructor
