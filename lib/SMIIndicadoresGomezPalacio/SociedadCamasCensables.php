...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfyuynoxp">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisndduwedn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfyuynoxp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfyuynoxp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisndduwedn === 'undefined') {
    varMorrisndduwedn = Morris.Line({
      element: 'Morrisndduwedn',
