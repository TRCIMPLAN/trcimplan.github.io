...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseeeapjed">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxijvewhc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzycfzbll" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseeeapjed a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseeeapjed a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxijvewhc === 'undefined') {
    varMorrisxijvewhc = Morris.Line({
      element: 'Morrisxijvewhc',
...
// LENGUETA
$('#Lenguetaseeeapjed a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzycfzbll;
  ...
  function initmapzycfzbll() {
    // Nuevo Mapa
    mapzycfzbll = new L.Map('LeafLetzycfzbll');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzycfzbll.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzycfzbll.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzycfzbll === 'undefined') {
    varinitmapzycfzbll = initmapzycfzbll();
  };
});
FINAL;
    } // constructor
