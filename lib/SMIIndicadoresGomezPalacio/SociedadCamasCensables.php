...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasszbjrchx">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnfkdwosr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasszbjrchx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasszbjrchx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnfkdwosr === 'undefined') {
    varMorrisnfkdwosr = Morris.Line({
      element: 'Morrisnfkdwosr',
