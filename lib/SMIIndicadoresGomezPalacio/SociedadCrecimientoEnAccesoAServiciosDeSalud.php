...
<p>Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Acceso a Servicios de Salud en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: -4.6000 },{ fecha: '2009-12-31', dato: -4.5500 },{ fecha: '2010-12-31', dato: -4.5500 },{ fecha: '2011-12-31', dato: -4.5500 },{ fecha: '2012-12-31', dato: -4.5500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
