...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfxbfoeac">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjugmauzn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfxbfoeac a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfxbfoeac a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjugmauzn;
  ...
  function initmapjugmauzn() {
    // Nuevo Mapa
    mapjugmauzn = new L.Map('LeafLetjugmauzn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjugmauzn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjugmauzn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjugmauzn === 'undefined') {
    varinitmapjugmauzn = initmapjugmauzn();
  };
});
FINAL;
    } // constructor
