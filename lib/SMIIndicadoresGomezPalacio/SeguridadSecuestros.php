...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmwdfbxgi">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteyzwvvcl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmwdfbxgi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmwdfbxgi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeyzwvvcl;
  ...
  function initmapeyzwvvcl() {
    // Nuevo Mapa
    mapeyzwvvcl = new L.Map('LeafLeteyzwvvcl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeyzwvvcl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeyzwvvcl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeyzwvvcl === 'undefined') {
    varinitmapeyzwvvcl = initmapeyzwvvcl();
  };
});
FINAL;
    } // constructor
