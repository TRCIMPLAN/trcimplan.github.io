...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasowtjupid">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoeaazweg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasowtjupid a:first').tab('show')
});
// LENGUETA
$('#Lenguetasowtjupid a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoeaazweg;
  ...
  function initmapoeaazweg() {
    // Nuevo Mapa
    mapoeaazweg = new L.Map('LeafLetoeaazweg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoeaazweg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoeaazweg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoeaazweg === 'undefined') {
    varinitmapoeaazweg = initmapoeaazweg();
  };
});
FINAL;
    } // constructor
