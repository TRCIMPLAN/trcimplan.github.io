...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxhgmjftf">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszzhtmddi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxhgmjftf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxhgmjftf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszzhtmddi === 'undefined') {
    varMorriszzhtmddi = Morris.Line({
      element: 'Morriszzhtmddi',
      data: [{ fecha: '2014-01-31', dato: 26 },{ fecha: '2014-02-28', dato: 24 },{ fecha: '2014-03-31', dato: 28 },{ fecha: '2014-04-30', dato: 22 },{ fecha: '2014-05-31', dato: 25 },{ fecha: '2014-06-30', dato: 18 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
