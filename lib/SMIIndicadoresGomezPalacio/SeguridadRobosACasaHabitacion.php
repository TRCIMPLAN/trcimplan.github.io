...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslmycbvag">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvprdjwgy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslmycbvag a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslmycbvag a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvprdjwgy === 'undefined') {
    varMorrisvprdjwgy = Morris.Line({
      element: 'Morrisvprdjwgy',
