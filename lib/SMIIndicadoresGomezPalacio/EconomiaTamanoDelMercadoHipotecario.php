...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuiuevjio">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszdpfwbls" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrjotwffe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuiuevjio a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuiuevjio a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszdpfwbls === 'undefined') {
    varMorriszdpfwbls = Morris.Line({
      element: 'Morriszdpfwbls',
...
// LENGUETA
$('#Lenguetasuiuevjio a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprjotwffe;
  ...
  function initmaprjotwffe() {
    // Nuevo Mapa
    maprjotwffe = new L.Map('LeafLetrjotwffe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprjotwffe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprjotwffe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprjotwffe === 'undefined') {
    varinitmaprjotwffe = initmaprjotwffe();
  };
});
FINAL;
    } // constructor
