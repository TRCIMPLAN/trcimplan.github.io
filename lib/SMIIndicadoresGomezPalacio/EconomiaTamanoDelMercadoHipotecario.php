...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbufbcjrt">
...
<div id="Morrismlzkoply" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfbzewgqo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbufbcjrt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbufbcjrt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismlzkoply === 'undefined') {
    varMorrismlzkoply = Morris.Line({
      element: 'Morrismlzkoply',
...
// LENGUETA
$('#Lenguetasbufbcjrt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfbzewgqo;
  ...
  function initmapfbzewgqo() {
    // Nuevo Mapa
    mapfbzewgqo = new L.Map('LeafLetfbzewgqo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfbzewgqo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfbzewgqo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfbzewgqo === 'undefined') {
    varinitmapfbzewgqo = initmapfbzewgqo();
  };
});
FINAL;
    } // constructor
