...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswepudjrz">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishxdwkaqv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswepudjrz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswepudjrz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishxdwkaqv === 'undefined') {
    varMorrishxdwkaqv = Morris.Line({
      element: 'Morrishxdwkaqv',
