<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SeguridadTasaMensualEstatalDeRoboDeVehiculoSinViolencia
 *
...
class SeguridadTasaMensualEstatalDeRoboDeVehiculoSinViolencia extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Tasa mensual estatal de Robo de Vehículo Sin Violencia en Gómez Palacio';
