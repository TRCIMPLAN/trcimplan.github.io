...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasllhgfpiv">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetexrdhzlb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasllhgfpiv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasllhgfpiv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapexrdhzlb;
  ...
  function initmapexrdhzlb() {
    // Nuevo Mapa
    mapexrdhzlb = new L.Map('LeafLetexrdhzlb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapexrdhzlb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapexrdhzlb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapexrdhzlb === 'undefined') {
    varinitmapexrdhzlb = initmapexrdhzlb();
  };
});
FINAL;
    } // constructor
