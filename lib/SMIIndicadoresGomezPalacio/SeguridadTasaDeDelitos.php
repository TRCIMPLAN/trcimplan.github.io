...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdcnyobyn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvycxpvjj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdcnyobyn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdcnyobyn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvycxpvjj;
  ...
  function initmapvycxpvjj() {
    // Nuevo Mapa
    mapvycxpvjj = new L.Map('LeafLetvycxpvjj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvycxpvjj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvycxpvjj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvycxpvjj === 'undefined') {
    varinitmapvycxpvjj = initmapvycxpvjj();
  };
});
FINAL;
    } // constructor
