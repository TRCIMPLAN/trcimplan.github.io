...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgqamghsr">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetelleckno" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgqamghsr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgqamghsr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapelleckno;
  ...
  function initmapelleckno() {
    // Nuevo Mapa
    mapelleckno = new L.Map('LeafLetelleckno');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapelleckno.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapelleckno.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapelleckno === 'undefined') {
    varinitmapelleckno = initmapelleckno();
  };
});
FINAL;
    } // constructor
