...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasflhlecgy">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyaebajsk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasflhlecgy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasflhlecgy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyaebajsk;
  ...
  function initmapyaebajsk() {
    // Nuevo Mapa
    mapyaebajsk = new L.Map('LeafLetyaebajsk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyaebajsk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyaebajsk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyaebajsk === 'undefined') {
    varinitmapyaebajsk = initmapyaebajsk();
  };
});
FINAL;
    } // constructor
