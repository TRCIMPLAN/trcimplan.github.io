...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszpwrbexe">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetugbwekrr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszpwrbexe a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszpwrbexe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapugbwekrr;
  ...
  function initmapugbwekrr() {
    // Nuevo Mapa
    mapugbwekrr = new L.Map('LeafLetugbwekrr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapugbwekrr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapugbwekrr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapugbwekrr === 'undefined') {
    varinitmapugbwekrr = initmapugbwekrr();
  };
});
FINAL;
    } // constructor
