...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnsendsdu">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetewzdwsit" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnsendsdu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnsendsdu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapewzdwsit;
  ...
  function initmapewzdwsit() {
    // Nuevo Mapa
    mapewzdwsit = new L.Map('LeafLetewzdwsit');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapewzdwsit.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapewzdwsit.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapewzdwsit === 'undefined') {
    varinitmapewzdwsit = initmapewzdwsit();
  };
});
FINAL;
    } // constructor
