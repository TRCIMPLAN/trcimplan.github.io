<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Empleados en el Sector Formal (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaEmpleadosEnElSectorFormal extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empleados en el Sector Formal en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 75.8459 },{ fecha: '2009-12-31', dato: 69.4612 },{ fecha: '2010-12-31', dato: 57.1342 },{ fecha: '2011-12-31', dato: 62.3430 },{ fecha: '2012-12-31', dato: 56.3498 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice de "Gobiernos Eficaces y Eficientes". Mide el número de empleados en el sector formal como porcentaje de la población ocupada total. El INEGI define como sector formal a todas aquellas actividades económicas que se desarrollan en empresas constituidas en sociedad, corporaciones, instituciones públicas o privadas, y negocios no constituidos en sociedad pero que reportan ingresos ante la autoridad hacendaria.</p>
