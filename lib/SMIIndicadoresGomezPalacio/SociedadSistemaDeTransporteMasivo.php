<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Sistema de Transporte Másivo (Creado por Central:SmiLanzadera)
 *
...
/**
 * Clase SociedadSistemaDeTransporteMasivo
 */
class SociedadSistemaDeTransporteMasivo extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Sistema de Transporte Másivo en Gómez Palacio';
     // $this->autor             = '';
        $this->fecha             = '2015-07-14T16:01';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'sociedad-sistema-de-transporte-masivo';
        $this->imagen            = '../smi/introduccion/imagen.jpg';
        $this->imagen_previa     = '../smi/introduccion/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales. Las categorías son de uso interno
        $this->descripcion       = 'Incluido en el subíndice "Precursores".
Qué mide: Si una ciudad cuenta con un sistema de transporte masivo en operación, en
construcción, en estatus de proyecto o ninguna de las tres.

Unidades: Variable categórica que toma el valor de tres si se trata de una ciudad con un
sistema de trasporte masivo en operación, dos si el sistema se encuentra en construcción o
bien si se trata de una ciudad de menos de 250 mil habitantes, uno si se tiene aprobado el
proyecto ejecutivo del sistema por parte de Banobras, o cero en otro caso.
Fuente: Centro de Transporte Sustentable (CTS)/ Banco Nacional de Obras y Servicios Públicos (Banobras)/ El Poder del Consumidor A.C. (EPC), 2008-2012.';
...
Qué mide: Si una ciudad cuenta con un sistema de transporte masivo en operación, en
construcción, en estatus de proyecto o ninguna de las tres.</p>

<p>Unidades: Variable categórica que toma el valor de tres si se trata de una ciudad con un
sistema de trasporte masivo en operación, dos si el sistema se encuentra en construcción o
bien si se trata de una ciudad de menos de 250 mil habitantes, uno si se tiene aprobado el
proyecto ejecutivo del sistema por parte de Banobras, o cero en otro caso.
Fuente: Centro de Transporte Sustentable (CTS)/ Banco Nacional de Obras y Servicios Públicos (Banobras)/ El Poder del Consumidor A.C. (EPC), 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Sistema de Transporte Másivo en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Sistema de Transporte Másivo</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Sistema de Transporte Másivo</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
