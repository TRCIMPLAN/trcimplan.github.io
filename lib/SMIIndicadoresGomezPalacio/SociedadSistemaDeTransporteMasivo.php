<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Sistema de Transporte Masivo (Creado por Central:SmiLanzadera)
 *
...
class SociedadSistemaDeTransporteMasivo extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Precursores". Qué mide: Si una ciudad cuenta con un sistema de transporte masivo en operación, en construcción, en estatus de proyecto o ninguna de las tres.</p>
