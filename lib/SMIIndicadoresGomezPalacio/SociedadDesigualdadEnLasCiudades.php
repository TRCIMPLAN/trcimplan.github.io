<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Desigualdad en las Ciudades (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadDesigualdadEnLasCiudades extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        $this->fecha             = '2015-07-14T15:43';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'sociedad-desigualdad-en-las-ciudades';
        $this->imagen            = '../smi/introduccion/imagen.jpg';
        $this->imagen_previa     = '../smi/introduccion/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales. Las categorías son de uso interno
        $this->descripcion       = 'Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Este indicador es un coeficiente de Gini salarial para cuantificar la desigualdad en
los salarios de una población. El coeficiente adopta valores entre 0 y 1, donde 0 representa
una distribución completamente igual (todos tienen los mismos ingresos) y 1 una distribución
completamente desigual (1 persona tiene todos los ingresos y los demás ninguno).
Fuente: Estimaciones de IMCO con datos de INEGI (ENOE).';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Este indicador es un coeficiente de Gini salarial para cuantificar la desigualdad en
los salarios de una población. El coeficiente adopta valores entre 0 y 1, donde 0 representa
una distribución completamente igual (todos tienen los mismos ingresos) y 1 una distribución
completamente desigual (1 persona tiene todos los ingresos y los demás ninguno).
Fuente: Estimaciones de IMCO con datos de INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Desigualdad en las Ciudades en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Desigualdad en las Ciudades</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Desigualdad en las Ciudades</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.3527 },{ fecha: '2009-12-31', dato: 0.3357 },{ fecha: '2010-12-31', dato: 0.3225 },{ fecha: '2011-12-31', dato: 0.3353 },{ fecha: '2012-12-31', dato: 0.3498 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0.3498 },{ region: 'Gómez Palacio', dato: 0.3498 },{ region: 'Lerdo', dato: 0.3498 },{ region: 'Matamoros', dato: 0.3498 },{ region: 'La Laguna', dato: 0.3498 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
