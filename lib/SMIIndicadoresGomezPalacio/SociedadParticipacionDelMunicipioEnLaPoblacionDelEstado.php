<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadParticipacionDelMunicipioEnLaPoblacionDelEstado
 *
...
class SociedadParticipacionDelMunicipioEnLaPoblacionDelEstado extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Participación del municipio en la población del estado en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '20.0000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
