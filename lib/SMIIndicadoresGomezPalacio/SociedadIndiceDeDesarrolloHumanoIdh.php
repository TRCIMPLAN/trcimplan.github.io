...
class SociedadIndiceDeDesarrolloHumanoIdh extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbyciqeti">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzwqyqhpv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbyciqeti a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbyciqeti a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzwqyqhpv;
  ...
  function initmapzwqyqhpv() {
    // Nuevo Mapa
    mapzwqyqhpv = new L.Map('LeafLetzwqyqhpv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzwqyqhpv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzwqyqhpv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzwqyqhpv === 'undefined') {
    varinitmapzwqyqhpv = initmapzwqyqhpv();
  };
});
FINAL;
    } // constructor
