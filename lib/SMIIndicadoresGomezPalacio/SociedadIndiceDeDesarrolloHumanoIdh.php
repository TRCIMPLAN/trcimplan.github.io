...
class SociedadIndiceDeDesarrolloHumanoIdh extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszuhzsqgz">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsxsrnhgs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszuhzsqgz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszuhzsqgz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsxsrnhgs;
  ...
  function initmapsxsrnhgs() {
    // Nuevo Mapa
    mapsxsrnhgs = new L.Map('LeafLetsxsrnhgs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsxsrnhgs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsxsrnhgs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsxsrnhgs === 'undefined') {
    varinitmapsxsrnhgs = initmapsxsrnhgs();
  };
});
FINAL;
    } // constructor
