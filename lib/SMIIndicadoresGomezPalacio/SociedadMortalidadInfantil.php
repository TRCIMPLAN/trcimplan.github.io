...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrggfmyxh">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfhwcstno" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrggfmyxh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrggfmyxh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfhwcstno;
  ...
  function initmapfhwcstno() {
    // Nuevo Mapa
    mapfhwcstno = new L.Map('LeafLetfhwcstno');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfhwcstno.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfhwcstno.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfhwcstno === 'undefined') {
    varinitmapfhwcstno = initmapfhwcstno();
  };
});
FINAL;
    } // constructor
