<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Mortalidad Infantil (Creado por Central:SmiLanzadera)
 *
...
<p>Los datos pueden modificarse debido al manejo de los registros administrativos por parte de la Secretaria de Salud.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Mortalidad Infantil en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2009-12-31', dato: 5.9000 },{ fecha: '2010-12-31', dato: 8.0000 },{ fecha: '2011-12-31', dato: 12.6000 },{ fecha: '2012-12-31', dato: 9.5000 },{ fecha: '2013-12-31', dato: 9.1000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Tasa de mortalidad infantil. Defunciones de menores de un año por cada mil nacidos vivos. Se incluye en el subíndice "Sociedad Preparada, Incluyente y Sana" de IMCO.</p>
