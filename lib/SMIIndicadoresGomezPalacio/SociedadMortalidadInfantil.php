...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszqddpwpc">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwmpujsfq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszqddpwpc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszqddpwpc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwmpujsfq;
  ...
  function initmapwmpujsfq() {
    // Nuevo Mapa
    mapwmpujsfq = new L.Map('LeafLetwmpujsfq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwmpujsfq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwmpujsfq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwmpujsfq === 'undefined') {
    varinitmapwmpujsfq = initmapwmpujsfq();
  };
});
FINAL;
    } // constructor
