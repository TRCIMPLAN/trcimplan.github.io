<?php
/**
 * EconomiaIndiceEspecializacionLocalEnIndustriaManufacturera.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaIndiceEspecializacionLocalEnIndustriaManufacturera
 */
class EconomiaIndiceEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaindice-especializacion-local-en-industria-manufacturera';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Producción bruta total de la industria manufacturera entre la producción bruta total.</p>
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Índice de Especialización Local en Industria Manufacturera</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 76.0600 },{ region: 'Gómez Palacio', dato: 60.2300 },{ region: 'Lerdo', dato: 53.9400 },{ region: 'Matamoros', dato: 58.7200 },{ region: 'La Laguna', dato: 71.1000 },{ region: 'Nacional', dato: 44.3400 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
