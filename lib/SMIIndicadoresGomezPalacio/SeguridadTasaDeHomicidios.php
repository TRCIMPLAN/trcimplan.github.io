...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxtrdlbbu">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxxnuwipw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxtrdlbbu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxtrdlbbu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxxnuwipw;
  ...
  function initmapxxnuwipw() {
    // Nuevo Mapa
    mapxxnuwipw = new L.Map('LeafLetxxnuwipw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxxnuwipw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxxnuwipw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxxnuwipw === 'undefined') {
    varinitmapxxnuwipw = initmapxxnuwipw();
  };
});
FINAL;
    } // constructor
