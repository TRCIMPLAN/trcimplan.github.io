...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasehaplukr">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmqixspnw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasehaplukr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasehaplukr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmqixspnw;
  ...
  function initmapmqixspnw() {
    // Nuevo Mapa
    mapmqixspnw = new L.Map('LeafLetmqixspnw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmqixspnw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmqixspnw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmqixspnw === 'undefined') {
    varinitmapmqixspnw = initmapmqixspnw();
  };
});
FINAL;
    } // constructor
