...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasubcjazce">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmalbppbu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasubcjazce a:first').tab('show')
});
// LENGUETA
$('#Lenguetasubcjazce a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmalbppbu;
  ...
  function initmapmalbppbu() {
    // Nuevo Mapa
    mapmalbppbu = new L.Map('LeafLetmalbppbu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmalbppbu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmalbppbu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmalbppbu === 'undefined') {
    varinitmapmalbppbu = initmapmalbppbu();
  };
});
FINAL;
    } // constructor
