...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrvmfsmnp">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsjojolsv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrvmfsmnp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrvmfsmnp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsjojolsv;
  ...
  function initmapsjojolsv() {
    // Nuevo Mapa
    mapsjojolsv = new L.Map('LeafLetsjojolsv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsjojolsv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsjojolsv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsjojolsv === 'undefined') {
    varinitmapsjojolsv = initmapsjojolsv();
  };
});
FINAL;
    } // constructor
