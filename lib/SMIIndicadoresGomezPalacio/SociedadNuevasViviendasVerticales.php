<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadNuevasViviendasVerticales
 *
...
class SociedadNuevasViviendasVerticales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nuevas viviendas verticales en Gómez Palacio';
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2018-12-31', 'valor' => '2.9400', 'fuente_nombre' => 'IMCO', 'notas' => 'Porcentaje de las viviendas vigentes (CONAVI (SNIIV))'));
    } // otras_regiones
