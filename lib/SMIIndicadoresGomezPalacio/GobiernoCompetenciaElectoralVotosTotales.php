...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoqulwvdy">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqvgtxzhe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoqulwvdy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoqulwvdy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqvgtxzhe;
  ...
  function initmapqvgtxzhe() {
    // Nuevo Mapa
    mapqvgtxzhe = new L.Map('LeafLetqvgtxzhe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqvgtxzhe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqvgtxzhe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqvgtxzhe === 'undefined') {
    varinitmapqvgtxzhe = initmapqvgtxzhe();
  };
});
FINAL;
    } // constructor
