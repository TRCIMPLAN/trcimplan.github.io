<?php
/**
 * EconomiaPersonalOcupadoEnServicios.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaPersonalOcupadoEnServicios
 */
class EconomiaPersonalOcupadoEnServicios extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiapersonal-ocupado-en-servicios';
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Personal Ocupado en los Servicios en Gómez Palacio</h3>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Personal Ocupado en los Servicios</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
