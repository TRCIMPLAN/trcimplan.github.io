<?php
/**
 * SociedadRazonEntreMujeresHombresEnEnsenanzaMediaSuperior.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadRazonEntreMujeresHombresEnEnsenanzaMediaSuperior
 */
class SociedadRazonEntreMujeresHombresEnEnsenanzaMediaSuperior extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sociedadrazon-entre-mujeres-hombres-en-ensenanza-media-superior';
        ...
        $this->claves       = 'Gómez Palacio, Educación, Género, Objetivos del Milenio';
