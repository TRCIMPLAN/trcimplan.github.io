...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiviylhpc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettzgncljw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiviylhpc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiviylhpc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptzgncljw;
  ...
  function initmaptzgncljw() {
    // Nuevo Mapa
    maptzgncljw = new L.Map('LeafLettzgncljw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptzgncljw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptzgncljw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptzgncljw === 'undefined') {
    varinitmaptzgncljw = initmaptzgncljw();
  };
});
FINAL;
    } // constructor
