...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassodgmtqk">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrrmyjadb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassodgmtqk a:first').tab('show')
});
// LENGUETA
$('#Lenguetassodgmtqk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprrmyjadb;
  ...
  function initmaprrmyjadb() {
    // Nuevo Mapa
    maprrmyjadb = new L.Map('LeafLetrrmyjadb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprrmyjadb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprrmyjadb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprrmyjadb === 'undefined') {
    varinitmaprrmyjadb = initmaprrmyjadb();
  };
});
FINAL;
    } // constructor
