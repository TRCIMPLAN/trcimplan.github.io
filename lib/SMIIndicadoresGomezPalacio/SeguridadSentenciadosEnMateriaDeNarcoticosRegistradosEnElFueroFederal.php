...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashkauvahm">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfaegndrs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashkauvahm a:first').tab('show')
});
// LENGUETA
$('#Lenguetashkauvahm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfaegndrs;
  ...
  function initmapfaegndrs() {
    // Nuevo Mapa
    mapfaegndrs = new L.Map('LeafLetfaegndrs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfaegndrs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfaegndrs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfaegndrs === 'undefined') {
    varinitmapfaegndrs = initmapfaegndrs();
  };
});
FINAL;
    } // constructor
