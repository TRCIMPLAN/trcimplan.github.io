<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SeguridadDelitosDelFueroComun
 *
...
class SeguridadDelitosDelFueroComun extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Delitos del Fuero Común en Gómez Palacio';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2017-12-31', 'valor' => '470', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 96, crudo 48
    } // datos
