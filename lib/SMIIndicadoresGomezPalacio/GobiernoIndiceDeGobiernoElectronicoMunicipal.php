...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasniluzazu">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlsdzaybv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasniluzazu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasniluzazu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplsdzaybv;
  ...
  function initmaplsdzaybv() {
    // Nuevo Mapa
    maplsdzaybv = new L.Map('LeafLetlsdzaybv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplsdzaybv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplsdzaybv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplsdzaybv === 'undefined') {
    varinitmaplsdzaybv = initmaplsdzaybv();
  };
});
FINAL;
    } // constructor
