...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyouqvvva">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvlbaqlbv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyouqvvva a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyouqvvva a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvlbaqlbv;
  ...
  function initmapvlbaqlbv() {
    // Nuevo Mapa
    mapvlbaqlbv = new L.Map('LeafLetvlbaqlbv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvlbaqlbv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvlbaqlbv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvlbaqlbv === 'undefined') {
    varinitmapvlbaqlbv = initmapvlbaqlbv();
  };
});
FINAL;
    } // constructor
