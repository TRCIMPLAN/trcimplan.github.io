<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Seguridad Competencia de Servicios Notariales (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Secretaría de Gobernación (Directorio de Notarios), 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia de Servicios Notariales en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 7.8798 },{ fecha: '2009-12-31', dato: 8.1431 },{ fecha: '2010-12-31', dato: 8.0300 },{ fecha: '2011-12-31', dato: 7.4322 },{ fecha: '2012-12-31', dato: 8.8655 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
