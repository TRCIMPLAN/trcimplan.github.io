<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio EconomiaInversionSinActividadPetroleraExtraccionYRefinacion
 *
...
class EconomiaInversionSinActividadPetroleraExtraccionYRefinacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Inversión sin actividad petrolera (extracción y refinación) en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '16707350.00', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
