...
class EconomiaRegistroDeUnaPropiedadPercentilPromedio extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Índice de Competitividad Urbana, Gobierno, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2012-12-31', 'valor' => '0.7953', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 12, crudo 6
    } // datos
