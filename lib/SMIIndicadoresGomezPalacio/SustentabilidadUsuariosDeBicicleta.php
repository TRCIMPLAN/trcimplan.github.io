<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Usuarios de Bicicleta (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadUsuariosDeBicicleta extends \Base\Publicacion {
