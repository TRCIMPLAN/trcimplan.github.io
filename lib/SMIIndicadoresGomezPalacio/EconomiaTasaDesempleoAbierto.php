<?php
/**
 * EconomiaTasaDesempleoAbierto.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaTasaDesempleoAbierto
 */
class EconomiaTasaDesempleoAbierto extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiatasa-desempleo-abierto';
...
3er. Trimestre: 5.20 %</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tasa de Desempleo Abierto en Gómez Palacio</h3>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Tasa de Desempleo Abierto</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '1990-03-12', dato: 2.9000 },{ fecha: '2000-02-14', dato: 0.9800 },{ fecha: '2010-06-25', dato: 7.8000 },{ fecha: '2014-03-31', dato: 6.2000 },{ fecha: '2014-06-30', dato: 5.0200 },{ fecha: '2014-09-30', dato: 7.0400 },{ fecha: '2014-12-31', dato: 7.5500 },{ fecha: '2015-03-31', dato: 5.8400 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
