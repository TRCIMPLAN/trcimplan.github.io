...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrmruouws">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiqoryyfy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrmruouws a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrmruouws a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiqoryyfy === 'undefined') {
    varMorrisiqoryyfy = Morris.Line({
      element: 'Morrisiqoryyfy',
