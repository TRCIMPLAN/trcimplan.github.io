...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspkbhnddx">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxhjfxztx" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspkbhnddx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspkbhnddx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxhjfxztx === 'undefined') {
    varMorrisxhjfxztx = Morris.Line({
      element: 'Morrisxhjfxztx',
