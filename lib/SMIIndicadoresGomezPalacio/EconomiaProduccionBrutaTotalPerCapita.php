...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdgzpsife">
...
<div id="Morrisnmdzdwxi" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlxxikxdy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdgzpsife a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdgzpsife a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnmdzdwxi === 'undefined') {
    varMorrisnmdzdwxi = Morris.Line({
      element: 'Morrisnmdzdwxi',
...
// LENGUETA
$('#Lenguetasdgzpsife a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplxxikxdy;
  ...
  function initmaplxxikxdy() {
    // Nuevo Mapa
    maplxxikxdy = new L.Map('LeafLetlxxikxdy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplxxikxdy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplxxikxdy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplxxikxdy === 'undefined') {
    varinitmaplxxikxdy = initmaplxxikxdy();
  };
});
FINAL;
    } // constructor
