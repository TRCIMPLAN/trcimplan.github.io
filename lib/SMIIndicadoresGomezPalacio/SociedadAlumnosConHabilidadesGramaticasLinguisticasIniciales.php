<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Alumnos con Habilidades Gramáticas-Lingüisticas Iniciales (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadAlumnosConHabilidadesGramaticasLinguisticasIniciales extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Alumnos con Habilidades Gramáticas-Lingüisticas Iniciales en Gómez Palacio';
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Porcentaje de Alumnos de 6to de primaria ubicados en Nivel I según resultados de la prueba PLANEA de la SEP.</p>
