...
class SustentabilidadDestinosViaAerea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjzpgetnu">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpjwnvgyq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjzpgetnu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjzpgetnu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappjwnvgyq;
  ...
  function initmappjwnvgyq() {
    // Nuevo Mapa
    mappjwnvgyq = new L.Map('LeafLetpjwnvgyq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappjwnvgyq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappjwnvgyq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappjwnvgyq === 'undefined') {
    varinitmappjwnvgyq = initmappjwnvgyq();
  };
});
FINAL;
    } // constructor
