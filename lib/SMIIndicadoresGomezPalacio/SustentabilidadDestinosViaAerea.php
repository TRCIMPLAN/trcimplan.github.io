...
class SustentabilidadDestinosViaAerea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjdlmruxr">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetijnfyxei" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjdlmruxr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjdlmruxr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapijnfyxei;
  ...
  function initmapijnfyxei() {
    // Nuevo Mapa
    mapijnfyxei = new L.Map('LeafLetijnfyxei');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapijnfyxei.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapijnfyxei.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapijnfyxei === 'undefined') {
    varinitmapijnfyxei = initmapijnfyxei();
  };
});
FINAL;
    } // constructor
