...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascluyoziv">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdrznwoow" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascluyoziv a:first').tab('show')
});
// LENGUETA
$('#Lenguetascluyoziv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdrznwoow;
  ...
  function initmapdrznwoow() {
    // Nuevo Mapa
    mapdrznwoow = new L.Map('LeafLetdrznwoow');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdrznwoow.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdrznwoow.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdrznwoow === 'undefined') {
    varinitmapdrznwoow = initmapdrznwoow();
  };
});
FINAL;
    } // constructor
