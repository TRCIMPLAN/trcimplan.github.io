...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswiivvlzz">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaifitnqt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswiivvlzz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswiivvlzz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaifitnqt;
  ...
  function initmapaifitnqt() {
    // Nuevo Mapa
    mapaifitnqt = new L.Map('LeafLetaifitnqt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaifitnqt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaifitnqt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaifitnqt === 'undefined') {
    varinitmapaifitnqt = initmapaifitnqt();
  };
});
FINAL;
    } // constructor
