...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseurqkwdw">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaervpxrf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseurqkwdw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseurqkwdw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaervpxrf;
  ...
  function initmapaervpxrf() {
    // Nuevo Mapa
    mapaervpxrf = new L.Map('LeafLetaervpxrf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaervpxrf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaervpxrf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaervpxrf === 'undefined') {
    varinitmapaervpxrf = initmapaervpxrf();
  };
});
FINAL;
    } // constructor
