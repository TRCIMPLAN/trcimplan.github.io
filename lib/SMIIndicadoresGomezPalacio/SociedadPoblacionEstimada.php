...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbgxfodxa">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisavaemles" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbgxfodxa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbgxfodxa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisavaemles === 'undefined') {
    varMorrisavaemles = Morris.Line({
      element: 'Morrisavaemles',
