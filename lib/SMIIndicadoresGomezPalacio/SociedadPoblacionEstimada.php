...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmxascyhu">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyjltrqro" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmxascyhu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmxascyhu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyjltrqro === 'undefined') {
    varMorrisyjltrqro = Morris.Line({
      element: 'Morrisyjltrqro',
