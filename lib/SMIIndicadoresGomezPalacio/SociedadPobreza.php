...
class SociedadPobreza extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgownlqtu">
...
Consulta la [Base de Datos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnrfzuxao" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgownlqtu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgownlqtu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnrfzuxao;
  ...
  function initmapnrfzuxao() {
    // Nuevo Mapa
    mapnrfzuxao = new L.Map('LeafLetnrfzuxao');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnrfzuxao.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnrfzuxao.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnrfzuxao === 'undefined') {
    varinitmapnrfzuxao = initmapnrfzuxao();
  };
});
FINAL;
    } // constructor
