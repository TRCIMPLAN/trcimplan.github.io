...
class SociedadPobreza extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgwbrriyq">
...
Consulta la [Base de Datos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmzocxcpu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgwbrriyq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgwbrriyq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmzocxcpu;
  ...
  function initmapmzocxcpu() {
    // Nuevo Mapa
    mapmzocxcpu = new L.Map('LeafLetmzocxcpu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmzocxcpu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmzocxcpu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmzocxcpu === 'undefined') {
    varinitmapmzocxcpu = initmapmzocxcpu();
  };
});
FINAL;
    } // constructor
