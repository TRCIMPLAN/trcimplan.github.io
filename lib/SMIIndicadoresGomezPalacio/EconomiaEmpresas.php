<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Empresas (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpresas extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empresas en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 21.8200 },{ fecha: '2009-12-31', dato: 21.9051 },{ fecha: '2010-12-31', dato: 21.0969 },{ fecha: '2011-12-31', dato: 19.4995 },{ fecha: '2012-12-31', dato: 23.2116 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
