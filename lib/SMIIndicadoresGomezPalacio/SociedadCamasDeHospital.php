...
Fuente: SINAIS.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Mide el número de camas censables relativo a la población. Este indicador es un proxy de la infraestructura médica con la que cuenta el sector público de salud. 
Fuente: SINAIS.</p>
