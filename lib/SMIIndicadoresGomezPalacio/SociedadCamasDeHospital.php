<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Camas de Hospital (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: SINAIS.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Camas de Hospital en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.9542 },{ fecha: '2009-12-31', dato: 1.9311 },{ fecha: '2010-12-31', dato: 2.1468 },{ fecha: '2011-12-31', dato: 2.1217 },{ fecha: '2012-12-31', dato: 2.0983 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Mide el número de camas censables relativo a la población. Este indicador es un proxy de la infraestructura médica con la que cuenta el sector público de salud.</p>
