...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskslkfsyd">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishkclgrqb" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskslkfsyd a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskslkfsyd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishkclgrqb === 'undefined') {
    varMorrishkclgrqb = Morris.Line({
      element: 'Morrishkclgrqb',
