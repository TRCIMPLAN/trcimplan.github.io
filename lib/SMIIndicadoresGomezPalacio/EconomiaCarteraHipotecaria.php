...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuvqbieao">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfsziqrui" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuvqbieao a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuvqbieao a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfsziqrui === 'undefined') {
    varMorrisfsziqrui = Morris.Line({
      element: 'Morrisfsziqrui',
