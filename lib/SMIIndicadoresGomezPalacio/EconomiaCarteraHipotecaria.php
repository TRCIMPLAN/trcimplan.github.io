...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqpwjfbug">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisccepbwef" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzabpyscs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqpwjfbug a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqpwjfbug a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisccepbwef === 'undefined') {
    varMorrisccepbwef = Morris.Line({
      element: 'Morrisccepbwef',
...
// LENGUETA
$('#Lenguetasqpwjfbug a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzabpyscs;
  ...
  function initmapzabpyscs() {
    // Nuevo Mapa
    mapzabpyscs = new L.Map('LeafLetzabpyscs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzabpyscs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzabpyscs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzabpyscs === 'undefined') {
    varinitmapzabpyscs = initmapzabpyscs();
  };
});
FINAL;
    } // constructor
