<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Alumnos con Habilidades Científico-Matemáticas Prácticas (Creado por Central:SmiLanzadera)
 *
...
class SociedadAlumnosConHabilidadesCientificoMatematicasPracticas extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Alumnos con Habilidades Científico-Matemáticas Prácticas en Gómez Palacio';
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 15.0000 },{ region: 'Gómez Palacio', dato: 12.8000 },{ region: 'Lerdo', dato: 12.1000 },{ region: 'Matamoros', dato: 10.9000 },{ region: 'La Laguna', dato: 13.6000 },{ region: 'Coahuila', dato: 15.6000 },{ region: 'Durango', dato: 13.9000 },{ region: 'Nacional', dato: 13.8000 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
