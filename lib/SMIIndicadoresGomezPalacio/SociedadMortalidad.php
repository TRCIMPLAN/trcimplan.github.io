...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvgrqdxuq">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetowdgydzh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvgrqdxuq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvgrqdxuq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapowdgydzh;
  ...
  function initmapowdgydzh() {
    // Nuevo Mapa
    mapowdgydzh = new L.Map('LeafLetowdgydzh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapowdgydzh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapowdgydzh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapowdgydzh === 'undefined') {
    varinitmapowdgydzh = initmapowdgydzh();
  };
});
FINAL;
    } // constructor
