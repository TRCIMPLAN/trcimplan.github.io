...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashlbotfwa">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlnxwydhf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashlbotfwa a:first').tab('show')
});
// LENGUETA
$('#Lenguetashlbotfwa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplnxwydhf;
  ...
  function initmaplnxwydhf() {
    // Nuevo Mapa
    maplnxwydhf = new L.Map('LeafLetlnxwydhf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplnxwydhf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplnxwydhf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplnxwydhf === 'undefined') {
    varinitmaplnxwydhf = initmaplnxwydhf();
  };
});
FINAL;
    } // constructor
