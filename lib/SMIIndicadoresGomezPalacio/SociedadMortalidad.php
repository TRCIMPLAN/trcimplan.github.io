...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjbhiuror">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetojimxkzn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjbhiuror a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjbhiuror a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapojimxkzn;
  ...
  function initmapojimxkzn() {
    // Nuevo Mapa
    mapojimxkzn = new L.Map('LeafLetojimxkzn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapojimxkzn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapojimxkzn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapojimxkzn === 'undefined') {
    varinitmapojimxkzn = initmapojimxkzn();
  };
});
FINAL;
    } // constructor
