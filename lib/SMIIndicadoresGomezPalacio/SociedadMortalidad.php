...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrkrzdhiv">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxfvtngyd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrkrzdhiv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrkrzdhiv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxfvtngyd;
  ...
  function initmapxfvtngyd() {
    // Nuevo Mapa
    mapxfvtngyd = new L.Map('LeafLetxfvtngyd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxfvtngyd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxfvtngyd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxfvtngyd === 'undefined') {
    varinitmapxfvtngyd = initmapxfvtngyd();
  };
});
FINAL;
    } // constructor
