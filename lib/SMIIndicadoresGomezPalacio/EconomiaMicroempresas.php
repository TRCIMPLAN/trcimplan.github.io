...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoqnmuhyn">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismntkhodt" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxfkawdpk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoqnmuhyn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoqnmuhyn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismntkhodt === 'undefined') {
    varMorrismntkhodt = Morris.Line({
      element: 'Morrismntkhodt',
...
// LENGUETA
$('#Lenguetasoqnmuhyn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxfkawdpk;
  ...
  function initmapxfkawdpk() {
    // Nuevo Mapa
    mapxfkawdpk = new L.Map('LeafLetxfkawdpk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxfkawdpk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxfkawdpk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxfkawdpk === 'undefined') {
    varinitmapxfkawdpk = initmapxfkawdpk();
  };
});
FINAL;
    } // constructor
