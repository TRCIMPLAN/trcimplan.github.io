...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasurgblhpp">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisurdtmlqq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmijfdwxk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasurgblhpp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasurgblhpp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisurdtmlqq === 'undefined') {
    varMorrisurdtmlqq = Morris.Line({
      element: 'Morrisurdtmlqq',
...
// LENGUETA
$('#Lenguetasurgblhpp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmijfdwxk;
  ...
  function initmapmijfdwxk() {
    // Nuevo Mapa
    mapmijfdwxk = new L.Map('LeafLetmijfdwxk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmijfdwxk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmijfdwxk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmijfdwxk === 'undefined') {
    varinitmapmijfdwxk = initmapmijfdwxk();
  };
});
FINAL;
    } // constructor
