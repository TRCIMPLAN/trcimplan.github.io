...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmiswxdrx">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrqvqrshp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethjjaghnu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmiswxdrx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmiswxdrx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrqvqrshp === 'undefined') {
    varMorrisrqvqrshp = Morris.Line({
      element: 'Morrisrqvqrshp',
...
// LENGUETA
$('#Lenguetasmiswxdrx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphjjaghnu;
  ...
  function initmaphjjaghnu() {
    // Nuevo Mapa
    maphjjaghnu = new L.Map('LeafLethjjaghnu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphjjaghnu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphjjaghnu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphjjaghnu === 'undefined') {
    varinitmaphjjaghnu = initmaphjjaghnu();
  };
});
FINAL;
    } // constructor
