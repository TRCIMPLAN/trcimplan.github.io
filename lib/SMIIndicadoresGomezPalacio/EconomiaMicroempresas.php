...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspcbuzaik">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoxvjnizb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgjekhuen" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspcbuzaik a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspcbuzaik a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoxvjnizb === 'undefined') {
    varMorrisoxvjnizb = Morris.Line({
      element: 'Morrisoxvjnizb',
...
// LENGUETA
$('#Lenguetaspcbuzaik a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgjekhuen;
  ...
  function initmapgjekhuen() {
    // Nuevo Mapa
    mapgjekhuen = new L.Map('LeafLetgjekhuen');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgjekhuen.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgjekhuen.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgjekhuen === 'undefined') {
    varinitmapgjekhuen = initmapgjekhuen();
  };
});
FINAL;
    } // constructor
