...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashxqomlan">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqessbnyl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashxqomlan a:first').tab('show')
});
// LENGUETA
$('#Lenguetashxqomlan a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqessbnyl;
  ...
  function initmapqessbnyl() {
    // Nuevo Mapa
    mapqessbnyl = new L.Map('LeafLetqessbnyl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqessbnyl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqessbnyl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqessbnyl === 'undefined') {
    varinitmapqessbnyl = initmapqessbnyl();
  };
});
FINAL;
    } // constructor
