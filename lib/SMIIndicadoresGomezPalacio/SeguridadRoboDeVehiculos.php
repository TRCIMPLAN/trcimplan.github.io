...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjufjtuvn">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgscoardo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjufjtuvn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjufjtuvn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgscoardo;
  ...
  function initmapgscoardo() {
    // Nuevo Mapa
    mapgscoardo = new L.Map('LeafLetgscoardo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgscoardo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgscoardo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgscoardo === 'undefined') {
    varinitmapgscoardo = initmapgscoardo();
  };
});
FINAL;
    } // constructor
