...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoieljzsn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetydhavudl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoieljzsn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoieljzsn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapydhavudl;
  ...
  function initmapydhavudl() {
    // Nuevo Mapa
    mapydhavudl = new L.Map('LeafLetydhavudl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapydhavudl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapydhavudl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapydhavudl === 'undefined') {
    varinitmapydhavudl = initmapydhavudl();
  };
});
FINAL;
    } // constructor
