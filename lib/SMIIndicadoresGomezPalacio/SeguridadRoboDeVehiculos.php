...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvxfsmqkv">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxxfogevz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvxfsmqkv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvxfsmqkv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxxfogevz === 'undefined') {
    varMorrisxxfogevz = Morris.Line({
      element: 'Morrisxxfogevz',
