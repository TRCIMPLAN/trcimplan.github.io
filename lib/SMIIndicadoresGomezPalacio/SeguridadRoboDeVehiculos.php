...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasodllavlv">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfjvvyjun" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasodllavlv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasodllavlv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfjvvyjun;
  ...
  function initmapfjvvyjun() {
    // Nuevo Mapa
    mapfjvvyjun = new L.Map('LeafLetfjvvyjun');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfjvvyjun.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfjvvyjun.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfjvvyjun === 'undefined') {
    varinitmapfjvvyjun = initmapfjvvyjun();
  };
});
FINAL;
    } // constructor
