<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Escuelas de Calidad (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadEscuelasDeCalidad extends \Base\Publicacion {
...
<p>Fuente: Mejora tu Escuela con datos de la SEP.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Escuelas de Calidad en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Escuelas de Calidad</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Escuelas de Calidad</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 5.0400 },{ fecha: '2009-12-31', dato: 5.0400 },{ fecha: '2010-12-31', dato: 9.1700 },{ fecha: '2011-12-31', dato: 8.2000 },{ fecha: '2012-12-31', dato: 19.1100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 26.6300 },{ region: 'Gómez Palacio', dato: 19.1100 },{ region: 'Lerdo', dato: 16.6700 },{ region: 'Matamoros', dato: 3.2300 },{ region: 'La Laguna', dato: 20.1800 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
