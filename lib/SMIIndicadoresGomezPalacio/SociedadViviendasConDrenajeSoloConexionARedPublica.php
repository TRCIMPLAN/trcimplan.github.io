<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Viviendas con Drenaje (sólo conexión a red pública) (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadViviendasConDrenajeSoloConexionARedPublica extends \Base\Publicacion {
...
Fuente: Estimaciones de IMCO a partir del Módulo de Condiciones Socioeconómicas (MCS) del Consejo Nacional para la Evaluación de la Política de Desarrollo Social (CONEVAL).';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Mide las Viviendas con acceso a la red pública de drenaje.
Fuente: Estimaciones de IMCO a partir del Módulo de Condiciones Socioeconómicas (MCS) del Consejo Nacional para la Evaluación de la Política de Desarrollo Social (CONEVAL).</p>
      ...
      <h3>Observaciones</h3>
<p>El SMI cuenta con el indicador "Viviendas con Drenaje" el cual está basado en datos del Censo de Población y Vivienda 2010 de INEGI.</p>
