...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspvvvvfla">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbrihdqbn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspvvvvfla a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspvvvvfla a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbrihdqbn;
  ...
  function initmapbrihdqbn() {
    // Nuevo Mapa
    mapbrihdqbn = new L.Map('LeafLetbrihdqbn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbrihdqbn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbrihdqbn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbrihdqbn === 'undefined') {
    varinitmapbrihdqbn = initmapbrihdqbn();
  };
});
FINAL;
    } // constructor
