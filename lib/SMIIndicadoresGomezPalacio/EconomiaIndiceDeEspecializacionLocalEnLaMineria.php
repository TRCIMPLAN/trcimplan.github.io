...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvhpaqpga">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmcuoxlwh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvhpaqpga a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvhpaqpga a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmcuoxlwh;
  ...
  function initmapmcuoxlwh() {
    // Nuevo Mapa
    mapmcuoxlwh = new L.Map('LeafLetmcuoxlwh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmcuoxlwh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmcuoxlwh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmcuoxlwh === 'undefined') {
    varinitmapmcuoxlwh = initmapmcuoxlwh();
  };
});
FINAL;
    } // constructor
