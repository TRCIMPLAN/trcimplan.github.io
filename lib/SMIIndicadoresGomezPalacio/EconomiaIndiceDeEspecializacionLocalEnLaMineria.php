...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqxmrktix">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteunofnju" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqxmrktix a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqxmrktix a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeunofnju;
  ...
  function initmapeunofnju() {
    // Nuevo Mapa
    mapeunofnju = new L.Map('LeafLeteunofnju');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeunofnju.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeunofnju.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeunofnju === 'undefined') {
    varinitmapeunofnju = initmapeunofnju();
  };
});
FINAL;
    } // constructor
