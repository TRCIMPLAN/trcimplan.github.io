...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasesogujxd">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdqxzhkul" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasesogujxd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasesogujxd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdqxzhkul;
  ...
  function initmapdqxzhkul() {
    // Nuevo Mapa
    mapdqxzhkul = new L.Map('LeafLetdqxzhkul');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdqxzhkul.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdqxzhkul.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdqxzhkul === 'undefined') {
    varinitmapdqxzhkul = initmapdqxzhkul();
  };
});
FINAL;
    } // constructor
