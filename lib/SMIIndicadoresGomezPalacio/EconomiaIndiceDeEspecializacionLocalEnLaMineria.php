...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasevtjxsby">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfkzxulds" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasevtjxsby a:first').tab('show')
});
// LENGUETA
$('#Lenguetasevtjxsby a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfkzxulds;
  ...
  function initmapfkzxulds() {
    // Nuevo Mapa
    mapfkzxulds = new L.Map('LeafLetfkzxulds');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfkzxulds.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfkzxulds.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfkzxulds === 'undefined') {
    varinitmapfkzxulds = initmapfkzxulds();
  };
});
FINAL;
    } // constructor
