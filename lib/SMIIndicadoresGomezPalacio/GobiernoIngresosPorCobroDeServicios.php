...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastvujgktk">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissqptzawe" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastvujgktk a:first').tab('show')
});
// LENGUETA
$('#Lenguetastvujgktk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissqptzawe === 'undefined') {
    varMorrissqptzawe = Morris.Line({
      element: 'Morrissqptzawe',
