...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswdrjymec">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswevoncpn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetonrgiqxc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswdrjymec a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswdrjymec a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswevoncpn === 'undefined') {
    varMorriswevoncpn = Morris.Line({
      element: 'Morriswevoncpn',
...
// LENGUETA
$('#Lenguetaswdrjymec a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maponrgiqxc;
  ...
  function initmaponrgiqxc() {
    // Nuevo Mapa
    maponrgiqxc = new L.Map('LeafLetonrgiqxc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maponrgiqxc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maponrgiqxc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaponrgiqxc === 'undefined') {
    varinitmaponrgiqxc = initmaponrgiqxc();
  };
});
FINAL;
    } // constructor
