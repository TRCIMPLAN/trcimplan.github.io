...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasijkatljy">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisslbyuhhn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwuskhrnh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasijkatljy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasijkatljy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisslbyuhhn === 'undefined') {
    varMorrisslbyuhhn = Morris.Line({
      element: 'Morrisslbyuhhn',
...
// LENGUETA
$('#Lenguetasijkatljy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwuskhrnh;
  ...
  function initmapwuskhrnh() {
    // Nuevo Mapa
    mapwuskhrnh = new L.Map('LeafLetwuskhrnh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwuskhrnh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwuskhrnh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwuskhrnh === 'undefined') {
    varinitmapwuskhrnh = initmapwuskhrnh();
  };
});
FINAL;
    } // constructor
