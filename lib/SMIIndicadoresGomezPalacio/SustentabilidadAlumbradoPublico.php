...
class SustentabilidadAlumbradoPublico extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjwkxkyyr">
...
Censo de Población y Vivienda 2010. Consulta las [Bases de Datos](http://www.inegi.org.mx/est/contenidos/proyectos/ccpv/cpv2010/tabulados_urbano.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqfyimexu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjwkxkyyr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjwkxkyyr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqfyimexu;
  ...
  function initmapqfyimexu() {
    // Nuevo Mapa
    mapqfyimexu = new L.Map('LeafLetqfyimexu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqfyimexu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqfyimexu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqfyimexu === 'undefined') {
    varinitmapqfyimexu = initmapqfyimexu();
  };
});
FINAL;
    } // constructor
