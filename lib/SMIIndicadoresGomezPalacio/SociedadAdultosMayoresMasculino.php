...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasidizrksg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnbqfbcjz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetakjsyrdt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasidizrksg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasidizrksg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnbqfbcjz === 'undefined') {
    varMorrisnbqfbcjz = Morris.Line({
      element: 'Morrisnbqfbcjz',
...
// LENGUETA
$('#Lenguetasidizrksg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapakjsyrdt;
  ...
  function initmapakjsyrdt() {
    // Nuevo Mapa
    mapakjsyrdt = new L.Map('LeafLetakjsyrdt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapakjsyrdt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapakjsyrdt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapakjsyrdt === 'undefined') {
    varinitmapakjsyrdt = initmapakjsyrdt();
  };
});
FINAL;
    } // constructor
