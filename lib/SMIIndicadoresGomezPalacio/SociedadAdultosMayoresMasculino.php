...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszlqsmoaa">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskwjtamba" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethyibvoyz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszlqsmoaa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszlqsmoaa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskwjtamba === 'undefined') {
    varMorriskwjtamba = Morris.Line({
      element: 'Morriskwjtamba',
...
// LENGUETA
$('#Lenguetaszlqsmoaa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphyibvoyz;
  ...
  function initmaphyibvoyz() {
    // Nuevo Mapa
    maphyibvoyz = new L.Map('LeafLethyibvoyz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphyibvoyz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphyibvoyz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphyibvoyz === 'undefined') {
    varinitmaphyibvoyz = initmaphyibvoyz();
  };
});
FINAL;
    } // constructor
