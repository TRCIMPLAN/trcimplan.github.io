...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiegwrgbu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscukjmpxq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiegwrgbu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiegwrgbu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscukjmpxq === 'undefined') {
    varMorriscukjmpxq = Morris.Line({
      element: 'Morriscukjmpxq',
