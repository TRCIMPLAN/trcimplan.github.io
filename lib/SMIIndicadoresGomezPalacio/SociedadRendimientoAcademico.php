<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Rendimiento Académico (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadRendimientoAcademico extends \Base\Publicacion {
...
<p>Porcentaje de alumnos de educación básica y media superior en niveles Bueno y Excelente en Matemáticas de prueba ENLACE. Fuente: Mejora tu Escuela con datos de la Secretaría de Educación Pública (SEP).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Rendimiento Académico en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 41.5000 },{ fecha: '2009-12-31', dato: 41.5000 },{ fecha: '2010-12-31', dato: 36.3000 },{ fecha: '2011-12-31', dato: 35.8000 },{ fecha: '2012-12-31', dato: 38.9000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
