...
class SociedadMedicos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgvejxudq">
...
<div id="Morrisjqxulwtd" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmnxuxlyo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgvejxudq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgvejxudq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjqxulwtd === 'undefined') {
    varMorrisjqxulwtd = Morris.Line({
      element: 'Morrisjqxulwtd',
...
// LENGUETA
$('#Lenguetasgvejxudq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmnxuxlyo;
  ...
  function initmapmnxuxlyo() {
    // Nuevo Mapa
    mapmnxuxlyo = new L.Map('LeafLetmnxuxlyo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmnxuxlyo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmnxuxlyo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmnxuxlyo === 'undefined') {
    varinitmapmnxuxlyo = initmapmnxuxlyo();
  };
});
FINAL;
    } // constructor
