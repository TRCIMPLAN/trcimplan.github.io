...
class SociedadMedicos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascwyqgwyy">
...
<div id="Morrisoicphcuo" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyvvqiaie" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascwyqgwyy a:first').tab('show')
});
// LENGUETA
$('#Lenguetascwyqgwyy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoicphcuo === 'undefined') {
    varMorrisoicphcuo = Morris.Line({
      element: 'Morrisoicphcuo',
...
// LENGUETA
$('#Lenguetascwyqgwyy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyvvqiaie;
  ...
  function initmapyvvqiaie() {
    // Nuevo Mapa
    mapyvvqiaie = new L.Map('LeafLetyvvqiaie');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyvvqiaie.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyvvqiaie.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyvvqiaie === 'undefined') {
    varinitmapyvvqiaie = initmapyvvqiaie();
  };
});
FINAL;
    } // constructor
