<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadNivelUnoDeMatematicasDePlanea
 *
...
class SociedadNivelUnoDeMatematicasDePlanea extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nivel uno de Matemáticas de PLANEA en Gómez Palacio';
...
Nivel 1: Tienen dificultades para realizar operaciones con fracciones y operaciones que combinen incógnitas o variables (representadas con letras), así como para establecer y analizar entre dos variables.';
    ...
    public function datos() {
        return array(
            array('fecha' => '2017-12-31', 'valor' => '71.8000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
