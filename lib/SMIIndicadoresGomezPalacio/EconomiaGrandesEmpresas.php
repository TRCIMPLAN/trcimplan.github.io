...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascttigwfa">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxgiihvfm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascttigwfa a:first').tab('show')
});
// LENGUETA
$('#Lenguetascttigwfa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxgiihvfm === 'undefined') {
    varMorrisxgiihvfm = Morris.Line({
      element: 'Morrisxgiihvfm',
