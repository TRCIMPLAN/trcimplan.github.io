...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasidghiryj">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgakyntbw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasidghiryj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasidghiryj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgakyntbw === 'undefined') {
    varMorrisgakyntbw = Morris.Line({
      element: 'Morrisgakyntbw',
