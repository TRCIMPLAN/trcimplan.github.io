...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjabyzmha">
...
<div id="Morriskhctaqyo" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxuhilgpq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjabyzmha a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjabyzmha a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskhctaqyo === 'undefined') {
    varMorriskhctaqyo = Morris.Line({
      element: 'Morriskhctaqyo',
...
// LENGUETA
$('#Lenguetasjabyzmha a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxuhilgpq;
  ...
  function initmapxuhilgpq() {
    // Nuevo Mapa
    mapxuhilgpq = new L.Map('LeafLetxuhilgpq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxuhilgpq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxuhilgpq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxuhilgpq === 'undefined') {
    varinitmapxuhilgpq = initmapxuhilgpq();
  };
});
FINAL;
    } // constructor
