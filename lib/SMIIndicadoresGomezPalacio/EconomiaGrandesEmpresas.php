...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiqhbfbvc">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswsxsufis" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiqhbfbvc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiqhbfbvc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswsxsufis === 'undefined') {
    varMorriswsxsufis = Morris.Line({
      element: 'Morriswsxsufis',
