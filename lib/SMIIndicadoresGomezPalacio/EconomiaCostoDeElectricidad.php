<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio EconomiaCostoDeElectricidad
 *
...
class EconomiaCostoDeElectricidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Costo de electricidad en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '26.3116', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2016-12-31', 'valor' => '26.3000', 'fuente_nombre' => 'IMCO'));
    } // otras_regiones
