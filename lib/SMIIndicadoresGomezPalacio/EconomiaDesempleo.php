...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashtyfwobn">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdxwjzrqc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuusvrwaq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashtyfwobn a:first').tab('show')
});
// LENGUETA
$('#Lenguetashtyfwobn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdxwjzrqc === 'undefined') {
    varMorrisdxwjzrqc = Morris.Line({
      element: 'Morrisdxwjzrqc',
...
// LENGUETA
$('#Lenguetashtyfwobn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuusvrwaq;
  ...
  function initmapuusvrwaq() {
    // Nuevo Mapa
    mapuusvrwaq = new L.Map('LeafLetuusvrwaq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuusvrwaq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuusvrwaq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuusvrwaq === 'undefined') {
    varinitmapuusvrwaq = initmapuusvrwaq();
  };
});
FINAL;
    } // constructor
