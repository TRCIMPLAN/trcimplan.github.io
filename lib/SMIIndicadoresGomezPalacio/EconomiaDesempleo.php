...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfkdknjfa">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscvxdiean" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaqovytno" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfkdknjfa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfkdknjfa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscvxdiean === 'undefined') {
    varMorriscvxdiean = Morris.Line({
      element: 'Morriscvxdiean',
...
// LENGUETA
$('#Lenguetasfkdknjfa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaqovytno;
  ...
  function initmapaqovytno() {
    // Nuevo Mapa
    mapaqovytno = new L.Map('LeafLetaqovytno');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaqovytno.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaqovytno.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaqovytno === 'undefined') {
    varinitmapaqovytno = initmapaqovytno();
  };
});
FINAL;
    } // constructor
