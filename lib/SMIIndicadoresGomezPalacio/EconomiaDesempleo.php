...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdjmdgncx">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristbahlbnw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdjmdgncx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdjmdgncx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristbahlbnw === 'undefined') {
    varMorristbahlbnw = Morris.Line({
      element: 'Morristbahlbnw',
