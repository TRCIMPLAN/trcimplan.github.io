...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswgdtput">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswuxvwciq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswgdtput a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswgdtput a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswuxvwciq === 'undefined') {
    varMorriswuxvwciq = Morris.Line({
      element: 'Morriswuxvwciq',
