<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Seguridad Percepción de inseguridad (Creado por Central:SmiLanzadera)
 *
...
class SeguridadPercepcionDeInseguridad extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->descripcion       = 'Forma parte de subíndice de "Sistema de Derecho Confiable y Objetivo". Mide: El porcentaje de personas que se sienten inseguras dentro de su municipio. Ésta es una variable a nivel estatal debido a que la encuesta no es representativa a nivel ciudad. Unidades: Porcentaje de la población total. Fuente: INEGI (Encuesta Nacional de Victimización y Percepción sobre Seguridad Pública), 2011-2013.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Forma parte de subíndice de "Sistema de Derecho Confiable y Objetivo". Mide: El porcentaje de personas que se sienten inseguras dentro de su municipio. Ésta es una variable a nivel estatal debido a que la encuesta no es representativa a nivel ciudad. Unidades: Porcentaje de la población total. Fuente: INEGI (Encuesta Nacional de Victimización y Percepción sobre Seguridad Pública), 2011-2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Percepción de inseguridad en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 81.7400 },{ fecha: '2009-12-31', dato: 81.7400 },{ fecha: '2010-12-31', dato: 81.7400 },{ fecha: '2011-12-31', dato: 73.3900 },{ fecha: '2012-12-31', dato: 65.9700 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
