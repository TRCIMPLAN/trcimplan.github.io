...
class GobiernoIngresosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfqeeuysl">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgcjrfnxc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqwmepmlw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfqeeuysl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfqeeuysl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgcjrfnxc === 'undefined') {
    varMorrisgcjrfnxc = Morris.Line({
      element: 'Morrisgcjrfnxc',
...
// LENGUETA
$('#Lenguetasfqeeuysl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqwmepmlw;
  ...
  function initmapqwmepmlw() {
    // Nuevo Mapa
    mapqwmepmlw = new L.Map('LeafLetqwmepmlw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqwmepmlw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqwmepmlw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqwmepmlw === 'undefined') {
    varinitmapqwmepmlw = initmapqwmepmlw();
  };
});
FINAL;
    } // constructor
