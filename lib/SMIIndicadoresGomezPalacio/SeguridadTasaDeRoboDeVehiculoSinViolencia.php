<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Seguridad Tasa de Robo de Vehículo Sin Violencia (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SeguridadTasaDeRoboDeVehiculoSinViolencia extends \Base\Publicacion {
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0 },{ region: 'Gómez Palacio', dato: 0 },{ region: 'Lerdo', dato: 0 },{ region: 'Matamoros', dato: 0 },{ region: 'La Laguna', dato: 22.7000 },{ region: 'Coahuila', dato: 16.7900 },{ region: 'Durango', dato: 36.2700 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
