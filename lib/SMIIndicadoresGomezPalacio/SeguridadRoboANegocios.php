...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslyepnhtt">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgqcrfifu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslyepnhtt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslyepnhtt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgqcrfifu === 'undefined') {
    varMorrisgqcrfifu = Morris.Line({
      element: 'Morrisgqcrfifu',
