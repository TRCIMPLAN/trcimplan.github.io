<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Población Ocupada Sin Ingresos (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaPoblacionOcupadaSinIngresos extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      ...
      <h3>Observaciones</h3>
<p>Porcentaje de la población ocupada</p>

    </div>
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Población Ocupada Sin Ingresos en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 10.0800 },{ fecha: '2009-12-31', dato: 5.0400 },{ fecha: '2010-12-31', dato: 4.5600 },{ fecha: '2011-12-31', dato: 7.7100 },{ fecha: '2012-12-31', dato: 7.5200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 11.6300 },{ region: 'Gómez Palacio', dato: 7.5200 },{ region: 'Lerdo', dato: 0.2200 },{ region: 'Matamoros', dato: 7.9300 },{ region: 'La Laguna', dato: 9.1700 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice de "Mercado Laboral". Mide la población que actualmente está empleada, pero que no recibe remuneración por su trabajo. Una parte importante de este indicador son trabajadores familiares sin pago. Algunos de estos casos podrían corresponder a situaciones cercanas a la esclavitud moderna o situaciones especiales en las que los trabajadores no cobran por los servicios que desempeñan.</p>
