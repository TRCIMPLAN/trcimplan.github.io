...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasddewdhpg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqdlzafwg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasddewdhpg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasddewdhpg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqdlzafwg === 'undefined') {
    varMorrisqdlzafwg = Morris.Line({
      element: 'Morrisqdlzafwg',
