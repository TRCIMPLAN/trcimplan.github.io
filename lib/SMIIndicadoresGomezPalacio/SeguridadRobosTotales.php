...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasajanalix">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiolpthoq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasajanalix a:first').tab('show')
});
// LENGUETA
$('#Lenguetasajanalix a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiolpthoq === 'undefined') {
    varMorrisiolpthoq = Morris.Line({
      element: 'Morrisiolpthoq',
