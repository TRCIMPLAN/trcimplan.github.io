...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasobojzimm">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissmxmebru" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasobojzimm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasobojzimm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissmxmebru === 'undefined') {
    varMorrissmxmebru = Morris.Line({
      element: 'Morrissmxmebru',
