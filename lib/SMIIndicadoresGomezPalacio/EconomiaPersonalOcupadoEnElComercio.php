<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Personal Ocupado en el Comercio (Creado por Central:SmiLanzadera)
 *
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica-1">
      <h3>Gráfica de Personal Ocupado en el Comercio en Gómez Palacio con fuente INEGI</h3>
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 26.9458 },{ region: 'Gómez Palacio', dato: 29.4578 },{ region: 'Lerdo', dato: 24.1890 },{ region: 'Matamoros', dato: 35.3180 },{ region: 'La Laguna', dato: 27.6995 },{ region: 'Coahuila', dato: 22.8278 },{ region: 'Durango', dato: 30.6424 },{ region: 'Nacional', dato: 29.6141 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Personal ocupado en comercio al por mayor y al por menor entre el personal ocupado total.</p>
