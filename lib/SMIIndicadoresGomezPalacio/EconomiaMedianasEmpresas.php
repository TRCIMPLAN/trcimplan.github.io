...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasembozvhw">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseasstunr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgqpeaqfh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasembozvhw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasembozvhw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseasstunr === 'undefined') {
    varMorriseasstunr = Morris.Line({
      element: 'Morriseasstunr',
...
// LENGUETA
$('#Lenguetasembozvhw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgqpeaqfh;
  ...
  function initmapgqpeaqfh() {
    // Nuevo Mapa
    mapgqpeaqfh = new L.Map('LeafLetgqpeaqfh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgqpeaqfh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgqpeaqfh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgqpeaqfh === 'undefined') {
    varinitmapgqpeaqfh = initmapgqpeaqfh();
  };
});
FINAL;
    } // constructor
