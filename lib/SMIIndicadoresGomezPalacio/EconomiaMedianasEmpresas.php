...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdoytigwh">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxsnwdqvh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetduvblfmj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdoytigwh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdoytigwh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxsnwdqvh === 'undefined') {
    varMorrisxsnwdqvh = Morris.Line({
      element: 'Morrisxsnwdqvh',
...
// LENGUETA
$('#Lenguetasdoytigwh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapduvblfmj;
  ...
  function initmapduvblfmj() {
    // Nuevo Mapa
    mapduvblfmj = new L.Map('LeafLetduvblfmj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapduvblfmj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapduvblfmj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapduvblfmj === 'undefined') {
    varinitmapduvblfmj = initmapduvblfmj();
  };
});
FINAL;
    } // constructor
