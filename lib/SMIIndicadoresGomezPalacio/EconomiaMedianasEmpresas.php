...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjbbpmwhb">
...
<div id="Morrisrzocpskt" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnfnvrrqy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjbbpmwhb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjbbpmwhb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrzocpskt === 'undefined') {
    varMorrisrzocpskt = Morris.Line({
      element: 'Morrisrzocpskt',
...
// LENGUETA
$('#Lenguetasjbbpmwhb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnfnvrrqy;
  ...
  function initmapnfnvrrqy() {
    // Nuevo Mapa
    mapnfnvrrqy = new L.Map('LeafLetnfnvrrqy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnfnvrrqy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnfnvrrqy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnfnvrrqy === 'undefined') {
    varinitmapnfnvrrqy = initmapnfnvrrqy();
  };
});
FINAL;
    } // constructor
