...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasawnbsmrc">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvgbxppck" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasawnbsmrc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasawnbsmrc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvgbxppck;
  ...
  function initmapvgbxppck() {
    // Nuevo Mapa
    mapvgbxppck = new L.Map('LeafLetvgbxppck');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvgbxppck.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvgbxppck.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvgbxppck === 'undefined') {
    varinitmapvgbxppck = initmapvgbxppck();
  };
});
FINAL;
    } // constructor
