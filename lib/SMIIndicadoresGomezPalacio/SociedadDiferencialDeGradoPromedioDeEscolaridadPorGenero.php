...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassljgeeqj">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethztygqle" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassljgeeqj a:first').tab('show')
});
// LENGUETA
$('#Lenguetassljgeeqj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphztygqle;
  ...
  function initmaphztygqle() {
    // Nuevo Mapa
    maphztygqle = new L.Map('LeafLethztygqle');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphztygqle.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphztygqle.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphztygqle === 'undefined') {
    varinitmaphztygqle = initmaphztygqle();
  };
});
FINAL;
    } // constructor
