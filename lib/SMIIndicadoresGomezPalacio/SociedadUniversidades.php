...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqiepyks">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfbszrjgs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqiepyks a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqiepyks a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfbszrjgs;
  ...
  function initmapfbszrjgs() {
    // Nuevo Mapa
    mapfbszrjgs = new L.Map('LeafLetfbszrjgs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfbszrjgs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfbszrjgs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfbszrjgs === 'undefined') {
    varinitmapfbszrjgs = initmapfbszrjgs();
  };
});
FINAL;
    } // constructor
