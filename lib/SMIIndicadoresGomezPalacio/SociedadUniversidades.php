...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdvjzywnr">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetadbfcliw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdvjzywnr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdvjzywnr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapadbfcliw;
  ...
  function initmapadbfcliw() {
    // Nuevo Mapa
    mapadbfcliw = new L.Map('LeafLetadbfcliw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapadbfcliw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapadbfcliw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapadbfcliw === 'undefined') {
    varinitmapadbfcliw = initmapadbfcliw();
  };
});
FINAL;
    } // constructor
