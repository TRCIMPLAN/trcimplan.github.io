<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Sistema de Transporte Masivo (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadSistemaDeTransporteMasivo extends \Base\Publicacion {
