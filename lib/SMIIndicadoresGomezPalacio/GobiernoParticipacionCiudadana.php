<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Gobierno Participación Ciudadana (Creado por Central:SmiLanzadera)
 *
 ...
 */
class GobiernoParticipacionCiudadana extends \Base\Publicacion {
...
<p>Para los años 2008, 2009 y 2010 se consideraron los datos de las elecciones de 2009, mientras que para los años 2011 y 2012 se tomaron datos de las elecciones de 2012. Unidades: Porcentaje de la lista nominal. Fuente: Instituto Federal Electoral (IFE), 2009 y 2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Participación Ciudadana en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 42.4900 },{ fecha: '2009-12-31', dato: 42.4900 },{ fecha: '2010-12-31', dato: 42.4900 },{ fecha: '2011-12-31', dato: 58.3100 },{ fecha: '2012-12-31', dato: 58.3100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
