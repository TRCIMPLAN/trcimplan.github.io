<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Consumo de Agua (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadConsumoDeAgua extends \Base\Publicacion {
...
<p>Unidades: Metros cúbicos por persona. Fuente: CONAGUA, 2008-2009.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Consumo de Agua en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Consumo de Agua</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Consumo de Agua</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 88.8000 },{ fecha: '2009-12-31', dato: 87.8000 },{ fecha: '2010-12-31', dato: 86.7000 },{ fecha: '2011-12-31', dato: 85.7000 },{ fecha: '2012-12-31', dato: 84.8000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 127.0000 },{ region: 'Gómez Palacio', dato: 84.8000 },{ region: 'Lerdo', dato: 94.1000 },{ region: 'Matamoros', dato: 109.6000 },{ region: 'La Laguna', dato: 110.2000 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
