...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascmwhlhvu">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxxvcbtjw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascmwhlhvu a:first').tab('show')
});
// LENGUETA
$('#Lenguetascmwhlhvu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxxvcbtjw;
  ...
  function initmapxxvcbtjw() {
    // Nuevo Mapa
    mapxxvcbtjw = new L.Map('LeafLetxxvcbtjw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxxvcbtjw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxxvcbtjw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxxvcbtjw === 'undefined') {
    varinitmapxxvcbtjw = initmapxxvcbtjw();
  };
});
FINAL;
    } // constructor
