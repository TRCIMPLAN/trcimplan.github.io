...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslthufges">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfznitfrt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslthufges a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslthufges a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfznitfrt;
  ...
  function initmapfznitfrt() {
    // Nuevo Mapa
    mapfznitfrt = new L.Map('LeafLetfznitfrt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfznitfrt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfznitfrt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfznitfrt === 'undefined') {
    varinitmapfznitfrt = initmapfznitfrt();
  };
});
FINAL;
    } // constructor
