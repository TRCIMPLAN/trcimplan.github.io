...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslgxkantp">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxmdqxhuh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslgxkantp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslgxkantp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxmdqxhuh;
  ...
  function initmapxmdqxhuh() {
    // Nuevo Mapa
    mapxmdqxhuh = new L.Map('LeafLetxmdqxhuh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxmdqxhuh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxmdqxhuh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxmdqxhuh === 'undefined') {
    varinitmapxmdqxhuh = initmapxmdqxhuh();
  };
});
FINAL;
    } // constructor
