...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastmxunrao">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyndimyon" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastmxunrao a:first').tab('show')
});
// LENGUETA
$('#Lenguetastmxunrao a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyndimyon;
  ...
  function initmapyndimyon() {
    // Nuevo Mapa
    mapyndimyon = new L.Map('LeafLetyndimyon');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyndimyon.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyndimyon.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyndimyon === 'undefined') {
    varinitmapyndimyon = initmapyndimyon();
  };
});
FINAL;
    } // constructor
