...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasizgubgjx">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjyyklhgq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasizgubgjx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasizgubgjx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjyyklhgq;
  ...
  function initmapjyyklhgq() {
    // Nuevo Mapa
    mapjyyklhgq = new L.Map('LeafLetjyyklhgq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjyyklhgq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjyyklhgq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjyyklhgq === 'undefined') {
    varinitmapjyyklhgq = initmapjyyklhgq();
  };
});
FINAL;
    } // constructor
