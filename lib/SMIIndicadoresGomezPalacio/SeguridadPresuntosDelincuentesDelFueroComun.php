...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszxbqupcn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpkvyassy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszxbqupcn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszxbqupcn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappkvyassy;
  ...
  function initmappkvyassy() {
    // Nuevo Mapa
    mappkvyassy = new L.Map('LeafLetpkvyassy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappkvyassy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappkvyassy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappkvyassy === 'undefined') {
    varinitmappkvyassy = initmappkvyassy();
  };
});
FINAL;
    } // constructor
