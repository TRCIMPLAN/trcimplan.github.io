<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Empresa Socialmente Responsable (Creado por Central:SmiLanzadera)
 *
...
class SociedadEmpresaSocialmenteResponsable extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Empresa Socialmente Responsable en Gómez Palacio';
...
<p>Fuente: Centro Mexicano para la Filantropía (CEMEFI).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica-1">
      <h3>Gráfica de Empresa Socialmente Responsable en Gómez Palacio con fuente IMCO</h3>
