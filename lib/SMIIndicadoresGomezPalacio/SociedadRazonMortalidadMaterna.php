<?php
/**
 * SociedadRazonMortalidadMaterna.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadRazonMortalidadMaterna
 */
class SociedadRazonMortalidadMaterna extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sociedadrazon-mortalidad-materna';
        ...
        $this->claves       = 'Gómez Palacio, Salud, Género, Bienestar, Objetivos del Milenio';
