...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasogqcqshb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisospexcly" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkaryghyd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasogqcqshb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasogqcqshb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisospexcly === 'undefined') {
    varMorrisospexcly = Morris.Line({
      element: 'Morrisospexcly',
...
// LENGUETA
$('#Lenguetasogqcqshb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkaryghyd;
  ...
  function initmapkaryghyd() {
    // Nuevo Mapa
    mapkaryghyd = new L.Map('LeafLetkaryghyd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkaryghyd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkaryghyd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkaryghyd === 'undefined') {
    varinitmapkaryghyd = initmapkaryghyd();
  };
});
FINAL;
    } // constructor
