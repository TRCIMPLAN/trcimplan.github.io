...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasodjksale">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxybjsnik" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetubzgqtku" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasodjksale a:first').tab('show')
});
// LENGUETA
$('#Lenguetasodjksale a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxybjsnik === 'undefined') {
    varMorrisxybjsnik = Morris.Line({
      element: 'Morrisxybjsnik',
...
// LENGUETA
$('#Lenguetasodjksale a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapubzgqtku;
  ...
  function initmapubzgqtku() {
    // Nuevo Mapa
    mapubzgqtku = new L.Map('LeafLetubzgqtku');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapubzgqtku.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapubzgqtku.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapubzgqtku === 'undefined') {
    varinitmapubzgqtku = initmapubzgqtku();
  };
});
FINAL;
    } // constructor
