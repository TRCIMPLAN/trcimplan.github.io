...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszbwbxcwg">
...
<div id="Morrishcxkptlq" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgerzlbfk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszbwbxcwg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszbwbxcwg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishcxkptlq === 'undefined') {
    varMorrishcxkptlq = Morris.Line({
      element: 'Morrishcxkptlq',
...
// LENGUETA
$('#Lenguetaszbwbxcwg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgerzlbfk;
  ...
  function initmapgerzlbfk() {
    // Nuevo Mapa
    mapgerzlbfk = new L.Map('LeafLetgerzlbfk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgerzlbfk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgerzlbfk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgerzlbfk === 'undefined') {
    varinitmapgerzlbfk = initmapgerzlbfk();
  };
});
FINAL;
    } // constructor
