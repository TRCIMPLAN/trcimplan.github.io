...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaeynzqni">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqbcebdpj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaeynzqni a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaeynzqni a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqbcebdpj === 'undefined') {
    varMorrisqbcebdpj = Morris.Line({
      element: 'Morrisqbcebdpj',
