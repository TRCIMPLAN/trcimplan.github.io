...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasenlxhzco">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszylrjwbo" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxewhkhga" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasenlxhzco a:first').tab('show')
});
// LENGUETA
$('#Lenguetasenlxhzco a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszylrjwbo === 'undefined') {
    varMorriszylrjwbo = Morris.Line({
      element: 'Morriszylrjwbo',
...
// LENGUETA
$('#Lenguetasenlxhzco a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxewhkhga;
  ...
  function initmapxewhkhga() {
    // Nuevo Mapa
    mapxewhkhga = new L.Map('LeafLetxewhkhga');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxewhkhga.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxewhkhga.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxewhkhga === 'undefined') {
    varinitmapxewhkhga = initmapxewhkhga();
  };
});
FINAL;
    } // constructor
