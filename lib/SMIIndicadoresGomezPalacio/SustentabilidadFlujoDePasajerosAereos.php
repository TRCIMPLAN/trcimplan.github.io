<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Flujo de Pasajeros Aéreos (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadFlujoDePasajerosAereos extends \Base\Publicacion {
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Precursores". Qué mide: El número de pasajeros en vuelos que salen o llegan a las ciudades con aeropuerto cada año ajustado por cada mil habitantes.</p>
