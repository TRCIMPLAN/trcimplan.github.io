...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspchqrlrt">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfpsgdhyz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspchqrlrt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspchqrlrt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfpsgdhyz;
  ...
  function initmapfpsgdhyz() {
    // Nuevo Mapa
    mapfpsgdhyz = new L.Map('LeafLetfpsgdhyz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfpsgdhyz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfpsgdhyz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfpsgdhyz === 'undefined') {
    varinitmapfpsgdhyz = initmapfpsgdhyz();
  };
});
FINAL;
    } // constructor
