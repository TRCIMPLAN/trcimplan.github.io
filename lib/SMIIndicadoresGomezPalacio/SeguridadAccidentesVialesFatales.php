...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasexkotwtc">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzymlkwuv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasexkotwtc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasexkotwtc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzymlkwuv;
  ...
  function initmapzymlkwuv() {
    // Nuevo Mapa
    mapzymlkwuv = new L.Map('LeafLetzymlkwuv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzymlkwuv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzymlkwuv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzymlkwuv === 'undefined') {
    varinitmapzymlkwuv = initmapzymlkwuv();
  };
});
FINAL;
    } // constructor
