...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxkipsodn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlsswvzde" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxkipsodn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxkipsodn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplsswvzde;
  ...
  function initmaplsswvzde() {
    // Nuevo Mapa
    maplsswvzde = new L.Map('LeafLetlsswvzde');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplsswvzde.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplsswvzde.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplsswvzde === 'undefined') {
    varinitmaplsswvzde = initmaplsswvzde();
  };
});
FINAL;
    } // constructor
