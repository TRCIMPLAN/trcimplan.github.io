...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslyvjccfo">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlconwsyr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslyvjccfo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslyvjccfo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplconwsyr;
  ...
  function initmaplconwsyr() {
    // Nuevo Mapa
    maplconwsyr = new L.Map('LeafLetlconwsyr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplconwsyr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplconwsyr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplconwsyr === 'undefined') {
    varinitmaplconwsyr = initmaplconwsyr();
  };
});
FINAL;
    } // constructor
