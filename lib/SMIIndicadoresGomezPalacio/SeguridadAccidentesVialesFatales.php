...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastssddojz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsqlhhfjw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastssddojz a:first').tab('show')
});
// LENGUETA
$('#Lenguetastssddojz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsqlhhfjw;
  ...
  function initmapsqlhhfjw() {
    // Nuevo Mapa
    mapsqlhhfjw = new L.Map('LeafLetsqlhhfjw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsqlhhfjw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsqlhhfjw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsqlhhfjw === 'undefined') {
    varinitmapsqlhhfjw = initmapsqlhhfjw();
  };
});
FINAL;
    } // constructor
