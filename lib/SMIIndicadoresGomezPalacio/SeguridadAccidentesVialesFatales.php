...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskrwfvrwr">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetopniiygf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskrwfvrwr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskrwfvrwr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapopniiygf;
  ...
  function initmapopniiygf() {
    // Nuevo Mapa
    mapopniiygf = new L.Map('LeafLetopniiygf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapopniiygf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapopniiygf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapopniiygf === 'undefined') {
    varinitmapopniiygf = initmapopniiygf();
  };
});
FINAL;
    } // constructor
