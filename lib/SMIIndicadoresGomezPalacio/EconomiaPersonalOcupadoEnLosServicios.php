...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasytippiin">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisekzthtvy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasytippiin a:first').tab('show')
});
// LENGUETA
$('#Lenguetasytippiin a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisekzthtvy === 'undefined') {
    varMorrisekzthtvy = Morris.Line({
      element: 'Morrisekzthtvy',
