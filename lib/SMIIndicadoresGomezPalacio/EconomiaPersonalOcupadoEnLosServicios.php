...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszazdlhsa">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishlmfveni" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbkdsswjx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszazdlhsa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszazdlhsa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishlmfveni === 'undefined') {
    varMorrishlmfveni = Morris.Line({
      element: 'Morrishlmfveni',
...
// LENGUETA
$('#Lenguetaszazdlhsa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbkdsswjx;
  ...
  function initmapbkdsswjx() {
    // Nuevo Mapa
    mapbkdsswjx = new L.Map('LeafLetbkdsswjx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbkdsswjx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbkdsswjx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbkdsswjx === 'undefined') {
    varinitmapbkdsswjx = initmapbkdsswjx();
  };
});
FINAL;
    } // constructor
