...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszwehhqht">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgyjopipf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszwehhqht a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszwehhqht a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgyjopipf === 'undefined') {
    varMorrisgyjopipf = Morris.Line({
      element: 'Morrisgyjopipf',
