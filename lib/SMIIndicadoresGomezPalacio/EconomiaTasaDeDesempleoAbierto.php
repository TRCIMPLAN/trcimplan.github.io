...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 6.2500 },{ region: 'Gómez Palacio', dato: 6.3551 },{ region: 'Lerdo', dato: 0.0000 },{ region: 'Matamoros', dato: 2.8169 },{ region: 'La Laguna', dato: 5.2529 },{ region: 'Coahuila', dato: 5.2641 },{ region: 'Durango', dato: 4.8742 },{ region: 'Nacional', dato: 4.5981 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
