...
class SociedadRezagoAlimentario extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Grupos Vulnerables, Bienestar, Sector Automotriz';
        // Para el Organizador
        $this->categorias  = array('Grupos Vulnerables', 'Bienestar', 'Sector Automotriz');
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '18.1100', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
