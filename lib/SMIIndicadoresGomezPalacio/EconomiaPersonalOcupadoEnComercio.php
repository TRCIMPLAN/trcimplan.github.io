<?php
/**
 * EconomiaPersonalOcupadoEnComercio.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaPersonalOcupadoEnComercio
 */
class EconomiaPersonalOcupadoEnComercio extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiapersonal-ocupado-en-comercio';
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Personal Ocupado en el Comercio en Gómez Palacio</h3>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Personal Ocupado en el Comercio</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
