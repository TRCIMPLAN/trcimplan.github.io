...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastomeomzc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaojhdmcj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastomeomzc a:first').tab('show')
});
// LENGUETA
$('#Lenguetastomeomzc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaojhdmcj;
  ...
  function initmapaojhdmcj() {
    // Nuevo Mapa
    mapaojhdmcj = new L.Map('LeafLetaojhdmcj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaojhdmcj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaojhdmcj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaojhdmcj === 'undefined') {
    varinitmapaojhdmcj = initmapaojhdmcj();
  };
});
FINAL;
    } // constructor
