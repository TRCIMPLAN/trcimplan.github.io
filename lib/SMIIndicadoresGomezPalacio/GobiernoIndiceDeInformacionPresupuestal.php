...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 35.4839 },{ fecha: '2009-12-31', dato: 35.4839 },{ fecha: '2010-12-31', dato: 20.0000 },{ fecha: '2011-12-31', dato: 32.2581 },{ fecha: '2012-12-31', dato: 23.5294 },{ fecha: '2013-12-31', dato: 35.0000 },{ fecha: '2014-12-31', dato: 29.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
