...
FINAL;
  ...
  if (typeof vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos === 'undefined') {
    vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos = Morris.Line({
      ...
      data: [{ fecha: '2015-03-31', dato: 5319.43 },{ fecha: '2015-06-30', dato: 5252.37 },{ fecha: '2015-09-30', dato: 5627.16 },{ fecha: '2015-12-31', dato: 5479.11 },{ fecha: '2016-03-31', dato: 5148.37 },{ fecha: '2016-06-30', dato: 5893.86 },{ fecha: '2016-09-30', dato: 5698.27 },{ fecha: '2016-12-31', dato: 5966.48 },{ fecha: '2017-03-31', dato: 6254.41 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
