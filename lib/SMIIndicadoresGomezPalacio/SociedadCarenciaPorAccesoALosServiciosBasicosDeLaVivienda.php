<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda
 *
...
class SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a los servicios básicos de la vivienda en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
