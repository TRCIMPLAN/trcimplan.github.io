<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Centros de Investigación (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaCentrosDeInvestigacion extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      ...
      <p><b>Unidad:</b> Centros de investigación por cada 100 mil de PEA.</p>
    </div>
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Centros de Investigación en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Centros de Investigación</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Centros de Investigación</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
