<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Uso de Servicios Financieros (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadUsoDeServiciosFinancieros extends \Base\Publicacion {
...
<p>Unidades: Tarjetas por adulto. Fuente: Comisión Nacional Bancaria y de Valores (CNBV), 2010-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Uso de Servicios Financieros en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Uso de Servicios Financieros</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Uso de Servicios Financieros</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.9801 },{ fecha: '2009-12-31', dato: 0.9607 },{ fecha: '2010-12-31', dato: 0.9417 },{ fecha: '2011-12-31', dato: 1.1847 },{ fecha: '2012-12-31', dato: 1.3857 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 1.8228 },{ region: 'Gómez Palacio', dato: 1.3857 },{ region: 'Lerdo', dato: 0.3919 },{ region: 'Matamoros', dato: 0.6439 },{ region: 'La Laguna', dato: 1.4435 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
