...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasezqhiigq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfkmpkdlq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasezqhiigq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasezqhiigq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfkmpkdlq === 'undefined') {
    varMorrisfkmpkdlq = Morris.Line({
      element: 'Morrisfkmpkdlq',
