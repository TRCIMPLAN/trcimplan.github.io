...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspzslfypp">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnbyxzjcf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpmheexta" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspzslfypp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspzslfypp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnbyxzjcf === 'undefined') {
    varMorrisnbyxzjcf = Morris.Line({
      element: 'Morrisnbyxzjcf',
...
// LENGUETA
$('#Lenguetaspzslfypp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappmheexta;
  ...
  function initmappmheexta() {
    // Nuevo Mapa
    mappmheexta = new L.Map('LeafLetpmheexta');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappmheexta.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappmheexta.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappmheexta === 'undefined') {
    varinitmappmheexta = initmappmheexta();
  };
});
FINAL;
    } // constructor
