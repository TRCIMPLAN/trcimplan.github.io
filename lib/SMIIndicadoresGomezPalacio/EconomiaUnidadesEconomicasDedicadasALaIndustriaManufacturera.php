...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyupjsqdc">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgchnzdjd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyupjsqdc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyupjsqdc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgchnzdjd === 'undefined') {
    varMorrisgchnzdjd = Morris.Line({
      element: 'Morrisgchnzdjd',
