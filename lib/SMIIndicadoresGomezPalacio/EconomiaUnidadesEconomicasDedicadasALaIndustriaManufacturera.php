...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassuirmpjq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyjosglgx" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassuirmpjq a:first').tab('show')
});
// LENGUETA
$('#Lenguetassuirmpjq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyjosglgx === 'undefined') {
    varMorrisyjosglgx = Morris.Line({
      element: 'Morrisyjosglgx',
