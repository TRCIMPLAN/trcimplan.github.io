...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskddumbws">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdisawopi" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaukezibs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskddumbws a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskddumbws a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdisawopi === 'undefined') {
    varMorrisdisawopi = Morris.Line({
      element: 'Morrisdisawopi',
...
// LENGUETA
$('#Lenguetaskddumbws a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaukezibs;
  ...
  function initmapaukezibs() {
    // Nuevo Mapa
    mapaukezibs = new L.Map('LeafLetaukezibs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaukezibs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaukezibs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaukezibs === 'undefined') {
    varinitmapaukezibs = initmapaukezibs();
  };
});
FINAL;
    } // constructor
