...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasntbklvnf">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispemdoizs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfytlrxxp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasntbklvnf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasntbklvnf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispemdoizs === 'undefined') {
    varMorrispemdoizs = Morris.Line({
      element: 'Morrispemdoizs',
...
// LENGUETA
$('#Lenguetasntbklvnf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfytlrxxp;
  ...
  function initmapfytlrxxp() {
    // Nuevo Mapa
    mapfytlrxxp = new L.Map('LeafLetfytlrxxp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfytlrxxp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfytlrxxp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfytlrxxp === 'undefined') {
    varinitmapfytlrxxp = initmapfytlrxxp();
  };
});
FINAL;
    } // constructor
