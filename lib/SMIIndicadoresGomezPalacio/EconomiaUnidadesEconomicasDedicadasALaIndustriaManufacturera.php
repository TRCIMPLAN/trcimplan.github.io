...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasziaswbdr">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszxnaufbv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasziaswbdr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasziaswbdr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszxnaufbv === 'undefined') {
    varMorriszxnaufbv = Morris.Line({
      element: 'Morriszxnaufbv',
