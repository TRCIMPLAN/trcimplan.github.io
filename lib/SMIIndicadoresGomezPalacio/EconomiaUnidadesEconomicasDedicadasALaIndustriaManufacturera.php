...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasogqaqkgn">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispbynlllh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqqerdjnr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasogqaqkgn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasogqaqkgn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispbynlllh === 'undefined') {
    varMorrispbynlllh = Morris.Line({
      element: 'Morrispbynlllh',
...
// LENGUETA
$('#Lenguetasogqaqkgn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqqerdjnr;
  ...
  function initmapqqerdjnr() {
    // Nuevo Mapa
    mapqqerdjnr = new L.Map('LeafLetqqerdjnr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqqerdjnr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqqerdjnr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqqerdjnr === 'undefined') {
    varinitmapqqerdjnr = initmapqqerdjnr();
  };
});
FINAL;
    } // constructor
