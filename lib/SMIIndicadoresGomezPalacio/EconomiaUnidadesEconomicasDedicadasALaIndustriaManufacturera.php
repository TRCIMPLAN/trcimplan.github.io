...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslcujyumv">
...
<div id="Morrissnjuwaov" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcewqfers" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslcujyumv a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslcujyumv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissnjuwaov === 'undefined') {
    varMorrissnjuwaov = Morris.Line({
      element: 'Morrissnjuwaov',
...
// LENGUETA
$('#Lenguetaslcujyumv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcewqfers;
  ...
  function initmapcewqfers() {
    // Nuevo Mapa
    mapcewqfers = new L.Map('LeafLetcewqfers');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcewqfers.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcewqfers.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcewqfers === 'undefined') {
    varinitmapcewqfers = initmapcewqfers();
  };
});
FINAL;
    } // constructor
