<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Usuarios de Transporte Colectivo Privado (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadUsuariosDeTransporteColectivoPrivado extends \Base\Publicacion {
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Se considera como usuarios a la población de 12 a 65 años de edad que realizan traslados con motivo de estudios o trabajo. El Transporte Colectivo Privado puede ser proporcionado por una empresa o alguna institución académica.</p>
