<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Consumo de Diesel en Transporte de Bienes (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadConsumoDeDieselEnTransporteDeBienes extends \Base\Publicacion {
