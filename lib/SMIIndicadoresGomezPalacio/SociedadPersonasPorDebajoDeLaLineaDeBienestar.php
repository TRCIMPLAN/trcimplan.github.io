<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Personas por Debajo de la Línea de Bienestar (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadPersonasPorDebajoDeLaLineaDeBienestar extends \Base\Publicacion {
...
<p>Fuente: INEGI (ENOE), CONEVAL.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Personas por Debajo de la Línea de Bienestar en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Personas por Debajo de la Línea de Bienestar</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Personas por Debajo de la Línea de Bienestar</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.7500 },{ fecha: '2009-12-31', dato: 1.1600 },{ fecha: '2010-12-31', dato: 2.8900 },{ fecha: '2011-12-31', dato: 3.0900 },{ fecha: '2012-12-31', dato: 4.4900 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 3.3200 },{ region: 'Gómez Palacio', dato: 4.4900 },{ region: 'Lerdo', dato: 2.6800 },{ region: 'Matamoros', dato: 6.0700 },{ region: 'La Laguna', dato: 3.7800 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
