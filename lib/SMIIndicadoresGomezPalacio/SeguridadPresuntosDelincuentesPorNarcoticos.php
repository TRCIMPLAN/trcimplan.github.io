...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoutqbcol">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbmvmuccr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoutqbcol a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoutqbcol a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbmvmuccr;
  ...
  function initmapbmvmuccr() {
    // Nuevo Mapa
    mapbmvmuccr = new L.Map('LeafLetbmvmuccr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbmvmuccr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbmvmuccr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbmvmuccr === 'undefined') {
    varinitmapbmvmuccr = initmapbmvmuccr();
  };
});
FINAL;
    } // constructor
