...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrrneinth">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbwpnudbx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrrneinth a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrrneinth a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbwpnudbx;
  ...
  function initmapbwpnudbx() {
    // Nuevo Mapa
    mapbwpnudbx = new L.Map('LeafLetbwpnudbx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbwpnudbx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbwpnudbx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbwpnudbx === 'undefined') {
    varinitmapbwpnudbx = initmapbwpnudbx();
  };
});
FINAL;
    } // constructor
