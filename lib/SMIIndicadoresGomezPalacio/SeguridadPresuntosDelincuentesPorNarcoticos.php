...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascobhufaa">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfoizuase" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascobhufaa a:first').tab('show')
});
// LENGUETA
$('#Lenguetascobhufaa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfoizuase;
  ...
  function initmapfoizuase() {
    // Nuevo Mapa
    mapfoizuase = new L.Map('LeafLetfoizuase');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfoizuase.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfoizuase.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfoizuase === 'undefined') {
    varinitmapfoizuase = initmapfoizuase();
  };
});
FINAL;
    } // constructor
