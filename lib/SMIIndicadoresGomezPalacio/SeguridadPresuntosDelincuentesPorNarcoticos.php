...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashsrmvywy">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethgrmluwe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashsrmvywy a:first').tab('show')
});
// LENGUETA
$('#Lenguetashsrmvywy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphgrmluwe;
  ...
  function initmaphgrmluwe() {
    // Nuevo Mapa
    maphgrmluwe = new L.Map('LeafLethgrmluwe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphgrmluwe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphgrmluwe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphgrmluwe === 'undefined') {
    varinitmaphgrmluwe = initmaphgrmluwe();
  };
});
FINAL;
    } // constructor
