...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspqusseta">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetukdmrxwf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspqusseta a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspqusseta a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapukdmrxwf;
  ...
  function initmapukdmrxwf() {
    // Nuevo Mapa
    mapukdmrxwf = new L.Map('LeafLetukdmrxwf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapukdmrxwf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapukdmrxwf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapukdmrxwf === 'undefined') {
    varinitmapukdmrxwf = initmapukdmrxwf();
  };
});
FINAL;
    } // constructor
