<?php
/**
 * SociedadDiferencialGradoPromedioEscolaridadPorGenero.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadDiferencialGradoPromedioEscolaridadPorGenero
 */
class SociedadDiferencialGradoPromedioEscolaridadPorGenero extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sociedaddiferencial-grado-promedio-escolaridad-por-genero';
        $this->descripcion  = 'Grado promedio de escolaridad (GPE) de las mujeres menos GPE de hombres.';
        $this->claves       = 'Gómez Palacio, Género, Educación, Objetivos del Milenio';
