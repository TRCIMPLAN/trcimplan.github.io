<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPoblacionConEducacionSuperior
 *
...
class SociedadPoblacionConEducacionSuperior extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con educación superior en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '23.5000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
