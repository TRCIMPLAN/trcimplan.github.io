<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio EconomiaPosgradosDeCalidad
 *
...
class EconomiaPosgradosDeCalidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Educación, Innovación';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '19', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
