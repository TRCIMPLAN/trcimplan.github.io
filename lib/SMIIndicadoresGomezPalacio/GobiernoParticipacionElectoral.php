...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasstrffejb">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmzufxedz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasstrffejb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasstrffejb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmzufxedz;
  ...
  function initmapmzufxedz() {
    // Nuevo Mapa
    mapmzufxedz = new L.Map('LeafLetmzufxedz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmzufxedz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmzufxedz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmzufxedz === 'undefined') {
    varinitmapmzufxedz = initmapmzufxedz();
  };
});
FINAL;
    } // constructor
