...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfiuffkdc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnvmmhqoe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfiuffkdc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfiuffkdc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnvmmhqoe;
  ...
  function initmapnvmmhqoe() {
    // Nuevo Mapa
    mapnvmmhqoe = new L.Map('LeafLetnvmmhqoe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnvmmhqoe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnvmmhqoe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnvmmhqoe === 'undefined') {
    varinitmapnvmmhqoe = initmapnvmmhqoe();
  };
});
FINAL;
    } // constructor
