...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastrflzmqg">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzjrhihqm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastrflzmqg a:first').tab('show')
});
// LENGUETA
$('#Lenguetastrflzmqg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzjrhihqm;
  ...
  function initmapzjrhihqm() {
    // Nuevo Mapa
    mapzjrhihqm = new L.Map('LeafLetzjrhihqm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzjrhihqm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzjrhihqm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzjrhihqm === 'undefined') {
    varinitmapzjrhihqm = initmapzjrhihqm();
  };
});
FINAL;
    } // constructor
