...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnodjivdo">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetroyuisvo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnodjivdo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnodjivdo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maproyuisvo;
  ...
  function initmaproyuisvo() {
    // Nuevo Mapa
    maproyuisvo = new L.Map('LeafLetroyuisvo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maproyuisvo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maproyuisvo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaproyuisvo === 'undefined') {
    varinitmaproyuisvo = initmaproyuisvo();
  };
});
FINAL;
    } // constructor
