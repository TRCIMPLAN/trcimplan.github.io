...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashmkiyhfe">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvorbjnmb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashmkiyhfe a:first').tab('show')
});
// LENGUETA
$('#Lenguetashmkiyhfe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvorbjnmb;
  ...
  function initmapvorbjnmb() {
    // Nuevo Mapa
    mapvorbjnmb = new L.Map('LeafLetvorbjnmb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvorbjnmb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvorbjnmb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvorbjnmb === 'undefined') {
    varinitmapvorbjnmb = initmapvorbjnmb();
  };
});
FINAL;
    } // constructor
