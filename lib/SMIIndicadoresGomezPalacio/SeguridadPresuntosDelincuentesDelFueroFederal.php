...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdztigpul">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetafefcwuf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdztigpul a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdztigpul a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapafefcwuf;
  ...
  function initmapafefcwuf() {
    // Nuevo Mapa
    mapafefcwuf = new L.Map('LeafLetafefcwuf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapafefcwuf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapafefcwuf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapafefcwuf === 'undefined') {
    varinitmapafefcwuf = initmapafefcwuf();
  };
});
FINAL;
    } // constructor
