...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvddywaug">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteyltcsnc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvddywaug a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvddywaug a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeyltcsnc;
  ...
  function initmapeyltcsnc() {
    // Nuevo Mapa
    mapeyltcsnc = new L.Map('LeafLeteyltcsnc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeyltcsnc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeyltcsnc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeyltcsnc === 'undefined') {
    varinitmapeyltcsnc = initmapeyltcsnc();
  };
});
FINAL;
    } // constructor
