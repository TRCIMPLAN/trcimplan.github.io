...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswlauxwkz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvkxzqpoy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswlauxwkz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswlauxwkz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvkxzqpoy;
  ...
  function initmapvkxzqpoy() {
    // Nuevo Mapa
    mapvkxzqpoy = new L.Map('LeafLetvkxzqpoy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvkxzqpoy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvkxzqpoy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvkxzqpoy === 'undefined') {
    varinitmapvkxzqpoy = initmapvkxzqpoy();
  };
});
FINAL;
    } // constructor
