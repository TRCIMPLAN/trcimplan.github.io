...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassxcoyxrv">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvwimpfjk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassxcoyxrv a:first').tab('show')
});
// LENGUETA
$('#Lenguetassxcoyxrv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvwimpfjk;
  ...
  function initmapvwimpfjk() {
    // Nuevo Mapa
    mapvwimpfjk = new L.Map('LeafLetvwimpfjk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvwimpfjk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvwimpfjk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvwimpfjk === 'undefined') {
    varinitmapvwimpfjk = initmapvwimpfjk();
  };
});
FINAL;
    } // constructor
