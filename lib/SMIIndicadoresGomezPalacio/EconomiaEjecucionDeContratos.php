<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Ejecución de Contratos (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Doing Business en México, 2007, 2009, 2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Ejecución de Contratos en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 305 },{ fecha: '2009-12-31', dato: 259 },{ fecha: '2010-12-31', dato: 259 },{ fecha: '2011-12-31', dato: 243 },{ fecha: '2012-12-31', dato: 243 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
