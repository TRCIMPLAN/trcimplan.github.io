<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Registro de Una Propiedad (Creado por Central:SmiLanzadera)
 *
...
class EconomiaRegistroDeUnaPropiedad extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Registro de Una Propiedad en Gómez Palacio';
     // $this->autor             = '';
        ...
        $this->claves            = 'IMPLAN, Gómez Palacio, Índice de Competitividad Urbana, Doing Business';
...
<p>Incluido en el Mide el promedio de los percentiles en que se ubica la ciudad en cada uno de los factores que determinan la facilidad para registrar una propiedad: número de trámites, tiempo (días) y costo (% valor de la propiedad). Este indicador se calcula a nivel estatal.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Registro de Una Propiedad en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Registro de Una Propiedad</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Registro de Una Propiedad</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
