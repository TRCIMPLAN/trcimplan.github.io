<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Red Carretera Avanzada (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadRedCarreteraAvanzada extends \Base\Publicacion {
