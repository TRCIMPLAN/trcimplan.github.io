<?php
/**
 * EconomiaUnidadesEconomicasDedicadasServicios.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaUnidadesEconomicasDedicadasServicios
 */
class EconomiaUnidadesEconomicasDedicadasServicios extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaunidades-economicas-dedicadas-servicios';
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Unidades Económicas Dedicadas a los Servicios en Gómez Palacio</h3>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Unidades Económicas Dedicadas a los Servicios</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
