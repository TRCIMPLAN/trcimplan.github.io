...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxfpxwdrz">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrcsvdzwh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetskonulqy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxfpxwdrz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxfpxwdrz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrcsvdzwh === 'undefined') {
    varMorrisrcsvdzwh = Morris.Line({
      element: 'Morrisrcsvdzwh',
...
// LENGUETA
$('#Lenguetasxfpxwdrz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapskonulqy;
  ...
  function initmapskonulqy() {
    // Nuevo Mapa
    mapskonulqy = new L.Map('LeafLetskonulqy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapskonulqy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapskonulqy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapskonulqy === 'undefined') {
    varinitmapskonulqy = initmapskonulqy();
  };
});
FINAL;
    } // constructor
