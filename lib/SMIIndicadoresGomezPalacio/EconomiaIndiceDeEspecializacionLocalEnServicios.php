...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastjnajeon">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswnllwjjr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrzrhoyha" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastjnajeon a:first').tab('show')
});
// LENGUETA
$('#Lenguetastjnajeon a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswnllwjjr === 'undefined') {
    varMorriswnllwjjr = Morris.Line({
      element: 'Morriswnllwjjr',
...
// LENGUETA
$('#Lenguetastjnajeon a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprzrhoyha;
  ...
  function initmaprzrhoyha() {
    // Nuevo Mapa
    maprzrhoyha = new L.Map('LeafLetrzrhoyha');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprzrhoyha.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprzrhoyha.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprzrhoyha === 'undefined') {
    varinitmaprzrhoyha = initmaprzrhoyha();
  };
});
FINAL;
    } // constructor
