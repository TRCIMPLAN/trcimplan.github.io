...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqidnyyry">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyfprzpge" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlznjsohx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqidnyyry a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqidnyyry a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyfprzpge === 'undefined') {
    varMorrisyfprzpge = Morris.Line({
      element: 'Morrisyfprzpge',
...
// LENGUETA
$('#Lenguetasqidnyyry a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplznjsohx;
  ...
  function initmaplznjsohx() {
    // Nuevo Mapa
    maplznjsohx = new L.Map('LeafLetlznjsohx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplznjsohx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplznjsohx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplznjsohx === 'undefined') {
    varinitmaplznjsohx = initmaplznjsohx();
  };
});
FINAL;
    } // constructor
