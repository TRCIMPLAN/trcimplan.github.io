...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdjoptwgm">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishptqlvxc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetckeoeyme" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdjoptwgm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdjoptwgm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishptqlvxc === 'undefined') {
    varMorrishptqlvxc = Morris.Line({
      element: 'Morrishptqlvxc',
...
// LENGUETA
$('#Lenguetasdjoptwgm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapckeoeyme;
  ...
  function initmapckeoeyme() {
    // Nuevo Mapa
    mapckeoeyme = new L.Map('LeafLetckeoeyme');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapckeoeyme.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapckeoeyme.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapckeoeyme === 'undefined') {
    varinitmapckeoeyme = initmapckeoeyme();
  };
});
FINAL;
    } // constructor
