...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaqkvchwj">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxnbwoamf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaqkvchwj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaqkvchwj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxnbwoamf;
  ...
  function initmapxnbwoamf() {
    // Nuevo Mapa
    mapxnbwoamf = new L.Map('LeafLetxnbwoamf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxnbwoamf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxnbwoamf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxnbwoamf === 'undefined') {
    varinitmapxnbwoamf = initmapxnbwoamf();
  };
});
FINAL;
    } // constructor
