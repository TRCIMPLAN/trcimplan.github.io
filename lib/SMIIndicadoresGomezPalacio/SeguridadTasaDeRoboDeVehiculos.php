...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasraufctty">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrwvhsfrw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasraufctty a:first').tab('show')
});
// LENGUETA
$('#Lenguetasraufctty a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprwvhsfrw;
  ...
  function initmaprwvhsfrw() {
    // Nuevo Mapa
    maprwvhsfrw = new L.Map('LeafLetrwvhsfrw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprwvhsfrw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprwvhsfrw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprwvhsfrw === 'undefined') {
    varinitmaprwvhsfrw = initmaprwvhsfrw();
  };
});
FINAL;
    } // constructor
