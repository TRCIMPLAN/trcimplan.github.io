...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasylnzqkek">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrfhwqzno" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasylnzqkek a:first').tab('show')
});
// LENGUETA
$('#Lenguetasylnzqkek a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprfhwqzno;
  ...
  function initmaprfhwqzno() {
    // Nuevo Mapa
    maprfhwqzno = new L.Map('LeafLetrfhwqzno');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprfhwqzno.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprfhwqzno.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprfhwqzno === 'undefined') {
    varinitmaprfhwqzno = initmaprfhwqzno();
  };
});
FINAL;
    } // constructor
