...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmsnqmdzt">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetynrqzgoj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmsnqmdzt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmsnqmdzt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapynrqzgoj;
  ...
  function initmapynrqzgoj() {
    // Nuevo Mapa
    mapynrqzgoj = new L.Map('LeafLetynrqzgoj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapynrqzgoj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapynrqzgoj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapynrqzgoj === 'undefined') {
    varinitmapynrqzgoj = initmapynrqzgoj();
  };
});
FINAL;
    } // constructor
