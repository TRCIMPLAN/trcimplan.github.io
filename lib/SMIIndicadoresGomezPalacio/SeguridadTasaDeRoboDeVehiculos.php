...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasonudlbmx">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxzcsoiqy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasonudlbmx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasonudlbmx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxzcsoiqy;
  ...
  function initmapxzcsoiqy() {
    // Nuevo Mapa
    mapxzcsoiqy = new L.Map('LeafLetxzcsoiqy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxzcsoiqy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxzcsoiqy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxzcsoiqy === 'undefined') {
    varinitmapxzcsoiqy = initmapxzcsoiqy();
  };
});
FINAL;
    } // constructor
