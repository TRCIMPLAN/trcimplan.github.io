...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjqwmjzhw">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwcisvrmj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjqwmjzhw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjqwmjzhw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwcisvrmj;
  ...
  function initmapwcisvrmj() {
    // Nuevo Mapa
    mapwcisvrmj = new L.Map('LeafLetwcisvrmj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwcisvrmj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwcisvrmj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwcisvrmj === 'undefined') {
    varinitmapwcisvrmj = initmapwcisvrmj();
  };
});
FINAL;
    } // constructor
