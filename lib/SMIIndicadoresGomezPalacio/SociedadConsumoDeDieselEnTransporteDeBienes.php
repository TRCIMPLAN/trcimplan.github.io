<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Consumo de Diesel en Transporte de Bienes (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadConsumoDeDieselEnTransporteDeBienes extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->archivo           = 'sociedad-consumo-de-diesel-en-transporte-de-bienes';
        $this->imagen            = '../smi/introduccion/imagen.jpg';
        $this->imagen_previa     = '../smi/introduccion/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales. Las categorías son de uso interno
        $this->descripcion       = 'Incluido en el subíndice "Precursores".
Qué mide: El consumo de diesel en metros cúbicos por cada 10 mil habitantes por kilómetro
de carretera. Este indicador intenta medir la eficiencia en la distribución de bienes dentro de
la ciudad por medio del consumo de diesel. Mientras más poblada y más densa sea la ciudad,
el costo unitario de distribución de bienes debe de ser menor debido a las economías de
densidad. Un menor consumo de diesel, por kilómetro recorrido y habitante abastecido, es
más eficiente que un consumo mayor ya que nos indica que para dicha ciudad, se necesita
menos combustible para mover los bienes de un lugar a otro. Esto último provoca beneficios
tanto económicos (el costo por unidad transportada es menor) como ambientales.
Unidades: Metros cúbicos de diesel por cada 10 mil habitantes por kilómetro de carretera.
Fuente: PEMEX, INEGI, 2008-2012.';
...
tanto económicos (el costo por unidad transportada es menor) como ambientales.
Unidades: Metros cúbicos de diesel por cada 10 mil habitantes por kilómetro de carretera.
Fuente: PEMEX, INEGI, 2008-2012.</p>
      ...
      <p><b>Unidad:</b> Metros cúbicos de Diesel/10 mil habinates/Kilómetros de red carretera.</p>
    </div>
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Consumo de Diesel en Transporte de Bienes en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Consumo de Diesel en Transporte de Bienes</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Consumo de Diesel en Transporte de Bienes</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.8010 },{ fecha: '2009-12-31', dato: 2.6615 },{ fecha: '2010-12-31', dato: 2.6574 },{ fecha: '2011-12-31', dato: 1.8862 },{ fecha: '2012-12-31', dato: 1.8470 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 1.8470 },{ region: 'Gómez Palacio', dato: 1.8470 },{ region: 'Lerdo', dato: 1.8470 },{ region: 'Matamoros', dato: 1.8470 },{ region: 'La Laguna', dato: 1.8470 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
