...
class SociedadViviendasConInternet extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslvcqbabn">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetljhdjspt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslvcqbabn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslvcqbabn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapljhdjspt;
  ...
  function initmapljhdjspt() {
    // Nuevo Mapa
    mapljhdjspt = new L.Map('LeafLetljhdjspt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapljhdjspt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapljhdjspt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapljhdjspt === 'undefined') {
    varinitmapljhdjspt = initmapljhdjspt();
  };
});
FINAL;
    } // constructor
