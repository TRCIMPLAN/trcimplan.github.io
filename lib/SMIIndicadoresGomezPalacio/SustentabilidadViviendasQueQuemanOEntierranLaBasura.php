<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SustentabilidadViviendasQueQuemanOEntierranLaBasura
 *
...
class SustentabilidadViviendasQueQuemanOEntierranLaBasura extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Viviendas que queman o entierran la basura en Gómez Palacio';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '11.9100', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
