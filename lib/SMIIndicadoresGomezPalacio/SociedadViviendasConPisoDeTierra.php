<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Viviendas con Piso de Tierra (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadViviendasConPisoDeTierra extends \Base\Publicacion {
...
Unidades: Por cada 100 viviendas habitadas.
Fuente: Estimaciones de IMCO a partir del MCS (CONEVAL).';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Mide el número de viviendas con piso de tierra.
Unidades: Por cada 100 viviendas habitadas.
Fuente: Estimaciones de IMCO a partir del MCS (CONEVAL).</p>
