<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Líneas de Autobús (Creado por Central:SmiLanzadera)
 *
...
/**
 * Clase SociedadLineasDeAutobus
 */
class SociedadLineasDeAutobus extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        $this->fecha             = '2015-07-14T16:10';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'sociedad-lineas-de-autobus';
        $this->imagen            = '../smi/introduccion/imagen.jpg';
        $this->imagen_previa     = '../smi/introduccion/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales. Las categorías son de uso interno
        $this->descripcion       = 'Incluido en el subíndice "Precursores".
Qué mide: El número de líneas de autobuses foráneos que conectan a la ciudad.
Unidades: Líneas de autobús.
Fuente: IMCO con información de la SCT y centrales camioneras, 2013.';
...
Qué mide: El número de líneas de autobuses foráneos que conectan a la ciudad.
Unidades: Líneas de autobús.
Fuente: IMCO con información de la SCT y centrales camioneras, 2013.</p>
