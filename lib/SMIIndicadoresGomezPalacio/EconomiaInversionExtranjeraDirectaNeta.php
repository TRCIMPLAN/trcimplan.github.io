<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Inversión Extranjera Directa (Neta) (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaInversionExtranjeraDirectaNeta extends \Base\Publicacion {
...
<p>Dólares per cápita (promedio móvil tres años).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Inversión Extranjera Directa (Neta) en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 531.77 },{ fecha: '2009-12-31', dato: 495.54 },{ fecha: '2010-12-31', dato: 647.97 },{ fecha: '2011-12-31', dato: 431.91 },{ fecha: '2012-12-31', dato: 609.79 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice de "Aprovechamiento de las Relaciones Internacionales". Mide el promedio móvil de tres años de la inversión extranjera directa neta que recibe cada ciudad. Este indicador se calcula a nivel municipal a partir de la cifra estatal, la cual se prorratea con el porcentaje que aporta cada municipio al PIB estatal.</p>
