...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszwtphxzy">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdguugiiy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnactsbxi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszwtphxzy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszwtphxzy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdguugiiy === 'undefined') {
    varMorrisdguugiiy = Morris.Line({
      element: 'Morrisdguugiiy',
...
// LENGUETA
$('#Lenguetaszwtphxzy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnactsbxi;
  ...
  function initmapnactsbxi() {
    // Nuevo Mapa
    mapnactsbxi = new L.Map('LeafLetnactsbxi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnactsbxi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnactsbxi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnactsbxi === 'undefined') {
    varinitmapnactsbxi = initmapnactsbxi();
  };
});
FINAL;
    } // constructor
