...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqnbyuesk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgmfgmimm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqnbyuesk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqnbyuesk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgmfgmimm === 'undefined') {
    varMorrisgmfgmimm = Morris.Line({
      element: 'Morrisgmfgmimm',
