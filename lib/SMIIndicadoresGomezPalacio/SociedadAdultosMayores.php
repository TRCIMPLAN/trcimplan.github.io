...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdijlgunh">
...
<div id="Morrisqoclfovp" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfrcorkks" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdijlgunh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdijlgunh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqoclfovp === 'undefined') {
    varMorrisqoclfovp = Morris.Line({
      element: 'Morrisqoclfovp',
...
// LENGUETA
$('#Lenguetasdijlgunh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfrcorkks;
  ...
  function initmapfrcorkks() {
    // Nuevo Mapa
    mapfrcorkks = new L.Map('LeafLetfrcorkks');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfrcorkks.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfrcorkks.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfrcorkks === 'undefined') {
    varinitmapfrcorkks = initmapfrcorkks();
  };
});
FINAL;
    } // constructor
