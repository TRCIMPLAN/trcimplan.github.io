...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasogjofhtq">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissddoafas" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuscvycon" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasogjofhtq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasogjofhtq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissddoafas === 'undefined') {
    varMorrissddoafas = Morris.Line({
      element: 'Morrissddoafas',
...
// LENGUETA
$('#Lenguetasogjofhtq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuscvycon;
  ...
  function initmapuscvycon() {
    // Nuevo Mapa
    mapuscvycon = new L.Map('LeafLetuscvycon');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuscvycon.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuscvycon.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuscvycon === 'undefined') {
    varinitmapuscvycon = initmapuscvycon();
  };
});
FINAL;
    } // constructor
