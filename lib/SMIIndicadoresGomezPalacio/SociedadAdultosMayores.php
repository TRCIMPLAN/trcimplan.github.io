...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashsymbbwd">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisinkahesr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashsymbbwd a:first').tab('show')
});
// LENGUETA
$('#Lenguetashsymbbwd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisinkahesr === 'undefined') {
    varMorrisinkahesr = Morris.Line({
      element: 'Morrisinkahesr',
