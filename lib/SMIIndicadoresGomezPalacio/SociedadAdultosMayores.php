<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Adultos Mayores (Creado por Central:SmiLanzadera)
 *
...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Adultos Mayores en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 47033 },{ region: 'Gómez Palacio', dato: 21075 },{ region: 'Lerdo', dato: 9807 },{ region: 'Matamoros', dato: 7718 },{ region: 'La Laguna', dato: 85633 },{ region: 'Coahuila', dato: 195028 },{ region: 'Durango', dato: 123424 },{ region: 'Nacional', dato: 8107885 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
