...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslxmwmtmz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrgtplpte" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdpsnqobs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslxmwmtmz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslxmwmtmz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrgtplpte === 'undefined') {
    varMorrisrgtplpte = Morris.Line({
      element: 'Morrisrgtplpte',
...
// LENGUETA
$('#Lenguetaslxmwmtmz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdpsnqobs;
  ...
  function initmapdpsnqobs() {
    // Nuevo Mapa
    mapdpsnqobs = new L.Map('LeafLetdpsnqobs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdpsnqobs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdpsnqobs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdpsnqobs === 'undefined') {
    varinitmapdpsnqobs = initmapdpsnqobs();
  };
});
FINAL;
    } // constructor
