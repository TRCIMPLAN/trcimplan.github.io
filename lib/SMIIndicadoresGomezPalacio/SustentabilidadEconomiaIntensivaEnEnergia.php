<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Economía Intensiva en Energía (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadEconomiaIntensivaEnEnergia extends \Base\Publicacion {
...
Fuente: Petróleos Mexicanos (PEMEX) y estimaciones de IMCO con información del INEGI, 2008-2012.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Se incluye en el subíndice "Manejo Sustentable del Medio Ambiente". Mide el volumen de combustibles que requiere una ciudad para generar un millón de pesos del PIB.
Fuente: Petróleos Mexicanos (PEMEX) y estimaciones de IMCO con información del INEGI, 2008-2012.</p>
      ...
      <p><b>Unidad:</b> Metros cúbicos de combustibes por cada millón de PIB.</p>
    </div>
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Economía Intensiva en Energía en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Economía Intensiva en Energía</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Economía Intensiva en Energía</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 5.1000 },{ fecha: '2009-12-31', dato: 4.9000 },{ fecha: '2010-12-31', dato: 4.8000 },{ fecha: '2011-12-31', dato: 4.6000 },{ fecha: '2012-12-31', dato: 4.5000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 2.6000 },{ region: 'Gómez Palacio', dato: 4.5000 },{ region: 'Lerdo', dato: 17.0000 },{ region: 'Matamoros', dato: 1.3000 },{ region: 'La Laguna', dato: 3.4000 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
