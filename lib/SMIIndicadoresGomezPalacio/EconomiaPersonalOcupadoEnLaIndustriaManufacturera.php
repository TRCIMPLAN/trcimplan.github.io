...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspzsmykrh">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismxxvqhsr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfanitqys" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspzsmykrh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspzsmykrh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismxxvqhsr === 'undefined') {
    varMorrismxxvqhsr = Morris.Line({
      element: 'Morrismxxvqhsr',
...
// LENGUETA
$('#Lenguetaspzsmykrh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfanitqys;
  ...
  function initmapfanitqys() {
    // Nuevo Mapa
    mapfanitqys = new L.Map('LeafLetfanitqys');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfanitqys.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfanitqys.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfanitqys === 'undefined') {
    varinitmapfanitqys = initmapfanitqys();
  };
});
FINAL;
    } // constructor
