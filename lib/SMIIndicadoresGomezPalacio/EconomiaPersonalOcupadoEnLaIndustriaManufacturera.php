...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasphuwsdbw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjudliqpn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasphuwsdbw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasphuwsdbw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjudliqpn === 'undefined') {
    varMorrisjudliqpn = Morris.Line({
      element: 'Morrisjudliqpn',
