...
class SociedadMortalidadPorVihSida extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Gómez Palacio, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '2.9000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
