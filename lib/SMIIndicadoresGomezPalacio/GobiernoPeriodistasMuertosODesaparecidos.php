<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Gobierno Periodistas Muertos o Desaparecidos (Creado por Central:SmiLanzadera)
 *
 ...
 */
class GobiernoPeriodistasMuertosODesaparecidos extends \Base\Publicacion {
...
<p>Unidades: Periodistas asesinados o desaparecidos. Fuente: Artículo 19, 2004-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Periodistas Muertos o Desaparecidos en Gómez Palacio</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0 },{ fecha: '2009-12-31', dato: 1 },{ fecha: '2010-12-31', dato: 1 },{ fecha: '2011-12-31', dato: 1 },{ fecha: '2012-12-31', dato: 1 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
