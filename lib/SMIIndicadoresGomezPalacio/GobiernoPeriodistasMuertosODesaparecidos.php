...
class GobiernoPeriodistasMuertosODesaparecidos extends \SMIBase\PublicacionWeb {
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2016-12-31', 'valor' => 'ND', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 12, crudo 6
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2016-12-31', 'valor' => '8', 'fuente_nombre' => 'IMCO'),
            array('region_nombre' => 'Gómez Palacio', 'fecha' => '2016-12-31', 'valor' => 'ND', 'fuente_nombre' => 'IMCO'),
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2016-12-31', 'valor' => '8', 'fuente_nombre' => 'IMCO'));
    } // otras_regiones
...
Unidades: Periodistas asesinados o desaparecidos. Fuente: Artículo 19, 2004-2012.
OBSERVACIONES_FINAL;
    } // observaciones
