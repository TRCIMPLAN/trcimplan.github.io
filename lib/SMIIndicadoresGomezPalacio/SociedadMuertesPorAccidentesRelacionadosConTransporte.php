<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Muertes por Accidentes Relacionados con Transporte (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadMuertesPorAccidentesRelacionadosConTransporte extends \Base\Publicacion {
