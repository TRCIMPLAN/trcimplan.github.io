...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgnchhrah">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscbxpjezw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgosewxml" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgnchhrah a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgnchhrah a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscbxpjezw === 'undefined') {
    varMorriscbxpjezw = Morris.Line({
      element: 'Morriscbxpjezw',
...
// LENGUETA
$('#Lenguetasgnchhrah a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgosewxml;
  ...
  function initmapgosewxml() {
    // Nuevo Mapa
    mapgosewxml = new L.Map('LeafLetgosewxml');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgosewxml.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgosewxml.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgosewxml === 'undefined') {
    varinitmapgosewxml = initmapgosewxml();
  };
});
FINAL;
    } // constructor
