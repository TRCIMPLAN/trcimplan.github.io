...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassdfmgtgw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnymqagak" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnpszmsjk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassdfmgtgw a:first').tab('show')
});
// LENGUETA
$('#Lenguetassdfmgtgw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnymqagak === 'undefined') {
    varMorrisnymqagak = Morris.Line({
      element: 'Morrisnymqagak',
...
// LENGUETA
$('#Lenguetassdfmgtgw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnpszmsjk;
  ...
  function initmapnpszmsjk() {
    // Nuevo Mapa
    mapnpszmsjk = new L.Map('LeafLetnpszmsjk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnpszmsjk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnpszmsjk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnpszmsjk === 'undefined') {
    varinitmapnpszmsjk = initmapnpszmsjk();
  };
});
FINAL;
    } // constructor
