...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszflwqaqi">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnhyckcxt" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetynzqzoek" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszflwqaqi a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszflwqaqi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnhyckcxt === 'undefined') {
    varMorrisnhyckcxt = Morris.Line({
      element: 'Morrisnhyckcxt',
...
// LENGUETA
$('#Lenguetaszflwqaqi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapynzqzoek;
  ...
  function initmapynzqzoek() {
    // Nuevo Mapa
    mapynzqzoek = new L.Map('LeafLetynzqzoek');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapynzqzoek.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapynzqzoek.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapynzqzoek === 'undefined') {
    varinitmapynzqzoek = initmapynzqzoek();
  };
});
FINAL;
    } // constructor
