...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxufhlegr">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislgoyzfyd" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpjgklkir" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxufhlegr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxufhlegr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislgoyzfyd === 'undefined') {
    varMorrislgoyzfyd = Morris.Line({
      element: 'Morrislgoyzfyd',
...
// LENGUETA
$('#Lenguetasxufhlegr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappjgklkir;
  ...
  function initmappjgklkir() {
    // Nuevo Mapa
    mappjgklkir = new L.Map('LeafLetpjgklkir');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappjgklkir.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappjgklkir.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappjgklkir === 'undefined') {
    varinitmappjgklkir = initmappjgklkir();
  };
});
FINAL;
    } // constructor
