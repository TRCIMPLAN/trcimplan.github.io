...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnkfzwpde">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgkfmmboi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnkfzwpde a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnkfzwpde a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgkfmmboi === 'undefined') {
    varMorrisgkfmmboi = Morris.Line({
      element: 'Morrisgkfmmboi',
