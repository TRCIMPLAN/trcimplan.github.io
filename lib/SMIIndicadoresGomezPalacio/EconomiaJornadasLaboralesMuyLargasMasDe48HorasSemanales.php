<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Economía Jornadas laborales muy largas (más de 48 horas semanales) (Creado por Central:SmiLanzadera)
 *
...
/**
 * Clase EconomiaJornadasLaboralesMuyLargasMasDe48HorasSemanales
 */
class EconomiaJornadasLaboralesMuyLargasMasDe48HorasSemanales extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Jornadas laborales muy largas (más de 48 horas semanales) en Gómez Palacio';
     // $this->autor             = '';
        $this->fecha             = '2015-07-14T14:33';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'economia-jornadas-laborales-muy-largas-mas-de-48-horas-semanales';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Mide los trabajadores que laboran más de 48 horas por semana, como un proxy de la baja productividad del trabajo. Existe evidencia que sustenta que entre más horas se trabajen, por encima de un umbral, la productividad decrece o al menos no aumenta. Sin embargo, los efectos psicológicos y sociales de jornadas muy largas son negativos.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Jornadas laborales muy largas (más de 48 horas semanales) en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Jornadas laborales muy largas (más de 48 horas semanales)</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Jornadas laborales muy largas (más de 48 horas semanales)</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 23.6000 },{ fecha: '2009-12-31', dato: 19.6100 },{ fecha: '2010-12-31', dato: 19.9300 },{ fecha: '2011-12-31', dato: 25.7900 },{ fecha: '2012-12-31', dato: 27.4500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
