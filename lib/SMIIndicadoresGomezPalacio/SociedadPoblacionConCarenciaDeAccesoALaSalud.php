<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadPoblacionConCarenciaDeAccesoALaSalud
 *
...
/**
 * Clase SociedadPoblacionConCarenciaDeAccesoALaSalud
 */
class SociedadPoblacionConCarenciaDeAccesoALaSalud extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con carencia de acceso a la salud en Gómez Palacio';
        $this->fecha       = '2018-02-06T11:57:26';
        // El nombre del archivo a crear
        $this->archivo     = 'sociedad-poblacion-con-carencia-de-acceso-a-la-salud';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '28.9000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '16.3000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
