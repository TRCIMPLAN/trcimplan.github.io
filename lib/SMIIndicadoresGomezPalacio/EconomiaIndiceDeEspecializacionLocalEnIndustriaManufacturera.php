...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashebkuwkb">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjmireizg" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkwvubvqi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashebkuwkb a:first').tab('show')
});
// LENGUETA
$('#Lenguetashebkuwkb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjmireizg === 'undefined') {
    varMorrisjmireizg = Morris.Line({
      element: 'Morrisjmireizg',
...
// LENGUETA
$('#Lenguetashebkuwkb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkwvubvqi;
  ...
  function initmapkwvubvqi() {
    // Nuevo Mapa
    mapkwvubvqi = new L.Map('LeafLetkwvubvqi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkwvubvqi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkwvubvqi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkwvubvqi === 'undefined') {
    varinitmapkwvubvqi = initmapkwvubvqi();
  };
});
FINAL;
    } // constructor
