...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastlaorjhw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskffezxim" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastlaorjhw a:first').tab('show')
});
// LENGUETA
$('#Lenguetastlaorjhw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskffezxim === 'undefined') {
    varMorriskffezxim = Morris.Line({
      element: 'Morriskffezxim',
