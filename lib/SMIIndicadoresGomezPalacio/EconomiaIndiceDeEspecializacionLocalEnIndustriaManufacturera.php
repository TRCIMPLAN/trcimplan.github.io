...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashkekqtfj">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswkvdeczs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetamjbsjlg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashkekqtfj a:first').tab('show')
});
// LENGUETA
$('#Lenguetashkekqtfj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswkvdeczs === 'undefined') {
    varMorriswkvdeczs = Morris.Line({
      element: 'Morriswkvdeczs',
...
// LENGUETA
$('#Lenguetashkekqtfj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapamjbsjlg;
  ...
  function initmapamjbsjlg() {
    // Nuevo Mapa
    mapamjbsjlg = new L.Map('LeafLetamjbsjlg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapamjbsjlg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapamjbsjlg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapamjbsjlg === 'undefined') {
    varinitmapamjbsjlg = initmapamjbsjlg();
  };
});
FINAL;
    } // constructor
