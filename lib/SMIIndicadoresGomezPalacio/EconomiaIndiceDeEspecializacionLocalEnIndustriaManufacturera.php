...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastmzqpqqo">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswclncbvq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjtttvrnu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastmzqpqqo a:first').tab('show')
});
// LENGUETA
$('#Lenguetastmzqpqqo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswclncbvq === 'undefined') {
    varMorriswclncbvq = Morris.Line({
      element: 'Morriswclncbvq',
...
// LENGUETA
$('#Lenguetastmzqpqqo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjtttvrnu;
  ...
  function initmapjtttvrnu() {
    // Nuevo Mapa
    mapjtttvrnu = new L.Map('LeafLetjtttvrnu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjtttvrnu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjtttvrnu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjtttvrnu === 'undefined') {
    varinitmapjtttvrnu = initmapjtttvrnu();
  };
});
FINAL;
    } // constructor
