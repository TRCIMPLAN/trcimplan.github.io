...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspjxvttrq">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetusnottof" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspjxvttrq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspjxvttrq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapusnottof;
  ...
  function initmapusnottof() {
    // Nuevo Mapa
    mapusnottof = new L.Map('LeafLetusnottof');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapusnottof.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapusnottof.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapusnottof === 'undefined') {
    varinitmapusnottof = initmapusnottof();
  };
});
FINAL;
    } // constructor
