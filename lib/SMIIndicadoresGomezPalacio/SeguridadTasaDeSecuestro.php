...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnrlymwqz">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmywfnkbf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnrlymwqz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnrlymwqz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmywfnkbf;
  ...
  function initmapmywfnkbf() {
    // Nuevo Mapa
    mapmywfnkbf = new L.Map('LeafLetmywfnkbf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmywfnkbf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmywfnkbf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmywfnkbf === 'undefined') {
    varinitmapmywfnkbf = initmapmywfnkbf();
  };
});
FINAL;
    } // constructor
