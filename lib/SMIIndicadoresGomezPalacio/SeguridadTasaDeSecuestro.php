...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasanlbnogj">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetasxqiylc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasanlbnogj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasanlbnogj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapasxqiylc;
  ...
  function initmapasxqiylc() {
    // Nuevo Mapa
    mapasxqiylc = new L.Map('LeafLetasxqiylc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapasxqiylc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapasxqiylc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapasxqiylc === 'undefined') {
    varinitmapasxqiylc = initmapasxqiylc();
  };
});
FINAL;
    } // constructor
