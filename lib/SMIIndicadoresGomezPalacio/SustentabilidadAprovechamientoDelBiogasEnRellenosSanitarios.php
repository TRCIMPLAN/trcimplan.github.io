<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sustentabilidad Aprovechamiento del Biogás en Rellenos Sanitarios (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadAprovechamientoDelBiogasEnRellenosSanitarios extends \Base\Publicacion {
...
<p>Fuente: Secretaría de Desarrollo Social (SEDESOL), 2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Aprovechamiento del Biogás en Rellenos Sanitarios en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Aprovechamiento del Biogás en Rellenos Sanitarios</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Aprovechamiento del Biogás en Rellenos Sanitarios</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
