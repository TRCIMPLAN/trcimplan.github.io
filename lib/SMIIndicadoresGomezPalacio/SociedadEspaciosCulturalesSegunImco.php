<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Sociedad Espacios Culturales (según IMCO) (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadEspaciosCulturalesSegunImco extends \Base\Publicacion {
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.0400 },{ fecha: '2009-12-31', dato: 0.0400 },{ fecha: '2010-12-31', dato: 0.0400 },{ fecha: '2011-12-31', dato: 0.0400 },{ fecha: '2012-12-31', dato: 0.1500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0.3600 },{ region: 'Gómez Palacio', dato: 0.1500 },{ region: 'Lerdo', dato: 0.2200 },{ region: 'Matamoros', dato: 0.1100 },{ region: 'La Laguna', dato: 0.2600 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana" Mide el número de espacios culturales relativo a la población. Se consideran espacios culturales museos, teatros, galerías, auditorios, bibliotecas, librerías y casas de artesanías.</p>
