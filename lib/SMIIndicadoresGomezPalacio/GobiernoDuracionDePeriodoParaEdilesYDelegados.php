<?php
/**
 * TrcIMPLAN - SMI Indicadores Gómez Palacio Gobierno Duración de período para ediles y delegados (Creado por Central:SmiLanzadera)
 *
 ...
 */
class GobiernoDuracionDePeriodoParaEdilesYDelegados extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->descripcion       = 'Forma parte de subíndice de "Sistema Político Estable y Funcional". Mide el número de años durante los cuales el gobierno municipal / delegacional ejerce el cargo. Se asume que entre más largos sean los periodos de gobierno, mayor será el aprendizaje de los funcionarios y el conocimiento acumulado, lo que podría derivar en políticas públicas más eficientes. Unidades: Años. Fuente: IMCO con información del Sistema Nacional de Información Municipal del Instituto Nacional para el Federalismo y el Desarrollo Municipal (INAFED), 2013.';
...
<p>Forma parte de subíndice de "Sistema Político Estable y Funcional". Mide el número de años durante los cuales el gobierno municipal / delegacional ejerce el cargo. Se asume que entre más largos sean los periodos de gobierno, mayor será el aprendizaje de los funcionarios y el conocimiento acumulado, lo que podría derivar en políticas públicas más eficientes. Unidades: Años. Fuente: IMCO con información del Sistema Nacional de Información Municipal del Instituto Nacional para el Federalismo y el Desarrollo Municipal (INAFED), 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Duración de período para ediles y delegados en Gómez Palacio</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-otras_regiones">
      <h3>Gráfica con los últimos datos de Duración de período para ediles y delegados</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Duración de período para ediles y delegados</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 3.0000 },{ fecha: '2009-12-31', dato: 3.0000 },{ fecha: '2010-12-31', dato: 3.0000 },{ fecha: '2011-12-31', dato: 3.0000 },{ fecha: '2012-12-31', dato: 3.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 4.0000 },{ region: 'Gómez Palacio', dato: 3.0000 },{ region: 'Lerdo', dato: 3.0000 },{ region: 'Matamoros', dato: 4.0000 },{ region: 'La Laguna', dato: 3.5000 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
