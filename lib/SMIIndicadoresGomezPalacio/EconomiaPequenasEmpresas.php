...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqryvaxj">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqkwksuye" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiropgsie" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqryvaxj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqryvaxj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqkwksuye === 'undefined') {
    varMorrisqkwksuye = Morris.Line({
      element: 'Morrisqkwksuye',
...
// LENGUETA
$('#Lenguetasbqryvaxj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiropgsie;
  ...
  function initmapiropgsie() {
    // Nuevo Mapa
    mapiropgsie = new L.Map('LeafLetiropgsie');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiropgsie.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiropgsie.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiropgsie === 'undefined') {
    varinitmapiropgsie = initmapiropgsie();
  };
});
FINAL;
    } // constructor
