...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrcmnirux">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuwsuwbek" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzaumiuop" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrcmnirux a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrcmnirux a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuwsuwbek === 'undefined') {
    varMorrisuwsuwbek = Morris.Line({
      element: 'Morrisuwsuwbek',
...
// LENGUETA
$('#Lenguetasrcmnirux a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzaumiuop;
  ...
  function initmapzaumiuop() {
    // Nuevo Mapa
    mapzaumiuop = new L.Map('LeafLetzaumiuop');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzaumiuop.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzaumiuop.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzaumiuop === 'undefined') {
    varinitmapzaumiuop = initmapzaumiuop();
  };
});
FINAL;
    } // constructor
