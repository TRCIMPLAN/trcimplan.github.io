...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasohnjvemi">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnfelivia" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlercxzsf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasohnjvemi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasohnjvemi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnfelivia === 'undefined') {
    varMorrisnfelivia = Morris.Line({
      element: 'Morrisnfelivia',
...
// LENGUETA
$('#Lenguetasohnjvemi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplercxzsf;
  ...
  function initmaplercxzsf() {
    // Nuevo Mapa
    maplercxzsf = new L.Map('LeafLetlercxzsf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplercxzsf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplercxzsf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplercxzsf === 'undefined') {
    varinitmaplercxzsf = initmaplercxzsf();
  };
});
FINAL;
    } // constructor
