<?php
/**
 * SeguridadTasaRoboVehiculoConViolencia.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SeguridadTasaRoboVehiculoConViolencia
 */
class SeguridadTasaRoboVehiculoConViolencia extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'seguridadtasa-robo-vehiculo-con-violencia';
        $this->descripcion  = '';
...
<p>Fuente: <a href="http://secretariadoejecutivo.gob.mx/incidencia-delictiva/incidencia-delictiva-fuero-comun.php">Secretariado Ejecutivo del Sistema Nacional de Seguridad</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Tasa de Robo de Vehículo con Violencia</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 0 },{ region: 'Gómez Palacio', dato: 0 },{ region: 'Lerdo', dato: 0 },{ region: 'Matamoros', dato: 0 },{ region: 'La Laguna', dato: 0 },{ region: 'Coahuila', dato: 1.8900 },{ region: 'Durango', dato: 4.5900 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
