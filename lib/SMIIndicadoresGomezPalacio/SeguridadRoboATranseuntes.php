...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslezfhade">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishbxyjbqa" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetueqtlajk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslezfhade a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslezfhade a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishbxyjbqa === 'undefined') {
    varMorrishbxyjbqa = Morris.Line({
      element: 'Morrishbxyjbqa',
      data: [{ fecha: '2014-01-31', dato: 29 },{ fecha: '2014-02-28', dato: 37 },{ fecha: '2014-03-31', dato: 66 },{ fecha: '2014-04-30', dato: 34 },{ fecha: '2014-05-31', dato: 33 },{ fecha: '2014-06-30', dato: 25 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetaslezfhade a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapueqtlajk;
  ...
  function initmapueqtlajk() {
    // Nuevo Mapa
    mapueqtlajk = new L.Map('LeafLetueqtlajk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapueqtlajk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapueqtlajk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapueqtlajk === 'undefined') {
    varinitmapueqtlajk = initmapueqtlajk();
  };
});
FINAL;
    } // constructor
