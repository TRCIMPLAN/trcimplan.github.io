...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxibvtbqn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfbfrwpsy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxibvtbqn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxibvtbqn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfbfrwpsy === 'undefined') {
    varMorrisfbfrwpsy = Morris.Line({
      element: 'Morrisfbfrwpsy',
