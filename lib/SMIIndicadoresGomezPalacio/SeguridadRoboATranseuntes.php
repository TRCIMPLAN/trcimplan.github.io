...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastslgpcyg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswugbtmwk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastslgpcyg a:first').tab('show')
});
// LENGUETA
$('#Lenguetastslgpcyg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswugbtmwk === 'undefined') {
    varMorriswugbtmwk = Morris.Line({
      element: 'Morriswugbtmwk',
