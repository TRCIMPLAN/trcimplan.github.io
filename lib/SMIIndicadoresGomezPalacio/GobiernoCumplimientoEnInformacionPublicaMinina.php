...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseqosjdha">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmjbqlmwe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseqosjdha a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseqosjdha a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmjbqlmwe;
  ...
  function initmapmjbqlmwe() {
    // Nuevo Mapa
    mapmjbqlmwe = new L.Map('LeafLetmjbqlmwe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmjbqlmwe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmjbqlmwe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmjbqlmwe === 'undefined') {
    varinitmapmjbqlmwe = initmapmjbqlmwe();
  };
});
FINAL;
    } // constructor
