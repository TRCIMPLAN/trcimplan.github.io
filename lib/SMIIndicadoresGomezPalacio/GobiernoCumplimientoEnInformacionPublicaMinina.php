...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyisscvof">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiuugrijo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyisscvof a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyisscvof a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiuugrijo;
  ...
  function initmapiuugrijo() {
    // Nuevo Mapa
    mapiuugrijo = new L.Map('LeafLetiuugrijo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiuugrijo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiuugrijo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiuugrijo === 'undefined') {
    varinitmapiuugrijo = initmapiuugrijo();
  };
});
FINAL;
    } // constructor
