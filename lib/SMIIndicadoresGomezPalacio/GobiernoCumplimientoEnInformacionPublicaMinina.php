...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxnoqvmhb">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethipfphhn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxnoqvmhb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxnoqvmhb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphipfphhn;
  ...
  function initmaphipfphhn() {
    // Nuevo Mapa
    maphipfphhn = new L.Map('LeafLethipfphhn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphipfphhn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphipfphhn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphipfphhn === 'undefined') {
    varinitmaphipfphhn = initmaphipfphhn();
  };
});
FINAL;
    } // constructor
