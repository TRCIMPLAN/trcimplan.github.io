...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyifjuxpn">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdftheelx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyifjuxpn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyifjuxpn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdftheelx;
  ...
  function initmapdftheelx() {
    // Nuevo Mapa
    mapdftheelx = new L.Map('LeafLetdftheelx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdftheelx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdftheelx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdftheelx === 'undefined') {
    varinitmapdftheelx = initmapdftheelx();
  };
});
FINAL;
    } // constructor
