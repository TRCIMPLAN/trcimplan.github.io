...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswgiekvuj">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdmkoynxb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswgiekvuj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswgiekvuj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdmkoynxb;
  ...
  function initmapdmkoynxb() {
    // Nuevo Mapa
    mapdmkoynxb = new L.Map('LeafLetdmkoynxb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdmkoynxb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdmkoynxb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdmkoynxb === 'undefined') {
    varinitmapdmkoynxb = initmapdmkoynxb();
  };
});
FINAL;
    } // constructor
