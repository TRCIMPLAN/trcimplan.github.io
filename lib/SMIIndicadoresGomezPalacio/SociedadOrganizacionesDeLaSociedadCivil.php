...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszbolqrlx">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvingkymn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszbolqrlx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszbolqrlx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvingkymn;
  ...
  function initmapvingkymn() {
    // Nuevo Mapa
    mapvingkymn = new L.Map('LeafLetvingkymn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvingkymn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvingkymn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvingkymn === 'undefined') {
    varinitmapvingkymn = initmapvingkymn();
  };
});
FINAL;
    } // constructor
