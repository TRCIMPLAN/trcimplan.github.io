...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnxmttigv">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetburmwbye" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnxmttigv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnxmttigv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapburmwbye;
  ...
  function initmapburmwbye() {
    // Nuevo Mapa
    mapburmwbye = new L.Map('LeafLetburmwbye');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapburmwbye.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapburmwbye.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapburmwbye === 'undefined') {
    varinitmapburmwbye = initmapburmwbye();
  };
});
FINAL;
    } // constructor
