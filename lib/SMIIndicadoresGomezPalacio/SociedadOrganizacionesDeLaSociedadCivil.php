...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjmhghkwz">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvfotrnix" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjmhghkwz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjmhghkwz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvfotrnix;
  ...
  function initmapvfotrnix() {
    // Nuevo Mapa
    mapvfotrnix = new L.Map('LeafLetvfotrnix');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvfotrnix.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvfotrnix.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvfotrnix === 'undefined') {
    varinitmapvfotrnix = initmapvfotrnix();
  };
});
FINAL;
    } // constructor
