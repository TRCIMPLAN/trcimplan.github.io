...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasphouibgr">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjyinqtbz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasphouibgr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasphouibgr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjyinqtbz;
  ...
  function initmapjyinqtbz() {
    // Nuevo Mapa
    mapjyinqtbz = new L.Map('LeafLetjyinqtbz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjyinqtbz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjyinqtbz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjyinqtbz === 'undefined') {
    varinitmapjyinqtbz = initmapjyinqtbz();
  };
});
FINAL;
    } // constructor
