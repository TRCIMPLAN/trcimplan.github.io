...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswcwuanxo">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwyebagdi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswcwuanxo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswcwuanxo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwyebagdi;
  ...
  function initmapwyebagdi() {
    // Nuevo Mapa
    mapwyebagdi = new L.Map('LeafLetwyebagdi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwyebagdi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwyebagdi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwyebagdi === 'undefined') {
    varinitmapwyebagdi = initmapwyebagdi();
  };
});
FINAL;
    } // constructor
