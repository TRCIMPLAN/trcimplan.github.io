...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasetudkpcz">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteidtkdep" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasetudkpcz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasetudkpcz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeidtkdep;
  ...
  function initmapeidtkdep() {
    // Nuevo Mapa
    mapeidtkdep = new L.Map('LeafLeteidtkdep');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeidtkdep.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeidtkdep.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeidtkdep === 'undefined') {
    varinitmapeidtkdep = initmapeidtkdep();
  };
});
FINAL;
    } // constructor
