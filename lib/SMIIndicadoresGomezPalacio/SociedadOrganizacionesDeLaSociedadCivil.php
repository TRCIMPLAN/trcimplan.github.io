...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszldrcogg">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetopuheydb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszldrcogg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszldrcogg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapopuheydb;
  ...
  function initmapopuheydb() {
    // Nuevo Mapa
    mapopuheydb = new L.Map('LeafLetopuheydb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapopuheydb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapopuheydb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapopuheydb === 'undefined') {
    varinitmapopuheydb = initmapopuheydb();
  };
});
FINAL;
    } // constructor
