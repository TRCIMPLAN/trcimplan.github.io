...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoyxczbqk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrbjaknfu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoyxczbqk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoyxczbqk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrbjaknfu === 'undefined') {
    varMorrisrbjaknfu = Morris.Line({
      element: 'Morrisrbjaknfu',
