...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrbzazffk">
...
<div id="Morrismsddheiu" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzltkccnr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrbzazffk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrbzazffk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismsddheiu === 'undefined') {
    varMorrismsddheiu = Morris.Line({
      element: 'Morrismsddheiu',
...
// LENGUETA
$('#Lenguetasrbzazffk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzltkccnr;
  ...
  function initmapzltkccnr() {
    // Nuevo Mapa
    mapzltkccnr = new L.Map('LeafLetzltkccnr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzltkccnr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzltkccnr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzltkccnr === 'undefined') {
    varinitmapzltkccnr = initmapzltkccnr();
  };
});
FINAL;
    } // constructor
