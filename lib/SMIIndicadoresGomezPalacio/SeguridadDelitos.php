...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasimkkobis">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisarvsdlsw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasimkkobis a:first').tab('show')
});
// LENGUETA
$('#Lenguetasimkkobis a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisarvsdlsw === 'undefined') {
    varMorrisarvsdlsw = Morris.Line({
      element: 'Morrisarvsdlsw',
