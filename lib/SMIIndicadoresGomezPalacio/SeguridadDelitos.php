...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasikforndw">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdpmicvqz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgzpynsmy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasikforndw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasikforndw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdpmicvqz === 'undefined') {
    varMorrisdpmicvqz = Morris.Line({
      element: 'Morrisdpmicvqz',
...
// LENGUETA
$('#Lenguetasikforndw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgzpynsmy;
  ...
  function initmapgzpynsmy() {
    // Nuevo Mapa
    mapgzpynsmy = new L.Map('LeafLetgzpynsmy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgzpynsmy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgzpynsmy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgzpynsmy === 'undefined') {
    varinitmapgzpynsmy = initmapgzpynsmy();
  };
});
FINAL;
    } // constructor
