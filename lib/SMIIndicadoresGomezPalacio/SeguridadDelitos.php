...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgbpqxjmc">
...
<div id="Morriskzbjfvga" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjvrueipd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgbpqxjmc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgbpqxjmc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskzbjfvga === 'undefined') {
    varMorriskzbjfvga = Morris.Line({
      element: 'Morriskzbjfvga',
...
// LENGUETA
$('#Lenguetasgbpqxjmc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjvrueipd;
  ...
  function initmapjvrueipd() {
    // Nuevo Mapa
    mapjvrueipd = new L.Map('LeafLetjvrueipd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjvrueipd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjvrueipd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjvrueipd === 'undefined') {
    varinitmapjvrueipd = initmapjvrueipd();
  };
});
FINAL;
    } // constructor
