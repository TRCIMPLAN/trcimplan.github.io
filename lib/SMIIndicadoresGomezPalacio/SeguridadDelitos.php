...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvwkvokhp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskifrhahr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettrghumzc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvwkvokhp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvwkvokhp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskifrhahr === 'undefined') {
    varMorriskifrhahr = Morris.Line({
      element: 'Morriskifrhahr',
...
// LENGUETA
$('#Lenguetasvwkvokhp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptrghumzc;
  ...
  function initmaptrghumzc() {
    // Nuevo Mapa
    maptrghumzc = new L.Map('LeafLettrghumzc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptrghumzc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptrghumzc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptrghumzc === 'undefined') {
    varinitmaptrghumzc = initmaptrghumzc();
  };
});
FINAL;
    } // constructor
