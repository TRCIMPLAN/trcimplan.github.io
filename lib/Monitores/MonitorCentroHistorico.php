 ...
 */
class MonitorCentroHistorico extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->descripcion                = 'Espacio dedicado a los datos más relevantes sobre el Centro Histórico de Torreón.';
        $this->claves                     = 'IMPLAN, Torreon, Centro Histórico';
    ...
    //~ $this->contenido_archivo_html     = 'lib/Monitores/MonitorDeNegocios.html';
        ...
        // Para el Organizador
        $this->categorias                 = array('Infraestructura','Servicios Públicos','Vialidad');
        $this->fuentes                    = array();
    ...
    public function html() {
        ...
        $this->contenido->articleBody =
            $this->cargar_archivo('lib/Monitores/MonitorCentroHistorico.html').
            $this->cargar_archivo_markdown_extra('lib/Monitores/MonitorCentroHistorico.md');
    ...
    public function javascript() {
        ...
        $this->javascript = $this->cargar_archivo('lib/Monitores/MonitorCentroHistorico.js');
