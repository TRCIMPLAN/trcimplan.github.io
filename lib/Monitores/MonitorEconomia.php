 ...
 */
class MonitorEconomia extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->autor                      = 'Lic. Jorge Fernando del Moral Fraire'; // Puede ser un arreglo de textos array('x','y')
        $this->fecha                      = '2021-02-02T09:50';
    ...
    //~ $this->contenido_archivo_html     = 'lib/Monitores/MonitorDeNegocios.html';
        ...
        // Para el Organizador
        $this->categorias                 = array('Competitividad','Empresas','Macroeconomía','Mercados');
        $this->fuentes                    = array();
    ...
    public function html() {
        ...
        $this->contenido->articleBody =
            $this->cargar_archivo('lib/Monitores/MonitorEconomia.html').
            $this->cargar_archivo_markdown_extra('lib/Monitores/MonitorEconomia.md');
    ...
    public function javascript() {
        ...
        $this->javascript = $this->cargar_archivo('lib/Monitores/MonitorEconomia.js');
