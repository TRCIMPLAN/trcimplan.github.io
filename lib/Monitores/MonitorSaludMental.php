...
/**
 * Clase Monitor de Salud Mental
 */
class MonitorSaludMental extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->descripcion                = 'Monitor de Salud Mental para Coahuila.';
    ...
    public function html() {
        ...
        $this->contenido->articleBody =
            $this->cargar_archivo('lib/Monitores/MonitorSaludMental.html').
            $this->cargar_archivo_markdown_extra('lib/Monitores/MonitorSaludMental.md');
    ...
    public function javascript() {
        ...
        $this->javascript = $this->cargar_archivo('lib/Monitores/MonitorSaludMental.js');
