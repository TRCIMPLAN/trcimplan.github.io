...
/**
 * Clase Monitor de ingresos
 */
class MonitorIngresos extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->fecha                      = '2021-08-26T13:28';
        // El nombre del archivo a crear
        $this->archivo                    = 'monitor-de-ingresos'; // En minúsculas, sin espacios, use guiones, letras y números
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion                = 'En este monitor puede encontrar la información más actualizada y relevante de los ingresos en La Laguna.';
        $this->claves                     = 'IMPLAN, Torreon, Negocios';
        // Ruta al archivo markdown con el contenido
        //$this->contenido_archivo_markdown = 'lib/Monitores/TablaNegocios.md';
        // Ruta al archivo HTML con el contenido
        //$this->contenido_archivo_html     = 'lib/Monitores/MonitorIngresos.html';
        // Ruta al archivo javascript
        //$this->javascript                 = 'lib/Monitores/MonitorIngresos.js';
        // Banderas
    ...
    public function html() {
        ...
        $this->contenido->articleBody =
            $this->cargar_archivo('lib/Monitores/MonitorIngresos.html').
            $this->cargar_archivo_markdown_extra('lib/Monitores/MonitorIngresos.md');
    ...
    public function javascript() {
        ...
        $this->javascript = $this->cargar_archivo('lib/Monitores/MonitorIngresos.js');
