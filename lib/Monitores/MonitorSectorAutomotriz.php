 ...
 */
class MonitorSectorAutomotriz extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->descripcion                = 'Monitor de sector automotriz para la Zona Metropolitana de La Laguna.';
    ...
    public function html() {
        ...
        $this->contenido->articleBody =
            $this->cargar_archivo('lib/Monitores/MonitorSectorAutomotriz.html').
            $this->cargar_archivo_markdown_extra('lib/Monitores/MonitorSectorAutomotriz.md');
    ...
    public function javascript() {
        ...
        $this->javascript = $this->cargar_archivo('lib/Monitores/MonitorSectorAutomotriz.js');
