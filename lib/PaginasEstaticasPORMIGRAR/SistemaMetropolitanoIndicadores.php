<?php
/*
 * SMIbeta - Proyectos Sistema Metropolitano de Indicadores
 *
...
/**
 * Clase SistemaMetropolitanoIndicadores
 */
class SistemaMetropolitanoIndicadores extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo     = 'smi';
        $this->descripcion = 'El Sistema Metropolitano de Indicadores (SMI) es un banco de información sobre los temas de interés de nuestra ciudad y su zona metropolitana, para conocer el estado de distintos fenómenos comparables en el tiempo, pero también con otras ciudades y con estándares internacionales.';
