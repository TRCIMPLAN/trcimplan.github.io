...
/**
 * Clase MensajeDelDirector
 */
class MensajeDelDirector extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->encabezado  = '<img class="img-responsive" src="mensaje-del-director/encabezado.jpg">';
        $this->contenido   = <<<FINAL
<span><img src="mensaje-del-director/eduardo-olguin.jpg" alt="Eduardo Olguín"></span>
