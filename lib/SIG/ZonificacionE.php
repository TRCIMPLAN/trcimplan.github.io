 ...
 * Clase ZonificacionE
 */
class ZonificacionE extends \Base\PublicacionSchemaArticle {
    ...
    //~ $this->autor                      = '';
        ...
        $this->claves                     = 'IMPLAN, Torreon, SIG, Zonificacion Norma E';
        // Opción de navegación a poner como activa
        $this->nombre_menu                = 'Información Geográfica > Zonificación';
        // Ruta al archivo markdown con el contenido
        $this->contenido_archivo_markdown = 'lib/SIG/ZonificacionE.md';
        // Banderas
