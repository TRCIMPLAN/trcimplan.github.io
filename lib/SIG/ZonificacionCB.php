 ...
 */
class ZonificacionCB extends \Base\PublicacionSchemaArticle {
    ...
    //~ $this->autor                      = '';
        ...
        $this->claves                     = 'IMPLAN, Torreon, SIG, Zonificacion CB';
        // Opción de navegación a poner como activa
        $this->nombre_menu                = 'Información Geográfica > Zonificación';
        // Ruta al archivo markdown con el contenido
        $this->contenido_archivo_markdown = 'lib/SIG/ZonificacionCB.md';
        // Banderas
