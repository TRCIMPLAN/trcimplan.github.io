 ...
 */
class ZonificacionIP extends \Base\PublicacionSchemaArticle {
    ...
    public function __construct() {
        ...
        $this->claves                     = 'IMPLAN, Torreon, SIG, Zonificacion Norma IP';
        // Opción de navegación a poner como activa
        $this->nombre_menu                = 'Información Geográfica > Zonificación Secundaria';
        // Ruta al archivo markdown con el contenido
        $this->contenido_archivo_markdown = 'lib/SIG/ZonificacionIP.md';
    } // constructor
