 ...
 */
class ZonificacionH6 extends \Base\PublicacionSchemaArticle {
    ...
    //~ $this->autor                      = '';
        ...
        $this->claves                     = 'IMPLAN, Torreon, SIG, Zonificacion Norma H6';
        // Opción de navegación a poner como activa
        $this->nombre_menu                = 'Información Geográfica > Zonificación';
        // Ruta al archivo markdown con el contenido
        $this->contenido_archivo_markdown = 'lib/SIG/ZonificacionH6.md';
        // Banderas
