...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxccfophx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfbndfpyu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxccfophx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxccfophx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfbndfpyu === 'undefined') {
    varMorrisfbndfpyu = Morris.Line({
      element: 'Morrisfbndfpyu',
