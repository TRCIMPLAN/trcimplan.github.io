...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbwxlinuk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisapzyslhl" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbwxlinuk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbwxlinuk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisapzyslhl === 'undefined') {
    varMorrisapzyslhl = Morris.Line({
      element: 'Morrisapzyslhl',
