...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasilfksogi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyzwchghv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasilfksogi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasilfksogi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyzwchghv === 'undefined') {
    varMorrisyzwchghv = Morris.Line({
      element: 'Morrisyzwchghv',
