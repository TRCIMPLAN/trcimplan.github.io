...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 106 },{ region: 'Gómez Palacio', dato: 56 },{ region: 'Lerdo', dato: 4 },{ region: 'Matamoros', dato: 9 },{ region: 'La Laguna', dato: 175 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
