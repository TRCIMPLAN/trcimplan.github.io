...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskxvajbrr">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqijaovha" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdtbkhxes" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskxvajbrr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskxvajbrr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqijaovha === 'undefined') {
    varMorrisqijaovha = Morris.Line({
      element: 'Morrisqijaovha',
      data: [{ fecha: '2014-01-31', dato: 10 },{ fecha: '2014-02-28', dato: 4 },{ fecha: '2014-03-31', dato: 9 },{ fecha: '2014-04-30', dato: 9 },{ fecha: '2014-05-31', dato: 7 },{ fecha: '2014-06-30', dato: 9 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetaskxvajbrr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdtbkhxes;
  ...
  function initmapdtbkhxes() {
    // Nuevo Mapa
    mapdtbkhxes = new L.Map('LeafLetdtbkhxes');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdtbkhxes.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdtbkhxes.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdtbkhxes === 'undefined') {
    varinitmapdtbkhxes = initmapdtbkhxes();
  };
});
FINAL;
    } // constructor
