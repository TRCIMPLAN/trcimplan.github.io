...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasidfeoixo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscbafoykz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasidfeoixo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasidfeoixo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscbafoykz === 'undefined') {
    varMorriscbafoykz = Morris.Line({
      element: 'Morriscbafoykz',
