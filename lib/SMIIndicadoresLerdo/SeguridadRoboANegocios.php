<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Seguridad Robo a Negocios (Creado por Central:SmiLanzadera)
 *
...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Robo a Negocios en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 10 },{ fecha: '2014-02-28', dato: 4 },{ fecha: '2014-03-31', dato: 9 },{ fecha: '2014-04-30', dato: 9 },{ fecha: '2014-05-31', dato: 7 },{ fecha: '2014-06-30', dato: 9 },{ fecha: '2014-07-31', dato: 13 },{ fecha: '2014-08-31', dato: 1 },{ fecha: '2014-09-30', dato: 5 },{ fecha: '2014-10-31', dato: 8 },{ fecha: '2014-11-30', dato: 4 },{ fecha: '2014-12-31', dato: 3 },{ fecha: '2015-01-31', dato: 6 },{ fecha: '2015-02-28', dato: 7 },{ fecha: '2015-03-31', dato: 2 },{ fecha: '2015-04-30', dato: 4 },{ fecha: '2015-05-31', dato: 7 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 60 },{ region: 'Gómez Palacio', dato: 38 },{ region: 'Lerdo', dato: 7 },{ region: 'Matamoros', dato: 6 },{ region: 'La Laguna', dato: 111 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
