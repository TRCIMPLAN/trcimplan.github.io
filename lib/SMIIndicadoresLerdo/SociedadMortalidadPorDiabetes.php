...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnvvfacmr">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzqahxkin" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnvvfacmr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnvvfacmr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzqahxkin;
  ...
  function initmapzqahxkin() {
    // Nuevo Mapa
    mapzqahxkin = new L.Map('LeafLetzqahxkin');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzqahxkin.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzqahxkin.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzqahxkin === 'undefined') {
    varinitmapzqahxkin = initmapzqahxkin();
  };
});
FINAL;
    } // constructor
