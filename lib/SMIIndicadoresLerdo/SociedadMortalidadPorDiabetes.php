...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmhpuljkx">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfvcypbhy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmhpuljkx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmhpuljkx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfvcypbhy;
  ...
  function initmapfvcypbhy() {
    // Nuevo Mapa
    mapfvcypbhy = new L.Map('LeafLetfvcypbhy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfvcypbhy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfvcypbhy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfvcypbhy === 'undefined') {
    varinitmapfvcypbhy = initmapfvcypbhy();
  };
});
FINAL;
    } // constructor
