...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfrymkgwn">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetniktitpv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfrymkgwn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfrymkgwn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapniktitpv;
  ...
  function initmapniktitpv() {
    // Nuevo Mapa
    mapniktitpv = new L.Map('LeafLetniktitpv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapniktitpv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapniktitpv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapniktitpv === 'undefined') {
    varinitmapniktitpv = initmapniktitpv();
  };
});
FINAL;
    } // constructor
