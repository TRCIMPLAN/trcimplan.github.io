...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnooverlm">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethurmnlza" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnooverlm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnooverlm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphurmnlza;
  ...
  function initmaphurmnlza() {
    // Nuevo Mapa
    maphurmnlza = new L.Map('LeafLethurmnlza');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphurmnlza.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphurmnlza.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphurmnlza === 'undefined') {
    varinitmaphurmnlza = initmaphurmnlza();
  };
});
FINAL;
    } // constructor
