...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdaiyzjdj">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetydeunfqp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdaiyzjdj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdaiyzjdj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapydeunfqp;
  ...
  function initmapydeunfqp() {
    // Nuevo Mapa
    mapydeunfqp = new L.Map('LeafLetydeunfqp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapydeunfqp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapydeunfqp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapydeunfqp === 'undefined') {
    varinitmapydeunfqp = initmapydeunfqp();
  };
});
FINAL;
    } // constructor
