...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslqexjlhl">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettrjmjpgm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslqexjlhl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslqexjlhl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptrjmjpgm;
  ...
  function initmaptrjmjpgm() {
    // Nuevo Mapa
    maptrjmjpgm = new L.Map('LeafLettrjmjpgm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptrjmjpgm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptrjmjpgm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptrjmjpgm === 'undefined') {
    varinitmaptrjmjpgm = initmaptrjmjpgm();
  };
});
FINAL;
    } // constructor
