...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvfddbivs">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvxbssabg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvfddbivs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvfddbivs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvxbssabg;
  ...
  function initmapvxbssabg() {
    // Nuevo Mapa
    mapvxbssabg = new L.Map('LeafLetvxbssabg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvxbssabg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvxbssabg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvxbssabg === 'undefined') {
    varinitmapvxbssabg = initmapvxbssabg();
  };
});
FINAL;
    } // constructor
