<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sustentabilidad Empresas Certificadas como Limpias (Creado por Central:SmiLanzadera)
 *
...
Fuente: Procuraduría Federal de Protección al Ambiente (PROFEPA), 2009-2012.';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Manejo Sustentable del Medio Ambiente". Mide el número de empresas que cuentan con la certificación de “Empresa Limpia”emitido por la Procuraduría Federal de Protección al Ambiente (PROFEPA), que evidencia el cumplimiento de la normatividad y buenas prácticas ambientales.
Unidades: Empresas certificadas como limpias por cada mil.
Fuente: Procuraduría Federal de Protección al Ambiente (PROFEPA), 2009-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empresas Certificadas como Limpias en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.2000 },{ fecha: '2009-12-31', dato: 2.8000 },{ fecha: '2010-12-31', dato: 1.4000 },{ fecha: '2011-12-31', dato: 5.8000 },{ fecha: '2012-12-31', dato: 1.4000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
