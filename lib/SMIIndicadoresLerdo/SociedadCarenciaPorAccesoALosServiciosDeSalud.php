<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadCarenciaPorAccesoALosServiciosDeSalud
 *
...
class SociedadCarenciaPorAccesoALosServiciosDeSalud extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a los servicios de salud en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '15.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
