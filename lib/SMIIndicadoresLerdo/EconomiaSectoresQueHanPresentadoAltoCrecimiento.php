<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Sectores que Han Presentado Alto Crecimiento (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje del PIB de la ciudad.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica-1">
      <h3>Gráfica de Sectores que Han Presentado Alto Crecimiento en Lerdo con fuente IMCO</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica-1"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 4.5100 },{ fecha: '2009-12-31', dato: 18.8300 },{ fecha: '2010-12-31', dato: 34.2000 },{ fecha: '2011-12-31', dato: 34.2800 },{ fecha: '2012-12-31', dato: 34.5900 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
