<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sociedad Personas por Debajo de la Línea de Bienestar (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: INEGI (ENOE), CONEVAL.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Personas por Debajo de la Línea de Bienestar en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.3600 },{ fecha: '2009-12-31', dato: 7.7800 },{ fecha: '2010-12-31', dato: 4.5800 },{ fecha: '2011-12-31', dato: 5.0400 },{ fecha: '2012-12-31', dato: 2.6800 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
