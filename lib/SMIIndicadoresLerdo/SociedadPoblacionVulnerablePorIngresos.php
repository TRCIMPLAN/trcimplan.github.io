<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadPoblacionVulnerablePorIngresos
 *
...
class SociedadPoblacionVulnerablePorIngresos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población vulnerable por ingresos en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '11.3000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2010-12-31', 'valor' => '9.6000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '13.7000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 6, crudo 3
    } // datos
