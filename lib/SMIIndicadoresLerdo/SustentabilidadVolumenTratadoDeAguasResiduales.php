...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasohessfze">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnqcpjqrt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasohessfze a:first').tab('show')
});
// LENGUETA
$('#Lenguetasohessfze a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnqcpjqrt;
  ...
  function initmapnqcpjqrt() {
    // Nuevo Mapa
    mapnqcpjqrt = new L.Map('LeafLetnqcpjqrt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnqcpjqrt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnqcpjqrt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnqcpjqrt === 'undefined') {
    varinitmapnqcpjqrt = initmapnqcpjqrt();
  };
});
FINAL;
    } // constructor
