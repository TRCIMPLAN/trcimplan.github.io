...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxcjrnawn">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdzwfhier" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxcjrnawn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxcjrnawn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdzwfhier;
  ...
  function initmapdzwfhier() {
    // Nuevo Mapa
    mapdzwfhier = new L.Map('LeafLetdzwfhier');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdzwfhier.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdzwfhier.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdzwfhier === 'undefined') {
    varinitmapdzwfhier = initmapdzwfhier();
  };
});
FINAL;
    } // constructor
