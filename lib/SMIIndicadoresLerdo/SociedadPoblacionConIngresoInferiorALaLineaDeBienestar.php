<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadPoblacionConIngresoInferiorALaLineaDeBienestar
 *
...
class SociedadPoblacionConIngresoInferiorALaLineaDeBienestar extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con ingreso inferior a la línea de bienestar. en Lerdo';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2015-12-31', 'valor' => '50.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 12, crudo 6
    } // datos
