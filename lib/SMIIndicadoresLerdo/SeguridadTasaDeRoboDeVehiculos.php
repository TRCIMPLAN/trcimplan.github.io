<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Seguridad Tasa de Robo de VehÍculos (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública (SESNSP) e INEGI, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tasa de Robo de VehÍculos en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 11.3158 },{ fecha: '2009-12-31', dato: 11.3158 },{ fecha: '2010-12-31', dato: 11.3158 },{ fecha: '2011-12-31', dato: 107.1293 },{ fecha: '2012-12-31', dato: 40.1776 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
