...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasacomsngo">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetndioinex" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasacomsngo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasacomsngo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapndioinex;
  ...
  function initmapndioinex() {
    // Nuevo Mapa
    mapndioinex = new L.Map('LeafLetndioinex');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapndioinex.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapndioinex.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapndioinex === 'undefined') {
    varinitmapndioinex = initmapndioinex();
  };
});
FINAL;
    } // constructor
