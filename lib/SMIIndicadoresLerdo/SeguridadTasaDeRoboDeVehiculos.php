...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascehnawfl">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgdtvqvat" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascehnawfl a:first').tab('show')
});
// LENGUETA
$('#Lenguetascehnawfl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgdtvqvat;
  ...
  function initmapgdtvqvat() {
    // Nuevo Mapa
    mapgdtvqvat = new L.Map('LeafLetgdtvqvat');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgdtvqvat.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgdtvqvat.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgdtvqvat === 'undefined') {
    varinitmapgdtvqvat = initmapgdtvqvat();
  };
});
FINAL;
    } // constructor
