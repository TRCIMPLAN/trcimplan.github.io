...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgamqieup">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmwlfstzi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgamqieup a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgamqieup a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmwlfstzi;
  ...
  function initmapmwlfstzi() {
    // Nuevo Mapa
    mapmwlfstzi = new L.Map('LeafLetmwlfstzi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmwlfstzi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmwlfstzi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmwlfstzi === 'undefined') {
    varinitmapmwlfstzi = initmapmwlfstzi();
  };
});
FINAL;
    } // constructor
