<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadNivelDosDeLenguajeYComunicacionDePlanea
 *
...
class SociedadNivelDosDeLenguajeYComunicacionDePlanea extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nivel dos de Lenguaje y Comunicación de PLANEA en Lerdo';
...
discriminan y relacionan información oportuna y confiable, y la organizan a partir de un propósito.';
    ...
    public function datos() {
        return array(
            array('fecha' => '2017-12-31', 'valor' => '20.6000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
