...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrvlbawef">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkamalvrj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrvlbawef a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrvlbawef a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkamalvrj;
  ...
  function initmapkamalvrj() {
    // Nuevo Mapa
    mapkamalvrj = new L.Map('LeafLetkamalvrj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkamalvrj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkamalvrj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkamalvrj === 'undefined') {
    varinitmapkamalvrj = initmapkamalvrj();
  };
});
FINAL;
    } // constructor
