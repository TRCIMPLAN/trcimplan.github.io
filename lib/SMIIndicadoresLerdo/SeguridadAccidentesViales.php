...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassceaakep">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisepdkjcmq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassceaakep a:first').tab('show')
});
// LENGUETA
$('#Lenguetassceaakep a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisepdkjcmq === 'undefined') {
    varMorrisepdkjcmq = Morris.Line({
      element: 'Morrisepdkjcmq',
