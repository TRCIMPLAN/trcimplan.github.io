...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasskxlpusw">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisctqzwcae" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasskxlpusw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasskxlpusw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisctqzwcae === 'undefined') {
    varMorrisctqzwcae = Morris.Line({
      element: 'Morrisctqzwcae',
