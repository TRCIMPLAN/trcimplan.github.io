...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszzzqctxd">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlwldnpbx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszzzqctxd a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszzzqctxd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplwldnpbx;
  ...
  function initmaplwldnpbx() {
    // Nuevo Mapa
    maplwldnpbx = new L.Map('LeafLetlwldnpbx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplwldnpbx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplwldnpbx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplwldnpbx === 'undefined') {
    varinitmaplwldnpbx = initmaplwldnpbx();
  };
});
FINAL;
    } // constructor
