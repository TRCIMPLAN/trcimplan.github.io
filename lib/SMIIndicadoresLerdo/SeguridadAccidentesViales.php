...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszxyacors">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxhsvukqb" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszxyacors a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszxyacors a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxhsvukqb === 'undefined') {
    varMorrisxhsvukqb = Morris.Line({
      element: 'Morrisxhsvukqb',
