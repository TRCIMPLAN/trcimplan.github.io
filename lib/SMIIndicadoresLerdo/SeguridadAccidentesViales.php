...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrgktmymv">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishziyuzgo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrgktmymv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrgktmymv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishziyuzgo === 'undefined') {
    varMorrishziyuzgo = Morris.Line({
      element: 'Morrishziyuzgo',
