...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspsambplm">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettksqedyf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspsambplm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspsambplm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptksqedyf;
  ...
  function initmaptksqedyf() {
    // Nuevo Mapa
    maptksqedyf = new L.Map('LeafLettksqedyf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptksqedyf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptksqedyf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptksqedyf === 'undefined') {
    varinitmaptksqedyf = initmaptksqedyf();
  };
});
FINAL;
    } // constructor
