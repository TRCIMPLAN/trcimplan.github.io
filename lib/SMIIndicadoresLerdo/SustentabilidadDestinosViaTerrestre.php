...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashwifeejg">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzfaabkre" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashwifeejg a:first').tab('show')
});
// LENGUETA
$('#Lenguetashwifeejg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzfaabkre;
  ...
  function initmapzfaabkre() {
    // Nuevo Mapa
    mapzfaabkre = new L.Map('LeafLetzfaabkre');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzfaabkre.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzfaabkre.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzfaabkre === 'undefined') {
    varinitmapzfaabkre = initmapzfaabkre();
  };
});
FINAL;
    } // constructor
