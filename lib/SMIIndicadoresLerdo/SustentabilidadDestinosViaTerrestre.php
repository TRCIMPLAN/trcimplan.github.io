...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskshvzvnj">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiifdttrl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskshvzvnj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskshvzvnj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiifdttrl;
  ...
  function initmapiifdttrl() {
    // Nuevo Mapa
    mapiifdttrl = new L.Map('LeafLetiifdttrl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiifdttrl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiifdttrl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiifdttrl === 'undefined') {
    varinitmapiifdttrl = initmapiifdttrl();
  };
});
FINAL;
    } // constructor
