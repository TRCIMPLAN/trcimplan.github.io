...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasytkhidax">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetirhifdzj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasytkhidax a:first').tab('show')
});
// LENGUETA
$('#Lenguetasytkhidax a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapirhifdzj;
  ...
  function initmapirhifdzj() {
    // Nuevo Mapa
    mapirhifdzj = new L.Map('LeafLetirhifdzj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapirhifdzj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapirhifdzj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapirhifdzj === 'undefined') {
    varinitmapirhifdzj = initmapirhifdzj();
  };
});
FINAL;
    } // constructor
