...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxpxiqgzk">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmfpmvkfv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxpxiqgzk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxpxiqgzk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmfpmvkfv;
  ...
  function initmapmfpmvkfv() {
    // Nuevo Mapa
    mapmfpmvkfv = new L.Map('LeafLetmfpmvkfv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmfpmvkfv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmfpmvkfv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmfpmvkfv === 'undefined') {
    varinitmapmfpmvkfv = initmapmfpmvkfv();
  };
});
FINAL;
    } // constructor
