...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvgungkzm">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbwiajunu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvgungkzm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvgungkzm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbwiajunu;
  ...
  function initmapbwiajunu() {
    // Nuevo Mapa
    mapbwiajunu = new L.Map('LeafLetbwiajunu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbwiajunu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbwiajunu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbwiajunu === 'undefined') {
    varinitmapbwiajunu = initmapbwiajunu();
  };
});
FINAL;
    } // constructor
