...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswnvdhffv">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpqntxeqc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswnvdhffv a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswnvdhffv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappqntxeqc;
  ...
  function initmappqntxeqc() {
    // Nuevo Mapa
    mappqntxeqc = new L.Map('LeafLetpqntxeqc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappqntxeqc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappqntxeqc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappqntxeqc === 'undefined') {
    varinitmappqntxeqc = initmappqntxeqc();
  };
});
FINAL;
    } // constructor
