...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascmojomxd">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvqddpxqh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascmojomxd a:first').tab('show')
});
// LENGUETA
$('#Lenguetascmojomxd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvqddpxqh;
  ...
  function initmapvqddpxqh() {
    // Nuevo Mapa
    mapvqddpxqh = new L.Map('LeafLetvqddpxqh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvqddpxqh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvqddpxqh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvqddpxqh === 'undefined') {
    varinitmapvqddpxqh = initmapvqddpxqh();
  };
});
FINAL;
    } // constructor
