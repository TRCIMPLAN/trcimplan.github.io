...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseufnedbr">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjltzrinr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseufnedbr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseufnedbr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjltzrinr;
  ...
  function initmapjltzrinr() {
    // Nuevo Mapa
    mapjltzrinr = new L.Map('LeafLetjltzrinr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjltzrinr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjltzrinr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjltzrinr === 'undefined') {
    varinitmapjltzrinr = initmapjltzrinr();
  };
});
FINAL;
    } // constructor
