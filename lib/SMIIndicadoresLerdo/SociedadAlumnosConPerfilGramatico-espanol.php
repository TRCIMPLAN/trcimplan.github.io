<?php
/**
 * SociedadAlumnosConPerfilGramatico-espanol.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadAlumnosConPerfilGramatico-espanol
 */
class SociedadAlumnosConPerfilGramatico-espanol extends \Base\Publicacion {
