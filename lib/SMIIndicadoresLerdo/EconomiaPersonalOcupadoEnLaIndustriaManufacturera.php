...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyjgzvbkk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismsvsnjcb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvfcrmief" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyjgzvbkk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyjgzvbkk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismsvsnjcb === 'undefined') {
    varMorrismsvsnjcb = Morris.Line({
      element: 'Morrismsvsnjcb',
...
// LENGUETA
$('#Lenguetasyjgzvbkk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvfcrmief;
  ...
  function initmapvfcrmief() {
    // Nuevo Mapa
    mapvfcrmief = new L.Map('LeafLetvfcrmief');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvfcrmief.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvfcrmief.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvfcrmief === 'undefined') {
    varinitmapvfcrmief = initmapvfcrmief();
  };
});
FINAL;
    } // constructor
