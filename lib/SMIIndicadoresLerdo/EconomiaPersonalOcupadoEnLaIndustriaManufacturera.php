...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasknvvhyrw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrksipbut" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettxjaatff" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasknvvhyrw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasknvvhyrw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrksipbut === 'undefined') {
    varMorrisrksipbut = Morris.Line({
      element: 'Morrisrksipbut',
...
// LENGUETA
$('#Lenguetasknvvhyrw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptxjaatff;
  ...
  function initmaptxjaatff() {
    // Nuevo Mapa
    maptxjaatff = new L.Map('LeafLettxjaatff');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptxjaatff.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptxjaatff.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptxjaatff === 'undefined') {
    varinitmaptxjaatff = initmaptxjaatff();
  };
});
FINAL;
    } // constructor
