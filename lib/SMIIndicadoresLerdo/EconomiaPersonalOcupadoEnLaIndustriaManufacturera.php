...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbcxcihrk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqbsclcym" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzbqixuub" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbcxcihrk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbcxcihrk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqbsclcym === 'undefined') {
    varMorrisqbsclcym = Morris.Line({
      element: 'Morrisqbsclcym',
...
// LENGUETA
$('#Lenguetasbcxcihrk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzbqixuub;
  ...
  function initmapzbqixuub() {
    // Nuevo Mapa
    mapzbqixuub = new L.Map('LeafLetzbqixuub');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzbqixuub.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzbqixuub.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzbqixuub === 'undefined') {
    varinitmapzbqixuub = initmapzbqixuub();
  };
});
FINAL;
    } // constructor
