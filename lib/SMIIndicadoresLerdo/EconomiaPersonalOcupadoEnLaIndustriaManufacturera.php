...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbbdksuzr">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisekobmzuf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbbdksuzr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbbdksuzr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisekobmzuf === 'undefined') {
    varMorrisekobmzuf = Morris.Line({
      element: 'Morrisekobmzuf',
