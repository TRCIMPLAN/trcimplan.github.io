...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassbkdoprp">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnpaoznhu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassbkdoprp a:first').tab('show')
});
// LENGUETA
$('#Lenguetassbkdoprp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnpaoznhu === 'undefined') {
    varMorrisnpaoznhu = Morris.Line({
      element: 'Morrisnpaoznhu',
