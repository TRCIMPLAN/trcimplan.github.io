...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasryoqxaqt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnzybcsgw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpqgqenfi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasryoqxaqt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasryoqxaqt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnzybcsgw === 'undefined') {
    varMorrisnzybcsgw = Morris.Line({
      element: 'Morrisnzybcsgw',
...
// LENGUETA
$('#Lenguetasryoqxaqt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappqgqenfi;
  ...
  function initmappqgqenfi() {
    // Nuevo Mapa
    mappqgqenfi = new L.Map('LeafLetpqgqenfi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappqgqenfi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappqgqenfi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappqgqenfi === 'undefined') {
    varinitmappqgqenfi = initmappqgqenfi();
  };
});
FINAL;
    } // constructor
