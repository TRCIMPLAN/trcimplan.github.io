...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfwcsinfk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqybgzlje" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnszhbljl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfwcsinfk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfwcsinfk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqybgzlje === 'undefined') {
    varMorrisqybgzlje = Morris.Line({
      element: 'Morrisqybgzlje',
...
// LENGUETA
$('#Lenguetasfwcsinfk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnszhbljl;
  ...
  function initmapnszhbljl() {
    // Nuevo Mapa
    mapnszhbljl = new L.Map('LeafLetnszhbljl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnszhbljl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnszhbljl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnszhbljl === 'undefined') {
    varinitmapnszhbljl = initmapnszhbljl();
  };
});
FINAL;
    } // constructor
