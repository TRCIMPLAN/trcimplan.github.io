...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbenjjlam">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristdflhcpi" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetteuarfqc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbenjjlam a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbenjjlam a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristdflhcpi === 'undefined') {
    varMorristdflhcpi = Morris.Line({
      element: 'Morristdflhcpi',
...
// LENGUETA
$('#Lenguetasbenjjlam a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapteuarfqc;
  ...
  function initmapteuarfqc() {
    // Nuevo Mapa
    mapteuarfqc = new L.Map('LeafLetteuarfqc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapteuarfqc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapteuarfqc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapteuarfqc === 'undefined') {
    varinitmapteuarfqc = initmapteuarfqc();
  };
});
FINAL;
    } // constructor
