...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuypiquzn">
...
<div id="Morrisdrdzgscj" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrxkgfjym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuypiquzn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuypiquzn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdrdzgscj === 'undefined') {
    varMorrisdrdzgscj = Morris.Line({
      element: 'Morrisdrdzgscj',
...
// LENGUETA
$('#Lenguetasuypiquzn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprxkgfjym;
  ...
  function initmaprxkgfjym() {
    // Nuevo Mapa
    maprxkgfjym = new L.Map('LeafLetrxkgfjym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprxkgfjym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprxkgfjym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprxkgfjym === 'undefined') {
    varinitmaprxkgfjym = initmaprxkgfjym();
  };
});
FINAL;
    } // constructor
