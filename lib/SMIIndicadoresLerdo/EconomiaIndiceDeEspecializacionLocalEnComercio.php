...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmjeyvikg">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismlsbvext" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvsjuxqwy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmjeyvikg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmjeyvikg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismlsbvext === 'undefined') {
    varMorrismlsbvext = Morris.Line({
      element: 'Morrismlsbvext',
...
// LENGUETA
$('#Lenguetasmjeyvikg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvsjuxqwy;
  ...
  function initmapvsjuxqwy() {
    // Nuevo Mapa
    mapvsjuxqwy = new L.Map('LeafLetvsjuxqwy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvsjuxqwy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvsjuxqwy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvsjuxqwy === 'undefined') {
    varinitmapvsjuxqwy = initmapvsjuxqwy();
  };
});
FINAL;
    } // constructor
