...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswfeasjcv">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxwzrftji" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswfeasjcv a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswfeasjcv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxwzrftji === 'undefined') {
    varMorrisxwzrftji = Morris.Line({
      element: 'Morrisxwzrftji',
