...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbpggiiut">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswwbmnlsw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbpggiiut a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbpggiiut a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswwbmnlsw === 'undefined') {
    varMorriswwbmnlsw = Morris.Line({
      element: 'Morriswwbmnlsw',
