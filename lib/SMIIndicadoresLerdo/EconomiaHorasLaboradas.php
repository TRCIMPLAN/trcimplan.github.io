<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaHorasLaboradas
 *
...
class EconomiaHorasLaboradas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Horas laboradas en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '15607673.5400', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 el decimal es por "Horas trabajadas al año"')); // formateado 0, valor 2, crudo 2
    } // datos
