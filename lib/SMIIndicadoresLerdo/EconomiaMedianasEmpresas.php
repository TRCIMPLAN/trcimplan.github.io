...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbuwawwfo">
...
<div id="Morriszciumxyu" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzjueadpu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbuwawwfo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbuwawwfo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszciumxyu === 'undefined') {
    varMorriszciumxyu = Morris.Line({
      element: 'Morriszciumxyu',
...
// LENGUETA
$('#Lenguetasbuwawwfo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzjueadpu;
  ...
  function initmapzjueadpu() {
    // Nuevo Mapa
    mapzjueadpu = new L.Map('LeafLetzjueadpu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzjueadpu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzjueadpu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzjueadpu === 'undefined') {
    varinitmapzjueadpu = initmapzjueadpu();
  };
});
FINAL;
    } // constructor
