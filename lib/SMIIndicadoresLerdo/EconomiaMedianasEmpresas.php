...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspvqtooxq">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscwxulmho" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfvowymfh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspvqtooxq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspvqtooxq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscwxulmho === 'undefined') {
    varMorriscwxulmho = Morris.Line({
      element: 'Morriscwxulmho',
...
// LENGUETA
$('#Lenguetaspvqtooxq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfvowymfh;
  ...
  function initmapfvowymfh() {
    // Nuevo Mapa
    mapfvowymfh = new L.Map('LeafLetfvowymfh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfvowymfh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfvowymfh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfvowymfh === 'undefined') {
    varinitmapfvowymfh = initmapfvowymfh();
  };
});
FINAL;
    } // constructor
