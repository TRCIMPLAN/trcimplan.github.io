...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgzuyucyd">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjudontfr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetghdvpwkl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgzuyucyd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgzuyucyd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjudontfr === 'undefined') {
    varMorrisjudontfr = Morris.Line({
      element: 'Morrisjudontfr',
...
// LENGUETA
$('#Lenguetasgzuyucyd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapghdvpwkl;
  ...
  function initmapghdvpwkl() {
    // Nuevo Mapa
    mapghdvpwkl = new L.Map('LeafLetghdvpwkl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapghdvpwkl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapghdvpwkl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapghdvpwkl === 'undefined') {
    varinitmapghdvpwkl = initmapghdvpwkl();
  };
});
FINAL;
    } // constructor
