<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadViviendasDondeSeparanEnOrganicoEInorganicoLosResiduos
 *
...
class SociedadViviendasDondeSeparanEnOrganicoEInorganicoLosResiduos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Viviendas donde separan en Orgánico e Inorgánico los Residuos en Lerdo';
        ...
        $this->claves      = 'IMPLAN, Lerdo, Vivienda, Medio Ambiente';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '14424', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 cambió a "cantidad"')); // formateado 0, valor 2, crudo 2
    } // datos
