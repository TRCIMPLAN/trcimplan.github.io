...
/**
 * Clase EconomiaTasaInformalidad
 */
class EconomiaTasaInformalidad extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiatasa-informalidad';
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2011-12-31', dato: 57.6200 },{ fecha: '2012-03-31', dato: 56.6600 },{ fecha: '2012-06-30', dato: 60.4300 },{ fecha: '2012-09-30', dato: 60.9300 },{ fecha: '2012-12-31', dato: 61.1700 },{ fecha: '2013-03-31', dato: 60.3900 },{ fecha: '2013-06-30', dato: 57.8000 },{ fecha: '2013-09-30', dato: 57.1400 },{ fecha: '2013-12-31', dato: 58.6500 },{ fecha: '2014-03-31', dato: 66.6600 },{ fecha: '2014-06-30', dato: 52.5400 },{ fecha: '2014-09-30', dato: 61.0200 },{ fecha: '2014-12-31', dato: 57.6900 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
