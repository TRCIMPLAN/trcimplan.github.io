<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sociedad Pobreza Extrema (Creado por Central:SmiLanzadera)
 *
...
<p>Consulta la <a href="http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx">Base de Datos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Pobreza Extrema en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 6.8000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
