...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassturlgjb">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishwtbsbrh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkmzzqtcw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassturlgjb a:first').tab('show')
});
// LENGUETA
$('#Lenguetassturlgjb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishwtbsbrh === 'undefined') {
    varMorrishwtbsbrh = Morris.Line({
      element: 'Morrishwtbsbrh',
...
// LENGUETA
$('#Lenguetassturlgjb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkmzzqtcw;
  ...
  function initmapkmzzqtcw() {
    // Nuevo Mapa
    mapkmzzqtcw = new L.Map('LeafLetkmzzqtcw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkmzzqtcw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkmzzqtcw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkmzzqtcw === 'undefined') {
    varinitmapkmzzqtcw = initmapkmzzqtcw();
  };
});
FINAL;
    } // constructor
