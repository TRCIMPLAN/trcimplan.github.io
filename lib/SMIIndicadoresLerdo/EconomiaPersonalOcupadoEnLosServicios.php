...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassqgxfxnq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisljlshcoy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmhhcjcvd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassqgxfxnq a:first').tab('show')
});
// LENGUETA
$('#Lenguetassqgxfxnq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisljlshcoy === 'undefined') {
    varMorrisljlshcoy = Morris.Line({
      element: 'Morrisljlshcoy',
...
// LENGUETA
$('#Lenguetassqgxfxnq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmhhcjcvd;
  ...
  function initmapmhhcjcvd() {
    // Nuevo Mapa
    mapmhhcjcvd = new L.Map('LeafLetmhhcjcvd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmhhcjcvd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmhhcjcvd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmhhcjcvd === 'undefined') {
    varinitmapmhhcjcvd = initmapmhhcjcvd();
  };
});
FINAL;
    } // constructor
