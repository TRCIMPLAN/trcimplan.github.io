<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Empleados en el Sector Formal (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpleadosEnElSectorFormal extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empleados en el Sector Formal en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 59.4393 },{ fecha: '2009-12-31', dato: 65.7476 },{ fecha: '2010-12-31', dato: 57.6312 },{ fecha: '2011-12-31', dato: 36.6446 },{ fecha: '2012-12-31', dato: 34.1412 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
