...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastavwoujl">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisltsgrspy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastavwoujl a:first').tab('show')
});
// LENGUETA
$('#Lenguetastavwoujl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisltsgrspy === 'undefined') {
    varMorrisltsgrspy = Morris.Line({
      element: 'Morrisltsgrspy',
