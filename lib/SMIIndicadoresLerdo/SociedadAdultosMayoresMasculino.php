...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasinrozmor">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxyobxrda" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnuvirvea" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasinrozmor a:first').tab('show')
});
// LENGUETA
$('#Lenguetasinrozmor a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxyobxrda === 'undefined') {
    varMorrisxyobxrda = Morris.Line({
      element: 'Morrisxyobxrda',
...
// LENGUETA
$('#Lenguetasinrozmor a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnuvirvea;
  ...
  function initmapnuvirvea() {
    // Nuevo Mapa
    mapnuvirvea = new L.Map('LeafLetnuvirvea');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnuvirvea.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnuvirvea.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnuvirvea === 'undefined') {
    varinitmapnuvirvea = initmapnuvirvea();
  };
});
FINAL;
    } // constructor
