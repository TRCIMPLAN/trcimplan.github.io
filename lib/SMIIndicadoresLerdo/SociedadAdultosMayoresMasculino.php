...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszczrzkiy">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispnytfuww" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszczrzkiy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszczrzkiy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispnytfuww === 'undefined') {
    varMorrispnytfuww = Morris.Line({
      element: 'Morrispnytfuww',
