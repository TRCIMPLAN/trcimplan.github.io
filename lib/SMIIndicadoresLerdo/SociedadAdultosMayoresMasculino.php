...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszsgjqcvs">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuruskcoh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcypefkvn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszsgjqcvs a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszsgjqcvs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuruskcoh === 'undefined') {
    varMorrisuruskcoh = Morris.Line({
      element: 'Morrisuruskcoh',
...
// LENGUETA
$('#Lenguetaszsgjqcvs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcypefkvn;
  ...
  function initmapcypefkvn() {
    // Nuevo Mapa
    mapcypefkvn = new L.Map('LeafLetcypefkvn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcypefkvn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcypefkvn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcypefkvn === 'undefined') {
    varinitmapcypefkvn = initmapcypefkvn();
  };
});
FINAL;
    } // constructor
