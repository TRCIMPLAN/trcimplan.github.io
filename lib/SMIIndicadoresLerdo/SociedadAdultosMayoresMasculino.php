...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasipjyuigu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisozliaidu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasipjyuigu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasipjyuigu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisozliaidu === 'undefined') {
    varMorrisozliaidu = Morris.Line({
      element: 'Morrisozliaidu',
