...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskvijcige">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisaggmgvzw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskvijcige a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskvijcige a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaggmgvzw === 'undefined') {
    varMorrisaggmgvzw = Morris.Line({
      element: 'Morrisaggmgvzw',
