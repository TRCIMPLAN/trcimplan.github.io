...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassgnhlzkr">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfhqyizxm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassgnhlzkr a:first').tab('show')
});
// LENGUETA
$('#Lenguetassgnhlzkr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfhqyizxm;
  ...
  function initmapfhqyizxm() {
    // Nuevo Mapa
    mapfhqyizxm = new L.Map('LeafLetfhqyizxm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfhqyizxm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfhqyizxm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfhqyizxm === 'undefined') {
    varinitmapfhqyizxm = initmapfhqyizxm();
  };
});
FINAL;
    } // constructor
