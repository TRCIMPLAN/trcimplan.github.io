...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswnrofens">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmwzotfha" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswnrofens a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswnrofens a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmwzotfha;
  ...
  function initmapmwzotfha() {
    // Nuevo Mapa
    mapmwzotfha = new L.Map('LeafLetmwzotfha');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmwzotfha.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmwzotfha.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmwzotfha === 'undefined') {
    varinitmapmwzotfha = initmapmwzotfha();
  };
});
FINAL;
    } // constructor
