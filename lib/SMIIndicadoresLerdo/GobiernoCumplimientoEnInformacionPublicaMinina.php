...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswntccotw">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcvpwbxjn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswntccotw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswntccotw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcvpwbxjn;
  ...
  function initmapcvpwbxjn() {
    // Nuevo Mapa
    mapcvpwbxjn = new L.Map('LeafLetcvpwbxjn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcvpwbxjn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcvpwbxjn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcvpwbxjn === 'undefined') {
    varinitmapcvpwbxjn = initmapcvpwbxjn();
  };
});
FINAL;
    } // constructor
