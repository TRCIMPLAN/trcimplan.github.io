...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasholsyive">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnlkaxipm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasholsyive a:first').tab('show')
});
// LENGUETA
$('#Lenguetasholsyive a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnlkaxipm;
  ...
  function initmapnlkaxipm() {
    // Nuevo Mapa
    mapnlkaxipm = new L.Map('LeafLetnlkaxipm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnlkaxipm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnlkaxipm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnlkaxipm === 'undefined') {
    varinitmapnlkaxipm = initmapnlkaxipm();
  };
});
FINAL;
    } // constructor
