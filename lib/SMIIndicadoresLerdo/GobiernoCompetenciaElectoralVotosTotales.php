...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdxggcwka">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettqhqtthc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdxggcwka a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdxggcwka a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptqhqtthc;
  ...
  function initmaptqhqtthc() {
    // Nuevo Mapa
    maptqhqtthc = new L.Map('LeafLettqhqtthc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptqhqtthc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptqhqtthc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptqhqtthc === 'undefined') {
    varinitmaptqhqtthc = initmaptqhqtthc();
  };
});
FINAL;
    } // constructor
