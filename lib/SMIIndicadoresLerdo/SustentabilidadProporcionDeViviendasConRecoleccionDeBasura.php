<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadProporcionDeViviendasConRecoleccionDeBasura
 *
...
class SustentabilidadProporcionDeViviendasConRecoleccionDeBasura extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Proporción de viviendas con recolección de basura en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '90.5500', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda')); // formateado 0, valor 2, crudo 1
    } // datos
