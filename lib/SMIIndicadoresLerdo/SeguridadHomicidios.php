...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxmvgoiwp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjlfqkvyn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxmvgoiwp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxmvgoiwp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjlfqkvyn === 'undefined') {
    varMorrisjlfqkvyn = Morris.Line({
      element: 'Morrisjlfqkvyn',
