...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascymybncr">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisozjfyffi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascymybncr a:first').tab('show')
});
// LENGUETA
$('#Lenguetascymybncr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisozjfyffi === 'undefined') {
    varMorrisozjfyffi = Morris.Line({
      element: 'Morrisozjfyffi',
