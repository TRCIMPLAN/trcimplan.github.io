...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskqufpbtd">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishdzunaaq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskqufpbtd a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskqufpbtd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishdzunaaq === 'undefined') {
    varMorrishdzunaaq = Morris.Line({
      element: 'Morrishdzunaaq',
