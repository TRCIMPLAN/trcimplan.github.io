...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasahqvshws">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswosjbcod" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasahqvshws a:first').tab('show')
});
// LENGUETA
$('#Lenguetasahqvshws a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswosjbcod === 'undefined') {
    varMorriswosjbcod = Morris.Line({
      element: 'Morriswosjbcod',
