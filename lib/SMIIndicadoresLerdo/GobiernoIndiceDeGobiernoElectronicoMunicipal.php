...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskkxbqcuh">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrzfasrdy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskkxbqcuh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskkxbqcuh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprzfasrdy;
  ...
  function initmaprzfasrdy() {
    // Nuevo Mapa
    maprzfasrdy = new L.Map('LeafLetrzfasrdy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprzfasrdy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprzfasrdy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprzfasrdy === 'undefined') {
    varinitmaprzfasrdy = initmaprzfasrdy();
  };
});
FINAL;
    } // constructor
