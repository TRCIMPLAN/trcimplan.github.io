...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvzntkfkc">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteovhqliq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvzntkfkc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvzntkfkc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeovhqliq;
  ...
  function initmapeovhqliq() {
    // Nuevo Mapa
    mapeovhqliq = new L.Map('LeafLeteovhqliq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeovhqliq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeovhqliq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeovhqliq === 'undefined') {
    varinitmapeovhqliq = initmapeovhqliq();
  };
});
FINAL;
    } // constructor
