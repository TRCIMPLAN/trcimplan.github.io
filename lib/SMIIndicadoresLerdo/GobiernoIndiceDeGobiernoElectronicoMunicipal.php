...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvmarfqwj">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetimvtxahs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvmarfqwj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvmarfqwj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapimvtxahs;
  ...
  function initmapimvtxahs() {
    // Nuevo Mapa
    mapimvtxahs = new L.Map('LeafLetimvtxahs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapimvtxahs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapimvtxahs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapimvtxahs === 'undefined') {
    varinitmapimvtxahs = initmapimvtxahs();
  };
});
FINAL;
    } // constructor
