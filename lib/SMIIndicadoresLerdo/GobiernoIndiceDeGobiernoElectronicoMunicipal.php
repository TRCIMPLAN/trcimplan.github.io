...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasduargzjs">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettcisthos" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasduargzjs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasduargzjs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptcisthos;
  ...
  function initmaptcisthos() {
    // Nuevo Mapa
    maptcisthos = new L.Map('LeafLettcisthos');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptcisthos.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptcisthos.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptcisthos === 'undefined') {
    varinitmaptcisthos = initmaptcisthos();
  };
});
FINAL;
    } // constructor
