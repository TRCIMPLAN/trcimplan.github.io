...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbokzcsjt">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetclfxyiow" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbokzcsjt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbokzcsjt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapclfxyiow;
  ...
  function initmapclfxyiow() {
    // Nuevo Mapa
    mapclfxyiow = new L.Map('LeafLetclfxyiow');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapclfxyiow.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapclfxyiow.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapclfxyiow === 'undefined') {
    varinitmapclfxyiow = initmapclfxyiow();
  };
});
FINAL;
    } // constructor
