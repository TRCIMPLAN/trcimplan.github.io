...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfeeyqgzw">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbcpowwrv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfeeyqgzw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfeeyqgzw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbcpowwrv;
  ...
  function initmapbcpowwrv() {
    // Nuevo Mapa
    mapbcpowwrv = new L.Map('LeafLetbcpowwrv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbcpowwrv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbcpowwrv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbcpowwrv === 'undefined') {
    varinitmapbcpowwrv = initmapbcpowwrv();
  };
});
FINAL;
    } // constructor
