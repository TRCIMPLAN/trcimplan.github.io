...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbuwergek">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwlbpfisz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbuwergek a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbuwergek a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwlbpfisz;
  ...
  function initmapwlbpfisz() {
    // Nuevo Mapa
    mapwlbpfisz = new L.Map('LeafLetwlbpfisz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwlbpfisz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwlbpfisz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwlbpfisz === 'undefined') {
    varinitmapwlbpfisz = initmapwlbpfisz();
  };
});
FINAL;
    } // constructor
