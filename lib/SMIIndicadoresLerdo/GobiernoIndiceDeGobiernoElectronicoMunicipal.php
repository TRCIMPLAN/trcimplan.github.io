...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvrlzyetx">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxfsrgnhn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvrlzyetx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvrlzyetx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxfsrgnhn;
  ...
  function initmapxfsrgnhn() {
    // Nuevo Mapa
    mapxfsrgnhn = new L.Map('LeafLetxfsrgnhn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxfsrgnhn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxfsrgnhn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxfsrgnhn === 'undefined') {
    varinitmapxfsrgnhn = initmapxfsrgnhn();
  };
});
FINAL;
    } // constructor
