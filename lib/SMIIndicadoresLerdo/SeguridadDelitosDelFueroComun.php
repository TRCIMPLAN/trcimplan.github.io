<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SeguridadDelitosDelFueroComun
 *
...
class SeguridadDelitosDelFueroComun extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Delitos del Fuero Común en Lerdo';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2017-12-31', 'valor' => '166', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 94, crudo 47
    } // datos
