...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfazyidtk">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetncmwgrtj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfazyidtk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfazyidtk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapncmwgrtj;
  ...
  function initmapncmwgrtj() {
    // Nuevo Mapa
    mapncmwgrtj = new L.Map('LeafLetncmwgrtj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapncmwgrtj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapncmwgrtj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapncmwgrtj === 'undefined') {
    varinitmapncmwgrtj = initmapncmwgrtj();
  };
});
FINAL;
    } // constructor
