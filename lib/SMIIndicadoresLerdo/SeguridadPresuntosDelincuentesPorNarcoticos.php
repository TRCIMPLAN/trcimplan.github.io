...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascayvmubh">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiopoowva" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascayvmubh a:first').tab('show')
});
// LENGUETA
$('#Lenguetascayvmubh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiopoowva;
  ...
  function initmapiopoowva() {
    // Nuevo Mapa
    mapiopoowva = new L.Map('LeafLetiopoowva');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiopoowva.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiopoowva.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiopoowva === 'undefined') {
    varinitmapiopoowva = initmapiopoowva();
  };
});
FINAL;
    } // constructor
