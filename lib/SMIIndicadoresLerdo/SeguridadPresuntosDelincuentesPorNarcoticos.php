...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmhlbhovu">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkiunoflb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmhlbhovu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmhlbhovu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkiunoflb;
  ...
  function initmapkiunoflb() {
    // Nuevo Mapa
    mapkiunoflb = new L.Map('LeafLetkiunoflb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkiunoflb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkiunoflb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkiunoflb === 'undefined') {
    varinitmapkiunoflb = initmapkiunoflb();
  };
});
FINAL;
    } // constructor
