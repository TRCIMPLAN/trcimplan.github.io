...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuvhllhye">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdjlgagol" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuvhllhye a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuvhllhye a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdjlgagol;
  ...
  function initmapdjlgagol() {
    // Nuevo Mapa
    mapdjlgagol = new L.Map('LeafLetdjlgagol');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdjlgagol.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdjlgagol.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdjlgagol === 'undefined') {
    varinitmapdjlgagol = initmapdjlgagol();
  };
});
FINAL;
    } // constructor
