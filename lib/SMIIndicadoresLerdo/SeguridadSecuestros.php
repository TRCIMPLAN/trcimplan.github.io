...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdccmdgmw">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdvojxsyc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdccmdgmw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdccmdgmw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdvojxsyc;
  ...
  function initmapdvojxsyc() {
    // Nuevo Mapa
    mapdvojxsyc = new L.Map('LeafLetdvojxsyc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdvojxsyc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdvojxsyc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdvojxsyc === 'undefined') {
    varinitmapdvojxsyc = initmapdvojxsyc();
  };
});
FINAL;
    } // constructor
