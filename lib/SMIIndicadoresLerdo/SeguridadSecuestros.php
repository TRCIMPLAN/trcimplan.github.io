...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfzqagrtd">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdtrwcmuv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfzqagrtd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfzqagrtd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdtrwcmuv;
  ...
  function initmapdtrwcmuv() {
    // Nuevo Mapa
    mapdtrwcmuv = new L.Map('LeafLetdtrwcmuv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdtrwcmuv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdtrwcmuv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdtrwcmuv === 'undefined') {
    varinitmapdtrwcmuv = initmapdtrwcmuv();
  };
});
FINAL;
    } // constructor
