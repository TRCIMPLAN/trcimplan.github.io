...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgmtshvat">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyzknwfoy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgmtshvat a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgmtshvat a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyzknwfoy;
  ...
  function initmapyzknwfoy() {
    // Nuevo Mapa
    mapyzknwfoy = new L.Map('LeafLetyzknwfoy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyzknwfoy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyzknwfoy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyzknwfoy === 'undefined') {
    varinitmapyzknwfoy = initmapyzknwfoy();
  };
});
FINAL;
    } // constructor
