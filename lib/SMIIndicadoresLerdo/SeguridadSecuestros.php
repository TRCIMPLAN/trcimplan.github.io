...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascabedvpu">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwqgqnqjx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascabedvpu a:first').tab('show')
});
// LENGUETA
$('#Lenguetascabedvpu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwqgqnqjx;
  ...
  function initmapwqgqnqjx() {
    // Nuevo Mapa
    mapwqgqnqjx = new L.Map('LeafLetwqgqnqjx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwqgqnqjx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwqgqnqjx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwqgqnqjx === 'undefined') {
    varinitmapwqgqnqjx = initmapwqgqnqjx();
  };
});
FINAL;
    } // constructor
