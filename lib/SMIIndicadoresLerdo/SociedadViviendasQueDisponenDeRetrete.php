...
class SociedadViviendasQueDisponenDeRetrete extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgkrhhvvt">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfkmzfmfj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgkrhhvvt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgkrhhvvt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfkmzfmfj;
  ...
  function initmapfkmzfmfj() {
    // Nuevo Mapa
    mapfkmzfmfj = new L.Map('LeafLetfkmzfmfj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfkmzfmfj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfkmzfmfj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfkmzfmfj === 'undefined') {
    varinitmapfkmzfmfj = initmapfkmzfmfj();
  };
});
FINAL;
    } // constructor
