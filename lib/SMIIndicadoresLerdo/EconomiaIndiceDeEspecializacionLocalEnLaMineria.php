...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswjmxnjpp">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgnrquxnv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswjmxnjpp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswjmxnjpp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgnrquxnv;
  ...
  function initmapgnrquxnv() {
    // Nuevo Mapa
    mapgnrquxnv = new L.Map('LeafLetgnrquxnv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgnrquxnv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgnrquxnv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgnrquxnv === 'undefined') {
    varinitmapgnrquxnv = initmapgnrquxnv();
  };
});
FINAL;
    } // constructor
