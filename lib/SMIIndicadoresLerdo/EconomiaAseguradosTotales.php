<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaAseguradosTotales
 *
...
class EconomiaAseguradosTotales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Asegurados Totales en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-01-31', 'valor' => '16377', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-02-28', 'valor' => '16253', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-03-31', 'valor' => '16530', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-04-30', 'valor' => '16595', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-05-31', 'valor' => '16724', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-06-30', 'valor' => '16920', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)')); // formateado 0, valor 12, crudo 6
    } // datos
