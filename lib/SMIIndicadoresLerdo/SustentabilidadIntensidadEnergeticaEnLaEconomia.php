<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadIntensidadEnergeticaEnLaEconomia
 *
...
class SustentabilidadIntensidadEnergeticaEnLaEconomia extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Intensidad Energética en la Economía en Lerdo';
        ...
        $this->claves      = 'IMPLAN, Lerdo, Índice de Competitividad Urbana, Recursos Naturales, Medio Ambiente';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '131105188.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2011-12-31', 'valor' => '131105188.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2012-12-31', 'valor' => '131105188.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2013-12-31', 'valor' => '128210647.0000', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2014-12-31', 'valor' => '132342389.0000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 10, crudo 5
    } // datos
