...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvrrxwzne">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmsyohfxv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvrrxwzne a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvrrxwzne a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmsyohfxv;
  ...
  function initmapmsyohfxv() {
    // Nuevo Mapa
    mapmsyohfxv = new L.Map('LeafLetmsyohfxv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmsyohfxv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmsyohfxv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmsyohfxv === 'undefined') {
    varinitmapmsyohfxv = initmapmsyohfxv();
  };
});
FINAL;
    } // constructor
