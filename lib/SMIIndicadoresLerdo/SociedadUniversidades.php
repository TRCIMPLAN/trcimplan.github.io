...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasefhhbdub">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetscnmxols" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasefhhbdub a:first').tab('show')
});
// LENGUETA
$('#Lenguetasefhhbdub a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapscnmxols;
  ...
  function initmapscnmxols() {
    // Nuevo Mapa
    mapscnmxols = new L.Map('LeafLetscnmxols');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapscnmxols.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapscnmxols.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapscnmxols === 'undefined') {
    varinitmapscnmxols = initmapscnmxols();
  };
});
FINAL;
    } // constructor
