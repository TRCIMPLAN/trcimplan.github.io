...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdwoenvoe">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlkawxrlu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdwoenvoe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdwoenvoe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplkawxrlu;
  ...
  function initmaplkawxrlu() {
    // Nuevo Mapa
    maplkawxrlu = new L.Map('LeafLetlkawxrlu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplkawxrlu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplkawxrlu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplkawxrlu === 'undefined') {
    varinitmaplkawxrlu = initmaplkawxrlu();
  };
});
FINAL;
    } // constructor
