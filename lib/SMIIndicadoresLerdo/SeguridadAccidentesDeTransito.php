<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SeguridadAccidentesDeTransito
 *
...
class SeguridadAccidentesDeTransito extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Accidentes de Tránsito en Lerdo';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2016-12-31', 'valor' => '342', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2017-12-31', 'valor' => '281', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2018-12-31', 'valor' => '243', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 44, crudo 23
    } // datos
