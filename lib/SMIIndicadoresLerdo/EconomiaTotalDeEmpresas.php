...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgnfyknpq">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrchpwedb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyubuydpy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgnfyknpq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgnfyknpq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrchpwedb === 'undefined') {
    varMorrisrchpwedb = Morris.Line({
      element: 'Morrisrchpwedb',
...
// LENGUETA
$('#Lenguetasgnfyknpq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyubuydpy;
  ...
  function initmapyubuydpy() {
    // Nuevo Mapa
    mapyubuydpy = new L.Map('LeafLetyubuydpy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyubuydpy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyubuydpy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyubuydpy === 'undefined') {
    varinitmapyubuydpy = initmapyubuydpy();
  };
});
FINAL;
    } // constructor
