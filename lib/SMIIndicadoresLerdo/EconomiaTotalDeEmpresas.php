...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashoaovcww">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisltabkdfp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnqynlxan" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashoaovcww a:first').tab('show')
});
// LENGUETA
$('#Lenguetashoaovcww a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisltabkdfp === 'undefined') {
    varMorrisltabkdfp = Morris.Line({
      element: 'Morrisltabkdfp',
...
// LENGUETA
$('#Lenguetashoaovcww a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnqynlxan;
  ...
  function initmapnqynlxan() {
    // Nuevo Mapa
    mapnqynlxan = new L.Map('LeafLetnqynlxan');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnqynlxan.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnqynlxan.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnqynlxan === 'undefined') {
    varinitmapnqynlxan = initmapnqynlxan();
  };
});
FINAL;
    } // constructor
