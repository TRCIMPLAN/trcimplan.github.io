...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasihmbjhqp">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrmalmbwe" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnkubwrrg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasihmbjhqp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasihmbjhqp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrmalmbwe === 'undefined') {
    varMorrisrmalmbwe = Morris.Line({
      element: 'Morrisrmalmbwe',
...
// LENGUETA
$('#Lenguetasihmbjhqp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnkubwrrg;
  ...
  function initmapnkubwrrg() {
    // Nuevo Mapa
    mapnkubwrrg = new L.Map('LeafLetnkubwrrg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnkubwrrg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnkubwrrg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnkubwrrg === 'undefined') {
    varinitmapnkubwrrg = initmapnkubwrrg();
  };
});
FINAL;
    } // constructor
