...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmuzfczuh">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismxvnnbna" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetntdzprgt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmuzfczuh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmuzfczuh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismxvnnbna === 'undefined') {
    varMorrismxvnnbna = Morris.Line({
      element: 'Morrismxvnnbna',
...
// LENGUETA
$('#Lenguetasmuzfczuh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapntdzprgt;
  ...
  function initmapntdzprgt() {
    // Nuevo Mapa
    mapntdzprgt = new L.Map('LeafLetntdzprgt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapntdzprgt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapntdzprgt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapntdzprgt === 'undefined') {
    varinitmapntdzprgt = initmapntdzprgt();
  };
});
FINAL;
    } // constructor
