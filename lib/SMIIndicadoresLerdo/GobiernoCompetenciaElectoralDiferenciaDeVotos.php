...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasibfnklhu">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetenxcsozk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasibfnklhu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasibfnklhu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapenxcsozk;
  ...
  function initmapenxcsozk() {
    // Nuevo Mapa
    mapenxcsozk = new L.Map('LeafLetenxcsozk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapenxcsozk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapenxcsozk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapenxcsozk === 'undefined') {
    varinitmapenxcsozk = initmapenxcsozk();
  };
});
FINAL;
    } // constructor
