...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastvngvbkf">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdmdpcjzx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastvngvbkf a:first').tab('show')
});
// LENGUETA
$('#Lenguetastvngvbkf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdmdpcjzx;
  ...
  function initmapdmdpcjzx() {
    // Nuevo Mapa
    mapdmdpcjzx = new L.Map('LeafLetdmdpcjzx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdmdpcjzx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdmdpcjzx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdmdpcjzx === 'undefined') {
    varinitmapdmdpcjzx = initmapdmdpcjzx();
  };
});
FINAL;
    } // constructor
