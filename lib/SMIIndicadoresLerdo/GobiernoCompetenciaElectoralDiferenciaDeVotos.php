...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashqgqsrmz">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfebvcxfs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashqgqsrmz a:first').tab('show')
});
// LENGUETA
$('#Lenguetashqgqsrmz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfebvcxfs;
  ...
  function initmapfebvcxfs() {
    // Nuevo Mapa
    mapfebvcxfs = new L.Map('LeafLetfebvcxfs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfebvcxfs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfebvcxfs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfebvcxfs === 'undefined') {
    varinitmapfebvcxfs = initmapfebvcxfs();
  };
});
FINAL;
    } // constructor
