...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxrksgour">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetunbsufin" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxrksgour a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxrksgour a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapunbsufin;
  ...
  function initmapunbsufin() {
    // Nuevo Mapa
    mapunbsufin = new L.Map('LeafLetunbsufin');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapunbsufin.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapunbsufin.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapunbsufin === 'undefined') {
    varinitmapunbsufin = initmapunbsufin();
  };
});
FINAL;
    } // constructor
