...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasudfacxpl">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrbtutmxd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasudfacxpl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasudfacxpl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprbtutmxd;
  ...
  function initmaprbtutmxd() {
    // Nuevo Mapa
    maprbtutmxd = new L.Map('LeafLetrbtutmxd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprbtutmxd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprbtutmxd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprbtutmxd === 'undefined') {
    varinitmaprbtutmxd = initmaprbtutmxd();
  };
});
FINAL;
    } // constructor
