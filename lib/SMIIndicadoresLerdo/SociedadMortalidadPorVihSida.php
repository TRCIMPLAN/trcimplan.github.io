...
class SociedadMortalidadPorVihSida extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Lerdo, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '3.3000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
