...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasspkthtbn">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmymmfcpk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasspkthtbn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasspkthtbn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmymmfcpk;
  ...
  function initmapmymmfcpk() {
    // Nuevo Mapa
    mapmymmfcpk = new L.Map('LeafLetmymmfcpk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmymmfcpk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmymmfcpk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmymmfcpk === 'undefined') {
    varinitmapmymmfcpk = initmapmymmfcpk();
  };
});
FINAL;
    } // constructor
