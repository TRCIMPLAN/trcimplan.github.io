...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.0000 },{ fecha: '2009-12-31', dato: 0.0000 },{ fecha: '2010-12-31', dato: 0.0000 },{ fecha: '2011-12-31', dato: 19.3548 },{ fecha: '2012-12-31', dato: 29.4118 },{ fecha: '2013-12-31', dato: 28.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
