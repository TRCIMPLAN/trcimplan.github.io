...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslrddlxao">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetewisbxmi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslrddlxao a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslrddlxao a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapewisbxmi;
  ...
  function initmapewisbxmi() {
    // Nuevo Mapa
    mapewisbxmi = new L.Map('LeafLetewisbxmi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapewisbxmi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapewisbxmi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapewisbxmi === 'undefined') {
    varinitmapewisbxmi = initmapewisbxmi();
  };
});
FINAL;
    } // constructor
