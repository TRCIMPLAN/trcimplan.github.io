...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassfjvoewz">
...
<div id="Morriscniojwlv" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfolaygpy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassfjvoewz a:first').tab('show')
});
// LENGUETA
$('#Lenguetassfjvoewz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscniojwlv === 'undefined') {
    varMorriscniojwlv = Morris.Line({
      element: 'Morriscniojwlv',
...
// LENGUETA
$('#Lenguetassfjvoewz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfolaygpy;
  ...
  function initmapfolaygpy() {
    // Nuevo Mapa
    mapfolaygpy = new L.Map('LeafLetfolaygpy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfolaygpy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfolaygpy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfolaygpy === 'undefined') {
    varinitmapfolaygpy = initmapfolaygpy();
  };
});
FINAL;
    } // constructor
