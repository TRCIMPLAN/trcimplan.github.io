<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Inversión Extranjera Directa (Neta) (Creado por Central:SmiLanzadera)
 *
...
<p>Dólares per cápita (promedio móvil tres años).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Inversión Extranjera Directa (Neta) en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 56.67 },{ fecha: '2009-12-31', dato: 52.66 },{ fecha: '2010-12-31', dato: 68.80 },{ fecha: '2011-12-31', dato: 45.77 },{ fecha: '2012-12-31', dato: 64.53 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
