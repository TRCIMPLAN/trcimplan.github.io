...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasclijlqoa">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqtilhvko" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasclijlqoa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasclijlqoa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqtilhvko;
  ...
  function initmapqtilhvko() {
    // Nuevo Mapa
    mapqtilhvko = new L.Map('LeafLetqtilhvko');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqtilhvko.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqtilhvko.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqtilhvko === 'undefined') {
    varinitmapqtilhvko = initmapqtilhvko();
  };
});
FINAL;
    } // constructor
