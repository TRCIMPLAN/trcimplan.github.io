...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyfbrrwlc">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlxdgtfjj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyfbrrwlc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyfbrrwlc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplxdgtfjj;
  ...
  function initmaplxdgtfjj() {
    // Nuevo Mapa
    maplxdgtfjj = new L.Map('LeafLetlxdgtfjj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplxdgtfjj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplxdgtfjj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplxdgtfjj === 'undefined') {
    varinitmaplxdgtfjj = initmaplxdgtfjj();
  };
});
FINAL;
    } // constructor
