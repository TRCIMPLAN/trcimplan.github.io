...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassahtjdme">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbnwtoyai" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassahtjdme a:first').tab('show')
});
// LENGUETA
$('#Lenguetassahtjdme a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbnwtoyai;
  ...
  function initmapbnwtoyai() {
    // Nuevo Mapa
    mapbnwtoyai = new L.Map('LeafLetbnwtoyai');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbnwtoyai.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbnwtoyai.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbnwtoyai === 'undefined') {
    varinitmapbnwtoyai = initmapbnwtoyai();
  };
});
FINAL;
    } // constructor
