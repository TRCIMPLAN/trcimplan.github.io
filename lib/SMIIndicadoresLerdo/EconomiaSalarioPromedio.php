<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Salario promedio (Creado por Central:SmiLanzadera)
 *
...
class EconomiaSalarioPromedio extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Salario promedio en Lerdo';
     // $this->autor             = '';
...
<p>Salario promedio mensual para personal ocupado con jornadas laborales de 35 a 48 horas semanales.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Salario promedio en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2015-03-31', dato: 5518.95 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
