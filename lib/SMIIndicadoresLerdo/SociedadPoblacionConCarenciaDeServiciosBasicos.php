<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadPoblacionConCarenciaDeServiciosBasicos
 *
...
class SociedadPoblacionConCarenciaDeServiciosBasicos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con carencia de servicios básicos en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '7.0000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '6.3000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
