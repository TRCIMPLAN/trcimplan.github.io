...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashhcpdcuo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristibnmqmu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashhcpdcuo a:first').tab('show')
});
// LENGUETA
$('#Lenguetashhcpdcuo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristibnmqmu === 'undefined') {
    varMorristibnmqmu = Morris.Line({
      element: 'Morristibnmqmu',
