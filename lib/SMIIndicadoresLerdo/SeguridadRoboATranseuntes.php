...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnayuzslk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrrfmwnft" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnayuzslk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnayuzslk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrrfmwnft === 'undefined') {
    varMorrisrrfmwnft = Morris.Line({
      element: 'Morrisrrfmwnft',
