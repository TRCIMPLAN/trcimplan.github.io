...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfyfueqwo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoroxtfpk" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetozkcurdx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfyfueqwo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfyfueqwo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoroxtfpk === 'undefined') {
    varMorrisoroxtfpk = Morris.Line({
      element: 'Morrisoroxtfpk',
      data: [{ fecha: '2014-01-31', dato: 4 },{ fecha: '2014-02-28', dato: 14 },{ fecha: '2014-03-31', dato: 6 },{ fecha: '2014-04-30', dato: 8 },{ fecha: '2014-05-31', dato: 5 },{ fecha: '2014-06-30', dato: 13 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetasfyfueqwo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapozkcurdx;
  ...
  function initmapozkcurdx() {
    // Nuevo Mapa
    mapozkcurdx = new L.Map('LeafLetozkcurdx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapozkcurdx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapozkcurdx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapozkcurdx === 'undefined') {
    varinitmapozkcurdx = initmapozkcurdx();
  };
});
FINAL;
    } // constructor
