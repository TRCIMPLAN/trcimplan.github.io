...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspasnexsi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisukdxxnhv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspasnexsi a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspasnexsi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisukdxxnhv === 'undefined') {
    varMorrisukdxxnhv = Morris.Line({
      element: 'Morrisukdxxnhv',
