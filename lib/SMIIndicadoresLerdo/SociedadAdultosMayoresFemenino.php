...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascsvbxtiw">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxzjhbgur" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetinpgcxpu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascsvbxtiw a:first').tab('show')
});
// LENGUETA
$('#Lenguetascsvbxtiw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxzjhbgur === 'undefined') {
    varMorrisxzjhbgur = Morris.Line({
      element: 'Morrisxzjhbgur',
...
// LENGUETA
$('#Lenguetascsvbxtiw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapinpgcxpu;
  ...
  function initmapinpgcxpu() {
    // Nuevo Mapa
    mapinpgcxpu = new L.Map('LeafLetinpgcxpu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapinpgcxpu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapinpgcxpu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapinpgcxpu === 'undefined') {
    varinitmapinpgcxpu = initmapinpgcxpu();
  };
});
FINAL;
    } // constructor
