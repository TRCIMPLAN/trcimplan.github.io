...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasghzfaatn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisninnhpgw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasghzfaatn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasghzfaatn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisninnhpgw === 'undefined') {
    varMorrisninnhpgw = Morris.Line({
      element: 'Morrisninnhpgw',
