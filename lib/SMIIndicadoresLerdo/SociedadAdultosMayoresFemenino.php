...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuaoqthnn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnakioezr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuaoqthnn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuaoqthnn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnakioezr === 'undefined') {
    varMorrisnakioezr = Morris.Line({
      element: 'Morrisnakioezr',
