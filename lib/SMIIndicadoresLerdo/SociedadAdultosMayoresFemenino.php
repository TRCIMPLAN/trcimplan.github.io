...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrkjxezdb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdvruuwaw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjthkrpli" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrkjxezdb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrkjxezdb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdvruuwaw === 'undefined') {
    varMorrisdvruuwaw = Morris.Line({
      element: 'Morrisdvruuwaw',
...
// LENGUETA
$('#Lenguetasrkjxezdb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjthkrpli;
  ...
  function initmapjthkrpli() {
    // Nuevo Mapa
    mapjthkrpli = new L.Map('LeafLetjthkrpli');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjthkrpli.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjthkrpli.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjthkrpli === 'undefined') {
    varinitmapjthkrpli = initmapjthkrpli();
  };
});
FINAL;
    } // constructor
