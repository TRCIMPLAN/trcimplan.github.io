...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasejducrhi">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnxcdvopz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasejducrhi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasejducrhi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnxcdvopz;
  ...
  function initmapnxcdvopz() {
    // Nuevo Mapa
    mapnxcdvopz = new L.Map('LeafLetnxcdvopz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnxcdvopz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnxcdvopz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnxcdvopz === 'undefined') {
    varinitmapnxcdvopz = initmapnxcdvopz();
  };
});
FINAL;
    } // constructor
