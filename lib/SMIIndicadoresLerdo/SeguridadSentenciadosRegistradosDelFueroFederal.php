...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslnwpiljq">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetazbnpllr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslnwpiljq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslnwpiljq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapazbnpllr;
  ...
  function initmapazbnpllr() {
    // Nuevo Mapa
    mapazbnpllr = new L.Map('LeafLetazbnpllr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapazbnpllr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapazbnpllr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapazbnpllr === 'undefined') {
    varinitmapazbnpllr = initmapazbnpllr();
  };
});
FINAL;
    } // constructor
