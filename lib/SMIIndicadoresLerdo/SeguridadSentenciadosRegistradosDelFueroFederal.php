...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiekioosn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrwhebxuy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiekioosn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiekioosn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprwhebxuy;
  ...
  function initmaprwhebxuy() {
    // Nuevo Mapa
    maprwhebxuy = new L.Map('LeafLetrwhebxuy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprwhebxuy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprwhebxuy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprwhebxuy === 'undefined') {
    varinitmaprwhebxuy = initmaprwhebxuy();
  };
});
FINAL;
    } // constructor
