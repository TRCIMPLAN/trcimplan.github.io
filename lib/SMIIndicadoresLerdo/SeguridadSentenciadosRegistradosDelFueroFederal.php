...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasplhywpkq">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgucpjjbc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasplhywpkq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasplhywpkq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgucpjjbc;
  ...
  function initmapgucpjjbc() {
    // Nuevo Mapa
    mapgucpjjbc = new L.Map('LeafLetgucpjjbc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgucpjjbc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgucpjjbc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgucpjjbc === 'undefined') {
    varinitmapgucpjjbc = initmapgucpjjbc();
  };
});
FINAL;
    } // constructor
