...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslbzdwpyg">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqlpvzeyl" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslbzdwpyg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslbzdwpyg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqlpvzeyl === 'undefined') {
    varMorrisqlpvzeyl = Morris.Line({
      element: 'Morrisqlpvzeyl',
