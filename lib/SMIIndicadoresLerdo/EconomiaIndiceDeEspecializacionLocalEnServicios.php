...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasefohshhs">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfxqgevdr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasefohshhs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasefohshhs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfxqgevdr === 'undefined') {
    varMorrisfxqgevdr = Morris.Line({
      element: 'Morrisfxqgevdr',
