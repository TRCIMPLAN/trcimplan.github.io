...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdrxufkwm">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisatsxcexz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetokxbtmra" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdrxufkwm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdrxufkwm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisatsxcexz === 'undefined') {
    varMorrisatsxcexz = Morris.Line({
      element: 'Morrisatsxcexz',
...
// LENGUETA
$('#Lenguetasdrxufkwm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapokxbtmra;
  ...
  function initmapokxbtmra() {
    // Nuevo Mapa
    mapokxbtmra = new L.Map('LeafLetokxbtmra');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapokxbtmra.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapokxbtmra.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapokxbtmra === 'undefined') {
    varinitmapokxbtmra = initmapokxbtmra();
  };
});
FINAL;
    } // constructor
