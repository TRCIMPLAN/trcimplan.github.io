...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslhglyqkk">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjqndxkcm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslhglyqkk a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslhglyqkk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjqndxkcm;
  ...
  function initmapjqndxkcm() {
    // Nuevo Mapa
    mapjqndxkcm = new L.Map('LeafLetjqndxkcm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjqndxkcm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjqndxkcm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjqndxkcm === 'undefined') {
    varinitmapjqndxkcm = initmapjqndxkcm();
  };
});
FINAL;
    } // constructor
