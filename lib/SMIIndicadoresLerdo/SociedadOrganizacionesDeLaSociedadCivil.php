...
class SociedadOrganizacionesDeLaSociedadCivil extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Organizaciones de la Sociedad Civil en Lerdo con fuente IMCO</h3>
...
FINAL;
    ...
    protected function seccion_grafica_2_html() {
        return <<<FINAL
      <h3>Gráfica de Organizaciones de la Sociedad Civil en Lerdo con fuente RFOSC</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosRfosc === 'undefined') {
    vargraficaDatosRfosc = Morris.Line({
      ...
      data: [{ fecha: '2014-03-31', dato: 22.7000 },{ fecha: '2016-11-25', dato: 31.3000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
