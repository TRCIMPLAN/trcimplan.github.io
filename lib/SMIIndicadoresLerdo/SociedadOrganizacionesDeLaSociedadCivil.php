...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjfchhltg">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetplfwowdj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjfchhltg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjfchhltg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapplfwowdj;
  ...
  function initmapplfwowdj() {
    // Nuevo Mapa
    mapplfwowdj = new L.Map('LeafLetplfwowdj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapplfwowdj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapplfwowdj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapplfwowdj === 'undefined') {
    varinitmapplfwowdj = initmapplfwowdj();
  };
});
FINAL;
    } // constructor
