...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnjxxptkd">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcvwlpmgp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnjxxptkd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnjxxptkd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcvwlpmgp;
  ...
  function initmapcvwlpmgp() {
    // Nuevo Mapa
    mapcvwlpmgp = new L.Map('LeafLetcvwlpmgp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcvwlpmgp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcvwlpmgp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcvwlpmgp === 'undefined') {
    varinitmapcvwlpmgp = initmapcvwlpmgp();
  };
});
FINAL;
    } // constructor
