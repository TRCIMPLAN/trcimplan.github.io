...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaqpmgnkq">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetljuxjhpn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaqpmgnkq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaqpmgnkq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapljuxjhpn;
  ...
  function initmapljuxjhpn() {
    // Nuevo Mapa
    mapljuxjhpn = new L.Map('LeafLetljuxjhpn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapljuxjhpn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapljuxjhpn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapljuxjhpn === 'undefined') {
    varinitmapljuxjhpn = initmapljuxjhpn();
  };
});
FINAL;
    } // constructor
