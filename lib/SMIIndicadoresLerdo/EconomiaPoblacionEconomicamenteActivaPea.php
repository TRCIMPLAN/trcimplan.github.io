<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaPoblacionEconomicamenteActivaPea
 *
...
class EconomiaPoblacionEconomicamenteActivaPea extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población Económicamente Activa (PEA) en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '54779', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
