<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Tasa de Condiciones Críticas de Ocupación (Creado por Central:SmiLanzadera)
 *
...
class EconomiaTasaDeCondicionesCriticasDeOcupacion extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tasa de Condiciones Críticas de Ocupación en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2016-03-31', dato: 8.8900 },{ fecha: '2016-09-30', dato: 9.2100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
