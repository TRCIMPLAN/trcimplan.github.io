<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sociedad Diferencial de Grado Promedio de Escolaridad por Género (Creado por Central:SmiLanzadera)
 *
...
<p>Años de escolaridad.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Diferencial de Grado Promedio de Escolaridad por Género en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: -0.0600 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
