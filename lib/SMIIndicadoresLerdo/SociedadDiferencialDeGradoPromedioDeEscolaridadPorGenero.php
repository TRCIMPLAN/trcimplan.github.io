...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascjmjrilw">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkqufulvx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascjmjrilw a:first').tab('show')
});
// LENGUETA
$('#Lenguetascjmjrilw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkqufulvx;
  ...
  function initmapkqufulvx() {
    // Nuevo Mapa
    mapkqufulvx = new L.Map('LeafLetkqufulvx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkqufulvx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkqufulvx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkqufulvx === 'undefined') {
    varinitmapkqufulvx = initmapkqufulvx();
  };
});
FINAL;
    } // constructor
