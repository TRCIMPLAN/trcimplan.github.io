...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdvubiost">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnvkmanwr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdvubiost a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdvubiost a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnvkmanwr;
  ...
  function initmapnvkmanwr() {
    // Nuevo Mapa
    mapnvkmanwr = new L.Map('LeafLetnvkmanwr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnvkmanwr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnvkmanwr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnvkmanwr === 'undefined') {
    varinitmapnvkmanwr = initmapnvkmanwr();
  };
});
FINAL;
    } // constructor
