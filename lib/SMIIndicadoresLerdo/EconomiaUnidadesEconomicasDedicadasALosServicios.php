...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasexqrjsof">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqcdqptdt" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqfdascxy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasexqrjsof a:first').tab('show')
});
// LENGUETA
$('#Lenguetasexqrjsof a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqcdqptdt === 'undefined') {
    varMorrisqcdqptdt = Morris.Line({
      element: 'Morrisqcdqptdt',
...
// LENGUETA
$('#Lenguetasexqrjsof a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqfdascxy;
  ...
  function initmapqfdascxy() {
    // Nuevo Mapa
    mapqfdascxy = new L.Map('LeafLetqfdascxy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqfdascxy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqfdascxy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqfdascxy === 'undefined') {
    varinitmapqfdascxy = initmapqfdascxy();
  };
});
FINAL;
    } // constructor
