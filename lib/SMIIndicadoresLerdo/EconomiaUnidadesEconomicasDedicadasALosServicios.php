...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascalivcsb">
...
<div id="Morriskqrshhan" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgnktyqlx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascalivcsb a:first').tab('show')
});
// LENGUETA
$('#Lenguetascalivcsb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskqrshhan === 'undefined') {
    varMorriskqrshhan = Morris.Line({
      element: 'Morriskqrshhan',
...
// LENGUETA
$('#Lenguetascalivcsb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgnktyqlx;
  ...
  function initmapgnktyqlx() {
    // Nuevo Mapa
    mapgnktyqlx = new L.Map('LeafLetgnktyqlx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgnktyqlx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgnktyqlx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgnktyqlx === 'undefined') {
    varinitmapgnktyqlx = initmapgnktyqlx();
  };
});
FINAL;
    } // constructor
