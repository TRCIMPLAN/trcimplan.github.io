...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjdtutiuk">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbdvjzfxg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjdtutiuk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjdtutiuk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbdvjzfxg;
  ...
  function initmapbdvjzfxg() {
    // Nuevo Mapa
    mapbdvjzfxg = new L.Map('LeafLetbdvjzfxg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbdvjzfxg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbdvjzfxg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbdvjzfxg === 'undefined') {
    varinitmapbdvjzfxg = initmapbdvjzfxg();
  };
});
FINAL;
    } // constructor
