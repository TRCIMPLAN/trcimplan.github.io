...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasztkbsnjl">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettgpifuqf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasztkbsnjl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasztkbsnjl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptgpifuqf;
  ...
  function initmaptgpifuqf() {
    // Nuevo Mapa
    maptgpifuqf = new L.Map('LeafLettgpifuqf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptgpifuqf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptgpifuqf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptgpifuqf === 'undefined') {
    varinitmaptgpifuqf = initmaptgpifuqf();
  };
});
FINAL;
    } // constructor
