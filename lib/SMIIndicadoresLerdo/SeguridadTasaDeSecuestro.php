...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswespumwg">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetigosgwvn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswespumwg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswespumwg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapigosgwvn;
  ...
  function initmapigosgwvn() {
    // Nuevo Mapa
    mapigosgwvn = new L.Map('LeafLetigosgwvn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapigosgwvn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapigosgwvn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapigosgwvn === 'undefined') {
    varinitmapigosgwvn = initmapigosgwvn();
  };
});
FINAL;
    } // constructor
