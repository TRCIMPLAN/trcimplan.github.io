...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskgskuybg">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmxtyoffr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskgskuybg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskgskuybg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmxtyoffr;
  ...
  function initmapmxtyoffr() {
    // Nuevo Mapa
    mapmxtyoffr = new L.Map('LeafLetmxtyoffr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmxtyoffr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmxtyoffr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmxtyoffr === 'undefined') {
    varinitmapmxtyoffr = initmapmxtyoffr();
  };
});
FINAL;
    } // constructor
