...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgzwpdite">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwqykoysp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgzwpdite a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgzwpdite a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwqykoysp;
  ...
  function initmapwqykoysp() {
    // Nuevo Mapa
    mapwqykoysp = new L.Map('LeafLetwqykoysp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwqykoysp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwqykoysp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwqykoysp === 'undefined') {
    varinitmapwqykoysp = initmapwqykoysp();
  };
});
FINAL;
    } // constructor
