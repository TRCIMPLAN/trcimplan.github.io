<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadSuperficieUrbana
 *
...
class SustentabilidadSuperficieUrbana extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Superficie Urbana en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '30.7774', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
