...
class GobiernoIngresosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxavrgdsc">
...
<div id="Morrisqytogjao" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxlgwubag" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxavrgdsc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxavrgdsc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqytogjao === 'undefined') {
    varMorrisqytogjao = Morris.Line({
      element: 'Morrisqytogjao',
...
// LENGUETA
$('#Lenguetasxavrgdsc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxlgwubag;
  ...
  function initmapxlgwubag() {
    // Nuevo Mapa
    mapxlgwubag = new L.Map('LeafLetxlgwubag');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxlgwubag.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxlgwubag.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxlgwubag === 'undefined') {
    varinitmapxlgwubag = initmapxlgwubag();
  };
});
FINAL;
    } // constructor
