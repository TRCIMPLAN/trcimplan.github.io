...
class GobiernoIngresosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslmtebibe">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgbucwurn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgmzurslj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslmtebibe a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslmtebibe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgbucwurn === 'undefined') {
    varMorrisgbucwurn = Morris.Line({
      element: 'Morrisgbucwurn',
...
// LENGUETA
$('#Lenguetaslmtebibe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgmzurslj;
  ...
  function initmapgmzurslj() {
    // Nuevo Mapa
    mapgmzurslj = new L.Map('LeafLetgmzurslj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgmzurslj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgmzurslj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgmzurslj === 'undefined') {
    varinitmapgmzurslj = initmapgmzurslj();
  };
});
FINAL;
    } // constructor
