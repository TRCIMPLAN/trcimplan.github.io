...
class SociedadIndiceDeDesarrolloHumanoIdh extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaickvcmk">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettvtpsnmv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaickvcmk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaickvcmk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptvtpsnmv;
  ...
  function initmaptvtpsnmv() {
    // Nuevo Mapa
    maptvtpsnmv = new L.Map('LeafLettvtpsnmv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptvtpsnmv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptvtpsnmv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptvtpsnmv === 'undefined') {
    varinitmaptvtpsnmv = initmaptvtpsnmv();
  };
});
FINAL;
    } // constructor
