...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdokryebg">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyzkkynwz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdokryebg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdokryebg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyzkkynwz === 'undefined') {
    varMorrisyzkkynwz = Morris.Line({
      element: 'Morrisyzkkynwz',
