...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasggngelen">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrkufbwuq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasggngelen a:first').tab('show')
});
// LENGUETA
$('#Lenguetasggngelen a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrkufbwuq === 'undefined') {
    varMorrisrkufbwuq = Morris.Line({
      element: 'Morrisrkufbwuq',
