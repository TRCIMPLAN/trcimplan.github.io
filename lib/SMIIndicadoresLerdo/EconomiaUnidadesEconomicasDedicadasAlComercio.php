...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmuowskpe">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisljumznvi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmuowskpe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmuowskpe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisljumznvi === 'undefined') {
    varMorrisljumznvi = Morris.Line({
      element: 'Morrisljumznvi',
