...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswrfuvutn">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissspmeond" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsnokcouu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswrfuvutn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswrfuvutn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissspmeond === 'undefined') {
    varMorrissspmeond = Morris.Line({
      element: 'Morrissspmeond',
...
// LENGUETA
$('#Lenguetaswrfuvutn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsnokcouu;
  ...
  function initmapsnokcouu() {
    // Nuevo Mapa
    mapsnokcouu = new L.Map('LeafLetsnokcouu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsnokcouu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsnokcouu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsnokcouu === 'undefined') {
    varinitmapsnokcouu = initmapsnokcouu();
  };
});
FINAL;
    } // constructor
