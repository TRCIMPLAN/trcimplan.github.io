...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbxuvivsq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissptuzfnc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbxuvivsq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbxuvivsq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissptuzfnc === 'undefined') {
    varMorrissptuzfnc = Morris.Line({
      element: 'Morrissptuzfnc',
