...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjyyelzms">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseuozheyr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetchctsewd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjyyelzms a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjyyelzms a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseuozheyr === 'undefined') {
    varMorriseuozheyr = Morris.Line({
      element: 'Morriseuozheyr',
...
// LENGUETA
$('#Lenguetasjyyelzms a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapchctsewd;
  ...
  function initmapchctsewd() {
    // Nuevo Mapa
    mapchctsewd = new L.Map('LeafLetchctsewd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapchctsewd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapchctsewd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapchctsewd === 'undefined') {
    varinitmapchctsewd = initmapchctsewd();
  };
});
FINAL;
    } // constructor
