...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrknycgbl">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwuxyhrum" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrknycgbl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrknycgbl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwuxyhrum;
  ...
  function initmapwuxyhrum() {
    // Nuevo Mapa
    mapwuxyhrum = new L.Map('LeafLetwuxyhrum');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwuxyhrum.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwuxyhrum.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwuxyhrum === 'undefined') {
    varinitmapwuxyhrum = initmapwuxyhrum();
  };
});
FINAL;
    } // constructor
