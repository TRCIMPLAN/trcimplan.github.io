...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswysewylx">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetorhcihwm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswysewylx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswysewylx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maporhcihwm;
  ...
  function initmaporhcihwm() {
    // Nuevo Mapa
    maporhcihwm = new L.Map('LeafLetorhcihwm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maporhcihwm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maporhcihwm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaporhcihwm === 'undefined') {
    varinitmaporhcihwm = initmaporhcihwm();
  };
});
FINAL;
    } // constructor
