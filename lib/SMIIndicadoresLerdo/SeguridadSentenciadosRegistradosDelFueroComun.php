...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgtqtdapb">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpcxhfgop" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgtqtdapb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgtqtdapb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappcxhfgop;
  ...
  function initmappcxhfgop() {
    // Nuevo Mapa
    mappcxhfgop = new L.Map('LeafLetpcxhfgop');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappcxhfgop.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappcxhfgop.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappcxhfgop === 'undefined') {
    varinitmappcxhfgop = initmappcxhfgop();
  };
});
FINAL;
    } // constructor
