...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseeqopelc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgfxztaiz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseeqopelc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseeqopelc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgfxztaiz;
  ...
  function initmapgfxztaiz() {
    // Nuevo Mapa
    mapgfxztaiz = new L.Map('LeafLetgfxztaiz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgfxztaiz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgfxztaiz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgfxztaiz === 'undefined') {
    varinitmapgfxztaiz = initmapgfxztaiz();
  };
});
FINAL;
    } // constructor
