...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyvpsnzhm">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyptautid" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyvpsnzhm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyvpsnzhm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyptautid;
  ...
  function initmapyptautid() {
    // Nuevo Mapa
    mapyptautid = new L.Map('LeafLetyptautid');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyptautid.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyptautid.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyptautid === 'undefined') {
    varinitmapyptautid = initmapyptautid();
  };
});
FINAL;
    } // constructor
