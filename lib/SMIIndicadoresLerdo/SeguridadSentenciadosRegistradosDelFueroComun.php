...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassizvolss">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetggbeyzhk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassizvolss a:first').tab('show')
});
// LENGUETA
$('#Lenguetassizvolss a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapggbeyzhk;
  ...
  function initmapggbeyzhk() {
    // Nuevo Mapa
    mapggbeyzhk = new L.Map('LeafLetggbeyzhk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapggbeyzhk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapggbeyzhk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapggbeyzhk === 'undefined') {
    varinitmapggbeyzhk = initmapggbeyzhk();
  };
});
FINAL;
    } // constructor
