...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskfznceiu">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuvezhqud" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskfznceiu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskfznceiu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuvezhqud;
  ...
  function initmapuvezhqud() {
    // Nuevo Mapa
    mapuvezhqud = new L.Map('LeafLetuvezhqud');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuvezhqud.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuvezhqud.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuvezhqud === 'undefined') {
    varinitmapuvezhqud = initmapuvezhqud();
  };
});
FINAL;
    } // constructor
