...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyhvdozcu">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmvmacgky" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyhvdozcu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyhvdozcu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmvmacgky;
  ...
  function initmapmvmacgky() {
    // Nuevo Mapa
    mapmvmacgky = new L.Map('LeafLetmvmacgky');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmvmacgky.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmvmacgky.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmvmacgky === 'undefined') {
    varinitmapmvmacgky = initmapmvmacgky();
  };
});
FINAL;
    } // constructor
