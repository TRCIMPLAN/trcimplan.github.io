...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslfexslwg">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetswjgfagh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslfexslwg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslfexslwg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapswjgfagh;
  ...
  function initmapswjgfagh() {
    // Nuevo Mapa
    mapswjgfagh = new L.Map('LeafLetswjgfagh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapswjgfagh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapswjgfagh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapswjgfagh === 'undefined') {
    varinitmapswjgfagh = initmapswjgfagh();
  };
});
FINAL;
    } // constructor
