<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sociedad Usuarios de Internet (Creado por Central:SmiLanzadera)
 *
...
class SociedadUsuariosDeInternet extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->claves            = 'IMPLAN, Lerdo, Innovación, Competitividad, Población, Objetivos del Milenio';
