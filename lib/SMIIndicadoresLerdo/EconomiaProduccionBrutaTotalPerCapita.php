...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskpyyfpns">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisenheboyn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskpyyfpns a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskpyyfpns a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisenheboyn === 'undefined') {
    varMorrisenheboyn = Morris.Line({
      element: 'Morrisenheboyn',
