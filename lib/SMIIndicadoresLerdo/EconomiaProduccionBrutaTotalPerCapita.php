...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqmwdywkm">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqjethuze" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqmwdywkm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqmwdywkm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqjethuze === 'undefined') {
    varMorrisqjethuze = Morris.Line({
      element: 'Morrisqjethuze',
