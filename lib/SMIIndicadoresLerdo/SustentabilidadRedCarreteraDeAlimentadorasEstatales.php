...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmubvkkku">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqyzfglos" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmubvkkku a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmubvkkku a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqyzfglos;
  ...
  function initmapqyzfglos() {
    // Nuevo Mapa
    mapqyzfglos = new L.Map('LeafLetqyzfglos');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqyzfglos.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqyzfglos.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqyzfglos === 'undefined') {
    varinitmapqyzfglos = initmapqyzfglos();
  };
});
FINAL;
    } // constructor
