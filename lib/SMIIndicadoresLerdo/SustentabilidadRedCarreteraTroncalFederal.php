<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sustentabilidad Red Carretera Troncal Federal (Creado por Central:SmiLanzadera)
 *
...
<p>No aplica a nivel metropolitano.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Red Carretera Troncal Federal en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-12-31', dato: 160 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
