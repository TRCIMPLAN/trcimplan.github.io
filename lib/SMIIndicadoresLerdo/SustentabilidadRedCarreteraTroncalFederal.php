...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvyvrcffd">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetskzvukdi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvyvrcffd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvyvrcffd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapskzvukdi;
  ...
  function initmapskzvukdi() {
    // Nuevo Mapa
    mapskzvukdi = new L.Map('LeafLetskzvukdi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapskzvukdi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapskzvukdi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapskzvukdi === 'undefined') {
    varinitmapskzvukdi = initmapskzvukdi();
  };
});
FINAL;
    } // constructor
