...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspyunbamt">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkxlrmruh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspyunbamt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspyunbamt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkxlrmruh;
  ...
  function initmapkxlrmruh() {
    // Nuevo Mapa
    mapkxlrmruh = new L.Map('LeafLetkxlrmruh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkxlrmruh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkxlrmruh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkxlrmruh === 'undefined') {
    varinitmapkxlrmruh = initmapkxlrmruh();
  };
});
FINAL;
    } // constructor
