...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszotronby">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoozpjfsz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszotronby a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszotronby a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoozpjfsz;
  ...
  function initmapoozpjfsz() {
    // Nuevo Mapa
    mapoozpjfsz = new L.Map('LeafLetoozpjfsz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoozpjfsz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoozpjfsz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoozpjfsz === 'undefined') {
    varinitmapoozpjfsz = initmapoozpjfsz();
  };
});
FINAL;
    } // constructor
