...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjizqjdqv">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetglcuksuu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjizqjdqv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjizqjdqv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapglcuksuu;
  ...
  function initmapglcuksuu() {
    // Nuevo Mapa
    mapglcuksuu = new L.Map('LeafLetglcuksuu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapglcuksuu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapglcuksuu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapglcuksuu === 'undefined') {
    varinitmapglcuksuu = initmapglcuksuu();
  };
});
FINAL;
    } // constructor
