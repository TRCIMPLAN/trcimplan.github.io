...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbkeardcl">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkgsaxpkq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbkeardcl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbkeardcl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkgsaxpkq;
  ...
  function initmapkgsaxpkq() {
    // Nuevo Mapa
    mapkgsaxpkq = new L.Map('LeafLetkgsaxpkq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkgsaxpkq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkgsaxpkq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkgsaxpkq === 'undefined') {
    varinitmapkgsaxpkq = initmapkgsaxpkq();
  };
});
FINAL;
    } // constructor
