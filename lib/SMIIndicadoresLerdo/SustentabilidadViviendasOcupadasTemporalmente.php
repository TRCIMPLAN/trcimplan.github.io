...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasotfdoxtp">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlkhqjalg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasotfdoxtp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasotfdoxtp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplkhqjalg;
  ...
  function initmaplkhqjalg() {
    // Nuevo Mapa
    maplkhqjalg = new L.Map('LeafLetlkhqjalg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplkhqjalg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplkhqjalg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplkhqjalg === 'undefined') {
    varinitmaplkhqjalg = initmaplkhqjalg();
  };
});
FINAL;
    } // constructor
