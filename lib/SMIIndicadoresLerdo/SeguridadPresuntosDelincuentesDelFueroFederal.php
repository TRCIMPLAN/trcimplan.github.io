...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbazrvzph">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuhpsidxt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbazrvzph a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbazrvzph a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuhpsidxt;
  ...
  function initmapuhpsidxt() {
    // Nuevo Mapa
    mapuhpsidxt = new L.Map('LeafLetuhpsidxt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuhpsidxt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuhpsidxt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuhpsidxt === 'undefined') {
    varinitmapuhpsidxt = initmapuhpsidxt();
  };
});
FINAL;
    } // constructor
