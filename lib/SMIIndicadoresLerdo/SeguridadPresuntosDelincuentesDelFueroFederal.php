...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmfmtplgq">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiorrjfmh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmfmtplgq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmfmtplgq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiorrjfmh;
  ...
  function initmapiorrjfmh() {
    // Nuevo Mapa
    mapiorrjfmh = new L.Map('LeafLetiorrjfmh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiorrjfmh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiorrjfmh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiorrjfmh === 'undefined') {
    varinitmapiorrjfmh = initmapiorrjfmh();
  };
});
FINAL;
    } // constructor
