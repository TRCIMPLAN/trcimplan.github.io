...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaegreenn">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethdrytazy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaegreenn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaegreenn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphdrytazy;
  ...
  function initmaphdrytazy() {
    // Nuevo Mapa
    maphdrytazy = new L.Map('LeafLethdrytazy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphdrytazy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphdrytazy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphdrytazy === 'undefined') {
    varinitmaphdrytazy = initmaphdrytazy();
  };
});
FINAL;
    } // constructor
