...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjdvuqzxn">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdvzeeabs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjdvuqzxn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjdvuqzxn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdvzeeabs;
  ...
  function initmapdvzeeabs() {
    // Nuevo Mapa
    mapdvzeeabs = new L.Map('LeafLetdvzeeabs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdvzeeabs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdvzeeabs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdvzeeabs === 'undefined') {
    varinitmapdvzeeabs = initmapdvzeeabs();
  };
});
FINAL;
    } // constructor
