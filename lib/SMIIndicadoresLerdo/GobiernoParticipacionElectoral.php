...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyoysltjw">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethgnpwzrr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyoysltjw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyoysltjw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphgnpwzrr;
  ...
  function initmaphgnpwzrr() {
    // Nuevo Mapa
    maphgnpwzrr = new L.Map('LeafLethgnpwzrr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphgnpwzrr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphgnpwzrr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphgnpwzrr === 'undefined') {
    varinitmaphgnpwzrr = initmaphgnpwzrr();
  };
});
FINAL;
    } // constructor
