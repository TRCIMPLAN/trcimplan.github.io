...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseirivmcq">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgcylndoz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseirivmcq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseirivmcq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgcylndoz;
  ...
  function initmapgcylndoz() {
    // Nuevo Mapa
    mapgcylndoz = new L.Map('LeafLetgcylndoz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgcylndoz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgcylndoz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgcylndoz === 'undefined') {
    varinitmapgcylndoz = initmapgcylndoz();
  };
});
FINAL;
    } // constructor
