<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Gobierno Muertes por Infecciones Instestinales (Creado por Central:SmiLanzadera)
 *
...
class GobiernoMuertesPorInfeccionesInstestinales extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Muertes por Infecciones Instestinales en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.1386 },{ fecha: '2009-12-31', dato: 1.4063 },{ fecha: '2010-12-31', dato: 2.0805 },{ fecha: '2011-12-31', dato: 1.3683 },{ fecha: '2012-12-31', dato: 2.0272 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
