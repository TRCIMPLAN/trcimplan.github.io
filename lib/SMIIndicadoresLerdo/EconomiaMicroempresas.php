...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasskmomjij">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisknqxcggo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasskmomjij a:first').tab('show')
});
// LENGUETA
$('#Lenguetasskmomjij a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisknqxcggo === 'undefined') {
    varMorrisknqxcggo = Morris.Line({
      element: 'Morrisknqxcggo',
