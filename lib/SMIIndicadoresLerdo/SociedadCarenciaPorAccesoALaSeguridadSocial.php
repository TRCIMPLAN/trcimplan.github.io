<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadCarenciaPorAccesoALaSeguridadSocial
 *
...
class SociedadCarenciaPorAccesoALaSeguridadSocial extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a la seguridad social en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '44.4000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
