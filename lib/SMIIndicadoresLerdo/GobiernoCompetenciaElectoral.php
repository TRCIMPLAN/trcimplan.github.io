...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoyyykkxd">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgwylnlxo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoyyykkxd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoyyykkxd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgwylnlxo;
  ...
  function initmapgwylnlxo() {
    // Nuevo Mapa
    mapgwylnlxo = new L.Map('LeafLetgwylnlxo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgwylnlxo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgwylnlxo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgwylnlxo === 'undefined') {
    varinitmapgwylnlxo = initmapgwylnlxo();
  };
});
FINAL;
    } // constructor
