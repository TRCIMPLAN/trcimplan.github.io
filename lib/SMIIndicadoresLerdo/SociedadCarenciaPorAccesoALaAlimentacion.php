<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadCarenciaPorAccesoALaAlimentacion
 *
...
class SociedadCarenciaPorAccesoALaAlimentacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a la alimentación en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '19.1000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
