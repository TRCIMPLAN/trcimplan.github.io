...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2015-01-31', dato: 1 },{ fecha: '2015-02-28', dato: 4 },{ fecha: '2015-03-31', dato: 6 },{ fecha: '2015-04-30', dato: 10 },{ fecha: '2015-05-31', dato: 8 },{ fecha: '2015-06-30', dato: 8 },{ fecha: '2015-07-31', dato: 9 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
