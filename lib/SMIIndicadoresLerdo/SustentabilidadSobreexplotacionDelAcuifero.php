...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 28.4000 },{ fecha: '2009-12-31', dato: 28.4000 },{ fecha: '2010-12-31', dato: 28.4000 },{ fecha: '2011-12-31', dato: 28.4000 },{ fecha: '2012-12-31', dato: 28.4000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
