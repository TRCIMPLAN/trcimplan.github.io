...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdzzgrpvr">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrlugowyt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdzzgrpvr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdzzgrpvr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprlugowyt;
  ...
  function initmaprlugowyt() {
    // Nuevo Mapa
    maprlugowyt = new L.Map('LeafLetrlugowyt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprlugowyt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprlugowyt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprlugowyt === 'undefined') {
    varinitmaprlugowyt = initmaprlugowyt();
  };
});
FINAL;
    } // constructor
