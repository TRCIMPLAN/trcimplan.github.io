...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfcfjumfu">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgiydkeja" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfcfjumfu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfcfjumfu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgiydkeja;
  ...
  function initmapgiydkeja() {
    // Nuevo Mapa
    mapgiydkeja = new L.Map('LeafLetgiydkeja');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgiydkeja.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgiydkeja.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgiydkeja === 'undefined') {
    varinitmapgiydkeja = initmapgiydkeja();
  };
});
FINAL;
    } // constructor
