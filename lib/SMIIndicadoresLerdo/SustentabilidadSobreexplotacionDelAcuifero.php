...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxbvagbdz">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmdvgnzpa" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxbvagbdz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxbvagbdz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmdvgnzpa;
  ...
  function initmapmdvgnzpa() {
    // Nuevo Mapa
    mapmdvgnzpa = new L.Map('LeafLetmdvgnzpa');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmdvgnzpa.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmdvgnzpa.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmdvgnzpa === 'undefined') {
    varinitmapmdvgnzpa = initmapmdvgnzpa();
  };
});
FINAL;
    } // constructor
