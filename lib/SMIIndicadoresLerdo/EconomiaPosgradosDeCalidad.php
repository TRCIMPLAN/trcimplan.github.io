<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Posgrados de Calidad (Creado por Central:SmiLanzadera)
 *
...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Posgrados de Calidad en Lerdo';
     // $this->autor             = '';
...
<p>Incluido en el subíndice de "Innovación en los Sectores Económicos". Mide el número de posgrados registrados en el Programa Nacional de Posgrados de Calidad de CONACYT. Esta variable es estatal.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Posgrados de Calidad en Lerdo</h3>
