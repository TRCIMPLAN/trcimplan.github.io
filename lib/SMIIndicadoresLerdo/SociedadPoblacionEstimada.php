...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnrbqohsa">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvbekesho" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxkvfvpll" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnrbqohsa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnrbqohsa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvbekesho === 'undefined') {
    varMorrisvbekesho = Morris.Line({
      element: 'Morrisvbekesho',
...
// LENGUETA
$('#Lenguetasnrbqohsa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxkvfvpll;
  ...
  function initmapxkvfvpll() {
    // Nuevo Mapa
    mapxkvfvpll = new L.Map('LeafLetxkvfvpll');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxkvfvpll.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxkvfvpll.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxkvfvpll === 'undefined') {
    varinitmapxkvfvpll = initmapxkvfvpll();
  };
});
FINAL;
    } // constructor
