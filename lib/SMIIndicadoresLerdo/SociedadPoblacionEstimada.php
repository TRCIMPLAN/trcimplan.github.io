...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassftmbtls">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswiybndpw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettamejntk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassftmbtls a:first').tab('show')
});
// LENGUETA
$('#Lenguetassftmbtls a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswiybndpw === 'undefined') {
    varMorriswiybndpw = Morris.Line({
      element: 'Morriswiybndpw',
...
// LENGUETA
$('#Lenguetassftmbtls a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptamejntk;
  ...
  function initmaptamejntk() {
    // Nuevo Mapa
    maptamejntk = new L.Map('LeafLettamejntk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptamejntk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptamejntk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptamejntk === 'undefined') {
    varinitmaptamejntk = initmaptamejntk();
  };
});
FINAL;
    } // constructor
