...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdwlghvpk">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismiaqtido" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdwlghvpk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdwlghvpk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismiaqtido === 'undefined') {
    varMorrismiaqtido = Morris.Line({
      element: 'Morrismiaqtido',
