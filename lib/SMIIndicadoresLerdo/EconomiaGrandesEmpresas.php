...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfgobyzma">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwmifnctf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfgobyzma a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfgobyzma a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwmifnctf;
  ...
  function initmapwmifnctf() {
    // Nuevo Mapa
    mapwmifnctf = new L.Map('LeafLetwmifnctf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwmifnctf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwmifnctf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwmifnctf === 'undefined') {
    varinitmapwmifnctf = initmapwmifnctf();
  };
});
FINAL;
    } // constructor
