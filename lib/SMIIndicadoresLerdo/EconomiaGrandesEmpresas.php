...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasanlalldl">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkdbmpjlv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasanlalldl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasanlalldl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkdbmpjlv;
  ...
  function initmapkdbmpjlv() {
    // Nuevo Mapa
    mapkdbmpjlv = new L.Map('LeafLetkdbmpjlv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkdbmpjlv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkdbmpjlv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkdbmpjlv === 'undefined') {
    varinitmapkdbmpjlv = initmapkdbmpjlv();
  };
});
FINAL;
    } // constructor
