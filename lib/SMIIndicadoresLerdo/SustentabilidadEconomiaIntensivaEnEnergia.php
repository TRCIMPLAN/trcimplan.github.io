<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Sustentabilidad Economía Intensiva en Energía (Creado por Central:SmiLanzadera)
 *
...
Fuente: Petróleos Mexicanos (PEMEX) y estimaciones de IMCO con información del INEGI, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Economía Intensiva en Energía en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 21.5000 },{ fecha: '2009-12-31', dato: 21.0000 },{ fecha: '2010-12-31', dato: 20.0000 },{ fecha: '2011-12-31', dato: 18.3000 },{ fecha: '2012-12-31', dato: 17.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
