...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqphodidx">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjcawahqq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqphodidx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqphodidx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjcawahqq;
  ...
  function initmapjcawahqq() {
    // Nuevo Mapa
    mapjcawahqq = new L.Map('LeafLetjcawahqq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjcawahqq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjcawahqq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjcawahqq === 'undefined') {
    varinitmapjcawahqq = initmapjcawahqq();
  };
});
FINAL;
    } // constructor
