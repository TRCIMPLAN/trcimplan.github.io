...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspmwprdue">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgmdkhhiy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspmwprdue a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspmwprdue a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgmdkhhiy;
  ...
  function initmapgmdkhhiy() {
    // Nuevo Mapa
    mapgmdkhhiy = new L.Map('LeafLetgmdkhhiy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgmdkhhiy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgmdkhhiy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgmdkhhiy === 'undefined') {
    varinitmapgmdkhhiy = initmapgmdkhhiy();
  };
});
FINAL;
    } // constructor
