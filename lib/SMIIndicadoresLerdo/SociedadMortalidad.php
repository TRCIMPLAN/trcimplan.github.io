...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasitbrlzns">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaypantwa" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasitbrlzns a:first').tab('show')
});
// LENGUETA
$('#Lenguetasitbrlzns a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaypantwa;
  ...
  function initmapaypantwa() {
    // Nuevo Mapa
    mapaypantwa = new L.Map('LeafLetaypantwa');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaypantwa.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaypantwa.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaypantwa === 'undefined') {
    varinitmapaypantwa = initmapaypantwa();
  };
});
FINAL;
    } // constructor
