...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvyoebpbf">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzfceiboh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvyoebpbf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvyoebpbf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzfceiboh;
  ...
  function initmapzfceiboh() {
    // Nuevo Mapa
    mapzfceiboh = new L.Map('LeafLetzfceiboh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzfceiboh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzfceiboh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzfceiboh === 'undefined') {
    varinitmapzfceiboh = initmapzfceiboh();
  };
});
FINAL;
    } // constructor
