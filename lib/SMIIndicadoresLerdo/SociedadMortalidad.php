...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasshdgguvv">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetforyrngd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasshdgguvv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasshdgguvv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapforyrngd;
  ...
  function initmapforyrngd() {
    // Nuevo Mapa
    mapforyrngd = new L.Map('LeafLetforyrngd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapforyrngd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapforyrngd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapforyrngd === 'undefined') {
    varinitmapforyrngd = initmapforyrngd();
  };
});
FINAL;
    } // constructor
