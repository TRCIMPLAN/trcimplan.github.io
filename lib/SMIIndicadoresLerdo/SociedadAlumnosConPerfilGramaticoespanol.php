...
class SociedadAlumnosConPerfilGramaticoespanol extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascupkulrp">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpavomxwq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascupkulrp a:first').tab('show')
});
// LENGUETA
$('#Lenguetascupkulrp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappavomxwq;
  ...
  function initmappavomxwq() {
    // Nuevo Mapa
    mappavomxwq = new L.Map('LeafLetpavomxwq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappavomxwq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappavomxwq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappavomxwq === 'undefined') {
    varinitmappavomxwq = initmappavomxwq();
  };
});
FINAL;
    } // constructor
