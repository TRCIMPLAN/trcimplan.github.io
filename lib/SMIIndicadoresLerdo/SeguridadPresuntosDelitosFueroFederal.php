<?php
/**
 * SeguridadPresuntosDelitosFueroFederal.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SeguridadPresuntosDelitosFueroFederal
 */
class SeguridadPresuntosDelitosFueroFederal extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'seguridadpresuntos-delitos-fuero-federal';
        $this->descripcion  = '';
...
<p>Fuente: <a href="http://www.inegi.org.mx/est/lista_cubos/consulta.aspx?p=gob&amp;c=5">INEGI</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Presuntos Delitos del Fuero Federal</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
