...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasidpdvsbg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxjzavlih" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbkwijadz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasidpdvsbg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasidpdvsbg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxjzavlih === 'undefined') {
    varMorrisxjzavlih = Morris.Line({
      element: 'Morrisxjzavlih',
...
// LENGUETA
$('#Lenguetasidpdvsbg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbkwijadz;
  ...
  function initmapbkwijadz() {
    // Nuevo Mapa
    mapbkwijadz = new L.Map('LeafLetbkwijadz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbkwijadz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbkwijadz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbkwijadz === 'undefined') {
    varinitmapbkwijadz = initmapbkwijadz();
  };
});
FINAL;
    } // constructor
