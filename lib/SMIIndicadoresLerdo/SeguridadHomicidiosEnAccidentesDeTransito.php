<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SeguridadHomicidiosEnAccidentesDeTransito
 *
...
class SeguridadHomicidiosEnAccidentesDeTransito extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Homicidios en accidentes de tránsito en Lerdo';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2019-05-31', 'valor' => '0', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 34, crudo 17
    } // datos
