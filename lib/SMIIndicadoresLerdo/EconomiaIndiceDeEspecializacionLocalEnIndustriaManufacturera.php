...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbddowmha">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisblfpakhc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbddowmha a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbddowmha a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisblfpakhc === 'undefined') {
    varMorrisblfpakhc = Morris.Line({
      element: 'Morrisblfpakhc',
