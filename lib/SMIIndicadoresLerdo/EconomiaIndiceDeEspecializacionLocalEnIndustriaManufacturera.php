...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgnuocmsa">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisaypxahfx" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgnuocmsa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgnuocmsa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaypxahfx === 'undefined') {
    varMorrisaypxahfx = Morris.Line({
      element: 'Morrisaypxahfx',
