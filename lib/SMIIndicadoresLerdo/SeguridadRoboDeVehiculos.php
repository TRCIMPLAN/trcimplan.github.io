...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasescjoqou">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrmgevlts" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasescjoqou a:first').tab('show')
});
// LENGUETA
$('#Lenguetasescjoqou a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprmgevlts;
  ...
  function initmaprmgevlts() {
    // Nuevo Mapa
    maprmgevlts = new L.Map('LeafLetrmgevlts');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprmgevlts.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprmgevlts.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprmgevlts === 'undefined') {
    varinitmaprmgevlts = initmaprmgevlts();
  };
});
FINAL;
    } // constructor
