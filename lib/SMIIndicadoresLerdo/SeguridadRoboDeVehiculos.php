...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascrfugmcf">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismzitgppo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascrfugmcf a:first').tab('show')
});
// LENGUETA
$('#Lenguetascrfugmcf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismzitgppo === 'undefined') {
    varMorrismzitgppo = Morris.Line({
      element: 'Morrismzitgppo',
