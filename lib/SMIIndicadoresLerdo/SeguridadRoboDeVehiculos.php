...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasktiffpri">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkvijqktr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasktiffpri a:first').tab('show')
});
// LENGUETA
$('#Lenguetasktiffpri a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkvijqktr;
  ...
  function initmapkvijqktr() {
    // Nuevo Mapa
    mapkvijqktr = new L.Map('LeafLetkvijqktr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkvijqktr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkvijqktr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkvijqktr === 'undefined') {
    varinitmapkvijqktr = initmapkvijqktr();
  };
});
FINAL;
    } // constructor
