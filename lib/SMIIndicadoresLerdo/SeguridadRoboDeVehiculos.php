...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjhumpmfx">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwrphisyz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjhumpmfx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjhumpmfx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwrphisyz;
  ...
  function initmapwrphisyz() {
    // Nuevo Mapa
    mapwrphisyz = new L.Map('LeafLetwrphisyz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwrphisyz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwrphisyz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwrphisyz === 'undefined') {
    varinitmapwrphisyz = initmapwrphisyz();
  };
});
FINAL;
    } // constructor
