...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfucburjo">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyyhgcfah" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfucburjo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfucburjo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyyhgcfah;
  ...
  function initmapyyhgcfah() {
    // Nuevo Mapa
    mapyyhgcfah = new L.Map('LeafLetyyhgcfah');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyyhgcfah.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyyhgcfah.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyyhgcfah === 'undefined') {
    varinitmapyyhgcfah = initmapyyhgcfah();
  };
});
FINAL;
    } // constructor
