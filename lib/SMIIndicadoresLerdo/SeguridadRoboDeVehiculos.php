...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskaebmkkv">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlucercig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskaebmkkv a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskaebmkkv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplucercig;
  ...
  function initmaplucercig() {
    // Nuevo Mapa
    maplucercig = new L.Map('LeafLetlucercig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplucercig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplucercig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplucercig === 'undefined') {
    varinitmaplucercig = initmaplucercig();
  };
});
FINAL;
    } // constructor
