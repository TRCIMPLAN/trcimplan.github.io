...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvnvdapnb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfnaxzhir" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvnvdapnb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvnvdapnb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfnaxzhir === 'undefined') {
    varMorrisfnaxzhir = Morris.Line({
      element: 'Morrisfnaxzhir',
