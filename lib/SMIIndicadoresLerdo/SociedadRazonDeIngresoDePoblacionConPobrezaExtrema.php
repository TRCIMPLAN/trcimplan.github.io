<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadRazonDeIngresoDePoblacionConPobrezaExtrema
 *
...
class SociedadRazonDeIngresoDePoblacionConPobrezaExtrema extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón de ingreso de población con pobreza extrema en Lerdo';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '14.0000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '16.0000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
