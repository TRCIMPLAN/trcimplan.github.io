...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasywomzhzx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbrzbmapm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasywomzhzx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasywomzhzx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbrzbmapm === 'undefined') {
    varMorrisbrzbmapm = Morris.Line({
      element: 'Morrisbrzbmapm',
