...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasugpjhnwo">
...
<div id="Morristtxkpxds" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetclfchlob" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasugpjhnwo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasugpjhnwo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristtxkpxds === 'undefined') {
    varMorristtxkpxds = Morris.Line({
      element: 'Morristtxkpxds',
...
// LENGUETA
$('#Lenguetasugpjhnwo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapclfchlob;
  ...
  function initmapclfchlob() {
    // Nuevo Mapa
    mapclfchlob = new L.Map('LeafLetclfchlob');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapclfchlob.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapclfchlob.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapclfchlob === 'undefined') {
    varinitmapclfchlob = initmapclfchlob();
  };
});
FINAL;
    } // constructor
