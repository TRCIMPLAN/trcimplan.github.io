<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Empresas (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpresas extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empresas en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 12.6842 },{ fecha: '2009-12-31', dato: 20.4751 },{ fecha: '2010-12-31', dato: 20.4766 },{ fecha: '2011-12-31', dato: 14.1013 },{ fecha: '2012-12-31', dato: 13.0615 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
