...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxuggtdaj">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszwnakumv" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnwefzyad" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxuggtdaj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxuggtdaj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszwnakumv === 'undefined') {
    varMorriszwnakumv = Morris.Line({
      element: 'Morriszwnakumv',
...
// LENGUETA
$('#Lenguetasxuggtdaj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnwefzyad;
  ...
  function initmapnwefzyad() {
    // Nuevo Mapa
    mapnwefzyad = new L.Map('LeafLetnwefzyad');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnwefzyad.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnwefzyad.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnwefzyad === 'undefined') {
    varinitmapnwefzyad = initmapnwefzyad();
  };
});
FINAL;
    } // constructor
