...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfrypnxby">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisghmxkjmb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethyhhwrkk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfrypnxby a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfrypnxby a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisghmxkjmb === 'undefined') {
    varMorrisghmxkjmb = Morris.Line({
      element: 'Morrisghmxkjmb',
...
// LENGUETA
$('#Lenguetasfrypnxby a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphyhhwrkk;
  ...
  function initmaphyhhwrkk() {
    // Nuevo Mapa
    maphyhhwrkk = new L.Map('LeafLethyhhwrkk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphyhhwrkk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphyhhwrkk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphyhhwrkk === 'undefined') {
    varinitmaphyhhwrkk = initmaphyhhwrkk();
  };
});
FINAL;
    } // constructor
