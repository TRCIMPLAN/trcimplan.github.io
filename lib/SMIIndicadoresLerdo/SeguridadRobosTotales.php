...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasltwmikno">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxolwvuox" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasltwmikno a:first').tab('show')
});
// LENGUETA
$('#Lenguetasltwmikno a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxolwvuox === 'undefined') {
    varMorrisxolwvuox = Morris.Line({
      element: 'Morrisxolwvuox',
