...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszcjzixkp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishmanvzbf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjpzuvkaw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszcjzixkp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszcjzixkp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishmanvzbf === 'undefined') {
    varMorrishmanvzbf = Morris.Line({
      element: 'Morrishmanvzbf',
...
// LENGUETA
$('#Lenguetaszcjzixkp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjpzuvkaw;
  ...
  function initmapjpzuvkaw() {
    // Nuevo Mapa
    mapjpzuvkaw = new L.Map('LeafLetjpzuvkaw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjpzuvkaw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjpzuvkaw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjpzuvkaw === 'undefined') {
    varinitmapjpzuvkaw = initmapjpzuvkaw();
  };
});
FINAL;
    } // constructor
