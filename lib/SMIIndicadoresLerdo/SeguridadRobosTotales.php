<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Seguridad Robos Totales (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 356 },{ region: 'Gómez Palacio', dato: 159 },{ region: 'Lerdo', dato: 57 },{ region: 'Matamoros', dato: 27 },{ region: 'La Laguna', dato: 599 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
