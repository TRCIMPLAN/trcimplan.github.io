...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswseauypo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishqcthooj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswseauypo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswseauypo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishqcthooj === 'undefined') {
    varMorrishqcthooj = Morris.Line({
      element: 'Morrishqcthooj',
