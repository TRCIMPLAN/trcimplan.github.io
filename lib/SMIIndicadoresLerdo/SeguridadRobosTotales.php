...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastxirgceo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisftrblthj" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetchjyssfu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastxirgceo a:first').tab('show')
});
// LENGUETA
$('#Lenguetastxirgceo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisftrblthj === 'undefined') {
    varMorrisftrblthj = Morris.Line({
      element: 'Morrisftrblthj',
...
// LENGUETA
$('#Lenguetastxirgceo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapchjyssfu;
  ...
  function initmapchjyssfu() {
    // Nuevo Mapa
    mapchjyssfu = new L.Map('LeafLetchjyssfu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapchjyssfu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapchjyssfu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapchjyssfu === 'undefined') {
    varinitmapchjyssfu = initmapchjyssfu();
  };
});
FINAL;
    } // constructor
