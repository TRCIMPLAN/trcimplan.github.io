<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Grandes Empresas (según CNN Expansión) (Creado por Central:SmiLanzadera)
 *
...
class EconomiaGrandesEmpresasSegunCnnExpansion extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Grandes Empresas (según CNN Expansión) en Lerdo</h3>
