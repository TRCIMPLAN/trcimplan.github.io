...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskczllizh">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisypirbhpp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskczllizh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskczllizh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisypirbhpp === 'undefined') {
    varMorrisypirbhpp = Morris.Line({
      element: 'Morrisypirbhpp',
