...
class SociedadOcupacionPorVivienda extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiekyguxk">
...
Datos obtenidos de [INEGI. Censos de población y vivienda 2010](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfspwdjvq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiekyguxk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiekyguxk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfspwdjvq;
  ...
  function initmapfspwdjvq() {
    // Nuevo Mapa
    mapfspwdjvq = new L.Map('LeafLetfspwdjvq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfspwdjvq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfspwdjvq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfspwdjvq === 'undefined') {
    varinitmapfspwdjvq = initmapfspwdjvq();
  };
});
FINAL;
    } // constructor
