...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasstblgpdb">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbjutlvsm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasstblgpdb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasstblgpdb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbjutlvsm === 'undefined') {
    varMorrisbjutlvsm = Morris.Line({
      element: 'Morrisbjutlvsm',
