...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgujxbiuc">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskjrhgicy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxnsfhutt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgujxbiuc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgujxbiuc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskjrhgicy === 'undefined') {
    varMorriskjrhgicy = Morris.Line({
      element: 'Morriskjrhgicy',
...
// LENGUETA
$('#Lenguetasgujxbiuc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxnsfhutt;
  ...
  function initmapxnsfhutt() {
    // Nuevo Mapa
    mapxnsfhutt = new L.Map('LeafLetxnsfhutt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxnsfhutt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxnsfhutt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxnsfhutt === 'undefined') {
    varinitmapxnsfhutt = initmapxnsfhutt();
  };
});
FINAL;
    } // constructor
