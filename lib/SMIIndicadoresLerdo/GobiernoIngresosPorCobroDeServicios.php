...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashvygasdy">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxvqejxsw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetekfuvnze" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashvygasdy a:first').tab('show')
});
// LENGUETA
$('#Lenguetashvygasdy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxvqejxsw === 'undefined') {
    varMorrisxvqejxsw = Morris.Line({
      element: 'Morrisxvqejxsw',
...
// LENGUETA
$('#Lenguetashvygasdy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapekfuvnze;
  ...
  function initmapekfuvnze() {
    // Nuevo Mapa
    mapekfuvnze = new L.Map('LeafLetekfuvnze');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapekfuvnze.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapekfuvnze.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapekfuvnze === 'undefined') {
    varinitmapekfuvnze = initmapekfuvnze();
  };
});
FINAL;
    } // constructor
