...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyobafgck">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisaywgddzi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyobafgck a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyobafgck a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaywgddzi === 'undefined') {
    varMorrisaywgddzi = Morris.Line({
      element: 'Morrisaywgddzi',
