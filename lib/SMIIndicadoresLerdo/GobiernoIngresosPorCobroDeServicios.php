...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasayjrfocb">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisadrfmjfh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrjbvowlp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasayjrfocb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasayjrfocb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisadrfmjfh === 'undefined') {
    varMorrisadrfmjfh = Morris.Line({
      element: 'Morrisadrfmjfh',
...
// LENGUETA
$('#Lenguetasayjrfocb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprjbvowlp;
  ...
  function initmaprjbvowlp() {
    // Nuevo Mapa
    maprjbvowlp = new L.Map('LeafLetrjbvowlp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprjbvowlp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprjbvowlp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprjbvowlp === 'undefined') {
    varinitmaprjbvowlp = initmaprjbvowlp();
  };
});
FINAL;
    } // constructor
