...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasecgwurgi">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskkckisvs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetckdubutt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasecgwurgi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasecgwurgi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskkckisvs === 'undefined') {
    varMorriskkckisvs = Morris.Line({
      element: 'Morriskkckisvs',
...
// LENGUETA
$('#Lenguetasecgwurgi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapckdubutt;
  ...
  function initmapckdubutt() {
    // Nuevo Mapa
    mapckdubutt = new L.Map('LeafLetckdubutt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapckdubutt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapckdubutt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapckdubutt === 'undefined') {
    varinitmapckdubutt = initmapckdubutt();
  };
});
FINAL;
    } // constructor
