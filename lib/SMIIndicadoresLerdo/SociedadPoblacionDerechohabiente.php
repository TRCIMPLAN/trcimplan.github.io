...
class SociedadPoblacionDerechohabiente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjplqkiap">
...
Fuente: INEGI
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbqmeziur" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjplqkiap a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjplqkiap a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbqmeziur;
  ...
  function initmapbqmeziur() {
    // Nuevo Mapa
    mapbqmeziur = new L.Map('LeafLetbqmeziur');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbqmeziur.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbqmeziur.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbqmeziur === 'undefined') {
    varinitmapbqmeziur = initmapbqmeziur();
  };
});
FINAL;
    } // constructor
