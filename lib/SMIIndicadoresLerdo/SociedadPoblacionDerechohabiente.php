...
class SociedadPoblacionDerechohabiente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnnmjdjva">
...
Fuente: INEGI
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetclwngfmp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnnmjdjva a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnnmjdjva a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapclwngfmp;
  ...
  function initmapclwngfmp() {
    // Nuevo Mapa
    mapclwngfmp = new L.Map('LeafLetclwngfmp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapclwngfmp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapclwngfmp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapclwngfmp === 'undefined') {
    varinitmapclwngfmp = initmapclwngfmp();
  };
});
FINAL;
    } // constructor
