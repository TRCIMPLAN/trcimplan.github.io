...
class SociedadPoblacionDerechohabiente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnexukutb">
...
Fuente: INEGI
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrrkwnvga" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnexukutb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnexukutb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprrkwnvga;
  ...
  function initmaprrkwnvga() {
    // Nuevo Mapa
    maprrkwnvga = new L.Map('LeafLetrrkwnvga');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprrkwnvga.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprrkwnvga.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprrkwnvga === 'undefined') {
    varinitmaprrkwnvga = initmaprrkwnvga();
  };
});
FINAL;
    } // constructor
