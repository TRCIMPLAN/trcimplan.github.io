...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastzismozt">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisybpgxfep" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlvwfktcv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastzismozt a:first').tab('show')
});
// LENGUETA
$('#Lenguetastzismozt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisybpgxfep === 'undefined') {
    varMorrisybpgxfep = Morris.Line({
      element: 'Morrisybpgxfep',
...
// LENGUETA
$('#Lenguetastzismozt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplvwfktcv;
  ...
  function initmaplvwfktcv() {
    // Nuevo Mapa
    maplvwfktcv = new L.Map('LeafLetlvwfktcv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplvwfktcv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplvwfktcv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplvwfktcv === 'undefined') {
    varinitmaplvwfktcv = initmaplvwfktcv();
  };
});
FINAL;
    } // constructor
