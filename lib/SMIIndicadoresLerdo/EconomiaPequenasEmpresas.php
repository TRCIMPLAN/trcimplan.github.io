...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyhskrhsq">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqmsfclls" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettzoubsjp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyhskrhsq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyhskrhsq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqmsfclls === 'undefined') {
    varMorrisqmsfclls = Morris.Line({
      element: 'Morrisqmsfclls',
...
// LENGUETA
$('#Lenguetasyhskrhsq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptzoubsjp;
  ...
  function initmaptzoubsjp() {
    // Nuevo Mapa
    maptzoubsjp = new L.Map('LeafLettzoubsjp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptzoubsjp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptzoubsjp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptzoubsjp === 'undefined') {
    varinitmaptzoubsjp = initmaptzoubsjp();
  };
});
FINAL;
    } // constructor
