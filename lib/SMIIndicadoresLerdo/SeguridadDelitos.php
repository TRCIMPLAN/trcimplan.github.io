...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasddtgkqsd">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisswdthiil" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasddtgkqsd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasddtgkqsd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisswdthiil === 'undefined') {
    varMorrisswdthiil = Morris.Line({
      element: 'Morrisswdthiil',
