...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdnkoetcn">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislnbhprjg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdnkoetcn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdnkoetcn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislnbhprjg === 'undefined') {
    varMorrislnbhprjg = Morris.Line({
      element: 'Morrislnbhprjg',
