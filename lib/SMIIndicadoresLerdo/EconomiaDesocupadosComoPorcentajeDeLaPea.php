...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrqyqyqhi">
...
<div id="Morrisdmommixc" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqoopsfcy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrqyqyqhi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrqyqyqhi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdmommixc === 'undefined') {
    varMorrisdmommixc = Morris.Line({
      element: 'Morrisdmommixc',
...
// LENGUETA
$('#Lenguetasrqyqyqhi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqoopsfcy;
  ...
  function initmapqoopsfcy() {
    // Nuevo Mapa
    mapqoopsfcy = new L.Map('LeafLetqoopsfcy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqoopsfcy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqoopsfcy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqoopsfcy === 'undefined') {
    varinitmapqoopsfcy = initmapqoopsfcy();
  };
});
FINAL;
    } // constructor
