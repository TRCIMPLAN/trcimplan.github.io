...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasluowdnec">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscnteuiur" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasluowdnec a:first').tab('show')
});
// LENGUETA
$('#Lenguetasluowdnec a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscnteuiur === 'undefined') {
    varMorriscnteuiur = Morris.Line({
      element: 'Morriscnteuiur',
