...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxbvixhyx">
...
<div id="Morrislrufemhd" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuprblrsk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxbvixhyx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxbvixhyx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislrufemhd === 'undefined') {
    varMorrislrufemhd = Morris.Line({
      element: 'Morrislrufemhd',
...
// LENGUETA
$('#Lenguetasxbvixhyx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuprblrsk;
  ...
  function initmapuprblrsk() {
    // Nuevo Mapa
    mapuprblrsk = new L.Map('LeafLetuprblrsk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuprblrsk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuprblrsk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuprblrsk === 'undefined') {
    varinitmapuprblrsk = initmapuprblrsk();
  };
});
FINAL;
    } // constructor
