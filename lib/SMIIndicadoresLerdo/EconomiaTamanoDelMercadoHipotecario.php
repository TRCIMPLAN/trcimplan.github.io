...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbyjfsyjn">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswpytjbvc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbyjfsyjn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbyjfsyjn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswpytjbvc === 'undefined') {
    varMorriswpytjbvc = Morris.Line({
      element: 'Morriswpytjbvc',
