...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashsnniedz">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvpgmhgza" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashsnniedz a:first').tab('show')
});
// LENGUETA
$('#Lenguetashsnniedz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvpgmhgza === 'undefined') {
    varMorrisvpgmhgza = Morris.Line({
      element: 'Morrisvpgmhgza',
