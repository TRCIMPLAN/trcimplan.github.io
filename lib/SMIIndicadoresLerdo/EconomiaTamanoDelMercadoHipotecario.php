...
class EconomiaTamanoDelMercadoHipotecario extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasemcobqgz">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnlfcmwng" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetelpoihkq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasemcobqgz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasemcobqgz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnlfcmwng === 'undefined') {
    varMorrisnlfcmwng = Morris.Line({
      element: 'Morrisnlfcmwng',
...
// LENGUETA
$('#Lenguetasemcobqgz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapelpoihkq;
  ...
  function initmapelpoihkq() {
    // Nuevo Mapa
    mapelpoihkq = new L.Map('LeafLetelpoihkq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapelpoihkq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapelpoihkq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapelpoihkq === 'undefined') {
    varinitmapelpoihkq = initmapelpoihkq();
  };
});
FINAL;
    } // constructor
