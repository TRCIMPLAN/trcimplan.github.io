<?php
/**
 * TrcIMPLAN - SMI Indicadores Lerdo Economía Población Ocupada Sin Ingresos (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje de la población ocupada</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Población Ocupada Sin Ingresos en Lerdo</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 5.3000 },{ fecha: '2009-12-31', dato: 3.9100 },{ fecha: '2010-12-31', dato: 1.4700 },{ fecha: '2011-12-31', dato: 8.5200 },{ fecha: '2012-12-31', dato: 0.2200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
