<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon RedCiclista2
 *
 ...
 * Clase RedCiclista2
 */
class RedCiclista2 extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'red-ciclista2';
        $this->autor              = 'Arq. Cecilio Pedro Secunza Schott';
        $this->fecha              = '2018-07-04T13:46';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'red-ciclista2';
        $this->imagen             = 'red-ciclista2/imagen.jpg';
        $this->imagen_previa      = 'red-ciclista2/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Otra versión de la red ciclista';
        $this->claves             = 'IMPLAN';
        ...
        $mapa->theMap             = <<<FINAL
<iframe src="https://www.google.com/maps/d/embed?mid=1K5Bzaltg5F2zaxSXnyVk7GKiWAihYFo8" width="640" height="480"></iframe>
FINAL;
