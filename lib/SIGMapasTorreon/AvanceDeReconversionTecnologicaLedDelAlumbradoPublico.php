<?php
/**
 * TrcIMPLAN - Avance de Reconversión Tecnológica Led del Alumbrado Público
 *
...
class AvanceDeReconversionTecnologicaLedDelAlumbradoPublico extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->claves             = 'IMPLAN, Torreon, Alumbrado, Reconversión';
        $this->categorias         = array('Competitividad', 'Infraestructura');
