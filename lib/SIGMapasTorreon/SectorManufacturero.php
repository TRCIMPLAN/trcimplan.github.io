<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon SectorManufacturero
 *
...
/**
 * Clase SectorManufacturero
 */
class SectorManufacturero extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Sector Manufacturero';
        $this->autor              = 'Arq. Daniela Patricia Corral Hernández';
        $this->fecha              = '2017-04-05T15:45';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'sector-manufacturero';
        $this->imagen             = 'sector-manufacturero/imagen.jpg';
        $this->imagen_previa      = 'sector-manufacturero/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Mapa referente a las unidades económicas del Sector Manufacturero según el Sistema de Clasificación Industrial de América del Norte. Se muestran los cinco Subsectores elegidos por su peso económico, para el Plan de Política Industrial.';
        $this->claves             = 'Industrias, Manufactura, La Laguna';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/516907ee-1a15-11e7-8394-0ecd1babdde5/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/516907ee-1a15-11e7-8394-0ecd1babdde5/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe><br><b>VERSIÓN DE DIVULGACIÓN E INFORMACIÓN, NO PRODUCE EFECTOS JURÍDICOS.</b>
FINAL;
