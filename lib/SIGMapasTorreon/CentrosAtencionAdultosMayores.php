<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon CentrosAtencionAdultosMayores
 *
...
/**
 * Clase CentrosAtencionAdultosMayores
 */
class CentrosAtencionAdultosMayores extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Centros de Atención a Adultos Mayores';
        $this->autor              = 'Arq. Daniela Patricia Corral Hernández';
        $this->fecha              = '2017-03-02T09:19';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'centros-atencion-adultos-mayores';
        $this->imagen             = 'centros-atencion-adultos-mayores/imagen.jpg';
        $this->imagen_previa      = 'centros-atencion-adultos-mayores/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Ubicación de centros de atención a adultos mayores en la ciudad de Torreón Coahuila.';
        $this->claves             = 'IMPLAN, Torreon, Adultos Mayores, Centros de Atencion';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/e7bcd4c2-f93c-11e6-9e15-0ecd1babdde5/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe><br><b>VERSIÓN DE DIVULGACIÓN E INFORMACIÓN, NO PRODUCE EFECTOS JURÍDICOS.</b>
FINAL;
