...
/**
 * Clase InfraestructuraVial
 */
class InfraestructuraVial extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Infraestructura Vial';
        $this->autor              = 'Arq. Daniela Patricia Corral Hernández';
        $this->fecha              = '2015-10-20T09:10';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'infraestructura-vial';
        $this->imagen             = 'infraestructura-vial/imagen.jpg';
        $this->imagen_previa      = 'infraestructura-vial/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Mapa de jerarquía de vialidades que permite los intercambios entre las diversas funciones que se desarrollan en la ciudad de Torreón.';
        $this->claves             = 'IMPLAN, Torreon, Vialidades, Infraestructura';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/3e3e7590-7982-11e4-8c5e-0e4fddd5de28/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/3e3e7590-7982-11e4-8c5e-0e4fddd5de28/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
