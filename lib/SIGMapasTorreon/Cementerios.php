<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon Cementerios
 *
 ...
 * Clase Cementerios
 */
class Cementerios extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Cementerios';
        $this->autor              = 'Arq. Daniela Patricia Corral Hernández';
        $this->fecha              = '2017-02-21T14:28';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'cementerios';
        $this->imagen             = 'cementerios/imagen.jpg';
        $this->imagen_previa      = 'cementerios/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Ubicación de cementerios en la ciudad de Torreón.';
        $this->claves             = 'IMPLAN, Torreon, Cementerios';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/d3b705b6-f224-11e6-877f-0ef24382571b/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/d3b705b6-f224-11e6-877f-0ef24382571b/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe><br><b>VERSIÓN DE DIVULGACIÓN E INFORMACIÓN, NO PRODUCE EFECTOS JURÍDICOS.</b>
FINAL;
