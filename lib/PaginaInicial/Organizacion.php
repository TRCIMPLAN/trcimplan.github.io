...
class Organizacion extends \Base\SchemaGovernmentOrganization {
    ...
    public function html() {
        ...
        $b[] = '  <section id="organizacion">';
            ...
            $b[] = '    <img class="banner" src="imagenes/banner-implan-2018-01.jpg" width="100" height="500" alt="IMPLAN Torreon">';
            //  $b[] = ' ';
            $b[] = '<li></li>';
            //INICIO  CONVOCATORIAS
            $b[] = '<div class="slider2">';
                $b[] = '<ul>';
                $b[] = '<a href="http://www.trcimplan.gob.mx/investigaciones/resultados-consulta-zona-norte-mayo2020.pdf"><img src="imagenes\programa-zona-norte\banner-pzn-consulta.jpg" alt="Programa Zona Norte"></a>';
