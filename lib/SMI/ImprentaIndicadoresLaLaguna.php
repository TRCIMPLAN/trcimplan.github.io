<?php
/*
 * SMIbeta - SMI Indicadores La Laguna Imprenta
 *
...
/**
 * Clase ImprentaIndicadoresLaLaguna
 */
class ImprentaIndicadoresLaLaguna extends \Base\Imprenta {
    ...
    public function __construct() {
        $this->indicadores_directorio = 'SMIIndicadoresLaLaguna';
        $this->titulo                 = 'Sistema Metropolitano de Indicadores: La Laguna';
        $this->descripcion            = 'Indicadores de La Laguna. IMPLAN Torreón, Sistema Metropolitano de Indicadores.';
        $this->claves                 = 'IMPLAN, Torreon, Indicadores, La Laguna';
        $this->directorio             = 'indicadores-la-laguna';
        $this->ruta                   = 'indicadores-la-laguna/index.html';
