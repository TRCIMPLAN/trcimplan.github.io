<?php
/*
 * SMIbeta - SMI Indicadores Gómez Palacio Imprenta
 *
...
/**
 * Clase ImprentaIndicadoresGomezPalacio
 */
class ImprentaIndicadoresGomezPalacio extends \Base\Imprenta {
    ...
    public function __construct() {
        $this->indicadores_directorio = 'SMIIndicadoresGomezPalacio';
        $this->titulo                 = 'Sistema Metropolitano de Indicadores: Gómez Palacio';
        $this->descripcion            = 'Indicadores de Gómez Palacio. IMPLAN Torreón, Sistema Metropolitano de Indicadores.';
        $this->claves                 = 'IMPLAN, Torreon, Indicadores, Gomez Palacio';
        $this->directorio             = 'indicadores-gomez-palacio';
        $this->ruta                   = 'indicadores-gomez-palacio/index.html';
