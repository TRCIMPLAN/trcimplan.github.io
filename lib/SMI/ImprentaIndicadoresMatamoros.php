<?php
/*
 * SMIbeta - SMI Indicadores Matamoros Imprenta
 *
 ...
 */
class ImprentaIndicadoresMatamoros extends \Base\Imprenta {
    ...
    public function __construct() {
        $this->indicadores_directorio = 'SMIIndicadoresMatamoros';
        $this->titulo                 = 'Sistema Metropolitano de Indicadores: Matamoros';
        $this->descripcion            = 'Indicadores de Matamoros. IMPLAN Torreón, Sistema Metropolitano de Indicadores.';
        $this->claves                 = 'IMPLAN, Torreon, Indicadores, Matamoros';
        $this->directorio             = 'indicadores-matamoros';
        $this->ruta                   = 'indicadores-matamoros/index.html';
