 ...
 * Clase SMICategorias
 */
class SMICategorias extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre         = 'Indicadores por Categoría';
     // $this->autor          = 'Autor';
        ...
        $this->descripcion    = 'Indicadores agrupados por categorías.';
        $this->claves         = 'IMPLAN, Torreon, Indicadores, Gomez Palacio, Lerdo, Matamoros, La Laguna, Categorias';
        $this->categorias     = array();
        // El estado puede ser 'publicar' (lo usa), 'revisar' o 'ignorar' (lo omite)
        $this->estado         = 'publicar';
        // URL de destino
        $this->url            = '../indicadores-categorias/index.html';
     // $this->url_etiqueta   = '';
        // Sin contenido
        $this->contenido      = '';
        // Sin JavaScript
