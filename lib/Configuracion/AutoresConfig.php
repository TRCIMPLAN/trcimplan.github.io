...
class AutoresConfig {
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'Alfredo Viesca Domínguez',          'lic-alfredo-viesca-dominguez',          'IMPLAN Torreón', 'Investigación Cualitativa',             '', 'alvidom27@hotmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Frida García Gutiérrez',            'unknown',                               'IMPLAN Torreón', 'Integración de Proyectos',              '', 'garciafrida07@gmail.com', '');
    //~ $this->autores[] = new \Base\Autor('', 'Ing.', 'Guillermo Valdés Lozano',           'ing-guillermo-valdes-lozano',           'IMPLAN Torreón', 'Programación y Software',               'Desarrollador de los sistemas informáticos. Responsable del sitio web. Colabora en iniciativas de gobierno abierto.', 'gvaldes@trcimplan.gob.mx', 'guivaloz', 'guillermo-valdes-lozano.md');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Ihanelly Hernández Villa',          'unknown',                               'IMPLAN Torreón', 'Analista de Costos',                    '', 'ihanellyhdzv@gmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Iván de Luna Aldape',               'unknown',                               'IMPLAN Torreón', 'Director de Investigación Estratégica', '', 'ideluna@trcimplan.gob.mx', '');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'Jesús Javier Morán García',         'lic-jesus-javier-moran-garcia',         'IMPLAN Torreón', 'Coordinador Jurídico',                  '', 'transparencia@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Julio Alexis Magaña Cisneros',      'unknown',                               'IMPLAN Torreón', 'Estudios Sectoriales',                  '', 'alexis_wh@hotmail.com', '');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Ing.', 'Luis Campos Hinojosa',              'unknown',                               'IMPLAN Torreón', 'Director de Investigación Estratégica', '', 'lcampos@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Ing.', 'Víctor Manuel Gómez Reynoso',       'unknown',                               'IMPLAN Torreón', 'Soporte Técnico',                       '', 'vmparadigma@hotmail.com', '');
    } // constructor
