...
class AutoresConfig {
    ...
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'Natalia Morga Torres',              'lic-natalia-morga-torres',              'IMPLAN Torreón', 'Analista de Costos',                    '', '@hotmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'C.P.', 'Janeth Ramírez Facio',              'cp-janeth-ramirez-facio',               'IMPLAN Torreón', 'Auxiliar Administrativo',               'Tel. de Contacto: (871) 5007078', 'facio_janeth@hotmail.com', 'JanethFacio');
