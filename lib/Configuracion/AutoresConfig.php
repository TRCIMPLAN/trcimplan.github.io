...
class AutoresConfig {
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'José Alejandro Reyes Carrillo',     'lic-jose-alejandro-reyes-carrillo',     'IMPLAN Torreón', 'Coordinación Jurídica',                 '', 'transparencia@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Daniel Alejandro López Murga',      'lic-daniel-alejandro-lopez-murga',      'IMPLAN Torreón', 'Indicadores socioEconómicos',                'Tel. de Contacto: (871) 5007078, ext.2311', 'daniel_lmd@hotmail.com', 'daniellpzmur');
