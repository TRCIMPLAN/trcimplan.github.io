...
class AutoresConfig {
    ...
    public function __construct() {
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'arq-jose-antonio-ramirez-reyes',        'IMPLAN TORREÓN', 'DIRECTOR GENERAL',                      'Tel. de Contacto: (871) 5007078, ext.2338', 'jose.ramirez@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'María Teresa Sánchez Domínguez',    'lic-maria-teresa-sanchez-dominguez',    'IMPLAN TORREÓN', 'Secretario Técnico',                    'Tel. de Contacto: (871) 5007078, ext.2317', 'info@trcimplan.gob.mx', 'Maryteredoming3');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Miriam Alejandra Ramírez Martínez', 'lic-miriam-alejandra-ramirez-martinez', 'IMPLAN TORREÓN', 'Coordinación Jurídica',                 'Tel. de Contacto: (871) 5007078, ext.2311', 'transparencia@trcimplan.gob.mx', ' ');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Carla Estefanía Tovar Triana',      'arq-carla-estefania-tovar-triana',      'IMPLAN TORREÓN', 'Directora de Planeación Urbana Sustentable','Tel. de Contacto: (871) 5007078, ext.2316', 'info@trcimplan.gob.mx', ' ');
