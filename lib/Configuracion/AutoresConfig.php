...
class AutoresConfig {
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'José Alejandro Reyes Carrillo',     'lic-jose-alejandro-reyes-carrillo',     'IMPLAN Torreón', 'Coordinación Jurídica',                 '', 'transparencia@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Ana Luisa Pacheco Meraz',           'lic-ana-luisa-pacheco-meraz',           'IMPLAN Torreón', 'Indicadores Sociodemográficos',         '', 'ana_luisa56@hotmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Cecilio Pedro Secunza Schott',      'arq-cecilio-pedro-secunza-schott',      'IMPLAN Torreón', 'Director de Planeación Urbana',         '', 'cecilio_88@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Daniel Alejandro López Murga',      'lic-daniel-alejandro-lopez-murga',      'IMPLAN Torreón', 'Indicadores Sociodemográficos',         '', 'daniel_lmd@hotmail.com', '');
    //~ $this->autores[] = new \Base\Autor('', 'Arq.', 'Daniela Patricia Corral Hernández', 'arq-daniela-patricia-corral-hernandez', 'IMPLAN Torreón', 'Analista SIG',                          '', 'daniela.corral07@gmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Eduardo Holguín Zehfuss',           'lic-eduardo-holguin-zehfuss',           'IMPLAN Torreón', 'Director General',                      '', 'eholguin@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Frida García Gutiérrez',            'lic-frida-valeria-garcia-gutierrez',    'IMPLAN Torreón', 'Integración de Proyectos',              '', 'garciafrida07@gmail.com', '');
    //~ $this->autores[] = new \Base\Autor('', 'Ing.', 'Guillermo Valdés Lozano',           'ing-guillermo-valdes-lozano',           'IMPLAN Torreón', 'Programación y Software',               'Desarrollador de los sistemas informáticos. Responsable del sitio web. Colabora en iniciativas de gobierno abierto.', 'gvaldes@trcimplan.gob.mx', 'guivaloz', 'guillermo-valdes-lozano.md');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Ihanelly Hernández Villa',          'arq-ihanelly-hernandez-villa',          'IMPLAN Torreón', 'Regeneración Urbana',                   '', 'ihanellyhdzv@gmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Israel Sinai Charur Méndez',        'lic-israel-sinai-charur-mendez',        'IMPLAN Torreón', 'Difusión y Diseño Gráfico',             '', 'darksunno@gmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Iván de Luna Aldape',               'lic-ivan-de-luna-aldape',               'IMPLAN Torreón', 'Director de Investigación Estratégica', '', 'ideluna@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Jair Miramontes Chávez',            'arq-jair-miramontes-chavez',            'IMPLAN Torreón', 'Sistemas de Información Geográfica',    '', 'yair_mi@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Janeth Ramírez Facio',              'lic-janeth-ramirez-facio',              'IMPLAN Torreón', 'Auxiliar Administrativo',               '', 'facio_janeth@hotmail.com', '');
    ...
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'José de Jesús Ruiz Fernández',      'lic-jose-de-jesus-ruiz-fernandez',      'IMPLAN Torreón', 'Director de Competitividad Sectorial',  '', 'jruiz@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'lic-jose-antonio-ramirez-reyes',        'IMPLAN Torreón', 'Director de Competitividad Sectorial',  '', 'info@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Julio Alexis Magaña Cisneros',      'arq-julio-alexis-magana-cisneros',      'IMPLAN Torreón', 'Estudios Sectoriales',                  '', 'alexis_wh@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Macarena Garcia Aguilar',           'lic-macarena-garcia-aguilar',           'IMPLAN Torreón', 'Gestión y Difusión Social',             '', 'macarena1605@gmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'María Teresa Sánchez Domínguez',    'lic-maria-teresa-sanchez-dominguez',    'IMPLAN Torreón', 'Asistente Presidencia',                 '', 'marytere161091@hotmail.com', '');
