...
class AutoresConfig {
    ...
    public function __construct() {
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Carla Estefanía Tovar Triana',      'arq-carla-estefania-tovar-triana',      'IMPLAN Torreón', 'Director de Planeación Urbana Sustentable','Tel. de Contacto: (871) 5007078, ext.2316', 'info@trcimplan.gob.mx', ' ');
