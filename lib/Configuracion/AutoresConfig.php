...
class AutoresConfig {
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'José Alejandro Reyes Carrillo',     'lic-jose-alejandro-reyes-carrillo',     'IMPLAN Torreón', 'Coordinación Jurídica',                 '', 'transparencia@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Daniel Alejandro López Murga',      'lic-daniel-alejandro-lopez-murga',      'IMPLAN Torreón', 'Indicadores Sociodemográficos',         'Tel. de Contacto: (871) 5007078, ext.2311', 'daniel_lmd@hotmail.com', 'daniellpzmur');
    ...
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'José de Jesús Ruiz Fernández',      'lic-jose-de-jesus-ruiz-fernandez',      'IMPLAN Torreón', 'Director de Competitividad Sectorial',  '', 'jruiz@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Nayeli Alejandra García Rodríguez', 'lic-nayeli-alejandra-garcia-aguirre',   'IMPLAN Torreón', 'Auxiliar Administrativo',               'Tel. de Contacto: (871) 5007078', 'nayeli_ale08@hotmail.com', 'nayeli_garcia08');
        ...
        $this->autores[] = new \Base\Autor('', ''    , 'Jesús Manuel Sotomayor Serrano',    'jesus-manuel-sotomayor-serrano',        'IMPLAN Torreón', 'Asistente de Presidencia',              'Tel. de Contacto: (871) 5007078', 'jmsotomayor82@hotmail.com', 'JMSotomayor82');
