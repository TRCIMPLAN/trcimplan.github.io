...
class AutoresConfig {
    ...
    const INDICE_TITULO            = 'Quiénes Somos?';                               // Título para la página índice
    const INDICE_DESCRIPCION       = '¿Quiénes son integrantes del IMPLAN Torreón?.'; // Descripción para la página índice
    ...
    public function __construct() {
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'arq-jose-antonio-ramirez-reyes',        'IMPLAN TORREÓN', 'DIRECTOR GENERAL',                      'Tel. de Contacto: (871) 5007078, ext.2338', 'director@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'María Teresa Sánchez Domínguez',    'lic-maria-teresa-sanchez-dominguez',    'IMPLAN TORREÓN', 'Secretario Técnico',                    'Tel. de Contacto: (871) 5007078, ext.2317', 'coordinacion@trcimplan.gob.mx', 'Maryteredoming3');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Maira Ivonne Flores Reyes',         'lic-maira-ivonne-flores-reyes',         'IMPLAN TORREÓN', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2353', 'comunicacion@trcimplan.gob.mx', ' ');


        $this->autores[] = new \Base\Autor('', 'Lic.', 'Jesús Abraham Salazar Valadez',     'lic-jesus-abraham-salazar-valadez',     'IMPLAN TORREÓN', 'Director de Competitividad Sectorial',  'Tel. de Contacto: (871) 5007078, ext.2338', 'competitividad@trcimplan.gob.mx', ' ');

        $this->autores[] = new \Base\Autor('', 'Lic.', 'Oscar Francisco Martínez Olivas',   'lic-oscar-francisco-martinez-olivas',   'IMPLAN Torreón', 'Coordinación Jurídica',                 'Tel. de Contacto: (871) 5007078, ext.2311', 'juridico@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Felipe de Jesús Medina Delgado',    'lic-felipe-de-jesus-medina-delgado',    'IMPLAN TORREÓN', 'Asistente de Direcciones',              'Tel. de Contacto: (871) 5007078, ext.2317', 'transparencia@trcimplan.gob.mx', ' ');

        $this->autores[] = new \Base\Autor('', 'Lic.', 'Frida García Gutiérrez',            'lic-frida-valeria-garcia-gutierrez',    'IMPLAN TORREÓN', 'Directora de Proyectos Estratégicos',   'Tel. de Contacto: (871) 5007078, ext.2305', 'proyectos@trcimplan.gob.mx', 'garciafrida07');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Miriam Janeth González Quintana',   'lic-miriam-janeth-gonzalez-quintana',   'IMPLAN TORREÓN', 'Planeación Estratégica Integral',       'Tel. de Contacto: (871) 5007078, ext.2305', 'proyectos@trcimplan.gob.mx', 'MiriamJglz');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Carla Estefanía Tovar Triana',      'arq-carla-estefania-tovar-triana',      'IMPLAN TORREÓN', 'Directora de Planeación Urbana Sustentable','Tel. de Contacto: (871) 5007078, ext.2316', 'planeacion@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Olga Daniela Sánchez Valles',       'arq-olga-daniela-sanchez-valles',       'IMPLAN TORREÓN', 'Regeneración Urbana',                   'Tel. de Contacto: (871) 5007078, ext.2316', 'regeneracion@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Ihanelly Hernández Villa',          'arq-ihanelly-hernandez-villa',          'IMPLAN TORREÓN', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2316', 'planesyprogramas@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Jair Miramontes Chávez',            'arq-jair-miramontes-chavez',            'IMPLAN TORREÓN', 'Sistemas de Información Geográfica',    'Tel. de Contacto: (871) 5007078, ext.2316', 'sig@trcimplan.gob.mx', 'Jairmi');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Edgardo de la Cruz Torres',         'lic-edgardo-de-la-cruz-torres',         'IMPLAN TORREÓN', 'Instrumentación política y jurídica',   'Tel. de Contacto: (871) 5007078, ext.2316', 'info@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Estefanía Rodríguez Schott',        'arq-estefania-rodriguez-schott',        'IMPLAN TORREÓN', 'Vinculación Universidad Empresa',       'Tel. de Contacto: (871) 5007078, ext.2338', 'sig@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Ing.', 'Ricardo Miranda Briones',           'ing-ricardo-miranda-briones',           'IMPLAN TORREÓN', 'Estudios Sectoriales',                  'Tel. de Contacto: (871) 5007078, ext.2305', 'esectoriales@trcimplan.gob.mx', ' ');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Pedro Eleazar González Valdez',     'lic-pedro-eleazar-gonzalez-valdez',     'IMPLAN TORREÓN', 'Director de Investigación Estratégica', 'Tel. de Contacto: (871) 5007078, ext.2311', 'investigacion@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Olga Alejandra Noriega Aranda',     'lic-olga-alejandra-noriega-aranda',     'IMPLAN TORREÓN', 'Indicadores Económicos',                  'Tel. de Contacto: (871) 5007078, ext.2305', 'economicos@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Carlos Andrés Chairez Ibarra',      'lic-carlos-andres-chairez-ibarra',      'IMPLAN Torreón', 'Indicadores Sociodemográficos',         'Tel. de Contacto: (871) 5007078, ext.2311', 'sociodemografico@trcimplan.gob.mx', ' ');
        $this->autores[] = new \Base\Autor('', 'Lsci.', 'Víctor Manuel Gómez Reynoso',      'lsci-victor-manuel-gomez-reynoso',      'IMPLAN TORREÓN', 'Programación y Software',               'Tel. de Contacto: (871) 5007078, ext.2311', 'soporte@trcimplan.gob.mx', 'VGomezReynoso');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Michelle Bañuelos Barrientos',      'lic-michelle-banuelos-barrientos',      'IMPLAN TORREÓN', 'Soporte Técnico',                       'Tel. de Contacto: (871) 5007078, ext.2311', 'info@trcimplan.gob.mx', '');
        ...
        $this->autores[] = new \Base\Autor('', 'C.',   'Jesús Manuel Sotomayor Serrano',    'jesus-manuel-sotomayor-serrano',        'IMPLAN TORREÓN', 'Asistente de Presidencia',              'Tel. de Contacto: (871) 5007078', 'gestoria@trcimplan.gob.mx', 'JMSotomayor82');
        ...
        $this->autores[] = new \Base\Autor('', 'C.P.', 'Cynthia García Castañeda',          'cp-cynthia-garcia-castaneda',           'IMPLAN TORREÓN', 'Auxiliar Administrativo',               'Tel. de Contacto: (871) 5007078', 'info@trcimplan.gob.mx', '');
    ...
    //$this->autores[] = new \Base\Autor('', 'Lic.', 'Miriam Alejandra Ramírez Martínez', 'lic-miriam-alejandra-ramirez-martinez', 'IMPLAN TORREÓN', 'Coordinación Jurídica',                 'Tel. de Contacto: (871) 5007078, ext.2311', 'juridico@trcimplan.gob.mx', ' ');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Ing.', 'Guillermo Valdés Lozano',           'ing-guillermo-valdes-lozano',           'IMPLAN Torreón', 'Programación y Software',               'Desarrollador de los sistemas informáticos.', 'gvaldes@trcimplan.gob.mx', 'guivaloz', 'guillermo-valdes-lozano.md');
