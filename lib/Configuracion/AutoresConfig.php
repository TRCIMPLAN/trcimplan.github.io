...
class AutoresConfig {
    ...
    public function __construct() {
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Frida García Gutiérrez',            'lic-frida-valeria-garcia-gutierrez',    'IMPLAN Torreón', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2305', 'proyectosestrategicos@trcimplan.gob.mx', 'garciafrida07');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'arq-jose-antonio-ramirez-reyes',        'IMPLAN Torreón', 'Director de Planeación Urbana Sustentable','Tel. de Contacto: (871) 5007078, ext.2338', 'jose.ramirez@trcimplan.gob.mx', ' ');
