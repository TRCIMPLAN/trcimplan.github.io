...
class AutoresConfig {
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'Adriana Vargas Flores',             'lic-adriana-vargas-flores',             'IMPLAN Torreón', 'Integración de Proyectos',              '', 'vargasadriana09@gmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Alejandra Martínez Avilés',         'arq-alejandra-martinez-aviles',         'IMPLAN Torreón', 'Analista de Costos',                    'Tel. de Contacto: (871) 5007078, ext.2305', 'alemtzza@gmail.com', '');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'Alicia Valdez Ibarra',              'lic-alicia-valdez-ibarra',              'IMPLAN Torreón', 'Director de Proyectos Estratégicos',    'Tel. de Contacto: (871) 5007078, ext.2305', 'alicia.valdez.ibarra@gmail.com', 'alicia_vi');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Ana Luisa Pacheco Meraz',           'lic-ana-luisa-pacheco-meraz',           'IMPLAN Torreón', 'Indicadores Sociodemográficos',         'Tel. de Contacto: (871) 5007078, ext.2311', 'ana_luisa56@hotmail.com', 'anapm56');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Carla Estefanía Tovar Triana',      'arq-carla-estefania-tovar-triana',      'IMPLAN Torreón', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2316', '@gmail.com', '');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Arq.', 'Daniela Patricia Corral Hernández', 'arq-daniela-patricia-corral-hernandez', 'IMPLAN Torreón', 'Analista SIG',                          '', 'daniela.corral07@gmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Felipe de Jesús Medina Delgado',    'lic-felipe-de-jesus-medina-delgado',    'IMPLAN Torreón', 'Asistente de Direcciones',              'Tel. de Contacto: (871) 5007078, ext.2317', 'felipe.medinadelgado@outlook.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Frida García Gutiérrez',            'lic-frida-valeria-garcia-gutierrez',    'IMPLAN Torreón', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2305', 'garciafrida07@gmail.com', 'garciafrida07');
    ...
    //~ $this->autores[] = new \Base\Autor('', 'Lic.', 'Gerardo Villa González',            'lic-gerardo-villa-gonzalez',            'IMPLAN Torreón', 'Coordinación Jurídica',                 'Tel. de Contacto: (871) 5007078, ext.2311', 'transparencia@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Ihanelly Hernández Villa',          'arq-ihanelly-hernandez-villa',          'IMPLAN Torreón', 'Regeneración Urbana',                   'Tel. de Contacto: (871) 5007078, ext.2316', 'ihanellyhdzv@gmail.com', 'ihanelly_64');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Israel Sinai Charur Méndez',        'lic-israel-sinai-charur-mendez',        'IMPLAN Torreón', 'Difusión y Diseño Gráfico',             'Tel. de Contacto: (871) 5007078, ext.2461', 'darksunno@gmail.com', 'sunnocharur');
        ...
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Jair Miramontes Chávez',            'arq-jair-miramontes-chavez',            'IMPLAN Torreón', 'Sistemas de Información Geográfica',    'Tel. de Contacto: (871) 5007078, ext.2316', 'yair_mi@hotmail.com', 'Jairmi');
    ...
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'José de Jesús Ruiz Fernández',      'lic-jose-de-jesus-ruiz-fernandez',      'IMPLAN Torreón', 'Director de Competitividad Sectorial',  '', 'jruiz@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'arq-jose-antonio-ramirez-reyes',        'IMPLAN Torreón', 'Director de Competitividad Sectorial',  'Tel. de Contacto: (871) 5007078, ext.2338', 'info@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'Julio Alexis Magaña Cisneros',      'arq-julio-alexis-magana-cisneros',      'IMPLAN Torreón', 'Estudios Sectoriales',                  'Tel. de Contacto: (871) 5007078, ext.2316', 'alexis_wh@hotmail.com', 'jokeralex53');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Macarena Garcia Aguilar',           'lic-macarena-garcia-aguilar',           'IMPLAN Torreón', 'Gestión y Difusión Social',             'Tel. de Contacto: (871) 5007078, ext.2353', 'macarena1605@gmail.com', 'macarenaga_');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Maira Ivonne Flores Reyes',         'lic-maira-ivonne-flores-reyes',         'IMPLAN Torreón', 'Integración de Proyectos',              'Tel. de Contacto: (871) 5007078, ext.2353', 'ivonreyes85@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'María Teresa Sánchez Domínguez',    'lic-maria-teresa-sanchez-dominguez',    'IMPLAN Torreón', 'Asistente Presidencia',                 'Tel. de Contacto: (871) 5007078, ext.2317', 'marytere161091@hotmail.com', 'Maryteredoming3');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Miriam Janeth González Quintana',   'lic-miriam-janeth-gonzalez-quintana',   'IMPLAN Torreón', 'Planeación Estratégica Integral',       'Tel. de Contacto: (871) 5007078, ext.2305', 'miriam.jglz@gmail.com', 'MiriamJglz');
        $this->autores[] = new \Base\Autor('', 'C.',   'Nayeli Alejandra García Rodríguez', 'lic-nayeli-alejandra-garcia-aguirre',   'IMPLAN Torreón', 'Auxiliar Administrativo',               'Tel. de Contacto: (871) 5007078', 'nayeli_ale08@hotmail.com', 'nayeli_garcia08');
        $this->autores[] = new \Base\Autor('', 'Lsci.', 'Víctor Manuel Gómez Reynoso',      'lsci-victor-manuel-gomez-reynoso',      'IMPLAN Torreón', 'Programación y Software',               'Tel. de Contacto: (871) 5007078, ext.2311', 'vmparadigma@hotmail.com', 'VGomezReynoso');
        ...
        $this->autores[] = new \Base\Autor('', 'C.',   'Jesús Manuel Sotomayor Serrano',    'jesus-manuel-sotomayor-serrano',        'IMPLAN Torreón', 'Asistente de Presidencia',              'Tel. de Contacto: (871) 5007078', 'jmsotomayor82@hotmail.com', 'JMSotomayor82');
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'Natalia Morga Torres',              'lic-natalia-morga-torres',              'IMPLAN Torreón', 'Analista de Costos',                    '', '@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Pedro Eleazar González Valdez',     'lic-pedro-eleazar-gonzalez-valdez',     'IMPLAN Torreón', 'Indicadores Económicos',                'Tel. de Contacto: (871) 5007078, ext.2311', 'eleazar.gonzalez.v@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Bernardo García Colores García',    'lic-bernardo-garcia-colores-garcia',    'IMPLAN Torreón', 'Analista SIG',                          'Tel. de Contacto: (871) 5007078, ext.2305', '@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Jesús Abraham Salazar Valadez',     'lic-jesus-abraham-salazar-valadez',     'IMPLAN Torreón', 'Director de Competitividad Sectorial',  'Tel. de Contacto: (871) 5007078, ext.2338', '@hotmail.com', '');
        ...
        $this->autores[] = new \Base\Autor('', 'C.P.', 'Santa Julia Camarillo Aguirre',     'cp-santa-julia-camarillo-aguirre',      'IMPLAN Torreón', 'Contador',                              'Tel. de Contacto: (871) 5007078, ext.2315', 'sanjuly_06@hotmail.com', '');
        $this->autores[] = new \Base\Autor('', 'Lic.', 'Janeth Ramírez Facio',              'lic-janeth-ramirez-facio',              'IMPLAN Torreón', 'Auxiliar Administrativo',               'Tel. de Contacto: (871) 5007078', 'facio_janeth@hotmail.com', 'JanethFacio');
