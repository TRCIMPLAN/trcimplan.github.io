...
class AutoresConfig {
    ...
    //~     $this->autores[] = new \Base\Autor('', 'Lic.', 'José de Jesús Ruiz Fernández',      'lic-jose-de-jesus-ruiz-fernandez',      'IMPLAN Torreón', 'Director de Competitividad Sectorial',  '', 'jruiz@trcimplan.gob.mx', '');
        $this->autores[] = new \Base\Autor('', 'Arq.', 'José Antonio Ramírez Reyes',        'arq-jose-antonio-ramirez-reyes',        'IMPLAN Torreón', 'Director de Planeación Urbana',         'Tel. de Contacto: (871) 5007078, ext.2338', 'info@trcimplan.gob.mx', '');
