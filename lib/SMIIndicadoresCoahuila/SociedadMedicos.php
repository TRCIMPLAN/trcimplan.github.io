<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadMedicos
 *
...
class SociedadMedicos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Médicos en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Salud, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2002-12-31', 'valor' => '3.2000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2003-12-31', 'valor' => '3.2000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2004-12-31', 'valor' => '3.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2005-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2006-12-31', 'valor' => '3.4000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2007-12-31', 'valor' => '3.9000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2008-12-31', 'valor' => '3.8000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2009-12-31', 'valor' => '4.3000', 'fuente_nombre' => 'SINAIS (SSA)'),
            ...
            array('fecha' => '2012-12-31', 'valor' => '4.5000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2013-12-31', 'valor' => '4.5000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2014-12-31', 'valor' => '4.5000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 30, crudo 15
    } // datos
