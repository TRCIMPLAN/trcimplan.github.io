<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SustentabilidadCapacidadDeTratamientoDeAguaEnOperacion
 *
...
class SustentabilidadCapacidadDeTratamientoDeAguaEnOperacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Capacidad de Tratamiento de Agua en Operación en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Índice de Competitividad Urbana, Medio Ambiente, Recursos Naturales';
        // Para el Organizador
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2016-12-31', 'valor' => '2.3000', 'fuente_nombre' => 'IMCO'),
