<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadEsperanzaDeVidaDeLasMujeres
 *
...
class SociedadEsperanzaDeVidaDeLasMujeres extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Esperanza de Vida de las Mujeres en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '78.1000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
