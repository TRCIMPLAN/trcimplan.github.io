<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadCasosAcumuladosDeCovid19Negativos
 *
...
class SociedadCasosAcumuladosDeCovid19Negativos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Casos acumulados de COVID-19 negativos en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2020-05-07', 'valor' => '336', 'fuente_nombre' => 'Secretaría de Salud'),
            array('fecha' => '2020-05-09', 'valor' => '1156', 'fuente_nombre' => 'Secretaría de Salud'),
            array('fecha' => '2020-05-15', 'valor' => '21', 'fuente_nombre' => 'Secretaría de Salud'),
            array('fecha' => '2020-05-16', 'valor' => '31', 'fuente_nombre' => 'Secretaría de Salud'),
            array('fecha' => '2020-05-17', 'valor' => '123', 'fuente_nombre' => 'Secretaría de Salud')); // formateado 0, valor 10, crudo 5
    } // datos
