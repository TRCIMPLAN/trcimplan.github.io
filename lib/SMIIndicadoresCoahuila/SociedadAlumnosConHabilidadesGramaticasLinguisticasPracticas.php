<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadAlumnosConHabilidadesGramaticasLinguisticasPracticas
 *
...
class SociedadAlumnosConHabilidadesGramaticasLinguisticasPracticas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Gramáticas-Lingüísticas Prácticas en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '17.0000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
