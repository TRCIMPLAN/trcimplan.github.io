<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadIndiceDeDesarrolloHumanoIdh
 *
...
class SociedadIndiceDeDesarrolloHumanoIdh extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Desarrollo Humano (IDH) en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '0.7760', 'fuente_nombre' => 'INAFED-PNUD')); // formateado 0, valor 2, crudo 1
    } // datos
