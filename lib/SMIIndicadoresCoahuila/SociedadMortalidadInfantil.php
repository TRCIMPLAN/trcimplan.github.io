<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadMortalidadInfantil
 *
...
class SociedadMortalidadInfantil extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad Infantil en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Salud, Objetivos del Milenio, Índice de Competitividad Urbana, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2010-12-31', 'valor' => '10.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2011-12-31', 'valor' => '9.4000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2012-12-31', 'valor' => '12.8000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2013-12-31', 'valor' => '11.9000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 10, crudo 5
    } // datos
