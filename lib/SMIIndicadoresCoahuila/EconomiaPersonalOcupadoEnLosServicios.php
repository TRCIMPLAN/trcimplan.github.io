<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila EconomiaPersonalOcupadoEnLosServicios
 *
...
class EconomiaPersonalOcupadoEnLosServicios extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personal Ocupado en los Servicios en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '28.6520', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
