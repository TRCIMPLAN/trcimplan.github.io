<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SustentabilidadGeneracionDeBasura
 *
...
class SustentabilidadGeneracionDeBasura extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Generación de Basura en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Medio Ambiente, Recursos Naturales';
        // Para el Organizador
