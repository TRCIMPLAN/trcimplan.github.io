<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila GobiernoIndiceDeInformacionPresupuestal
 *
...
class GobiernoIndiceDeInformacionPresupuestal extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Información Presupuestal en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Índice de Competitividad Urbana, Transparencia';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '100.0000', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2018-12-31', 'valor' => '68.7400', 'fuente_nombre' => 'IMCO', 'notas' => 'Índice (0-100) (IMCO)'),
