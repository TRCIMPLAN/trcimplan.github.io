<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadGradoPromedioDeEscolaridad
 *
...
class SociedadGradoPromedioDeEscolaridad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Grado Promedio de Escolaridad en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '9.9000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
