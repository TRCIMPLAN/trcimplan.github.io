...
class SeguridadViolenciaFamiliar extends \SMIBase\PublicacionWeb {
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-03-31', 'valor' => '797', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos'),
            array('fecha' => '2022-04-30', 'valor' => '797', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 4, crudo 2
    } // datos
