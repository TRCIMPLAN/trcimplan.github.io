<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadMortalidadPorVihSida
 *
...
class SociedadMortalidadPorVihSida extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por VIH-SIDA en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
        $this->categorias  = array('Salud', 'Bienestar', 'Grupos Vulnerables', 'Objetivos del Milenio', 'Sector Automotriz');
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '3.7000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
