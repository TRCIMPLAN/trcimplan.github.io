<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadPobrezaExtrema
 *
...
class SociedadPobrezaExtrema extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Pobreza Extrema en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Bienestar, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '2.9400', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
