...
class Imprenta extends \Base\ImprentaPublicaciones {
    ...
    public function __construct() {
        ...
        $this->publicaciones_directorio  = 'SMIIndicadoresCoahuila';
        // Los siguientes parámetros dan datos para el concentrador y las páginas que no los tienen
        $this->titulo                    = 'Indicadores de Coahuila';
        $this->descripcion               = 'Sistema Metropolitano de Indicadores, Región Coahuila.';
        $this->claves                    = 'IMPLAN, SMI, Indicadores, Metropolitanos, Coahuila';
        ...
        $this->directorio                = 'indicadores-coahuila';
