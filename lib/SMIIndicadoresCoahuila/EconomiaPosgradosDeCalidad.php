<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila EconomiaPosgradosDeCalidad
 *
...
class EconomiaPosgradosDeCalidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Posgrados de Calidad en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Educación, Innovación';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-04-30', 'valor' => '51', 'fuente_nombre' => 'CONACYT', 'notas' => 'Fuente: [CONACYT](http://www.conacyt.gob.mx)'),
            array('fecha' => '2016-12-31', 'valor' => '54', 'fuente_nombre' => 'CONACYT')); // formateado 0, valor 4, crudo 3
    } // datos
