<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadRezagoEducativo
 *
...
class SociedadRezagoEducativo extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Rezago Educativo en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Educación, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '12.1000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
