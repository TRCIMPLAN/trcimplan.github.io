<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SeguridadDelitosPatrimoniales
 *
...
class SeguridadDelitosPatrimoniales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Delitos Patrimoniales en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2019-11-30', 'valor' => '20', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 2, crudo 1
    } // datos
