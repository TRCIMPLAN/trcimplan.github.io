<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadPobrezaModerada
 *
 ...
 */
class SociedadPobrezaModerada extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Pobreza Moderada en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Bienestar, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '24.7600', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2015-12-31', 'valor' => '23.4000', 'fuente_nombre' => 'CONEVAL'),
            ...
            array('region_nombre' => 'Matamoros', 'fecha' => '2015-12-31', 'valor' => '37.7000', 'fuente_nombre' => 'CONEVAL'),
