<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadUsuariosDeInternet
 *
...
class SociedadUsuariosDeInternet extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Usuarios de Internet en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Innovación, Competitividad, Objetivos del Milenio';
        // Para el Organizador
