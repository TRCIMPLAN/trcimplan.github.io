...
class Imprenta extends \Base\ImprentaPublicaciones {
    ...
    public function __construct() {
        ...
        $this->publicaciones_directorio  = 'IBCColoniasTorreonDistritos';
        // Los siguientes parámetros dan datos para el índice/galería que será creado
        $this->titulo                    = 'Colonias de Torreón Distritos';
        $this->descripcion               = 'Indicadores Básicos de Colonias de Torreón Distritos, Coahuila de Zaragoza, México.';
        $this->claves                    = 'IMPLAN, Torreon, Indicadores, Colonias, Torreón Distritos';
        ...
        $this->nombre_menu               = 'Indicadores Básicos de Colonias > Colonias de Torreón Distritos';
        // Ruta a la clase para hacer la página con el índice
        $this->indices_paginas           = '\\Base\\PaginasListadoAlfabetico';
        // Directorio en la raíz que será creado para alojar el concentrador y las páginas
        $this->directorio                = 'ibc-colonias-torreondistritos';
