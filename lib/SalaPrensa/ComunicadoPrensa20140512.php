...
class ComunicadoPrensa20140512 extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre_menu   = 'Com. Prensa 12.5.14';
        $this->directorio    = 'sala-prensa';
        $this->archivo       = '2014-05-14-comunicado-prensa';
        $this->descripcion   = 'Precisiones respecto a conferencia de Sam Podolsky y a la siguiente reflexión del investigador.';
        $this->claves        = 'IMPLAN, Torreon, Comunicado, Prensa';
        $this->imagen_previa = 'presentacion-smi/imagen-previa.jpg';
        $this->categorias    = array('Comunicados');
        $this->contenido     = <<<FINAL
<img class="img-responsive contenido-imagen" src="2014-05-14-comunicado-prensa/implan.png">
...
<p>Precisión 1: "El Consejo" del Instituto de Planeación y Competitividad de Torreón (IMPLAN Torreón) está conformado por miembros del sector público, privado y social. 70% del "El Consejo" está representado por ciudadanos, el resto son miembros del Cabildo y funcionarios del Ayuntamiento.</p>
