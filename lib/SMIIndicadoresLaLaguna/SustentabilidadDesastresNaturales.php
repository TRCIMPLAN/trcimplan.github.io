...
class SustentabilidadDesastresNaturales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, La Laguna, Índice de Competitividad Urbana, Bienestar, Medio Ambiente';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2013-12-31', 'valor' => '19', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2014-12-31', 'valor' => '15', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 14, crudo 7
    } // datos
