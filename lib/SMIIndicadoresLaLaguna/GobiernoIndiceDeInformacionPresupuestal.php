...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashexdusos">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetouyqlhlf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashexdusos a:first').tab('show')
});
// LENGUETA
$('#Lenguetashexdusos a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapouyqlhlf;
  ...
  function initmapouyqlhlf() {
    // Nuevo Mapa
    mapouyqlhlf = new L.Map('LeafLetouyqlhlf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapouyqlhlf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapouyqlhlf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapouyqlhlf === 'undefined') {
    varinitmapouyqlhlf = initmapouyqlhlf();
  };
});
FINAL;
    } // constructor
