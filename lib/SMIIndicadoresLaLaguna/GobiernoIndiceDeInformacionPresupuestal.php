...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvttsxmkq">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetotpnthqt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvttsxmkq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvttsxmkq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapotpnthqt;
  ...
  function initmapotpnthqt() {
    // Nuevo Mapa
    mapotpnthqt = new L.Map('LeafLetotpnthqt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapotpnthqt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapotpnthqt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapotpnthqt === 'undefined') {
    varinitmapotpnthqt = initmapotpnthqt();
  };
});
FINAL;
    } // constructor
