...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiaiygrsx">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoiwxidws" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiaiygrsx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiaiygrsx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoiwxidws;
  ...
  function initmapoiwxidws() {
    // Nuevo Mapa
    mapoiwxidws = new L.Map('LeafLetoiwxidws');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoiwxidws.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoiwxidws.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoiwxidws === 'undefined') {
    varinitmapoiwxidws = initmapoiwxidws();
  };
});
FINAL;
    } // constructor
