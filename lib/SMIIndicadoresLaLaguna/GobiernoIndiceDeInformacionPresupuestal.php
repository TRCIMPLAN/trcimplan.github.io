...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswcwbexuy">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethhlwuzur" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswcwbexuy a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswcwbexuy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphhlwuzur;
  ...
  function initmaphhlwuzur() {
    // Nuevo Mapa
    maphhlwuzur = new L.Map('LeafLethhlwuzur');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphhlwuzur.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphhlwuzur.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphhlwuzur === 'undefined') {
    varinitmaphhlwuzur = initmaphhlwuzur();
  };
});
FINAL;
    } // constructor
