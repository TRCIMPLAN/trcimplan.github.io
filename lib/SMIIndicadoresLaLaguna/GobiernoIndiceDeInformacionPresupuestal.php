<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Gobierno Índice de Información Presupuestal (Creado por Central:SmiLanzadera)
 *
...
<p>Incluido en el subíndice de "Gobiernos Eficientes y Eficaces". Mide la calidad de la información tanto de los presupuestos de egresos como de las leyes de ingresos de las ciudades.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Índice de Información Presupuestal en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 15.3226 },{ fecha: '2009-12-31', dato: 15.3226 },{ fecha: '2010-12-31', dato: 5.0000 },{ fecha: '2011-12-31', dato: 14.5161 },{ fecha: '2012-12-31', dato: 22.7941 },{ fecha: '2013-12-31', dato: 26.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
