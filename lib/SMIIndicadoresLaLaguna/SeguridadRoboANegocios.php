...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasriyxlgsj">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiiqsmsng" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoebjgkdw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasriyxlgsj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasriyxlgsj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiiqsmsng === 'undefined') {
    varMorrisiiqsmsng = Morris.Line({
      element: 'Morrisiiqsmsng',
...
// LENGUETA
$('#Lenguetasriyxlgsj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoebjgkdw;
  ...
  function initmapoebjgkdw() {
    // Nuevo Mapa
    mapoebjgkdw = new L.Map('LeafLetoebjgkdw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoebjgkdw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoebjgkdw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoebjgkdw === 'undefined') {
    varinitmapoebjgkdw = initmapoebjgkdw();
  };
});
FINAL;
    } // constructor
