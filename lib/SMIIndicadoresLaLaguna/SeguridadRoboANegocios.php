...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasohovtmmd">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislghycqvj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasohovtmmd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasohovtmmd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislghycqvj === 'undefined') {
    varMorrislghycqvj = Morris.Line({
      element: 'Morrislghycqvj',
