...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmhqvypig">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszjnwyolr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmhqvypig a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmhqvypig a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszjnwyolr === 'undefined') {
    varMorriszjnwyolr = Morris.Line({
      element: 'Morriszjnwyolr',
