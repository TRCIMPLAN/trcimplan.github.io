...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasopydtkro">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiookycyw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasopydtkro a:first').tab('show')
});
// LENGUETA
$('#Lenguetasopydtkro a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiookycyw;
  ...
  function initmapiookycyw() {
    // Nuevo Mapa
    mapiookycyw = new L.Map('LeafLetiookycyw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiookycyw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiookycyw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiookycyw === 'undefined') {
    varinitmapiookycyw = initmapiookycyw();
  };
});
FINAL;
    } // constructor
