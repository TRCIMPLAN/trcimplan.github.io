...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasngeltier">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkgrgwhnw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasngeltier a:first').tab('show')
});
// LENGUETA
$('#Lenguetasngeltier a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkgrgwhnw;
  ...
  function initmapkgrgwhnw() {
    // Nuevo Mapa
    mapkgrgwhnw = new L.Map('LeafLetkgrgwhnw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkgrgwhnw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkgrgwhnw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkgrgwhnw === 'undefined') {
    varinitmapkgrgwhnw = initmapkgrgwhnw();
  };
});
FINAL;
    } // constructor
