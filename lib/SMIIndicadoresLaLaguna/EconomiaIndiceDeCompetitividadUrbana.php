...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvybjvjqb">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgijekwmt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvybjvjqb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvybjvjqb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgijekwmt;
  ...
  function initmapgijekwmt() {
    // Nuevo Mapa
    mapgijekwmt = new L.Map('LeafLetgijekwmt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgijekwmt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgijekwmt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgijekwmt === 'undefined') {
    varinitmapgijekwmt = initmapgijekwmt();
  };
});
FINAL;
    } // constructor
