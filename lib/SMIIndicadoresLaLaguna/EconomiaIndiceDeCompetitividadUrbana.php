...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmrbabwua">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxqdvgcca" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmrbabwua a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmrbabwua a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxqdvgcca;
  ...
  function initmapxqdvgcca() {
    // Nuevo Mapa
    mapxqdvgcca = new L.Map('LeafLetxqdvgcca');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxqdvgcca.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxqdvgcca.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxqdvgcca === 'undefined') {
    varinitmapxqdvgcca = initmapxqdvgcca();
  };
});
FINAL;
    } // constructor
