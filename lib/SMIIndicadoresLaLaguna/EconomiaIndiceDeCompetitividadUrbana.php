...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswziupqgz">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetegdweyow" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswziupqgz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswziupqgz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapegdweyow;
  ...
  function initmapegdweyow() {
    // Nuevo Mapa
    mapegdweyow = new L.Map('LeafLetegdweyow');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapegdweyow.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapegdweyow.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapegdweyow === 'undefined') {
    varinitmapegdweyow = initmapegdweyow();
  };
});
FINAL;
    } // constructor
