...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnuofzxax">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislfgzaarc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnuofzxax a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnuofzxax a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislfgzaarc === 'undefined') {
    varMorrislfgzaarc = Morris.Line({
      element: 'Morrislfgzaarc',
