...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasudjytqtg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjcxybtjl" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasudjytqtg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasudjytqtg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjcxybtjl === 'undefined') {
    varMorrisjcxybtjl = Morris.Line({
      element: 'Morrisjcxybtjl',
