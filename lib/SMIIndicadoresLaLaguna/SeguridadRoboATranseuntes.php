...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxfhsresi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismrgxxzgf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetixyuqlbe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxfhsresi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxfhsresi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismrgxxzgf === 'undefined') {
    varMorrismrgxxzgf = Morris.Line({
      element: 'Morrismrgxxzgf',
...
// LENGUETA
$('#Lenguetasxfhsresi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapixyuqlbe;
  ...
  function initmapixyuqlbe() {
    // Nuevo Mapa
    mapixyuqlbe = new L.Map('LeafLetixyuqlbe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapixyuqlbe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapixyuqlbe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapixyuqlbe === 'undefined') {
    varinitmapixyuqlbe = initmapixyuqlbe();
  };
});
FINAL;
    } // constructor
