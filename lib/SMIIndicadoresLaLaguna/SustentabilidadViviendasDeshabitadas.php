...
class SustentabilidadViviendasDeshabitadas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbdhhqhqa">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetybeznhhx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbdhhqhqa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbdhhqhqa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapybeznhhx;
  ...
  function initmapybeznhhx() {
    // Nuevo Mapa
    mapybeznhhx = new L.Map('LeafLetybeznhhx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapybeznhhx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapybeznhhx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapybeznhhx === 'undefined') {
    varinitmapybeznhhx = initmapybeznhhx();
  };
});
FINAL;
    } // constructor
