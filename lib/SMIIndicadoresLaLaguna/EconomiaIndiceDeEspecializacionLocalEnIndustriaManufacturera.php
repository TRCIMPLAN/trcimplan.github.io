...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszkliugaj">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdyadqvgj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszkliugaj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszkliugaj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdyadqvgj === 'undefined') {
    varMorrisdyadqvgj = Morris.Line({
      element: 'Morrisdyadqvgj',
