...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxbdiypcn">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristyuyxuju" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzeptbxiw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxbdiypcn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxbdiypcn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristyuyxuju === 'undefined') {
    varMorristyuyxuju = Morris.Line({
      element: 'Morristyuyxuju',
...
// LENGUETA
$('#Lenguetasxbdiypcn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzeptbxiw;
  ...
  function initmapzeptbxiw() {
    // Nuevo Mapa
    mapzeptbxiw = new L.Map('LeafLetzeptbxiw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzeptbxiw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzeptbxiw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzeptbxiw === 'undefined') {
    varinitmapzeptbxiw = initmapzeptbxiw();
  };
});
FINAL;
    } // constructor
