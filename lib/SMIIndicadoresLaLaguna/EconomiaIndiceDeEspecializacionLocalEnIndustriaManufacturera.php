...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjudqxgqf">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbwzxvtcn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxuiirvhg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjudqxgqf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjudqxgqf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbwzxvtcn === 'undefined') {
    varMorrisbwzxvtcn = Morris.Line({
      element: 'Morrisbwzxvtcn',
...
// LENGUETA
$('#Lenguetasjudqxgqf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxuiirvhg;
  ...
  function initmapxuiirvhg() {
    // Nuevo Mapa
    mapxuiirvhg = new L.Map('LeafLetxuiirvhg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxuiirvhg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxuiirvhg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxuiirvhg === 'undefined') {
    varinitmapxuiirvhg = initmapxuiirvhg();
  };
});
FINAL;
    } // constructor
