...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasljetnicu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbntdyzdt" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasljetnicu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasljetnicu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbntdyzdt === 'undefined') {
    varMorrisbntdyzdt = Morris.Line({
      element: 'Morrisbntdyzdt',
