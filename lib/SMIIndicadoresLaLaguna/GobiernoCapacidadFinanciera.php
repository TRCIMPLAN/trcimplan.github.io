...
class GobiernoCapacidadFinanciera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbvkyxaoz">
...
<div id="Morrisiewdwbjb" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxmznjygo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbvkyxaoz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbvkyxaoz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiewdwbjb === 'undefined') {
    varMorrisiewdwbjb = Morris.Line({
      element: 'Morrisiewdwbjb',
...
// LENGUETA
$('#Lenguetasbvkyxaoz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxmznjygo;
  ...
  function initmapxmznjygo() {
    // Nuevo Mapa
    mapxmznjygo = new L.Map('LeafLetxmznjygo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxmznjygo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxmznjygo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxmznjygo === 'undefined') {
    varinitmapxmznjygo = initmapxmznjygo();
  };
});
FINAL;
    } // constructor
