...
class GobiernoCapacidadFinanciera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiwteabfl">
...
<div id="Morrisnqmktsrx" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetibluzyto" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiwteabfl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiwteabfl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnqmktsrx === 'undefined') {
    varMorrisnqmktsrx = Morris.Line({
      element: 'Morrisnqmktsrx',
...
// LENGUETA
$('#Lenguetasiwteabfl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapibluzyto;
  ...
  function initmapibluzyto() {
    // Nuevo Mapa
    mapibluzyto = new L.Map('LeafLetibluzyto');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapibluzyto.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapibluzyto.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapibluzyto === 'undefined') {
    varinitmapibluzyto = initmapibluzyto();
  };
});
FINAL;
    } // constructor
