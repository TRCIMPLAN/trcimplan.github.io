...
class GobiernoRelacionDeIngresosPropiosYTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswwiefcbs">
...
<div id="Morrisjavxlgiy" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxmxbonnx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswwiefcbs a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswwiefcbs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjavxlgiy === 'undefined') {
    varMorrisjavxlgiy = Morris.Line({
      element: 'Morrisjavxlgiy',
...
// LENGUETA
$('#Lenguetaswwiefcbs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxmxbonnx;
  ...
  function initmapxmxbonnx() {
    // Nuevo Mapa
    mapxmxbonnx = new L.Map('LeafLetxmxbonnx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxmxbonnx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxmxbonnx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxmxbonnx === 'undefined') {
    varinitmapxmxbonnx = initmapxmxbonnx();
  };
});
FINAL;
    } // constructor
