...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszdjafblw">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetutezuxgm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszdjafblw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszdjafblw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maputezuxgm;
  ...
  function initmaputezuxgm() {
    // Nuevo Mapa
    maputezuxgm = new L.Map('LeafLetutezuxgm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maputezuxgm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maputezuxgm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaputezuxgm === 'undefined') {
    varinitmaputezuxgm = initmaputezuxgm();
  };
});
FINAL;
    } // constructor
