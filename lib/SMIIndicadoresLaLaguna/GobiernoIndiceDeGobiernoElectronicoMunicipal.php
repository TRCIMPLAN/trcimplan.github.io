...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasafmllvjj">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettgmvfzkp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasafmllvjj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasafmllvjj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptgmvfzkp;
  ...
  function initmaptgmvfzkp() {
    // Nuevo Mapa
    maptgmvfzkp = new L.Map('LeafLettgmvfzkp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptgmvfzkp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptgmvfzkp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptgmvfzkp === 'undefined') {
    varinitmaptgmvfzkp = initmaptgmvfzkp();
  };
});
FINAL;
    } // constructor
