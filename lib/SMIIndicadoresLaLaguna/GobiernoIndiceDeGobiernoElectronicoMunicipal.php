...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasibnwrkfx">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetalgklrbn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasibnwrkfx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasibnwrkfx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapalgklrbn;
  ...
  function initmapalgklrbn() {
    // Nuevo Mapa
    mapalgklrbn = new L.Map('LeafLetalgklrbn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapalgklrbn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapalgklrbn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapalgklrbn === 'undefined') {
    varinitmapalgklrbn = initmapalgklrbn();
  };
});
FINAL;
    } // constructor
