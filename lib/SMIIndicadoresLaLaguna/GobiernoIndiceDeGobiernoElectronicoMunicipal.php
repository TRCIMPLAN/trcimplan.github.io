...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdrgxtwit">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsxuctome" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdrgxtwit a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdrgxtwit a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsxuctome;
  ...
  function initmapsxuctome() {
    // Nuevo Mapa
    mapsxuctome = new L.Map('LeafLetsxuctome');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsxuctome.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsxuctome.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsxuctome === 'undefined') {
    varinitmapsxuctome = initmapsxuctome();
  };
});
FINAL;
    } // constructor
