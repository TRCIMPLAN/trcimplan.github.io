<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Alumnos con Perfil Gramático-Español (Creado por Central:SmiLanzadera)
 *
...
Consulta la <a href="http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/">Base de datos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Alumnos con Perfil Gramático-Español en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2013-12-31', dato: 40.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
