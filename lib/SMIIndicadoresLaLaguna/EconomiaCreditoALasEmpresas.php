...
class EconomiaCreditoALasEmpresas extends \SMIBase\PublicacionWeb {
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2016-12-31', 'valor' => '57.00', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2017-12-31', 'valor' => '219.79', 'fuente_nombre' => 'IMCO', 'notas' => 'Pesos por cada mil pesos de actividad económica (CNBV)'),
            array('fecha' => '2018-12-31', 'valor' => '211.04', 'fuente_nombre' => 'IMCO', 'notas' => 'Pesos por cada mil pesos de actividad económica (CNBV)'),
            array('fecha' => '2019-12-31', 'valor' => '127', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2019-12-31', 'valor' => '127', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2020-12-31', 'valor' => '116', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2021-12-31', 'valor' => '131', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 24, crudo 14
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2016-12-31', 'valor' => '37857566.00', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 cambió a "Miles de pesos"'),
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2021-12-31', 'valor' => '131', 'fuente_nombre' => 'IMCO'));
    } // otras_regiones
