...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasinzopcoh">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristvuvtebt" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasinzopcoh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasinzopcoh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristvuvtebt === 'undefined') {
    varMorristvuvtebt = Morris.Line({
      element: 'Morristvuvtebt',
