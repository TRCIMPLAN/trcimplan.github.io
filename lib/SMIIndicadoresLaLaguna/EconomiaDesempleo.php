...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasocikrhgn">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnfaifnqh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetslmyqnzf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasocikrhgn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasocikrhgn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnfaifnqh === 'undefined') {
    varMorrisnfaifnqh = Morris.Line({
      element: 'Morrisnfaifnqh',
...
// LENGUETA
$('#Lenguetasocikrhgn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapslmyqnzf;
  ...
  function initmapslmyqnzf() {
    // Nuevo Mapa
    mapslmyqnzf = new L.Map('LeafLetslmyqnzf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapslmyqnzf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapslmyqnzf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapslmyqnzf === 'undefined') {
    varinitmapslmyqnzf = initmapslmyqnzf();
  };
});
FINAL;
    } // constructor
