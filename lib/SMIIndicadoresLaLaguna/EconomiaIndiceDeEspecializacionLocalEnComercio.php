...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjmciobec">
...
<div id="Morrishythibig" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsbhqjvxs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjmciobec a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjmciobec a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishythibig === 'undefined') {
    varMorrishythibig = Morris.Line({
      element: 'Morrishythibig',
...
// LENGUETA
$('#Lenguetasjmciobec a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsbhqjvxs;
  ...
  function initmapsbhqjvxs() {
    // Nuevo Mapa
    mapsbhqjvxs = new L.Map('LeafLetsbhqjvxs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsbhqjvxs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsbhqjvxs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsbhqjvxs === 'undefined') {
    varinitmapsbhqjvxs = initmapsbhqjvxs();
  };
});
FINAL;
    } // constructor
