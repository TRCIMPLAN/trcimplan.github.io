<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadCarenciaPorAccesoALosServiciosDeSalud
 *
...
class SociedadCarenciaPorAccesoALosServiciosDeSalud extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a los servicios de salud en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '23.0900', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2015-12-31', 'valor' => '18.0800', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2020-12-31', 'valor' => '24.3500', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 6, crudo 3
    } // datos
