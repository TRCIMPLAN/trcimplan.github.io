<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Ocupación Hotelera (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje del total de cuartos de hotel.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Ocupación Hotelera en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 30.4000 },{ fecha: '2009-12-31', dato: 27.4500 },{ fecha: '2010-12-31', dato: 26.5800 },{ fecha: '2011-12-31', dato: 26.5800 },{ fecha: '2012-12-31', dato: 29.3600 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
