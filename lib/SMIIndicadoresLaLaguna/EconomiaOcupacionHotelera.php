...
class EconomiaOcupacionHotelera extends \SMIBase\PublicacionWeb {
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2017-12-31', 'valor' => '0.0000', 'fuente_nombre' => 'IMCO', 'notas' => 'Porcentaje de la oferta total (SECTUR)'),
            array('fecha' => '2018-12-31', 'valor' => '0.0000', 'fuente_nombre' => 'IMCO', 'notas' => 'Porcentaje de la oferta total (SECTUR)')); // formateado 0, valor 18, crudo 11
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2016-12-31', 'valor' => '48.8700', 'fuente_nombre' => 'IMCO'),
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2018-12-31', 'valor' => '0.0000', 'fuente_nombre' => 'IMCO', 'notas' => 'Porcentaje de la oferta total (SECTUR)'));
    } // otras_regiones
