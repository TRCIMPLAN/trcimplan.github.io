...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswshjcvw">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetizvkxyza" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswshjcvw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswshjcvw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapizvkxyza;
  ...
  function initmapizvkxyza() {
    // Nuevo Mapa
    mapizvkxyza = new L.Map('LeafLetizvkxyza');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapizvkxyza.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapizvkxyza.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapizvkxyza === 'undefined') {
    varinitmapizvkxyza = initmapizvkxyza();
  };
});
FINAL;
    } // constructor
