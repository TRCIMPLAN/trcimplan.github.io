...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasywaodlis">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethykxegin" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasywaodlis a:first').tab('show')
});
// LENGUETA
$('#Lenguetasywaodlis a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphykxegin;
  ...
  function initmaphykxegin() {
    // Nuevo Mapa
    maphykxegin = new L.Map('LeafLethykxegin');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphykxegin.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphykxegin.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphykxegin === 'undefined') {
    varinitmaphykxegin = initmaphykxegin();
  };
});
FINAL;
    } // constructor
