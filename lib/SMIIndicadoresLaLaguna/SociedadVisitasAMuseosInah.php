<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Visitas a Museos INAH (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 85.0018 },{ fecha: '2009-12-31', dato: 83.8799 },{ fecha: '2010-12-31', dato: 84.2941 },{ fecha: '2011-12-31', dato: 83.1957 },{ fecha: '2012-12-31', dato: 90.4452 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
