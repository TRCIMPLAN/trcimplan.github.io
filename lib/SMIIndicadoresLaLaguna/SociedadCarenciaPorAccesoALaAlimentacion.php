<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadCarenciaPorAccesoALaAlimentacion
 *
...
class SociedadCarenciaPorAccesoALaAlimentacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a la alimentación en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '24.6800', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2015-12-31', 'valor' => '19.8800', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2020-12-31', 'valor' => '22.1900', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 6, crudo 3
    } // datos
