...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqgpcfdlz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetumaplrci" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqgpcfdlz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqgpcfdlz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapumaplrci;
  ...
  function initmapumaplrci() {
    // Nuevo Mapa
    mapumaplrci = new L.Map('LeafLetumaplrci');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapumaplrci.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapumaplrci.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapumaplrci === 'undefined') {
    varinitmapumaplrci = initmapumaplrci();
  };
});
FINAL;
    } // constructor
