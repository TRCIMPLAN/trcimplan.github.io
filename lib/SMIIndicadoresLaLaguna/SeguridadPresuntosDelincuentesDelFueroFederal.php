...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyoraprry">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqpvsucwa" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyoraprry a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyoraprry a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqpvsucwa;
  ...
  function initmapqpvsucwa() {
    // Nuevo Mapa
    mapqpvsucwa = new L.Map('LeafLetqpvsucwa');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqpvsucwa.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqpvsucwa.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqpvsucwa === 'undefined') {
    varinitmapqpvsucwa = initmapqpvsucwa();
  };
});
FINAL;
    } // constructor
