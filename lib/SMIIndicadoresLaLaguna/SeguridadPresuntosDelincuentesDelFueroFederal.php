...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnbiuzpvj">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaxdiulig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnbiuzpvj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnbiuzpvj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaxdiulig;
  ...
  function initmapaxdiulig() {
    // Nuevo Mapa
    mapaxdiulig = new L.Map('LeafLetaxdiulig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaxdiulig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaxdiulig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaxdiulig === 'undefined') {
    varinitmapaxdiulig = initmapaxdiulig();
  };
});
FINAL;
    } // constructor
