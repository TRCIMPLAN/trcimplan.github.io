...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfemygchv">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxcqhkdcu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfemygchv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfemygchv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxcqhkdcu;
  ...
  function initmapxcqhkdcu() {
    // Nuevo Mapa
    mapxcqhkdcu = new L.Map('LeafLetxcqhkdcu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxcqhkdcu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxcqhkdcu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxcqhkdcu === 'undefined') {
    varinitmapxcqhkdcu = initmapxcqhkdcu();
  };
});
FINAL;
    } // constructor
