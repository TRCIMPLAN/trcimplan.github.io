...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashfesfhrw">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnebdxfiv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashfesfhrw a:first').tab('show')
});
// LENGUETA
$('#Lenguetashfesfhrw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnebdxfiv;
  ...
  function initmapnebdxfiv() {
    // Nuevo Mapa
    mapnebdxfiv = new L.Map('LeafLetnebdxfiv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnebdxfiv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnebdxfiv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnebdxfiv === 'undefined') {
    varinitmapnebdxfiv = initmapnebdxfiv();
  };
});
FINAL;
    } // constructor
