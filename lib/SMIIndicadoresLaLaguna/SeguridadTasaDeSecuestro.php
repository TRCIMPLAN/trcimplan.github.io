...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseuxhcbsn">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpudchvwb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseuxhcbsn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseuxhcbsn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappudchvwb;
  ...
  function initmappudchvwb() {
    // Nuevo Mapa
    mappudchvwb = new L.Map('LeafLetpudchvwb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappudchvwb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappudchvwb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappudchvwb === 'undefined') {
    varinitmappudchvwb = initmappudchvwb();
  };
});
FINAL;
    } // constructor
