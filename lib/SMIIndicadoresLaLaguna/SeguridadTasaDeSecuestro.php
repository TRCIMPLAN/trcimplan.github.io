...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrelhmeko">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrxkshwxk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrelhmeko a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrelhmeko a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprxkshwxk;
  ...
  function initmaprxkshwxk() {
    // Nuevo Mapa
    maprxkshwxk = new L.Map('LeafLetrxkshwxk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprxkshwxk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprxkshwxk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprxkshwxk === 'undefined') {
    varinitmaprxkshwxk = initmaprxkshwxk();
  };
});
FINAL;
    } // constructor
