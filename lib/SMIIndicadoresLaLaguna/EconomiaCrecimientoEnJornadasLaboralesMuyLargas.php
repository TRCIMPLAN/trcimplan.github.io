<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Crecimiento en Jornadas Laborales Muy Largas (Creado por Central:SmiLanzadera)
 *
 ...
 */
class EconomiaCrecimientoEnJornadasLaboralesMuyLargas extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Jornadas Laborales Muy Largas en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.1500 },{ fecha: '2009-12-31', dato: 0.1500 },{ fecha: '2010-12-31', dato: 0.1500 },{ fecha: '2011-12-31', dato: 0.1500 },{ fecha: '2012-12-31', dato: 0.1500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 1.8600 },{ region: 'Gómez Palacio', dato: 0.8400 },{ region: 'Lerdo', dato: -10.0400 },{ region: 'Matamoros', dato: 6.2200 },{ region: 'La Laguna', dato: 0.1500 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice de "Mercado Laboral". Mide crecimiento en las jornadas laborales muy largas entre 2008 y 2012.</p>
