...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmhrsdxdu">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvhkffhci" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmhrsdxdu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmhrsdxdu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvhkffhci;
  ...
  function initmapvhkffhci() {
    // Nuevo Mapa
    mapvhkffhci = new L.Map('LeafLetvhkffhci');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvhkffhci.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvhkffhci.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvhkffhci === 'undefined') {
    varinitmapvhkffhci = initmapvhkffhci();
  };
});
FINAL;
    } // constructor
