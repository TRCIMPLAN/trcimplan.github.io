...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasognogadd">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettfbpvzbs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasognogadd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasognogadd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptfbpvzbs;
  ...
  function initmaptfbpvzbs() {
    // Nuevo Mapa
    maptfbpvzbs = new L.Map('LeafLettfbpvzbs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptfbpvzbs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptfbpvzbs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptfbpvzbs === 'undefined') {
    varinitmaptfbpvzbs = initmaptfbpvzbs();
  };
});
FINAL;
    } // constructor
