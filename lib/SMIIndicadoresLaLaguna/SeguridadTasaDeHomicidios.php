...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnlotzpqg">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoqhsmfub" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnlotzpqg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnlotzpqg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoqhsmfub;
  ...
  function initmapoqhsmfub() {
    // Nuevo Mapa
    mapoqhsmfub = new L.Map('LeafLetoqhsmfub');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoqhsmfub.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoqhsmfub.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoqhsmfub === 'undefined') {
    varinitmapoqhsmfub = initmapoqhsmfub();
  };
});
FINAL;
    } // constructor
