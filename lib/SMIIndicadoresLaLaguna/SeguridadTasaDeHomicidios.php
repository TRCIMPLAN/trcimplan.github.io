...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuvwfpisd">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcnmwaklf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuvwfpisd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuvwfpisd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcnmwaklf;
  ...
  function initmapcnmwaklf() {
    // Nuevo Mapa
    mapcnmwaklf = new L.Map('LeafLetcnmwaklf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcnmwaklf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcnmwaklf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcnmwaklf === 'undefined') {
    varinitmapcnmwaklf = initmapcnmwaklf();
  };
});
FINAL;
    } // constructor
