...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrciblzdy">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqfmfqtee" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrciblzdy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrciblzdy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqfmfqtee;
  ...
  function initmapqfmfqtee() {
    // Nuevo Mapa
    mapqfmfqtee = new L.Map('LeafLetqfmfqtee');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqfmfqtee.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqfmfqtee.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqfmfqtee === 'undefined') {
    varinitmapqfmfqtee = initmapqfmfqtee();
  };
});
FINAL;
    } // constructor
