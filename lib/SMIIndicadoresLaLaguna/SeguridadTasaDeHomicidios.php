...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrstittpz">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnlwucrtv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrstittpz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrstittpz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnlwucrtv;
  ...
  function initmapnlwucrtv() {
    // Nuevo Mapa
    mapnlwucrtv = new L.Map('LeafLetnlwucrtv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnlwucrtv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnlwucrtv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnlwucrtv === 'undefined') {
    varinitmapnlwucrtv = initmapnlwucrtv();
  };
});
FINAL;
    } // constructor
