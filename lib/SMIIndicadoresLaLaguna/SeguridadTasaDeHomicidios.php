...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasedexedow">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwvqvvlcr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasedexedow a:first').tab('show')
});
// LENGUETA
$('#Lenguetasedexedow a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwvqvvlcr;
  ...
  function initmapwvqvvlcr() {
    // Nuevo Mapa
    mapwvqvvlcr = new L.Map('LeafLetwvqvvlcr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwvqvvlcr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwvqvvlcr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwvqvvlcr === 'undefined') {
    varinitmapwvqvvlcr = initmapwvqvvlcr();
  };
});
FINAL;
    } // constructor
