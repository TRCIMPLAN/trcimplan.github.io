...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasepmpmmto">
...
<div id="Morrispajymixb" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuslxoouk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasepmpmmto a:first').tab('show')
});
// LENGUETA
$('#Lenguetasepmpmmto a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispajymixb === 'undefined') {
    varMorrispajymixb = Morris.Line({
      element: 'Morrispajymixb',
...
// LENGUETA
$('#Lenguetasepmpmmto a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuslxoouk;
  ...
  function initmapuslxoouk() {
    // Nuevo Mapa
    mapuslxoouk = new L.Map('LeafLetuslxoouk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuslxoouk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuslxoouk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuslxoouk === 'undefined') {
    varinitmapuslxoouk = initmapuslxoouk();
  };
});
FINAL;
    } // constructor
