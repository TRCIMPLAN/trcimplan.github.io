...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiaahbkno">
...
<div id="Morrisyrlsicdd" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbpirchpm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiaahbkno a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiaahbkno a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyrlsicdd === 'undefined') {
    varMorrisyrlsicdd = Morris.Line({
      element: 'Morrisyrlsicdd',
...
// LENGUETA
$('#Lenguetasiaahbkno a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbpirchpm;
  ...
  function initmapbpirchpm() {
    // Nuevo Mapa
    mapbpirchpm = new L.Map('LeafLetbpirchpm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbpirchpm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbpirchpm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbpirchpm === 'undefined') {
    varinitmapbpirchpm = initmapbpirchpm();
  };
});
FINAL;
    } // constructor
