...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasatchocai">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswepchpqf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjzanxqfo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasatchocai a:first').tab('show')
});
// LENGUETA
$('#Lenguetasatchocai a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswepchpqf === 'undefined') {
    varMorriswepchpqf = Morris.Line({
      element: 'Morriswepchpqf',
...
// LENGUETA
$('#Lenguetasatchocai a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjzanxqfo;
  ...
  function initmapjzanxqfo() {
    // Nuevo Mapa
    mapjzanxqfo = new L.Map('LeafLetjzanxqfo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjzanxqfo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjzanxqfo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjzanxqfo === 'undefined') {
    varinitmapjzanxqfo = initmapjzanxqfo();
  };
});
FINAL;
    } // constructor
