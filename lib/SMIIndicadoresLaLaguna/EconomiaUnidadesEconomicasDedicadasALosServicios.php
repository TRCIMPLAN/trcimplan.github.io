...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbtvprzfh">
...
<div id="Morrisfvcxqxys" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetedowxcpp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbtvprzfh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbtvprzfh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfvcxqxys === 'undefined') {
    varMorrisfvcxqxys = Morris.Line({
      element: 'Morrisfvcxqxys',
...
// LENGUETA
$('#Lenguetasbtvprzfh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapedowxcpp;
  ...
  function initmapedowxcpp() {
    // Nuevo Mapa
    mapedowxcpp = new L.Map('LeafLetedowxcpp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapedowxcpp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapedowxcpp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapedowxcpp === 'undefined') {
    varinitmapedowxcpp = initmapedowxcpp();
  };
});
FINAL;
    } // constructor
