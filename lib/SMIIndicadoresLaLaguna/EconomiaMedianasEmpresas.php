...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascjnsqssr">
...
<div id="Morriswredfiho" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqlamjolz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascjnsqssr a:first').tab('show')
});
// LENGUETA
$('#Lenguetascjnsqssr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswredfiho === 'undefined') {
    varMorriswredfiho = Morris.Line({
      element: 'Morriswredfiho',
...
// LENGUETA
$('#Lenguetascjnsqssr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqlamjolz;
  ...
  function initmapqlamjolz() {
    // Nuevo Mapa
    mapqlamjolz = new L.Map('LeafLetqlamjolz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqlamjolz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqlamjolz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqlamjolz === 'undefined') {
    varinitmapqlamjolz = initmapqlamjolz();
  };
});
FINAL;
    } // constructor
