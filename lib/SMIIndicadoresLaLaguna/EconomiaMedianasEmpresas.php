...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswoertnzs">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgtjuhqrj" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetccyibrrw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswoertnzs a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswoertnzs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgtjuhqrj === 'undefined') {
    varMorrisgtjuhqrj = Morris.Line({
      element: 'Morrisgtjuhqrj',
...
// LENGUETA
$('#Lenguetaswoertnzs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapccyibrrw;
  ...
  function initmapccyibrrw() {
    // Nuevo Mapa
    mapccyibrrw = new L.Map('LeafLetccyibrrw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapccyibrrw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapccyibrrw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapccyibrrw === 'undefined') {
    varinitmapccyibrrw = initmapccyibrrw();
  };
});
FINAL;
    } // constructor
