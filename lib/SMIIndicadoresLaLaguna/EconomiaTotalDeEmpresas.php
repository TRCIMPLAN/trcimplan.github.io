...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswajsrkbh">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfnxmiwmy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteljsflqd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswajsrkbh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswajsrkbh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfnxmiwmy === 'undefined') {
    varMorrisfnxmiwmy = Morris.Line({
      element: 'Morrisfnxmiwmy',
...
// LENGUETA
$('#Lenguetaswajsrkbh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeljsflqd;
  ...
  function initmapeljsflqd() {
    // Nuevo Mapa
    mapeljsflqd = new L.Map('LeafLeteljsflqd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeljsflqd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeljsflqd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeljsflqd === 'undefined') {
    varinitmapeljsflqd = initmapeljsflqd();
  };
});
FINAL;
    } // constructor
