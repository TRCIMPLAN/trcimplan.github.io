...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjkbnzzcl">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisaocicggb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethkvivfxd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjkbnzzcl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjkbnzzcl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaocicggb === 'undefined') {
    varMorrisaocicggb = Morris.Line({
      element: 'Morrisaocicggb',
...
// LENGUETA
$('#Lenguetasjkbnzzcl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphkvivfxd;
  ...
  function initmaphkvivfxd() {
    // Nuevo Mapa
    maphkvivfxd = new L.Map('LeafLethkvivfxd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphkvivfxd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphkvivfxd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphkvivfxd === 'undefined') {
    varinitmaphkvivfxd = initmaphkvivfxd();
  };
});
FINAL;
    } // constructor
