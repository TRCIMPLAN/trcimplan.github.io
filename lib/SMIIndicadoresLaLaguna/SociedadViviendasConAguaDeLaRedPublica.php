...
class SociedadViviendasConAguaDeLaRedPublica extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskuzdbgdv">
...
Enlace al [Sistema de Información Geográfica](http://201.159.104.45:8080/apps/implan2.html).
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetylmeisrd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskuzdbgdv a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskuzdbgdv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapylmeisrd;
  ...
  function initmapylmeisrd() {
    // Nuevo Mapa
    mapylmeisrd = new L.Map('LeafLetylmeisrd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapylmeisrd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapylmeisrd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapylmeisrd === 'undefined') {
    varinitmapylmeisrd = initmapylmeisrd();
  };
});
FINAL;
    } // constructor
