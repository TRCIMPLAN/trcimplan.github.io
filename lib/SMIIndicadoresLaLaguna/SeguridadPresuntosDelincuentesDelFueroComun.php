...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrzfgjzrt">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetixogtiju" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrzfgjzrt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrzfgjzrt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapixogtiju;
  ...
  function initmapixogtiju() {
    // Nuevo Mapa
    mapixogtiju = new L.Map('LeafLetixogtiju');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapixogtiju.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapixogtiju.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapixogtiju === 'undefined') {
    varinitmapixogtiju = initmapixogtiju();
  };
});
FINAL;
    } // constructor
