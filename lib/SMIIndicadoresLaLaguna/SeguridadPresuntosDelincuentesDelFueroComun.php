...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskqtvazlo">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetymciwikk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskqtvazlo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskqtvazlo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapymciwikk;
  ...
  function initmapymciwikk() {
    // Nuevo Mapa
    mapymciwikk = new L.Map('LeafLetymciwikk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapymciwikk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapymciwikk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapymciwikk === 'undefined') {
    varinitmapymciwikk = initmapymciwikk();
  };
});
FINAL;
    } // constructor
