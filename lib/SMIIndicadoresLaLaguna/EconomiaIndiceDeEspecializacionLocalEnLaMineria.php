...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasexbukghg">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetckxkbiks" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasexbukghg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasexbukghg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapckxkbiks;
  ...
  function initmapckxkbiks() {
    // Nuevo Mapa
    mapckxkbiks = new L.Map('LeafLetckxkbiks');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapckxkbiks.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapckxkbiks.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapckxkbiks === 'undefined') {
    varinitmapckxkbiks = initmapckxkbiks();
  };
});
FINAL;
    } // constructor
