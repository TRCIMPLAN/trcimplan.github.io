...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswkebijjm">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetansnjdii" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswkebijjm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswkebijjm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapansnjdii;
  ...
  function initmapansnjdii() {
    // Nuevo Mapa
    mapansnjdii = new L.Map('LeafLetansnjdii');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapansnjdii.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapansnjdii.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapansnjdii === 'undefined') {
    varinitmapansnjdii = initmapansnjdii();
  };
});
FINAL;
    } // constructor
