<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SustentabilidadAreasVerdesUrbanasPerCapita
 *
...
class SustentabilidadAreasVerdesUrbanasPerCapita extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Áreas verdes urbanas per cápita en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '1.4008', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2016-12-31', 'valor' => '3.2900', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 4, crudo 2
    } // datos
