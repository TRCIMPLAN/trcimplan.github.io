...
class SociedadAlumnosConPerfilGramaticoespanol extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmrkjwowk">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethjqfoyta" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmrkjwowk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmrkjwowk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphjqfoyta;
  ...
  function initmaphjqfoyta() {
    // Nuevo Mapa
    maphjqfoyta = new L.Map('LeafLethjqfoyta');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphjqfoyta.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphjqfoyta.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphjqfoyta === 'undefined') {
    varinitmaphjqfoyta = initmaphjqfoyta();
  };
});
FINAL;
    } // constructor
