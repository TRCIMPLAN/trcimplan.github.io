<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Empleados en el Sector Formal (Creado por Central:SmiLanzadera)
 *
...
class EconomiaEmpleadosEnElSectorFormal extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Empleados en el Sector Formal en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 70.0486 },{ fecha: '2009-12-31', dato: 70.1246 },{ fecha: '2010-12-31', dato: 57.2976 },{ fecha: '2011-12-31', dato: 55.2093 },{ fecha: '2012-12-31', dato: 48.7339 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
