...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyvyqzzja">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmajnrnbd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyvyqzzja a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyvyqzzja a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmajnrnbd;
  ...
  function initmapmajnrnbd() {
    // Nuevo Mapa
    mapmajnrnbd = new L.Map('LeafLetmajnrnbd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmajnrnbd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmajnrnbd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmajnrnbd === 'undefined') {
    varinitmapmajnrnbd = initmapmajnrnbd();
  };
});
FINAL;
    } // constructor
