...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslqrpjzkq">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvnkhvfex" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslqrpjzkq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslqrpjzkq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvnkhvfex;
  ...
  function initmapvnkhvfex() {
    // Nuevo Mapa
    mapvnkhvfex = new L.Map('LeafLetvnkhvfex');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvnkhvfex.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvnkhvfex.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvnkhvfex === 'undefined') {
    varinitmapvnkhvfex = initmapvnkhvfex();
  };
});
FINAL;
    } // constructor
