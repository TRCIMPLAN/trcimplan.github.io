...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslhyidhku">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdmybicvu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslhyidhku a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslhyidhku a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdmybicvu;
  ...
  function initmapdmybicvu() {
    // Nuevo Mapa
    mapdmybicvu = new L.Map('LeafLetdmybicvu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdmybicvu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdmybicvu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdmybicvu === 'undefined') {
    varinitmapdmybicvu = initmapdmybicvu();
  };
});
FINAL;
    } // constructor
