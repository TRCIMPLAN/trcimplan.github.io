...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasadivgswk">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrrbytskm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasadivgswk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasadivgswk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprrbytskm;
  ...
  function initmaprrbytskm() {
    // Nuevo Mapa
    maprrbytskm = new L.Map('LeafLetrrbytskm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprrbytskm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprrbytskm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprrbytskm === 'undefined') {
    varinitmaprrbytskm = initmaprrbytskm();
  };
});
FINAL;
    } // constructor
