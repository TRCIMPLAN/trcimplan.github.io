<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Gobierno Participación Electoral (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje de personas que emitieron su voto.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Participación Electoral en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-07-01', dato: 57.6800 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
