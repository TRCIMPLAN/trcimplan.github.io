...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmbxzeysa">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskuwndsoh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetasistpad" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmbxzeysa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmbxzeysa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskuwndsoh === 'undefined') {
    varMorriskuwndsoh = Morris.Line({
      element: 'Morriskuwndsoh',
...
// LENGUETA
$('#Lenguetasmbxzeysa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapasistpad;
  ...
  function initmapasistpad() {
    // Nuevo Mapa
    mapasistpad = new L.Map('LeafLetasistpad');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapasistpad.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapasistpad.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapasistpad === 'undefined') {
    varinitmapasistpad = initmapasistpad();
  };
});
FINAL;
    } // constructor
