...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswpmucrqr">
...
<div id="Morriswbbyjdav" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlhbdnxof" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswpmucrqr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswpmucrqr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswbbyjdav === 'undefined') {
    varMorriswbbyjdav = Morris.Line({
      element: 'Morriswbbyjdav',
...
// LENGUETA
$('#Lenguetaswpmucrqr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplhbdnxof;
  ...
  function initmaplhbdnxof() {
    // Nuevo Mapa
    maplhbdnxof = new L.Map('LeafLetlhbdnxof');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplhbdnxof.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplhbdnxof.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplhbdnxof === 'undefined') {
    varinitmaplhbdnxof = initmaplhbdnxof();
  };
});
FINAL;
    } // constructor
