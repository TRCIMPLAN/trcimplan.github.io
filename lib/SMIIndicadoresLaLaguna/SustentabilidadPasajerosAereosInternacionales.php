...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjqemsred">
...
<div id="Morristxswltwr" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdybirdpj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjqemsred a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjqemsred a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristxswltwr === 'undefined') {
    varMorristxswltwr = Morris.Line({
      element: 'Morristxswltwr',
...
// LENGUETA
$('#Lenguetasjqemsred a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdybirdpj;
  ...
  function initmapdybirdpj() {
    // Nuevo Mapa
    mapdybirdpj = new L.Map('LeafLetdybirdpj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdybirdpj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdybirdpj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdybirdpj === 'undefined') {
    varinitmapdybirdpj = initmapdybirdpj();
  };
});
FINAL;
    } // constructor
