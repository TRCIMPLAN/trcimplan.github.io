...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiaklveap">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismagknqsb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwdzekfsk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiaklveap a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiaklveap a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismagknqsb === 'undefined') {
    varMorrismagknqsb = Morris.Line({
      element: 'Morrismagknqsb',
...
// LENGUETA
$('#Lenguetasiaklveap a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwdzekfsk;
  ...
  function initmapwdzekfsk() {
    // Nuevo Mapa
    mapwdzekfsk = new L.Map('LeafLetwdzekfsk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwdzekfsk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwdzekfsk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwdzekfsk === 'undefined') {
    varinitmapwdzekfsk = initmapwdzekfsk();
  };
});
FINAL;
    } // constructor
