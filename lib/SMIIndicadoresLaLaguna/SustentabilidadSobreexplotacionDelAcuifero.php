...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashtheywla">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettblvxguc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashtheywla a:first').tab('show')
});
// LENGUETA
$('#Lenguetashtheywla a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptblvxguc;
  ...
  function initmaptblvxguc() {
    // Nuevo Mapa
    maptblvxguc = new L.Map('LeafLettblvxguc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptblvxguc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptblvxguc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptblvxguc === 'undefined') {
    varinitmaptblvxguc = initmaptblvxguc();
  };
});
FINAL;
    } // constructor
