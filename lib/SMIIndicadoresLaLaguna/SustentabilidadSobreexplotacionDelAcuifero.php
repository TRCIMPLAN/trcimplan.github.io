...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskakskjbm">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxekckwsq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskakskjbm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskakskjbm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxekckwsq;
  ...
  function initmapxekckwsq() {
    // Nuevo Mapa
    mapxekckwsq = new L.Map('LeafLetxekckwsq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxekckwsq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxekckwsq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxekckwsq === 'undefined') {
    varinitmapxekckwsq = initmapxekckwsq();
  };
});
FINAL;
    } // constructor
