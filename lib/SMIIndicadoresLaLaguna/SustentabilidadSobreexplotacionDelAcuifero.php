...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasujlofgpj">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqlxmutst" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasujlofgpj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasujlofgpj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqlxmutst;
  ...
  function initmapqlxmutst() {
    // Nuevo Mapa
    mapqlxmutst = new L.Map('LeafLetqlxmutst');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqlxmutst.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqlxmutst.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqlxmutst === 'undefined') {
    varinitmapqlxmutst = initmapqlxmutst();
  };
});
FINAL;
    } // constructor
