...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastcabxqlk">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqnrfqcmw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastcabxqlk a:first').tab('show')
});
// LENGUETA
$('#Lenguetastcabxqlk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqnrfqcmw;
  ...
  function initmapqnrfqcmw() {
    // Nuevo Mapa
    mapqnrfqcmw = new L.Map('LeafLetqnrfqcmw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqnrfqcmw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqnrfqcmw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqnrfqcmw === 'undefined') {
    varinitmapqnrfqcmw = initmapqnrfqcmw();
  };
});
FINAL;
    } // constructor
