...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxofvazno">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetobwovpym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxofvazno a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxofvazno a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapobwovpym;
  ...
  function initmapobwovpym() {
    // Nuevo Mapa
    mapobwovpym = new L.Map('LeafLetobwovpym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapobwovpym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapobwovpym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapobwovpym === 'undefined') {
    varinitmapobwovpym = initmapobwovpym();
  };
});
FINAL;
    } // constructor
