...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasihrxkged">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbzyvdaoa" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasihrxkged a:first').tab('show')
});
// LENGUETA
$('#Lenguetasihrxkged a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbzyvdaoa === 'undefined') {
    varMorrisbzyvdaoa = Morris.Line({
      element: 'Morrisbzyvdaoa',
