...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasecnugaoo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisshqwplti" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasecnugaoo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasecnugaoo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisshqwplti === 'undefined') {
    varMorrisshqwplti = Morris.Line({
      element: 'Morrisshqwplti',
