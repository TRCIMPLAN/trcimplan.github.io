...
class EconomiaIndiceDeGini extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslladtjjl">
...
Datos obtenidos de [CONEVAL](http://www.coneval.gob.mx/Paginas/principal.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetojcfvdib" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslladtjjl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslladtjjl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapojcfvdib;
  ...
  function initmapojcfvdib() {
    // Nuevo Mapa
    mapojcfvdib = new L.Map('LeafLetojcfvdib');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapojcfvdib.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapojcfvdib.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapojcfvdib === 'undefined') {
    varinitmapojcfvdib = initmapojcfvdib();
  };
});
FINAL;
    } // constructor
