...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoukdnoxe">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisptwxelcn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoukdnoxe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoukdnoxe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisptwxelcn === 'undefined') {
    varMorrisptwxelcn = Morris.Line({
      element: 'Morrisptwxelcn',
