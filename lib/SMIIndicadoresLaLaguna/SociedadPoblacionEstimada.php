...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdjhwkuym">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgvpxetjn" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdjhwkuym a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdjhwkuym a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgvpxetjn === 'undefined') {
    varMorrisgvpxetjn = Morris.Line({
      element: 'Morrisgvpxetjn',
