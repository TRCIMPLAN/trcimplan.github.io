...
class SociedadDiscapacidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, La Laguna, Grupos Vulnerables, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '4.3000', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => 'Personas que tienen dificultad para el desempeño y/o realización de tareas en la vida cotidiana.')); // formateado 0, valor 2, crudo 2
    } // datos
