...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoyimqryk">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethxdajetu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoyimqryk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoyimqryk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphxdajetu;
  ...
  function initmaphxdajetu() {
    // Nuevo Mapa
    maphxdajetu = new L.Map('LeafLethxdajetu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphxdajetu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphxdajetu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphxdajetu === 'undefined') {
    varinitmaphxdajetu = initmaphxdajetu();
  };
});
FINAL;
    } // constructor
