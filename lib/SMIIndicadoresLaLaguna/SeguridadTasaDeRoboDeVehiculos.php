...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasysxjpgbb">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetffwykexc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasysxjpgbb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasysxjpgbb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapffwykexc;
  ...
  function initmapffwykexc() {
    // Nuevo Mapa
    mapffwykexc = new L.Map('LeafLetffwykexc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapffwykexc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapffwykexc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapffwykexc === 'undefined') {
    varinitmapffwykexc = initmapffwykexc();
  };
});
FINAL;
    } // constructor
