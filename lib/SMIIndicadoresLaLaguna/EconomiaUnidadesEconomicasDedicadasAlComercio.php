...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvenbztgj">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxtmlqwek" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvenbztgj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvenbztgj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxtmlqwek === 'undefined') {
    varMorrisxtmlqwek = Morris.Line({
      element: 'Morrisxtmlqwek',
