...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnxsjcpme">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisurjeowyw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkedxnwkk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnxsjcpme a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnxsjcpme a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisurjeowyw === 'undefined') {
    varMorrisurjeowyw = Morris.Line({
      element: 'Morrisurjeowyw',
...
// LENGUETA
$('#Lenguetasnxsjcpme a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkedxnwkk;
  ...
  function initmapkedxnwkk() {
    // Nuevo Mapa
    mapkedxnwkk = new L.Map('LeafLetkedxnwkk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkedxnwkk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkedxnwkk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkedxnwkk === 'undefined') {
    varinitmapkedxnwkk = initmapkedxnwkk();
  };
});
FINAL;
    } // constructor
