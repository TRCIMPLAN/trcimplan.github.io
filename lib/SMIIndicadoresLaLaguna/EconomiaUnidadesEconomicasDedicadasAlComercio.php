...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyrsayhnh">
...
<div id="Morrisxmqcpdln" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvxgezjib" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyrsayhnh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyrsayhnh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxmqcpdln === 'undefined') {
    varMorrisxmqcpdln = Morris.Line({
      element: 'Morrisxmqcpdln',
...
// LENGUETA
$('#Lenguetasyrsayhnh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvxgezjib;
  ...
  function initmapvxgezjib() {
    // Nuevo Mapa
    mapvxgezjib = new L.Map('LeafLetvxgezjib');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvxgezjib.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvxgezjib.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvxgezjib === 'undefined') {
    varinitmapvxgezjib = initmapvxgezjib();
  };
});
FINAL;
    } // constructor
