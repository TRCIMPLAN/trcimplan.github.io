...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswuucfkfd">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqpfqrqnu" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmcpstrdx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswuucfkfd a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswuucfkfd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqpfqrqnu === 'undefined') {
    varMorrisqpfqrqnu = Morris.Line({
      element: 'Morrisqpfqrqnu',
...
// LENGUETA
$('#Lenguetaswuucfkfd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmcpstrdx;
  ...
  function initmapmcpstrdx() {
    // Nuevo Mapa
    mapmcpstrdx = new L.Map('LeafLetmcpstrdx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmcpstrdx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmcpstrdx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmcpstrdx === 'undefined') {
    varinitmapmcpstrdx = initmapmcpstrdx();
  };
});
FINAL;
    } // constructor
