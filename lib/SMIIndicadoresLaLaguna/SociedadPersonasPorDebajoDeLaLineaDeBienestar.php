<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Personas por Debajo de la Línea de Bienestar (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: INEGI (ENOE), CONEVAL.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Personas por Debajo de la Línea de Bienestar en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.6600 },{ fecha: '2009-12-31', dato: 2.3400 },{ fecha: '2010-12-31', dato: 4.2200 },{ fecha: '2011-12-31', dato: 2.9600 },{ fecha: '2012-12-31', dato: 3.7800 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
