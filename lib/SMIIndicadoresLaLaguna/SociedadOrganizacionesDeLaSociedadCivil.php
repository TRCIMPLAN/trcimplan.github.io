...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaekmzuyo">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetocrcimst" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaekmzuyo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaekmzuyo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapocrcimst;
  ...
  function initmapocrcimst() {
    // Nuevo Mapa
    mapocrcimst = new L.Map('LeafLetocrcimst');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapocrcimst.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapocrcimst.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapocrcimst === 'undefined') {
    varinitmapocrcimst = initmapocrcimst();
  };
});
FINAL;
    } // constructor
