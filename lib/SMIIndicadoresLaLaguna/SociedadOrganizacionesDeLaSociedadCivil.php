...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasumkszgns">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetajjzpxey" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasumkszgns a:first').tab('show')
});
// LENGUETA
$('#Lenguetasumkszgns a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapajjzpxey;
  ...
  function initmapajjzpxey() {
    // Nuevo Mapa
    mapajjzpxey = new L.Map('LeafLetajjzpxey');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapajjzpxey.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapajjzpxey.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapajjzpxey === 'undefined') {
    varinitmapajjzpxey = initmapajjzpxey();
  };
});
FINAL;
    } // constructor
