...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasadkohkil">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbdjsenaj" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetulhqjoll" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasadkohkil a:first').tab('show')
});
// LENGUETA
$('#Lenguetasadkohkil a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbdjsenaj === 'undefined') {
    varMorrisbdjsenaj = Morris.Line({
      element: 'Morrisbdjsenaj',
...
// LENGUETA
$('#Lenguetasadkohkil a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapulhqjoll;
  ...
  function initmapulhqjoll() {
    // Nuevo Mapa
    mapulhqjoll = new L.Map('LeafLetulhqjoll');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapulhqjoll.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapulhqjoll.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapulhqjoll === 'undefined') {
    varinitmapulhqjoll = initmapulhqjoll();
  };
});
FINAL;
    } // constructor
