...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnziuziyz">
...
<div id="Morriserxdyokb" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkspksxzs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnziuziyz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnziuziyz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriserxdyokb === 'undefined') {
    varMorriserxdyokb = Morris.Line({
      element: 'Morriserxdyokb',
...
// LENGUETA
$('#Lenguetasnziuziyz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkspksxzs;
  ...
  function initmapkspksxzs() {
    // Nuevo Mapa
    mapkspksxzs = new L.Map('LeafLetkspksxzs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkspksxzs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkspksxzs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkspksxzs === 'undefined') {
    varinitmapkspksxzs = initmapkspksxzs();
  };
});
FINAL;
    } // constructor
