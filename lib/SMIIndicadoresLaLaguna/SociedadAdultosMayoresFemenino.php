...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastskrssvm">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqqgbwdzc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastskrssvm a:first').tab('show')
});
// LENGUETA
$('#Lenguetastskrssvm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqqgbwdzc === 'undefined') {
    varMorrisqqgbwdzc = Morris.Line({
      element: 'Morrisqqgbwdzc',
