<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Centros de Investigación (Creado por Central:SmiLanzadera)
 *
...
class EconomiaCentrosDeInvestigacion extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Centros de Investigación en La Laguna</h3>
