...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjnayesxv">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishsncvkcs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteseboula" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjnayesxv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjnayesxv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishsncvkcs === 'undefined') {
    varMorrishsncvkcs = Morris.Line({
      element: 'Morrishsncvkcs',
...
// LENGUETA
$('#Lenguetasjnayesxv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeseboula;
  ...
  function initmapeseboula() {
    // Nuevo Mapa
    mapeseboula = new L.Map('LeafLeteseboula');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeseboula.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeseboula.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeseboula === 'undefined') {
    varinitmapeseboula = initmapeseboula();
  };
});
FINAL;
    } // constructor
