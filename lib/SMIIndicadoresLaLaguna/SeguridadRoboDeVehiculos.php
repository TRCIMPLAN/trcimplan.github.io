...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasglldseph">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetiyawcdrv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasglldseph a:first').tab('show')
});
// LENGUETA
$('#Lenguetasglldseph a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapiyawcdrv;
  ...
  function initmapiyawcdrv() {
    // Nuevo Mapa
    mapiyawcdrv = new L.Map('LeafLetiyawcdrv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapiyawcdrv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapiyawcdrv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapiyawcdrv === 'undefined') {
    varinitmapiyawcdrv = initmapiyawcdrv();
  };
});
FINAL;
    } // constructor
