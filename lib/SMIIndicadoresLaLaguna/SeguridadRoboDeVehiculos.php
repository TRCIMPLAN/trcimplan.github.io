...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqcownrsl">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswadoevxr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmepjdwol" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqcownrsl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqcownrsl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswadoevxr === 'undefined') {
    varMorriswadoevxr = Morris.Line({
      element: 'Morriswadoevxr',
...
// LENGUETA
$('#Lenguetasqcownrsl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmepjdwol;
  ...
  function initmapmepjdwol() {
    // Nuevo Mapa
    mapmepjdwol = new L.Map('LeafLetmepjdwol');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmepjdwol.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmepjdwol.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmepjdwol === 'undefined') {
    varinitmapmepjdwol = initmapmepjdwol();
  };
});
FINAL;
    } // constructor
