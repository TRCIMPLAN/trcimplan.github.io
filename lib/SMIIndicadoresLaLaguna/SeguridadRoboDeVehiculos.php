...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmfgrisqd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetersqivyi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmfgrisqd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmfgrisqd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapersqivyi;
  ...
  function initmapersqivyi() {
    // Nuevo Mapa
    mapersqivyi = new L.Map('LeafLetersqivyi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapersqivyi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapersqivyi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapersqivyi === 'undefined') {
    varinitmapersqivyi = initmapersqivyi();
  };
});
FINAL;
    } // constructor
