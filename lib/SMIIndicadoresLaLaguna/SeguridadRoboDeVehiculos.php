...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastoijcwkn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqwfiuckp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastoijcwkn a:first').tab('show')
});
// LENGUETA
$('#Lenguetastoijcwkn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqwfiuckp === 'undefined') {
    varMorrisqwfiuckp = Morris.Line({
      element: 'Morrisqwfiuckp',
