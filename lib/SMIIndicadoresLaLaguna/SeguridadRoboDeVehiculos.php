...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasswxslsbf">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetndihoroc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasswxslsbf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasswxslsbf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapndihoroc;
  ...
  function initmapndihoroc() {
    // Nuevo Mapa
    mapndihoroc = new L.Map('LeafLetndihoroc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapndihoroc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapndihoroc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapndihoroc === 'undefined') {
    varinitmapndihoroc = initmapndihoroc();
  };
});
FINAL;
    } // constructor
