...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasixthmcnm">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislaikptcp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasixthmcnm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasixthmcnm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislaikptcp === 'undefined') {
    varMorrislaikptcp = Morris.Line({
      element: 'Morrislaikptcp',
