...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasixphbrub">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmkvqladp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasixphbrub a:first').tab('show')
});
// LENGUETA
$('#Lenguetasixphbrub a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmkvqladp;
  ...
  function initmapmkvqladp() {
    // Nuevo Mapa
    mapmkvqladp = new L.Map('LeafLetmkvqladp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmkvqladp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmkvqladp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmkvqladp === 'undefined') {
    varinitmapmkvqladp = initmapmkvqladp();
  };
});
FINAL;
    } // constructor
