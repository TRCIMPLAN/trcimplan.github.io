...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdoqfpbgl">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbpkluvmz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdoqfpbgl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdoqfpbgl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbpkluvmz;
  ...
  function initmapbpkluvmz() {
    // Nuevo Mapa
    mapbpkluvmz = new L.Map('LeafLetbpkluvmz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbpkluvmz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbpkluvmz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbpkluvmz === 'undefined') {
    varinitmapbpkluvmz = initmapbpkluvmz();
  };
});
FINAL;
    } // constructor
