...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoizodojj">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswhsbqyfe" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoizodojj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoizodojj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswhsbqyfe === 'undefined') {
    varMorriswhsbqyfe = Morris.Line({
      element: 'Morriswhsbqyfe',
