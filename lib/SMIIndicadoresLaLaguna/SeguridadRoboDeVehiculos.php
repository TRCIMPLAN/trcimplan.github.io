...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqxgkjsnv">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszvtbmplh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqxgkjsnv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqxgkjsnv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszvtbmplh === 'undefined') {
    varMorriszvtbmplh = Morris.Line({
      element: 'Morriszvtbmplh',
