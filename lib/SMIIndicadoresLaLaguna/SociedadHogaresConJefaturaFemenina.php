...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasishjrnut">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethnzjlkyp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasishjrnut a:first').tab('show')
});
// LENGUETA
$('#Lenguetasishjrnut a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphnzjlkyp;
  ...
  function initmaphnzjlkyp() {
    // Nuevo Mapa
    maphnzjlkyp = new L.Map('LeafLethnzjlkyp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphnzjlkyp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphnzjlkyp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphnzjlkyp === 'undefined') {
    varinitmaphnzjlkyp = initmaphnzjlkyp();
  };
});
FINAL;
    } // constructor
