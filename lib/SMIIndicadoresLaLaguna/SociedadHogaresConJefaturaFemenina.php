...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasumbdxpxi">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjwzzxrwg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasumbdxpxi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasumbdxpxi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjwzzxrwg;
  ...
  function initmapjwzzxrwg() {
    // Nuevo Mapa
    mapjwzzxrwg = new L.Map('LeafLetjwzzxrwg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjwzzxrwg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjwzzxrwg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjwzzxrwg === 'undefined') {
    varinitmapjwzzxrwg = initmapjwzzxrwg();
  };
});
FINAL;
    } // constructor
