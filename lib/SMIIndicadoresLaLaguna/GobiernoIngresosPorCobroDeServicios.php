...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastohxmzrc">
...
Pesos
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjygvzvpu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastohxmzrc a:first').tab('show')
});
// LENGUETA
$('#Lenguetastohxmzrc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjygvzvpu === 'undefined') {
    varMorrisjygvzvpu = Morris.Line({
      element: 'Morrisjygvzvpu',
