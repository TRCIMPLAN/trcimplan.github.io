<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Ingresos Propios (Creado por Central:SmiLanzadera)
 *
...
<p>Incluido en el subíndice de "Gobiernos Eficientes y Eficaces". Mide el total de ingresos propios (impuestos, derechos, productos, aprovechamientos y contribuciones de mejoras) de la ciudad como porcentaje de sus ingresos totales.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Ingresos Propios en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 30.2066 },{ fecha: '2009-12-31', dato: 36.4974 },{ fecha: '2010-12-31', dato: 28.8759 },{ fecha: '2011-12-31', dato: 33.4999 },{ fecha: '2012-12-31', dato: 32.6557 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
