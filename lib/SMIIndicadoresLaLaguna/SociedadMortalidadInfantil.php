...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasymoowtqy">
...
<b>Unidad:</b> Por cada mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrpbntnjo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasymoowtqy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasymoowtqy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprpbntnjo;
  ...
  function initmaprpbntnjo() {
    // Nuevo Mapa
    maprpbntnjo = new L.Map('LeafLetrpbntnjo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprpbntnjo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprpbntnjo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprpbntnjo === 'undefined') {
    varinitmaprpbntnjo = initmaprpbntnjo();
  };
});
FINAL;
    } // constructor
