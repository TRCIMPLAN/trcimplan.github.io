<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Economía Jornadas laborales muy largas (más de 48 horas semanales) (Creado por Central:SmiLanzadera)
 *
...
class EconomiaJornadasLaboralesMuyLargasMasDe48HorasSemanales extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Jornadas laborales muy largas (más de 48 horas semanales) en La Laguna';
     // $this->autor             = '';
...
<p>Mide los trabajadores que laboran más de 48 horas por semana, como un proxy de la baja productividad del trabajo. Existe evidencia que sustenta que entre más horas se trabajen, por encima de un umbral, la productividad decrece o al menos no aumenta. Sin embargo, los efectos psicológicos y sociales de jornadas muy largas son negativos.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Jornadas laborales muy largas (más de 48 horas semanales) en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 26.8700 },{ fecha: '2009-12-31', dato: 18.4400 },{ fecha: '2010-12-31', dato: 23.3500 },{ fecha: '2011-12-31', dato: 22.8300 },{ fecha: '2012-12-31', dato: 25.5400 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
