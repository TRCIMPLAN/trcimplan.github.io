<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadCasosAcumuladosDeCovid19Sospechosos
 *
...
class SociedadCasosAcumuladosDeCovid19Sospechosos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Casos acumulados de COVID-19 sospechosos en La Laguna';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2020-04-20', 'valor' => '139', 'fuente_nombre' => 'Secretaría de Salud')); // formateado 0, valor 16, crudo 8
    } // datos
