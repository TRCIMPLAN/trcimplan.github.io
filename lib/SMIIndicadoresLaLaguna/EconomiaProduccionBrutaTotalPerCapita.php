...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasemdmiibc">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswfrilmdk" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbsarbhft" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasemdmiibc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasemdmiibc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswfrilmdk === 'undefined') {
    varMorriswfrilmdk = Morris.Line({
      element: 'Morriswfrilmdk',
...
// LENGUETA
$('#Lenguetasemdmiibc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbsarbhft;
  ...
  function initmapbsarbhft() {
    // Nuevo Mapa
    mapbsarbhft = new L.Map('LeafLetbsarbhft');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbsarbhft.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbsarbhft.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbsarbhft === 'undefined') {
    varinitmapbsarbhft = initmapbsarbhft();
  };
});
FINAL;
    } // constructor
