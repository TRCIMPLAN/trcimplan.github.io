...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasablrparn">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjupspcrh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethflahavu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasablrparn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasablrparn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjupspcrh === 'undefined') {
    varMorrisjupspcrh = Morris.Line({
      element: 'Morrisjupspcrh',
...
// LENGUETA
$('#Lenguetasablrparn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphflahavu;
  ...
  function initmaphflahavu() {
    // Nuevo Mapa
    maphflahavu = new L.Map('LeafLethflahavu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphflahavu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphflahavu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphflahavu === 'undefined') {
    varinitmaphflahavu = initmaphflahavu();
  };
});
FINAL;
    } // constructor
