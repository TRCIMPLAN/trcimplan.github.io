...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfgyfyopa">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisymwquqee" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpaollvds" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfgyfyopa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfgyfyopa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisymwquqee === 'undefined') {
    varMorrisymwquqee = Morris.Line({
      element: 'Morrisymwquqee',
...
// LENGUETA
$('#Lenguetasfgyfyopa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappaollvds;
  ...
  function initmappaollvds() {
    // Nuevo Mapa
    mappaollvds = new L.Map('LeafLetpaollvds');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappaollvds.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappaollvds.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappaollvds === 'undefined') {
    varinitmappaollvds = initmappaollvds();
  };
});
FINAL;
    } // constructor
