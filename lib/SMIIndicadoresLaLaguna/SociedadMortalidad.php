...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszgqwsyzl">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbshsoaui" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszgqwsyzl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszgqwsyzl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbshsoaui;
  ...
  function initmapbshsoaui() {
    // Nuevo Mapa
    mapbshsoaui = new L.Map('LeafLetbshsoaui');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbshsoaui.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbshsoaui.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbshsoaui === 'undefined') {
    varinitmapbshsoaui = initmapbshsoaui();
  };
});
FINAL;
    } // constructor
