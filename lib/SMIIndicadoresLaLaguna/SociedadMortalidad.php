...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswezhhczc">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkjxsthim" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswezhhczc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswezhhczc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkjxsthim;
  ...
  function initmapkjxsthim() {
    // Nuevo Mapa
    mapkjxsthim = new L.Map('LeafLetkjxsthim');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkjxsthim.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkjxsthim.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkjxsthim === 'undefined') {
    varinitmapkjxsthim = initmapkjxsthim();
  };
});
FINAL;
    } // constructor
