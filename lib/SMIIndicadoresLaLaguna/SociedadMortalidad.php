...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassubgfiss">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetchlerxym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassubgfiss a:first').tab('show')
});
// LENGUETA
$('#Lenguetassubgfiss a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapchlerxym;
  ...
  function initmapchlerxym() {
    // Nuevo Mapa
    mapchlerxym = new L.Map('LeafLetchlerxym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapchlerxym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapchlerxym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapchlerxym === 'undefined') {
    varinitmapchlerxym = initmapchlerxym();
  };
});
FINAL;
    } // constructor
