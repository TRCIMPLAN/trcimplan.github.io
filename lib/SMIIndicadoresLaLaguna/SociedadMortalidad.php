...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgtltqiqi">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetamtgidpi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgtltqiqi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgtltqiqi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapamtgidpi;
  ...
  function initmapamtgidpi() {
    // Nuevo Mapa
    mapamtgidpi = new L.Map('LeafLetamtgidpi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapamtgidpi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapamtgidpi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapamtgidpi === 'undefined') {
    varinitmapamtgidpi = initmapamtgidpi();
  };
});
FINAL;
    } // constructor
