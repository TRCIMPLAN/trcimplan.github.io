...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxfamnykt">
...
<b>Unidad:</b> Por cada 10 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfciccbfk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxfamnykt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxfamnykt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfciccbfk;
  ...
  function initmapfciccbfk() {
    // Nuevo Mapa
    mapfciccbfk = new L.Map('LeafLetfciccbfk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfciccbfk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfciccbfk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfciccbfk === 'undefined') {
    varinitmapfciccbfk = initmapfciccbfk();
  };
});
FINAL;
    } // constructor
