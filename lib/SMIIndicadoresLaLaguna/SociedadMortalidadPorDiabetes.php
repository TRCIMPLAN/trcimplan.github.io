...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasezlumbsx">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqqfyltxb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasezlumbsx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasezlumbsx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqqfyltxb;
  ...
  function initmapqqfyltxb() {
    // Nuevo Mapa
    mapqqfyltxb = new L.Map('LeafLetqqfyltxb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqqfyltxb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqqfyltxb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqqfyltxb === 'undefined') {
    varinitmapqqfyltxb = initmapqqfyltxb();
  };
});
FINAL;
    } // constructor
