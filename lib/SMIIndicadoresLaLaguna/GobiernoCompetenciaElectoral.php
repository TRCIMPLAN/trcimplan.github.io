...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszpuvqexo">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettjokjusr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszpuvqexo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszpuvqexo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptjokjusr;
  ...
  function initmaptjokjusr() {
    // Nuevo Mapa
    maptjokjusr = new L.Map('LeafLettjokjusr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptjokjusr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptjokjusr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptjokjusr === 'undefined') {
    varinitmaptjokjusr = initmaptjokjusr();
  };
});
FINAL;
    } // constructor
