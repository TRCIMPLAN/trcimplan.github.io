...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxbsabwyc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetreyaenxk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxbsabwyc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxbsabwyc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapreyaenxk;
  ...
  function initmapreyaenxk() {
    // Nuevo Mapa
    mapreyaenxk = new L.Map('LeafLetreyaenxk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapreyaenxk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapreyaenxk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapreyaenxk === 'undefined') {
    varinitmapreyaenxk = initmapreyaenxk();
  };
});
FINAL;
    } // constructor
