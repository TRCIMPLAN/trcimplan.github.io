...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasenanatsz">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetryfyoygs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasenanatsz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasenanatsz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapryfyoygs;
  ...
  function initmapryfyoygs() {
    // Nuevo Mapa
    mapryfyoygs = new L.Map('LeafLetryfyoygs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapryfyoygs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapryfyoygs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapryfyoygs === 'undefined') {
    varinitmapryfyoygs = initmapryfyoygs();
  };
});
FINAL;
    } // constructor
