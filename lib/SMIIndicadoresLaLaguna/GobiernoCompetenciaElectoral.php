...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgkyfynrv">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnhkdwwlp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgkyfynrv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgkyfynrv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnhkdwwlp;
  ...
  function initmapnhkdwwlp() {
    // Nuevo Mapa
    mapnhkdwwlp = new L.Map('LeafLetnhkdwwlp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnhkdwwlp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnhkdwwlp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnhkdwwlp === 'undefined') {
    varinitmapnhkdwwlp = initmapnhkdwwlp();
  };
});
FINAL;
    } // constructor
