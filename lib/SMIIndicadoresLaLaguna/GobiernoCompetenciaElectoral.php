...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasigvhsivc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpwvtgngi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasigvhsivc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasigvhsivc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappwvtgngi;
  ...
  function initmappwvtgngi() {
    // Nuevo Mapa
    mappwvtgngi = new L.Map('LeafLetpwvtgngi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappwvtgngi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappwvtgngi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappwvtgngi === 'undefined') {
    varinitmappwvtgngi = initmappwvtgngi();
  };
});
FINAL;
    } // constructor
