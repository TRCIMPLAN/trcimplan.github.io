...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoenixefg">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnfpgpysc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoenixefg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoenixefg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnfpgpysc;
  ...
  function initmapnfpgpysc() {
    // Nuevo Mapa
    mapnfpgpysc = new L.Map('LeafLetnfpgpysc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnfpgpysc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnfpgpysc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnfpgpysc === 'undefined') {
    varinitmapnfpgpysc = initmapnfpgpysc();
  };
});
FINAL;
    } // constructor
