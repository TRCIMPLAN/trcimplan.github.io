...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswplcibvq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisorahrlkd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswplcibvq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswplcibvq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisorahrlkd === 'undefined') {
    varMorrisorahrlkd = Morris.Line({
      element: 'Morrisorahrlkd',
