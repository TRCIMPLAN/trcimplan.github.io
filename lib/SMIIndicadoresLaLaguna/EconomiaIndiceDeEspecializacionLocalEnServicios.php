...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnewejiji">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvqwxonre" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnewejiji a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnewejiji a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvqwxonre === 'undefined') {
    varMorrisvqwxonre = Morris.Line({
      element: 'Morrisvqwxonre',
