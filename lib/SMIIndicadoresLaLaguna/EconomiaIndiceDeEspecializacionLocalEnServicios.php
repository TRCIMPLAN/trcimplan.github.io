...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqzukgutj">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristumkptta" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqzukgutj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqzukgutj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristumkptta === 'undefined') {
    varMorristumkptta = Morris.Line({
      element: 'Morristumkptta',
