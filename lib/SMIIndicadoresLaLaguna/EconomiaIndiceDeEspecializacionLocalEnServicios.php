...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmldtsyrk">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskxsshqbs" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmldtsyrk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmldtsyrk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskxsshqbs === 'undefined') {
    varMorriskxsshqbs = Morris.Line({
      element: 'Morriskxsshqbs',
