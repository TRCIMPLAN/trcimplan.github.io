...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspptcgklj">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisumcmyjcw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrmjvdpfw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspptcgklj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspptcgklj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisumcmyjcw === 'undefined') {
    varMorrisumcmyjcw = Morris.Line({
      element: 'Morrisumcmyjcw',
...
// LENGUETA
$('#Lenguetaspptcgklj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprmjvdpfw;
  ...
  function initmaprmjvdpfw() {
    // Nuevo Mapa
    maprmjvdpfw = new L.Map('LeafLetrmjvdpfw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprmjvdpfw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprmjvdpfw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprmjvdpfw === 'undefined') {
    varinitmaprmjvdpfw = initmaprmjvdpfw();
  };
});
FINAL;
    } // constructor
