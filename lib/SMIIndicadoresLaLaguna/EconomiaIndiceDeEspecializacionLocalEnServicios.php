...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqxuiejes">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbxjrfxeh" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLeterdfnvlu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqxuiejes a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqxuiejes a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbxjrfxeh === 'undefined') {
    varMorrisbxjrfxeh = Morris.Line({
      element: 'Morrisbxjrfxeh',
...
// LENGUETA
$('#Lenguetasqxuiejes a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maperdfnvlu;
  ...
  function initmaperdfnvlu() {
    // Nuevo Mapa
    maperdfnvlu = new L.Map('LeafLeterdfnvlu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maperdfnvlu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maperdfnvlu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaperdfnvlu === 'undefined') {
    varinitmaperdfnvlu = initmaperdfnvlu();
  };
});
FINAL;
    } // constructor
