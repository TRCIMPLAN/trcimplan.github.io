...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswffvrkey">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissdbhtkxf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettmnvdivo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswffvrkey a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswffvrkey a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissdbhtkxf === 'undefined') {
    varMorrissdbhtkxf = Morris.Line({
      element: 'Morrissdbhtkxf',
...
// LENGUETA
$('#Lenguetaswffvrkey a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptmnvdivo;
  ...
  function initmaptmnvdivo() {
    // Nuevo Mapa
    maptmnvdivo = new L.Map('LeafLettmnvdivo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptmnvdivo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptmnvdivo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptmnvdivo === 'undefined') {
    varinitmaptmnvdivo = initmaptmnvdivo();
  };
});
FINAL;
    } // constructor
