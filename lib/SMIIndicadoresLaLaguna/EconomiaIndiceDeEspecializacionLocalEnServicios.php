...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqilmoigv">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiiaymshp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfppmhktd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqilmoigv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqilmoigv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiiaymshp === 'undefined') {
    varMorrisiiaymshp = Morris.Line({
      element: 'Morrisiiaymshp',
...
// LENGUETA
$('#Lenguetasqilmoigv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfppmhktd;
  ...
  function initmapfppmhktd() {
    // Nuevo Mapa
    mapfppmhktd = new L.Map('LeafLetfppmhktd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfppmhktd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfppmhktd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfppmhktd === 'undefined') {
    varinitmapfppmhktd = initmapfppmhktd();
  };
});
FINAL;
    } // constructor
