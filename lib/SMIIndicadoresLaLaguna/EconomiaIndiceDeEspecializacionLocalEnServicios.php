...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswovrfxna">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristjhxbiup" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjlvoqfdj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswovrfxna a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswovrfxna a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristjhxbiup === 'undefined') {
    varMorristjhxbiup = Morris.Line({
      element: 'Morristjhxbiup',
...
// LENGUETA
$('#Lenguetaswovrfxna a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjlvoqfdj;
  ...
  function initmapjlvoqfdj() {
    // Nuevo Mapa
    mapjlvoqfdj = new L.Map('LeafLetjlvoqfdj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjlvoqfdj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjlvoqfdj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjlvoqfdj === 'undefined') {
    varinitmapjlvoqfdj = initmapjlvoqfdj();
  };
});
FINAL;
    } // constructor
