...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaxomnrgd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpkqmofqe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaxomnrgd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaxomnrgd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappkqmofqe;
  ...
  function initmappkqmofqe() {
    // Nuevo Mapa
    mappkqmofqe = new L.Map('LeafLetpkqmofqe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappkqmofqe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappkqmofqe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappkqmofqe === 'undefined') {
    varinitmappkqmofqe = initmappkqmofqe();
  };
});
FINAL;
    } // constructor
