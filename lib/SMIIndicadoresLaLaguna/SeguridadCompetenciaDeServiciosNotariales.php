<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Seguridad Competencia de Servicios Notariales (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Secretaría de Gobernación (Directorio de Notarios), 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia de Servicios Notariales en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 15.2350 },{ fecha: '2009-12-31', dato: 16.0865 },{ fecha: '2010-12-31', dato: 15.6118 },{ fecha: '2011-12-31', dato: 13.9464 },{ fecha: '2012-12-31', dato: 14.4016 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
