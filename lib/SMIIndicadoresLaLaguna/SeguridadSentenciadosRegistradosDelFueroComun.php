...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvqukkkef">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsdlhvlgs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvqukkkef a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvqukkkef a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsdlhvlgs;
  ...
  function initmapsdlhvlgs() {
    // Nuevo Mapa
    mapsdlhvlgs = new L.Map('LeafLetsdlhvlgs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsdlhvlgs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsdlhvlgs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsdlhvlgs === 'undefined') {
    varinitmapsdlhvlgs = initmapsdlhvlgs();
  };
});
FINAL;
    } // constructor
