...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmbyyikcz">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgvrsymuh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmbyyikcz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmbyyikcz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgvrsymuh;
  ...
  function initmapgvrsymuh() {
    // Nuevo Mapa
    mapgvrsymuh = new L.Map('LeafLetgvrsymuh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgvrsymuh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgvrsymuh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgvrsymuh === 'undefined') {
    varinitmapgvrsymuh = initmapgvrsymuh();
  };
});
FINAL;
    } // constructor
