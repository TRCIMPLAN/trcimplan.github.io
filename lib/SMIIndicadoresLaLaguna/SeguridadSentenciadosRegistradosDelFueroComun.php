...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrduesqmo">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjvjxzmxn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrduesqmo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrduesqmo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjvjxzmxn;
  ...
  function initmapjvjxzmxn() {
    // Nuevo Mapa
    mapjvjxzmxn = new L.Map('LeafLetjvjxzmxn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjvjxzmxn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjvjxzmxn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjvjxzmxn === 'undefined') {
    varinitmapjvjxzmxn = initmapjvjxzmxn();
  };
});
FINAL;
    } // constructor
