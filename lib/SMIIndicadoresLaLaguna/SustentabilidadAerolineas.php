 ...
 */
class SustentabilidadAerolineas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->fuentes     = array('IMCO', 'Operadora Mexicana de Aeropuertos (OMA)');
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2014-12-31', 'valor' => '5', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2016-12-31', 'valor' => '7', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2019-01-31', 'valor' => '6', 'fuente_nombre' => 'Operadora Mexicana de Aeropuertos (OMA)')); // formateado 0, valor 16, crudo 8
    } // datos
