<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sustentabilidad Aerolíneas (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadAerolineas extends \Base\Publicacion {
...
<p>Fuente: IMCO con información de la Secretaría de Comunicaciones y Transportes (SCT), 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Aerolíneas en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 10 },{ fecha: '2009-12-31', dato: 10 },{ fecha: '2010-12-31', dato: 10 },{ fecha: '2011-12-31', dato: 10 },{ fecha: '2012-12-31', dato: 10 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
