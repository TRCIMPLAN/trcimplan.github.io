...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasadezvhip">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetystgxokg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasadezvhip a:first').tab('show')
});
// LENGUETA
$('#Lenguetasadezvhip a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapystgxokg;
  ...
  function initmapystgxokg() {
    // Nuevo Mapa
    mapystgxokg = new L.Map('LeafLetystgxokg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapystgxokg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapystgxokg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapystgxokg === 'undefined') {
    varinitmapystgxokg = initmapystgxokg();
  };
});
FINAL;
    } // constructor
