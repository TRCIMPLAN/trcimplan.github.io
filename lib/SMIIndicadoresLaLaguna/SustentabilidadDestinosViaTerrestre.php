...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskbyfwwxx">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetijsfvokm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskbyfwwxx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskbyfwwxx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapijsfvokm;
  ...
  function initmapijsfvokm() {
    // Nuevo Mapa
    mapijsfvokm = new L.Map('LeafLetijsfvokm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapijsfvokm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapijsfvokm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapijsfvokm === 'undefined') {
    varinitmapijsfvokm = initmapijsfvokm();
  };
});
FINAL;
    } // constructor
