...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasspusqdff">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdtbtncti" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasspusqdff a:first').tab('show')
});
// LENGUETA
$('#Lenguetasspusqdff a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdtbtncti;
  ...
  function initmapdtbtncti() {
    // Nuevo Mapa
    mapdtbtncti = new L.Map('LeafLetdtbtncti');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdtbtncti.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdtbtncti.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdtbtncti === 'undefined') {
    varinitmapdtbtncti = initmapdtbtncti();
  };
});
FINAL;
    } // constructor
