...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastcvhmxqk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjybdtnbe" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastcvhmxqk a:first').tab('show')
});
// LENGUETA
$('#Lenguetastcvhmxqk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjybdtnbe === 'undefined') {
    varMorrisjybdtnbe = Morris.Line({
      element: 'Morrisjybdtnbe',
