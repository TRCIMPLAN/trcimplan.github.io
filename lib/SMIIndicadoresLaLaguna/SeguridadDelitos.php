...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbatyxdnp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdunpzlqb" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbatyxdnp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbatyxdnp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdunpzlqb === 'undefined') {
    varMorrisdunpzlqb = Morris.Line({
      element: 'Morrisdunpzlqb',
