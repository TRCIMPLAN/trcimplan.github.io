...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszbqjwmse">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyifakuef" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszbqjwmse a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszbqjwmse a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyifakuef === 'undefined') {
    varMorrisyifakuef = Morris.Line({
      element: 'Morrisyifakuef',
