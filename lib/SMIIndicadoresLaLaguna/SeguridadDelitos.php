...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascjnrdzgd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxvdqhdzp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascjnrdzgd a:first').tab('show')
});
// LENGUETA
$('#Lenguetascjnrdzgd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxvdqhdzp;
  ...
  function initmapxvdqhdzp() {
    // Nuevo Mapa
    mapxvdqhdzp = new L.Map('LeafLetxvdqhdzp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxvdqhdzp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxvdqhdzp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxvdqhdzp === 'undefined') {
    varinitmapxvdqhdzp = initmapxvdqhdzp();
  };
});
FINAL;
    } // constructor
