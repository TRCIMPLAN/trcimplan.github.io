...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbvsfeqib">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdrknympu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbvsfeqib a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbvsfeqib a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdrknympu === 'undefined') {
    varMorrisdrknympu = Morris.Line({
      element: 'Morrisdrknympu',
