...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasomswqifa">
...
<div id="Morrisaigtgyhg" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfazkznyq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasomswqifa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasomswqifa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaigtgyhg === 'undefined') {
    varMorrisaigtgyhg = Morris.Line({
      element: 'Morrisaigtgyhg',
...
// LENGUETA
$('#Lenguetasomswqifa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfazkznyq;
  ...
  function initmapfazkznyq() {
    // Nuevo Mapa
    mapfazkznyq = new L.Map('LeafLetfazkznyq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfazkznyq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfazkznyq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfazkznyq === 'undefined') {
    varinitmapfazkznyq = initmapfazkznyq();
  };
});
FINAL;
    } // constructor
