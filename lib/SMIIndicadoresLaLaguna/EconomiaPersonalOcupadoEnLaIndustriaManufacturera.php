...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascqvhhqqt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdpjdsghp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascqvhhqqt a:first').tab('show')
});
// LENGUETA
$('#Lenguetascqvhhqqt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdpjdsghp === 'undefined') {
    varMorrisdpjdsghp = Morris.Line({
      element: 'Morrisdpjdsghp',
