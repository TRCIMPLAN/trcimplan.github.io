...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbefejxmt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishnghmisn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxvwzccbj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbefejxmt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbefejxmt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishnghmisn === 'undefined') {
    varMorrishnghmisn = Morris.Line({
      element: 'Morrishnghmisn',
...
// LENGUETA
$('#Lenguetasbefejxmt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxvwzccbj;
  ...
  function initmapxvwzccbj() {
    // Nuevo Mapa
    mapxvwzccbj = new L.Map('LeafLetxvwzccbj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxvwzccbj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxvwzccbj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxvwzccbj === 'undefined') {
    varinitmapxvwzccbj = initmapxvwzccbj();
  };
});
FINAL;
    } // constructor
