...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastfhqbxuv">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristekrxmom" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastfhqbxuv a:first').tab('show')
});
// LENGUETA
$('#Lenguetastfhqbxuv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristekrxmom === 'undefined') {
    varMorristekrxmom = Morris.Line({
      element: 'Morristekrxmom',
