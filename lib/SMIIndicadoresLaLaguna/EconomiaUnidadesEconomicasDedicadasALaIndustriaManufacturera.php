...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasctpfwfnl">
...
<div id="Morrispmvjcwdw" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvpvckxae" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasctpfwfnl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasctpfwfnl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispmvjcwdw === 'undefined') {
    varMorrispmvjcwdw = Morris.Line({
      element: 'Morrispmvjcwdw',
...
// LENGUETA
$('#Lenguetasctpfwfnl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvpvckxae;
  ...
  function initmapvpvckxae() {
    // Nuevo Mapa
    mapvpvckxae = new L.Map('LeafLetvpvckxae');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvpvckxae.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvpvckxae.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvpvckxae === 'undefined') {
    varinitmapvpvckxae = initmapvpvckxae();
  };
});
FINAL;
    } // constructor
