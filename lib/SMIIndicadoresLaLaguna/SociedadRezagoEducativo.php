<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SociedadRezagoEducativo
 *
...
class SociedadRezagoEducativo extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Rezago Educativo en La Laguna';
        ...
        $this->claves      = 'IMPLAN, La Laguna, Educación, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
        $this->categorias  = array('Educación', 'Grupos Vulnerables', 'Objetivos del Milenio', 'Sector Automotriz');
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '15.7600', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '87.2500', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2020-12-31', 'valor' => '13.7400', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 6, crudo 3
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2020-12-31', 'valor' => '13.7400', 'fuente_nombre' => 'CONEVAL'),
