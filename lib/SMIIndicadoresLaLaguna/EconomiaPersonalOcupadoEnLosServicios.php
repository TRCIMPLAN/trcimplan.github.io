...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrjxgxwvc">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissvpswnqj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrjxgxwvc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrjxgxwvc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissvpswnqj === 'undefined') {
    varMorrissvpswnqj = Morris.Line({
      element: 'Morrissvpswnqj',
