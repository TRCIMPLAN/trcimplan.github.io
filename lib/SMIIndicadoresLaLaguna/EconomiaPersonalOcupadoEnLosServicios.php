...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfmciwcsb">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxewtmjxo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfmciwcsb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfmciwcsb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxewtmjxo === 'undefined') {
    varMorrisxewtmjxo = Morris.Line({
      element: 'Morrisxewtmjxo',
