...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxidbjumy">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissfnetcov" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmvjpzduj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxidbjumy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxidbjumy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissfnetcov === 'undefined') {
    varMorrissfnetcov = Morris.Line({
      element: 'Morrissfnetcov',
...
// LENGUETA
$('#Lenguetasxidbjumy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmvjpzduj;
  ...
  function initmapmvjpzduj() {
    // Nuevo Mapa
    mapmvjpzduj = new L.Map('LeafLetmvjpzduj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmvjpzduj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmvjpzduj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmvjpzduj === 'undefined') {
    varinitmapmvjpzduj = initmapmvjpzduj();
  };
});
FINAL;
    } // constructor
