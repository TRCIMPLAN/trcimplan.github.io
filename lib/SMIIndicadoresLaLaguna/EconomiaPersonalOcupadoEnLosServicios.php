...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbkwwrhtn">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjywkwlgs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetggkrwxay" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbkwwrhtn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbkwwrhtn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjywkwlgs === 'undefined') {
    varMorrisjywkwlgs = Morris.Line({
      element: 'Morrisjywkwlgs',
...
// LENGUETA
$('#Lenguetasbkwwrhtn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapggkrwxay;
  ...
  function initmapggkrwxay() {
    // Nuevo Mapa
    mapggkrwxay = new L.Map('LeafLetggkrwxay');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapggkrwxay.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapggkrwxay.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapggkrwxay === 'undefined') {
    varinitmapggkrwxay = initmapggkrwxay();
  };
});
FINAL;
    } // constructor
