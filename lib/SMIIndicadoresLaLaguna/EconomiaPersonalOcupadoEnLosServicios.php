...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasldqhgbhe">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisszhcbgct" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetikmscmew" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasldqhgbhe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasldqhgbhe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisszhcbgct === 'undefined') {
    varMorrisszhcbgct = Morris.Line({
      element: 'Morrisszhcbgct',
...
// LENGUETA
$('#Lenguetasldqhgbhe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapikmscmew;
  ...
  function initmapikmscmew() {
    // Nuevo Mapa
    mapikmscmew = new L.Map('LeafLetikmscmew');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapikmscmew.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapikmscmew.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapikmscmew === 'undefined') {
    varinitmapikmscmew = initmapikmscmew();
  };
});
FINAL;
    } // constructor
