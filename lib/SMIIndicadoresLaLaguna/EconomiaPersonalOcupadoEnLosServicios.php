...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswlysyswm">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjohxpfjm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswlysyswm a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswlysyswm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjohxpfjm === 'undefined') {
    varMorrisjohxpfjm = Morris.Line({
      element: 'Morrisjohxpfjm',
