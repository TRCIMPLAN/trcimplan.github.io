...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspkpyitic">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissvebkzqj" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspkpyitic a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspkpyitic a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissvebkzqj === 'undefined') {
    varMorrissvebkzqj = Morris.Line({
      element: 'Morrissvebkzqj',
