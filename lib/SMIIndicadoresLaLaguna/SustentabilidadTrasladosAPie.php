<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sustentabilidad Traslados a Pie (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadTrasladosAPie extends \Base\Publicacion {
      ...
      <table class="table table-hover table-bordered matriz">
        ...
        <tbody>
          <tr>
            ...
            <td>19.00 %</td>
            <td>Logit</td>
            <td>Viajes completos realizados a pie. No incluyen los viajes para tomar el transporte público.</td>
          </tr>
        </tbody>
      </table>
...
<p>Estudio realizado por Logit en 2011. Contempla los viajes de los municipios de Torreón y Matamoros.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Traslados a Pie en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2011-12-31', dato: 19.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
