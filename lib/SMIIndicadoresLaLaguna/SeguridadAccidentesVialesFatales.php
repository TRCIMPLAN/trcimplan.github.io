...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashwfasplf">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetavlepeec" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashwfasplf a:first').tab('show')
});
// LENGUETA
$('#Lenguetashwfasplf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapavlepeec;
  ...
  function initmapavlepeec() {
    // Nuevo Mapa
    mapavlepeec = new L.Map('LeafLetavlepeec');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapavlepeec.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapavlepeec.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapavlepeec === 'undefined') {
    varinitmapavlepeec = initmapavlepeec();
  };
});
FINAL;
    } // constructor
