...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfelohigb">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvapvjoqa" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfelohigb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfelohigb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvapvjoqa;
  ...
  function initmapvapvjoqa() {
    // Nuevo Mapa
    mapvapvjoqa = new L.Map('LeafLetvapvjoqa');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvapvjoqa.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvapvjoqa.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvapvjoqa === 'undefined') {
    varinitmapvapvjoqa = initmapvapvjoqa();
  };
});
FINAL;
    } // constructor
