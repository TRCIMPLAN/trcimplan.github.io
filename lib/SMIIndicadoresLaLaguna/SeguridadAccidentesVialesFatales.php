...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasldfegota">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkbjaftpn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasldfegota a:first').tab('show')
});
// LENGUETA
$('#Lenguetasldfegota a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkbjaftpn;
  ...
  function initmapkbjaftpn() {
    // Nuevo Mapa
    mapkbjaftpn = new L.Map('LeafLetkbjaftpn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkbjaftpn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkbjaftpn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkbjaftpn === 'undefined') {
    varinitmapkbjaftpn = initmapkbjaftpn();
  };
});
FINAL;
    } // constructor
