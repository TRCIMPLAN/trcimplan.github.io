...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashpxdonko">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmfezcyco" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashpxdonko a:first').tab('show')
});
// LENGUETA
$('#Lenguetashpxdonko a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmfezcyco;
  ...
  function initmapmfezcyco() {
    // Nuevo Mapa
    mapmfezcyco = new L.Map('LeafLetmfezcyco');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmfezcyco.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmfezcyco.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmfezcyco === 'undefined') {
    varinitmapmfezcyco = initmapmfezcyco();
  };
});
FINAL;
    } // constructor
