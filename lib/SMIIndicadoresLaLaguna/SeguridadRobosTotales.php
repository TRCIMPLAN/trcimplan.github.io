...
class SeguridadRobosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasacrmfezq">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfhaubdku" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasacrmfezq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasacrmfezq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfhaubdku === 'undefined') {
    varMorrisfhaubdku = Morris.Line({
      element: 'Morrisfhaubdku',
