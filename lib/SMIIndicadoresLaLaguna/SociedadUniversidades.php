<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Universidades (Creado por Central:SmiLanzadera)
 *
...
<li>Universidad Pedagógica de Durango-UGP</li>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Universidades en La Laguna</h3>
