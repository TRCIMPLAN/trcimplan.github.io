...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassqqwbpxo">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlvfxpifb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassqqwbpxo a:first').tab('show')
});
// LENGUETA
$('#Lenguetassqqwbpxo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplvfxpifb;
  ...
  function initmaplvfxpifb() {
    // Nuevo Mapa
    maplvfxpifb = new L.Map('LeafLetlvfxpifb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplvfxpifb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplvfxpifb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplvfxpifb === 'undefined') {
    varinitmaplvfxpifb = initmaplvfxpifb();
  };
});
FINAL;
    } // constructor
