...
class EconomiaCiudadFronterizaOPortuaria extends \SMIBase\PublicacionWeb {
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2018-12-31', 'valor' => 'ND', 'fuente_nombre' => 'IMCO', 'notas' => 'Variable categórica (0=ninguna, 1=puerto, 2=frontera) (IMCO)'),
            array('fecha' => '2019-12-31', 'valor' => '0', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2020-12-31', 'valor' => '0', 'fuente_nombre' => 'IMCO'),
            array('fecha' => '2021-12-31', 'valor' => '0', 'fuente_nombre' => 'IMCO')); // formateado 2, valor 20, crudo 13
    } // datos
