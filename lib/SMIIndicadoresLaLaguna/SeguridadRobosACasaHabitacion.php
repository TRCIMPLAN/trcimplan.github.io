...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascragfjpc">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrhdifjny" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascragfjpc a:first').tab('show')
});
// LENGUETA
$('#Lenguetascragfjpc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrhdifjny === 'undefined') {
    varMorrisrhdifjny = Morris.Line({
      element: 'Morrisrhdifjny',
