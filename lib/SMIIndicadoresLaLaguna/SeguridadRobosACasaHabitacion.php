<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Seguridad Robos a Casa Habitación (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica-1"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatosSecretariadoEjecutivoDelSistemaNacionalDeSeguridadPublica === 'undefined') {
    vargraficaDatosSecretariadoEjecutivoDelSistemaNacionalDeSeguridadPublica = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 115 },{ fecha: '2014-02-28', dato: 115 },{ fecha: '2014-03-31', dato: 123 },{ fecha: '2014-04-30', dato: 102 },{ fecha: '2014-05-31', dato: 155 },{ fecha: '2014-06-30', dato: 83 },{ fecha: '2014-07-31', dato: 101 },{ fecha: '2014-08-31', dato: 124 },{ fecha: '2014-09-30', dato: 128 },{ fecha: '2014-10-31', dato: 110 },{ fecha: '2014-11-30', dato: 92 },{ fecha: '2014-12-31', dato: 71 },{ fecha: '2015-01-31', dato: 110 },{ fecha: '2015-02-28', dato: 118 },{ fecha: '2015-03-31', dato: 79 },{ fecha: '2015-04-30', dato: 110 },{ fecha: '2015-05-31', dato: 104 },{ fecha: '2015-07-31', dato: 116 },{ fecha: '2015-08-31', dato: 105 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
