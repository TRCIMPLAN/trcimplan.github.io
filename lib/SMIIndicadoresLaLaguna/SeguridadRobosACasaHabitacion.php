...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasungkyhoo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskdlyuejr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfmfkidcu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasungkyhoo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasungkyhoo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskdlyuejr === 'undefined') {
    varMorriskdlyuejr = Morris.Line({
      element: 'Morriskdlyuejr',
...
// LENGUETA
$('#Lenguetasungkyhoo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfmfkidcu;
  ...
  function initmapfmfkidcu() {
    // Nuevo Mapa
    mapfmfkidcu = new L.Map('LeafLetfmfkidcu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfmfkidcu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfmfkidcu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfmfkidcu === 'undefined') {
    varinitmapfmfkidcu = initmapfmfkidcu();
  };
});
FINAL;
    } // constructor
