...
<h3>Gráfica</h3>
<div id="Morrisclmouglq" class="grafica"></div>
    </div>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisclmouglq === 'undefined') {
    varMorrisclmouglq = Morris.Line({
      element: 'Morrisclmouglq',
