...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspailbkkg">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdhnaqwlh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspailbkkg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspailbkkg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdhnaqwlh === 'undefined') {
    varMorrisdhnaqwlh = Morris.Line({
      element: 'Morrisdhnaqwlh',
