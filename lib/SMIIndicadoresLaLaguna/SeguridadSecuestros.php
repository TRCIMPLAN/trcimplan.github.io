...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdxquhgwx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdzmatfmv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdxquhgwx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdxquhgwx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdzmatfmv === 'undefined') {
    varMorrisdzmatfmv = Morris.Line({
      element: 'Morrisdzmatfmv',
