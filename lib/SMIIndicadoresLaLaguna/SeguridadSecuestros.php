...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdcqojvjs">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisybeucajr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdcqojvjs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdcqojvjs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisybeucajr === 'undefined') {
    varMorrisybeucajr = Morris.Line({
      element: 'Morrisybeucajr',
