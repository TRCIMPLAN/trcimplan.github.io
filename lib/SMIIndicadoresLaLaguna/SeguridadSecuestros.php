...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjzktoatw">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvqvfdpqh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjzktoatw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjzktoatw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvqvfdpqh;
  ...
  function initmapvqvfdpqh() {
    // Nuevo Mapa
    mapvqvfdpqh = new L.Map('LeafLetvqvfdpqh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvqvfdpqh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvqvfdpqh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvqvfdpqh === 'undefined') {
    varinitmapvqvfdpqh = initmapvqvfdpqh();
  };
});
FINAL;
    } // constructor
