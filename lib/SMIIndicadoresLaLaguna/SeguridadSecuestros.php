...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswoejmffz">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetscdcrfro" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswoejmffz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswoejmffz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapscdcrfro;
  ...
  function initmapscdcrfro() {
    // Nuevo Mapa
    mapscdcrfro = new L.Map('LeafLetscdcrfro');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapscdcrfro.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapscdcrfro.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapscdcrfro === 'undefined') {
    varinitmapscdcrfro = initmapscdcrfro();
  };
});
FINAL;
    } // constructor
