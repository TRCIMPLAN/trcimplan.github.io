...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasltobswzo">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettddysokv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasltobswzo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasltobswzo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptddysokv;
  ...
  function initmaptddysokv() {
    // Nuevo Mapa
    maptddysokv = new L.Map('LeafLettddysokv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptddysokv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptddysokv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptddysokv === 'undefined') {
    varinitmaptddysokv = initmaptddysokv();
  };
});
FINAL;
    } // constructor
