...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslmflcemq">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyysfefqj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslmflcemq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslmflcemq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyysfefqj;
  ...
  function initmapyysfefqj() {
    // Nuevo Mapa
    mapyysfefqj = new L.Map('LeafLetyysfefqj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyysfefqj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyysfefqj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyysfefqj === 'undefined') {
    varinitmapyysfefqj = initmapyysfefqj();
  };
});
FINAL;
    } // constructor
