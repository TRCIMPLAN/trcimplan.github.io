...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbmljnlvw">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetprwhwyig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbmljnlvw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbmljnlvw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapprwhwyig;
  ...
  function initmapprwhwyig() {
    // Nuevo Mapa
    mapprwhwyig = new L.Map('LeafLetprwhwyig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapprwhwyig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapprwhwyig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapprwhwyig === 'undefined') {
    varinitmapprwhwyig = initmapprwhwyig();
  };
});
FINAL;
    } // constructor
