...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslmxbtocr">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetphqdoyam" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslmxbtocr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslmxbtocr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapphqdoyam;
  ...
  function initmapphqdoyam() {
    // Nuevo Mapa
    mapphqdoyam = new L.Map('LeafLetphqdoyam');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapphqdoyam.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapphqdoyam.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapphqdoyam === 'undefined') {
    varinitmapphqdoyam = initmapphqdoyam();
  };
});
FINAL;
    } // constructor
