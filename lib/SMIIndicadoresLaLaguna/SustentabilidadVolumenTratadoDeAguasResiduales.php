...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrrugabnc">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnnsdybac" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrrugabnc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrrugabnc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnnsdybac;
  ...
  function initmapnnsdybac() {
    // Nuevo Mapa
    mapnnsdybac = new L.Map('LeafLetnnsdybac');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnnsdybac.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnnsdybac.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnnsdybac === 'undefined') {
    varinitmapnnsdybac = initmapnnsdybac();
  };
});
FINAL;
    } // constructor
