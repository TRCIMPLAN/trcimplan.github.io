...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseahynpin">
...
<b>Unidad:</b> Litros por segundo por cada mil habitantes.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbmvqbjfj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseahynpin a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseahynpin a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbmvqbjfj;
  ...
  function initmapbmvqbjfj() {
    // Nuevo Mapa
    mapbmvqbjfj = new L.Map('LeafLetbmvqbjfj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbmvqbjfj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbmvqbjfj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbmvqbjfj === 'undefined') {
    varinitmapbmvqbjfj = initmapbmvqbjfj();
  };
});
FINAL;
    } // constructor
