...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasexwxqtbt">
...
Litros por segundo por cada mil habitantes
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaihragsr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasexwxqtbt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasexwxqtbt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaihragsr;
  ...
  function initmapaihragsr() {
    // Nuevo Mapa
    mapaihragsr = new L.Map('LeafLetaihragsr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaihragsr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaihragsr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaihragsr === 'undefined') {
    varinitmapaihragsr = initmapaihragsr();
  };
});
FINAL;
    } // constructor
