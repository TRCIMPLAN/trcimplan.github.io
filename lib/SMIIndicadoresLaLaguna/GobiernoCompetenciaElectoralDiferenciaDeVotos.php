...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdzvazjat">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqxbavhpw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdzvazjat a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdzvazjat a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqxbavhpw;
  ...
  function initmapqxbavhpw() {
    // Nuevo Mapa
    mapqxbavhpw = new L.Map('LeafLetqxbavhpw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqxbavhpw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqxbavhpw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqxbavhpw === 'undefined') {
    varinitmapqxbavhpw = initmapqxbavhpw();
  };
});
FINAL;
    } // constructor
