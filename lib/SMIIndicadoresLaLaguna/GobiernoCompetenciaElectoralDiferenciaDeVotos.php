...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqndrpicd">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfrafquuy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqndrpicd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqndrpicd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfrafquuy;
  ...
  function initmapfrafquuy() {
    // Nuevo Mapa
    mapfrafquuy = new L.Map('LeafLetfrafquuy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfrafquuy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfrafquuy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfrafquuy === 'undefined') {
    varinitmapfrafquuy = initmapfrafquuy();
  };
});
FINAL;
    } // constructor
