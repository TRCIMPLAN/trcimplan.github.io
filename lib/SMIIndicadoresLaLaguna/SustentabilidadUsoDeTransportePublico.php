<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sustentabilidad Uso de Transporte Público (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SustentabilidadUsoDeTransportePublico extends \Base\Publicacion {
