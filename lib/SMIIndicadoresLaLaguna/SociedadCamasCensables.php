...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaqygfehf">
...
<div id="Morrislyeknyaa" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfgknxdnw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaqygfehf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaqygfehf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislyeknyaa === 'undefined') {
    varMorrislyeknyaa = Morris.Line({
      element: 'Morrislyeknyaa',
...
// LENGUETA
$('#Lenguetasaqygfehf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfgknxdnw;
  ...
  function initmapfgknxdnw() {
    // Nuevo Mapa
    mapfgknxdnw = new L.Map('LeafLetfgknxdnw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfgknxdnw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfgknxdnw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfgknxdnw === 'undefined') {
    varinitmapfgknxdnw = initmapfgknxdnw();
  };
});
FINAL;
    } // constructor
