...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashatwejvd">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislbhkmfox" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashatwejvd a:first').tab('show')
});
// LENGUETA
$('#Lenguetashatwejvd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislbhkmfox === 'undefined') {
    varMorrislbhkmfox = Morris.Line({
      element: 'Morrislbhkmfox',
