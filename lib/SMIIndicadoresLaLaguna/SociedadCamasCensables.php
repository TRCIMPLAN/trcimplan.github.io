...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgrgszzzp">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiiiiqdcg" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoyoyipkp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgrgszzzp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgrgszzzp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiiiiqdcg === 'undefined') {
    varMorrisiiiiqdcg = Morris.Line({
      element: 'Morrisiiiiqdcg',
...
// LENGUETA
$('#Lenguetasgrgszzzp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoyoyipkp;
  ...
  function initmapoyoyipkp() {
    // Nuevo Mapa
    mapoyoyipkp = new L.Map('LeafLetoyoyipkp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoyoyipkp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoyoyipkp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoyoyipkp === 'undefined') {
    varinitmapoyoyipkp = initmapoyoyipkp();
  };
});
FINAL;
    } // constructor
