...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspqqlhgwt">
...
<div id="Morrislsnqzuxa" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteuwwydvz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspqqlhgwt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspqqlhgwt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislsnqzuxa === 'undefined') {
    varMorrislsnqzuxa = Morris.Line({
      element: 'Morrislsnqzuxa',
...
// LENGUETA
$('#Lenguetaspqqlhgwt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeuwwydvz;
  ...
  function initmapeuwwydvz() {
    // Nuevo Mapa
    mapeuwwydvz = new L.Map('LeafLeteuwwydvz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeuwwydvz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeuwwydvz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeuwwydvz === 'undefined') {
    varinitmapeuwwydvz = initmapeuwwydvz();
  };
});
FINAL;
    } // constructor
