...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqvcxsbqj">
...
<div id="Morriscnoplklf" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgobpider" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqvcxsbqj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqvcxsbqj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscnoplklf === 'undefined') {
    varMorriscnoplklf = Morris.Line({
      element: 'Morriscnoplklf',
...
// LENGUETA
$('#Lenguetasqvcxsbqj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgobpider;
  ...
  function initmapgobpider() {
    // Nuevo Mapa
    mapgobpider = new L.Map('LeafLetgobpider');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgobpider.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgobpider.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgobpider === 'undefined') {
    varinitmapgobpider = initmapgobpider();
  };
});
FINAL;
    } // constructor
