...
class SociedadPobrezaExtrema extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfbizzguw">
...
Consulta la [Base de Datos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethfbozgav" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfbizzguw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfbizzguw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphfbozgav;
  ...
  function initmaphfbozgav() {
    // Nuevo Mapa
    maphfbozgav = new L.Map('LeafLethfbozgav');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphfbozgav.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphfbozgav.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphfbozgav === 'undefined') {
    varinitmaphfbozgav = initmaphfbozgav();
  };
});
FINAL;
    } // constructor
