...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyliquvmx">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskwjrwmdl" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyliquvmx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyliquvmx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskwjrwmdl === 'undefined') {
    varMorriskwjrwmdl = Morris.Line({
      element: 'Morriskwjrwmdl',
