...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxnjikgbb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvgpqenpu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxnjikgbb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxnjikgbb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvgpqenpu === 'undefined') {
    varMorrisvgpqenpu = Morris.Line({
      element: 'Morrisvgpqenpu',
