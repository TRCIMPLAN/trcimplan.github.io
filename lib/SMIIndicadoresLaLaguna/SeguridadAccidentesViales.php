...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrzhxmfya">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscjxiijwf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrzhxmfya a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrzhxmfya a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscjxiijwf === 'undefined') {
    varMorriscjxiijwf = Morris.Line({
      element: 'Morriscjxiijwf',
