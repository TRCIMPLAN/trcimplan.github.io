...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashmqbbcoe">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvyupznrz" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashmqbbcoe a:first').tab('show')
});
// LENGUETA
$('#Lenguetashmqbbcoe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvyupznrz === 'undefined') {
    varMorrisvyupznrz = Morris.Line({
      element: 'Morrisvyupznrz',
