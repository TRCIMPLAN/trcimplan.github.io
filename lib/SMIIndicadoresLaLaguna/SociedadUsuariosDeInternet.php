<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Usuarios de Internet (Creado por Central:SmiLanzadera)
 *
...
class SociedadUsuariosDeInternet extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->claves            = 'IMPLAN, La Laguna, Innovación, Competitividad, Población, Objetivos del Milenio';
