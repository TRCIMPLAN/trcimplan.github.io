...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoibgrxjh">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetteazrhis" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoibgrxjh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoibgrxjh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapteazrhis;
  ...
  function initmapteazrhis() {
    // Nuevo Mapa
    mapteazrhis = new L.Map('LeafLetteazrhis');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapteazrhis.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapteazrhis.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapteazrhis === 'undefined') {
    varinitmapteazrhis = initmapteazrhis();
  };
});
FINAL;
    } // constructor
