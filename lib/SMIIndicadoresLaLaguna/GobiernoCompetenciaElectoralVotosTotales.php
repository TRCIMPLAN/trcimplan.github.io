...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashtofyuld">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoskdqcgf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashtofyuld a:first').tab('show')
});
// LENGUETA
$('#Lenguetashtofyuld a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maposkdqcgf;
  ...
  function initmaposkdqcgf() {
    // Nuevo Mapa
    maposkdqcgf = new L.Map('LeafLetoskdqcgf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maposkdqcgf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maposkdqcgf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaposkdqcgf === 'undefined') {
    varinitmaposkdqcgf = initmaposkdqcgf();
  };
});
FINAL;
    } // constructor
