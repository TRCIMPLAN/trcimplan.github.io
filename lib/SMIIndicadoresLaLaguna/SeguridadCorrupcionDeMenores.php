<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SeguridadCorrupcionDeMenores
 *
...
/**
 * Clase SeguridadCorrupcionDeMenores
 */
class SeguridadCorrupcionDeMenores extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Corrupción de menores en La Laguna';
        $this->fecha       = '2018-07-25T14:05:56';
        // El nombre del archivo a crear
        $this->archivo     = 'seguridad-corrupcion-de-menores';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion = 'Cantidad de delitos por corrupción de menores por mes';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2022-05-31', 'valor' => '1', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública')); // formateado 0, valor 12, crudo 6
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'Nacional', 'fecha' => '2022-03-31', 'valor' => '164', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos'));
    } // otras_regiones
