...
class Indice extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo     = 'index';
        $this->descripcion = 'Listado de indicadores de La Laguna';
...
<tbody>
  ...
  <tr>
    ...
    <td class="derecha color3"><a class="vinculo" href="../indicadores-la-laguna/seguridad-accidentes-viales.html" data-toggle="tooltip" title="Cantidad, 31/12/2012, INEGI">4,107</a></td>
  </tr>
  <tr>
    <td class="subindice color3">SEGURIDAD</td>
  ...
  <tr>
    ...
    <td class="derecha color4"><a class="vinculo" href="../indicadores-la-laguna/sociedad-mortalidad.html" data-toggle="tooltip" title="Por cada mil, 31/12/2012, INEGI">5.6000</a></td>
  </tr>
  <tr>
    <td class="subindice color4">SOCIEDAD</td>
