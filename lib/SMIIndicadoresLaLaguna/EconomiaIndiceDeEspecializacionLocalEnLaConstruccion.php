...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskgvvzmei">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgizdpqjq" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskgvvzmei a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskgvvzmei a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgizdpqjq;
  ...
  function initmapgizdpqjq() {
    // Nuevo Mapa
    mapgizdpqjq = new L.Map('LeafLetgizdpqjq');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgizdpqjq.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgizdpqjq.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgizdpqjq === 'undefined') {
    varinitmapgizdpqjq = initmapgizdpqjq();
  };
});
FINAL;
    } // constructor
