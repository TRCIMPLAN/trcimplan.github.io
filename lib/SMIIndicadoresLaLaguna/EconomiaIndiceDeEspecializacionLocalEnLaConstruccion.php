...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasghnyvfwt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgacepesj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasghnyvfwt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasghnyvfwt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgacepesj;
  ...
  function initmapgacepesj() {
    // Nuevo Mapa
    mapgacepesj = new L.Map('LeafLetgacepesj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgacepesj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgacepesj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgacepesj === 'undefined') {
    varinitmapgacepesj = initmapgacepesj();
  };
});
FINAL;
    } // constructor
