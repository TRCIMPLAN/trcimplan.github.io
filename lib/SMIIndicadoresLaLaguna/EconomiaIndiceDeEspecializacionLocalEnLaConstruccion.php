...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjyenuqbw">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvwvherax" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjyenuqbw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjyenuqbw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvwvherax;
  ...
  function initmapvwvherax() {
    // Nuevo Mapa
    mapvwvherax = new L.Map('LeafLetvwvherax');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvwvherax.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvwvherax.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvwvherax === 'undefined') {
    varinitmapvwvherax = initmapvwvherax();
  };
});
FINAL;
    } // constructor
