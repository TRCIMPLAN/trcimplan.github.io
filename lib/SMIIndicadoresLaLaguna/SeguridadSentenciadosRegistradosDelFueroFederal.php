...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmebafvwa">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlsgphwwu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmebafvwa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmebafvwa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplsgphwwu;
  ...
  function initmaplsgphwwu() {
    // Nuevo Mapa
    maplsgphwwu = new L.Map('LeafLetlsgphwwu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplsgphwwu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplsgphwwu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplsgphwwu === 'undefined') {
    varinitmaplsgphwwu = initmaplsgphwwu();
  };
});
FINAL;
    } // constructor
