...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasptkkuovh">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfztzphif" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasptkkuovh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasptkkuovh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfztzphif === 'undefined') {
    varMorrisfztzphif = Morris.Line({
      element: 'Morrisfztzphif',
