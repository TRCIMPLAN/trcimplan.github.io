...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskegjkgkp">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisngykelyt" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnelknjuu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskegjkgkp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskegjkgkp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisngykelyt === 'undefined') {
    varMorrisngykelyt = Morris.Line({
      element: 'Morrisngykelyt',
...
// LENGUETA
$('#Lenguetaskegjkgkp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnelknjuu;
  ...
  function initmapnelknjuu() {
    // Nuevo Mapa
    mapnelknjuu = new L.Map('LeafLetnelknjuu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnelknjuu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnelknjuu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnelknjuu === 'undefined') {
    varinitmapnelknjuu = initmapnelknjuu();
  };
});
FINAL;
    } // constructor
