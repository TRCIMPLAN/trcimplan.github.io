...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgdgmnmic">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszehaycwk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgdgmnmic a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgdgmnmic a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszehaycwk === 'undefined') {
    varMorriszehaycwk = Morris.Line({
      element: 'Morriszehaycwk',
