...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashivrsxso">
...
<div id="Morrisisnzlgqm" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbfkewgeg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashivrsxso a:first').tab('show')
});
// LENGUETA
$('#Lenguetashivrsxso a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisisnzlgqm === 'undefined') {
    varMorrisisnzlgqm = Morris.Line({
      element: 'Morrisisnzlgqm',
...
// LENGUETA
$('#Lenguetashivrsxso a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbfkewgeg;
  ...
  function initmapbfkewgeg() {
    // Nuevo Mapa
    mapbfkewgeg = new L.Map('LeafLetbfkewgeg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbfkewgeg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbfkewgeg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbfkewgeg === 'undefined') {
    varinitmapbfkewgeg = initmapbfkewgeg();
  };
});
FINAL;
    } // constructor
