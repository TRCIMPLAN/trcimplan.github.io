...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxljppprp">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswosrsobx" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxljppprp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxljppprp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswosrsobx === 'undefined') {
    varMorriswosrsobx = Morris.Line({
      element: 'Morriswosrsobx',
