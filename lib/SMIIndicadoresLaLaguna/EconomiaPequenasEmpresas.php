...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiuerequj">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismmypadwd" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiuerequj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiuerequj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismmypadwd === 'undefined') {
    varMorrismmypadwd = Morris.Line({
      element: 'Morrismmypadwd',
