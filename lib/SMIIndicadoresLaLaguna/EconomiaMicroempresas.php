...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdtcbqdem">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishwvboavr" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdtcbqdem a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdtcbqdem a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishwvboavr === 'undefined') {
    varMorrishwvboavr = Morris.Line({
      element: 'Morrishwvboavr',
