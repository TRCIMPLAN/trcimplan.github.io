...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasezeawiqo">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisapwljebk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasezeawiqo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasezeawiqo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisapwljebk === 'undefined') {
    varMorrisapwljebk = Morris.Line({
      element: 'Morrisapwljebk',
