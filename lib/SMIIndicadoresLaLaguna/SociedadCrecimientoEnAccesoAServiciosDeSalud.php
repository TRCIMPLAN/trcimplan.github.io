<?php
/**
 * TrcIMPLAN - SMI Indicadores La Laguna Sociedad Crecimiento en Acceso a Servicios de Salud (Creado por Central:SmiLanzadera)
 *
 ...
 */
class SociedadCrecimientoEnAccesoAServiciosDeSalud extends \Base\Publicacion {
...
<p>Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Acceso a Servicios de Salud en La Laguna</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: -2.8000 },{ fecha: '2009-12-31', dato: -2.8400 },{ fecha: '2010-12-31', dato: -2.8400 },{ fecha: '2011-12-31', dato: -2.8400 },{ fecha: '2012-12-31', dato: -2.8400 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    public function redifusion_html() {
      ...
      <h3>Descripción</h3>
<p>Incluido en el subíndice "Sociedad Preparada, Incluyente y Sana". Mide la tasa de cambio entre 2008 y 2012 de la PEA que tiene acceso a instituciones de salud.</p>
