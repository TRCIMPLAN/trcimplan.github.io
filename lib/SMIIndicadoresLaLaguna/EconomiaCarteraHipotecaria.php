...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasygrbfjgw">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispmvfauvw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasygrbfjgw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasygrbfjgw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispmvfauvw === 'undefined') {
    varMorrispmvfauvw = Morris.Line({
      element: 'Morrispmvfauvw',
