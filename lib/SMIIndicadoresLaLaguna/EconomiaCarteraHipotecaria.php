...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxispdnsa">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqxlfgegy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvjkgmdlt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxispdnsa a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxispdnsa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqxlfgegy === 'undefined') {
    varMorrisqxlfgegy = Morris.Line({
      element: 'Morrisqxlfgegy',
...
// LENGUETA
$('#Lenguetasxispdnsa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvjkgmdlt;
  ...
  function initmapvjkgmdlt() {
    // Nuevo Mapa
    mapvjkgmdlt = new L.Map('LeafLetvjkgmdlt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvjkgmdlt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvjkgmdlt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvjkgmdlt === 'undefined') {
    varinitmapvjkgmdlt = initmapvjkgmdlt();
  };
});
FINAL;
    } // constructor
