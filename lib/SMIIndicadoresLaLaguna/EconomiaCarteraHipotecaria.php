...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasszalnegi">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvyidmrug" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetntvsdtue" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasszalnegi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasszalnegi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvyidmrug === 'undefined') {
    varMorrisvyidmrug = Morris.Line({
      element: 'Morrisvyidmrug',
...
// LENGUETA
$('#Lenguetasszalnegi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapntvsdtue;
  ...
  function initmapntvsdtue() {
    // Nuevo Mapa
    mapntvsdtue = new L.Map('LeafLetntvsdtue');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapntvsdtue.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapntvsdtue.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapntvsdtue === 'undefined') {
    varinitmapntvsdtue = initmapntvsdtue();
  };
});
FINAL;
    } // constructor
