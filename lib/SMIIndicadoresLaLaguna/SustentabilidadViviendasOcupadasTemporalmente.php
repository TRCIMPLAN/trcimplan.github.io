...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasritcrvoo">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzzrjvjal" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasritcrvoo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasritcrvoo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzzrjvjal;
  ...
  function initmapzzrjvjal() {
    // Nuevo Mapa
    mapzzrjvjal = new L.Map('LeafLetzzrjvjal');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzzrjvjal.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzzrjvjal.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzzrjvjal === 'undefined') {
    varinitmapzzrjvjal = initmapzzrjvjal();
  };
});
FINAL;
    } // constructor
