...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseqacmmdg">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoocmvwoi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseqacmmdg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseqacmmdg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoocmvwoi;
  ...
  function initmapoocmvwoi() {
    // Nuevo Mapa
    mapoocmvwoi = new L.Map('LeafLetoocmvwoi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoocmvwoi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoocmvwoi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoocmvwoi === 'undefined') {
    varinitmapoocmvwoi = initmapoocmvwoi();
  };
});
FINAL;
    } // constructor
