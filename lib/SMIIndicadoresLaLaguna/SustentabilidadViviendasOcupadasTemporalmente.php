...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyzwpetrc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqlwkoiep" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyzwpetrc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyzwpetrc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqlwkoiep;
  ...
  function initmapqlwkoiep() {
    // Nuevo Mapa
    mapqlwkoiep = new L.Map('LeafLetqlwkoiep');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqlwkoiep.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqlwkoiep.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqlwkoiep === 'undefined') {
    varinitmapqlwkoiep = initmapqlwkoiep();
  };
});
FINAL;
    } // constructor
