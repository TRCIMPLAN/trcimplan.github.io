<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SustentabilidadCapacidadDeTratamientoDeAguaEnOperacion
 *
...
class SustentabilidadCapacidadDeTratamientoDeAguaEnOperacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Capacidad de Tratamiento de Agua en Operación en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '1.6000', 'fuente_nombre' => 'IMCO-CONAGUA')); // formateado 0, valor 2, crudo 1
    } // datos
