<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaPosgradosDeCalidad
 *
...
class EconomiaPosgradosDeCalidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Posgrados de Calidad en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Educación, Innovación';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-04-30', 'valor' => '15', 'fuente_nombre' => 'CONACYT'),
            array('fecha' => '2016-12-31', 'valor' => '19', 'fuente_nombre' => 'CONACYT')); // formateado 0, valor 4, crudo 2
    } // datos
