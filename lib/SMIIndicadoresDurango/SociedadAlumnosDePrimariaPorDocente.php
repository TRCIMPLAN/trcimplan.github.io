<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SociedadAlumnosDePrimariaPorDocente
 *
...
class SociedadAlumnosDePrimariaPorDocente extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos de Primaria por Docente en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-07-01', 'valor' => '21.7000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
