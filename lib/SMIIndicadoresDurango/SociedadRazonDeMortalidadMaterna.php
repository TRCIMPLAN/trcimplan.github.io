<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SociedadRazonDeMortalidadMaterna
 *
...
class SociedadRazonDeMortalidadMaterna extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón de Mortalidad Materna en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Salud, Género, Bienestar, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '43.6000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
