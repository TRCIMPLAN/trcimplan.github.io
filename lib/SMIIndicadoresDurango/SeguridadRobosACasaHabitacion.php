<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SeguridadRobosACasaHabitacion
 *
...
class SeguridadRobosACasaHabitacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Robos a Casa Habitación en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-03-31', 'valor' => '121', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos')); // formateado 0, valor 2, crudo 1
    } // datos
