<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SustentabilidadGeneracionDeBasura
 *
...
class SustentabilidadGeneracionDeBasura extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Generación de Basura en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Medio Ambiente, Recursos Naturales';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '6.1000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
