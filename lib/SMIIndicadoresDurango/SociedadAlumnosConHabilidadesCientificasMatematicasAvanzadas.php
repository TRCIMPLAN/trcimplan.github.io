<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SociedadAlumnosConHabilidadesCientificasMatematicasAvanzadas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasAvanzadas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Avanzadas en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '7.5000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
