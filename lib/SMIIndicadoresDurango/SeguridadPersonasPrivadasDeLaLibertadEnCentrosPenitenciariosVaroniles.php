<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SeguridadPersonasPrivadasDeLaLibertadEnCentrosPenitenciariosVaroniles
 *
...
class SeguridadPersonasPrivadasDeLaLibertadEnCentrosPenitenciariosVaroniles extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas privadas de la libertad en centros penitenciarios varoniles en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '5704', 'fuente_nombre' => 'Encuesta Nacional de Población Privada de la Libertad')); // formateado 0, valor 2, crudo 1
    } // datos
