<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SociedadMortalidadPorVihSida
 *
...
class SociedadMortalidadPorVihSida extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por VIH-SIDA en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '2.5000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
