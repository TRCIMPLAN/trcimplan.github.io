<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaSalarioPromedioMensualParaTrabajadoresDeTiempoCompleto
 *
...
class EconomiaSalarioPromedioMensualParaTrabajadoresDeTiempoCompleto extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Salario Promedio Mensual para Trabajadores de Tiempo Completo en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Índice de Competitividad Urbana, Empleo';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-06-30', 'valor' => '5351.19', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2015-09-30', 'valor' => '5639.57', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2015-12-31', 'valor' => '5434.31', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2016-03-31', 'valor' => '5642.76', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2016-06-30', 'valor' => '5756.32', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2016-09-30', 'valor' => '5759.83', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2016-12-31', 'valor' => '5827.82', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos'),
            array('fecha' => '2017-03-31', 'valor' => '6217.26', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Microdatos')); // formateado 0, valor 16, crudo 8
    } // datos
