<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SustentabilidadMotorizacion
 *
...
class SustentabilidadMotorizacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Motorización en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Medio Ambiente, Movilidad, Recursos Naturales, Sector Automotriz, Vialidad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2000-12-31', 'valor' => '114', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2001-12-31', 'valor' => '164', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2002-12-31', 'valor' => '163', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2003-12-31', 'valor' => '195', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2004-12-31', 'valor' => '202', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2005-12-31', 'valor' => '205', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2006-12-31', 'valor' => '230', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2007-12-31', 'valor' => '241', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2008-12-31', 'valor' => '243', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2009-12-31', 'valor' => '269', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2010-12-31', 'valor' => '266', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2011-12-31', 'valor' => '266', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2012-12-31', 'valor' => '282', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '291', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2014-12-31', 'valor' => '309', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2015-12-31', 'valor' => '325', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 32, crudo 16
    } // datos
