<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaPersonalOcupadoEnElComercio
 *
...
class EconomiaPersonalOcupadoEnElComercio extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personal Ocupado en el Comercio en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Empleo, Mercados';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '30.6424', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
