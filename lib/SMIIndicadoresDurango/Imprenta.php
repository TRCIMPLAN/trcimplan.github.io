...
class Imprenta extends \Base\ImprentaPublicaciones {
    ...
    public function __construct() {
        ...
        $this->publicaciones_directorio  = 'SMIIndicadoresDurango';
        // Los siguientes parámetros dan datos para el concentrador y las páginas que no los tienen
        $this->titulo                    = 'Indicadores de Durango';
        $this->descripcion               = 'Sistema Metropolitano de Indicadores, Región Durango.';
        $this->claves                    = 'IMPLAN, SMI, Indicadores, Metropolitanos, Durango';
        ...
        $this->directorio                = 'indicadores-durango';
