...
/**
 * Clase ConsejoDirectivoAgendaComitesTecnicos
 */
class ConsejoDirectivoAgendaComitesTecnicos extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre        = 'Agenda Comités Técnicos';
        $this->nombre_menu   = 'Agenda Comités Técnicos';
        $this->directorio    = 'consejo-directivo';
        $this->archivo       = 'agenda-comites-tecnicos';
