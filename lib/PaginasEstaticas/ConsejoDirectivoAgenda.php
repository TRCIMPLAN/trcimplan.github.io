...
/**
 * Clase ConsejoDirectivoAgenda
 */
class ConsejoDirectivoAgenda extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre        = 'Agenda Consejo Directivo';
        $this->nombre_menu   = 'Agenda Consejo Directivo';
