...
/**
 * Clase InstitucionalQuienesSomos
 */
class InstitucionalQuienesSomos extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->imagen_previa = '/imagenes/implan.jpg';
        ...
        $this->encabezado    = '<img class="img-responsive" src="quienes-somos/encabezado.jpg">';
