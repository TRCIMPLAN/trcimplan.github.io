...
/**
 * Clase SustentabilidadMedioAmbiente
 */
class SustentabilidadMedioAmbiente extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo       = 'sustentabilidad-medio-ambiente';
        $this->imagen_previa = 'sustentabilidad-medio-ambiente/imagen.jpg';
     // $this->encabezado    = '<img class="img-responsive encabezado-imagen" src="sustentabilidad-medio-ambiente/encabezado.jpg">';
