...
class ComportamientoTendenciaIncidenciaDelictiva extends \Base\Publicacion {
    ...
    public function html() {
        ...
        $this->contenido->articleBody = $this->cargar_archivo('lib/Blog/ComportamientoTendenciaIncidenciaDelictiva.html');
    ...
    public function redifusion_html() {
        ...
        $this->redifusion = $this->cargar_archivo('lib/Blog/ComportamientoTendenciaIncidenciaDelictiva.html');
        // Ejecutar este método en el padre
