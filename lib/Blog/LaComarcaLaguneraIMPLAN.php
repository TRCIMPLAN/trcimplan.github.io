...
class LaComarcaLaguneraIMPLAN extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->encabezado       = '<img class="img-responsive encabezado-imagen" src="la-comarca-lagunera-implan/encabezado.jpg">';
     ...
     // $this->para_compartir   = true;
        ...
        $this->contenido        = $this->cargar_archivo_markdown_extra('lib/Blog/LaComarcaLaguneraIMPLAN.md');
     // $this->javascript       = '';
    } // constructor
