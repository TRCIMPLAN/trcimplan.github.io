...
class SegundaGeneracionSitioWeb extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->autor            = 'Ing. Guillermo Valdés, Lic. Israel S. Charur, Lic. Hugo Ramírez';
     ...
     // $this->encabezado_color = '#646464';
        ...
        $this->descripcion      = 'A partir de enero de 2015 se puso en línea el nuevo sitio web del IMPLAN Torreón.';
