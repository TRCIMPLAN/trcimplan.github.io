...
class LosDerechosDelPolicia extends \Base\Publicacion {
    ...
    public function html() {
        ...
        $this->contenido->articleBody = $this->cargar_archivo_markdown_extra('lib/Blog/LosDerechosDelPolicia.md');
    ...
    public function redifusion_html() {
        ...
        $markdown = $this->cargar_archivo_markdown_extra('lib/Blog/LosDerechosDelPolicia.md');
