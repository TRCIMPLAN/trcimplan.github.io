...
class NuevaInfraestructuraBaseTecnologiaLedTorreon extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->encabezado       = '<img class="img-responsive encabezado-imagen" src="nueva-infraestructura-base-tecnologia-led-torreon/encabezado.jpg">';
     ...
     // $this->para_compartir   = true;
        ...
        $this->contenido        = $this->cargar_archivo_markdown_extra('lib/Blog/NuevaInfraestructuraBaseTecnologiaLedTorreon.md');
     // $this->javascript       = '';
    } // constructor
