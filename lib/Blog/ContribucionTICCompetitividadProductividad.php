...
<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/nri-vs-competitividad-global-imco.png" alt="NRI vs Competitividad Global IMCO">

<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/nri-vs-competitividad-global-imd.png" alt="NRI vs Competitividad Global IMD">

<p>Las características laborales del sector son también atractivas: en la Unión Europea, la tasa de desempleo para los profesionistas del sector de las TICs es aproximadamente 10% menor a la tasa de desempleo promedio y en Estados Unidos entre 1990 y 2011 la tasa de crecimiento del empleo en el sector TIC fue de 10.4%. En cuanto a México, las personas dedicadas a las TICs ganan en promedio 118,000 pesos al año y se considera como uno delos sectores mejor pagados.</p>

<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/tasa-desempleo-promedio-union-europea.png" alt="Tasa de desempleo promedio en la Unión Europea">

<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/remuneraciones-anuales-industria-trabajador.png" alt="Remuneraciones anuales en la industria por trabajador">

<p>A nivel Internacional las TICs siguen tomando importancia: en 2013 el 50% del capital de riesgo de Estados Unidos fue dirigido al sector TIC y en dos tercios de los países de la OECD, más del 95% de las empresas cuenta con internet. Esto sin mencionar que la contribución de las TICs en el PIB es cada vez más alta. En la gráfica inferior se expone la participación de las TICs en el PIB de diferentes países:</p>

<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/porcentaje-participacion-industria-tic-pib-nacional.png" alt="Porcentaje de participación de la industria en el PIB nacional">

<p>Comparado con las potencias, México tiene una baja participación de las TICs en el PIB: mientras las TICs en México representan el 5.6% y el software 0.7%, Estados Unidos tiene una participación de más 7% por parte de las TICs del cual 4% pertenece al software.</p>

<p>Otros rezagos de México en este sector se mencionan en el NRI 2014, en el cual México ocupa el lugar 79 de 148, es decir 16 lugares debajo de la posición ocupada en 2013. Entre los pilares peor calificados en el índice tenemos infraestructura y contenido digital, accesibilidad, habilidades e innovación en los negocios.</p>

<p>A pesar del retraso la participación de las TICs en el PIB creció 75% en la década de 2000 a 2010 y consultoras e Institutos internacionales como KPMG y el Institute for Management Development aseguran queMéxico destaca de entre los países emergentes en el desarrollo de las TICs. En la siguiente gráfica se aprecia el crecimiento de la participación de las TICs en el PIB de México:</p>

<img class="img-responsive contenido-imagen" src="contribucion-tic-competitividad-productividad/valor-sector-tic-mexico-porcentaje-pib.png" alt="Valor del sector TIC en México">

<h3>Áreas de oportunidad en los modelos educativos</h3>

<p>Para impulsar de manera óptima el uso de TICs en todas las industrias, los emprendedores de empresas tecnológicas identificaron la necesidad de cambiar los modelos educativos unidimensionales y desarrollar en todas las carreras habilidades de matemáticas, programación y diseño de software; esto además de competencias gerenciales y de alta dirección. El dominar al menos el idioma inglés, es también esencial para los profesionistas del sector.</p>

<p>A continuación algunos ejemplos de plan de estudios que abarcan todas estas habilidades:</p>

<p><b>Ingeniero en Software</b></p>

<ul>
    <li>Universidad Autónoma de Guadalajara (UAG)</li>
    <li>Conocimientos de administración, evaluación, finanzas y alta dirección.</li>
    <li>Metodologías de investigación</li>
    <li>Habilidades técnicas: bases de datos, animación, redes, modelado de hardware, diseño de software, etc.</li>
    <li>Idiomas: Inglés avanzado</li>
    <li><a target="_blank" href="http://www.uag.mx/licenciatura/en-software/">Ir a la página de la carrera en el sitio web de la UAG.</a></li>
</ul>

<p><b>Ingeniero en Tecnologías de Información y Comunicaciones</b></p>

<ul>
    <li>ITESM</li>
    <li>"Es un profesionista con visión innovadora y con base sólida en arquitectura de Tecnologías de Información que le permite la implantación, el mantenimiento, la operación y la administración de soluciones sustentadas en electrónica, computación y sistemas de información, integradas al servicio de personas y organizaciones ante la nueva y dinámica sociedad de la era digital."</li>
    <li><a target="_blank" href="http://www.itesm.mx/wps/wcm/connect/itesm/tecnologico+de+monterrey/carreras+profesionales/areas+de+estudio/tecnologias+de+informacion+y+electronica/itic">Ir a la página de la carrera en el sitio web del ITESM.</a></li>
</ul>
