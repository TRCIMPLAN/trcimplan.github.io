...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasceyqtnsy">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqtoenzeo" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasceyqtnsy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasceyqtnsy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqtoenzeo === 'undefined') {
    varMorrisqtoenzeo = Morris.Line({
      element: 'Morrisqtoenzeo',
