...
class SeguridadRoboATranseuntes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnvaeydyi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisifvapuyq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnvaeydyi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnvaeydyi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisifvapuyq === 'undefined') {
    varMorrisifvapuyq = Morris.Line({
      element: 'Morrisifvapuyq',
