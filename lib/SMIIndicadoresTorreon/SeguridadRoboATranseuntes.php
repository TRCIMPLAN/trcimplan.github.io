...
<h3>Gráfica</h3>
<div id="Morrisnhwftutw" class="grafica"></div>
    </div>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnhwftutw === 'undefined') {
    varMorrisnhwftutw = Morris.Line({
      element: 'Morrisnhwftutw',
      data: [{ fecha: '2014-01-31', dato: 178 },{ fecha: '2014-02-28', dato: 134 },{ fecha: '2014-03-31', dato: 91 },{ fecha: '2014-04-30', dato: 5 },{ fecha: '2014-05-31', dato: 155 },{ fecha: '2014-06-30', dato: 101 },{ fecha: '2014-07-31', dato: 73 },{ fecha: '2014-08-31', dato: 89 },{ fecha: '2014-09-30', dato: 56 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
