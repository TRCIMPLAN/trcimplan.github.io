<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Crecimiento en Acceso a Servicios de Salud (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Crecimiento en Acceso a Servicios de Salud en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: -2.1000 },{ fecha: '2009-12-31', dato: -2.1200 },{ fecha: '2010-12-31', dato: -2.1200 },{ fecha: '2011-12-31', dato: -2.1200 },{ fecha: '2012-12-31', dato: -2.1200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
