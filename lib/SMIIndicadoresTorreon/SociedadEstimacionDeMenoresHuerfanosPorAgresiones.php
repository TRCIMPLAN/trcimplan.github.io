...
class SociedadEstimacionDeMenoresHuerfanosPorAgresiones extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasptndonqh">
...
Elaboración propia en base a las defunciones registradas en [SINAIS](http://www.sinais.salud.gob.mx)
    ...
    <div class="tab-pane active" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrischdmmmay" class="grafica"></div>
    </div>
  </div>
FINAL;
...
$(document).ready(function(){
  $('#Lenguetasptndonqh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasptndonqh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrischdmmmay === 'undefined') {
    varMorrischdmmmay = Morris.Line({
      element: 'Morrischdmmmay',
