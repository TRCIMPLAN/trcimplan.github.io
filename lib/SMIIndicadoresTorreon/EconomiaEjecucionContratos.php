<?php
/**
 * EconomiaEjecucionContratos.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaEjecucionContratos
 */
class EconomiaEjecucionContratos extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaejecucion-contratos';
...
Costo (% de cantidad demandada) = 27,9</td>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Ejecución de Contratos</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
