<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda
 *
...
class SociedadCarenciaPorAccesoALosServiciosBasicosDeLaVivienda extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Carencia por acceso a los servicios básicos de la vivienda en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '2.3000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2010-12-31', 'valor' => '1.9000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
