...
class SustentabilidadRedCarreteraDeAlimentadorasEstatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmzxlvtlq">
...
No aplica a nivel metropolitano
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetljailsdv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmzxlvtlq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmzxlvtlq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapljailsdv;
  ...
  function initmapljailsdv() {
    // Nuevo Mapa
    mapljailsdv = new L.Map('LeafLetljailsdv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapljailsdv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapljailsdv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapljailsdv === 'undefined') {
    varinitmapljailsdv = initmapljailsdv();
  };
});
FINAL;
    } // constructor
