<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadPoblacionConCarenciaDeServiciosBasicos
 *
...
class SociedadPoblacionConCarenciaDeServiciosBasicos extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con carencia de servicios básicos en Torreón';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2015-12-31', 'valor' => '1.9000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
