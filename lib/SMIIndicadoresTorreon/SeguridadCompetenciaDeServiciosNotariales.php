<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Seguridad Competencia de Servicios Notariales (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Secretaría de Gobernación (Directorio de Notarios), 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia de Servicios Notariales en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 22.4632 },{ fecha: '2009-12-31', dato: 22.1946 },{ fecha: '2010-12-31', dato: 21.5186 },{ fecha: '2011-12-31', dato: 19.7976 },{ fecha: '2012-12-31', dato: 19.9267 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
