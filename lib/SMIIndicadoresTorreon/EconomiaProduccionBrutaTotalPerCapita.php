...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfbsodcqe">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismerwqdcy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfbsodcqe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfbsodcqe a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismerwqdcy === 'undefined') {
    varMorrismerwqdcy = Morris.Line({
      element: 'Morrismerwqdcy',
