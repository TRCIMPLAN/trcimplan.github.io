...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxminvpas">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisswkcwips" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrhzzkuje" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxminvpas a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxminvpas a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisswkcwips === 'undefined') {
    varMorrisswkcwips = Morris.Line({
      element: 'Morrisswkcwips',
...
// LENGUETA
$('#Lenguetasxminvpas a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprhzzkuje;
  ...
  function initmaprhzzkuje() {
    // Nuevo Mapa
    maprhzzkuje = new L.Map('LeafLetrhzzkuje');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprhzzkuje.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprhzzkuje.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprhzzkuje === 'undefined') {
    varinitmaprhzzkuje = initmaprhzzkuje();
  };
});
FINAL;
    } // constructor
