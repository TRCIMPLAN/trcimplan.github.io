...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasctentdxj">
...
<div id="Morrisdiunonly" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettdvdhmym" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasctentdxj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasctentdxj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdiunonly === 'undefined') {
    varMorrisdiunonly = Morris.Line({
      element: 'Morrisdiunonly',
...
// LENGUETA
$('#Lenguetasctentdxj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptdvdhmym;
  ...
  function initmaptdvdhmym() {
    // Nuevo Mapa
    maptdvdhmym = new L.Map('LeafLettdvdhmym');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptdvdhmym.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptdvdhmym.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptdvdhmym === 'undefined') {
    varinitmaptdvdhmym = initmaptdvdhmym();
  };
});
FINAL;
    } // constructor
