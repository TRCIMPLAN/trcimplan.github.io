...
class EconomiaProduccionBrutaTotalPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslpeipgwb">
...
Datos obtenidos de [INEGI Censos económicos.](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbzttgqgx" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslpeipgwb a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslpeipgwb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbzttgqgx === 'undefined') {
    varMorrisbzttgqgx = Morris.Line({
      element: 'Morrisbzttgqgx',
