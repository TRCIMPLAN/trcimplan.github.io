...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspcnztgyo">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismzazyqlf" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjdjgymjj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspcnztgyo a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspcnztgyo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismzazyqlf === 'undefined') {
    varMorrismzazyqlf = Morris.Line({
      element: 'Morrismzazyqlf',
...
// LENGUETA
$('#Lenguetaspcnztgyo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjdjgymjj;
  ...
  function initmapjdjgymjj() {
    // Nuevo Mapa
    mapjdjgymjj = new L.Map('LeafLetjdjgymjj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjdjgymjj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjdjgymjj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjdjgymjj === 'undefined') {
    varinitmapjdjgymjj = initmapjdjgymjj();
  };
});
FINAL;
    } // constructor
