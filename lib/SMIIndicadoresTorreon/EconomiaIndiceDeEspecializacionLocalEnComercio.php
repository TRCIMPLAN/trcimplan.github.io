...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasurcaaawl">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswureoivk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasurcaaawl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasurcaaawl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswureoivk === 'undefined') {
    varMorriswureoivk = Morris.Line({
      element: 'Morriswureoivk',
