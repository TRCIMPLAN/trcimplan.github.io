...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoozcygtt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristazhxuqf" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoozcygtt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoozcygtt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristazhxuqf === 'undefined') {
    varMorristazhxuqf = Morris.Line({
      element: 'Morristazhxuqf',
