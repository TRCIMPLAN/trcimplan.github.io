...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspxqvccye">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisorbjesnv" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgiluaemx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspxqvccye a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspxqvccye a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisorbjesnv === 'undefined') {
    varMorrisorbjesnv = Morris.Line({
      element: 'Morrisorbjesnv',
...
// LENGUETA
$('#Lenguetaspxqvccye a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgiluaemx;
  ...
  function initmapgiluaemx() {
    // Nuevo Mapa
    mapgiluaemx = new L.Map('LeafLetgiluaemx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgiluaemx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgiluaemx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgiluaemx === 'undefined') {
    varinitmapgiluaemx = initmapgiluaemx();
  };
});
FINAL;
    } // constructor
