...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyrpicfhv">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisirctgnix" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxkjadyai" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyrpicfhv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyrpicfhv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisirctgnix === 'undefined') {
    varMorrisirctgnix = Morris.Line({
      element: 'Morrisirctgnix',
...
// LENGUETA
$('#Lenguetasyrpicfhv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxkjadyai;
  ...
  function initmapxkjadyai() {
    // Nuevo Mapa
    mapxkjadyai = new L.Map('LeafLetxkjadyai');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxkjadyai.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxkjadyai.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxkjadyai === 'undefined') {
    varinitmapxkjadyai = initmapxkjadyai();
  };
});
FINAL;
    } // constructor
