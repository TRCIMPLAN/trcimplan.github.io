...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuswfqtgy">
...
<div id="Morrisaopuvytv" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaqofdgbb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuswfqtgy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuswfqtgy a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisaopuvytv === 'undefined') {
    varMorrisaopuvytv = Morris.Line({
      element: 'Morrisaopuvytv',
...
// LENGUETA
$('#Lenguetasuswfqtgy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaqofdgbb;
  ...
  function initmapaqofdgbb() {
    // Nuevo Mapa
    mapaqofdgbb = new L.Map('LeafLetaqofdgbb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaqofdgbb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaqofdgbb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaqofdgbb === 'undefined') {
    varinitmapaqofdgbb = initmapaqofdgbb();
  };
});
FINAL;
    } // constructor
