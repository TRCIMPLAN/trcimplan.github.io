...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyzeeqqij">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdewpvziy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyzeeqqij a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyzeeqqij a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdewpvziy === 'undefined') {
    varMorrisdewpvziy = Morris.Line({
      element: 'Morrisdewpvziy',
