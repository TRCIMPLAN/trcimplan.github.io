...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaserdxsmqa">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyiyxbohr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgrekmylj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaserdxsmqa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaserdxsmqa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyiyxbohr === 'undefined') {
    varMorrisyiyxbohr = Morris.Line({
      element: 'Morrisyiyxbohr',
...
// LENGUETA
$('#Lenguetaserdxsmqa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgrekmylj;
  ...
  function initmapgrekmylj() {
    // Nuevo Mapa
    mapgrekmylj = new L.Map('LeafLetgrekmylj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgrekmylj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgrekmylj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgrekmylj === 'undefined') {
    varinitmapgrekmylj = initmapgrekmylj();
  };
});
FINAL;
    } // constructor
