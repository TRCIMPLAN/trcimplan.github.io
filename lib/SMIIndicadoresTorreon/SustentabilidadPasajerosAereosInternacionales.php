...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgcznrjbd">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszryzvxyl" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmzxrhhhp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgcznrjbd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgcznrjbd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszryzvxyl === 'undefined') {
    varMorriszryzvxyl = Morris.Line({
      element: 'Morriszryzvxyl',
...
// LENGUETA
$('#Lenguetasgcznrjbd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmzxrhhhp;
  ...
  function initmapmzxrhhhp() {
    // Nuevo Mapa
    mapmzxrhhhp = new L.Map('LeafLetmzxrhhhp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmzxrhhhp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmzxrhhhp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmzxrhhhp === 'undefined') {
    varinitmapmzxrhhhp = initmapmzxrhhhp();
  };
});
FINAL;
    } // constructor
