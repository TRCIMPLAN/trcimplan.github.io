...
class SustentabilidadPasajerosAereosInternacionales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswvtcegsj">
...
Se considera a nivel metropolitano. Consulta la [Base de Datos](http://www.oma.aero/es/aeropuertos/trfico-de-pasajeros/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqzbynswk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswvtcegsj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswvtcegsj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqzbynswk === 'undefined') {
    varMorrisqzbynswk = Morris.Line({
      element: 'Morrisqzbynswk',
