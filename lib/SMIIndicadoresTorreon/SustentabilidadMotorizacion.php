...
class SustentabilidadMotorizacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Torreón, Medio Ambiente, Movilidad, Recursos Naturales, Sector Automotriz, Vialidad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2015-12-31', 'valor' => '211', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 32, crudo 16
    } // datos
