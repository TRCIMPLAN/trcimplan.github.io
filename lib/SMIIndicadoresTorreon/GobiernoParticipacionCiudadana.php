<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Participación Ciudadana (Creado por Central:SmiLanzadera)
 *
...
<p>Para los años 2008, 2009 y 2010 se consideraron los datos de las elecciones de 2009, mientras que para los años 2011 y 2012 se tomaron datos de las elecciones de 2012. Unidades: Porcentaje de la lista nominal. Fuente: Instituto Federal Electoral (IFE), 2009 y 2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Participación Ciudadana en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 48.2900 },{ fecha: '2009-12-31', dato: 48.2900 },{ fecha: '2010-12-31', dato: 48.2900 },{ fecha: '2011-12-31', dato: 64.6600 },{ fecha: '2012-12-31', dato: 64.6600 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
