<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Usuarios de Internet (Creado por Central:SmiLanzadera)
 *
...
class SociedadUsuariosDeInternet extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->claves            = 'IMPLAN, Torreón, Innovación, Competitividad, Población, Objetivos del Milenio';
