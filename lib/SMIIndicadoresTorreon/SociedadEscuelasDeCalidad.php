<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Escuelas de Calidad (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Mejora tu Escuela con datos de la SEP.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Escuelas de Calidad en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 11.6100 },{ fecha: '2009-12-31', dato: 11.6100 },{ fecha: '2010-12-31', dato: 13.0600 },{ fecha: '2011-12-31', dato: 18.0200 },{ fecha: '2012-12-31', dato: 26.6300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
