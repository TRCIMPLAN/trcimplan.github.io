...
class SustentabilidadGeneracionDeBasura extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiegqfdbc">
...
Consulta la [Base de Datos](http://www3.inegi.org.mx/sistemas/sisept/default.aspx?t=mamb1065&s=est&c=33986)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxdcjkbhj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiegqfdbc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiegqfdbc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxdcjkbhj;
  ...
  function initmapxdcjkbhj() {
    // Nuevo Mapa
    mapxdcjkbhj = new L.Map('LeafLetxdcjkbhj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxdcjkbhj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxdcjkbhj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxdcjkbhj === 'undefined') {
    varinitmapxdcjkbhj = initmapxdcjkbhj();
  };
});
FINAL;
    } // constructor
