...
class SociedadPobrezaExtrema extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjzrrmljs">
...
Consulta la [Base de Datos](http://www.coneval.gob.mx/Medicion/Paginas/Medici%C3%B3n/Pobreza%202012/Pobreza-2012.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrgjzyhku" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjzrrmljs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjzrrmljs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprgjzyhku;
  ...
  function initmaprgjzyhku() {
    // Nuevo Mapa
    maprgjzyhku = new L.Map('LeafLetrgjzyhku');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprgjzyhku.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprgjzyhku.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprgjzyhku === 'undefined') {
    varinitmaprgjzyhku = initmaprgjzyhku();
  };
});
FINAL;
    } // constructor
