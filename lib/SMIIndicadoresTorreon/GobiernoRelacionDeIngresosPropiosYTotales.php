...
class GobiernoRelacionDeIngresosPropiosYTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoiqdveiu">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqecpuwuc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoiqdveiu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoiqdveiu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqecpuwuc === 'undefined') {
    varMorrisqecpuwuc = Morris.Line({
      element: 'Morrisqecpuwuc',
