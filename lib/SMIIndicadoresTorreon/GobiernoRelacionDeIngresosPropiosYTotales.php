...
class GobiernoRelacionDeIngresosPropiosYTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslpmdrnck">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisenjrlygl" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrafvvtpv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslpmdrnck a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslpmdrnck a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisenjrlygl === 'undefined') {
    varMorrisenjrlygl = Morris.Line({
      element: 'Morrisenjrlygl',
...
// LENGUETA
$('#Lenguetaslpmdrnck a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprafvvtpv;
  ...
  function initmaprafvvtpv() {
    // Nuevo Mapa
    maprafvvtpv = new L.Map('LeafLetrafvvtpv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprafvvtpv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprafvvtpv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprafvvtpv === 'undefined') {
    varinitmaprafvvtpv = initmaprafvvtpv();
  };
});
FINAL;
    } // constructor
