...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasitagbrlf">
...
Por cada 10 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLeteugajhxy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasitagbrlf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasitagbrlf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapeugajhxy;
  ...
  function initmapeugajhxy() {
    // Nuevo Mapa
    mapeugajhxy = new L.Map('LeafLeteugajhxy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapeugajhxy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapeugajhxy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapeugajhxy === 'undefined') {
    varinitmapeugajhxy = initmapeugajhxy();
  };
});
FINAL;
    } // constructor
