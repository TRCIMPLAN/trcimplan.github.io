...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskwdrkrlh">
...
<b>Unidad:</b> Por cada 10 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcuuqqbxd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskwdrkrlh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskwdrkrlh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcuuqqbxd;
  ...
  function initmapcuuqqbxd() {
    // Nuevo Mapa
    mapcuuqqbxd = new L.Map('LeafLetcuuqqbxd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcuuqqbxd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcuuqqbxd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcuuqqbxd === 'undefined') {
    varinitmapcuuqqbxd = initmapcuuqqbxd();
  };
});
FINAL;
    } // constructor
