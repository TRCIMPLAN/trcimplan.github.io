...
class SociedadMortalidadPorDiabetes extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjlycseyr">
...
<b>Unidad:</b> Por cada 10 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmbdmfwbk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjlycseyr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjlycseyr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmbdmfwbk;
  ...
  function initmapmbdmfwbk() {
    // Nuevo Mapa
    mapmbdmfwbk = new L.Map('LeafLetmbdmfwbk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmbdmfwbk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmbdmfwbk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmbdmfwbk === 'undefined') {
    varinitmapmbdmfwbk = initmapmbdmfwbk();
  };
});
FINAL;
    } // constructor
