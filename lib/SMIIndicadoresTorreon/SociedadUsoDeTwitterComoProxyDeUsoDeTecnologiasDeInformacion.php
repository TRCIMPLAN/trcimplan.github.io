<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Uso de Twitter como Proxy de Uso de Tecnologías de Información (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: IMCO, 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Uso de Twitter como Proxy de Uso de Tecnologías de Información en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 4.3230 },{ fecha: '2009-12-31', dato: 4.3230 },{ fecha: '2010-12-31', dato: 4.3230 },{ fecha: '2011-12-31', dato: 4.3230 },{ fecha: '2012-12-31', dato: 8.2249 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
