...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2015-01-31', dato: 120 },{ fecha: '2015-02-28', dato: 111 },{ fecha: '2015-03-31', dato: 115 },{ fecha: '2015-04-30', dato: 167 },{ fecha: '2015-05-31', dato: 134 },{ fecha: '2015-06-30', dato: 118 },{ fecha: '2015-07-31', dato: 127 },{ fecha: '2015-08-31', dato: 148 },{ fecha: '2015-09-30', dato: 135 },{ fecha: '2015-10-31', dato: 156 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
