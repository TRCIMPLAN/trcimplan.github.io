...
class EconomiaRegistroDePropiedades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfidbswdx">
...
Días
    ...
    <div class="tab-pane active" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxwmbzdfl" class="grafica"></div>
    </div>
  </div>
FINAL;
...
$(document).ready(function(){
  $('#Lenguetasfidbswdx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfidbswdx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxwmbzdfl === 'undefined') {
    varMorrisxwmbzdfl = Morris.Line({
      element: 'Morrisxwmbzdfl',
