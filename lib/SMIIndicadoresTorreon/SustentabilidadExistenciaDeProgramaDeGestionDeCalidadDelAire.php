<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadExistenciaDeProgramaDeGestionDeCalidadDelAire
 *
...
class SustentabilidadExistenciaDeProgramaDeGestionDeCalidadDelAire extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Existencia de Programa de Gestión de Calidad del Aire en Torreón';
...
NO=0, PED/PEMA=1, PROAIRE=2';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2015-12-31', 'valor' => '2', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 4, crudo 2
    } // datos
