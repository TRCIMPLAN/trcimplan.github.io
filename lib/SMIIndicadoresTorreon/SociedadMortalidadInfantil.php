...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrnhhulfd">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvbfeyubu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrnhhulfd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrnhhulfd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvbfeyubu;
  ...
  function initmapvbfeyubu() {
    // Nuevo Mapa
    mapvbfeyubu = new L.Map('LeafLetvbfeyubu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvbfeyubu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvbfeyubu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvbfeyubu === 'undefined') {
    varinitmapvbfeyubu = initmapvbfeyubu();
  };
});
FINAL;
    } // constructor
