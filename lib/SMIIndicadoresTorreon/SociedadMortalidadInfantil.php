<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Mortalidad Infantil (Creado por Central:SmiLanzadera)
 *
...
<p>Los datos pueden modificarse debido al manejo de los registros administrativos por parte de la Secretaria de Salud.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Mortalidad Infantil en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2009-12-31', dato: 6.1000 },{ fecha: '2010-12-31', dato: 8.9000 },{ fecha: '2011-12-31', dato: 6.7000 },{ fecha: '2012-12-31', dato: 12.2000 },{ fecha: '2013-12-31', dato: 12.4000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
