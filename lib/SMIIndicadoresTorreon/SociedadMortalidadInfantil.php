...
class SociedadMortalidadInfantil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslrpsyour">
...
Por cada mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsjmtwhsv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslrpsyour a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslrpsyour a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsjmtwhsv;
  ...
  function initmapsjmtwhsv() {
    // Nuevo Mapa
    mapsjmtwhsv = new L.Map('LeafLetsjmtwhsv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsjmtwhsv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsjmtwhsv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsjmtwhsv === 'undefined') {
    varinitmapsjmtwhsv = initmapsjmtwhsv();
  };
});
FINAL;
    } // constructor
