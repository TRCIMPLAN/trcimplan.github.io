<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Ocupación Hotelera (Creado por Central:SmiLanzadera)
 *
...
<p>Porcentaje del total de cuartos de hotel.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Ocupación Hotelera en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 52.9100 },{ fecha: '2009-12-31', dato: 44.3400 },{ fecha: '2010-12-31', dato: 42.2400 },{ fecha: '2011-12-31', dato: 42.2700 },{ fecha: '2012-12-31', dato: 47.0100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
