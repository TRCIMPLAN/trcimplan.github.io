...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskthzivlt">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqhrupmek" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskthzivlt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskthzivlt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqhrupmek;
  ...
  function initmapqhrupmek() {
    // Nuevo Mapa
    mapqhrupmek = new L.Map('LeafLetqhrupmek');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqhrupmek.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqhrupmek.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqhrupmek === 'undefined') {
    varinitmapqhrupmek = initmapqhrupmek();
  };
});
FINAL;
    } // constructor
