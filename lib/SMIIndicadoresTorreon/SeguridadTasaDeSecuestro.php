...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmkkiwpyq">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqfjtqhdp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmkkiwpyq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmkkiwpyq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqfjtqhdp;
  ...
  function initmapqfjtqhdp() {
    // Nuevo Mapa
    mapqfjtqhdp = new L.Map('LeafLetqfjtqhdp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqfjtqhdp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqfjtqhdp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqfjtqhdp === 'undefined') {
    varinitmapqfjtqhdp = initmapqfjtqhdp();
  };
});
FINAL;
    } // constructor
