...
class SeguridadTasaDeSecuestro extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasectljcsm">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzmkgjres" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasectljcsm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasectljcsm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzmkgjres;
  ...
  function initmapzmkgjres() {
    // Nuevo Mapa
    mapzmkgjres = new L.Map('LeafLetzmkgjres');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzmkgjres.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzmkgjres.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzmkgjres === 'undefined') {
    varinitmapzmkgjres = initmapzmkgjres();
  };
});
FINAL;
    } // constructor
