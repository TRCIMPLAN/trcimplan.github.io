...
class SociedadHogaresConJefaturaFemenina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslslotxid">
...
Consulta la [Base de Datos](http://www.inegi.org.mx/biinegi/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxgxmisoy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslslotxid a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslslotxid a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxgxmisoy;
  ...
  function initmapxgxmisoy() {
    // Nuevo Mapa
    mapxgxmisoy = new L.Map('LeafLetxgxmisoy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxgxmisoy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxgxmisoy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxgxmisoy === 'undefined') {
    varinitmapxgxmisoy = initmapxgxmisoy();
  };
});
FINAL;
    } // constructor
