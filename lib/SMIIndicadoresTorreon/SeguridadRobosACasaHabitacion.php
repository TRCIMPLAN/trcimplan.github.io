...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 70 },{ fecha: '2014-02-28', dato: 65 },{ fecha: '2014-03-31', dato: 73 },{ fecha: '2014-04-30', dato: 67 },{ fecha: '2014-05-31', dato: 108 },{ fecha: '2014-06-30', dato: 54 },{ fecha: '2014-07-31', dato: 58 },{ fecha: '2014-08-31', dato: 76 },{ fecha: '2014-09-30', dato: 81 },{ fecha: '2014-10-31', dato: 64 },{ fecha: '2014-11-30', dato: 44 },{ fecha: '2014-12-31', dato: 34 },{ fecha: '2015-01-31', dato: 67 },{ fecha: '2015-02-28', dato: 76 },{ fecha: '2015-03-31', dato: 42 },{ fecha: '2015-04-30', dato: 63 },{ fecha: '2015-05-31', dato: 64 },{ fecha: '2015-06-30', dato: 52 },{ fecha: '2015-07-31', dato: 65 },{ fecha: '2015-08-31', dato: 73 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
