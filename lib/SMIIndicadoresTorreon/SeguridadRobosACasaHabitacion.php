...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspkaucctj">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseumpmbzp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspkaucctj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspkaucctj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseumpmbzp === 'undefined') {
    varMorriseumpmbzp = Morris.Line({
      element: 'Morriseumpmbzp',
