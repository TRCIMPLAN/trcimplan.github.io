...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgwojpswo">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishibjxplu" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxbrqxrjp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgwojpswo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgwojpswo a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishibjxplu === 'undefined') {
    varMorrishibjxplu = Morris.Line({
      element: 'Morrishibjxplu',
      data: [{ fecha: '2014-01-31', dato: 70 },{ fecha: '2014-02-28', dato: 65 },{ fecha: '2014-03-31', dato: 73 },{ fecha: '2014-04-30', dato: 67 },{ fecha: '2014-05-31', dato: 108 },{ fecha: '2014-06-30', dato: 54 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetasgwojpswo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxbrqxrjp;
  ...
  function initmapxbrqxrjp() {
    // Nuevo Mapa
    mapxbrqxrjp = new L.Map('LeafLetxbrqxrjp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxbrqxrjp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxbrqxrjp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxbrqxrjp === 'undefined') {
    varinitmapxbrqxrjp = initmapxbrqxrjp();
  };
});
FINAL;
    } // constructor
