...
class SeguridadRobosACasaHabitacion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfjkyxdxn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswlsklwzh" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfjkyxdxn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfjkyxdxn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswlsklwzh === 'undefined') {
    varMorriswlsklwzh = Morris.Line({
      element: 'Morriswlsklwzh',
