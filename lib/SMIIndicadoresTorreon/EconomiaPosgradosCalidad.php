...
/**
 * Clase EconomiaPosgradosCalidad
 */
class EconomiaPosgradosCalidad extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaposgrados-calidad';
