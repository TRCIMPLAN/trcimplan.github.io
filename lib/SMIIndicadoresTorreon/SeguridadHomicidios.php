...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnwyobmfk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoqoxkluv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnwyobmfk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnwyobmfk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoqoxkluv === 'undefined') {
    varMorrisoqoxkluv = Morris.Line({
      element: 'Morrisoqoxkluv',
