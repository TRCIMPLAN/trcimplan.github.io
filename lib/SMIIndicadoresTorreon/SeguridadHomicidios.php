...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmekkxzfe">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjrrgfrbx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmekkxzfe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmekkxzfe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjrrgfrbx;
  ...
  function initmapjrrgfrbx() {
    // Nuevo Mapa
    mapjrrgfrbx = new L.Map('LeafLetjrrgfrbx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjrrgfrbx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjrrgfrbx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjrrgfrbx === 'undefined') {
    varinitmapjrrgfrbx = initmapjrrgfrbx();
  };
});
FINAL;
    } // constructor
