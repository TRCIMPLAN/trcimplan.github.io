...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyprukskh">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiaynpgwx" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdzwckzol" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyprukskh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyprukskh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiaynpgwx === 'undefined') {
    varMorrisiaynpgwx = Morris.Line({
      element: 'Morrisiaynpgwx',
...
// LENGUETA
$('#Lenguetasyprukskh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdzwckzol;
  ...
  function initmapdzwckzol() {
    // Nuevo Mapa
    mapdzwckzol = new L.Map('LeafLetdzwckzol');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdzwckzol.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdzwckzol.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdzwckzol === 'undefined') {
    varinitmapdzwckzol = initmapdzwckzol();
  };
});
FINAL;
    } // constructor
