...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasljhzjkme">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrhbyveod" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasljhzjkme a:first').tab('show')
});
// LENGUETA
$('#Lenguetasljhzjkme a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrhbyveod === 'undefined') {
    varMorrisrhbyveod = Morris.Line({
      element: 'Morrisrhbyveod',
