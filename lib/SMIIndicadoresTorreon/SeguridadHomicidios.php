...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswogetexi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismawuglzv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswogetexi a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswogetexi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismawuglzv === 'undefined') {
    varMorrismawuglzv = Morris.Line({
      element: 'Morrismawuglzv',
