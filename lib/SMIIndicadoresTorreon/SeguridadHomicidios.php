...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasumwjiyki">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgcmjhipb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasumwjiyki a:first').tab('show')
});
// LENGUETA
$('#Lenguetasumwjiyki a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgcmjhipb;
  ...
  function initmapgcmjhipb() {
    // Nuevo Mapa
    mapgcmjhipb = new L.Map('LeafLetgcmjhipb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgcmjhipb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgcmjhipb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgcmjhipb === 'undefined') {
    varinitmapgcmjhipb = initmapgcmjhipb();
  };
});
FINAL;
    } // constructor
