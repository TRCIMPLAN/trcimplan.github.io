...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgernsqxt">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetytdxlsae" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgernsqxt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgernsqxt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapytdxlsae;
  ...
  function initmapytdxlsae() {
    // Nuevo Mapa
    mapytdxlsae = new L.Map('LeafLetytdxlsae');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapytdxlsae.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapytdxlsae.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapytdxlsae === 'undefined') {
    varinitmapytdxlsae = initmapytdxlsae();
  };
});
FINAL;
    } // constructor
