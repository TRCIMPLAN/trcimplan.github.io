...
class SeguridadHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyyfuhpgu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrischbmdmdk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyyfuhpgu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyyfuhpgu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrischbmdmdk === 'undefined') {
    varMorrischbmdmdk = Morris.Line({
      element: 'Morrischbmdmdk',
