...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnsjphbxz">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqsmxdvxg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnsjphbxz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnsjphbxz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqsmxdvxg;
  ...
  function initmapqsmxdvxg() {
    // Nuevo Mapa
    mapqsmxdvxg = new L.Map('LeafLetqsmxdvxg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqsmxdvxg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqsmxdvxg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqsmxdvxg === 'undefined') {
    varinitmapqsmxdvxg = initmapqsmxdvxg();
  };
});
FINAL;
    } // constructor
