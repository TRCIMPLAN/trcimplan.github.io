...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdecnuxqi">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxphhobyt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdecnuxqi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdecnuxqi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxphhobyt;
  ...
  function initmapxphhobyt() {
    // Nuevo Mapa
    mapxphhobyt = new L.Map('LeafLetxphhobyt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxphhobyt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxphhobyt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxphhobyt === 'undefined') {
    varinitmapxphhobyt = initmapxphhobyt();
  };
});
FINAL;
    } // constructor
