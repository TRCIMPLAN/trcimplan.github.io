...
class SeguridadTasaDeHomicidios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfoqduoiy">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgofzmxgx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfoqduoiy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfoqduoiy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgofzmxgx;
  ...
  function initmapgofzmxgx() {
    // Nuevo Mapa
    mapgofzmxgx = new L.Map('LeafLetgofzmxgx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgofzmxgx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgofzmxgx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgofzmxgx === 'undefined') {
    varinitmapgofzmxgx = initmapgofzmxgx();
  };
});
FINAL;
    } // constructor
