<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sustentabilidad Economía Intensiva en Energía (Creado por Central:SmiLanzadera)
 *
...
Fuente: Petróleos Mexicanos (PEMEX) y estimaciones de IMCO con información del INEGI, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Economía Intensiva en Energía en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.9000 },{ fecha: '2009-12-31', dato: 2.8000 },{ fecha: '2010-12-31', dato: 2.8000 },{ fecha: '2011-12-31', dato: 2.8000 },{ fecha: '2012-12-31', dato: 2.6000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
