...
class SociedadPoblacionDerechohabiente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswwkkfgtq">
...
Fuente: INEGI
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbdqltpae" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswwkkfgtq a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswwkkfgtq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbdqltpae;
  ...
  function initmapbdqltpae() {
    // Nuevo Mapa
    mapbdqltpae = new L.Map('LeafLetbdqltpae');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbdqltpae.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbdqltpae.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbdqltpae === 'undefined') {
    varinitmapbdqltpae = initmapbdqltpae();
  };
});
FINAL;
    } // constructor
