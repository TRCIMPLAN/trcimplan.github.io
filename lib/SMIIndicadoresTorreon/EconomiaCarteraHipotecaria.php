...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspijylatb">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisevuxpksg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspijylatb a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspijylatb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisevuxpksg === 'undefined') {
    varMorrisevuxpksg = Morris.Line({
      element: 'Morrisevuxpksg',
