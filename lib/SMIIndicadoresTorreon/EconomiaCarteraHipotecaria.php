...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqokjkkeg">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvnfritgq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetveaxwmec" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqokjkkeg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqokjkkeg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvnfritgq === 'undefined') {
    varMorrisvnfritgq = Morris.Line({
      element: 'Morrisvnfritgq',
...
// LENGUETA
$('#Lenguetasqokjkkeg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapveaxwmec;
  ...
  function initmapveaxwmec() {
    // Nuevo Mapa
    mapveaxwmec = new L.Map('LeafLetveaxwmec');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapveaxwmec.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapveaxwmec.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapveaxwmec === 'undefined') {
    varinitmapveaxwmec = initmapveaxwmec();
  };
});
FINAL;
    } // constructor
