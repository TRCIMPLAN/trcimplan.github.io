<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Cartera Hipotecaria (Creado por Central:SmiLanzadera)
 *
    ...
    <div class="tab-pane" id="smi-indicador-datos">
      ...
      <table class="table table-hover table-bordered matriz">
        ...
        <tbody>
          <tr>
            <td>31/12/2010</td>
            <td>$ 3,479,653,828.00</td>
            <td>Comisión Nacional Bancaria y de Valores (CNBV)</td>
            <td></td>
          </tr>
          <tr>
            <td>31/12/2011</td>
            <td>$ 3,741,316,668.00</td>
            <td>Comisión Nacional Bancaria y de Valores (CNBV)</td>
            <td></td>
          </tr>
          <tr>
            <td>31/12/2012</td>
            <td>$ 4,027,766,032.00</td>
            <td>Comisión Nacional Bancaria y de Valores (CNBV)</td>
            <td></td>
          </tr>
          <tr>
            <td>31/12/2013</td>
            <td>$ 4,476,538,920.00</td>
            <td>Comisión Nacional Bancaria y de Valores (CNBV)</td>
            <td></td>
          </tr>
          <tr>
...
<p>Datos obtenidos de <a href="http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx">CNBV</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Cartera Hipotecaria en Torreón</h3>
