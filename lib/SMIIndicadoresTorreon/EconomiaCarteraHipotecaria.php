...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswmyomsnt">
...
Datos obtenidos de [CNBV](http://portafoliodeinformacion.cnbv.gob.mx/bm1/Paginas/carteravivienda.aspx)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispxgntcrk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswmyomsnt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswmyomsnt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispxgntcrk === 'undefined') {
    varMorrispxgntcrk = Morris.Line({
      element: 'Morrispxgntcrk',
