...
class EconomiaCarteraHipotecaria extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyugqlgas">
...
<div id="Morristqigskqm" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjgcebruk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyugqlgas a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyugqlgas a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristqigskqm === 'undefined') {
    varMorristqigskqm = Morris.Line({
      element: 'Morristqigskqm',
      data: [{ fecha: '2010-12-31', dato: 3479653828.0000 },{ fecha: '2011-12-31', dato: 3741316668.0000 },{ fecha: '2012-12-31', dato: 4027766032.0000 },{ fecha: '2013-12-31', dato: 4476538920.0000 },{ fecha: '2014-03-31', dato: 4664619926.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetasyugqlgas a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjgcebruk;
  ...
  function initmapjgcebruk() {
    // Nuevo Mapa
    mapjgcebruk = new L.Map('LeafLetjgcebruk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjgcebruk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjgcebruk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjgcebruk === 'undefined') {
    varinitmapjgcebruk = initmapjgcebruk();
  };
});
FINAL;
    } // constructor
