<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadPoblacionConIngresosInferioresALaLineaDeBienestarMinimo
 *
...
class SociedadPoblacionConIngresosInferioresALaLineaDeBienestarMinimo extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población con ingresos inferiores a la línea de bienestar mínimo en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '10.9000', 'fuente_nombre' => 'CONEVAL', 'notas' => 'La línea de bienestar mínimo para diciembre de 2015 es de $1,315.06 por persona al mes en el medio urbano')); // formateado 0, valor 2, crudo 2
    } // datos
