<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Empresa Socialmente Responsable (Creado por Central:SmiLanzadera)
 *
...
class SociedadEmpresaSocialmenteResponsable extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Empresa Socialmente Responsable en Torreón';
...
<p>Fuente: Centro Mexicano para la Filantropía (CEMEFI).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica-1">
      <h3>Gráfica de Empresa Socialmente Responsable en Torreón con fuente IMCO</h3>
