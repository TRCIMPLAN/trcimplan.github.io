...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqefiqwss">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetscendopi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqefiqwss a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqefiqwss a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapscendopi;
  ...
  function initmapscendopi() {
    // Nuevo Mapa
    mapscendopi = new L.Map('LeafLetscendopi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapscendopi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapscendopi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapscendopi === 'undefined') {
    varinitmapscendopi = initmapscendopi();
  };
});
FINAL;
    } // constructor
