...
class SeguridadPresuntosDelincuentesPorNarcoticos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszhhwcsaa">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqngwqnsh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszhhwcsaa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszhhwcsaa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqngwqnsh;
  ...
  function initmapqngwqnsh() {
    // Nuevo Mapa
    mapqngwqnsh = new L.Map('LeafLetqngwqnsh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqngwqnsh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqngwqnsh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqngwqnsh === 'undefined') {
    varinitmapqngwqnsh = initmapqngwqnsh();
  };
});
FINAL;
    } // constructor
