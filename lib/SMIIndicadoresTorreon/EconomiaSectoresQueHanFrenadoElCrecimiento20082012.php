...
class EconomiaSectoresQueHanFrenadoElCrecimiento20082012 extends \Base\Publicacion {
    ...
    public function __construct() {
        $this->nombre      = 'Sectores que Han Frenado el Crecimiento (2008-2012) en Torreón';
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyxywniwt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/) y [Centro de Estudios de las Finanzas Públicas](http://www.cefp.gob.mx/Pub_Macro_Estadisticas.htm)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlvtiojph" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyxywniwt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyxywniwt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplvtiojph;
  ...
  function initmaplvtiojph() {
    // Nuevo Mapa
    maplvtiojph = new L.Map('LeafLetlvtiojph');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplvtiojph.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplvtiojph.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplvtiojph === 'undefined') {
    varinitmaplvtiojph = initmaplvtiojph();
  };
});
FINAL;
    } // constructor
