...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrkplymla">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispbevaroa" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbvutbgle" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrkplymla a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrkplymla a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispbevaroa === 'undefined') {
    varMorrispbevaroa = Morris.Line({
      element: 'Morrispbevaroa',
...
// LENGUETA
$('#Lenguetasrkplymla a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbvutbgle;
  ...
  function initmapbvutbgle() {
    // Nuevo Mapa
    mapbvutbgle = new L.Map('LeafLetbvutbgle');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbvutbgle.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbvutbgle.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbvutbgle === 'undefined') {
    varinitmapbvutbgle = initmapbvutbgle();
  };
});
FINAL;
    } // constructor
