...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgqqywpas">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoncqjqtz" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvfblnzpl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgqqywpas a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgqqywpas a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoncqjqtz === 'undefined') {
    varMorrisoncqjqtz = Morris.Line({
      element: 'Morrisoncqjqtz',
...
// LENGUETA
$('#Lenguetasgqqywpas a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvfblnzpl;
  ...
  function initmapvfblnzpl() {
    // Nuevo Mapa
    mapvfblnzpl = new L.Map('LeafLetvfblnzpl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvfblnzpl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvfblnzpl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvfblnzpl === 'undefined') {
    varinitmapvfblnzpl = initmapvfblnzpl();
  };
});
FINAL;
    } // constructor
