...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqktqaumh">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszoaqhnta" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqktqaumh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqktqaumh a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszoaqhnta === 'undefined') {
    varMorriszoaqhnta = Morris.Line({
      element: 'Morriszoaqhnta',
