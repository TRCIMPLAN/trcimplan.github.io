...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspowgpjpc">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristrcfvzqk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspowgpjpc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspowgpjpc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristrcfvzqk === 'undefined') {
    varMorristrcfvzqk = Morris.Line({
      element: 'Morristrcfvzqk',
