...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyurbxxbp">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxofcurdw" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbhpnrbnh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyurbxxbp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyurbxxbp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxofcurdw === 'undefined') {
    varMorrisxofcurdw = Morris.Line({
      element: 'Morrisxofcurdw',
...
// LENGUETA
$('#Lenguetasyurbxxbp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbhpnrbnh;
  ...
  function initmapbhpnrbnh() {
    // Nuevo Mapa
    mapbhpnrbnh = new L.Map('LeafLetbhpnrbnh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbhpnrbnh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbhpnrbnh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbhpnrbnh === 'undefined') {
    varinitmapbhpnrbnh = initmapbhpnrbnh();
  };
});
FINAL;
    } // constructor
