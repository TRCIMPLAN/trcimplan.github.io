...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastjvynaaa">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisondsolzy" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkomgubwy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastjvynaaa a:first').tab('show')
});
// LENGUETA
$('#Lenguetastjvynaaa a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisondsolzy === 'undefined') {
    varMorrisondsolzy = Morris.Line({
      element: 'Morrisondsolzy',
...
// LENGUETA
$('#Lenguetastjvynaaa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkomgubwy;
  ...
  function initmapkomgubwy() {
    // Nuevo Mapa
    mapkomgubwy = new L.Map('LeafLetkomgubwy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkomgubwy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkomgubwy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkomgubwy === 'undefined') {
    varinitmapkomgubwy = initmapkomgubwy();
  };
});
FINAL;
    } // constructor
