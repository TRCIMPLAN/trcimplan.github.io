...
class EconomiaUnidadesEconomicasDedicadasAlComercio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszvlfdoog">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjudhhkya" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmgbfnhjd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszvlfdoog a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszvlfdoog a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjudhhkya === 'undefined') {
    varMorrisjudhhkya = Morris.Line({
      element: 'Morrisjudhhkya',
...
// LENGUETA
$('#Lenguetaszvlfdoog a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmgbfnhjd;
  ...
  function initmapmgbfnhjd() {
    // Nuevo Mapa
    mapmgbfnhjd = new L.Map('LeafLetmgbfnhjd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmgbfnhjd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmgbfnhjd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmgbfnhjd === 'undefined') {
    varinitmapmgbfnhjd = initmapmgbfnhjd();
  };
});
FINAL;
    } // constructor
