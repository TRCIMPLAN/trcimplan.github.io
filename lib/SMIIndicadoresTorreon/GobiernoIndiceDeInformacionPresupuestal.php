<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Índice de Información Presupuestal (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 25.8065 },{ fecha: '2009-12-31', dato: 25.8065 },{ fecha: '2010-12-31', dato: 0.0000 },{ fecha: '2011-12-31', dato: 3.2258 },{ fecha: '2012-12-31', dato: 17.6471 },{ fecha: '2013-12-31', dato: 22.0000 },{ fecha: '2014-12-31', dato: 93.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
