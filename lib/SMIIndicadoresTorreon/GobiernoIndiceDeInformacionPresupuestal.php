...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasngvpkhvz">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetigwfloxk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasngvpkhvz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasngvpkhvz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapigwfloxk;
  ...
  function initmapigwfloxk() {
    // Nuevo Mapa
    mapigwfloxk = new L.Map('LeafLetigwfloxk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapigwfloxk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapigwfloxk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapigwfloxk === 'undefined') {
    varinitmapigwfloxk = initmapigwfloxk();
  };
});
FINAL;
    } // constructor
