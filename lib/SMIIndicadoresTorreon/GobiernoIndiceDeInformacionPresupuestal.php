...
class GobiernoIndiceDeInformacionPresupuestal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastgbhirjf">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqadixwtz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastgbhirjf a:first').tab('show')
});
// LENGUETA
$('#Lenguetastgbhirjf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqadixwtz;
  ...
  function initmapqadixwtz() {
    // Nuevo Mapa
    mapqadixwtz = new L.Map('LeafLetqadixwtz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqadixwtz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqadixwtz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqadixwtz === 'undefined') {
    varinitmapqadixwtz = initmapqadixwtz();
  };
});
FINAL;
    } // constructor
