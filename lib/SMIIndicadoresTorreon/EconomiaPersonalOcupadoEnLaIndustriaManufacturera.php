...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasskeuoabr">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswnviugeg" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetewkdjzlp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasskeuoabr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasskeuoabr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswnviugeg === 'undefined') {
    varMorriswnviugeg = Morris.Line({
      element: 'Morriswnviugeg',
...
// LENGUETA
$('#Lenguetasskeuoabr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapewkdjzlp;
  ...
  function initmapewkdjzlp() {
    // Nuevo Mapa
    mapewkdjzlp = new L.Map('LeafLetewkdjzlp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapewkdjzlp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapewkdjzlp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapewkdjzlp === 'undefined') {
    varinitmapewkdjzlp = initmapewkdjzlp();
  };
});
FINAL;
    } // constructor
