...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmvghurjs">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisirdsrspn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxsphsghe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmvghurjs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmvghurjs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisirdsrspn === 'undefined') {
    varMorrisirdsrspn = Morris.Line({
      element: 'Morrisirdsrspn',
...
// LENGUETA
$('#Lenguetasmvghurjs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxsphsghe;
  ...
  function initmapxsphsghe() {
    // Nuevo Mapa
    mapxsphsghe = new L.Map('LeafLetxsphsghe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxsphsghe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxsphsghe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxsphsghe === 'undefined') {
    varinitmapxsphsghe = initmapxsphsghe();
  };
});
FINAL;
    } // constructor
