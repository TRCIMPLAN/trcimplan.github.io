...
/**
 * Clase EconomiaAperturaNegocios
 */
class EconomiaAperturaNegocios extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaapertura-negocios';
