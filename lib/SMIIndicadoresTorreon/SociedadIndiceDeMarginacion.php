<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Índice de Marginación (Creado por Central:SmiLanzadera)
 *
...
<p>Menos es menor grado de marginación</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Índice de Marginación en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '1990-12-31', dato: -1.9980 },{ fecha: '1995-12-31', dato: -1.7440 },{ fecha: '2000-12-31', dato: -1.9830 },{ fecha: '2005-12-31', dato: -1.8930 },{ fecha: '2015-12-31', dato: -1.7220 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
