...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjhlpumsu">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisarodsehq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjhlpumsu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjhlpumsu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisarodsehq === 'undefined') {
    varMorrisarodsehq = Morris.Line({
      element: 'Morrisarodsehq',
