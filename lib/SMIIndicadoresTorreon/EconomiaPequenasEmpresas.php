...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqgydppwz">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqeqyqngs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfzyeaqvf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqgydppwz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqgydppwz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqeqyqngs === 'undefined') {
    varMorrisqeqyqngs = Morris.Line({
      element: 'Morrisqeqyqngs',
...
// LENGUETA
$('#Lenguetasqgydppwz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfzyeaqvf;
  ...
  function initmapfzyeaqvf() {
    // Nuevo Mapa
    mapfzyeaqvf = new L.Map('LeafLetfzyeaqvf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfzyeaqvf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfzyeaqvf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfzyeaqvf === 'undefined') {
    varinitmapfzyeaqvf = initmapfzyeaqvf();
  };
});
FINAL;
    } // constructor
