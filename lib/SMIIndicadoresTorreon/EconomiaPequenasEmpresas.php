...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgzdcwwdq">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswydhfabw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgzdcwwdq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgzdcwwdq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswydhfabw === 'undefined') {
    varMorriswydhfabw = Morris.Line({
      element: 'Morriswydhfabw',
