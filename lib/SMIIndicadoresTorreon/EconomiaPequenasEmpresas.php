...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashjngdqrc">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskydjjwdq" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfzfgmtse" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashjngdqrc a:first').tab('show')
});
// LENGUETA
$('#Lenguetashjngdqrc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskydjjwdq === 'undefined') {
    varMorriskydjjwdq = Morris.Line({
      element: 'Morriskydjjwdq',
...
// LENGUETA
$('#Lenguetashjngdqrc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfzfgmtse;
  ...
  function initmapfzfgmtse() {
    // Nuevo Mapa
    mapfzfgmtse = new L.Map('LeafLetfzfgmtse');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfzfgmtse.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfzfgmtse.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfzfgmtse === 'undefined') {
    varinitmapfzfgmtse = initmapfzfgmtse();
  };
});
FINAL;
    } // constructor
