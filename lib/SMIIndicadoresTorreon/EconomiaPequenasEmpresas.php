...
class EconomiaPequenasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgsfudasi">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiovndnjp" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetidexldig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgsfudasi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgsfudasi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiovndnjp === 'undefined') {
    varMorrisiovndnjp = Morris.Line({
      element: 'Morrisiovndnjp',
...
// LENGUETA
$('#Lenguetasgsfudasi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapidexldig;
  ...
  function initmapidexldig() {
    // Nuevo Mapa
    mapidexldig = new L.Map('LeafLetidexldig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapidexldig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapidexldig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapidexldig === 'undefined') {
    varinitmapidexldig = initmapidexldig();
  };
});
FINAL;
    } // constructor
