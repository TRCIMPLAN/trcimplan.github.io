...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaxkmeaiq">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqmzzsbuu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaxkmeaiq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaxkmeaiq a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqmzzsbuu === 'undefined') {
    varMorrisqmzzsbuu = Morris.Line({
      element: 'Morrisqmzzsbuu',
