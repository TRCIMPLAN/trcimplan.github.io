...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbpofcbsw">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisyaorjpfu" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkflyomcb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbpofcbsw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbpofcbsw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisyaorjpfu === 'undefined') {
    varMorrisyaorjpfu = Morris.Line({
      element: 'Morrisyaorjpfu',
      data: [{ fecha: '2014-01-31', dato: 123 },{ fecha: '2014-02-28', dato: 147 },{ fecha: '2014-03-31', dato: 87 },{ fecha: '2014-04-30', dato: 95 },{ fecha: '2014-05-31', dato: 138 },{ fecha: '2014-06-30', dato: 98 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
// LENGUETA
$('#Lenguetasbpofcbsw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkflyomcb;
  ...
  function initmapkflyomcb() {
    // Nuevo Mapa
    mapkflyomcb = new L.Map('LeafLetkflyomcb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkflyomcb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkflyomcb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkflyomcb === 'undefined') {
    varinitmapkflyomcb = initmapkflyomcb();
  };
});
FINAL;
    } // constructor
