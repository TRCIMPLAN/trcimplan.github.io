...
class SeguridadRoboANegocios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvptvaotu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvoabvjsm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvptvaotu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvptvaotu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvoabvjsm === 'undefined') {
    varMorrisvoabvjsm = Morris.Line({
      element: 'Morrisvoabvjsm',
