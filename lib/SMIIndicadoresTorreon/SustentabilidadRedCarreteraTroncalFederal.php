...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasupcxftyd">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvdqqbimi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasupcxftyd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasupcxftyd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvdqqbimi;
  ...
  function initmapvdqqbimi() {
    // Nuevo Mapa
    mapvdqqbimi = new L.Map('LeafLetvdqqbimi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvdqqbimi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvdqqbimi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvdqqbimi === 'undefined') {
    varinitmapvdqqbimi = initmapvdqqbimi();
  };
});
FINAL;
    } // constructor
