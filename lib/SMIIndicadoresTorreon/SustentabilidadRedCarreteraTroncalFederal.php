...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrultpwsr">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmoowyhxd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrultpwsr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrultpwsr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmoowyhxd;
  ...
  function initmapmoowyhxd() {
    // Nuevo Mapa
    mapmoowyhxd = new L.Map('LeafLetmoowyhxd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmoowyhxd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmoowyhxd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmoowyhxd === 'undefined') {
    varinitmapmoowyhxd = initmapmoowyhxd();
  };
});
FINAL;
    } // constructor
