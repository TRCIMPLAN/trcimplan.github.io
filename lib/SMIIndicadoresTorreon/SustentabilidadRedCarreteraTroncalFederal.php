...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasksyzqzxo">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvfiuvbad" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasksyzqzxo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasksyzqzxo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvfiuvbad;
  ...
  function initmapvfiuvbad() {
    // Nuevo Mapa
    mapvfiuvbad = new L.Map('LeafLetvfiuvbad');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvfiuvbad.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvfiuvbad.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvfiuvbad === 'undefined') {
    varinitmapvfiuvbad = initmapvfiuvbad();
  };
});
FINAL;
    } // constructor
