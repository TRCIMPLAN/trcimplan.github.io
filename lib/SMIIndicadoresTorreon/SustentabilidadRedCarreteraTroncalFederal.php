...
class SustentabilidadRedCarreteraTroncalFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasesfttlys">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetekbaetie" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasesfttlys a:first').tab('show')
});
// LENGUETA
$('#Lenguetasesfttlys a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapekbaetie;
  ...
  function initmapekbaetie() {
    // Nuevo Mapa
    mapekbaetie = new L.Map('LeafLetekbaetie');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapekbaetie.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapekbaetie.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapekbaetie === 'undefined') {
    varinitmapekbaetie = initmapekbaetie();
  };
});
FINAL;
    } // constructor
