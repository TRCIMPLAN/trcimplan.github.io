<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sustentabilidad Red Carretera Troncal Federal (Creado por Central:SmiLanzadera)
 *
...
<p>No aplica a nivel metropolitano.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Red Carretera Troncal Federal en Torreón</h3>
