<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Promedio de horas para la realización de trámite de carta de no adeudo predial (Creado por Central:SmiLanzadera)
 *
...
/**
 * Clase GobiernoPromedioDeHorasParaLaRealizacionDeTramiteDeCartaDeNoAdeudoPredial
 */
class GobiernoPromedioDeHorasParaLaRealizacionDeTramiteDeCartaDeNoAdeudoPredial extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Promedio de horas para la realización de trámite de carta de no adeudo predial en Torreón';
     // $this->autor             = '';
        $this->fecha             = '2015-07-14T17:33';
        // El nombre del archivo a crear (obligatorio) y rutas relativas a las imágenes. Use minúsculas, números y/o guiones medios
        $this->archivo           = 'gobierno-promedio-de-horas-para-la-realizacion-de-tramite-de-carta-de-no-adeudo-predial';
