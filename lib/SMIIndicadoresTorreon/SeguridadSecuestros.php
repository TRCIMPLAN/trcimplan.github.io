...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdheyetrf">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrispvobvaul" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdheyetrf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdheyetrf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrispvobvaul === 'undefined') {
    varMorrispvobvaul = Morris.Line({
      element: 'Morrispvobvaul',
