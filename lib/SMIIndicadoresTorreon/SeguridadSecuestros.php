...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasitqzqisq">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcdpfreni" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasitqzqisq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasitqzqisq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcdpfreni;
  ...
  function initmapcdpfreni() {
    // Nuevo Mapa
    mapcdpfreni = new L.Map('LeafLetcdpfreni');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcdpfreni.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcdpfreni.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcdpfreni === 'undefined') {
    varinitmapcdpfreni = initmapcdpfreni();
  };
});
FINAL;
    } // constructor
