...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasspspsqcp">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbvzmryud" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasspspsqcp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasspspsqcp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbvzmryud === 'undefined') {
    varMorrisbvzmryud = Morris.Line({
      element: 'Morrisbvzmryud',
