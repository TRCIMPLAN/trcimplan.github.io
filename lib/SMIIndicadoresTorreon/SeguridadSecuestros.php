...
class SeguridadSecuestros extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswkeyvrjl">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriszuscepsc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswkeyvrjl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswkeyvrjl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszuscepsc === 'undefined') {
    varMorriszuscepsc = Morris.Line({
      element: 'Morriszuscepsc',
