...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiuvotide">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisirbxxfnq" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiuvotide a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiuvotide a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisirbxxfnq === 'undefined') {
    varMorrisirbxxfnq = Morris.Line({
      element: 'Morrisirbxxfnq',
