...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasglkvcodz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismfamhlaw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasglkvcodz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasglkvcodz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismfamhlaw === 'undefined') {
    varMorrismfamhlaw = Morris.Line({
      element: 'Morrismfamhlaw',
