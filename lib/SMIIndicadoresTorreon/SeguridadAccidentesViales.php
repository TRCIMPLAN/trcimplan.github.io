...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxjuztacl">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdwjdshzk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxjuztacl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxjuztacl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdwjdshzk === 'undefined') {
    varMorrisdwjdshzk = Morris.Line({
      element: 'Morrisdwjdshzk',
