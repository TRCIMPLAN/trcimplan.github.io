...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmuugbahd">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrrbvnbxb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjpcwjnxf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmuugbahd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmuugbahd a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrrbvnbxb === 'undefined') {
    varMorrisrrbvnbxb = Morris.Line({
      element: 'Morrisrrbvnbxb',
...
// LENGUETA
$('#Lenguetasmuugbahd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjpcwjnxf;
  ...
  function initmapjpcwjnxf() {
    // Nuevo Mapa
    mapjpcwjnxf = new L.Map('LeafLetjpcwjnxf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjpcwjnxf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjpcwjnxf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjpcwjnxf === 'undefined') {
    varinitmapjpcwjnxf = initmapjpcwjnxf();
  };
});
FINAL;
    } // constructor
