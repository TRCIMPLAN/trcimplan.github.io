...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxnuzszlm">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskmipottv" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcxmftlcy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxnuzszlm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxnuzszlm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskmipottv === 'undefined') {
    varMorriskmipottv = Morris.Line({
      element: 'Morriskmipottv',
...
// LENGUETA
$('#Lenguetasxnuzszlm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcxmftlcy;
  ...
  function initmapcxmftlcy() {
    // Nuevo Mapa
    mapcxmftlcy = new L.Map('LeafLetcxmftlcy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcxmftlcy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcxmftlcy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcxmftlcy === 'undefined') {
    varinitmapcxmftlcy = initmapcxmftlcy();
  };
});
FINAL;
    } // constructor
