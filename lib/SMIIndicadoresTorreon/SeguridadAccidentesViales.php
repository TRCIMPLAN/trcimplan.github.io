...
class SeguridadAccidentesViales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnrbpeauf">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfdjuzrtt" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnrbpeauf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnrbpeauf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfdjuzrtt === 'undefined') {
    varMorrisfdjuzrtt = Morris.Line({
      element: 'Morrisfdjuzrtt',
