<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Grandes Empresas (según CNN Expansión) (Creado por Central:SmiLanzadera)
 *
...
class EconomiaGrandesEmpresasSegunCnnExpansion extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Grandes Empresas (según CNN Expansión) en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 0.1141 },{ fecha: '2009-12-31', dato: 0.1186 },{ fecha: '2010-12-31', dato: 0.1184 },{ fecha: '2011-12-31', dato: 0.1197 },{ fecha: '2012-12-31', dato: 0.1205 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
