...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasexbchhtk">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoyqfieiw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasexbchhtk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasexbchhtk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoyqfieiw === 'undefined') {
    varMorrisoyqfieiw = Morris.Line({
      element: 'Morrisoyqfieiw',
