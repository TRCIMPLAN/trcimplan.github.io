...
class SociedadAdultosMayoresFemenino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqutecln">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuztqvfld" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqutecln a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqutecln a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuztqvfld === 'undefined') {
    varMorrisuztqvfld = Morris.Line({
      element: 'Morrisuztqvfld',
