...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqoilbcxc">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisoyplvvqw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqoilbcxc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqoilbcxc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisoyplvvqw === 'undefined') {
    varMorrisoyplvvqw = Morris.Line({
      element: 'Morrisoyplvvqw',
