...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasykuztqon">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisztulsscb" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasykuztqon a:first').tab('show')
});
// LENGUETA
$('#Lenguetasykuztqon a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisztulsscb === 'undefined') {
    varMorrisztulsscb = Morris.Line({
      element: 'Morrisztulsscb',
