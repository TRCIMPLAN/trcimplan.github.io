...
class EconomiaTotalDeEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmzslpbcz">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswvqrmxmw" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmzslpbcz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmzslpbcz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswvqrmxmw === 'undefined') {
    varMorriswvqrmxmw = Morris.Line({
      element: 'Morriswvqrmxmw',
