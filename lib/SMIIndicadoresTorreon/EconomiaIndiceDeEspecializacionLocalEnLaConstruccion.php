...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiktblxeq">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetloulhhql" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiktblxeq a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiktblxeq a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maploulhhql;
  ...
  function initmaploulhhql() {
    // Nuevo Mapa
    maploulhhql = new L.Map('LeafLetloulhhql');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maploulhhql.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maploulhhql.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaploulhhql === 'undefined') {
    varinitmaploulhhql = initmaploulhhql();
  };
});
FINAL;
    } // constructor
