...
class EconomiaIndiceDeEspecializacionLocalEnLaConstruccion extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoojjiwmi">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetquzuudzk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoojjiwmi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoojjiwmi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapquzuudzk;
  ...
  function initmapquzuudzk() {
    // Nuevo Mapa
    mapquzuudzk = new L.Map('LeafLetquzuudzk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapquzuudzk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapquzuudzk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapquzuudzk === 'undefined') {
    varinitmapquzuudzk = initmapquzuudzk();
  };
});
FINAL;
    } // constructor
