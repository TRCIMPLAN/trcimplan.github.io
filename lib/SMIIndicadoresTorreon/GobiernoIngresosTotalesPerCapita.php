...
class GobiernoIngresosTotalesPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszhozznrs">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriscwgtckgc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszhozznrs a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszhozznrs a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriscwgtckgc === 'undefined') {
    varMorriscwgtckgc = Morris.Line({
      element: 'Morriscwgtckgc',
