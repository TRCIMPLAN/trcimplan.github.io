 ...
 */
class EconomiaPromedioDeHorasParaLaRealizacionDelTramiteDeLicenciaParaNegocio extends \Base\Publicacion {
    ...
    public function __construct() {
     ...
     // $this->autor             = '';
        ...
        $this->claves            = 'IMPLAN, Torreón, SINDES, Gobierno, Empresas';
        $this->categorias        = array('SINDES', 'Gobierno', 'Empresas');
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Determina el número de horas requeridas para la realización del trámite de licencia para negocios. Número de Horas Empleadas para el Trámite de Licencias para Negocios, entre Número de Licencias para Negocios Otorgadas.</p>
