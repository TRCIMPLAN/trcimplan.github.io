...
class EconomiaTasaDeCondicionesCriticasDeOcupacion extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Tasa de Condiciones Críticas de Ocupación en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2016-03-31', dato: 8.7700 },{ fecha: '2016-09-30', dato: 11.5900 },{ fecha: '2016-12-31', dato: 30.3900 },{ fecha: '2017-03-31', dato: 10.4000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
