...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastenngqna">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetkomqomzp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastenngqna a:first').tab('show')
});
// LENGUETA
$('#Lenguetastenngqna a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapkomqomzp;
  ...
  function initmapkomqomzp() {
    // Nuevo Mapa
    mapkomqomzp = new L.Map('LeafLetkomqomzp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapkomqomzp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapkomqomzp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapkomqomzp === 'undefined') {
    varinitmapkomqomzp = initmapkomqomzp();
  };
});
FINAL;
    } // constructor
