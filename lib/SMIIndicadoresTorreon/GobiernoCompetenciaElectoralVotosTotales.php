...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbqjrcayx">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdkbwopew" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbqjrcayx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbqjrcayx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdkbwopew;
  ...
  function initmapdkbwopew() {
    // Nuevo Mapa
    mapdkbwopew = new L.Map('LeafLetdkbwopew');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdkbwopew.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdkbwopew.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdkbwopew === 'undefined') {
    varinitmapdkbwopew = initmapdkbwopew();
  };
});
FINAL;
    } // constructor
