<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Competencia Electoral Votos Totales (Creado por Central:SmiLanzadera)
 *
...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Competencia Electoral Votos Totales en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-07-01', dato: 246044 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
