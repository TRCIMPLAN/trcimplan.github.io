...
class GobiernoCompetenciaElectoralVotosTotales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasebpbobad">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdqamgpzr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasebpbobad a:first').tab('show')
});
// LENGUETA
$('#Lenguetasebpbobad a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdqamgpzr;
  ...
  function initmapdqamgpzr() {
    // Nuevo Mapa
    mapdqamgpzr = new L.Map('LeafLetdqamgpzr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdqamgpzr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdqamgpzr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdqamgpzr === 'undefined') {
    varinitmapdqamgpzr = initmapdqamgpzr();
  };
});
FINAL;
    } // constructor
