<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadTasaDeSuicidios
 *
...
class SociedadTasaDeSuicidios extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Tasa de suicidios en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '37', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 se uso el dato "cantidad" de muertes por suicidio')); // formateado 0, valor 2, crudo 2
    } // datos
