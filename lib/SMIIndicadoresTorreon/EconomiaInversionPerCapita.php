...
class EconomiaInversionPerCapita extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasirqnwfhg">
...
<div id="Morrisnlfuijyc" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmkaxkeca" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasirqnwfhg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasirqnwfhg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnlfuijyc === 'undefined') {
    varMorrisnlfuijyc = Morris.Line({
      element: 'Morrisnlfuijyc',
...
// LENGUETA
$('#Lenguetasirqnwfhg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmkaxkeca;
  ...
  function initmapmkaxkeca() {
    // Nuevo Mapa
    mapmkaxkeca = new L.Map('LeafLetmkaxkeca');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmkaxkeca.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmkaxkeca.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmkaxkeca === 'undefined') {
    varinitmapmkaxkeca = initmapmkaxkeca();
  };
});
FINAL;
    } // constructor
