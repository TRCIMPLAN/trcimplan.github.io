<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadUsoDeAutomovilParticular
 *
...
class SustentabilidadUsoDeAutomovilParticular extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Uso de Automóvil Particular en Torreón';
        ...
        $this->claves      = 'IMPLAN, Torreón, Medio Ambiente, Movilidad, Sector Automotriz, Vialidad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '157163', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 cambió a "cantidad" de Personas que viajan en automóvil particular para ir al trabajo/escuela')); // formateado 0, valor 2, crudo 2
    } // datos
