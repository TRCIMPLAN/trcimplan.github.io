<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadProporcionDeViviendasConRecoleccionDeBasura
 *
...
class SustentabilidadProporcionDeViviendasConRecoleccionDeBasura extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Proporción de viviendas con recolección de basura en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '97.5900', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda'),
            array('fecha' => '2015-12-31', 'valor' => '98.8600', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 4, crudo 2
    } // datos
