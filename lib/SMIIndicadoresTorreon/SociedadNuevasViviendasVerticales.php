<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadNuevasViviendasVerticales
 *
...
class SociedadNuevasViviendasVerticales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Nuevas viviendas verticales en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '2.6200', 'fuente_nombre' => 'IMCO')); // formateado 0, valor 2, crudo 1
    } // datos
