...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasshmapxut">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrffxcnkc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasshmapxut a:first').tab('show')
});
// LENGUETA
$('#Lenguetasshmapxut a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrffxcnkc === 'undefined') {
    varMorrisrffxcnkc = Morris.Line({
      element: 'Morrisrffxcnkc',
