...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasisgnxxiz">
...
<div id="Morriseaidbzko" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettfvzkduc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasisgnxxiz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasisgnxxiz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseaidbzko === 'undefined') {
    varMorriseaidbzko = Morris.Line({
      element: 'Morriseaidbzko',
...
// LENGUETA
$('#Lenguetasisgnxxiz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptfvzkduc;
  ...
  function initmaptfvzkduc() {
    // Nuevo Mapa
    maptfvzkduc = new L.Map('LeafLettfvzkduc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptfvzkduc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptfvzkduc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptfvzkduc === 'undefined') {
    varinitmaptfvzkduc = initmaptfvzkduc();
  };
});
FINAL;
    } // constructor
