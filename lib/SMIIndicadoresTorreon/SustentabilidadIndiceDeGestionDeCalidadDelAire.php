<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sustentabilidad Índice de Gestión de Calidad del Aire (Creado por Central:SmiLanzadera)
 *
...
Fuente: IMCO, con información al 2013.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Índice de Gestión de Calidad del Aire en Torreón</h3>
