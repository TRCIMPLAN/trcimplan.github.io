...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashhnvgjar">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmxutuirw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashhnvgjar a:first').tab('show')
});
// LENGUETA
$('#Lenguetashhnvgjar a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmxutuirw;
  ...
  function initmapmxutuirw() {
    // Nuevo Mapa
    mapmxutuirw = new L.Map('LeafLetmxutuirw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmxutuirw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmxutuirw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmxutuirw === 'undefined') {
    varinitmapmxutuirw = initmapmxutuirw();
  };
});
FINAL;
    } // constructor
