...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasarniemgg">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgcctlfgg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasarniemgg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasarniemgg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgcctlfgg;
  ...
  function initmapgcctlfgg() {
    // Nuevo Mapa
    mapgcctlfgg = new L.Map('LeafLetgcctlfgg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgcctlfgg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgcctlfgg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgcctlfgg === 'undefined') {
    varinitmapgcctlfgg = initmapgcctlfgg();
  };
});
FINAL;
    } // constructor
