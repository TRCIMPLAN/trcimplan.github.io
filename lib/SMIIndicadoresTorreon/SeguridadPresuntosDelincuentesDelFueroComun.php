...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvavlgrik">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqfmbeamy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvavlgrik a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvavlgrik a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqfmbeamy;
  ...
  function initmapqfmbeamy() {
    // Nuevo Mapa
    mapqfmbeamy = new L.Map('LeafLetqfmbeamy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqfmbeamy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqfmbeamy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqfmbeamy === 'undefined') {
    varinitmapqfmbeamy = initmapqfmbeamy();
  };
});
FINAL;
    } // constructor
