...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgwlewrif">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjamornlm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgwlewrif a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgwlewrif a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjamornlm;
  ...
  function initmapjamornlm() {
    // Nuevo Mapa
    mapjamornlm = new L.Map('LeafLetjamornlm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjamornlm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjamornlm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjamornlm === 'undefined') {
    varinitmapjamornlm = initmapjamornlm();
  };
});
FINAL;
    } // constructor
