...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfboxsmrk">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuczfvakb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfboxsmrk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfboxsmrk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuczfvakb;
  ...
  function initmapuczfvakb() {
    // Nuevo Mapa
    mapuczfvakb = new L.Map('LeafLetuczfvakb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuczfvakb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuczfvakb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuczfvakb === 'undefined') {
    varinitmapuczfvakb = initmapuczfvakb();
  };
});
FINAL;
    } // constructor
