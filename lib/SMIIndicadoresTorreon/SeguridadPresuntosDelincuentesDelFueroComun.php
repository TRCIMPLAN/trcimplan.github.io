...
class SeguridadPresuntosDelincuentesDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuykcxvkd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyxnfgchv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuykcxvkd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuykcxvkd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyxnfgchv;
  ...
  function initmapyxnfgchv() {
    // Nuevo Mapa
    mapyxnfgchv = new L.Map('LeafLetyxnfgchv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyxnfgchv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyxnfgchv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyxnfgchv === 'undefined') {
    varinitmapyxnfgchv = initmapyxnfgchv();
  };
});
FINAL;
    } // constructor
