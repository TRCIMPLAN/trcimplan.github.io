...
class SociedadIndiceDeDesarrolloHumanoIdh extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyeyyzttv">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaantsnjl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyeyyzttv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyeyyzttv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaantsnjl;
  ...
  function initmapaantsnjl() {
    // Nuevo Mapa
    mapaantsnjl = new L.Map('LeafLetaantsnjl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaantsnjl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaantsnjl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaantsnjl === 'undefined') {
    varinitmapaantsnjl = initmapaantsnjl();
  };
});
FINAL;
    } // constructor
