...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasavxogrzc">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoujoasgu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasavxogrzc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasavxogrzc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoujoasgu;
  ...
  function initmapoujoasgu() {
    // Nuevo Mapa
    mapoujoasgu = new L.Map('LeafLetoujoasgu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoujoasgu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoujoasgu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoujoasgu === 'undefined') {
    varinitmapoujoasgu = initmapoujoasgu();
  };
});
FINAL;
    } // constructor
