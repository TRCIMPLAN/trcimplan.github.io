...
class GobiernoCompetenciaElectoralDiferenciaDeVotos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasflksxeyi">
...
Cantidad de votos
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetriqdofcl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasflksxeyi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasflksxeyi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapriqdofcl;
  ...
  function initmapriqdofcl() {
    // Nuevo Mapa
    mapriqdofcl = new L.Map('LeafLetriqdofcl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapriqdofcl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapriqdofcl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapriqdofcl === 'undefined') {
    varinitmapriqdofcl = initmapriqdofcl();
  };
});
FINAL;
    } // constructor
