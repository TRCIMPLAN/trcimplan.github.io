<?php
/**
 * EconomiaObtencionCreditoCreacionGarantias.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaObtencionCreditoCreacionGarantias
 */
class EconomiaObtencionCreditoCreacionGarantias extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaobtencion-credito-creacion-garantias';
...
- Ranking en crear una garantía: 6</td>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Obtención de crédito - Creación de garantías</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
