<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Personas por Debajo de la Línea de Bienestar (Creado por Central:SmiLanzadera)
 *
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.3000 },{ fecha: '2009-12-31', dato: 2.0400 },{ fecha: '2010-12-31', dato: 4.0200 },{ fecha: '2011-12-31', dato: 2.6500 },{ fecha: '2012-12-31', dato: 3.3200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
