...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrvyplcaf">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswxnlsnuv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrvyplcaf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrvyplcaf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswxnlsnuv === 'undefined') {
    varMorriswxnlsnuv = Morris.Line({
      element: 'Morriswxnlsnuv',
