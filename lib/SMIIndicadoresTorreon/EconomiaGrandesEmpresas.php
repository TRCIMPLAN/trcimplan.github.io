...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasefzequkg">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvidhfelc" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbltxvmqe" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasefzequkg a:first').tab('show')
});
// LENGUETA
$('#Lenguetasefzequkg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvidhfelc === 'undefined') {
    varMorrisvidhfelc = Morris.Line({
      element: 'Morrisvidhfelc',
...
// LENGUETA
$('#Lenguetasefzequkg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbltxvmqe;
  ...
  function initmapbltxvmqe() {
    // Nuevo Mapa
    mapbltxvmqe = new L.Map('LeafLetbltxvmqe');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbltxvmqe.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbltxvmqe.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbltxvmqe === 'undefined') {
    varinitmapbltxvmqe = initmapbltxvmqe();
  };
});
FINAL;
    } // constructor
