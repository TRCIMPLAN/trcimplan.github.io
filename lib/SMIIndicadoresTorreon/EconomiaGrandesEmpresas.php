...
class EconomiaGrandesEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasungfnwvj">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisiiudnlqa" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasungfnwvj a:first').tab('show')
});
// LENGUETA
$('#Lenguetasungfnwvj a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisiiudnlqa === 'undefined') {
    varMorrisiiudnlqa = Morris.Line({
      element: 'Morrisiiudnlqa',
