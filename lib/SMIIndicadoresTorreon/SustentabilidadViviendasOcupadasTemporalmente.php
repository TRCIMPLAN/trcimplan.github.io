...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmaitthna">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsxdgyrsb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmaitthna a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmaitthna a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsxdgyrsb;
  ...
  function initmapsxdgyrsb() {
    // Nuevo Mapa
    mapsxdgyrsb = new L.Map('LeafLetsxdgyrsb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsxdgyrsb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsxdgyrsb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsxdgyrsb === 'undefined') {
    varinitmapsxdgyrsb = initmapsxdgyrsb();
  };
});
FINAL;
    } // constructor
