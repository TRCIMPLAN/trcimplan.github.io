...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasynzasqfl">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetaaiynyro" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasynzasqfl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasynzasqfl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapaaiynyro;
  ...
  function initmapaaiynyro() {
    // Nuevo Mapa
    mapaaiynyro = new L.Map('LeafLetaaiynyro');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapaaiynyro.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapaaiynyro.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapaaiynyro === 'undefined') {
    varinitmapaaiynyro = initmapaaiynyro();
  };
});
FINAL;
    } // constructor
