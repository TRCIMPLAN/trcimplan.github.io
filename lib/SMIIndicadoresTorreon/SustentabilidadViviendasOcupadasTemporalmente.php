...
class SustentabilidadViviendasOcupadasTemporalmente extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmdcdyrad">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqcmwvdjb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmdcdyrad a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmdcdyrad a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqcmwvdjb;
  ...
  function initmapqcmwvdjb() {
    // Nuevo Mapa
    mapqcmwvdjb = new L.Map('LeafLetqcmwvdjb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqcmwvdjb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqcmwvdjb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqcmwvdjb === 'undefined') {
    varinitmapqcmwvdjb = initmapqcmwvdjb();
  };
});
FINAL;
    } // constructor
