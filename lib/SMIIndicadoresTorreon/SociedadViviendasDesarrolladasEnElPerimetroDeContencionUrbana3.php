<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadViviendasDesarrolladasEnElPerimetroDeContencionUrbana3
 *
...
class SociedadViviendasDesarrolladasEnElPerimetroDeContencionUrbana3 extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Viviendas desarrolladas en el perímetro de contención urbana 3 en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2018-04-30', 'valor' => '62.9800', 'fuente_nombre' => 'SNIIV', 'notas' => 'Fuente: CONAVI, Sistema Nacional de Información e Indicadores de Vivienda (SNIIV)')); // formateado 0, valor 2, crudo 2
    } // datos
