...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasimmfdxtz">
...
<div id="Morrisslnhxxdt" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpynyrpnh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasimmfdxtz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasimmfdxtz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisslnhxxdt === 'undefined') {
    varMorrisslnhxxdt = Morris.Line({
      element: 'Morrisslnhxxdt',
...
// LENGUETA
$('#Lenguetasimmfdxtz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappynyrpnh;
  ...
  function initmappynyrpnh() {
    // Nuevo Mapa
    mappynyrpnh = new L.Map('LeafLetpynyrpnh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappynyrpnh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappynyrpnh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappynyrpnh === 'undefined') {
    varinitmappynyrpnh = initmappynyrpnh();
  };
});
FINAL;
    } // constructor
