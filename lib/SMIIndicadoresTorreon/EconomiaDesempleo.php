...
class EconomiaDesempleo extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslyonqiyp">
...
<div id="Morristwgxpbhi" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrqojafwj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslyonqiyp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslyonqiyp a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristwgxpbhi === 'undefined') {
    varMorristwgxpbhi = Morris.Line({
      element: 'Morristwgxpbhi',
...
// LENGUETA
$('#Lenguetaslyonqiyp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprqojafwj;
  ...
  function initmaprqojafwj() {
    // Nuevo Mapa
    maprqojafwj = new L.Map('LeafLetrqojafwj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprqojafwj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprqojafwj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprqojafwj === 'undefined') {
    varinitmaprqojafwj = initmaprqojafwj();
  };
});
FINAL;
    } // constructor
