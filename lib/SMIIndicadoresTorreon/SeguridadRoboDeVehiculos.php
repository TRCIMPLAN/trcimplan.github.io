...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyplmboob">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswipxswzs" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrguoftjf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyplmboob a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyplmboob a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswipxswzs === 'undefined') {
    varMorriswipxswzs = Morris.Line({
      element: 'Morriswipxswzs',
...
// LENGUETA
$('#Lenguetasyplmboob a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprguoftjf;
  ...
  function initmaprguoftjf() {
    // Nuevo Mapa
    maprguoftjf = new L.Map('LeafLetrguoftjf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprguoftjf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprguoftjf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprguoftjf === 'undefined') {
    varinitmaprguoftjf = initmaprguoftjf();
  };
});
FINAL;
    } // constructor
