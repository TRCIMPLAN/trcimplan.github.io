...
class SeguridadRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszffrufdz">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisxxtsyvfx" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgehelcmz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszffrufdz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszffrufdz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisxxtsyvfx === 'undefined') {
    varMorrisxxtsyvfx = Morris.Line({
      element: 'Morrisxxtsyvfx',
...
// LENGUETA
$('#Lenguetaszffrufdz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgehelcmz;
  ...
  function initmapgehelcmz() {
    // Nuevo Mapa
    mapgehelcmz = new L.Map('LeafLetgehelcmz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgehelcmz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgehelcmz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgehelcmz === 'undefined') {
    varinitmapgehelcmz = initmapgehelcmz();
  };
});
FINAL;
    } // constructor
