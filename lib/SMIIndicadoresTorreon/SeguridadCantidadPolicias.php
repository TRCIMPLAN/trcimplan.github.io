...
/**
 * Clase SeguridadCantidadPolicias
 */
class SeguridadCantidadPolicias extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'seguridadcantidad-policias';
