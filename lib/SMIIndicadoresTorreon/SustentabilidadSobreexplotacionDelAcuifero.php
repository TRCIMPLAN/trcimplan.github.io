...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmmasgywc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcntdwglz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmmasgywc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmmasgywc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcntdwglz;
  ...
  function initmapcntdwglz() {
    // Nuevo Mapa
    mapcntdwglz = new L.Map('LeafLetcntdwglz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcntdwglz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcntdwglz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcntdwglz === 'undefined') {
    varinitmapcntdwglz = initmapcntdwglz();
  };
});
FINAL;
    } // constructor
