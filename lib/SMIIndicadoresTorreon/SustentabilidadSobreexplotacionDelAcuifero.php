...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgdpchsyt">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethljcobol" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgdpchsyt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgdpchsyt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphljcobol;
  ...
  function initmaphljcobol() {
    // Nuevo Mapa
    maphljcobol = new L.Map('LeafLethljcobol');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphljcobol.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphljcobol.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphljcobol === 'undefined') {
    varinitmaphljcobol = initmaphljcobol();
  };
});
FINAL;
    } // constructor
