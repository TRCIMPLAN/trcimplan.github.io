...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasrdcvlgrv">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxvpmtjwt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasrdcvlgrv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasrdcvlgrv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxvpmtjwt;
  ...
  function initmapxvpmtjwt() {
    // Nuevo Mapa
    mapxvpmtjwt = new L.Map('LeafLetxvpmtjwt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxvpmtjwt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxvpmtjwt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxvpmtjwt === 'undefined') {
    varinitmapxvpmtjwt = initmapxvpmtjwt();
  };
});
FINAL;
    } // constructor
