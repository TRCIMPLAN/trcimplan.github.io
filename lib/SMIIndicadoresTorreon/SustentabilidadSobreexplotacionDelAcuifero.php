...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgjuarvpx">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethpqmgsrm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgjuarvpx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgjuarvpx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphpqmgsrm;
  ...
  function initmaphpqmgsrm() {
    // Nuevo Mapa
    maphpqmgsrm = new L.Map('LeafLethpqmgsrm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphpqmgsrm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphpqmgsrm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphpqmgsrm === 'undefined') {
    varinitmaphpqmgsrm = initmaphpqmgsrm();
  };
});
FINAL;
    } // constructor
