...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassqanjlei">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetljpxcsto" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassqanjlei a:first').tab('show')
});
// LENGUETA
$('#Lenguetassqanjlei a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapljpxcsto;
  ...
  function initmapljpxcsto() {
    // Nuevo Mapa
    mapljpxcsto = new L.Map('LeafLetljpxcsto');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapljpxcsto.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapljpxcsto.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapljpxcsto === 'undefined') {
    varinitmapljpxcsto = initmapljpxcsto();
  };
});
FINAL;
    } // constructor
