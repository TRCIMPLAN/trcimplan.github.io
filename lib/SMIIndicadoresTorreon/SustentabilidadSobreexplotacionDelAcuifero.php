...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasalvnhdaw">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxoimsycy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasalvnhdaw a:first').tab('show')
});
// LENGUETA
$('#Lenguetasalvnhdaw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxoimsycy;
  ...
  function initmapxoimsycy() {
    // Nuevo Mapa
    mapxoimsycy = new L.Map('LeafLetxoimsycy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxoimsycy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxoimsycy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxoimsycy === 'undefined') {
    varinitmapxoimsycy = initmapxoimsycy();
  };
});
FINAL;
    } // constructor
