...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasghojdlwh">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetscrltoie" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasghojdlwh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasghojdlwh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapscrltoie;
  ...
  function initmapscrltoie() {
    // Nuevo Mapa
    mapscrltoie = new L.Map('LeafLetscrltoie');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapscrltoie.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapscrltoie.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapscrltoie === 'undefined') {
    varinitmapscrltoie = initmapscrltoie();
  };
});
FINAL;
    } // constructor
