...
class SustentabilidadSobreexplotacionDelAcuifero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszrbobfre">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetskvwxmqt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszrbobfre a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszrbobfre a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapskvwxmqt;
  ...
  function initmapskvwxmqt() {
    // Nuevo Mapa
    mapskvwxmqt = new L.Map('LeafLetskvwxmqt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapskvwxmqt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapskvwxmqt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapskvwxmqt === 'undefined') {
    varinitmapskvwxmqt = initmapskvwxmqt();
  };
});
FINAL;
    } // constructor
