<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Sistema de Transporte Másivo (Creado por Central:SmiLanzadera)
 *
...
class SociedadSistemaDeTransporteMasivo extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre            = 'Sistema de Transporte Másivo en Torreón';
     // $this->autor             = '';
...
Fuente: Centro de Transporte Sustentable (CTS)/ Banco Nacional de Obras y Servicios Públicos (Banobras)/ El Poder del Consumidor A.C. (EPC), 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Sistema de Transporte Másivo en Torreón</h3>
