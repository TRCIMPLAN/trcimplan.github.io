...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasayuumawr">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjiksgmmn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasayuumawr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasayuumawr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjiksgmmn;
  ...
  function initmapjiksgmmn() {
    // Nuevo Mapa
    mapjiksgmmn = new L.Map('LeafLetjiksgmmn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjiksgmmn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjiksgmmn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjiksgmmn === 'undefined') {
    varinitmapjiksgmmn = initmapjiksgmmn();
  };
});
FINAL;
    } // constructor
