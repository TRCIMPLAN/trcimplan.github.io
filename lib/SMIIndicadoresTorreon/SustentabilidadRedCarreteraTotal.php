...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaolnbhqt">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxgkmfuue" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaolnbhqt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaolnbhqt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxgkmfuue;
  ...
  function initmapxgkmfuue() {
    // Nuevo Mapa
    mapxgkmfuue = new L.Map('LeafLetxgkmfuue');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxgkmfuue.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxgkmfuue.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxgkmfuue === 'undefined') {
    varinitmapxgkmfuue = initmapxgkmfuue();
  };
});
FINAL;
    } // constructor
