...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasucpuscpf">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuhuzsuix" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasucpuscpf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasucpuscpf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuhuzsuix;
  ...
  function initmapuhuzsuix() {
    // Nuevo Mapa
    mapuhuzsuix = new L.Map('LeafLetuhuzsuix');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuhuzsuix.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuhuzsuix.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuhuzsuix === 'undefined') {
    varinitmapuhuzsuix = initmapuhuzsuix();
  };
});
FINAL;
    } // constructor
