...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseddkrtoa">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbjlpdgqb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseddkrtoa a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseddkrtoa a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbjlpdgqb;
  ...
  function initmapbjlpdgqb() {
    // Nuevo Mapa
    mapbjlpdgqb = new L.Map('LeafLetbjlpdgqb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbjlpdgqb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbjlpdgqb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbjlpdgqb === 'undefined') {
    varinitmapbjlpdgqb = initmapbjlpdgqb();
  };
});
FINAL;
    } // constructor
