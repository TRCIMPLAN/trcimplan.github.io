...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashumdnyqx">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettkgzqnig" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashumdnyqx a:first').tab('show')
});
// LENGUETA
$('#Lenguetashumdnyqx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptkgzqnig;
  ...
  function initmaptkgzqnig() {
    // Nuevo Mapa
    maptkgzqnig = new L.Map('LeafLettkgzqnig');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptkgzqnig.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptkgzqnig.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptkgzqnig === 'undefined') {
    varinitmaptkgzqnig = initmaptkgzqnig();
  };
});
FINAL;
    } // constructor
