...
class SustentabilidadRedCarreteraTotal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspjwtvsak">
...
No aplica a nivel metropolitano.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmnhccxse" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspjwtvsak a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspjwtvsak a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmnhccxse;
  ...
  function initmapmnhccxse() {
    // Nuevo Mapa
    mapmnhccxse = new L.Map('LeafLetmnhccxse');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmnhccxse.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmnhccxse.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmnhccxse === 'undefined') {
    varinitmapmnhccxse = initmapmnhccxse();
  };
});
FINAL;
    } // constructor
