...
class SustentabilidadVolumenTratadoDeAguasResiduales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxqgkcbjz">
...
<b>Unidad:</b> Litros por segundo por cada mil habitantes.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdafgymns" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxqgkcbjz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxqgkcbjz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdafgymns;
  ...
  function initmapdafgymns() {
    // Nuevo Mapa
    mapdafgymns = new L.Map('LeafLetdafgymns');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdafgymns.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdafgymns.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdafgymns === 'undefined') {
    varinitmapdafgymns = initmapdafgymns();
  };
});
FINAL;
    } // constructor
