<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Razón Entre Mujeres y Hombres en la Enseñanza Media Superior (Creado por Central:SmiLanzadera)
 *
...
Consulta la <a href="http://www3.inegi.org.mx/sistemas/iter/default.aspx?ev=5">Base de Datos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Razón Entre Mujeres y Hombres en la Enseñanza Media Superior en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 1.0020 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
