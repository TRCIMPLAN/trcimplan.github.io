...
class SeguridadDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxpqqfohi">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishxdzylcm" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbuplgnxo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxpqqfohi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxpqqfohi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishxdzylcm === 'undefined') {
    varMorrishxdzylcm = Morris.Line({
      element: 'Morrishxdzylcm',
...
// LENGUETA
$('#Lenguetasxpqqfohi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbuplgnxo;
  ...
  function initmapbuplgnxo() {
    // Nuevo Mapa
    mapbuplgnxo = new L.Map('LeafLetbuplgnxo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbuplgnxo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbuplgnxo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbuplgnxo === 'undefined') {
    varinitmapbuplgnxo = initmapbuplgnxo();
  };
});
FINAL;
    } // constructor
