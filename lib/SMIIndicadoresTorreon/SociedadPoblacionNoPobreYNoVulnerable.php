<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadPoblacionNoPobreYNoVulnerable
 *
...
class SociedadPoblacionNoPobreYNoVulnerable extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población no pobre y no vulnerable en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '34.0000', 'fuente_nombre' => 'CONEVAL'),
            array('fecha' => '2015-12-31', 'valor' => '35.3000', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 4, crudo 2
    } // datos
