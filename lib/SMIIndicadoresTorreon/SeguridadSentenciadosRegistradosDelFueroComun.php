...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmmpmpzwp">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwifdkrdd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmmpmpzwp a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmmpmpzwp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwifdkrdd;
  ...
  function initmapwifdkrdd() {
    // Nuevo Mapa
    mapwifdkrdd = new L.Map('LeafLetwifdkrdd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwifdkrdd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwifdkrdd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwifdkrdd === 'undefined') {
    varinitmapwifdkrdd = initmapwifdkrdd();
  };
});
FINAL;
    } // constructor
