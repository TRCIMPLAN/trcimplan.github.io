...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyanqoqml">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmzlodmzv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyanqoqml a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyanqoqml a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmzlodmzv;
  ...
  function initmapmzlodmzv() {
    // Nuevo Mapa
    mapmzlodmzv = new L.Map('LeafLetmzlodmzv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmzlodmzv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmzlodmzv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmzlodmzv === 'undefined') {
    varinitmapmzlodmzv = initmapmzlodmzv();
  };
});
FINAL;
    } // constructor
