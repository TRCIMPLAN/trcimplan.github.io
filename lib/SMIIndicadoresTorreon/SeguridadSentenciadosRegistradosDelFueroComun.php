...
class SeguridadSentenciadosRegistradosDelFueroComun extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassxlxkdov">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetslkhnbvo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassxlxkdov a:first').tab('show')
});
// LENGUETA
$('#Lenguetassxlxkdov a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapslkhnbvo;
  ...
  function initmapslkhnbvo() {
    // Nuevo Mapa
    mapslkhnbvo = new L.Map('LeafLetslkhnbvo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapslkhnbvo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapslkhnbvo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapslkhnbvo === 'undefined') {
    varinitmapslkhnbvo = initmapslkhnbvo();
  };
});
FINAL;
    } // constructor
