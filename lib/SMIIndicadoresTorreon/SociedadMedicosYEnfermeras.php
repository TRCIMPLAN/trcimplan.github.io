<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadMedicosYEnfermeras
 *
...
class SociedadMedicosYEnfermeras extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Médicos y enfermeras en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '2492', 'fuente_nombre' => 'IMCO', 'notas' => 'En 2016 se uso el dato "cantidad" de médicos generales y familiares más enfermeras en operación')); // formateado 0, valor 2, crudo 2
    } // datos
