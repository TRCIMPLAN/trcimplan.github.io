...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslvcsrhwn">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqhoaulhu" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslvcsrhwn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslvcsrhwn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqhoaulhu === 'undefined') {
    varMorrisqhoaulhu = Morris.Line({
      element: 'Morrisqhoaulhu',
