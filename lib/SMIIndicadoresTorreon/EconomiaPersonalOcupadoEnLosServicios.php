...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasajnnkmmf">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishkhobepe" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasajnnkmmf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasajnnkmmf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishkhobepe === 'undefined') {
    varMorrishkhobepe = Morris.Line({
      element: 'Morrishkhobepe',
