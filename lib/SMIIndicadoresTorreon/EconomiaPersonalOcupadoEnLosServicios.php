...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaremvrln">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisbphpqjhm" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwdvrjzyn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaremvrln a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaremvrln a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisbphpqjhm === 'undefined') {
    varMorrisbphpqjhm = Morris.Line({
      element: 'Morrisbphpqjhm',
...
// LENGUETA
$('#Lenguetasaremvrln a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwdvrjzyn;
  ...
  function initmapwdvrjzyn() {
    // Nuevo Mapa
    mapwdvrjzyn = new L.Map('LeafLetwdvrjzyn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwdvrjzyn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwdvrjzyn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwdvrjzyn === 'undefined') {
    varinitmapwdvrjzyn = initmapwdvrjzyn();
  };
});
FINAL;
    } // constructor
