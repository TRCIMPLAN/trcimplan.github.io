...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmuodzbgm">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseaviyiog" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwjbwaowy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmuodzbgm a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmuodzbgm a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseaviyiog === 'undefined') {
    varMorriseaviyiog = Morris.Line({
      element: 'Morriseaviyiog',
...
// LENGUETA
$('#Lenguetasmuodzbgm a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwjbwaowy;
  ...
  function initmapwjbwaowy() {
    // Nuevo Mapa
    mapwjbwaowy = new L.Map('LeafLetwjbwaowy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwjbwaowy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwjbwaowy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwjbwaowy === 'undefined') {
    varinitmapwjbwaowy = initmapwjbwaowy();
  };
});
FINAL;
    } // constructor
