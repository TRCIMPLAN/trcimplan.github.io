...
class EconomiaPersonalOcupadoEnLosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetastarsoqda">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrismkigbsyk" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjccbusor" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetastarsoqda a:first').tab('show')
});
// LENGUETA
$('#Lenguetastarsoqda a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrismkigbsyk === 'undefined') {
    varMorrismkigbsyk = Morris.Line({
      element: 'Morrismkigbsyk',
...
// LENGUETA
$('#Lenguetastarsoqda a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjccbusor;
  ...
  function initmapjccbusor() {
    // Nuevo Mapa
    mapjccbusor = new L.Map('LeafLetjccbusor');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjccbusor.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjccbusor.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjccbusor === 'undefined') {
    varinitmapjccbusor = initmapjccbusor();
  };
});
FINAL;
    } // constructor
