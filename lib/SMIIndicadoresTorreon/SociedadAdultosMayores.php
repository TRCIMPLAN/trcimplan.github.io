...
class SociedadAdultosMayores extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskbxhkwpl">
...
<div id="Morriswlmjixhh" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxtzrlmhi" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskbxhkwpl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskbxhkwpl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswlmjixhh === 'undefined') {
    varMorriswlmjixhh = Morris.Line({
      element: 'Morriswlmjixhh',
...
// LENGUETA
$('#Lenguetaskbxhkwpl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxtzrlmhi;
  ...
  function initmapxtzrlmhi() {
    // Nuevo Mapa
    mapxtzrlmhi = new L.Map('LeafLetxtzrlmhi');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxtzrlmhi.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxtzrlmhi.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxtzrlmhi === 'undefined') {
    varinitmapxtzrlmhi = initmapxtzrlmhi();
  };
});
FINAL;
    } // constructor
