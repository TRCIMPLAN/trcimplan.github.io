...
class EconomiaTotalDeImportaciones extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->descripcion = 'Monto total de importaciones en millones de dólares.';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-12-31', 'valor' => '1659.00', 'fuente_nombre' => 'Secretaría de Administración Tributaria.')); // formateado 0, valor 2, crudo 1
    } // datos
