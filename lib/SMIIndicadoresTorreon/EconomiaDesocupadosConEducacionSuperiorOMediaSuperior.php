<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon EconomiaDesocupadosConEducacionSuperiorOMediaSuperior
 *
...
class EconomiaDesocupadosConEducacionSuperiorOMediaSuperior extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Desocupados con educación superior o media superior en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2018-03-31', 'valor' => '44.6000', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos')); // formateado 0, valor 2, crudo 1
    } // datos
