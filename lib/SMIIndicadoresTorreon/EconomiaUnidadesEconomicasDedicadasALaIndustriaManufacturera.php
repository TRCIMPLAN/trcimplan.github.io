...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswtvafmfu">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisotsofjsy" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswtvafmfu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswtvafmfu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisotsofjsy === 'undefined') {
    varMorrisotsofjsy = Morris.Line({
      element: 'Morrisotsofjsy',
