...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbdqdgynt">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisajgusfmr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdnyvflkc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbdqdgynt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbdqdgynt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisajgusfmr === 'undefined') {
    varMorrisajgusfmr = Morris.Line({
      element: 'Morrisajgusfmr',
...
// LENGUETA
$('#Lenguetasbdqdgynt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdnyvflkc;
  ...
  function initmapdnyvflkc() {
    // Nuevo Mapa
    mapdnyvflkc = new L.Map('LeafLetdnyvflkc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdnyvflkc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdnyvflkc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdnyvflkc === 'undefined') {
    varinitmapdnyvflkc = initmapdnyvflkc();
  };
});
FINAL;
    } // constructor
