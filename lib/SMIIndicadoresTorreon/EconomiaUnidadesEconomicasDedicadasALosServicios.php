...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasklmlltak">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqaeirvbk" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasklmlltak a:first').tab('show')
});
// LENGUETA
$('#Lenguetasklmlltak a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqaeirvbk === 'undefined') {
    varMorrisqaeirvbk = Morris.Line({
      element: 'Morrisqaeirvbk',
