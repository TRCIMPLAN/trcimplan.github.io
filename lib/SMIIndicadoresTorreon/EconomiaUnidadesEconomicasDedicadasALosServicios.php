...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszqrebtfz">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnxblucas" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqgvlyzhz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszqrebtfz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszqrebtfz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnxblucas === 'undefined') {
    varMorrisnxblucas = Morris.Line({
      element: 'Morrisnxblucas',
...
// LENGUETA
$('#Lenguetaszqrebtfz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqgvlyzhz;
  ...
  function initmapqgvlyzhz() {
    // Nuevo Mapa
    mapqgvlyzhz = new L.Map('LeafLetqgvlyzhz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqgvlyzhz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqgvlyzhz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqgvlyzhz === 'undefined') {
    varinitmapqgvlyzhz = initmapqgvlyzhz();
  };
});
FINAL;
    } // constructor
