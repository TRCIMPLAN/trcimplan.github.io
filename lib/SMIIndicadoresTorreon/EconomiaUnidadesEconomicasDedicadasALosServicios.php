...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswdzhcodc">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriskphodvum" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqytxjsxv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswdzhcodc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswdzhcodc a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriskphodvum === 'undefined') {
    varMorriskphodvum = Morris.Line({
      element: 'Morriskphodvum',
...
// LENGUETA
$('#Lenguetaswdzhcodc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqytxjsxv;
  ...
  function initmapqytxjsxv() {
    // Nuevo Mapa
    mapqytxjsxv = new L.Map('LeafLetqytxjsxv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqytxjsxv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqytxjsxv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqytxjsxv === 'undefined') {
    varinitmapqytxjsxv = initmapqytxjsxv();
  };
});
FINAL;
    } // constructor
