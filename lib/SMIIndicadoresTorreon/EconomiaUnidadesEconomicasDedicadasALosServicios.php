...
class EconomiaUnidadesEconomicasDedicadasALosServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvkcvokhl">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrishkdcjrag" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvkcvokhl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvkcvokhl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishkdcjrag === 'undefined') {
    varMorrishkdcjrag = Morris.Line({
      element: 'Morrishkdcjrag',
