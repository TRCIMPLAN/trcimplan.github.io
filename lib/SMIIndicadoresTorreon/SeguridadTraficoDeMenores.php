<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SeguridadTraficoDeMenores
 *
...
/**
 * Clase SeguridadTraficoDeMenores
 */
class SeguridadTraficoDeMenores extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Tráfico de menores en Torreón';
        $this->fecha       = '2018-07-26T08:54:12';
        // El nombre del archivo a crear
        $this->archivo     = 'seguridad-trafico-de-menores';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion = 'Cantidad de delitos por tráfico de menores por año';
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'Coahuila', 'fecha' => '2019-12-31', 'valor' => '0', 'fuente_nombre' => 'Secretariado Ejecutivo del Sistema Nacional de Seguridad Pública'));
    } // otras_regiones
