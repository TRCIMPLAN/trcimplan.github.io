<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Empresas Socialmente Responsables (Creado por Central:SmiLanzadera)
 *
...
<p>Fuente: Centro Mexicano para la Filantropía (CEMEFI).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica-1">
      <h3>Gráfica de Empresas Socialmente Responsables en Torreón con fuente IMCO</h3>
