...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasniflehyt">
...
<div id="Morrishjvjrgjl" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetswprzilm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasniflehyt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasniflehyt a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrishjvjrgjl === 'undefined') {
    varMorrishjvjrgjl = Morris.Line({
      element: 'Morrishjvjrgjl',
...
// LENGUETA
$('#Lenguetasniflehyt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapswprzilm;
  ...
  function initmapswprzilm() {
    // Nuevo Mapa
    mapswprzilm = new L.Map('LeafLetswprzilm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapswprzilm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapswprzilm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapswprzilm === 'undefined') {
    varinitmapswprzilm = initmapswprzilm();
  };
});
FINAL;
    } // constructor
