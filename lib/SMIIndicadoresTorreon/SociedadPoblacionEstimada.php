...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasevqhgyrv">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisvxqujjtp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasevqhgyrv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasevqhgyrv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvxqujjtp === 'undefined') {
    varMorrisvxqujjtp = Morris.Line({
      element: 'Morrisvxqujjtp',
