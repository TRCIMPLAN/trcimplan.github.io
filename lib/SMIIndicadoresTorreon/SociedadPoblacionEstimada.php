...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascdxptqqu">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisblmgubsm" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascdxptqqu a:first').tab('show')
});
// LENGUETA
$('#Lenguetascdxptqqu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisblmgubsm === 'undefined') {
    varMorrisblmgubsm = Morris.Line({
      element: 'Morrisblmgubsm',
