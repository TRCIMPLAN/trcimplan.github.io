...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjcpdclck">
...
<div id="Morriszlbvnapa" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLettjqhbbjn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjcpdclck a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjcpdclck a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriszlbvnapa === 'undefined') {
    varMorriszlbvnapa = Morris.Line({
      element: 'Morriszlbvnapa',
...
// LENGUETA
$('#Lenguetasjcpdclck a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptjqhbbjn;
  ...
  function initmaptjqhbbjn() {
    // Nuevo Mapa
    maptjqhbbjn = new L.Map('LeafLettjqhbbjn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptjqhbbjn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptjqhbbjn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptjqhbbjn === 'undefined') {
    varinitmaptjqhbbjn = initmaptjqhbbjn();
  };
});
FINAL;
    } // constructor
