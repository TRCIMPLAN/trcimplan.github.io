...
class SociedadPoblacionEstimada extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfuagkydi">
...
Estimaciones de CONAPO en base a INEGI. Consulta la [Base de Datos](http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristswcuwlr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsvbxcvod" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfuagkydi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfuagkydi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristswcuwlr === 'undefined') {
    varMorristswcuwlr = Morris.Line({
      element: 'Morristswcuwlr',
...
// LENGUETA
$('#Lenguetasfuagkydi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsvbxcvod;
  ...
  function initmapsvbxcvod() {
    // Nuevo Mapa
    mapsvbxcvod = new L.Map('LeafLetsvbxcvod');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsvbxcvod.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsvbxcvod.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsvbxcvod === 'undefined') {
    varinitmapsvbxcvod = initmapsvbxcvod();
  };
});
FINAL;
    } // constructor
