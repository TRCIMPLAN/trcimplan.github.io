...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 13.5500 },{ fecha: '2009-12-31', dato: 13.2100 },{ fecha: '2010-12-31', dato: 12.4400 },{ fecha: '2011-12-31', dato: 11.3700 },{ fecha: '2012-12-31', dato: 11.6300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
