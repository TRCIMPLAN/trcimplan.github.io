...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasssrzkddd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgyuacbsk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasssrzkddd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasssrzkddd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgyuacbsk;
  ...
  function initmapgyuacbsk() {
    // Nuevo Mapa
    mapgyuacbsk = new L.Map('LeafLetgyuacbsk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgyuacbsk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgyuacbsk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgyuacbsk === 'undefined') {
    varinitmapgyuacbsk = initmapgyuacbsk();
  };
});
FINAL;
    } // constructor
