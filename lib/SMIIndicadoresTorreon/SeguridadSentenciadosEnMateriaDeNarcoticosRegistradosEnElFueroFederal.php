...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasniadjqvd">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnayyjztr" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasniadjqvd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasniadjqvd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnayyjztr;
  ...
  function initmapnayyjztr() {
    // Nuevo Mapa
    mapnayyjztr = new L.Map('LeafLetnayyjztr');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnayyjztr.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnayyjztr.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnayyjztr === 'undefined') {
    varinitmapnayyjztr = initmapnayyjztr();
  };
});
FINAL;
    } // constructor
