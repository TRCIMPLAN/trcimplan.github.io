...
class SeguridadSentenciadosEnMateriaDeNarcoticosRegistradosEnElFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgswsdrgs">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvzeqrufc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgswsdrgs a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgswsdrgs a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvzeqrufc;
  ...
  function initmapvzeqrufc() {
    // Nuevo Mapa
    mapvzeqrufc = new L.Map('LeafLetvzeqrufc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvzeqrufc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvzeqrufc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvzeqrufc === 'undefined') {
    varinitmapvzeqrufc = initmapvzeqrufc();
  };
});
FINAL;
    } // constructor
