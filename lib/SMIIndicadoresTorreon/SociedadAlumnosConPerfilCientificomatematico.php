...
class SociedadAlumnosConPerfilCientificomatematico extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasangbwhvk">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfwbiuded" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasangbwhvk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasangbwhvk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfwbiuded;
  ...
  function initmapfwbiuded() {
    // Nuevo Mapa
    mapfwbiuded = new L.Map('LeafLetfwbiuded');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfwbiuded.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfwbiuded.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfwbiuded === 'undefined') {
    varinitmapfwbiuded = initmapfwbiuded();
  };
});
FINAL;
    } // constructor
