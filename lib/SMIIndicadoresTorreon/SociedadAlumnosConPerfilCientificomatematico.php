...
class SociedadAlumnosConPerfilCientificomatematico extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasptfeniub">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzjbfmcep" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasptfeniub a:first').tab('show')
});
// LENGUETA
$('#Lenguetasptfeniub a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzjbfmcep;
  ...
  function initmapzjbfmcep() {
    // Nuevo Mapa
    mapzjbfmcep = new L.Map('LeafLetzjbfmcep');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzjbfmcep.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzjbfmcep.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzjbfmcep === 'undefined') {
    varinitmapzjbfmcep = initmapzjbfmcep();
  };
});
FINAL;
    } // constructor
