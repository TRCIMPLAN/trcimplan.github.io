...
class SociedadAlumnosConPerfilCientificomatematico extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskmqdtryt">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbuggnkqd" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskmqdtryt a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskmqdtryt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbuggnkqd;
  ...
  function initmapbuggnkqd() {
    // Nuevo Mapa
    mapbuggnkqd = new L.Map('LeafLetbuggnkqd');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbuggnkqd.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbuggnkqd.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbuggnkqd === 'undefined') {
    varinitmapbuggnkqd = initmapbuggnkqd();
  };
});
FINAL;
    } // constructor
