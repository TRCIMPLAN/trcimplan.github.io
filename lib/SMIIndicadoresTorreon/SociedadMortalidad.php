...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasodwqwzdh">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmiugxfzs" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasodwqwzdh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasodwqwzdh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmiugxfzs;
  ...
  function initmapmiugxfzs() {
    // Nuevo Mapa
    mapmiugxfzs = new L.Map('LeafLetmiugxfzs');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmiugxfzs.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmiugxfzs.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmiugxfzs === 'undefined') {
    varinitmapmiugxfzs = initmapmiugxfzs();
  };
});
FINAL;
    } // constructor
