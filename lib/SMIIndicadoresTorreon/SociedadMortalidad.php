...
class SociedadMortalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasabsthmob">
...
Fuente Registros Administrativos INEGI, con estimaciones de población de CONAPO.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbuccpgio" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasabsthmob a:first').tab('show')
});
// LENGUETA
$('#Lenguetasabsthmob a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbuccpgio;
  ...
  function initmapbuccpgio() {
    // Nuevo Mapa
    mapbuccpgio = new L.Map('LeafLetbuccpgio');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbuccpgio.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbuccpgio.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbuccpgio === 'undefined') {
    varinitmapbuccpgio = initmapbuccpgio();
  };
});
FINAL;
    } // constructor
