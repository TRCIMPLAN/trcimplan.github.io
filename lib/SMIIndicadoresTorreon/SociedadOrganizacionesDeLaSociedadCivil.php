...
class SociedadOrganizacionesDeLaSociedadCivil extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskkorpige">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoaurbaif" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskkorpige a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskkorpige a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoaurbaif;
  ...
  function initmapoaurbaif() {
    // Nuevo Mapa
    mapoaurbaif = new L.Map('LeafLetoaurbaif');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoaurbaif.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoaurbaif.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoaurbaif === 'undefined') {
    varinitmapoaurbaif = initmapoaurbaif();
  };
});
FINAL;
    } // constructor
