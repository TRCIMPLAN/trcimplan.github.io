...
class SustentabilidadAlumbradoPublico extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascldsoiuo">
...
Censo de Población y Vivienda 2010. Consulta las [Bases de Datos](http://www.inegi.org.mx/est/contenidos/proyectos/ccpv/cpv2010/tabulados_urbano.aspx)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetutlcoxwv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascldsoiuo a:first').tab('show')
});
// LENGUETA
$('#Lenguetascldsoiuo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maputlcoxwv;
  ...
  function initmaputlcoxwv() {
    // Nuevo Mapa
    maputlcoxwv = new L.Map('LeafLetutlcoxwv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maputlcoxwv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maputlcoxwv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaputlcoxwv === 'undefined') {
    varinitmaputlcoxwv = initmaputlcoxwv();
  };
});
FINAL;
    } // constructor
