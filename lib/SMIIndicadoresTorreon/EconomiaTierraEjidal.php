<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Tierra Ejidal (Creado por Central:SmiLanzadera)
 *
...
<p>Unidades: Porcentaje de la superficie total de las unidades económicas. Fuente: INEGI, 2008.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Tierra Ejidal en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 68.2100 },{ fecha: '2009-12-31', dato: 68.2100 },{ fecha: '2010-12-31', dato: 68.2100 },{ fecha: '2011-12-31', dato: 68.2100 },{ fecha: '2012-12-31', dato: 68.2100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
