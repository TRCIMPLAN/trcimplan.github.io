...
class SociedadAlumnosConPerfilGramaticoespanol extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszxkmaglr">
...
Consulta la [Base de datos](http://www.enlace.sep.gob.mx/content/ba/pages/base_de_datos_completa_2013/)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetpwojkldk" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszxkmaglr a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszxkmaglr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mappwojkldk;
  ...
  function initmappwojkldk() {
    // Nuevo Mapa
    mappwojkldk = new L.Map('LeafLetpwojkldk');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mappwojkldk.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mappwojkldk.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmappwojkldk === 'undefined') {
    varinitmappwojkldk = initmappwojkldk();
  };
});
FINAL;
    } // constructor
