...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdcyoutqc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxlihbhjj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdcyoutqc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdcyoutqc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxlihbhjj;
  ...
  function initmapxlihbhjj() {
    // Nuevo Mapa
    mapxlihbhjj = new L.Map('LeafLetxlihbhjj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxlihbhjj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxlihbhjj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxlihbhjj === 'undefined') {
    varinitmapxlihbhjj = initmapxlihbhjj();
  };
});
FINAL;
    } // constructor
