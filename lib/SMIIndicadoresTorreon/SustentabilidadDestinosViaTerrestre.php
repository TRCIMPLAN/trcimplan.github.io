...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxnqcuogy">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlaxkragx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxnqcuogy a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxnqcuogy a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplaxkragx;
  ...
  function initmaplaxkragx() {
    // Nuevo Mapa
    maplaxkragx = new L.Map('LeafLetlaxkragx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplaxkragx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplaxkragx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplaxkragx === 'undefined') {
    varinitmaplaxkragx = initmaplaxkragx();
  };
});
FINAL;
    } // constructor
