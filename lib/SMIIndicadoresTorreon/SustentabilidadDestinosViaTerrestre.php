<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sustentabilidad Destinos Vía Terrestre (Creado por Central:SmiLanzadera)
 *
...
<p>Número total de Estados de la República Mexicana y E.U. a los cuales se puede acceder desde las Centrales de Autobuses de Torreón y Gómez Palacio</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Destinos Vía Terrestre en Torreón</h3>
