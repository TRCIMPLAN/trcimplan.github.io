...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasaljdcfpl">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetqzqvaies" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasaljdcfpl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasaljdcfpl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapqzqvaies;
  ...
  function initmapqzqvaies() {
    // Nuevo Mapa
    mapqzqvaies = new L.Map('LeafLetqzqvaies');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapqzqvaies.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapqzqvaies.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapqzqvaies === 'undefined') {
    varinitmapqzqvaies = initmapqzqvaies();
  };
});
FINAL;
    } // constructor
