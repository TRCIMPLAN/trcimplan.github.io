...
class SustentabilidadDestinosViaTerrestre extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszzxnwuhn">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethbelxqvo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszzxnwuhn a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszzxnwuhn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphbelxqvo;
  ...
  function initmaphbelxqvo() {
    // Nuevo Mapa
    maphbelxqvo = new L.Map('LeafLethbelxqvo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphbelxqvo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphbelxqvo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphbelxqvo === 'undefined') {
    varinitmaphbelxqvo = initmaphbelxqvo();
  };
});
FINAL;
    } // constructor
