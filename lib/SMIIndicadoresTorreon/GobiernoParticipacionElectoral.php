...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasejumozkb">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettuhrlbwb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasejumozkb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasejumozkb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptuhrlbwb;
  ...
  function initmaptuhrlbwb() {
    // Nuevo Mapa
    maptuhrlbwb = new L.Map('LeafLettuhrlbwb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptuhrlbwb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptuhrlbwb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptuhrlbwb === 'undefined') {
    varinitmaptuhrlbwb = initmaptuhrlbwb();
  };
});
FINAL;
    } // constructor
