...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskziutoel">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdqtwlgkf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskziutoel a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskziutoel a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdqtwlgkf;
  ...
  function initmapdqtwlgkf() {
    // Nuevo Mapa
    mapdqtwlgkf = new L.Map('LeafLetdqtwlgkf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdqtwlgkf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdqtwlgkf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdqtwlgkf === 'undefined') {
    varinitmapdqtwlgkf = initmapdqtwlgkf();
  };
});
FINAL;
    } // constructor
