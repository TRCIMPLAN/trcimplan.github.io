...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuhjdlzqk">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetphmwbefm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuhjdlzqk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuhjdlzqk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapphmwbefm;
  ...
  function initmapphmwbefm() {
    // Nuevo Mapa
    mapphmwbefm = new L.Map('LeafLetphmwbefm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapphmwbefm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapphmwbefm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapphmwbefm === 'undefined') {
    varinitmapphmwbefm = initmapphmwbefm();
  };
});
FINAL;
    } // constructor
