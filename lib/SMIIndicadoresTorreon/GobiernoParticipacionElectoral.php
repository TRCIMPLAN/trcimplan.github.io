...
class GobiernoParticipacionElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseivxpfep">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzkqdewch" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseivxpfep a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseivxpfep a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzkqdewch;
  ...
  function initmapzkqdewch() {
    // Nuevo Mapa
    mapzkqdewch = new L.Map('LeafLetzkqdewch');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzkqdewch.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzkqdewch.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzkqdewch === 'undefined') {
    varinitmapzkqdewch = initmapzkqdewch();
  };
});
FINAL;
    } // constructor
