...
class GobiernoIngresosPorCobroDeServicios extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasulkrskft">
...
<div id="Morrisdifoshjg" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetadoicuph" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasulkrskft a:first').tab('show')
});
// LENGUETA
$('#Lenguetasulkrskft a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdifoshjg === 'undefined') {
    varMorrisdifoshjg = Morris.Line({
      element: 'Morrisdifoshjg',
...
// LENGUETA
$('#Lenguetasulkrskft a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapadoicuph;
  ...
  function initmapadoicuph() {
    // Nuevo Mapa
    mapadoicuph = new L.Map('LeafLetadoicuph');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapadoicuph.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapadoicuph.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapadoicuph === 'undefined') {
    varinitmapadoicuph = initmapadoicuph();
  };
});
FINAL;
    } // constructor
