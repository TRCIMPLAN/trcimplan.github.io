 ...
 */
class GobiernoLitrosDeCombustibleGastadosPorHabitante extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      ...
      <p><b>Unidad:</b> Litros por Persona.</p>
      <h3>Observaciones</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-06-30', dato: 0.8500 },{ fecha: '2014-12-31', dato: 2.4000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
