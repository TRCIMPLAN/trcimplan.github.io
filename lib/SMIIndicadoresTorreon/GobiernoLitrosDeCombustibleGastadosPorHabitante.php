...
class GobiernoLitrosDeCombustibleGastadosPorHabitante extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Torreón, Sistema de Indicadores de Desempeño (SINDES), Recursos Naturales, Gobierno, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2014-12-31', 'valor' => '2.4000', 'fuente_nombre' => 'Ayuntamiento de Torreón')); // formateado 0, valor 4, crudo 2
    } // datos
