...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswjrgidvj">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuzvqqhes" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswjrgidvj a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswjrgidvj a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuzvqqhes;
  ...
  function initmapuzvqqhes() {
    // Nuevo Mapa
    mapuzvqqhes = new L.Map('LeafLetuzvqqhes');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuzvqqhes.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuzvqqhes.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuzvqqhes === 'undefined') {
    varinitmapuzvqqhes = initmapuzvqqhes();
  };
});
FINAL;
    } // constructor
