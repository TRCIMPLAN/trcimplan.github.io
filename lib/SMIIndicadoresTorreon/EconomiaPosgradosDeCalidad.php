...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskezclhge">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethyxwpbxb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskezclhge a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskezclhge a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphyxwpbxb;
  ...
  function initmaphyxwpbxb() {
    // Nuevo Mapa
    maphyxwpbxb = new L.Map('LeafLethyxwpbxb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphyxwpbxb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphyxwpbxb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphyxwpbxb === 'undefined') {
    varinitmaphyxwpbxb = initmaphyxwpbxb();
  };
});
FINAL;
    } // constructor
