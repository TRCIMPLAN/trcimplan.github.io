...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspbcvoxhu">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfqvrkayj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspbcvoxhu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspbcvoxhu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfqvrkayj;
  ...
  function initmapfqvrkayj() {
    // Nuevo Mapa
    mapfqvrkayj = new L.Map('LeafLetfqvrkayj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfqvrkayj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfqvrkayj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfqvrkayj === 'undefined') {
    varinitmapfqvrkayj = initmapfqvrkayj();
  };
});
FINAL;
    } // constructor
