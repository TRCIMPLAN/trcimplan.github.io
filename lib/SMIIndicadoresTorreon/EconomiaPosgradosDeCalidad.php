...
class EconomiaPosgradosDeCalidad extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspnwezdvl">
...
Datos obtenidos de [CONACYT](http://svrtmp.main.conacyt.mx/ConsultasPNPC/listar_padron.php)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetmvcnzigx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspnwezdvl a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspnwezdvl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapmvcnzigx;
  ...
  function initmapmvcnzigx() {
    // Nuevo Mapa
    mapmvcnzigx = new L.Map('LeafLetmvcnzigx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapmvcnzigx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapmvcnzigx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapmvcnzigx === 'undefined') {
    varinitmapmvcnzigx = initmapmvcnzigx();
  };
});
FINAL;
    } // constructor
