...
class SustentabilidadPoblacionQueTrabajaEnSuPropioMunicipio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnxovdmvh">
...
Consulta la [Base de Datos](http://www.conapo.gob.mx/en/CONAPO/Catalogo_Sistema_Urbano_Nacional_2012)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetotmxqppp" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnxovdmvh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnxovdmvh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapotmxqppp;
  ...
  function initmapotmxqppp() {
    // Nuevo Mapa
    mapotmxqppp = new L.Map('LeafLetotmxqppp');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapotmxqppp.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapotmxqppp.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapotmxqppp === 'undefined') {
    varinitmapotmxqppp = initmapotmxqppp();
  };
});
FINAL;
    } // constructor
