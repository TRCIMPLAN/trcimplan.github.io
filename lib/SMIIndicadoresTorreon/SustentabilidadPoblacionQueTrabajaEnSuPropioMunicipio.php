...
class SustentabilidadPoblacionQueTrabajaEnSuPropioMunicipio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashirvoxbx">
...
Consulta la [Base de Datos](http://www.conapo.gob.mx/en/CONAPO/Catalogo_Sistema_Urbano_Nacional_2012)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzzjizptf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashirvoxbx a:first').tab('show')
});
// LENGUETA
$('#Lenguetashirvoxbx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzzjizptf;
  ...
  function initmapzzjizptf() {
    // Nuevo Mapa
    mapzzjizptf = new L.Map('LeafLetzzjizptf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzzjizptf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzzjizptf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzzjizptf === 'undefined') {
    varinitmapzzjizptf = initmapzzjizptf();
  };
});
FINAL;
    } // constructor
