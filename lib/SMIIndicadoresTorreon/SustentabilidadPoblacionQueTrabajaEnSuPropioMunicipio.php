...
class SustentabilidadPoblacionQueTrabajaEnSuPropioMunicipio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqxjpaqmu">
...
Consulta la [Base de Datos](http://www.conapo.gob.mx/en/CONAPO/Catalogo_Sistema_Urbano_Nacional_2012)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnssofkzj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqxjpaqmu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqxjpaqmu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnssofkzj;
  ...
  function initmapnssofkzj() {
    // Nuevo Mapa
    mapnssofkzj = new L.Map('LeafLetnssofkzj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnssofkzj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnssofkzj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnssofkzj === 'undefined') {
    varinitmapnssofkzj = initmapnssofkzj();
  };
});
FINAL;
    } // constructor
