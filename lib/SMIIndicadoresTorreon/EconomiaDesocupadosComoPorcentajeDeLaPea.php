...
class EconomiaDesocupadosComoPorcentajeDeLaPea extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasocmgsvrk">
...
Datos obtenidos de [INEGI. Censos de población y vivienda](http://www.inegi.org.mx/sistemas/consulta_resultados/iter2010.aspx?c=27329&s=est)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisrgsfpcfn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetputrgbec" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasocmgsvrk a:first').tab('show')
});
// LENGUETA
$('#Lenguetasocmgsvrk a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisrgsfpcfn === 'undefined') {
    varMorrisrgsfpcfn = Morris.Line({
      element: 'Morrisrgsfpcfn',
...
// LENGUETA
$('#Lenguetasocmgsvrk a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapputrgbec;
  ...
  function initmapputrgbec() {
    // Nuevo Mapa
    mapputrgbec = new L.Map('LeafLetputrgbec');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapputrgbec.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapputrgbec.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapputrgbec === 'undefined') {
    varinitmapputrgbec = initmapputrgbec();
  };
});
FINAL;
    } // constructor
