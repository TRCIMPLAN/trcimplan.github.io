...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyzsgkkrv">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisqgrdsvqv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyzsgkkrv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyzsgkkrv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisqgrdsvqv === 'undefined') {
    varMorrisqgrdsvqv = Morris.Line({
      element: 'Morrisqgrdsvqv',
