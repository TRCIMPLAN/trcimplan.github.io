...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslwtxakil">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisilqlyuio" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnhojgyuc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslwtxakil a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslwtxakil a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisilqlyuio === 'undefined') {
    varMorrisilqlyuio = Morris.Line({
      element: 'Morrisilqlyuio',
...
// LENGUETA
$('#Lenguetaslwtxakil a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnhojgyuc;
  ...
  function initmapnhojgyuc() {
    // Nuevo Mapa
    mapnhojgyuc = new L.Map('LeafLetnhojgyuc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnhojgyuc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnhojgyuc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnhojgyuc === 'undefined') {
    varinitmapnhojgyuc = initmapnhojgyuc();
  };
});
FINAL;
    } // constructor
