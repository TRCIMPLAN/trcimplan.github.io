...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasiqxchabz">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisadctuxwn" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetwauhgqba" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasiqxchabz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasiqxchabz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisadctuxwn === 'undefined') {
    varMorrisadctuxwn = Morris.Line({
      element: 'Morrisadctuxwn',
...
// LENGUETA
$('#Lenguetasiqxchabz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapwauhgqba;
  ...
  function initmapwauhgqba() {
    // Nuevo Mapa
    mapwauhgqba = new L.Map('LeafLetwauhgqba');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapwauhgqba.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapwauhgqba.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapwauhgqba === 'undefined') {
    varinitmapwauhgqba = initmapwauhgqba();
  };
});
FINAL;
    } // constructor
