...
class EconomiaMicroempresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbxnownfn">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisuavwupki" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbxnownfn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbxnownfn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisuavwupki === 'undefined') {
    varMorrisuavwupki = Morris.Line({
      element: 'Morrisuavwupki',
