...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxjkkrfth">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisckdfmbka" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetsmjwexsl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxjkkrfth a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxjkkrfth a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisckdfmbka === 'undefined') {
    varMorrisckdfmbka = Morris.Line({
      element: 'Morrisckdfmbka',
...
// LENGUETA
$('#Lenguetasxjkkrfth a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapsmjwexsl;
  ...
  function initmapsmjwexsl() {
    // Nuevo Mapa
    mapsmjwexsl = new L.Map('LeafLetsmjwexsl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapsmjwexsl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapsmjwexsl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapsmjwexsl === 'undefined') {
    varinitmapsmjwexsl = initmapsmjwexsl();
  };
});
FINAL;
    } // constructor
