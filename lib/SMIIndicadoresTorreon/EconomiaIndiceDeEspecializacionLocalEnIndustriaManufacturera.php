...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasauznyjwl">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswanulbzg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasauznyjwl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasauznyjwl a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswanulbzg === 'undefined') {
    varMorriswanulbzg = Morris.Line({
      element: 'Morriswanulbzg',
