...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashrmdkzsr">
...
Datos obtenidos de [INEGI. Censos económicos](http://www3.inegi.org.mx/sistemas/saic/)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseyhrydja" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashrmdkzsr a:first').tab('show')
});
// LENGUETA
$('#Lenguetashrmdkzsr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseyhrydja === 'undefined') {
    varMorriseyhrydja = Morris.Line({
      element: 'Morriseyhrydja',
