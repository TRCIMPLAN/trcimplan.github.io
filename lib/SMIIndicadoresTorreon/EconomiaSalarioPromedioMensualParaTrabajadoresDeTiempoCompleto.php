...
FINAL;
  ...
  if (typeof vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos === 'undefined') {
    vargraficaDatosEncuestaNacionalDeOcupacionYEmpleoEnoeMicrodatos = Morris.Line({
      ...
      data: [{ fecha: '2015-03-31', dato: 6434.28 },{ fecha: '2015-06-30', dato: 6545.67 },{ fecha: '2015-09-30', dato: 6485.04 },{ fecha: '2015-12-31', dato: 6563.63 },{ fecha: '2016-03-31', dato: 6347.41 },{ fecha: '2016-06-30', dato: 6934.83 },{ fecha: '2016-09-30', dato: 6282.40 },{ fecha: '2016-12-31', dato: 6775.10 },{ fecha: '2017-03-31', dato: 6983.93 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
