<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SeguridadChoquesContraCiclistas
 *
...
class SeguridadChoquesContraCiclistas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Choques contra ciclistas en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '126', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2016-12-31', 'valor' => '113', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2017-12-31', 'valor' => '127', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2018-12-31', 'valor' => '115', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
