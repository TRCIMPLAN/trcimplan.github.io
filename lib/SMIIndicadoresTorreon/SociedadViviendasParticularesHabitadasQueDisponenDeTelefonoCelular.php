<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadViviendasParticularesHabitadasQueDisponenDeTelefonoCelular
 *
...
class SociedadViviendasParticularesHabitadasQueDisponenDeTelefonoCelular extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Viviendas Particulares Habitadas que disponen de Teléfono Celular en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '87.0000', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda', 'notas' => 'Fuente: INEGI, Intercensal 2015')); // formateado 0, valor 2, crudo 2
    } // datos
