...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascvrmdgip">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriswpzhakik" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascvrmdgip a:first').tab('show')
});
// LENGUETA
$('#Lenguetascvrmdgip a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriswpzhakik === 'undefined') {
    varMorriswpzhakik = Morris.Line({
      element: 'Morriswpzhakik',
