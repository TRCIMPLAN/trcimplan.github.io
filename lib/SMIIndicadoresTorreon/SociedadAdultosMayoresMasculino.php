...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasubpsqehn">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjqacdxsi" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvfcivvdt" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasubpsqehn a:first').tab('show')
});
// LENGUETA
$('#Lenguetasubpsqehn a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjqacdxsi === 'undefined') {
    varMorrisjqacdxsi = Morris.Line({
      element: 'Morrisjqacdxsi',
...
// LENGUETA
$('#Lenguetasubpsqehn a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvfcivvdt;
  ...
  function initmapvfcivvdt() {
    // Nuevo Mapa
    mapvfcivvdt = new L.Map('LeafLetvfcivvdt');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvfcivvdt.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvfcivvdt.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvfcivvdt === 'undefined') {
    varinitmapvfcivvdt = initmapvfcivvdt();
  };
});
FINAL;
    } // constructor
