...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskedlbyfb">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrislyfltcty" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskedlbyfb a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskedlbyfb a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrislyfltcty === 'undefined') {
    varMorrislyfltcty = Morris.Line({
      element: 'Morrislyfltcty',
