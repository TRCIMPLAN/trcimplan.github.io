...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasncwmrvnu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfacvnoqp" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasncwmrvnu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasncwmrvnu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfacvnoqp === 'undefined') {
    varMorrisfacvnoqp = Morris.Line({
      element: 'Morrisfacvnoqp',
