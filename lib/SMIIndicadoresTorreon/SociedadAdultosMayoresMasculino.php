...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasqrweonsu">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisjcutaqss" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasqrweonsu a:first').tab('show')
});
// LENGUETA
$('#Lenguetasqrweonsu a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisjcutaqss === 'undefined') {
    varMorrisjcutaqss = Morris.Line({
      element: 'Morrisjcutaqss',
