...
class SociedadAdultosMayoresMasculino extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasypcxmswv">
...
Cantidad
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristcokmadb" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLethynozpbc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasypcxmswv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasypcxmswv a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristcokmadb === 'undefined') {
    varMorristcokmadb = Morris.Line({
      element: 'Morristcokmadb',
...
// LENGUETA
$('#Lenguetasypcxmswv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphynozpbc;
  ...
  function initmaphynozpbc() {
    // Nuevo Mapa
    maphynozpbc = new L.Map('LeafLethynozpbc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphynozpbc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphynozpbc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphynozpbc === 'undefined') {
    varinitmaphynozpbc = initmaphynozpbc();
  };
});
FINAL;
    } // constructor
