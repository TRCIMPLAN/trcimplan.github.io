...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgnsqzway">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgnvyvcua" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgnsqzway a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgnsqzway a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgnvyvcua;
  ...
  function initmapgnvyvcua() {
    // Nuevo Mapa
    mapgnvyvcua = new L.Map('LeafLetgnvyvcua');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgnvyvcua.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgnvyvcua.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgnvyvcua === 'undefined') {
    varinitmapgnvyvcua = initmapgnvyvcua();
  };
});
FINAL;
    } // constructor
