...
class SociedadDiferencialDeGradoPromedioDeEscolaridadPorGenero extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasnsusolnt">
...
Años de escolaridad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbepqmrng" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasnsusolnt a:first').tab('show')
});
// LENGUETA
$('#Lenguetasnsusolnt a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbepqmrng;
  ...
  function initmapbepqmrng() {
    // Nuevo Mapa
    mapbepqmrng = new L.Map('LeafLetbepqmrng');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbepqmrng.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbepqmrng.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbepqmrng === 'undefined') {
    varinitmapbepqmrng = initmapbepqmrng();
  };
});
FINAL;
    } // constructor
