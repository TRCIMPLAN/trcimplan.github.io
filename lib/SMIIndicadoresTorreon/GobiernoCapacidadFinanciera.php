...
class GobiernoCapacidadFinanciera extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdxugoqpf">
...
Datos obtenidos de [INEGI. Estadística de finanzas públicas estatales y municipales](http://www.inegi.org.mx/sistemas/olap/Proyectos/bd/continuas/finanzaspublicas/FPMun.asp?s=est&c=11289&proy=efipem_fmun)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisfmxjygqi" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdxugoqpf a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdxugoqpf a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisfmxjygqi === 'undefined') {
    varMorrisfmxjygqi = Morris.Line({
      element: 'Morrisfmxjygqi',
