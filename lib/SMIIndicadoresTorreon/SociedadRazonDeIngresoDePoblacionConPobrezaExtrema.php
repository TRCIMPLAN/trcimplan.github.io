<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadRazonDeIngresoDePoblacionConPobrezaExtrema
 *
...
class SociedadRazonDeIngresoDePoblacionConPobrezaExtrema extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón de ingreso de población con pobreza extrema en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '12.0000', 'fuente_nombre' => 'CONEVAL'),
