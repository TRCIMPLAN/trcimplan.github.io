<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadTratamientoDeAguasResiduales
 *
...
class SustentabilidadTratamientoDeAguasResiduales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Tratamiento de Aguas Residuales en Torreón';
    ...
    public function datos() {
        return array(
            array('fecha' => '2014-12-31', 'valor' => '79.2900', 'fuente_nombre' => 'CONAGUA', 'notas' => 'Fuente: DGMA')); // formateado 0, valor 2, crudo 2
    } // datos
