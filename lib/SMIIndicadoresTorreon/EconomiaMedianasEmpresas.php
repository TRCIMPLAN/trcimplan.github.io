...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaseljpqmqz">
...
<div id="Morrisvojyopkb" class="grafica"></div>


    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbqvjztlm" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaseljpqmqz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaseljpqmqz a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisvojyopkb === 'undefined') {
    varMorrisvojyopkb = Morris.Line({
      element: 'Morrisvojyopkb',
...
// LENGUETA
$('#Lenguetaseljpqmqz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbqvjztlm;
  ...
  function initmapbqvjztlm() {
    // Nuevo Mapa
    mapbqvjztlm = new L.Map('LeafLetbqvjztlm');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbqvjztlm.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbqvjztlm.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbqvjztlm === 'undefined') {
    varinitmapbqvjztlm = initmapbqvjztlm();
  };
});
FINAL;
    } // constructor
