...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasepulpmrr">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisgbjnghfg" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetypvmfhhl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasepulpmrr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasepulpmrr a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisgbjnghfg === 'undefined') {
    varMorrisgbjnghfg = Morris.Line({
      element: 'Morrisgbjnghfg',
...
// LENGUETA
$('#Lenguetasepulpmrr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapypvmfhhl;
  ...
  function initmapypvmfhhl() {
    // Nuevo Mapa
    mapypvmfhhl = new L.Map('LeafLetypvmfhhl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapypvmfhhl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapypvmfhhl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapypvmfhhl === 'undefined') {
    varinitmapypvmfhhl = initmapypvmfhhl();
  };
});
FINAL;
    } // constructor
