...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskxkpyczg">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisnfrvcedr" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvvpbirry" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskxkpyczg a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskxkpyczg a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisnfrvcedr === 'undefined') {
    varMorrisnfrvcedr = Morris.Line({
      element: 'Morrisnfrvcedr',
...
// LENGUETA
$('#Lenguetaskxkpyczg a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvvpbirry;
  ...
  function initmapvvpbirry() {
    // Nuevo Mapa
    mapvvpbirry = new L.Map('LeafLetvvpbirry');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvvpbirry.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvvpbirry.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvvpbirry === 'undefined') {
    varinitmapvvpbirry = initmapvvpbirry();
  };
});
FINAL;
    } // constructor
