...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetascknhihzw">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisdewqzihv" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetascknhihzw a:first').tab('show')
});
// LENGUETA
$('#Lenguetascknhihzw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisdewqzihv === 'undefined') {
    varMorrisdewqzihv = Morris.Line({
      element: 'Morrisdewqzihv',
