...
class EconomiaMedianasEmpresas extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslydfcmdx">
...
Datos obtenidos de [SIEM](http://www.siem.gob.mx/siem/estadisticas/EstadoTamanoPublico.asp?p=1)
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrisptzzwykk" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetvhmvfsuo" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslydfcmdx a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslydfcmdx a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrisptzzwykk === 'undefined') {
    varMorrisptzzwykk = Morris.Line({
      element: 'Morrisptzzwykk',
...
// LENGUETA
$('#Lenguetaslydfcmdx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapvhmvfsuo;
  ...
  function initmapvhmvfsuo() {
    // Nuevo Mapa
    mapvhmvfsuo = new L.Map('LeafLetvhmvfsuo');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapvhmvfsuo.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapvhmvfsuo.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapvhmvfsuo === 'undefined') {
    varinitmapvhmvfsuo = initmapvhmvfsuo();
  };
});
FINAL;
    } // constructor
