<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Demandantes de Conflicto Laboral (Creado por Central:SmiLanzadera)
 *
...
class EconomiaDemandantesDeConflictoLaboral extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Demandantes de Conflicto Laboral en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 14.7359 },{ fecha: '2009-12-31', dato: 16.2095 },{ fecha: '2010-12-31', dato: 11.3546 },{ fecha: '2011-12-31', dato: 10.2486 },{ fecha: '2012-12-31', dato: 10.7936 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
