...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjvctyfxe">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetesfhtxrg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjvctyfxe a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjvctyfxe a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapesfhtxrg;
  ...
  function initmapesfhtxrg() {
    // Nuevo Mapa
    mapesfhtxrg = new L.Map('LeafLetesfhtxrg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapesfhtxrg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapesfhtxrg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapesfhtxrg === 'undefined') {
    varinitmapesfhtxrg = initmapesfhtxrg();
  };
});
FINAL;
    } // constructor
