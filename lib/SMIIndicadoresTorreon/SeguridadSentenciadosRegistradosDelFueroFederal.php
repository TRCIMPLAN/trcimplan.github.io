...
class SeguridadSentenciadosRegistradosDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaslgkwlgls">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethqdajgzc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaslgkwlgls a:first').tab('show')
});
// LENGUETA
$('#Lenguetaslgkwlgls a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphqdajgzc;
  ...
  function initmaphqdajgzc() {
    // Nuevo Mapa
    maphqdajgzc = new L.Map('LeafLethqdajgzc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphqdajgzc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphqdajgzc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphqdajgzc === 'undefined') {
    varinitmaphqdajgzc = initmaphqdajgzc();
  };
});
FINAL;
    } // constructor
