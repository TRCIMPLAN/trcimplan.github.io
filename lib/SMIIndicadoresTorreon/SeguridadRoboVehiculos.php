...
/**
 * Clase SeguridadRoboVehiculos
 */
class SeguridadRoboVehiculos extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'seguridadrobo-vehiculos';
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 135 },{ fecha: '2014-02-28', dato: 92 },{ fecha: '2014-03-31', dato: 70 },{ fecha: '2014-04-30', dato: 82 },{ fecha: '2014-05-31', dato: 115 },{ fecha: '2014-06-30', dato: 95 },{ fecha: '2014-07-31', dato: 83 },{ fecha: '2014-08-31', dato: 96 },{ fecha: '2014-09-30', dato: 97 },{ fecha: '2014-10-31', dato: 101 },{ fecha: '2014-11-30', dato: 71 },{ fecha: '2014-12-31', dato: 58 },{ fecha: '2015-01-31', dato: 74 },{ fecha: '2015-02-28', dato: 29 },{ fecha: '2015-03-31', dato: 34 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 34 },{ region: 'Gómez Palacio', dato: 54 },{ region: 'Lerdo', dato: 8 },{ region: 'Matamoros', dato: 1 },{ region: 'La Laguna', dato: 97 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
