...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgitbfjjd">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzrlnskgc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgitbfjjd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgitbfjjd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzrlnskgc;
  ...
  function initmapzrlnskgc() {
    // Nuevo Mapa
    mapzrlnskgc = new L.Map('LeafLetzrlnskgc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzrlnskgc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzrlnskgc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzrlnskgc === 'undefined') {
    varinitmapzrlnskgc = initmapzrlnskgc();
  };
});
FINAL;
    } // constructor
