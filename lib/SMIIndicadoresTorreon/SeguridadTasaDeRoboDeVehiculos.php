...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszzlrusmp">
...
<b>Unidad:</b> Por cada 100 mil.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbvrqnxlx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszzlrusmp a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszzlrusmp a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbvrqnxlx;
  ...
  function initmapbvrqnxlx() {
    // Nuevo Mapa
    mapbvrqnxlx = new L.Map('LeafLetbvrqnxlx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbvrqnxlx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbvrqnxlx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbvrqnxlx === 'undefined') {
    varinitmapbvrqnxlx = initmapbvrqnxlx();
  };
});
FINAL;
    } // constructor
