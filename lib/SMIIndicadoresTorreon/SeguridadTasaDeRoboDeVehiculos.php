...
class SeguridadTasaDeRoboDeVehiculos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszkmiuaiw">
...
Por cada 100 mil
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetnqcnkjad" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszkmiuaiw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszkmiuaiw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapnqcnkjad;
  ...
  function initmapnqcnkjad() {
    // Nuevo Mapa
    mapnqcnkjad = new L.Map('LeafLetnqcnkjad');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapnqcnkjad.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapnqcnkjad.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapnqcnkjad === 'undefined') {
    varinitmapnqcnkjad = initmapnqcnkjad();
  };
});
FINAL;
    } // constructor
