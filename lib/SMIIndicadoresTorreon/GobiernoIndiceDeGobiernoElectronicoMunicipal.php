...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasfvrzbwvo">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetttippbhl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasfvrzbwvo a:first').tab('show')
});
// LENGUETA
$('#Lenguetasfvrzbwvo a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapttippbhl;
  ...
  function initmapttippbhl() {
    // Nuevo Mapa
    mapttippbhl = new L.Map('LeafLetttippbhl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapttippbhl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapttippbhl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapttippbhl === 'undefined') {
    varinitmapttippbhl = initmapttippbhl();
  };
});
FINAL;
    } // constructor
