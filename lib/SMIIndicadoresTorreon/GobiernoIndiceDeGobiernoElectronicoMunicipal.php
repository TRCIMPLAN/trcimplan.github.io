...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasssselmxi">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxdtpzheu" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasssselmxi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasssselmxi a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxdtpzheu;
  ...
  function initmapxdtpzheu() {
    // Nuevo Mapa
    mapxdtpzheu = new L.Map('LeafLetxdtpzheu');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxdtpzheu.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxdtpzheu.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxdtpzheu === 'undefined') {
    varinitmapxdtpzheu = initmapxdtpzheu();
  };
});
FINAL;
    } // constructor
