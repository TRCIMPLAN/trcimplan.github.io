...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvfwjsprr">
...
<b>Unidad:</b> De 0 a 1.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbwyrcchl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvfwjsprr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvfwjsprr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbwyrcchl;
  ...
  function initmapbwyrcchl() {
    // Nuevo Mapa
    mapbwyrcchl = new L.Map('LeafLetbwyrcchl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbwyrcchl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbwyrcchl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbwyrcchl === 'undefined') {
    varinitmapbwyrcchl = initmapbwyrcchl();
  };
});
FINAL;
    } // constructor
