...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbgyhxlhh">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzuxngwco" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbgyhxlhh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbgyhxlhh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzuxngwco;
  ...
  function initmapzuxngwco() {
    // Nuevo Mapa
    mapzuxngwco = new L.Map('LeafLetzuxngwco');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzuxngwco.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzuxngwco.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzuxngwco === 'undefined') {
    varinitmapzuxngwco = initmapzuxngwco();
  };
});
FINAL;
    } // constructor
