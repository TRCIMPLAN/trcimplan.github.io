...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetassnoqklog">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetbgasuesj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetassnoqklog a:first').tab('show')
});
// LENGUETA
$('#Lenguetassnoqklog a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapbgasuesj;
  ...
  function initmapbgasuesj() {
    // Nuevo Mapa
    mapbgasuesj = new L.Map('LeafLetbgasuesj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapbgasuesj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapbgasuesj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapbgasuesj === 'undefined') {
    varinitmapbgasuesj = initmapbgasuesj();
  };
});
FINAL;
    } // constructor
