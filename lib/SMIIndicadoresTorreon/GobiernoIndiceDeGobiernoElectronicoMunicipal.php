...
class GobiernoIndiceDeGobiernoElectronicoMunicipal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvgomdloz">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjrpbaput" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvgomdloz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvgomdloz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjrpbaput;
  ...
  function initmapjrpbaput() {
    // Nuevo Mapa
    mapjrpbaput = new L.Map('LeafLetjrpbaput');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjrpbaput.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjrpbaput.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjrpbaput === 'undefined') {
    varinitmapjrpbaput = initmapjrpbaput();
  };
});
FINAL;
    } // constructor
