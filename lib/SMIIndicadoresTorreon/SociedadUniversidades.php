...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxunyktws">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLettsnistmh" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxunyktws a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxunyktws a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maptsnistmh;
  ...
  function initmaptsnistmh() {
    // Nuevo Mapa
    maptsnistmh = new L.Map('LeafLettsnistmh');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maptsnistmh.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maptsnistmh.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaptsnistmh === 'undefined') {
    varinitmaptsnistmh = initmaptsnistmh();
  };
});
FINAL;
    } // constructor
