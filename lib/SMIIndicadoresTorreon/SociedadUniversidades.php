...
class SociedadUniversidades extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxizefwbb">
...
* Universidad Pedagógica de Durango-UGP
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetflxnxujx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxizefwbb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxizefwbb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapflxnxujx;
  ...
  function initmapflxnxujx() {
    // Nuevo Mapa
    mapflxnxujx = new L.Map('LeafLetflxnxujx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapflxnxujx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapflxnxujx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapflxnxujx === 'undefined') {
    varinitmapflxnxujx = initmapflxnxujx();
  };
});
FINAL;
    } // constructor
