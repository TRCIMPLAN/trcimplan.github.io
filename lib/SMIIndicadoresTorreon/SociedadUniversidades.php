<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Universidades (Creado por Central:SmiLanzadera)
 *
...
<li>Universidad Pedagógica de Durango-UGP</li>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Universidades en Torreón</h3>
