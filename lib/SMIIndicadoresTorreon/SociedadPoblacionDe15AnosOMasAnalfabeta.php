<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadPoblacionDe15AnosOMasAnalfabeta
 *
...
class SociedadPoblacionDe15AnosOMasAnalfabeta extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Población de 15 años o más analfabeta en Torreón';
        ...
        $this->claves      = 'IMPLAN, Torreón, Educación, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2000-12-31', 'valor' => '2.6400', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2005-12-31', 'valor' => '2.1400', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2010-12-31', 'valor' => '1.7700', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2015-12-31', 'valor' => '1.4800', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
