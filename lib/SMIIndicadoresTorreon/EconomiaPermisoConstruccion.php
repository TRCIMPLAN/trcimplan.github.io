<?php
/**
 * EconomiaPermisoConstruccion.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaPermisoConstruccion
 */
class EconomiaPermisoConstruccion extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiapermiso-construccion';
...
Costo (% de ingreso per cápita) = 40,6</td>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Permiso de Construcción</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
