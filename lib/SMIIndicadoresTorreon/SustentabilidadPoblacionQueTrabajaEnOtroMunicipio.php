<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sustentabilidad Población que Trabaja en OTRO Municipio (Creado por Central:SmiLanzadera)
 *
...
<p>Para los datos de 2010 consulta la <a href="http://www.conapo.gob.mx/en/CONAPO/Catalogo_Sistema_Urbano_Nacional_2012">Base de Datos</a>. Para la fuente 2015 consulta la <a href="http://www3.inegi.org.mx/sistemas/microdatos/formato.aspx?c=34537">Base de Datos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Población que Trabaja en OTRO Municipio en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 4.2000 },{ fecha: '2015-12-31', dato: 4.9000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
