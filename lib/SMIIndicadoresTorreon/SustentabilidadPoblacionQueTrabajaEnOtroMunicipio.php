...
class SustentabilidadPoblacionQueTrabajaEnOtroMunicipio extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasyiaargau">
...
Consulta la [Base de Datos](http://www.conapo.gob.mx/en/CONAPO/Catalogo_Sistema_Urbano_Nacional_2012)
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjzkookpg" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasyiaargau a:first').tab('show')
});
// LENGUETA
$('#Lenguetasyiaargau a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjzkookpg;
  ...
  function initmapjzkookpg() {
    // Nuevo Mapa
    mapjzkookpg = new L.Map('LeafLetjzkookpg');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjzkookpg.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjzkookpg.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjzkookpg === 'undefined') {
    varinitmapjzkookpg = initmapjzkookpg();
  };
});
FINAL;
    } // constructor
