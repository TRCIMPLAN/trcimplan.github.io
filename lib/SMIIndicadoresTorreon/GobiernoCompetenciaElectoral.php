...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswoyuofuu">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetchtahyyy" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswoyuofuu a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswoyuofuu a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapchtahyyy;
  ...
  function initmapchtahyyy() {
    // Nuevo Mapa
    mapchtahyyy = new L.Map('LeafLetchtahyyy');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapchtahyyy.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapchtahyyy.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapchtahyyy === 'undefined') {
    varinitmapchtahyyy = initmapchtahyyy();
  };
});
FINAL;
    } // constructor
