...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaswojfghbf">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetgdrmohpc" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaswojfghbf a:first').tab('show')
});
// LENGUETA
$('#Lenguetaswojfghbf a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapgdrmohpc;
  ...
  function initmapgdrmohpc() {
    // Nuevo Mapa
    mapgdrmohpc = new L.Map('LeafLetgdrmohpc');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapgdrmohpc.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapgdrmohpc.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapgdrmohpc === 'undefined') {
    varinitmapgdrmohpc = initmapgdrmohpc();
  };
});
FINAL;
    } // constructor
