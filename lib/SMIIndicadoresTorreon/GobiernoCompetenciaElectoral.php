...
class GobiernoCompetenciaElectoral extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasubxttcca">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetttamfazj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasubxttcca a:first').tab('show')
});
// LENGUETA
$('#Lenguetasubxttcca a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapttamfazj;
  ...
  function initmapttamfazj() {
    // Nuevo Mapa
    mapttamfazj = new L.Map('LeafLetttamfazj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapttamfazj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapttamfazj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapttamfazj === 'undefined') {
    varinitmapttamfazj = initmapttamfazj();
  };
});
FINAL;
    } // constructor
