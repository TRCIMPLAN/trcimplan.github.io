<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Sociedad Desigualdad en las Ciudades (Creado por Central:SmiLanzadera)
 *
...
Fuente: Estimaciones de IMCO con datos de INEGI (ENOE).</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Desigualdad en las Ciudades en Torreón</h3>
