...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasbfwflevi">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morristupufyfc" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasbfwflevi a:first').tab('show')
});
// LENGUETA
$('#Lenguetasbfwflevi a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorristupufyfc === 'undefined') {
    varMorristupufyfc = Morris.Line({
      element: 'Morristupufyfc',
