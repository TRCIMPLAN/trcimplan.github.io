...
class SociedadCamasCensables extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaszkmwrihw">
...
SINAIS considera únicamente al Hospital General de Torreón y el Hospital Integral de Matamoros, Hospital General de Lerdo y el Hospital General de Gómez Palacio.
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morriseieylicl" class="grafica"></div>
    </div>
    <div class="tab-pane" id="mapa">
              <div id="LeafLetfnxgtjyj" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaszkmwrihw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaszkmwrihw a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorriseieylicl === 'undefined') {
    varMorriseieylicl = Morris.Line({
      element: 'Morriseieylicl',
...
// LENGUETA
$('#Lenguetaszkmwrihw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapfnxgtjyj;
  ...
  function initmapfnxgtjyj() {
    // Nuevo Mapa
    mapfnxgtjyj = new L.Map('LeafLetfnxgtjyj');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapfnxgtjyj.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapfnxgtjyj.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapfnxgtjyj === 'undefined') {
    varinitmapfnxgtjyj = initmapfnxgtjyj();
  };
});
FINAL;
    } // constructor
