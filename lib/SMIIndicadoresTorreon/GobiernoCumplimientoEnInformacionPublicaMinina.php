...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasuemrezsl">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrgymflej" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasuemrezsl a:first').tab('show')
});
// LENGUETA
$('#Lenguetasuemrezsl a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprgymflej;
  ...
  function initmaprgymflej() {
    // Nuevo Mapa
    maprgymflej = new L.Map('LeafLetrgymflej');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprgymflej.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprgymflej.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprgymflej === 'undefined') {
    varinitmaprgymflej = initmaprgymflej();
  };
});
FINAL;
    } // constructor
