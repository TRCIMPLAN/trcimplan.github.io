...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasemfcrdli">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlbmagomv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasemfcrdli a:first').tab('show')
});
// LENGUETA
$('#Lenguetasemfcrdli a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplbmagomv;
  ...
  function initmaplbmagomv() {
    // Nuevo Mapa
    maplbmagomv = new L.Map('LeafLetlbmagomv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplbmagomv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplbmagomv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplbmagomv === 'undefined') {
    varinitmaplbmagomv = initmaplbmagomv();
  };
});
FINAL;
    } // constructor
