<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Cumplimiento en Información Pública Mínina (Creado por Central:SmiLanzadera)
 *
...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Cumplimiento en Información Pública Mínina en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-03-03', dato: 100.0000 },{ fecha: '2014-06-30', dato: 98.7200 },{ fecha: '2014-09-30', dato: 96.0000 },{ fecha: '2014-10-31', dato: 72.0000 },{ fecha: '2014-11-30', dato: 83.0000 },{ fecha: '2014-12-31', dato: 82.6700 },{ fecha: '2015-01-31', dato: 82.6700 },{ fecha: '2015-02-28', dato: 89.3300 },{ fecha: '2015-03-31', dato: 89.3300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
