...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasjdrxupfx">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetoitskciv" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasjdrxupfx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasjdrxupfx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapoitskciv;
  ...
  function initmapoitskciv() {
    // Nuevo Mapa
    mapoitskciv = new L.Map('LeafLetoitskciv');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapoitskciv.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapoitskciv.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapoitskciv === 'undefined') {
    varinitmapoitskciv = initmapoitskciv();
  };
});
FINAL;
    } // constructor
