...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasoluxmbts">
...
Porcentaje
    ...
    <div class="tab-pane" id="grafica">
      <h4>Gráfica</h4>
<div id="Morrissogtptmg" class="grafica"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasoluxmbts a:first').tab('show')
});
// LENGUETA
$('#Lenguetasoluxmbts a[href="#grafica"]').on('shown.bs.tab', function (e) {
  // Gráfica
  if (typeof varMorrissogtptmg === 'undefined') {
    varMorrissogtptmg = Morris.Line({
      element: 'Morrissogtptmg',
