...
class GobiernoCumplimientoEnInformacionPublicaMinina extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetashwdnocpc">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxzqxrxsl" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetashwdnocpc a:first').tab('show')
});
// LENGUETA
$('#Lenguetashwdnocpc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxzqxrxsl;
  ...
  function initmapxzqxrxsl() {
    // Nuevo Mapa
    mapxzqxrxsl = new L.Map('LeafLetxzqxrxsl');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxzqxrxsl.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxzqxrxsl.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxzqxrxsl === 'undefined') {
    varinitmapxzqxrxsl = initmapxzqxrxsl();
  };
});
FINAL;
    } // constructor
