...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasmsfmqzxb">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLethvbgoeiz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasmsfmqzxb a:first').tab('show')
});
// LENGUETA
$('#Lenguetasmsfmqzxb a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maphvbgoeiz;
  ...
  function initmaphvbgoeiz() {
    // Nuevo Mapa
    maphvbgoeiz = new L.Map('LeafLethvbgoeiz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maphvbgoeiz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maphvbgoeiz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaphvbgoeiz === 'undefined') {
    varinitmaphvbgoeiz = initmaphvbgoeiz();
  };
});
FINAL;
    } // constructor
