...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasboepdayc">
...
<b>Unidad:</b> Porcentaje.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetrpmlswnf" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasboepdayc a:first').tab('show')
});
// LENGUETA
$('#Lenguetasboepdayc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maprpmlswnf;
  ...
  function initmaprpmlswnf() {
    // Nuevo Mapa
    maprpmlswnf = new L.Map('LeafLetrpmlswnf');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maprpmlswnf.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maprpmlswnf.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaprpmlswnf === 'undefined') {
    varinitmaprpmlswnf = initmaprpmlswnf();
  };
});
FINAL;
    } // constructor
