...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspohfsdqz">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetuxumgiba" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspohfsdqz a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspohfsdqz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapuxumgiba;
  ...
  function initmapuxumgiba() {
    // Nuevo Mapa
    mapuxumgiba = new L.Map('LeafLetuxumgiba');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapuxumgiba.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapuxumgiba.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapuxumgiba === 'undefined') {
    varinitmapuxumgiba = initmapuxumgiba();
  };
});
FINAL;
    } // constructor
