...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasvpizrlbx">
...
Porcentaje
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxdpspcmb" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasvpizrlbx a:first').tab('show')
});
// LENGUETA
$('#Lenguetasvpizrlbx a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxdpspcmb;
  ...
  function initmapxdpspcmb() {
    // Nuevo Mapa
    mapxdpspcmb = new L.Map('LeafLetxdpspcmb');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxdpspcmb.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxdpspcmb.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxdpspcmb === 'undefined') {
    varinitmapxdpspcmb = initmapxdpspcmb();
  };
});
FINAL;
    } // constructor
