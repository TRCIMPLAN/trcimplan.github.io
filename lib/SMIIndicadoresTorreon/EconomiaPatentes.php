<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Economía Patentes (Creado por Central:SmiLanzadera)
 *
...
<p>Unidades: Por cada 100 mil de PEA. Fuente: CONACYT, 2008-2012.</p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Patentes en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.8583 },{ fecha: '2009-12-31', dato: 2.4089 },{ fecha: '2010-12-31', dato: 3.5229 },{ fecha: '2011-12-31', dato: 4.5257 },{ fecha: '2012-12-31', dato: 5.6569 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
