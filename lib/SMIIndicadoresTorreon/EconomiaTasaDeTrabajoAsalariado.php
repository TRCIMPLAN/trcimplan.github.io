<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon EconomiaTasaDeTrabajoAsalariado
 *
...
class EconomiaTasaDeTrabajoAsalariado extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Tasa de trabajo asalariado en Torreón';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2019-06-30', 'valor' => '74.4000', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos')); // formateado 0, valor 10, crudo 5
    } // datos
