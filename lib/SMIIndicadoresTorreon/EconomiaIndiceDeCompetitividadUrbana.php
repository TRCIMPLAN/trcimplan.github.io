...
class EconomiaIndiceDeCompetitividadUrbana extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasgtsewucd">
...
De 0 a 1
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetlsbhibzx" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasgtsewucd a:first').tab('show')
});
// LENGUETA
$('#Lenguetasgtsewucd a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var maplsbhibzx;
  ...
  function initmaplsbhibzx() {
    // Nuevo Mapa
    maplsbhibzx = new L.Map('LeafLetlsbhibzx');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    maplsbhibzx.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    maplsbhibzx.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmaplsbhibzx === 'undefined') {
    varinitmaplsbhibzx = initmaplsbhibzx();
  };
});
FINAL;
    } // constructor
