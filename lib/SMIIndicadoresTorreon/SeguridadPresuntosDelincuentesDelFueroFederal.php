...
class SeguridadPresuntosDelincuentesDelFueroFederal extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasxfrbfqdz">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetcdvvzjab" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasxfrbfqdz a:first').tab('show')
});
// LENGUETA
$('#Lenguetasxfrbfqdz a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapcdvvzjab;
  ...
  function initmapcdvvzjab() {
    // Nuevo Mapa
    mapcdvvzjab = new L.Map('LeafLetcdvvzjab');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapcdvvzjab.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapcdvvzjab.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapcdvvzjab === 'undefined') {
    varinitmapcdvvzjab = initmapcdvvzjab();
  };
});
FINAL;
    } // constructor
