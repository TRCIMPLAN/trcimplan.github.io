...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasldfrevmr">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetdpktljep" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasldfrevmr a:first').tab('show')
});
// LENGUETA
$('#Lenguetasldfrevmr a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapdpktljep;
  ...
  function initmapdpktljep() {
    // Nuevo Mapa
    mapdpktljep = new L.Map('LeafLetdpktljep');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapdpktljep.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapdpktljep.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapdpktljep === 'undefined') {
    varinitmapdpktljep = initmapdpktljep();
  };
});
FINAL;
    } // constructor
