...
class SeguridadAccidentesVialesFatales extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaspzeahzzw">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetjmlubjep" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaspzeahzzw a:first').tab('show')
});
// LENGUETA
$('#Lenguetaspzeahzzw a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapjmlubjep;
  ...
  function initmapjmlubjep() {
    // Nuevo Mapa
    mapjmlubjep = new L.Map('LeafLetjmlubjep');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapjmlubjep.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapjmlubjep.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapjmlubjep === 'undefined') {
    varinitmapjmlubjep = initmapjmlubjep();
  };
});
FINAL;
    } // constructor
