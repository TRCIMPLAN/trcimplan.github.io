<?php
/**
 * EconomiaRegistroPropiedades.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaRegistroPropiedades
 */
class EconomiaRegistroPropiedades extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaregistro-propiedades';
...
Costo (% del valor de la propiedad) = 4,5</td>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Registro de Propiedades en Torreón</h3>
      <div id="graficaDatos" class="grafica"></div>
    </div>
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Registro de Propiedades</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
