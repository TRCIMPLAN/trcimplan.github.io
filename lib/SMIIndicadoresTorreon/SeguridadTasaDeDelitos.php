...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasutpwnilh">
...
<b>Unidad:</b> Cantidad.
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetzaavgnnn" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasutpwnilh a:first').tab('show')
});
// LENGUETA
$('#Lenguetasutpwnilh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapzaavgnnn;
  ...
  function initmapzaavgnnn() {
    // Nuevo Mapa
    mapzaavgnnn = new L.Map('LeafLetzaavgnnn');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapzaavgnnn.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapzaavgnnn.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapzaavgnnn === 'undefined') {
    varinitmapzaavgnnn = initmapzaavgnnn();
  };
});
FINAL;
    } // constructor
