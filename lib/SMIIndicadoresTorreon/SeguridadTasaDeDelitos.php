...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaskhsagpqc">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetyvginjlw" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaskhsagpqc a:first').tab('show')
});
// LENGUETA
$('#Lenguetaskhsagpqc a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapyvginjlw;
  ...
  function initmapyvginjlw() {
    // Nuevo Mapa
    mapyvginjlw = new L.Map('LeafLetyvginjlw');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapyvginjlw.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapyvginjlw.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapyvginjlw === 'undefined') {
    varinitmapyvginjlw = initmapyvginjlw();
  };
});
FINAL;
    } // constructor
