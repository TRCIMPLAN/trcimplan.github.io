...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetasdhpwjpfv">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetxteguljz" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetasdhpwjpfv a:first').tab('show')
});
// LENGUETA
$('#Lenguetasdhpwjpfv a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapxteguljz;
  ...
  function initmapxteguljz() {
    // Nuevo Mapa
    mapxteguljz = new L.Map('LeafLetxteguljz');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapxteguljz.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapxteguljz.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapxteguljz === 'undefined') {
    varinitmapxteguljz = initmapxteguljz();
  };
});
FINAL;
    } // constructor
