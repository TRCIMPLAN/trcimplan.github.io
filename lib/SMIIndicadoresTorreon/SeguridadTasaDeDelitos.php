...
class SeguridadTasaDeDelitos extends \Base\Publicacion {
  ...
  <ul class="nav nav-tabs lenguetas" id="Lenguetaselaopokh">
...
Cantidad
    ...
    <div class="tab-pane" id="mapa">
              <div id="LeafLetauonwkch" class="mapa"></div>
    </div>
...
$(document).ready(function(){
  $('#Lenguetaselaopokh a:first').tab('show')
});
// LENGUETA
$('#Lenguetaselaopokh a[href="#mapa"]').on('shown.bs.tab', function (e) {
  // Mapa
  var mapauonwkch;
  ...
  function initmapauonwkch() {
    // Nuevo Mapa
    mapauonwkch = new L.Map('LeafLetauonwkch');
    // Capa con el mapa
    var osmUrl='http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var osmAttrib='Ayuntamiento de Torreón. Map data © OpenStreetMap contributors';
    var osm = new L.TileLayer(osmUrl, {minZoom: 12, maxZoom: 18, attribution: osmAttrib});
    // Definir coordenadas del centro del mapa y el nivel de zoom
    mapauonwkch.setView(new L.LatLng(25.54, -103.44), 12);
    // Agregar capa con el mapa
    mapauonwkch.addLayer(osm);
  ...
  // Ejecutar el mapa
  if (typeof varinitmapauonwkch === 'undefined') {
    varinitmapauonwkch = initmapauonwkch();
  };
});
FINAL;
    } // constructor
