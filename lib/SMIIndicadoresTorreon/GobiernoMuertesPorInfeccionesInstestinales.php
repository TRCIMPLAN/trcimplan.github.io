<?php
/**
 * TrcIMPLAN - SMI Indicadores Torreón Gobierno Muertes por Infecciones Instestinales (Creado por Central:SmiLanzadera)
 *
...
class GobiernoMuertesPorInfeccionesInstestinales extends \Base\Publicacion {
  ...
  <div class="tab-content lengueta-contenido">
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Muertes por Infecciones Instestinales en Torreón</h3>
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 4.2956 },{ fecha: '2009-12-31', dato: 2.5081 },{ fecha: '2010-12-31', dato: 2.4712 },{ fecha: '2011-12-31', dato: 4.1097 },{ fecha: '2012-12-31', dato: 3.7523 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
