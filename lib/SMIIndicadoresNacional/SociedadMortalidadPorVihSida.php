<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadMortalidadPorVihSida
 *
...
class SociedadMortalidadPorVihSida extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por VIH-SIDA en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Salud, Bienestar, Grupos Vulnerables, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '4.2000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
