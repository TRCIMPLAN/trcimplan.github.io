<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera
 *
...
class EconomiaUnidadesEconomicasDedicadasALaIndustriaManufacturera extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Unidades Económicas Dedicadas a la Industria Manufacturera en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Empresas, Mercados';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '1998-12-31', 'valor' => '12.2200', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2003-12-31', 'valor' => '10.9400', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2008-12-31', 'valor' => '11.7300', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2013-10-31', 'valor' => '10.7100', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
