<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadMortalidad
 *
...
class SociedadMortalidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Salud';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2008-12-31', 'valor' => '5.0000', 'fuente_nombre' => 'SINAIS (SSA)'),
            ...
            array('fecha' => '2012-12-31', 'valor' => '5.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2013-12-31', 'valor' => '5.1000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 28, crudo 14
    } // datos
