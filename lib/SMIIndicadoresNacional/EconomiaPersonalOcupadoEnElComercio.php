<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaPersonalOcupadoEnElComercio
 *
...
class EconomiaPersonalOcupadoEnElComercio extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personal Ocupado en el Comercio en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Empleo, Mercados';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '1998-12-31', 'valor' => '27.4300', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2003-12-31', 'valor' => '30.7700', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2008-12-31', 'valor' => '30.5000', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '29.6141', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2020-03-31', 'valor' => '21.8700', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos'),
