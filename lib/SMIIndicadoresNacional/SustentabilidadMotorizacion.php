<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SustentabilidadMotorizacion
 *
...
class SustentabilidadMotorizacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Motorización en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Medio Ambiente, Movilidad, Recursos Naturales, Sector Automotriz, Vialidad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2000-12-31', 'valor' => '160', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2001-12-31', 'valor' => '175', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2002-12-31', 'valor' => '188', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2003-12-31', 'valor' => '196', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2004-12-31', 'valor' => '204', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2005-12-31', 'valor' => '214', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2006-12-31', 'valor' => '237', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2007-12-31', 'valor' => '250', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2008-12-31', 'valor' => '269', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2009-12-31', 'valor' => '279', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2010-12-31', 'valor' => '282', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2011-12-31', 'valor' => '288', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2012-12-31', 'valor' => '299', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '310', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2014-12-31', 'valor' => '321', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2015-12-31', 'valor' => '245', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 32, crudo 16
    } // datos
