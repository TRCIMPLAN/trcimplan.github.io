<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadPobrezaModerada
 *
...
class SociedadPobrezaModerada extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Pobreza Moderada en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Bienestar, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '34.3900', 'fuente_nombre' => 'CONEVAL')); // formateado 0, valor 2, crudo 1
    } // datos
