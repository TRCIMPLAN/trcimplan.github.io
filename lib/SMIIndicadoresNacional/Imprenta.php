...
class Imprenta extends \Base\ImprentaPublicaciones {
    ...
    public function __construct() {
        ...
        $this->publicaciones_directorio  = 'SMIIndicadoresNacional';
        // Los siguientes parámetros dan datos para el concentrador y las páginas que no los tienen
        $this->titulo                    = 'Indicadores de Nacional';
        $this->descripcion               = 'Sistema Metropolitano de Indicadores, Región Nacional.';
        $this->claves                    = 'IMPLAN, SMI, Indicadores, Metropolitanos, Nacional';
        ...
        $this->directorio                = 'indicadores-nacional';
