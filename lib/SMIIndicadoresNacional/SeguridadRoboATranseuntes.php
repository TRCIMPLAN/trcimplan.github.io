<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SeguridadRoboATranseuntes
 *
...
class SeguridadRoboATranseuntes extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Robo a Transeuntes en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-03-31', 'valor' => '6268', 'fuente_nombre' => 'Encuesta Nacional de Ocupación y Empleo (ENOE) Indicadores Estratégicos')); // formateado 0, valor 2, crudo 1
    } // datos
