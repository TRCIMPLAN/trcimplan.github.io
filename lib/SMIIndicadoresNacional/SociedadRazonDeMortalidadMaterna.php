<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadRazonDeMortalidadMaterna
 *
...
class SociedadRazonDeMortalidadMaterna extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón de Mortalidad Materna en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Salud, Género, Bienestar, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '39.2000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 2, crudo 1
    } // datos
