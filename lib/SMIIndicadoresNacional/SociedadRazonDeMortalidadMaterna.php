...
class SociedadRazonDeMortalidadMaterna extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves      = 'IMPLAN, Nacional, Salud, Género, Bienestar, Objetivos del Milenio, Cluster Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '39.2000', 'fuente_nombre' => 'SINAIS (SSA)'));
    } // datos
