<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadMortalidadInfantil
 *
...
class SociedadMortalidadInfantil extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad Infantil en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Salud, Objetivos del Milenio, Índice de Competitividad Urbana, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2009-12-31', 'valor' => '14.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2010-12-31', 'valor' => '13.9000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2011-12-31', 'valor' => '13.4000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2012-12-31', 'valor' => '13.1000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2013-12-31', 'valor' => '12.6000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 10, crudo 5
    } // datos
    ...
    public function otras_regiones() {
        return array(
            array('region_nombre' => 'Torreón', 'fecha' => '2016-12-31', 'valor' => '228.0000', 'fuente_nombre' => 'IMCO'),
            array('region_nombre' => 'Gómez Palacio', 'fecha' => '2016-12-31', 'valor' => '94.0000', 'fuente_nombre' => 'IMCO'),
            array('region_nombre' => 'Lerdo', 'fecha' => '2016-12-31', 'valor' => '13.0000', 'fuente_nombre' => 'IMCO'),
            array('region_nombre' => 'Matamoros', 'fecha' => '2016-12-31', 'valor' => '3.0000', 'fuente_nombre' => 'IMCO'),
