<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SeguridadPersonasPrivadasDeLaLibertadEnCentrosPenitenciariosVaroniles
 *
...
/**
 * Clase SeguridadPersonasPrivadasDeLaLibertadEnCentrosPenitenciariosVaroniles
 */
class SeguridadPersonasPrivadasDeLaLibertadEnCentrosPenitenciariosVaroniles extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personas privadas de la libertad en centros penitenciarios varoniles en Nacional';
        $this->fecha       = '2018-07-25T14:30:15';
        // El nombre del archivo a crear
        $this->archivo     = 'seguridad-personas-privadas-de-la-libertad-en-centros-penitenciarios-varoniles';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion = 'Cantidad total de personas que se encuentran recluidos en centros penitenciarios varoniles.';
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-12-31', 'valor' => '200380', 'fuente_nombre' => 'Encuesta Nacional de Población Privada de la Libertad')); // formateado 0, valor 2, crudo 1
    } // datos
