<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaPersonalOcupadoEnLaIndustriaManufacturera
 *
...
class EconomiaPersonalOcupadoEnLaIndustriaManufacturera extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Personal Ocupado en la Industria Manufacturera en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '1998-12-31', 'valor' => '30.2000', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2003-12-31', 'valor' => '25.8500', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2008-12-31', 'valor' => '23.1700', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '23.5138', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
