<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaAseguradosTotales
 *
...
class EconomiaAseguradosTotales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Asegurados Totales en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2022-01-31', 'valor' => '29111081', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)'),
            array('fecha' => '2022-02-28', 'valor' => '29292460', 'fuente_nombre' => 'Instituto Mexicano del Seguro Social (IMSS)')); // formateado 0, valor 4, crudo 2
    } // datos
