<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadAlumnosConHabilidadesCientificasMatematicasBasicas
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasBasicas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Básicas en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '18.9000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
...
Nivel II: Resuelven problemas aritméticos con números naturales. Lea el análisis [Competencias en Lenguaje y Matemáticas en los Estudiantes de la Comarca](http://www.trcimplan.gob.mx/blog/competencias-en-lenguaje-y-matematicas-en-los-estudiantes-de-la-comarca-parte-1.html). Consulta la [Base de Datos](http://planea.sep.gob.mx/ba/base_de_datos_2015/).
OBSERVACIONES_FINAL;
    } // observaciones
