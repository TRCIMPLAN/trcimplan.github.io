<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadGradoPromedioDeEscolaridad
 *
...
class SociedadGradoPromedioDeEscolaridad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Grado Promedio de Escolaridad en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Educación, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '9.1600', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
    ...
    public function otras_regiones() {
        return array(
            ...
            array('region_nombre' => 'La Laguna', 'fecha' => '2018-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'IMCO', 'notas' => 'Años promedio de escolaridad en población de 25 años o más (ENOE)'),
