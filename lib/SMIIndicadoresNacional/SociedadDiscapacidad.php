<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadDiscapacidad
 *
...
class SociedadDiscapacidad extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Discapacidad en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Grupos Vulnerables, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '5.1000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
