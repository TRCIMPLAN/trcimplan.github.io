<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadUsuariosDeInternet
 *
...
class SociedadUsuariosDeInternet extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Usuarios de Internet en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Innovación, Competitividad, Objetivos del Milenio';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '40.0000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
