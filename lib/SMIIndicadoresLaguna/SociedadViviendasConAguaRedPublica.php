<?php
/**
 * SociedadViviendasConAguaRedPublica.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SociedadViviendasConAguaRedPublica
 */
class SociedadViviendasConAguaRedPublica extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sociedadviviendas-con-agua-red-publica';
...
<p>Enlace al <a href="http://201.159.104.45:8080/apps/implan2.html">Sistema de Información Geográfica</a>.</p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Viviendas con Agua de la Red Pública</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
