<?php
/**
 * SustentabilidadTrasladosPie.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SustentabilidadTrasladosPie
 */
class SustentabilidadTrasladosPie extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sustentabilidadtraslados-pie';
...
<p>Estudio realizado por Logit en 2011. Contempla los viajes de los municipios de Torreón y Matamoros.</p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Traslados a Pie</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
