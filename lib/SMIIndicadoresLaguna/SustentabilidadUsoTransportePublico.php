<?php
/**
 * SustentabilidadUsoTransportePublico.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SustentabilidadUsoTransportePublico
 */
class SustentabilidadUsoTransportePublico extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sustentabilidaduso-transporte-publico';
  ...
  <div class="tab-content lengueta-contenido">
    <div class="tab-pane" id="smi-indicador-datos">
      <h3>Descripción</h3>
<p>Distribución porcentual del total de viajes cotidianos realizados por modalidad. No se consideran los viajes en taxi.</p>
...
<p>Estudio realizado por Logit en 2011. Contempla los viajes de los municipios de Torreón y Matamoros.</p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Uso de Transporte Público</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
