<?php
/**
 * EconomiaIndiceEspecializacionLocalEnComercio.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase EconomiaIndiceEspecializacionLocalEnComercio
 */
class EconomiaIndiceEspecializacionLocalEnComercio extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'economiaindice-especializacion-local-en-comercio';
...
<p>Datos obtenidos de <a href="http://www3.inegi.org.mx/sistemas/saic/">INEGI. Censos económicos</a></p>
    ...
    <div class="tab-pane" id="smi-indicador-grafica">
      <h3>Gráfica de Índice de Especialización Local en Comercio en La Laguna</h3>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Índice de Especialización Local en Comercio</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
