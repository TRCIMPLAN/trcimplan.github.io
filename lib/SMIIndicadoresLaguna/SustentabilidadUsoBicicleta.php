<?php
/**
 * SustentabilidadUsoBicicleta.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SustentabilidadUsoBicicleta
 */
class SustentabilidadUsoBicicleta extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sustentabilidaduso-bicicleta';
...
<p>Estudio realizado por Logit en 2011. Contempla los viajes de los municipios de Torreón y Matamoros.</p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Uso de Bicicleta</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
