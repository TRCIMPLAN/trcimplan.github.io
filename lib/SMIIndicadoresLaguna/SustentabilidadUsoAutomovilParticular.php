<?php
/**
 * SustentabilidadUsoAutomovilParticular.php
 *
 * IMPLAN Torreón
 */
...
/**
 * Clase SustentabilidadUsoAutomovilParticular
 */
class SustentabilidadUsoAutomovilParticular extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'sustentabilidaduso-automovil-particular';
...
<p>Estudio realizado por Logit en 2011. Contempla los viajes de los municipios de Torreón y Matamoros.</p>
    ...
    <div class="tab-pane" id="smi-indicador-relacionados">
      <h3>Páginas relacionadas con Uso de Automóvil Particular</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Creado</th>
