...
/**
 * Clase SeguridadRoboNegocios
 */
class SeguridadRoboNegocios extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->archivo      = 'seguridadrobo-negocios';
...
$('#smi-indicador a[href="#smi-indicador-grafica"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2014-01-31', dato: 215 },{ fecha: '2014-02-28', dato: 245 },{ fecha: '2014-03-31', dato: 217 },{ fecha: '2014-04-30', dato: 197 },{ fecha: '2014-05-31', dato: 240 },{ fecha: '2014-06-30', dato: 165 },{ fecha: '2014-07-31', dato: 183 },{ fecha: '2014-08-31', dato: 180 },{ fecha: '2014-09-30', dato: 190 },{ fecha: '2014-10-31', dato: 190 },{ fecha: '2014-11-30', dato: 137 },{ fecha: '2014-12-31', dato: 151 },{ fecha: '2015-01-31', dato: 163 },{ fecha: '2015-02-28', dato: 162 },{ fecha: '2015-03-31', dato: 122 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
$('#smi-indicador a[href="#smi-indicador-otras_regiones"]').on('shown.bs.tab', function(e){
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 79 },{ region: 'Gómez Palacio', dato: 34 },{ region: 'Lerdo', dato: 2 },{ region: 'Matamoros', dato: 7 },{ region: 'La Laguna', dato: 122 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
